...
/**
	 ...
	 * subject to an additional IP rights grant found at
	 * http://polymer.github.io/PATENTS.txt
	 */);class R{handleAttributeExpressions(t,e,i,n){const s=e[0];return"."===s?new L(t,e.slice(1),i).parts:"@"===s?[new O(t,e.slice(1),n.eventContext)]:"?"===s?[new D(t,e.slice(1),i)]:new T(t,e,i).parts}handleTextExpression(t){return new M(t)}}const I=new R;
/**
	 * @license
	 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
	 * This code may only be used under the BSD style license found at
