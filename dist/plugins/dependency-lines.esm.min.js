 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */);class k{handleAttributeExpressions(t,e,i,n){const s=e[0];return"."===s?new D(t,e.slice(1),i).parts:"@"===s?[new N(t,e.slice(1),n.eventContext)]:"?"===s?[new M(t,e.slice(1),i)]:new S(t,e,i).parts}handleTextExpression(t){return new T(t)}}const R=new k;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
