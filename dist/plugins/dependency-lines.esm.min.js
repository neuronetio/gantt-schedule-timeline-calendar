 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */);class B{handleAttributeExpressions(t,e,n,i){const r=e[0];return"."===r?new D(t,e.slice(1),n).parts:"@"===r?[new O(t,e.slice(1),i.eventContext)]:"?"===r?[new C(t,e.slice(1),n)]:new $(t,e,n).parts}handleTextExpression(t){return new N(t)}}const R=new B;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
