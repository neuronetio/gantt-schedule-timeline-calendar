 ...
 */const r="ExportImage",B="config.plugin."+r;class n{constructor(A,e){this.unsub=[],this.options=A,this.vido=e,this.state=e.state,this.api=e.api,this.api.plugins[r]={getImage:this.getImage.bind(this),download:this.download.bind(this)},this.destroy=this.destroy.bind(this),this.state.update(B,this.options),this.unsub.push(this.state.subscribe(B,(A=>this.options=A))),this.api.pluginInitialized(r)}getImage(e="jpeg"){return A(this,void 0,void 0,(function*(){return new Promise((A=>{const r=this.state.get("$data.elements.main");t(r).then((t=>{const r=t.toDataURL("image/"+e);A(r)}))}))}))}download(e="timeline.jpg",t="jpeg"){return A(this,void 0,void 0,(function*(){return yield this.getImage(t).then((A=>{const t=document.createElement("a");t.href=A,t.download=e,t.click()}))}))}destroy(){this.unsub.forEach((A=>A())),this.vido.api.pluginDestroyed(r)}}function s(A={}){return function(e){const t=e.state.get(B);t&&(A=e.api.mergeDeep({},A,t));return new n(A,e).destroy}}export{s as Plugin,r as pluginName,B as pluginPath};