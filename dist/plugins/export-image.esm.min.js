 ...
 */const r="ExportImage",B="config.plugin."+r;class n{constructor(A,e){this.unsub=[],this.options=A,this.vido=e,this.state=e.state,this.api=e.api,this.api.plugins[r]={getImage:this.getImage.bind(this),download:this.download.bind(this)},this.destroy=this.destroy.bind(this),this.state.update(B,this.options),this.unsub.push(this.state.subscribe(B,A=>this.options=A)),this.api.pluginInitialized(r)}getImage(){return A(this,arguments,void 0,function*(A="jpeg"){const e=this.state.get("$data.elements.main");return(yield t(e,{removeContainer:!0})).toDataURL("image/"+A)})}download(){return A(this,arguments,void 0,function*(A="timeline.jpg",e="jpeg"){return yield this.getImage(e).then(e=>{const t=document.createElement("a");t.href=e,t.download=A,t.click()})})}destroy(){this.unsub.forEach(A=>A()),this.vido.api.pluginDestroyed(r)}}function s(A={}){return function(e){const t=e.state.get(B);t&&(A=e.api.mergeDeep({},A,t));return new n(A,e).destroy}}export{s as Plugin,r as pluginName,B as pluginPath};