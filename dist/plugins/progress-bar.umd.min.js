...
/**
	 ...
	 * subject to an additional IP rights grant found at
	 * http://polymer.github.io/PATENTS.txt
	 */);class R{handleAttributeExpressions(t,e,n,i){const r=e[0];return"."===r?new k(t,e.slice(1),n).parts:"@"===r?[new B(t,e.slice(1),i.eventContext)]:"?"===r?[new P(t,e.slice(1),n)]:new M(t,e,n).parts}handleTextExpression(t){return new C(t)}}const A=new R;
/**
	 * @license
	 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
	 * This code may only be used under the BSD style license found at
