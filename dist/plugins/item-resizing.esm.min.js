 ...
 * @released  2022-07-15
 * @license   SEE LICENSE IN LICENSE FILE
 */function e(t,e=""){let i=`gstc__${t}`;return"gstc"===t&&(i="gstc"),e?`${i} ${i}--${e.replace(":","-")}`:i}
/**
 * ItemResizing plugin
 *
 * @copyright NEURONET - Rafal Pospiech
