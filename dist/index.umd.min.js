...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */const $t="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let s of n[e])isObject$1(s)?t[e].push(mergeDeep$1({},s)):t[e].push(s)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}
/**
     * Gantt-Schedule-Timeline-Calendar
     *
     * @copyright Rafal Pospiech <https://neuronet.io>
