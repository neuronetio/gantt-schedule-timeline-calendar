...
/**
     ...
     */function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:s,update:o,html:r,Actions:a,PointerAction:l,cache:c,StyleMap:d}=t,h="list-column-header-resizer";let u,p,m=n.getActions(h),f=n.getActions(h+"-dots");s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>u=t)),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{p=t,o()}));let g,v,y,b,w,_=new d({width:""}),x=!1;s(i.subscribe("config.classNames",t=>{g=n.getClass(h,{column:p}),v=n.getClass(h+"-container",{column:p}),y=n.getClass(h+"-dots",{column:p}),b=n.getClass(h+"-dots-dot",{column:p}),o()})),s(i.subscribeAll([`config.list.columns.data.${p.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");w=p.width*n.columns.percent*.01,_.style["--width"]=n.columns.resizer.width+"px",x=n.columns.resizer.inRealTime,i.update("_internal.list.width",w),o()}));let $=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{$=[];for(let e=0;e<t;e++)$.push(e);o()}));let C=w;new d({"--display":"none","--left":C+"px"});const M=`config.list.columns.data.${p.id}.width`,P={column:p,api:n,state:i,pointerOptions:{axis:"x",onMove({movementX:t}){let e=i.get("config.list.columns.minWidth");"number"==typeof p.minWidth&&(e=p.minWidth),(C+=t)<e&&(C=e),x&&i.update(M,C)}}};m.push(l);const O=a.create(m,P),A=a.create(f,P);return n=>u(r`
        <div class=${g} data-actions=${O}>
          ...
          <div class=${y} style=${_} data-actions=${A}>
            ${$.map(t=>r`
                  <div class=${b} />
                `)}
          </div>
