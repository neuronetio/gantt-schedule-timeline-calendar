...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */class Template{constructor(t,e){this.parts=[],this.element=e;const n=[],i=[],s=document.createTreeWalker(e.content,133,null,!1);let o=0,r=-1,l=0;const{strings:u,values:{length:p}}=t;for(;l<p;){const t=s.nextNode();if(null!==t){if(r++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:n}=e;let i=0;for(let t=0;t<n;t++)h(e[t].name,d)&&i++;for(;i-- >0;){const e=u[l],n=f.exec(e)[2],i=n.toLowerCase()+d,s=t.getAttribute(i);t.removeAttribute(i);const o=s.split(c);this.parts.push({type:"attribute",index:r,name:n,strings:o,sanitizer:void 0}),l+=o.length-1}}"TEMPLATE"===t.tagName&&(i.push(t),s.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(a)>=0){const i=t.parentNode,s=e.split(c),o=s.length-1;for(let e=0;e<o;e++){let n,o=s[e];if(""===o)n=m();else{const t=f.exec(o);null!==t&&h(t[2],d)&&(o=o.slice(0,t.index)+t[1]+t[2].slice(0,-d.length)+t[3]),n=document.createTextNode(o)}i.insertBefore(n,t),this.parts.push({type:"node",index:++r})}""===s[o]?(i.insertBefore(m(),t),n.push(t)):t.data=s[o],l+=o}}else if(8===t.nodeType)if(t.data===a){const e=t.parentNode;null!==t.previousSibling&&r!==o||(r++,e.insertBefore(m(),t)),o=r,this.parts.push({type:"node",index:r}),null===t.nextSibling?t.data="":(n.push(t),r--),l++}else{let e=-1;for(;-1!==(e=t.data.indexOf(a,e+1));)this.parts.push({type:"node",index:-1}),l++}}else s.currentNode=i.pop()}for(const t of n)t.parentNode.removeChild(t)}}const h=(t,e)=>{const n=t.length-e.length;return n>=0&&t.slice(n)===e},u=t=>-1!==t.index,p=document.createComment(""),m=()=>p.cloneNode(),f=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * http://polymer.github.io/PATENTS.txt
     */
class TemplateInstance{constructor(t,e,n){this.__parts=[],this.template=t,this.processor=e,this.options=n}update(t){let e=0;for(const n of this.__parts)void 0!==n&&n.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const t=n?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],i=this.template.parts,s=document.createTreeWalker(t,133,null,!1);let o,r=0,a=0,l=s.nextNode();for(;r<i.length;)if(o=i[r],u(o)){for(;a<o.index;)a++,"TEMPLATE"===l.nodeName&&(e.push(l),s.currentNode=l.content),null===(l=s.nextNode())&&(s.currentNode=e.pop(),l=s.nextNode());if("node"===o.type){const t=this.processor.handleTextExpression(this.options,o);t.insertAfterNode(l.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(l,o.name,o.strings,this.options,o));r++}else this.__parts.push(void 0),r++;return n&&(document.adoptNode(t),customElements.upgrade(t)),t}}
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */const O=new class DefaultTemplateProcessor{handleAttributeExpressions(t,e,n,i,s){const o=e[0];if("."===o){return new PropertyCommitter(t,e.slice(1),n,s).parts}return"@"===o?[new EventPart(t,e.slice(1),i.eventContext)]:"?"===o?[new BooleanAttributePart(t,e.slice(1),n)]:new AttributeCommitter(t,e,n,s).parts}handleTextExpression(t,e){return new NodePart(t,e)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */function templateFactory(t){let e=T.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},T.set(t.type,e));let n=e.stringsArray.get(t.strings);if(void 0!==n)return n;const i=t.strings.join(a);return void 0===(n=e.keyString.get(i))&&(n=new Template(t,t.getTemplateElement()),e.keyString.set(i,n)),e.stringsArray.set(t.strings,n),n}const T=new Map,A=new WeakMap,I=(t,e,n)=>{let i=A.get(e);void 0===i&&(s(e,e.firstChild),A.set(e,i=new NodePart(Object.assign({templateFactory:templateFactory},n),void 0)),i.appendInto(e)),i.setValue(t),i.commit()};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const S=(t,...e)=>new TemplateResult(t,e,"html",O),D=(t,...e)=>new SVGTemplateResult(t,e,"svg",O);
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */var R=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},verb("next"),verb("throw"),verb("return"),e[Symbol.asyncIterator]=function(){return this},e);function verb(n){e[n]=t[n]&&function(e){return new Promise((function(i,s){(function settle(t,e,n,i){Promise.resolve(i).then((function(e){t({value:e,done:n})}),e)})(i,s,(e=t[n](e)).done,e.value)}))}}};const N=t((t,e)=>async n=>{var i,s;if(!(n instanceof NodePart))throw new Error("asyncReplace can only be used in text bindings");if(t===n.value)return;const o=new NodePart(n.options,n.templatePart);n.value=t;let r=0;try{for(var a,l=R(t);!(a=await l.next()).done;){let i=a.value;if(n.value!==t)break;0===r&&(n.clear(),o.appendIntoPart(n)),void 0!==e&&(i=e(i,r)),o.setValue(i),o.commit(),r++}}catch(t){i={error:t}}finally{try{a&&!a.done&&(s=l.return)&&await s.call(l)}finally{if(i)throw i.error}}}),Y=new WeakMap,j=t(t=>e=>{if(!(e instanceof NodePart))throw new Error("cache can only be used in text bindings");let n=Y.get(e);void 0===n&&(n=new WeakMap,Y.set(e,n));const s=e.value;if(s instanceof TemplateInstance){if(t instanceof TemplateResult&&s.template===e.options.templateFactory(t))return void e.setValue(t);{let t=n.get(s.template);void 0===t&&(t={instance:s,nodes:document.createDocumentFragment()},n.set(s.template,t)),i(t.nodes,e.startNode.nextSibling,e.endNode)}}if(t instanceof TemplateResult){const i=e.options.templateFactory(t),s=n.get(i);void 0!==s&&(e.setValue(s.nodes),e.commit(),e.value=s.instance)}e.setValue(t)}),z=new WeakMap,k=t(t=>e=>{if(!(e instanceof AttributePart)||e instanceof PropertyPart||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:n}=e,{element:i}=n;let s=z.get(e);void 0===s&&(i.className=n.strings.join(" "),z.set(e,s=new Set));const{classList:o}=i;s.forEach(e=>{e in t||(o.remove(e),s.delete(e))});for(const e in t){const n=t[e];n!=s.has(e)&&(n?(o.add(e),s.add(e)):(o.remove(e),s.delete(e)))}}),H=new WeakMap,W=t((t,e)=>n=>{const i=H.get(n);if(Array.isArray(t)){if(Array.isArray(i)&&i.length===t.length&&t.every((t,e)=>t===i[e]))return}else if(i===t&&(void 0!==t||H.has(n)))return;n.setValue(e()),H.set(n,Array.isArray(t)?Array.from(t):t)}),V=t(t=>e=>{if(void 0===t&&e instanceof AttributePart){if(t!==e.value){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else e.setValue(t)}),B=(t,e)=>{const n=t.startNode.parentNode,i=null==e?t.endNode:e.startNode,s=n.insertBefore(m(),i);n.insertBefore(m(),i);const o=new NodePart(t.options,void 0);return o.insertAfterNode(s),o},X=(t,e)=>(t.setValue(e),t.commit(),t),G=(t,e,n)=>{const s=t.startNode.parentNode,o=n?n.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&i(s,e.startNode,r,o)},F=t=>{s(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},U=(t,e,n)=>{const i=new Map;for(let s=e;s<=n;s++)i.set(t[s],s);return i},J=new WeakMap,q=new WeakMap,Z=t((t,e,n)=>{let i;return void 0===n?n=e:void 0!==e&&(i=e),e=>{if(!(e instanceof NodePart))throw new Error("repeat can only be used in text bindings");const s=J.get(e)||[],o=q.get(e)||[],r=[],a=[],l=[];let c,d,h=0;for(const e of t)l[h]=i?i(e,h):h,a[h]=n(e,h),h++;let u=0,p=s.length-1,m=0,f=a.length-1;for(;u<=p&&m<=f;)if(null===s[u])u++;else if(null===s[p])p--;else if(o[u]===l[m])r[m]=X(s[u],a[m]),u++,m++;else if(o[p]===l[f])r[f]=X(s[p],a[f]),p--,f--;else if(o[u]===l[f])r[f]=X(s[u],a[f]),G(e,s[u],r[f+1]),u++,f--;else if(o[p]===l[m])r[m]=X(s[p],a[m]),G(e,s[p],s[u]),p--,m++;else if(void 0===c&&(c=U(l,m,f),d=U(o,u,p)),c.has(o[u]))if(c.has(o[p])){const t=d.get(l[m]),n=void 0!==t?s[t]:null;if(null===n){const t=B(e,s[u]);X(t,a[m]),r[m]=t}else r[m]=X(n,a[m]),G(e,n,s[u]),s[t]=null;m++}else F(s[p]),p--;else F(s[u]),u++;for(;m<=f;){const t=B(e,r[f+1]);X(t,a[m]),r[m++]=t}for(;u<=p;){const t=s[u++];null!==t&&F(t)}J.set(e,r),q.set(e,l)}}),K=new WeakMap,Q=document.createElement("template"),tt=t(t=>e=>{if(!(e instanceof NodePart))throw new Error("unsafeHTML can only be used in text bindings");const n=K.get(e);if(void 0!==n&&b(t)&&t===n.value&&e.value===n.fragment)return;const i=Q.cloneNode();i.innerHTML=t;const s=document.importNode(i.content,!0);e.setValue(s),K.set(e,{value:t,fragment:s})}),et=new WeakMap,nt=t((...t)=>e=>{let n=et.get(e);void 0===n&&(n={lastRenderedIndex:2147483647,values:[]},et.set(e,n));const i=n.values;let s=i.length;n.values=t;for(let o=0;o<t.length&&!(o>n.lastRenderedIndex);o++){const r=t[o];if(b(r)||"function"!=typeof r.then){e.setValue(r),n.lastRenderedIndex=o;break}o<s&&r===i[o]||(n.lastRenderedIndex=2147483647,s=0,Promise.resolve(r).then(t=>{const i=n.values.indexOf(r);i>-1&&i<n.lastRenderedIndex&&(n.lastRenderedIndex=i,e.setValue(t),e.commit())}))}}),it=new WeakMap;
/**
     * @license
...
/**
     ...
     */function Main(t,e={}){const{api:n,state:i,onDestroy:s,Actions:o,update:r,createComponent:a,html:l,StyleMap:c,schedule:d}=t,h=n.name;let u,p;s(i.subscribe("config.plugins",e=>{if(void 0!==e&&Array.isArray(e))for(const n of e){const e=n(t);"function"==typeof e&&s(e)}})),s(i.subscribe("config.components.List",t=>u=t)),s(i.subscribe("config.components.Chart",t=>p=t));const m=a(u);s(m.destroy);const f=a(p);let g;s(f.destroy),s(i.subscribe("config.wrappers.Main",t=>g=t));const v=n.getActions("");let y,b,w,_=new c({}),x=new c({}),$=new c({}),C=0,M=!1;function generateTree(t,e){if(i.get("_internal.flatTreeMap").length&&"subscribe"===e.type)return;const s=i.get("config.list.rows"),o=[];for(const t in s)o.push(s[t]);n.fillEmptyRowValues(o);const a=i.get("config.chart.items"),l=[];for(const t in a)l.push(a[t]);const c=n.makeTreeMap(o,l);i.update("_internal.treeMap",c);const d=n.getFlatTreeMapById(c);i.update("_internal.flatTreeMapById",d);const h=n.flattenTreeMap(c);i.update("_internal.flatTreeMap",h),r()}s(i.subscribe("config.classNames",t=>{const e=i.get("config");y=n.getClass(h,{config:e}),M&&(y+=` ${h}__list-column-header-resizer--active`),b=n.getClass("vertical-scroll",{config:e}),r()})),s(i.subscribeAll(["config.height","config.headerHeight","_internal.scrollBarHeight"],(function heightChange(){const t=i.get("config"),e=i.get("_internal.scrollBarHeight"),n=t.height-t.headerHeight-e;i.update("_internal.height",n),_.style["--height"]=t.height+"px",x.style.height=n+"px",x.style.width=e+"px",x.style["margin-top"]=t.headerHeight+"px",r()}))),s(i.subscribe("_internal.list.columns.resizer.active",(function resizerActiveChange(t){M=t,y=n.getClass(n.name),M&&(y+=` ${n.name}__list-column-header-resizer--active`),r()}))),s(i.subscribeAll(["config.list.rows;","config.chart.items;"],generateTree)),s(i.subscribeAll(["config.list.rows.*.parentId","config.chart.items.*.rowId"],generateTree,{bulk:!0})),s(i.subscribeAll(["config.list.rows.*.expanded","_internal.treeMap;"],(function prepareExpanded(){const t=i.get("config.list.rows"),e=n.getRowsFromIds(n.getRowsWithParentsExpanded(i.get("_internal.flatTreeMap"),i.get("_internal.flatTreeMapById"),t),t);C=n.getRowsHeight(e),i.update("_internal.list.rowsHeight",C),i.update("_internal.list.rowsWithParentsExpanded",e),r()}),{bulk:!0})),s(i.subscribeAll(["_internal.list.rowsWithParentsExpanded;","config.scroll.top"],(function generateVisibleRows(){const{visibleRows:t,compensation:e}=n.getVisibleRowsAndCompensation(i.get("_internal.list.rowsWithParentsExpanded")),s=i.get("config.scroll.smooth"),o=i.get("_internal.list.visibleRows");let a=!0;if(i.update("config.scroll.compensation",s?-e:0),t.length&&(a=t.some((t,e)=>void 0===o[e]||t.id!==o[e].id)),a){i.update("_internal.list.visibleRows",t);const e=[];for(const n of t)for(const t of n._internal.items)e.push(t);i.update("_internal.chart.visibleItems",e)}r()})));let P=0;s(i.subscribe("_internal.list.visibleRows;",(function onVisibleRowsChange(){const t=i.get("config.scroll.top");$.style.width="1px",$.style.height=C+"px",P!==t&&w&&(P=t,w.scrollTop=t),r()})));const O=(t,e)=>{const i=[];let s=e.leftGlobal;const o=e.rightGlobal,r=e.timePerPixel;let a=s-n.time.date(s).startOf(t),l=a/r,c=0,d=0;for(;s<o;){const e={sub:a,subPx:l,leftGlobal:s,rightGlobal:n.time.date(s).endOf(t).valueOf(),width:0,leftPx:0,rightPx:0};e.width=(e.rightGlobal-e.leftGlobal+a)/r,d=e.width>d?e.width:d,e.leftPx=c,c+=e.width,e.rightPx=c,i.push(e),s=e.rightGlobal+1,a=0,l=0}e.maxWidth[t]=d,e.dates[t]=i};if(s(i.subscribeAll(["config.chart.time","_internal.dimensions.width","config.scroll.left","_internal.scrollBarHeight","_internal.list.width","_internal.chart.dimensions"],d(()=>{const t=i.get("_internal.chart.dimensions.width");let e=n.mergeDeep({},i.get("config.chart.time"));const s=.01*(e=n.time.recalculateFromTo(e)).zoom;let o=i.get("config.scroll.left");if(e.timePerPixel=s+Math.pow(2,e.zoom),e.totalViewDurationMs=n.time.date(e.to).diff(e.from,"milliseconds"),e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,o>e.totalViewDurationPx&&(o=e.totalViewDurationPx-t),e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.leftGlobal+t*e.timePerPixel,e.leftInner=e.leftGlobal-e.from,e.rightInner=e.rightGlobal-e.from,e.leftPx=e.leftInner/e.timePerPixel,e.rightPx=e.rightInner/e.timePerPixel,Math.round(e.rightGlobal/e.timePerPixel)>Math.round(e.to/e.timePerPixel)){const t=(e.rightGlobal-e.to)/(e.rightGlobal-e.from);e.timePerPixel=e.timePerPixel-e.timePerPixel*t,e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.to,e.rightInner=e.rightGlobal-e.from,e.totalViewDurationMs=e.to-e.from,e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,e.rightInner=e.rightGlobal-e.from,e.rightPx=e.rightInner/e.timePerPixel,e.leftPx=e.leftInner/e.timePerPixel}O("day",e),O("month",e),i.update("_internal.chart.time",e),r()}),{bulk:!0})),""===location.port&&""!==location.host&&!location.host.startsWith("localhost"))try{const t=new XMLHttpRequest;t.open("POST","https://gstc-us.neuronet.io/"),t.send(JSON.stringify({location:{href:location.href,host:location.host}}))}catch(t){}i.update("_internal.scrollBarHeight",n.getScrollBarHeight());let T=0;const A={handleEvent:function handleEvent(t){if("scroll"===t.type){const e=t.target.scrollTop,n=t=>{t.top=e,T=t.top;const n=i.get("_internal.elements.vertical-scroll-inner");if(n){const e=n.clientHeight;t.percent.top=t.top/e}return t};T!==e&&i.update("config.scroll",n,{only:["top","percent.top"]})}else{const e=n.normalizeMouseWheelEvent(t),s=i.get("config.scroll.xMultiplier"),o=i.get("config.scroll.yMultiplier");t.shiftKey&&e.y?i.update("config.scroll.left",t=>n.limitScroll("left",t+=e.y*s)):e.x?i.update("config.scroll.left",t=>n.limitScroll("left",t+=e.x*s)):i.update("config.scroll.top",t=>T=n.limitScroll("top",t+=e.y*o))}},passive:!0,capture:!1};function onScrollStop(t){t.stopPropagation(),t.stopImmediatePropagation(),t.preventDefault()}const I={width:0,height:0};let S;class ResizeAction{constructor(t){S||((S=new Ot((e,n)=>{const s=t.clientWidth,o=t.clientHeight;I.width===s&&I.height===o||(I.width=s,I.height=o,i.update("_internal.dimensions",I))})).observe(t),i.update("_internal.elements.main",t))}update(){}destroy(t){S.unobserve(t)}}v.includes(ResizeAction)||v.push(ResizeAction),s(()=>{S.disconnect()});const D=Object.assign(Object.assign({},e),{api:n,state:i}),E=o.create(v,D),L=o.create([t=>{w||(w=t,i.update("_internal.elements.vertical-scroll",t))}]),R=o.create([t=>{i.update("_internal.elements.vertical-scroll-inner",t)}]);return n=>g(l`
        <div
...
/*! *****************************************************************************
    ...
    ***************************************************************************** */function __awaiter(t,e,n,i){return new(n||(n=Promise))((function(s,o){function fulfilled(t){try{step(i.next(t))}catch(t){o(t)}}function rejected(t){try{step(i.throw(t))}catch(t){o(t)}}function step(t){t.done?s(t.value):new n((function(e){e(t.value)})).then(fulfilled,rejected)}step((i=i.apply(t,e||[])).next())}))}
/**
     * List component
     *
     * @copyright Rafal Pospiech <https://neuronet.io>
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function List(t,e={}){const{api:n,state:i,onDestroy:s,Actions:o,update:r,reuseComponents:a,html:l,schedule:c,StyleMap:d,cache:h}=t,u=n.getActions("list");let p,m,f,g,v;s(i.subscribe("config.wrappers.List",t=>p=t)),s(i.subscribe("config.components.ListColumn",t=>m=t)),function renderIcons(){return __awaiter(this,void 0,void 0,(function*(){const t=i.get("config.list.expander.icons"),e={};for(const i in t){const s=t[i];e[i]=yield n.renderIcon(s)}i.update("_internal.list.expander.icons",e)}))}(),s(i.subscribe("config.list",(function onListChange(){g=i.get("config.list"),v=g.columns.percent,r()}))),s(i.subscribe("config.classNames",()=>{f=n.getClass("list",{list:g}),r()}));let y=[];s(i.subscribe("config.list.columns.data;",(function onListColumnsDataChange(t){a(y,Object.values(t),t=>({columnId:t.id}),m),r()}))),s(()=>{y.forEach(t=>t.destroy())});const b=new d({height:"","--expander-padding-width":"","--expander-size":""});function onScroll(t){t.stopPropagation(),t.preventDefault(),c(()=>{if("scroll"===t.type)i.update("config.scroll.top",t.target.scrollTop);else{const e=n.normalizeMouseWheelEvent(t);i.update("config.scroll.top",t=>n.limitScroll("top",t+=e.y*i.get("config.scroll.yMultiplier")))}})()}let w;function getWidth(t){w||(w=t.clientWidth,0===v&&(w=0),i.update("_internal.list.width",w))}s(i.subscribeAll(["config.height","config.list.expander"],t=>{const e=i.get("config.list.expander");b.style.height=i.get("config.height")+"px",b.style["--expander-padding-width"]=e.padding+"px",b.style["--expander-size"]=e.size+"px",r()}));u.push(class ListAction{constructor(t,e){e.state.update("_internal.elements.list",t),getWidth(t)}update(t){return getWidth(t)}});const _=o.create(u,Object.assign(Object.assign({},e),{api:n,state:i}));return e=>p(h(g.columns.percent>0?l`
              <div class=${f} data-actions=${_} style=${b} @scroll=${onScroll} @wheel=${onScroll}>
                ${y.map(t=>t.html())}
              </div>
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */class BindElementAction{constructor(t,e){let n=!1,i=e.state.get("_internal.elements.list-columns");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("_internal.elements.list-columns",i)}destroy(t,e){e.state.update("_internal.elements.list-columns",e=>e.filter(e=>e!==t))}}function ListColumn(t,e){const{api:n,state:i,onDestroy:s,onChange:o,Actions:r,update:a,createComponent:l,reuseComponents:c,html:d,StyleMap:h}=t;let u,p,m;s(i.subscribe("config.wrappers.ListColumn",t=>u=t)),s(i.subscribe("config.components.ListColumnRow",t=>p=t)),s(i.subscribe("config.components.ListColumnHeader",t=>m=t));const f=Object.assign(Object.assign({},e),{api:n,state:i}),g=n.getActions("list-column"),v=n.getActions("list-column-rows");let y,b,w;const _=new h({width:"","--width":""}),x=new h({width:"",height:""}),$=new h({width:"",height:""});let C,M,P=`config.list.columns.data.${e.columnId}`,O=i.subscribe(P,(function columnChanged(t){C=t,a()}));function calculateStyle(){const t=i.get("config.list"),e=i.get("config.scroll.compensation");w=t.columns.data[C.id].width*t.columns.percent*.01,M=w;const n=i.get("_internal.height");_.style.width=M+"px",_.style["--width"]=M+"px",x.style.height=n+"px",$.style.height=n+Math.abs(e)+"px",$.style.transform=`translate(0px, ${e}px)`}let T=i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${C.id}.width`,"_internal.chart.dimensions.width","_internal.height","config.scroll.compensation","_internal.list.width"],calculateStyle,{bulk:!0});const A=l(m,{columnId:e.columnId});s(A.destroy),o(t=>{e=t;for(const t in e)f[t]=e[t];O&&O(),A.change({columnId:e.columnId}),P=`config.list.columns.data.${e.columnId}`,O=i.subscribe(P,(function columnChanged(t){C=t,a()})),T&&T(),T=i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${C.id}.width`,"_internal.chart.dimensions.width","_internal.height","config.scroll.compensation","_internal.list.width"],calculateStyle,{bulk:!0}),A.change(e)}),s(()=>{O(),T()}),s(i.subscribe("config.classNames",t=>{y=n.getClass("list-column"),b=n.getClass("list-column-rows"),a()}));let I=[];function getRowHtml(t){return t.html()}s(i.subscribe("_internal.list.visibleRows;",t=>{c(I,t,t=>t&&{columnId:e.columnId,rowId:t.id,width:M},p),a()})),s((function rowsDestroy(){I.forEach(t=>t.destroy())})),g.push(BindElementAction);const S=r.create(g,{column:C,state:i,api:n}),D=r.create(v,{api:n,state:i});return n=>u(d`
        <div class=${y} data-actions=${S} style=${_}>
          ${A.html()}
          <div class=${b} style=${x} data-actions=${D}>
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:s,update:o,html:r,schedule:a,Actions:l,PointerAction:c,cache:d,StyleMap:h}=t,u="list-column-header-resizer";let p,m,f=n.getActions(u),g=n.getActions(u+"-dots");s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>p=t)),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{m=t,o()}));let v,y,b,w,_,x=new h({width:""}),$=!1;s(i.subscribe("config.classNames",t=>{v=n.getClass(u,{column:m}),y=n.getClass(u+"-container",{column:m}),b=n.getClass(u+"-dots",{column:m}),w=n.getClass(u+"-dots-dot",{column:m}),o()})),s(i.subscribeAll([`config.list.columns.data.${m.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");_=m.width*n.columns.percent*.01,x.style["--width"]=n.columns.resizer.width+"px",$=n.columns.resizer.inRealTime,i.update("_internal.list.width",_),o()}));let C=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{C=[];for(let e=0;e<t;e++)C.push(e);o()}));let M=_;new h({"--display":"none","--left":M+"px"});const P=`config.list.columns.data.${m.id}.width`,O={column:m,api:n,state:i,pointerOptions:{axis:"x",onMove:a((function onMove({movementX:t}){let e=i.get("config.list.columns.minWidth");"number"==typeof m.minWidth&&(e=m.minWidth),(M+=t)<e&&(M=e),$&&i.update(P,M)}))}};f.push(c);const T=l.create(f,O),A=l.create(g,O);return n=>p(r`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */class BindElementAction$1{constructor(t,e){let n=e.state.get("_internal.elements.list-column-rows"),i=!1;void 0===n&&(i=!0,n=[]),n.includes(t)||(n.push(t),i=!0),i&&e.state.update("_internal.elements.list-column-rows",n)}destroy(t,e){e.state.update("_internal.elements.list-column-rows",e=>e.filter(e=>e!==t))}}function ListColumnRow(t,e){const{api:n,state:i,onDestroy:s,Detach:o,Actions:r,update:a,html:l,createComponent:c,onChange:d,StyleMap:h,unsafeHTML:u,PointerAction:p}=t,m=Object.assign(Object.assign({},e),{api:n,state:i});let f=!1;const g=new o(()=>f);let v,y;s(i.subscribe("config.wrappers.ListColumnRow",t=>v=t)),s(i.subscribe("config.components.ListColumnRowExpander",t=>y=t));let b,w,_=`_internal.flatTreeMapById.${e.rowId}`,x=i.get(_),$=`config.list.columns.data.${e.columnId}`,C=i.get($),M=new h(C.expander?{height:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{height:"",top:"","--height":""},!0);const P=c(y,{row:x});d((t,n)=>{if(n.leave||void 0===t.rowId||void 0===t.columnId)return f=!0,b&&b(),w&&w(),void a();f=!1,e=t;for(const t in e)m[t]=e[t];const s=e.rowId,o=e.columnId;b&&b(),w&&w(),_=`_internal.flatTreeMapById.${s}`,$=`config.list.columns.data.${o}`,b=i.subscribeAll([_,$,"config.list.expander"],t=>{if(C=i.get($),x=i.get(_),void 0===C||void 0===x)return f=!0,void a();if(void 0===C||void 0===x)return;const e=i.get("config.list.expander");M.setStyle({}),M.style.height=x.height+"px",M.style["--height"]=x.height+"px",C.expander&&(M.style["--expander-padding-width"]=e.padding*(x._internal.parents.length+1)+"px");for(let t of x._internal.parents){const e=i.get(`_internal.flatTreeMapById.${t}`);if("object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children){const t=e.style.children;for(const e in t)M.style[e]=t[e]}}if("object"==typeof x.style&&"Object"===x.style.constructor.name&&"object"==typeof x.style.current){const t=x.style.current;for(const e in t)M.style[e]=t[e]}a()},{bulk:!0}),P&&P.change({row:x}),w=i.subscribe($,t=>{C=t,a()})}),s(()=>{P&&P.destroy(),w(),b()});let O,T=n.getActions("list-column-row");s(i.subscribe("config.classNames",t=>{O=n.getClass("list-column-row"),a()})),T.includes(BindElementAction$1)||T.push(BindElementAction$1),m.pointerOptions={axis:"x|y",onMove({event:t,movementX:e,movementY:s}){t.stopPropagation(),t.preventDefault(),e?i.update("config.list.columns.percent",t=>((t+=e*i.get("config.scroll.xMultiplier"))<0&&(t=0),t>100&&(t=100),t)):s&&i.update("config.scroll.top",t=>(t-=s*i.get("config.scroll.yMultiplier"),t=n.limitScroll("top",t)))}},T.push(p);const A=r.create(T,m);return n=>v(l`
        <div detach=${g} class=${O} style=${M} data-actions=${A}>
          ${C.expander?P.html():null}
          <div class=${O+"-content"}>
            ${C.isHTML?function getHtml(){return void 0===x?null:"function"==typeof C.data?u(C.data(x)):u(x[C.data])}():function getText(){return void 0===x?null:"function"==typeof C.data?C.data(x):x[C.data]}()}
          </div>
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ListColumnRowExpander(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,createComponent:l,onChange:c}=t,d=n.getActions("list-column-row-expander"),h=Object.assign(Object.assign({},e),{api:n,state:i});let u,p;s(i.subscribe("config.components.ListColumnRowExpanderToggle",t=>p=t));const m=l(p,e.row?{row:e.row}:{});let f;if(s(m.destroy),s(i.subscribe("config.wrappers.ListColumnRowExpander",t=>f=t)),s(i.subscribe("config.classNames",t=>{u=n.getClass("list-column-row-expander"),r()})),e.row){c((function onPropsChange(t){e=t;for(const t in e)h[t]=e[t];m.change(e)})),s((function listExpanderDestroy(){}))}const g=o.create(d,h);return n=>f(a`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ListToggle(t,e={}){const{html:n,onDestroy:i,api:s,state:o,update:r}=t;let a,l;i(o.subscribe("config.classNames",t=>{a=s.getClass("list-toggle")})),i(o.subscribe("config.wrappers.ListToggle",t=>l=t));let c={open:"",close:""};!function renderIcons(){return __awaiter(this,void 0,void 0,(function*(){const t=o.get("config.list.toggle.icons");for(const e in t){const n=t[e];c[e]=yield s.renderIcon(n)}r()}))}();let d=!0;function toggle(t){o.update("config.list.columns.percent",t=>0===t?100:0)}return i(o.subscribe("config.list.columns.percent",t=>d=0!==t)),i=>l(n`
...
/**
     ...
     */class BindElementAction$2 extends Action{constructor(t,e){super(),e.state.update("_internal.elements.chart-calendar-dates",e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e))}}function ChartCalendarDate(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,onChange:a,html:l,StyleMap:c}=t,d=n.getActions("chart-calendar-date");let h;s(i.subscribe("config.wrappers.ChartCalendarDate",t=>h=t));let u=n.getClass("chart-calendar-date",e),p="";p=n.time.date(e.date.leftGlobal).format("YYYY-MM-DD")===e.currentDate?" current":"";let m,f,g=new c({width:"","margin-left":"",visibility:"visible"}),v=new c({overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"});const y=()=>{if(!e)return;m=i.get("_internal.chart.time"),g.style.width=e.date.width+"px",g.style["margin-left"]=-e.date.subPx+"px",g.style.visibility="visible",v.style={overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"};const t=n.time.date(e.date.leftGlobal);p=t.format("YYYY-MM-DD")===e.currentDate?" current":t.subtract(1,"days").format("YYYY-MM-DD")===e.currentDate?" next":t.add(1,"days").format("YYYY-MM-DD")===e.currentDate?" previous":"";const s=m.maxWidth[e.period];switch(e.period){case"month":f=l`
        ...
        `,s>=40&&s<50)f=l`
          ...
          `}}r()};let b;const w={date:e.date,period:e.period,api:n,state:i};a((t,n)=>{if(n.leave)return g.style.visibility="hidden",r();e=t,w.date=e.date,w.period=e.period,b&&b(),b=i.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],y,{bulk:!0})}),s(()=>{b()}),d.includes(BindElementAction$2)||d.push(BindElementAction$2);const _=o.create(d,w);return n=>h(l`
        <div
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ChartTimeline(t,e){const{api:n,state:i,onDestroy:s,Action:o,Actions:r,update:a,html:l,createComponent:c,StyleMap:d}=t,h=n.getActions("chart-timeline"),u=Object.assign(Object.assign({},e),{api:n,state:i});let p;s(i.subscribe("config.wrappers.ChartTimeline",t=>p=t));const m=i.get("config.components.ChartTimelineGrid"),f=i.get("config.components.ChartTimelineItems"),g=i.get("config.components.ListToggle"),v=c(m);s(v.destroy);const y=c(f);s(y.destroy);const b=c(g);let w,_,x;s(b.destroy),s(i.subscribe("config.classNames",()=>{w=n.getClass("chart-timeline"),_=n.getClass("chart-timeline-inner"),a()})),s(i.subscribe("config.list.toggle.display",t=>x=t));let $=new d({}),C=new d({});s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","_internal.list.rowsHeight","config.scroll.compensation","_internal.chart.time.dates.day"],(function calculateStyle(){const t=n.getCompensationX(),e=n.getCompensationY(),s=i.get("_internal.chart.dimensions.width"),o=i.get("_internal.list.rowsHeight");$.style.height=i.get("_internal.height")+"px",$.style["--negative-compensation-x"]=t+"px",$.style["--compensation-x"]=Math.round(Math.abs(t))+"px",$.style["--negative-compensation-y"]=e+"px",$.style["--compensation-y"]=Math.abs(e)+"px",$.style.width=s?s+"px":"0px",C.style.height=o+"px",C.style.width=s?s+t+"px":"0px",C.style.transform=`translate(-${t}px, ${e}px)`,a()}))),h.push(class BindElementAction extends o{constructor(t){super(),i.get("_internal.elements.chart-timeline")!==t&&i.update("_internal.elements.chart-timeline",t)}});const M=r.create(h,u);return i=>p(l`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ChartTimelineItems(t,e={}){const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,reuseComponents:l,StyleMap:c}=t,d=n.getActions("chart-timeline-items");let h;s(i.subscribe("config.wrappers.ChartTimelineItems",t=>h=t));const u=i.get("config.components.ChartTimelineItemsRow");let p;s(i.subscribe("config.classNames",()=>{p=n.getClass("chart-timeline-items"),r()}));let m=new c({},!0);s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","config.scroll.compensation","_internal.chart.time.dates.day"],(function calculateStyle(){const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height"),s=n.getCompensationY(),o=n.getCompensationX();m.style.width=t+o+"px",m.style.height=e+Math.abs(s)+"px"})));let f=[];s(i.subscribeAll(["_internal.list.visibleRows;","config.chart.items"],(function createRowComponents(){const t=i.get("_internal.list.visibleRows");l(f,t||[],t=>({row:t}),u),r()}))),s((function destroyRows(){f.forEach(t=>t.destroy())}));const g=o.create(d,{api:n,state:i});return n=>h(a`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */class BindElementAction$6{constructor(t,e){let n=!1,i=e.state.get("_internal.elements.chart-timeline-items-rows");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("_internal.elements.chart-timeline-items-rows",i,{only:null})}destroy(t,e){e.state.update("_internal.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}const At=(t,e)=>{const{api:n,state:i,onDestroy:s,Detach:o,Actions:r,update:a,html:l,onChange:c,reuseComponents:d,StyleMap:h}=t,u=Object.assign(Object.assign({},e),{api:n,state:i});let p;s(i.subscribe("config.wrappers.ChartTimelineItemsRow",t=>p=t));const m=i.get("config.components.ChartTimelineItemsRowItem");let f,g,v=`_internal.flatTreeMapById.${e.row.id}._internal.items`,y=new h({width:"",height:""},!0),b=[],w=!1;const _=new o(()=>w),x=()=>{const t=i.get("_internal.chart");w=!1;const s=n.getCompensationX();y.style.width=t.dimensions.width+s+"px",e?(y.style.height=e.row.height+"px",y.style["--row-height"]=e.row.height+"px"):w=!0};c((t,n)=>{if(n.leave||void 0===t.row)return w=!0,a();e=t;for(const t in e)u[t]=e[t];(t=>{v=`_internal.flatTreeMapById.${t.id}._internal.items`,"function"==typeof f&&f(),"function"==typeof g&&g(),f=i.subscribe("_internal.chart",t=>{if(void 0===t)return w=!0,a();x(),a()}),g=i.subscribe(v,e=>{if(void 0===e)return w=!0,d(b,[],e=>({row:t,item:e}),m),a();d(b,e,e=>({row:t,item:e}),m),x(),a()})})(e.row)}),s(()=>{g(),f(),b.forEach(t=>t.destroy())});const $=n.getActions("chart-timeline-items-row");let C;s(i.subscribe("config.classNames",()=>{C=n.getClass("chart-timeline-items-row",e),a()})),$.includes(BindElementAction$6)||$.push(BindElementAction$6);const M=r.create($,u);return n=>p(l`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */class BindElementAction$7{constructor(t,e){let n=!1,i=e.state.get("_internal.elements.chart-timeline-items-row-items");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("_internal.elements.chart-timeline-items-row-items",i,{only:null})}destroy(t,e){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}}function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,Detach:o,Actions:r,update:a,html:l,onChange:c,unsafeHTML:d,StyleMap:h}=t;let u;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>u=t));let p=new h({width:"",height:"",left:""}),m=0,f=0,g=!1;const v={item:e.item,row:e.row,left:m,width:f,api:n,state:i};let y=!1;function updateItem(){var t,s,o,r,l,c,d,h,u,v,b;if(g)return;let w=i.get("_internal.chart.time");m=(e.item.time.start-w.leftGlobal)/w.timePerPixel,m=.1*Math.round(10*m),f=(e.item.time.end-e.item.time.start)/w.timePerPixel,(f-=i.get("config.chart.spacing")||0)&&(f=.1*Math.round(10*f));const _=p.style.width,x=p.style.left,$=n.getCompensationX();p.setStyle({});const C=n.isItemInViewport(e.item,w.leftGlobal,w.rightGlobal);y=!C,C?(p.style.width=f+"px",p.style.left=m+$+"px"):(p.style.width=_,p.style.left=x);const M=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(r=null===(o=null===(s=null===(t=M[n])||void 0===t?void 0:t.style)||void 0===s?void 0:s.items)||void 0===o?void 0:o.item)||void 0===r?void 0:r.children;e&&p.setStyle(Object.assign(Object.assign({},p.style),e))}const P=null===(u=null===(h=null===(d=null===(c=null===(l=e)||void 0===l?void 0:l.row)||void 0===c?void 0:c.style)||void 0===d?void 0:d.items)||void 0===h?void 0:h.item)||void 0===u?void 0:u.current;P&&p.setStyle(Object.assign(Object.assign({},p.style),P));const O=null===(b=null===(v=e)||void 0===v?void 0:v.item)||void 0===b?void 0:b.style;O&&p.setStyle(Object.assign(Object.assign({},p.style),O)),a()}c((function onPropsChange(t,n){if(n.leave||void 0===t.row||void 0===t.item)return g=!0,y=!0,a();y=!1,g=!1,e=t,v.item=e.item,v.row=e.row,v.left=m,v.width=f,updateItem()}));const b="chart-timeline-items-row-item",w=n.getActions(b);let _,x;s(i.subscribe("config.classNames",()=>{_=n.getClass(b,e),x=n.getClass(b+"-label",e),a()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()})),w.push(BindElementAction$7);const $=r.create(w,v),C=new o(()=>y);return n=>u(l`
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */const Nt="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const Yt={name:Nt,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,date:t=>t?St(t):St(),dayjs:St};
/**
     * Gantt-Schedule-Timeline-Calendar
     *
     * @copyright Rafal Pospiech <https://neuronet.io>
