...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const I=(t,...e)=>new TemplateResult(t,e,"html",P),A=(t,...e)=>new SVGTemplateResult(t,e,"svg",P);
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ListExpander(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,createComponent:l,onChange:c}=t,d=n.getActions("list-expander"),h=Object.assign(Object.assign({},e),{api:n,state:i});let u,p;s(i.subscribe("config.components.ListToggle",t=>p=t));const m=l(p,e.row?{row:e.row}:{});let f;if(s(m.destroy),s(i.subscribe("config.wrappers.ListExpander",t=>f=t)),s(i.subscribe("config.classNames",t=>{u=n.getClass("list-expander"),r()})),e.row){c((function onPropsChange(t){e=t;for(const t in e)h[t]=e[t];m.change(e)})),s((function listExpanderDestroy(){}))}const g=o.create(d,h);return n=>f(a`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ChartTimeline(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,createComponent:l,StyleMap:c}=t,d=n.getActions("chart-timeline"),h=Object.assign(Object.assign({},e),{api:n,state:i});let u;s(i.subscribe("config.wrappers.ChartTimeline",t=>u=t));const p=i.get("config.components.ChartTimelineGrid"),m=i.get("config.components.ChartTimelineItems"),f=l(p);s(f.destroy);const g=l(m);let v,y;s(g.destroy),s(i.subscribe("config.classNames",()=>{v=n.getClass("chart-timeline"),y=n.getClass("chart-timeline-inner"),r()}));let b=new c({}),w=new c({});s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","_internal.list.rowsHeight","config.scroll.compensation","_internal.chart.time.dates.day"],(function calculateStyle(){const t=n.getCompensationX(),e=n.getCompensationY(),s=i.get("_internal.chart.dimensions.width"),o=i.get("_internal.list.rowsHeight");b.style.height=i.get("_internal.height")+"px",b.style.width=s?s+"px":"0px",w.style.height=o+"px",w.style.width=s?s+t+"px":"0px",w.style.transform=`translate(-${t}px, ${e}px)`,r()}))),d.push(t=>{i.update("_internal.elements.chart-timeline",t)});const _=o.create(d,h);return i=>u(a`
