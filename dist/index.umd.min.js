...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */const vt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),t=>{e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>e.filter(e=>e!==t),{only:[""]})}),bt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l}=t,c=n.getActions("chart-timeline-grid-row-block");let d;s(i.subscribe("config.wrappers.ChartTimelineGridRowBlock",t=>{d=t,r()}));const u=n.time.date().startOf("day").valueOf();let h,p;const f=t=>{h=n.getClass("chart-timeline-grid-row-block"),p=h+"-content",t.leftGlobal===u&&(h+=" current")};f(e.time);let m=`width: ${e.time.width}px;height: ${e.row.height}px;`;return l((t,n)=>{if(n.leave)return m="visibility: hidden;",r();f((e=t).time),m=`width: ${e.time.width}px; height: ${e.row.height}px;`;const s=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=s[t];"object"==typeof e.style&&"object"==typeof e.style.gridBlock&&"string"==typeof e.style.gridBlock.children&&(m+=e.style.gridBlock.children)}"object"==typeof e.row.style&&"object"==typeof e.row.style.gridBlock&&"string"==typeof e.row.style.gridBlock.current&&(m+=e.row.style.gridBlock.current),r()}),-1===c.indexOf(vt)&&c.push(vt),s=>d(a`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */const yt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-rows",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}),wt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,reuseComponents:c,styleMap:d}=t;let u;s(i.subscribe("config.wrappers.ChartTimelineItemsRow",t=>u=t));const h=i.get("config.components.ChartTimelineItemsRowItem");let p,f,m=`_internal.flatTreeMapById.${e.row.id}._internal.items`,g={visibility:"",width:"",height:"",overflow:"hidden"},v={width:"",height:"",overflow:"hidden"},b=[];function updateDom(){if(!e)return void(g.visibility="hidden");const t=i.get("_internal.chart");g.visibility="visible",g.width=t.dimensions.width+"px",g.height=e.row.height+"px",g["--row-height"]=e.row.height+"px",v.width=t.time.totalViewDurationPx+"px",v.height=e.row.height+"px"}l((t,n)=>{if(n.leave)return g.visibility="hidden",r();((t,e)=>{if(e.leave)return updateDom(),r();m=`_internal.flatTreeMapById.${t.id}._internal.items`,"function"==typeof p&&p(),"function"==typeof f&&f(),p=i.subscribe("_internal.chart",(t,e)=>{updateDom(),r()}),f=i.subscribe(m,e=>{b=c(b,e,e=>({row:t,item:e}),h),updateDom(),r()})})((e=t).row,n)}),s(()=>{f(),p(),b.forEach(t=>t.destroy())});const y=n.getActions("chart-timeline-items-row");let w,_;return s(i.subscribe("config.classNames",()=>{w=n.getClass("chart-timeline-items-row",e),_=n.getClass("chart-timeline-items-row-inner",e),r()})),y.includes(yt)||y.push(yt),s=>u(a`
        <div
          class=${w}
...
/**
     ...
     * @license   GPL-3.0
     */
const Dt="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const It={name:Dt,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,date:t=>t?Ct(t):Ct(),dayjs:Ct};
/**
     * Gantt-Schedule-Timeline-Calendar
     *
     * @copyright Rafal Pospiech <https://neuronet.io>
