...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */const $t="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let s of n[e])isObject$1(s)?t[e].push(mergeDeep$1({},s)):t[e].push(s)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const xt={name:$t,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),s=mergeDeep$1({},t.actions);let i=[...Object.keys(n),...Object.keys(s)];i=i.filter(t=>i.includes(t));const o={};for(const t of i)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==s[t]&&Array.isArray(s[t])&&(o[t]=[...o[t],...s[t]]);return delete t.actions,delete e.actions,o}(t,e),s={config:mergeDeep$1({},e,t)};return s.config.actions=n,new DeepState(s,{delimeter:"."})},mergeDeep:mergeDeep$1,date:t=>t?bt(t):bt(),dayjs:bt};
/**
     * Gantt-Schedule-Timeline-Calendar
     *
     * @copyright Rafal Pospiech <https://neuronet.io>
