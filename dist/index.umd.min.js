...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */class DefaultTemplateProcessor{handleAttributeExpressions(t,e,n,i,s){const o=e[0];if("."===o){return new PropertyCommitter(t,e.slice(1),n,s).parts}return"@"===o?[new EventPart(t,e.slice(1),i.eventContext)]:"?"===o?[new BooleanAttributePart(t,e.slice(1),n)]:new AttributeCommitter(t,e,n,s).parts}handleTextExpression(t,e){return new NodePart(t,e)}}const f=new DefaultTemplateProcessor;
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */class BindElementAction{constructor(t,e){let n=!1,i=e.state.get("_internal.elements.list-columns");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("_internal.elements.list-columns",i)}destroy(t,e){e.state.update("_internal.elements.list-columns",e=>e.filter(e=>e!==t))}}function ListColumn(t,e){const{api:n,state:i,onDestroy:s,onChange:o,Actions:r,update:a,createComponent:l,reuseComponents:c,html:d,StyleMap:h}=t;let u;s(i.subscribe("config.wrappers.ListColumn",t=>u=t));const p=[];let m,f;p.push(i.subscribe("config.components.ListColumnRow",t=>m=t)),p.push(i.subscribe("config.components.ListColumnHeader",t=>f=t));const g=Object.assign(Object.assign({},e),{api:n,state:i}),v=n.getActions("list-column"),y=n.getActions("list-column-rows");let b,w,_;const x=new h({width:"","--width":""}),$=new h({width:"",height:""}),C=new h({width:"",height:""});let M,P,T=`config.list.columns.data.${e.columnId}`,O=i.subscribe(T,(function columnChanged(t){M=t,a()}));function calculateStyle(){const t=i.get("config.list"),e=i.get("config.scroll.compensation.y");_=t.columns.data[M.id].width*t.columns.percent*.01,P=_;const n=i.get("_internal.height");x.style.width=P+"px",x.style["--width"]=P+"px",$.style.height=n+"px",C.style.height=n+Math.abs(e)+"px",C.style.transform=`translate(0px, ${e}px)`}let A=i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${M.id}.width`,"_internal.chart.dimensions.width","_internal.height","config.scroll.compensation.y","_internal.list.width"],calculateStyle,{bulk:!0});const S=l(f,{columnId:e.columnId});s(S.destroy),o(t=>{e=t;for(const t in e)g[t]=e[t];O&&O(),S.change({columnId:e.columnId}),T=`config.list.columns.data.${e.columnId}`,O=i.subscribe(T,(function columnChanged(t){M=t,a()})),A&&A(),A=i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${M.id}.width`,"_internal.chart.dimensions.width","_internal.height","config.scroll.compensation.y","_internal.list.width"],calculateStyle,{bulk:!0}),S.change(e)}),s(()=>{O(),A()}),s(i.subscribe("config.classNames",t=>{b=n.getClass("list-column"),w=n.getClass("list-column-rows"),a()}));const I=[];function getRowHtml(t){return t.html()}s(i.subscribe("_internal.list.visibleRows;",t=>{const n=c(I,t,t=>t&&{columnId:e.columnId,rowId:t.id,width:P},m);return a(),n})),s(()=>{I.forEach(t=>t.destroy()),p.forEach(t=>t())}),v.push(BindElementAction);const D=r.create(v,{column:M,state:i,api:n}),E=r.create(y,{api:n,state:i});return n=>u(d`<div class=${b} data-actions=${D} style=${x}>${S.html()}<div class=${w} style=${$} data-actions=${E}><div class=${w+"--scroll-compensation"} style=${C}>${I.map(getRowHtml)}</div></div></div>`,{vido:t,props:e,templateProps:n})}
/**
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ListColumnRowExpander(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,createComponent:l,onChange:c}=t,d=n.getActions("list-column-row-expander"),h=Object.assign(Object.assign({},e),{api:n,state:i});let u,p;const m=i.subscribe("config.components.ListColumnRowExpanderToggle",t=>p=t),f=l(p,e.row?{row:e.row}:{});let g;if(s(()=>{f.destroy(),m()}),s(i.subscribe("config.wrappers.ListColumnRowExpander",t=>g=t)),s(i.subscribe("config.classNames",t=>{u=n.getClass("list-column-row-expander"),r()})),e.row){c((function onPropsChange(t){e=t;for(const t in e)h[t]=e[t];f.change(e)}))}const v=o.create(d,h);return n=>g(a`<div class=${u} data-action=${v}>${f.html()}</div>`,{vido:t,props:e,templateProps:n})}
/**
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ChartCalendar(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,reuseComponents:a,html:l,StyleMap:c}=t,d=n.getActions("chart-calendar"),h=Object.assign(Object.assign({},e),{api:n,state:i}),u=i.get("config.components.ChartCalendarDate");let p,m,f;s(i.subscribe("config.wrappers.ChartCalendar",t=>p=t)),s(i.subscribe("config.classNames",t=>{m=n.getClass("chart-calendar"),r()}));const g=new c({height:"","--headerHeight":""});s(i.subscribe("config.headerHeight",t=>{f=t,g.style.height=f+"px",g.style["--calendar-height"]=f+"px",r()}));const v=[],y=[];s(i.subscribe("_internal.chart.time.dates",t=>{const e=n.time.date().format("YYYY-MM-DD");"object"==typeof t.day&&Array.isArray(t.day)&&t.day.length&&a(v,t.day,t=>t&&{period:"day",date:t,currentDate:e},u),"object"==typeof t.month&&Array.isArray(t.month)&&t.month.length&&a(y,t.month,t=>t&&{period:"month",date:t,currentDate:e},u),r()})),s(()=>{v.forEach(t=>t.destroy()),y.forEach(t=>t.destroy())}),d.push(t=>{i.update("_internal.elements.chart-calendar",t)});const b=o.create(d,h);return n=>p(l`<div class=${m} data-actions=${b} style=${g}><div class=${m+"-dates "+m+"-dates--months"}>${y.map(t=>t.html())}</div><div class=${m+"-dates "+m+"-dates--days"}>${v.map(t=>t.html())}</div></div>`,{props:e,vido:t,templateProps:n})}class Action$1{constructor(){this.isAction=!0}}Action$1.prototype.isAction=!0;
/**
     ...
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */
class BindElementAction$2 extends Action$1{constructor(t,e){super(),e.state.update("_internal.elements.chart-calendar-dates",e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e))}}function ChartCalendarDate(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,onChange:a,html:l,StyleMap:c,Detach:d}=t,h=n.getActions("chart-calendar-date");let u,p;s(i.subscribe("config.wrappers.ChartCalendarDate",t=>u=t)),s(i.subscribe("config.classNames",()=>{p=n.getClass("chart-calendar-date",e)}));let m,f,g="";g=n.time.date(e.date.leftGlobal).format("YYYY-MM-DD")===e.currentDate?" current":"";const v=new c({width:"","margin-left":"",visibility:"visible"}),y=new c({overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"}),updateDate=()=>{if(!e)return;m=i.get("_internal.chart.time"),v.style.width=e.date.width+"px",v.style["margin-left"]=-e.date.subPx+"px",v.style.visibility="visible",y.style={overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"};const t=n.time.date(e.date.leftGlobal);g=t.format("YYYY-MM-DD")===e.currentDate?" current":t.subtract(1,"days").format("YYYY-MM-DD")===e.currentDate?" next":t.add(1,"days").format("YYYY-MM-DD")===e.currentDate?" previous":"";const s=m.maxWidth[e.period];switch(e.period){case"month":f=l`<div class=${p+"-content "+p+"-content--month"+g} style=${y}>${t.format("MMMM YYYY")}</div>`,s<=100&&(f=l`<div class=${p+"-content "+p+"-content--month"+g}>${t.format("MMM'YY")}</div>`);break;case"day":if(f=l`<div class=${p+"-content "+p+"-content--day _0"+g}><div class=${p+"-content "+p+"-content--day-small"+g}>${t.format("DD")} ${t.format("ddd")}</div></div>`,s>=40&&s<50)f=l`<div class=${p+"-content "+p+"-content--day _40"+g}>${t.format("DD")}</div><div class=${p+"-content "+p+"-content--day-word"+g}>${t.format("dd")}</div>`;else if(s>=50&&s<90)f=l`<div class=${p+"-content "+p+"-content--day _50"+g}>${t.format("DD")}</div><div class=${p+"-content "+p+"-content--day-word"+g}>${t.format("ddd")}</div>`;else if(s>=90&&s<180)f=l`<div class=${p+"-content "+p+"-content--day _90"+g}>${t.format("DD")}</div><div class=${p+"-content "+p+"-content--day-word"+g}>${t.format("dddd")}</div>`;else if(s>=180&&s<400){const e=[],n=t.startOf("day");for(let t=0;t<12;t++){const i=n.add(2*t,"hours"),s=(n.add(2*t+1,"hours").endOf("hour").valueOf()-i.valueOf())/m.timePerPixel;e.push({width:s,formatted:i.format("HH")})}f=l`<div class=${p+"-content "+p+"-content--day _180"+g}>${t.format("DD dddd")}</div><div class=${p+"-content "+p+"-content--hours"+g}>${e.map(t=>l`<div class=${p+"-content "+p+"-content--hours-hour"+g} style=width:${t.width}>${t.formatted}</div>`)}</div>`}else if(s>=400&&s<1e3){const e=[],n=t.startOf("day");for(let t=0;t<24;t++){const i=n.add(t,"hours"),s=(n.add(t,"hours").endOf("hour").valueOf()-i.valueOf())/m.timePerPixel;e.push({width:s,formatted:i.format("HH")})}f=l`<div class=${p+"-content "+p+"-content--day _400"+g}>${t.format("DD dddd")}</div><div class=${p+"-content "+p+"-content--hours"+g}>${e.map(t=>l`<div class=${p+"-content "+p+"-content--hours-hour"+g} style=width:${t.width}>${t.formatted}</div>`)}</div>`}else if(s>=1e3&&s<2e3){const e=[],n=t.startOf("day");for(let t=0;t<24;t++){const i=n.add(t,"hours"),s=(n.add(t,"hours").endOf("hour").valueOf()-i.valueOf())/m.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}f=l`<div class=${p+"-content "+p+"-content--day _1000"+g} style=${y}>${t.format("DD dddd")}</div><div class=${p+"-content "+p+"-content--hours"+g}>${e.map(t=>l`<div class=${p+"-content "+p+"-content--hours-hour"+g} style=width:${t.width}>${t.formatted}</div>`)}</div>`}else if(s>=2e3&&s<5e3){const e=[],n=t.startOf("day");for(let t=0;t<48;t++){const i=n.add(30*t,"minutes"),s=(n.add(30*(t+1),"minutes").valueOf()-i.valueOf())/m.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}f=l`<div class=${p+"-content "+p+"-content--day _2000"+g} style=${y}>${t.format("DD dddd")}</div><div class=${p+"-content "+p+"-content--hours"+g}>${e.map(t=>l`<div class=${p+"-content "+p+"-content--hours-hour"+g} style=width:${t.width}>${t.formatted}</div>`)}</div>`}else if(s>=5e3&&s<2e4){const e=[],n=t.startOf("day");for(let t=0;t<96;t++){const i=n.add(15*t,"minutes"),s=(n.add(15*(t+1),"minutes").valueOf()-i.valueOf())/m.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}f=l`<div class=${p+"-content "+p+"-content--day _5000"+g} style=${y}>${t.format("DD dddd")}</div><div class=${p+"-content "+p+"-content--hours"+g}>${e.map(t=>l`<div class=${p+"-content "+p+"-content--hours-hour"+g} style=width:${t.width}>${t.formatted}</div>`)}</div>`}else if(s>=2e4){const e=[],n=t.startOf("day");for(let t=0;t<288;t++){const i=n.add(5*t,"minutes"),s=(n.add(5*(t+1),"minutes").valueOf()-i.valueOf())/m.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}f=l`<div class=${p+"-content "+p+"-content--day _20000"+g} style=${y}>${t.format("DD dddd")}</div><div class=${p+"-content "+p+"-content--hours"+g}>${e.map(t=>l`<div class=${p+"-content "+p+"-content--hours-hour"+g} style=width:${t.width}>${t.formatted}</div>`)}</div>`}}r()};let b=!1;const w=new d(()=>b);let _;const x={date:e.date,period:e.period,api:n,state:i};a((t,n)=>{if(n.leave)return b=!0,r();b=!1,e=t,x.date=e.date,x.period=e.period,_&&_(),_=i.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],updateDate,{bulk:!0})}),s(()=>{_()}),h.includes(BindElementAction$2)||h.push(BindElementAction$2);const $=o.create(h,x);return n=>u(l`<div detach=${w} class=${p+" "+p+"--"+e.period+g} style=${v} data-actions=${$}>${f}</div>`,{props:e,vido:t,templateProps:n})}
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ChartTimeline(t,e){const{api:n,state:i,onDestroy:s,Action:o,Actions:r,update:a,html:l,createComponent:c,StyleMap:d}=t,h=n.getActions("chart-timeline"),u=Object.assign(Object.assign({},e),{api:n,state:i});let p;s(i.subscribe("config.wrappers.ChartTimeline",t=>p=t));const m=i.get("config.components.ChartTimelineGrid"),f=i.get("config.components.ChartTimelineItems"),g=i.get("config.components.ListToggle"),v=c(m);s(v.destroy);const y=c(f);s(y.destroy);const b=c(g);let w,_,x;s(b.destroy),s(i.subscribe("config.classNames",()=>{w=n.getClass("chart-timeline"),_=n.getClass("chart-timeline-inner"),a()})),s(i.subscribe("config.list.toggle.display",t=>x=t));const $=new d({}),C=new d({});s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","_internal.list.rowsHeight","config.scroll.compensation","_internal.chart.time.dates.day"],(function calculateStyle(){const t=n.getCompensationX(),e=n.getCompensationY(),s=i.get("_internal.chart.dimensions.width"),o=i.get("_internal.list.rowsHeight");$.style.height=i.get("_internal.height")+"px",$.style["--height"]=$.style.height,$.style["--negative-compensation-x"]=t+"px",$.style["--compensation-x"]=Math.round(Math.abs(t))+"px",$.style["--negative-compensation-y"]=e+"px",$.style["--compensation-y"]=Math.abs(e)+"px",s?($.style.width=s+"px",$.style["--width"]=s+"px"):($.style.width="0px",$.style["--width"]="0px"),C.style.height=o+"px",C.style.width=s?s+t+"px":"0px",C.style.transform=`translate(-${t}px, ${e}px)`,a()}))),h.push(class BindElementAction extends o{constructor(t){super(),i.get("_internal.elements.chart-timeline")!==t&&i.update("_internal.elements.chart-timeline",t)}});const M=r.create(h,u);return i=>p(l`<div class=${w} style=${$} data-actions=${M} @wheel=${n.onScroll}><div class=${_} style=${C}>${v.html()}${y.html()}${x?b.html():""}</div></div>`,{props:e,vido:t,templateProps:i})}
/**
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ChartTimelineItems(t,e={}){const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,reuseComponents:l,StyleMap:c}=t,d=n.getActions("chart-timeline-items");let h,u,p;s(i.subscribe("config.wrappers.ChartTimelineItems",t=>h=t)),s(i.subscribe("config.components.ChartTimelineItemsRow",t=>u=t)),s(i.subscribe("config.classNames",()=>{p=n.getClass("chart-timeline-items"),r()}));const m=new c({},!0);s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","config.scroll.compensation","_internal.chart.time.dates.day"],(function calculateStyle(){const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height"),s=n.getCompensationY(),o=n.getCompensationX();m.style.width=t+o+"px",m.style.height=e+Math.abs(s)+"px"})));const f=[];s(i.subscribeAll(["_internal.list.visibleRows;","config.chart.items"],(function createRowComponents(){const t=i.get("_internal.list.visibleRows");l(f,t||[],t=>({row:t}),u),r()}))),s(()=>{f.forEach(t=>t.destroy())});const g=o.create(d,{api:n,state:i});return n=>h(a`<div class=${p} style=${m} data-actions=${g}>${f.map(t=>t.html())}</div>`,{props:e,vido:t,templateProps:n})}
/**
