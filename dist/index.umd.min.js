...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const I=(t,...e)=>new TemplateResult(t,e,"html",P),T=(t,...e)=>new SVGTemplateResult(t,e,"svg",P);
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     */function List(t,e={}){const{api:n,state:i,onDestroy:s,Actions:o,update:r,reuseComponents:a,html:l,schedule:c,StyleMap:d,cache:h}=t,u=n.getActions("list");let p,f,m,g,v;s(i.subscribe("config.wrappers.List",t=>p=t)),s(i.subscribe("config.components.ListColumn",t=>f=t)),s(i.subscribe("config.list",(function onListChange(){g=i.get("config.list"),v=g.columns.percent,r()}))),s(i.subscribe("config.classNames",()=>{m=n.getClass("list",{list:g}),r()}));let y=[];s(i.subscribe("config.list.columns.data;",(function onListColumnsDataChange(t){a(y,Object.values(t),t=>({columnId:t.id}),f),r()}))),s(()=>{y.forEach(t=>t.destroy())});const b=new d({height:"","--expander-padding-width":"","--expander-size":""});s(i.subscribeAll(["config.height","config.list.expander"],t=>{const e=i.get("config.list.expander");b.style.height=i.get("config.height")+"px",b.style["--expander-padding-width"]=e.padding+"px",b.style["--expander-size"]=e.size+"px",r()}));const w={handleEvent:c((function onScrollHandler(t){if(t.stopPropagation(),t.preventDefault(),"scroll"===t.type)i.update("config.scroll.top",t.target.scrollTop);else{const e=n.normalizeMouseWheelEvent(t);i.update("config.scroll.top",t=>n.limitScroll("top",t+=e.y*i.get("config.scroll.yMultiplier")))}})),passive:!1};let _;function getWidth(t){_||(_=t.clientWidth,0===v&&(_=0),i.update("_internal.list.width",_))}u.push(class ListAction{constructor(t){i.update("_internal.elements.list",t),getWidth(t)}update(t){return getWidth(t)}});const x=o.create(u,Object.assign(Object.assign({},e),{api:n,state:i}));return e=>p(h(g.columns.percent>0?l`
              <div class=${m} data-actions=${x} style=${b} @scroll=${w} @wheel=${w}>
                ${y.map(t=>t.html())}
              </div>
...
/**
     ...
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */
function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,Detach:o,Action:r,Actions:a,update:l,html:c,onChange:d,unsafeHTML:h,StyleMap:u}=t;let p;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>p=t));let f=new u({width:"",height:"",left:""}),m=0,g=0,v=!1;const y={item:e.item,row:e.row,left:m,width:g,api:n,state:i};let b=!1;function updateItem(){var t,s,o,r,a,c,d,h;if(v)return;let u=i.get("_internal.chart.time");m=(e.item.time.start-u.leftGlobal)/u.timePerPixel,m=.1*Math.round(10*m),g=(e.item.time.end-e.item.time.start)/u.timePerPixel,(g-=i.get("config.chart.spacing")||0)&&(g=.1*Math.round(10*g));const p=f.style.width,y=f.style.left,w=n.getCompensationX();f.setStyle({});const _=n.isItemInViewport(e.item,u.leftGlobal,u.rightGlobal);b=!_,_?(f.style.width=g+"px",f.style.left=m+w+"px"):(f.style.width=p,f.style.left=y);const x=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(o=null===(s=null===(t=x[n].style)||void 0===t?void 0:t.items)||void 0===s?void 0:s.item)||void 0===o?void 0:o.children;e&&f.setStyle(Object.assign(Object.assign({},f.style),e))}const $=null===(d=null===(c=null===(a=null===(r=e.row)||void 0===r?void 0:r.style)||void 0===a?void 0:a.items)||void 0===c?void 0:c.item)||void 0===d?void 0:d.current;$&&f.setStyle(Object.assign(Object.assign({},f.style),$));const C=null===(h=e.item)||void 0===h?void 0:h.style;C&&f.setStyle(Object.assign(Object.assign({},f.style),C)),l()}d((function onPropsChange(t,n){if(n.leave)return v=!0,b=!0,l();b=!1,v=!1,e=t,y.item=e.item,y.row=e.row,y.left=m,y.width=g,updateItem()}));const w="chart-timeline-items-row-item",_=n.getActions(w);let x,$;s(i.subscribe("config.classNames",()=>{x=n.getClass(w,e),$=n.getClass(w+"-label",e),l()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()}));_.push(class BindElementAction extends r{constructor(t,e){super(),e.state.update("_internal.elements.chart-timeline-items-row-items",(function updateRowItems(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null})}destroy(t,e){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}});const C=a.create(_,y),M=new o(()=>b);return n=>p(c`
        <div detach=${M} class=${x} data-actions=${C} style=${f}>
          <div class=${$}>
