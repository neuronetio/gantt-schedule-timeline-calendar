...
/**
     ...
     */const directive=t=>(...e)=>{const n=t(...e);return n.isDirective=!0,n};class Directive{constructor(){this.isDirective=!0,this.isClass=!0}body(t){}runPart(t){return this.body(t)}}const isDirective=t=>null!=t&&"boolean"==typeof t.isDirective,t=null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,reparentNodes=(t,e,n=null,i=null)=>{for(;e!==n;){const n=e.nextSibling;t.insertBefore(e,i),e=n}},removeNodes=(t,e,n=null)=>{for(;e!==n;){const n=e.nextSibling;t.removeChild(e),e=n}},e={},n={},i=`{{lit-${String(Math.random()).slice(2)}}}`,s=`\x3c!--${i}--\x3e`,o=new RegExp(`${i}|${s}`),r="$lit$";
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */let c;const d=` ${i} `,h=document.createElement("template");class TemplateResult{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let o=0;o<t;o++){const t=this.strings[o],a=t.lastIndexOf("\x3c!--");n=(a>-1||n)&&-1===t.indexOf("--\x3e",a+1);const c=l.exec(t);e+=null===c?t+(n?d:s):t.substr(0,c.index)+c[1]+c[2]+r+c[3]+i}return e+=this.strings[t],e}getTemplateElement(){const t=h.cloneNode();return t.innerHTML=function convertConstantTemplateStringToTrustedHTML(t){const e=window,n=e.trustedTypes||e.TrustedTypes;return n&&!c&&(c=n.createPolicy("lit-html",{createHTML:t=>t})),c?c.createHTML(t):t}(this.getHTML()),t}}class SVGTemplateResult extends TemplateResult{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,n=e.firstChild;return e.removeChild(n),reparentNodes(e,n.firstChild),t}}
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */function templateFactory(t){let e=g.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},g.set(t.type,e));let n=e.stringsArray.get(t.strings);if(void 0!==n)return n;const s=t.strings.join(i);return n=e.keyString.get(s),void 0===n&&(n=new Template(t,t.getTemplateElement()),e.keyString.set(s,n)),e.stringsArray.set(t.strings,n),n}const g=new Map,v=new WeakMap,render=(t,e,n)=>{let i=v.get(e);void 0===i&&(removeNodes(e,e.firstChild),v.set(e,i=new NodePart(Object.assign({templateFactory:templateFactory},n),void 0)),i.appendInto(e)),i.setValue(t),i.commit()};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.3");const html=(t,...e)=>new TemplateResult(t,e,"html",f),svg=(t,...e)=>new SVGTemplateResult(t,e,"svg",f);
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */var __asyncValues$1=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},verb("next"),verb("throw"),verb("return"),e[Symbol.asyncIterator]=function(){return this},e);function verb(n){e[n]=t[n]&&function(e){return new Promise((function(i,s){(function settle(t,e,n,i){Promise.resolve(i).then((function(e){t({value:e,done:n})}),e)})(i,s,(e=t[n](e)).done,e.value)}))}}};const b=directive((t,e)=>async n=>{var i,s;if(!(n instanceof NodePart))throw new Error("asyncReplace can only be used in text bindings");if(t===n.value)return;const o=new NodePart(n.options,n.templatePart);n.value=t;let r=0;try{for(var a,l=__asyncValues$1(t);!(a=await l.next()).done;){let i=a.value;if(n.value!==t)break;0===r&&(n.clear(),o.appendIntoPart(n)),void 0!==e&&(i=e(i,r)),o.setValue(i),o.commit(),r++}}catch(t){i={error:t}}finally{try{a&&!a.done&&(s=l.return)&&await s.call(l)}finally{if(i)throw i.error}}}),w=new WeakMap,_=directive(t=>e=>{if(!(e instanceof NodePart))throw new Error("cache can only be used in text bindings");let n=w.get(e);void 0===n&&(n=new WeakMap,w.set(e,n));const i=e.value;if(i instanceof TemplateInstance){if(t instanceof TemplateResult&&i.template===e.options.templateFactory(t))return void e.setValue(t);{let t=n.get(i.template);void 0===t&&(t={instance:i,nodes:document.createDocumentFragment()},n.set(i.template,t)),reparentNodes(t.nodes,e.startNode.nextSibling,e.endNode)}}if(t instanceof TemplateResult){const i=e.options.templateFactory(t),s=n.get(i);void 0!==s&&(e.setValue(s.nodes),e.commit(),e.value=s.instance)}e.setValue(t)}),x=new WeakMap,$=directive(t=>e=>{if(!(e instanceof AttributePart)||e instanceof PropertyPart||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:n}=e,{element:i}=n;let s=x.get(e);void 0===s&&(i.className=n.strings.join(" "),x.set(e,s=new Set));const{classList:o}=i;s.forEach(e=>{e in t||(o.remove(e),s.delete(e))});for(const e in t){const n=t[e];n!=s.has(e)&&(n?(o.add(e),s.add(e)):(o.remove(e),s.delete(e)))}}),C=new WeakMap,M=directive((t,e)=>n=>{const i=C.get(n);if(Array.isArray(t)){if(Array.isArray(i)&&i.length===t.length&&t.every((t,e)=>t===i[e]))return}else if(i===t&&(void 0!==t||C.has(n)))return;n.setValue(e()),C.set(n,Array.isArray(t)?Array.from(t):t)}),P=directive(t=>e=>{if(void 0===t&&e instanceof AttributePart){if(t!==e.value){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else e.setValue(t)}),createAndInsertPart=(t,e)=>{const n=t.startNode.parentNode,i=null==e?t.endNode:e.startNode,s=n.insertBefore(createMarker(),i);n.insertBefore(createMarker(),i);const o=new NodePart(t.options,void 0);return o.insertAfterNode(s),o},updatePart=(t,e)=>(t.setValue(e),t.commit(),t),insertPartBefore=(t,e,n)=>{const i=t.startNode.parentNode,s=n?n.startNode:t.endNode,o=e.endNode.nextSibling;o!==s&&reparentNodes(i,e.startNode,o,s)},removePart=t=>{removeNodes(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},generateMap=(t,e,n)=>{const i=new Map;for(let s=e;s<=n;s++)i.set(t[s],s);return i},O=new WeakMap,T=new WeakMap,A=directive((t,e,n)=>{let i;return void 0===n?n=e:void 0!==e&&(i=e),e=>{if(!(e instanceof NodePart))throw new Error("repeat can only be used in text bindings");const s=O.get(e)||[],o=T.get(e)||[],r=[],a=[],l=[];let c,d,h=0;for(const e of t)l[h]=i?i(e,h):h,a[h]=n(e,h),h++;let u=0,p=s.length-1,m=0,f=a.length-1;for(;u<=p&&m<=f;)if(null===s[u])u++;else if(null===s[p])p--;else if(o[u]===l[m])r[m]=updatePart(s[u],a[m]),u++,m++;else if(o[p]===l[f])r[f]=updatePart(s[p],a[f]),p--,f--;else if(o[u]===l[f])r[f]=updatePart(s[u],a[f]),insertPartBefore(e,s[u],r[f+1]),u++,f--;else if(o[p]===l[m])r[m]=updatePart(s[p],a[m]),insertPartBefore(e,s[p],s[u]),p--,m++;else if(void 0===c&&(c=generateMap(l,m,f),d=generateMap(o,u,p)),c.has(o[u]))if(c.has(o[p])){const t=d.get(l[m]),n=void 0!==t?s[t]:null;if(null===n){const t=createAndInsertPart(e,s[u]);updatePart(t,a[m]),r[m]=t}else r[m]=updatePart(n,a[m]),insertPartBefore(e,n,s[u]),s[t]=null;m++}else removePart(s[p]),p--;else removePart(s[u]),u++;for(;m<=f;){const t=createAndInsertPart(e,r[f+1]);updatePart(t,a[m]),r[m++]=t}for(;u<=p;){const t=s[u++];null!==t&&removePart(t)}O.set(e,r),T.set(e,l)}}),S=new WeakMap,I=document.createElement("template"),D=directive(t=>e=>{if(!(e instanceof NodePart))throw new Error("unsafeHTML can only be used in text bindings");const n=S.get(e);if(void 0!==n&&isPrimitive(t)&&t===n.value&&e.value===n.fragment)return;const i=I.cloneNode();i.innerHTML=t;const s=document.importNode(i.content,!0);e.setValue(s),S.set(e,{value:t,fragment:s})}),E=new WeakMap,L=directive((...t)=>e=>{let n=E.get(e);void 0===n&&(n={lastRenderedIndex:2147483647,values:[]},E.set(e,n));const i=n.values;let s=i.length;n.values=t;for(let o=0;o<t.length&&!(o>n.lastRenderedIndex);o++){const r=t[o];if(isPrimitive(r)||"function"!=typeof r.then){e.setValue(r),n.lastRenderedIndex=o;break}o<s&&r===i[o]||(n.lastRenderedIndex=2147483647,s=0,Promise.resolve(r).then(t=>{const i=n.values.indexOf(r);i>-1&&i<n.lastRenderedIndex&&(n.lastRenderedIndex=i,e.setValue(t),e.commit())}))}}),R=new WeakMap;
/**
     * @license
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ChartCalendar(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,reuseComponents:a,html:l,StyleMap:c}=t,d=n.getActions("chart-calendar"),h=Object.assign(Object.assign({},e),{api:n,state:i}),u=i.get("config.components.ChartCalendarDate");let p,m;s(i.subscribe("config.wrappers.ChartCalendar",t=>p=t)),s(i.subscribe("config.classNames",t=>{m=n.getClass("chart-calendar"),r()}));let f,g,v=new c({height:"","--headerHeight":""});s(i.subscribe("config.headerHeight",t=>{f=t,v.style.height=f+"px",v.style["--calendar-height"]=f+"px",r()})),s(i.subscribe("config.chart.time.period",t=>g=t));let y,b=[],w=[];s(i.subscribe("_internal.chart.time.dates",t=>{const e=n.time.date().format("YYYY-MM-DD");"object"==typeof t.day&&Array.isArray(t.day)&&t.day.length&&a(b,t.day,t=>t&&{period:"day",date:t,currentDate:e},u),"object"==typeof t.month&&Array.isArray(t.month)&&t.month.length&&a(w,t.month,t=>t&&{period:"month",date:t,currentDate:e},u),r()})),s(()=>{b.forEach(t=>t.destroy())}),d.push(t=>{i.update("_internal.elements.chart-calendar",t)}),s(n.subscribeSlots("chart-calendar",t=>y=t,e));const _=o.create(d,h);return n=>p(l`
        <div class=${m} data-actions=${_} style=${v}>
          ${y.get("before")}
          <div class=${m+"-dates "+m+"-dates--months"}>${w.map(t=>t.html())}</div>
          <div class=${m+"-dates "+m+"-dates--days"}>${b.map(t=>t.html())}</div>
          ${y.get("after")}
        </div>
...
/**
     ...
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */
class BindElementAction$2 extends Action$1{constructor(t,e){super(),e.state.update("_internal.elements.chart-calendar-dates",e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e))}}function ChartCalendarDate(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,onChange:a,html:l,StyleMap:c,Detach:d}=t,h=n.getActions("chart-calendar-date");let u;s(i.subscribe("config.wrappers.ChartCalendarDate",t=>u=t));let p=n.getClass("chart-calendar-date",e),m="";m=n.time.date(e.date.leftGlobal).format("YYYY-MM-DD")===e.currentDate?" current":"";let f,g,v,y=new c({width:"","margin-left":"",visibility:"visible"}),b=new c({overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"});s(n.subscribeSlots("chart-calendar-date",t=>v=t,e));const updateDate=()=>{if(!e)return;f=i.get("_internal.chart.time"),y.style.width=e.date.width+"px",y.style["margin-left"]=-e.date.subPx+"px",y.style.visibility="visible",b.style={overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"};const t=n.time.date(e.date.leftGlobal);m=t.format("YYYY-MM-DD")===e.currentDate?" current":t.subtract(1,"days").format("YYYY-MM-DD")===e.currentDate?" next":t.add(1,"days").format("YYYY-MM-DD")===e.currentDate?" previous":"";const s=f.maxWidth[e.period];switch(e.period){case"month":g=l`
          <div class=${p+"-content "+p+"-content--month"+m} style=${b}>
            ${v.get("before-month")}${t.format("MMMM YYYY")}${v.get("after-month")}
          </div>
        `,s<=100&&(g=l`
            <div class=${p+"-content "+p+"-content--month"+m}>
              ${v.get("before-month")}${t.format("MMM'YY")}${v.get("after-month")}
            </div>
          `);break;case"day":if(g=l`
          <div class=${p+"-content "+p+"-content--day _0"+m}>
            <div class=${p+"-content "+p+"-content--day-small"+m}>
              ${v.get("before-day")}${t.format("DD")} ${t.format("ddd")}${v.get("after-day")}
            </div>
          </div>
        `,s>=40&&s<50)g=l`
            <div class=${p+"-content "+p+"-content--day _40"+m}>
              ${v.get("before-day")}${t.format("DD")}${v.get("after-day")}
            </div>
            <div class=${p+"-content "+p+"-content--day-word"+m}>
              ${v.get("before-day-word")}${t.format("dd")}${v.get("after-day-word")}
            </div>
          `;else if(s>=50&&s<90)g=l`
            <div class=${p+"-content "+p+"-content--day _50"+m}>
              ${v.get("before-day")}${t.format("DD")}${v.get("after-day")}
            </div>
            <div class=${p+"-content "+p+"-content--day-word"+m}>
              ${v.get("before-day-word")}${t.format("ddd")}${v.get("after-day-word")}
            </div>
          `;else if(s>=90&&s<180)g=l`
            <div class=${p+"-content "+p+"-content--day _90"+m}>
              ${v.get("before-day")}${t.format("DD")}${v.get("after-day")}
            </div>
            <div class=${p+"-content "+p+"-content--day-word"+m}>
              ${v.get("before-day-word")}${t.format("dddd")}${v.get("after-day-word")}
            </div>
          `;else if(s>=180&&s<400){const e=[],n=t.startOf("day");for(let t=0;t<12;t++){const i=n.add(2*t,"hours"),s=(n.add(2*t+1,"hours").endOf("hour").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH")})}g=l`
            <div class=${p+"-content "+p+"-content--day _180"+m}>
              ${t.format("DD dddd")}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+m}>
              ${e.map(t=>l`
                    <div
                      class="${p+"-content "+p+"-content--hours-hour"+m}"
          ...
          `}else if(s>=400&&s<1e3){const e=[],n=t.startOf("day");for(let t=0;t<24;t++){const i=n.add(t,"hours"),s=(n.add(t,"hours").endOf("hour").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH")})}g=l`
            <div class=${p+"-content "+p+"-content--day _400"+m}>
              ${t.format("DD dddd")}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+m}>
              ${e.map(t=>l`
          ...
          `}else if(s>=1e3&&s<2e3){const e=[],n=t.startOf("day");for(let t=0;t<24;t++){const i=n.add(t,"hours"),s=(n.add(t,"hours").endOf("hour").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _1000"+m} style=${b}>
              ${t.format("DD dddd")}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+m}>
              ${e.map(t=>l`
          ...
          `}else if(s>=2e3&&s<5e3){const e=[],n=t.startOf("day");for(let t=0;t<48;t++){const i=n.add(30*t,"minutes"),s=(n.add(30*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _2000"+m} style=${b}>
              ${t.format("DD dddd")}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+m}>
              ${e.map(t=>l`
          ...
          `}else if(s>=5e3&&s<2e4){const e=[],n=t.startOf("day");for(let t=0;t<96;t++){const i=n.add(15*t,"minutes"),s=(n.add(15*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _5000"+m} style=${b}>
              ${t.format("DD dddd")}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+m}>
              ${e.map(t=>l`
          ...
          `}else if(s>=2e4){const e=[],n=t.startOf("day");for(let t=0;t<288;t++){const i=n.add(5*t,"minutes"),s=(n.add(5*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}g=l`
            <div
              class=${p+"-content "+p+"-content--day _20000"+m}
              style=${b}
            >
              ${t.format("DD dddd")}
            </div>
          ...
          `}}r()};let w=!1;const _=new d(()=>w);let x;const $={date:e.date,period:e.period,api:n,state:i};a((t,n)=>{if(n.leave)return w=!0,r();w=!1,e=t,$.date=e.date,$.period=e.period,x&&x(),x=i.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],updateDate,{bulk:!0})}),s(()=>{x()}),h.includes(BindElementAction$2)||h.push(BindElementAction$2);const C=o.create(h,$);return n=>u(l`
        <div
          detach=${_}
          class=${p+" "+p+"--"+e.period+m}
          style=${y}
          data-actions=${C}
        >
          ${v.get("before")}${g}${v.get("after")}
        </div>
      `,{props:e,vido:t,templateProps:n})}
/**
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */class BindElementAction$7{constructor(t,e){let n=!1,i=e.state.get("_internal.elements.chart-timeline-items-row-items");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("_internal.elements.chart-timeline-items-row-items",i,{only:null})}destroy(t,e){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}}function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,Detach:o,Actions:r,update:a,html:l,onChange:c,unsafeHTML:d,StyleMap:h}=t;let u;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>u=t));let p=new h({width:"",height:"",left:""}),m=0,f=0,g=!1;const v={item:e.item,row:e.row,left:m,width:f,api:n,state:i};let y=!1;function updateItem(){var t,s,o,r,l,c,d,h,u,b,_;if(g)return;let x=i.get("_internal.chart.time");m=(e.item.time.start-x.leftGlobal)/x.timePerPixel,m=.1*Math.round(10*m),f=(e.item.time.end-e.item.time.start)/x.timePerPixel,f-=i.get("config.chart.spacing")||0,f&&(f=.1*Math.round(10*f));const $=p.style.width,C=p.style.left,M=n.getCompensationX();p.setStyle({});const P=n.isItemInViewport(e.item,x.leftGlobal,x.rightGlobal);y=!P,P?(p.style.width=f+"px",p.style.left=m+M+"px"):(p.style.width=$,p.style.left=C);const O=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(r=null===(o=null===(s=null===(t=O[n])||void 0===t?void 0:t.style)||void 0===s?void 0:s.items)||void 0===o?void 0:o.item)||void 0===r?void 0:r.children;e&&p.setStyle(Object.assign(Object.assign({},p.style),e))}const T=null===(u=null===(h=null===(d=null===(c=null===(l=e)||void 0===l?void 0:l.row)||void 0===c?void 0:c.style)||void 0===d?void 0:d.items)||void 0===h?void 0:h.item)||void 0===u?void 0:u.current;T&&p.setStyle(Object.assign(Object.assign({},p.style),T));const A=null===(_=null===(b=e)||void 0===b?void 0:b.item)||void 0===_?void 0:_.style;A&&p.setStyle(Object.assign(Object.assign({},p.style),A)),v.left=m+M,v.width=f,w.change(v,{leave:!1}),a()}const b="chart-timeline-items-row-item";let w;s(n.subscribeSlots(b,t=>w=t,e)),c((function onPropsChange(t,n){if(n.leave||void 0===t.row||void 0===t.item)return g=!0,y=!0,w.change(v,n),a();y=!1,g=!1,e=t,v.item=e.item,v.row=e.row,w.change(v,n),updateItem()}));const _=n.getActions(b);let x,$;s(i.subscribe("config.classNames",()=>{x=n.getClass(b,e),$=n.getClass(b+"-label",e),a()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()})),_.push(BindElementAction$7);const C=r.create(_,v),M=new o(()=>y);return n=>u(l`
        <div detach=${M} class=${x} data-actions=${C} style=${p}>
          ${w.get("before")}
          <div class=${$}>
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */const dt="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const ht={name:dt,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,date:t=>t?ot(t):ot(),dayjs:ot};
/**
     * Gantt-Schedule-Timeline-Calendar
     *
     * @copyright Rafal Pospiech <https://neuronet.io>
