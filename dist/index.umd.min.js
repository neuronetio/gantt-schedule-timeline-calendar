...
/**
     ...
     */const t=new WeakMap,e=e=>(...n)=>{const s=e(...n);return t.set(s,!0),s},n=e=>"function"==typeof e&&t.has(e),s=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,i=(t,e,n=null,s=null)=>{for(;e!==n;){const n=e.nextSibling;t.insertBefore(e,s),e=n}},o=(t,e,n=null)=>{for(;e!==n;){const n=e.nextSibling;t.removeChild(e),e=n}},r={},a={},l=`{{lit-${String(Math.random()).slice(2)}}}`,c=`\x3c!--${l}--\x3e`,d=new RegExp(`${l}|${c}`),u="$lit$";class Template{constructor(t,e){this.parts=[],this.element=e;const n=[],s=[],i=document.createTreeWalker(e.content,133,null,!1);let o=0,r=-1,a=0;const{strings:c,values:{length:p}}=t;for(;a<p;){const t=i.nextNode();if(null!==t){if(r++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:n}=e;let s=0;for(let t=0;t<n;t++)h(e[t].name,u)&&s++;for(;s-- >0;){const e=c[a],n=f.exec(e)[2],s=n.toLowerCase()+u,i=t.getAttribute(s);t.removeAttribute(s);const o=i.split(d);this.parts.push({type:"attribute",index:r,name:n,strings:o}),a+=o.length-1}}"TEMPLATE"===t.tagName&&(s.push(t),i.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(l)>=0){const s=t.parentNode,i=e.split(d),o=i.length-1;for(let e=0;e<o;e++){let n,o=i[e];if(""===o)n=m();else{const t=f.exec(o);null!==t&&h(t[2],u)&&(o=o.slice(0,t.index)+t[1]+t[2].slice(0,-u.length)+t[3]),n=document.createTextNode(o)}s.insertBefore(n,t),this.parts.push({type:"node",index:++r})}""===i[o]?(s.insertBefore(m(),t),n.push(t)):t.data=i[o],a+=o}}else if(8===t.nodeType)if(t.data===l){const e=t.parentNode;null!==t.previousSibling&&r!==o||(r++,e.insertBefore(m(),t)),o=r,this.parts.push({type:"node",index:r}),null===t.nextSibling?t.data="":(n.push(t),r--),a++}else{let e=-1;for(;-1!==(e=t.data.indexOf(l,e+1));)this.parts.push({type:"node",index:-1}),a++}}else i.currentNode=s.pop()}for(const t of n)t.parentNode.removeChild(t)}}const h=(t,e)=>{const n=t.length-e.length;return n>=0&&t.slice(n)===e},p=t=>-1!==t.index,m=()=>document.createComment(""),f=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */var A=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},verb("next"),verb("throw"),verb("return"),e[Symbol.asyncIterator]=function(){return this},e);function verb(n){e[n]=t[n]&&function(e){return new Promise((function(s,i){(function settle(t,e,n,s){Promise.resolve(s).then((function(e){t({value:e,done:n})}),e)})(s,i,(e=t[n](e)).done,e.value)}))}}};const I=e((t,e)=>async n=>{var s,i;if(!(n instanceof NodePart))throw new Error("asyncReplace can only be used in text bindings");if(t===n.value)return;const o=new NodePart(n.options);n.value=t;let r=0;try{for(var a,l=A(t);!(a=await l.next()).done;){let s=a.value;if(n.value!==t)break;0===r&&(n.clear(),o.appendIntoPart(n)),void 0!==e&&(s=e(s,r)),o.setValue(s),o.commit(),r++}}catch(t){s={error:t}}finally{try{a&&!a.done&&(i=l.return)&&await i.call(l)}finally{if(s)throw s.error}}}),D=new WeakMap,R=e(t=>e=>{if(!(e instanceof NodePart))throw new Error("cache can only be used in text bindings");let n=D.get(e);void 0===n&&(n=new WeakMap,D.set(e,n));const s=e.value;if(s instanceof TemplateInstance){if(t instanceof TemplateResult&&s.template===e.options.templateFactory(t))return void e.setValue(t);{let t=n.get(s.template);void 0===t&&(t={instance:s,nodes:document.createDocumentFragment()},n.set(s.template,t)),i(t.nodes,e.startNode.nextSibling,e.endNode)}}if(t instanceof TemplateResult){const s=e.options.templateFactory(t),i=n.get(s);void 0!==i&&(e.setValue(i.nodes),e.commit(),e.value=i.instance)}e.setValue(t)}),E=new WeakMap,N=e(t=>e=>{if(!(e instanceof AttributePart)||e instanceof PropertyPart||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:n}=e,{element:s}=n;E.has(e)||(s.className=n.strings.join(" "));const{classList:i}=s,o=E.get(e);for(const e in o)e in t||i.remove(e);for(const e in t){const n=t[e];if(!o||n!==o[e]){i[n?"add":"remove"](e)}}E.set(e,t)}),S=new WeakMap,L=e((t,e)=>n=>{const s=S.get(n);if(Array.isArray(t)){if(Array.isArray(s)&&s.length===t.length&&t.every((t,e)=>t===s[e]))return}else if(s===t&&(void 0!==t||S.has(n)))return;n.setValue(e()),S.set(n,Array.isArray(t)?Array.from(t):t)}),k=e(t=>e=>{if(void 0===t&&e instanceof AttributePart){if(t!==e.value){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else e.setValue(t)}),H=(t,e)=>{const n=t.startNode.parentNode,s=void 0===e?t.endNode:e.startNode,i=n.insertBefore(m(),s);n.insertBefore(m(),s);const o=new NodePart(t.options);return o.insertAfterNode(i),o},j=(t,e)=>(t.setValue(e),t.commit(),t),V=(t,e,n)=>{const s=t.startNode.parentNode,o=n?n.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&i(s,e.startNode,r,o)},z=t=>{o(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},W=(t,e,n)=>{const s=new Map;for(let i=e;i<=n;i++)s.set(t[i],i);return s},B=new WeakMap,Y=new WeakMap,G=e((t,e,n)=>{let s;return void 0===n?n=e:void 0!==e&&(s=e),e=>{if(!(e instanceof NodePart))throw new Error("repeat can only be used in text bindings");const i=B.get(e)||[],o=Y.get(e)||[],r=[],a=[],l=[];let c,d,u=0;for(const e of t)l[u]=s?s(e,u):u,a[u]=n(e,u),u++;let h=0,p=i.length-1,m=0,f=a.length-1;for(;h<=p&&m<=f;)if(null===i[h])h++;else if(null===i[p])p--;else if(o[h]===l[m])r[m]=j(i[h],a[m]),h++,m++;else if(o[p]===l[f])r[f]=j(i[p],a[f]),p--,f--;else if(o[h]===l[f])r[f]=j(i[h],a[f]),V(e,i[h],r[f+1]),h++,f--;else if(o[p]===l[m])r[m]=j(i[p],a[m]),V(e,i[p],i[h]),p--,m++;else if(void 0===c&&(c=W(l,m,f),d=W(o,h,p)),c.has(o[h]))if(c.has(o[p])){const t=d.get(l[m]),n=void 0!==t?i[t]:null;if(null===n){const t=H(e,i[h]);j(t,a[m]),r[m]=t}else r[m]=j(n,a[m]),V(e,n,i[h]),i[t]=null;m++}else z(i[p]),p--;else z(i[h]),h++;for(;m<=f;){const t=H(e,r[f+1]);j(t,a[m]),r[m++]=t}for(;h<=p;){const t=i[h++];null!==t&&z(t)}B.set(e,r),Y.set(e,l)}}),F=new WeakMap,U=e(t=>e=>{if(!(e instanceof AttributePart)||e instanceof PropertyPart||"style"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:n}=e,{style:s}=n.element;F.has(e)||(s.cssText=n.strings.join(" "));const i=F.get(e);for(const e in i)e in t||(-1===e.indexOf("-")?s[e]=null:s.removeProperty(e));for(const e in t)-1===e.indexOf("-")?s[e]=t[e]:s.setProperty(e,t[e]);F.set(e,t)}),J=new WeakMap,q=e(t=>e=>{if(!(e instanceof NodePart))throw new Error("unsafeHTML can only be used in text bindings");const n=J.get(e);if(void 0!==n&&v(t)&&t===n.value&&e.value===n.fragment)return;const s=document.createElement("template");s.innerHTML=t;const i=document.importNode(s.content,!0);e.setValue(i),J.set(e,{value:t,fragment:i})}),Z=new WeakMap,X=e((...t)=>e=>{let n=Z.get(e);void 0===n&&(n={lastRenderedIndex:2147483647,values:[]},Z.set(e,n));const s=n.values;let i=s.length;n.values=t;for(let o=0;o<t.length&&!(o>n.lastRenderedIndex);o++){const r=t[o];if(v(r)||"function"!=typeof r.then){e.setValue(r),n.lastRenderedIndex=o;break}o<i&&r===s[o]||(n.lastRenderedIndex=2147483647,i=0,Promise.resolve(r).then(t=>{const s=n.values.indexOf(r);s>-1&&s<n.lastRenderedIndex&&(n.lastRenderedIndex=s,e.setValue(t),e.commit())}))}});
/**
     * @license
...
function Main(t,e={}){const{api:n,state:s,onDestroy:i,actions:o,update:r,createComponent:a,html:l}=t,c=n.name;let d,u;i(s.subscribe("config.components.List",t=>d=t)),i(s.subscribe("config.components.Chart",t=>u=t));const h=a(d);i(h.destroy);const p=a(u);let m;i(p.destroy),i(s.subscribe("config.plugins",e=>{if(void 0!==e&&Array.isArray(e))for(const n of e){const e=n(t);"function"==typeof e&&i(e)}})),i(s.subscribe("config.wrappers.Main",t=>m=t));const f=n.getActions("");let g,v,b,y,w,_,$=0,x=!1;i(s.subscribe("config.classNames",(function updateClassNames(t){const e=s.get("config");g=n.getClass(c,{config:e}),x&&(g+=` ${c}__list-column-header-resizer--active`),v=n.getClass("vertical-scroll",{config:e}),r()}))),i(s.subscribeAll(["config.height","config.headerHeight","_internal.scrollBarHeight"],(function heightChange(){const t=s.get("config"),e=s.get("_internal.scrollBarHeight"),n=t.height-t.headerHeight-e;s.update("_internal.height",n),b=`--height: ${t.height}px`,y=`height: ${n}px; width: ${e}px; margin-top: ${t.headerHeight}px;`,r()}))),i(s.subscribe("_internal.list.columns.resizer.active",(function resizerActiveChange(t){x=t,g=n.getClass(n.name),x&&(g+=` ${n.name}__list-column-header-resizer--active`),r()}))),i(s.subscribeAll(["config.list.rows;","config.chart.items;","config.list.rows.*.parentId","config.chart.items.*.rowId"],(function generateTree(t,e){if(s.get("_internal.flatTreeMap").length&&"subscribe"===e.type)return;const i=s.get("config.list.rows"),o=[];for(const t in i)o.push(i[t]);n.fillEmptyRowValues(o);const a=s.get("config.chart.items"),l=[];for(const t in a)l.push(a[t]);const c=n.makeTreeMap(o,l);s.update("_internal.treeMap",c),s.update("_internal.flatTreeMapById",n.getFlatTreeMapById(c)),s.update("_internal.flatTreeMap",n.flattenTreeMap(c)),r()}),{bulk:!0})),i(s.subscribeAll(["config.list.rows.*.expanded","_internal.treeMap;"],(function prepareExpanded(){const t=s.get("config.list.rows"),e=n.getRowsFromIds(n.getRowsWithParentsExpanded(s.get("_internal.flatTreeMap"),s.get("_internal.flatTreeMapById"),t),t);$=n.getRowsHeight(e),s.update("_internal.list.rowsHeight",$),s.update("_internal.list.rowsWithParentsExpanded",e),r()}),{bulk:!0})),i(s.subscribeAll(["_internal.list.rowsWithParentsExpanded","config.scroll.top"],(function generateVisibleRows(){const{visibleRows:t,compensation:e}=n.getVisibleRowsAndCompensation(s.get("_internal.list.rowsWithParentsExpanded")),i=s.get("_internal.list.visibleRows");let o=!0;if(s.update("config.scroll.compensation",-e),t.length&&(o=t.some((t,e)=>void 0===i[e]||t.id!==i[e].id)),o){s.update("_internal.list.visibleRows",t);const e=[];for(const n of t)for(const t of n._internal.items)e.push(t);s.update("_internal.chart.visibleItems",e)}r()})));let C=0;function generateAndAddPeriodDates(t,e){const s=[];let i=e.leftGlobal;const o=e.rightGlobal,r=e.timePerPixel;let a=i-n.time.date(i).startOf(t),l=a/r,c=0,d=0;for(;i<o;){const e={sub:a,subPx:l,leftGlobal:i,rightGlobal:n.time.date(i).endOf(t).valueOf(),width:0,leftPx:0,rightPx:0};e.width=(e.rightGlobal-e.leftGlobal+a)/r,d=e.width>d?e.width:d,e.leftPx=c,c+=e.width,e.rightPx=c,s.push(e),i=e.rightGlobal+1,a=0,l=0}e.maxWidth[t]=d,e.dates[t]=s}i(s.subscribe("_internal.list.visibleRows;",(function onVisibleRowsChange(){const t=s.get("config.scroll.top");w=`height: ${$}px; width: 1px`,C!==t&&_&&(C=t,_.scrollTop=t),r()}))),i(s.subscribeAll(["config.chart.time","_internal.dimensions.width","config.scroll.left","_internal.scrollBarHeight","_internal.list.width","_internal.chart.dimensions"],(function recalculateTimes(){const t=s.get("_internal.chart.dimensions.width");let e=n.mergeDeep({},s.get("config.chart.time"));const i=.01*(e=n.time.recalculateFromTo(e)).zoom;let o=s.get("config.scroll.left");if(e.timePerPixel=i+Math.pow(2,e.zoom),e.totalViewDurationMs=n.time.date(e.to).diff(e.from,"milliseconds"),e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,o>e.totalViewDurationPx&&(o=e.totalViewDurationPx-t),e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.leftGlobal+t*e.timePerPixel,e.leftInner=e.leftGlobal-e.from,e.rightInner=e.rightGlobal-e.from,e.leftPx=e.leftInner/e.timePerPixel,e.rightPx=e.rightInner/e.timePerPixel,Math.round(e.rightGlobal/e.timePerPixel)>Math.round(e.to/e.timePerPixel)){const t=(e.rightGlobal-e.to)/(e.rightGlobal-e.from);e.timePerPixel=e.timePerPixel-e.timePerPixel*t,e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.to,e.rightInner=e.rightGlobal-e.from,e.totalViewDurationMs=e.to-e.from,e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,e.rightInner=e.rightGlobal-e.from,e.rightPx=e.rightInner/e.timePerPixel,e.leftPx=e.leftInner/e.timePerPixel}generateAndAddPeriodDates("day",e),generateAndAddPeriodDates("month",e),s.update("_internal.chart.time",e),r()}),{bulk:!0})),s.update("_internal.scrollBarHeight",n.getScrollBarHeight());let M=0;const P={handleEvent:vt((function handleEvent(t){const e=t.target.scrollTop;M!==e&&s.update("config.scroll",(function handleOnScroll(t){t.top=e,M=t.top;const n=s.get("_internal.elements.vertical-scroll-inner");if(n){const e=n.clientHeight;t.percent.top=t.top/e}return t}),{only:["top","percent.top"]})})),passive:!0,capture:!1};function onScrollStop(t){t.stopPropagation(),t.preventDefault()}const O={width:0,height:0};let T;function resizeAction(t){T||((T=new gt((e,n)=>{const i=t.clientWidth,o=t.clientHeight;O.width===i&&O.height===o||(O.width=i,O.height=o,s.update("_internal.dimensions",O))})).observe(t),s.update("_internal.elements.main",t))}function bindScrollElement(t){_||(_=t,s.update("_internal.elements.vertical-scroll",t))}function bindScrollInnerElement(t){s.update("_internal.elements.vertical-scroll-inner",t)}return f.includes(resizeAction)||f.push(resizeAction),i(()=>{T.disconnect()}),function updateTemplate(i){return m(l`
        ...
        >
          ...
          >
            <div style=${w} data-actions=${o([bindScrollInnerElement])} />
          </div>
        </div>
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function List(t,e={}){const{api:n,state:s,onDestroy:i,actions:o,update:r,reuseComponents:a,html:l}=t,c=n.getActions("list");let d,u,h,p,m;i(s.subscribe("config.wrappers.List",t=>d=t)),i(s.subscribe("config.components.ListColumn",t=>u=t)),i(s.subscribe("config.list",(function onListChange(){p=s.get("config.list"),m=p.columns.percent,r()}))),i(s.subscribe("config.classNames",()=>{h=n.getClass("list",{list:p}),r()}));let f=[];i(s.subscribe("config.list.columns.data;",(function onListColumnsDataChange(t){a(f,Object.values(t),t=>({columnId:t.id}),u),r()}))),i(()=>{f.forEach(t=>t.destroy())});let g="";i(s.subscribe("config.height",t=>{g=`height: ${t}px`,r()}));const v={handleEvent:vt((function onScrollHandler(t){if(t.stopPropagation(),t.preventDefault(),"scroll"===t.type)s.update("config.scroll.top",t.target.scrollTop);else{const e=n.normalizeMouseWheelEvent(t);s.update("config.scroll.top",t=>n.limitScroll("top",t+=e.y*s.get("config.scroll.yMultiplier")))}})),passive:!1};let b;function getWidth(t){b||(b=t.clientWidth,0===m&&(b=0),s.update("_internal.list.width",b),s.update("_internal.elements.list",t))}return c.push(t=>(s.update("_internal.elements.list",t),getWidth(t),{update:getWidth})),i=>d(p.columns.percent>0?l`
            <div
              class=${h}
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function Chart(t,e={}){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,createComponent:l}=t,c=s.get("config.components.ChartCalendar"),d=s.get("config.components.ChartTimeline");let u;i(s.subscribe("config.wrappers.Chart",t=>u=t));const h=l(c);i(h.destroy);const p=l(d);i(p.destroy);let m,f,g,v,b="",y="",w=n.getActions("chart");function handleEvent(t){let e,i;if("scroll"===t.type)s.update("config.scroll.left",t.target.scrollLeft),e=t.target.scrollLeft;else{const o=n.normalizeMouseWheelEvent(t),r=s.get("config.scroll.xMultiplier"),a=s.get("config.scroll.yMultiplier");t.shiftKey&&o.y?s.update("config.scroll.left",t=>e=n.limitScroll("left",t+=o.y*r)):o.x?s.update("config.scroll.left",t=>e=n.limitScroll("left",t+=o.x*r)):s.update("config.scroll.top",t=>i=n.limitScroll("top",t+=o.y*a))}const o=s.get("_internal.elements.chart"),r=s.get("_internal.elements.horizontal-scroll-inner");if(o){const t=s.get("config.scroll.left");let e=0;t&&(e=Math.round(t/(r.clientWidth-o.clientWidth)*100))>100&&(e=100),s.update("config.scroll.percent.left",e)}}i(s.subscribe("config.classNames",t=>{m=n.getClass("chart"),f=n.getClass("horizontal-scroll"),g=n.getClass("horizontal-scroll-inner"),r()})),i(s.subscribe("config.scroll.left",t=>{v&&v.scrollLeft!==t&&(v.scrollLeft=t),r()})),i(s.subscribeAll(["_internal.chart.dimensions.width","_internal.chart.time.totalViewDurationPx"],(function horizontalScroll(t,e){b=`width: ${s.get("_internal.chart.dimensions.width")}px`,y=`width: ${s.get("_internal.chart.time.totalViewDurationPx")}px; height:1px`,r()})));const _={handleEvent:vt(handleEvent),passive:!0,capture:!1},$={handleEvent:handleEvent,passive:!0,capture:!1};function bindElement(t){v||(v=t,s.update("_internal.elements.horizontal-scroll",t))}function bindInnerScroll(t){s.update("_internal.elements.horizontal-scroll-inner",t)}let x,C=0;return w.push(t=>{x||((x=new gt((e,n)=>{const i=t.clientWidth,o=t.clientHeight,r=i-s.get("_internal.scrollBarHeight");C!==i&&(C=i,s.update("_internal.chart.dimensions",{width:i,innerWidth:r,height:o}))})).observe(t),s.update("_internal.elements.chart",t))}),i(()=>{x.disconnect()}),function updateTemplate(e){return u(a`
        <div class=${m} data-actions=${o(w,{api:n,state:s})} @wheel=${$}>
          ${h.html()}${p.html()}
          <div class=${f} style=${b} data-actions=${o([bindElement])} @scroll=${_}>
            <div class=${g} style=${y} data-actions=${o([bindInnerScroll])} />
          </div>
        </div>
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function bindElementAction$3(t,e){return e.state.update("_internal.elements.chart-timeline-items-row-items",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}}}function ChartTimelineItemsRowItem(t,e){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,onChange:l}=t;let c;i(s.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>c=t));let d,u,h=0,p=0;function updateItem(){u="";let t=s.get("_internal.chart.time");h=(e.item.time.start-t.leftGlobal)/t.timePerPixel,p=(e.item.time.end-e.item.time.start)/t.timePerPixel,p-=s.get("config.chart.spacing"),d=`left:${h}px; width:${p}px; `,"object"==typeof e.item.style&&"Object"===e.item.style.constructor.name&&"string"==typeof e.item.style.current&&(u+=e.item.style.current),r()}l(t=>{e=t,updateItem()});const m="chart-timeline-items-row-item",f=n.getActions(m);let g,v,b;return i(s.subscribe("config.classNames",()=>{g=n.getClass(m,e),v=n.getClass(m+"-content",e),b=n.getClass(m+"-content-label",e),r()})),i(s.subscribe("_internal.chart.time",t=>{updateItem()})),-1===f.indexOf(bindElementAction$3)&&f.push(bindElementAction$3),function updateTemplate(i){return c(a`
        <div
          class=${g}
