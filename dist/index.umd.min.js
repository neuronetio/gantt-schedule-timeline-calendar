...
/**
     ...
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */
function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,Detach:o,Action:r,Actions:a,update:l,html:c,onChange:d,unsafeHTML:h,StyleMap:u}=t;let p;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>p=t));let m=new u({width:"",height:"",left:""}),f=0,g=0,v=!1;const y={item:e.item,row:e.row,left:f,width:g,api:n,state:i};let b=!1;function updateItem(){var t,s,o,r,a,c,d,h;if(v)return;let u=i.get("_internal.chart.time");f=(e.item.time.start-u.leftGlobal)/u.timePerPixel,f=.1*Math.round(10*f),g=(e.item.time.end-e.item.time.start)/u.timePerPixel,(g-=i.get("config.chart.spacing")||0)&&(g=.1*Math.round(10*g));const p=m.style.width,y=m.style.left,w=n.getCompensationX();m.setStyle({});const _=n.isItemInViewport(e.item,u.leftGlobal,u.rightGlobal);b=!_,_?(m.style.width=g+"px",m.style.left=f+w+"px"):(m.style.width=p,m.style.left=y);const x=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(o=null===(s=null===(t=x[n].style)||void 0===t?void 0:t.items)||void 0===s?void 0:s.item)||void 0===o?void 0:o.children;e&&m.setStyle(Object.assign(Object.assign({},m.style),e))}const $=null===(d=null===(c=null===(a=null===(r=e.row)||void 0===r?void 0:r.style)||void 0===a?void 0:a.items)||void 0===c?void 0:c.item)||void 0===d?void 0:d.current;$&&m.setStyle(Object.assign(Object.assign({},m.style),$));const C=null===(h=e.item)||void 0===h?void 0:h.style;C&&m.setStyle(Object.assign(Object.assign({},m.style),C)),l()}d((function onPropsChange(t,n){if(n.leave)return v=!0,b=!0,l();b=!1,v=!1,e=t,y.item=e.item,y.row=e.row,y.left=f,y.width=g,updateItem()}));const w="chart-timeline-items-row-item",_=n.getActions(w);let x,$;s(i.subscribe("config.classNames",()=>{x=n.getClass(w,e),$=n.getClass(w+"-label",e),l()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()}));_.push(class BindElementAction extends r{constructor(t,e){super(),e.state.update("_internal.elements.chart-timeline-items-row-items",(function updateRowItems(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null})}destroy(t,e){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}});const C=a.create(_,y),M=new o(()=>b);return n=>p(c`
