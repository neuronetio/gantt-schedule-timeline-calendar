...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const T=(t,...e)=>new TemplateResult(t,e,"html",P),I=(t,...e)=>new SVGTemplateResult(t,e,"svg",P);
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     */function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:s,update:o,html:r,Actions:a,PointerAction:l,cache:c,StyleMap:d}=t,h="list-column-header-resizer";let u,p,m=n.getActions(h),f=n.getActions(h+"-dots");s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>u=t)),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{p=t,o()}));let g,v,y,b,w,_=new d({width:""}),x=!1;s(i.subscribe("config.classNames",t=>{g=n.getClass(h,{column:p}),v=n.getClass(h+"-container",{column:p}),y=n.getClass(h+"-dots",{column:p}),b=n.getClass(h+"-dots-dot",{column:p}),o()})),s(i.subscribeAll([`config.list.columns.data.${p.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");w=p.width*n.columns.percent*.01,_.style["--width"]=n.columns.resizer.width+"px",x=n.columns.resizer.inRealTime,i.update("_internal.list.width",w),o()}));let $=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{$=[];for(let e=0;e<t;e++)$.push(e);o()}));let C=w;new d({"--display":"none","--left":C+"px"});const M=`config.list.columns.data.${p.id}.width`,P={column:p,api:n,state:i,pointerOptions:{axis:"x",onMove({movementX:t}){let e=i.get("config.list.columns.minWidth");"number"==typeof p.minWidth&&(e=p.minWidth),(C+=t)<e&&(C=e),x&&i.update(M,C)}}};m.push(l);const O=a.create(m,P),S=a.create(f,P);return n=>u(r`
        <div class=${g} data-actions=${O}>
          ...
          <div class=${y} style=${_} data-actions=${S}>
            ${$.map(t=>r`
                  <div class=${b} />
                `)}
          </div>
...
/**
     ...
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */
function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,Detach:o,Action:r,Actions:a,update:l,html:c,onChange:d,unsafeHTML:h,StyleMap:u}=t;let p;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>p=t));let m=new u({width:"",height:"",left:""}),f=0,g=0,v=!1;const y={item:e.item,row:e.row,left:f,width:g,api:n,state:i};let b=!1;function updateItem(){var t,s,o,r,a,c,d,h,u,p,y;if(v)return;let w=i.get("_internal.chart.time");f=(e.item.time.start-w.leftGlobal)/w.timePerPixel,f=.1*Math.round(10*f),g=(e.item.time.end-e.item.time.start)/w.timePerPixel,(g-=i.get("config.chart.spacing")||0)&&(g=.1*Math.round(10*g));const _=m.style.width,x=m.style.left,$=n.getCompensationX();m.setStyle({});const C=n.isItemInViewport(e.item,w.leftGlobal,w.rightGlobal);b=!C,C?(m.style.width=g+"px",m.style.left=f+$+"px"):(m.style.width=_,m.style.left=x);const M=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(r=null===(o=null===(s=null===(t=M[n])||void 0===t?void 0:t.style)||void 0===s?void 0:s.items)||void 0===o?void 0:o.item)||void 0===r?void 0:r.children;e&&m.setStyle(Object.assign(Object.assign({},m.style),e))}const P=null===(u=null===(h=null===(d=null===(c=null===(a=e)||void 0===a?void 0:a.row)||void 0===c?void 0:c.style)||void 0===d?void 0:d.items)||void 0===h?void 0:h.item)||void 0===u?void 0:u.current;P&&m.setStyle(Object.assign(Object.assign({},m.style),P));const O=null===(y=null===(p=e)||void 0===p?void 0:p.item)||void 0===y?void 0:y.style;O&&m.setStyle(Object.assign(Object.assign({},m.style),O)),l()}d((function onPropsChange(t,n){if(n.leave||void 0===t.row||void 0===t.item)return v=!0,b=!0,l();b=!1,v=!1,e=t,y.item=e.item,y.row=e.row,y.left=f,y.width=g,updateItem()}));const w="chart-timeline-items-row-item",_=n.getActions(w);let x,$;s(i.subscribe("config.classNames",()=>{x=n.getClass(w,e),$=n.getClass(w+"-label",e),l()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()}));_.push(class BindElementAction extends r{constructor(t,e){super(),e.state.update("_internal.elements.chart-timeline-items-row-items",(function updateRowItems(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null})}destroy(t,e){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}});const C=a.create(_,y),M=new o(()=>b);return n=>p(c`
        <div detach=${M} class=${x} data-actions=${C} style=${m}>
          <div class=${$}>
...
/**
     ...
     * @license   GPL-3.0
     */
const Et="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const Nt={name:Et,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,date:t=>t?Tt(t):Tt(),dayjs:Tt};
/**
     * Gantt-Schedule-Timeline-Calendar
     *
     * @copyright Rafal Pospiech <https://neuronet.io>
