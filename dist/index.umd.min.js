...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ListExpander(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c}=t,d=n.getActions("list-expander");let u,h,p,f,m;s(i.subscribe("config.components.ListToggle",t=>m=t));const g=l(m,e.row?{row:e.row}:{});let v;if(s(g.destroy),s(i.subscribe("config.wrappers.ListExpander",t=>v=t)),s(i.subscribe("config.classNames",t=>{u=n.getClass("list-expander"),f=n.getClass("list-expander-padding"),r()})),s(i.subscribeAll(["config.list.expander.padding"],t=>{h=t,r()})),e.row){let t;c(n=>{e=n,t&&t(),t=i.subscribe(`_internal.list.rows.${e.row.id}.parentId`,(function parentChanged(t){p="width:"+e.row._internal.parents.length*h+"px",r()})),g.change(e)}),s((function listExpanderDestroy(){t&&t()}))}else p="width:0px";return s=>v(a`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function bindElementAction(t,e){return e.state.update("_internal.elements.chart-timeline-grid-rows",(function updateGridRows(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-grid-rows",e=>e.filter(e=>e!==t))}}}function ChartTimelineGridRow(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l,onChange:c,styleMap:d}=t;let u;s(i.subscribe("config.wrappers.ChartTimelineGridRow",t=>{u=t,r()}));const h=i.get("config.components.ChartTimelineGridRowBlock"),p=n.getActions("chart-timeline-grid-row");let f=n.getClass("chart-timeline-grid-row"),m={width:e.width+"px",height:e.row.height+"px",opacity:"1",pointerEvents:"all",overflow:"hidden"},g=[];return c((t,n)=>{var s,o,a,c,d,u,p;if(n.leave)return m.opacity="0",m.pointerEvents="none",void r();l(g,(e=t).blocks,t=>t,h),(m={}).opacity="1",m.pointerEvents="all",m.height=e.row.height+"px",m.width=e.width+"px";const f=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(a=null===(o=null===(s=f[t].style)||void 0===s?void 0:s.grid)||void 0===o?void 0:o.row)||void 0===a?void 0:a.children;e&&(m=Object.assign(Object.assign({},m),e))}const v=null===(p=null===(u=null===(d=null===(c=e.row)||void 0===c?void 0:c.style)||void 0===d?void 0:d.grid)||void 0===u?void 0:u.row)||void 0===p?void 0:p.current;v&&(m=Object.assign(Object.assign({},m),v)),r()}),s(()=>{g.forEach(t=>t.destroy())}),-1===p.indexOf(bindElementAction)&&p.push(bindElementAction),s=>u(a`
        <div
          class=${f}
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */const mt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),t=>{e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>e.filter(e=>e!==t),{only:[""]})}),gt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,styleMap:c}=t,d=n.getActions("chart-timeline-grid-row-block");let u;s(i.subscribe("config.wrappers.ChartTimelineGridRowBlock",t=>{u=t,r()}));const h=n.time.date().startOf("day").valueOf();let p,f;const m=t=>{p=n.getClass("chart-timeline-grid-row-block"),f=p+"-content",t.leftGlobal===h&&(p+=" current")};m(e.time);let g={width:"",height:""};return l((t,n)=>{var s,o,a,l,c,d,u;if(n.leave)return;m((e=t).time),(g={}).width=e.time.width+"px",g.height=e.row.height+"px";const h=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(a=null===(o=null===(s=h[t].style)||void 0===s?void 0:s.grid)||void 0===o?void 0:o.block)||void 0===a?void 0:a.children;e&&(g=Object.assign(Object.assign({},g),e))}const p=null===(u=null===(d=null===(c=null===(l=e.row)||void 0===l?void 0:l.style)||void 0===c?void 0:c.grid)||void 0===d?void 0:d.block)||void 0===u?void 0:u.current;p&&(g=Object.assign(Object.assign({},g),p)),r()}),-1===d.indexOf(mt)&&d.push(mt),s=>u(a`
        <div
          class=${p}
          data-actions=${o(d,Object.assign(Object.assign({},e),{api:n,state:i}))}
          style=${c(g)}
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */const vt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-rows",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}),bt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,reuseComponents:c,styleMap:d}=t;let u;s(i.subscribe("config.wrappers.ChartTimelineItemsRow",t=>u=t));const h=i.get("config.components.ChartTimelineItemsRowItem");let p,f,m=`_internal.flatTreeMapById.${e.row.id}._internal.items`,g={opacity:"1",pointerEvents:"all",width:"",height:""},v={width:"",height:""},b=[];const y=()=>{const t=i.get("_internal.chart");if(g.opacity="1",g.pointerEvents="all",g.width=t.dimensions.width+"px",v.width=t.time.totalViewDurationPx+"px",!e)return g.opacity="0",void(g.pointerEvents="none");g.height=e.row.height+"px",g["--row-height"]=e.row.height+"px",v.height=e.row.height+"px"};l((t,n)=>{if(n.leave)return y(),r();(t=>{m=`_internal.flatTreeMapById.${t.id}._internal.items`,"function"==typeof p&&p(),"function"==typeof f&&f(),p=i.subscribe("_internal.chart",(t,e)=>{y(),r()}),f=i.subscribe(m,e=>{b=c(b,e,e=>({row:t,item:e}),h),y(),r()})})((e=t).row)}),s(()=>{f(),p(),b.forEach(t=>t.destroy())});const w=n.getActions("chart-timeline-items-row");let _,$;return s(i.subscribe("config.classNames",()=>{_=n.getClass("chart-timeline-items-row",e),$=n.getClass("chart-timeline-items-row-inner",e),r()})),w.includes(vt)||w.push(vt),s=>u(a`
        <div
          class=${_}
...
/**
     ...
     * @license   GPL-3.0
     */
const Ot="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const Pt={name:Ot,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,date:t=>t?$t(t):$t(),dayjs:$t};
/**
     * Gantt-Schedule-Timeline-Calendar
     *
     * @copyright Rafal Pospiech <https://neuronet.io>
