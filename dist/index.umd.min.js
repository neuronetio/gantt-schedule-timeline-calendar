...
/**
     ...
     */const directive=t=>(...e)=>{const n=t(...e);return n.isDirective=!0,n};class Directive{constructor(){this.isDirective=!0,this.isClass=!0}body(t){}}const isDirective=t=>null!=t&&"boolean"==typeof t.isDirective,t=null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,reparentNodes=(t,e,n=null,i=null)=>{for(;e!==n;){const n=e.nextSibling;t.insertBefore(e,i),e=n}},removeNodes=(t,e,n=null)=>{for(;e!==n;){const n=e.nextSibling;t.removeChild(e),e=n}},e={},n={},i=`{{lit-${String(Math.random()).slice(2)}}}`,s=`\x3c!--${i}--\x3e`,o=new RegExp(`${i}|${s}`),r="$lit$";
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.4");const html=(t,...e)=>new TemplateResult(t,e,"html",f),svg=(t,...e)=>new SVGTemplateResult(t,e,"svg",f);
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ChartCalendar(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,reuseComponents:a,html:l,StyleMap:c}=t,d=n.getActions("chart-calendar"),h=Object.assign(Object.assign({},e),{api:n,state:i}),u=i.get("config.components.ChartCalendarDate");let p,m;s(i.subscribe("config.wrappers.ChartCalendar",t=>p=t)),s(i.subscribe("config.classNames",t=>{m=n.getClass("chart-calendar"),r()}));let f,g=new c({height:"","--headerHeight":""});s(i.subscribe("config.headerHeight",t=>{f=t,g.style.height=f+"px",g.style["--calendar-height"]=f+"px",r()}));let v=[],y=[];s(i.subscribe("_internal.chart.time.dates",t=>{const e=n.time.date().format("YYYY-MM-DD");let i;return"object"==typeof t.day&&Array.isArray(t.day)&&t.day.length&&(i=a(v,t.day,t=>t&&{period:"day",date:t,currentDate:e},u)),"object"==typeof t.month&&Array.isArray(t.month)&&t.month.length&&(i=a(y,t.month,t=>t&&{period:"month",date:t,currentDate:e},u)),r(),i})),d.push(t=>{i.update("_internal.elements.chart-calendar",t)});const b=o.create(d,h);return n=>p(l`
     ...
     */class BindElementAction$2 extends Action{constructor(t,e){super(),e.state.update("_internal.elements.chart-calendar-dates",e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e))}}function ChartCalendarDate(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,onChange:a,html:l,StyleMap:c,Detach:d}=t,h=n.getActions("chart-calendar-date");let u;s(i.subscribe("config.wrappers.ChartCalendarDate",t=>u=t));let p=n.getClass("chart-calendar-date",e),m="";m=n.time.date(e.date.leftGlobal).format("YYYY-MM-DD")===e.currentDate?" current":"";let f,g,v=new c({width:"","margin-left":"",visibility:"visible"}),y=new c({overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"});const updateDate=()=>{if(!e)return;f=i.get("_internal.chart.time"),v.style.width=e.date.width+"px",v.style["margin-left"]=-e.date.subPx+"px",v.style.visibility="visible",y.style={overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"};const t=n.time.date(e.date.leftGlobal);m=t.format("YYYY-MM-DD")===e.currentDate?" current":t.subtract(1,"days").format("YYYY-MM-DD")===e.currentDate?" next":t.add(1,"days").format("YYYY-MM-DD")===e.currentDate?" previous":"";const s=f.maxWidth[e.period];switch(e.period){case"month":g=l`
        ...
        `,s>=40&&s<50)g=l`
          ...
          `}else if(s>=1e3&&s<2e3){const e=[],n=t.startOf("day");for(let t=0;t<24;t++){const i=n.add(t,"hours"),s=(n.add(t,"hours").endOf("hour").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _1000"+m} style=${y}>
              ${t.format("DD dddd")}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+m}>
              ${e.map(t=>l`
          ...
          `}else if(s>=2e3&&s<5e3){const e=[],n=t.startOf("day");for(let t=0;t<48;t++){const i=n.add(30*t,"minutes"),s=(n.add(30*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _2000"+m} style=${y}>
              ${t.format("DD dddd")}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+m}>
              ${e.map(t=>l`
          ...
          `}else if(s>=5e3&&s<2e4){const e=[],n=t.startOf("day");for(let t=0;t<96;t++){const i=n.add(15*t,"minutes"),s=(n.add(15*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _5000"+m} style=${y}>
              ${t.format("DD dddd")}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+m}>
              ${e.map(t=>l`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function ChartTimelineItems(t,e={}){const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,reuseComponents:l,StyleMap:c}=t,d=n.getActions("chart-timeline-items");let h;s(i.subscribe("config.wrappers.ChartTimelineItems",t=>h=t));const u=i.get("config.components.ChartTimelineItemsRow");let p;s(i.subscribe("config.classNames",()=>{p=n.getClass("chart-timeline-items"),r()}));let m=new c({},!0);s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","config.scroll.compensation","_internal.chart.time.dates.day"],(function calculateStyle(){const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height"),s=n.getCompensationY(),o=n.getCompensationX();m.style.width=t+o+"px",m.style.height=e+Math.abs(s)+"px"})));let f=[];s(i.subscribeAll(["_internal.list.visibleRows;","config.chart.items"],(function createRowComponents(){const t=i.get("_internal.list.visibleRows"),e=l(f,t||[],t=>({row:t}),u);return r(),e})));const g=o.create(d,{api:n,state:i});return n=>h(a`
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */class BindElementAction$7{constructor(t,e){let n=!1,i=e.state.get("_internal.elements.chart-timeline-items-row-items");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("_internal.elements.chart-timeline-items-row-items",i,{only:null})}destroy(t,e){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}}function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,Detach:o,Actions:r,update:a,html:l,onChange:c,unsafeHTML:d,StyleMap:h}=t;let u;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>u=t));let p=new h({width:"",height:"",left:""}),m=0,f=0,g=!1;const v={item:e.item,row:e.row,left:m,width:f,api:n,state:i};let y=!1;function updateItem(){var t,s,o,r,l,c,d,h,u,b,w;if(g)return;let _=i.get("_internal.chart.time");m=(e.item.time.start-_.leftGlobal)/_.timePerPixel,m=.1*Math.round(10*m),f=(e.item.time.end-e.item.time.start)/_.timePerPixel,f-=i.get("config.chart.spacing")||0,f&&(f=.1*Math.round(10*f));const x=p.style.width,$=p.style.left,C=n.getCompensationX();p.setStyle({});const M=n.isItemInViewport(e.item,_.leftGlobal,_.rightGlobal);y=!M,M?(p.style.width=f+"px",p.style.left=m+C+"px"):(p.style.width=x,p.style.left=$);const P=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(r=null===(o=null===(s=null===(t=P[n])||void 0===t?void 0:t.style)||void 0===s?void 0:s.items)||void 0===o?void 0:o.item)||void 0===r?void 0:r.children;e&&p.setStyle(Object.assign(Object.assign({},p.style),e))}const O=null===(u=null===(h=null===(d=null===(c=null===(l=e)||void 0===l?void 0:l.row)||void 0===c?void 0:c.style)||void 0===d?void 0:d.items)||void 0===h?void 0:h.item)||void 0===u?void 0:u.current;O&&p.setStyle(Object.assign(Object.assign({},p.style),O));const T=null===(w=null===(b=e)||void 0===b?void 0:b.item)||void 0===w?void 0:w.style;T&&p.setStyle(Object.assign(Object.assign({},p.style),T)),v.left=m+C,v.width=f,a()}const b="chart-timeline-items-row-item";c((function onPropsChange(t,n){if(n.leave||void 0===t.row||void 0===t.item)return g=!0,y=!0,a();y=!1,g=!1,e=t,v.item=e.item,v.row=e.row,updateItem()}));const w=n.getActions(b);let _,x;s(i.subscribe("config.classNames",()=>{_=n.getClass(b,e),x=n.getClass(b+"-label",e),a()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()})),w.push(BindElementAction$7);const $=r.create(w,v),C=new o(()=>y);return n=>u(l`
