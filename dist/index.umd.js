...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,ChartCalendarDate:function({date:t},e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a}=e,l="chart-calendar-date",c=n.getActions(l);let d,h,u,p,f,m,g,b,v,y,w,_,$,x,M,C;return s(i.subscribe("config.wrappers.ChartCalendarDate",t=>d=t)),s(i.subscribe("config.classNames",()=>{h=n.getClass(l,{date:t}),n.time.date(t.leftGlobal).format("YYYY-MM-DD")===n.time.date().format("YYYY-MM-DD")&&(h+=" current"),n.time.date(t.leftGlobal).subtract(1,"day").format("YYYY-MM-DD")===n.time.date().format("YYYY-MM-DD")&&(h+=" next"),n.time.date(t.leftGlobal).add(1,"day").format("YYYY-MM-DD")===n.time.date().format("YYYY-MM-DD")&&(h+=" previous"),u=n.getClass(`${l}-formatted`,{date:t}),p=n.getClass(`${l}-formatted-year`,{date:t}),f=n.getClass(`${l}-formatted-month`,{date:t}),m=n.getClass(`${l}-formatted-day`,{date:t}),g=n.getClass(`${l}-formatted-day-word`,{date:t}),r()})),s(i.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],(function(){b=i.get("_internal.chart.time"),C=b.zoom<=22?18:13;const e=n.time.date(t.leftGlobal),s=b.maxWidth[b.period];v=s<=40;const o=i.get("config.chart.calendar.vertical.smallFormat");y=e.format(o),w=e.format("YYYY"),_=e.format("MMMM"),$=e.format("DD"),x=e.format("dddd"),s<=70?(w=e.format("YY"),_=e.format("MMM"),$=e.format("DD"),x=e.format("ddd")):s<=150&&(x=e.format("ddd")),M=`width: ${t.width}px; margin-left:-${t.subPx}px; --day-size: ${C}px`,r()}),{bulk:!0})),s=>d(a`
