...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */const N=new class{handleAttributeExpressions(t,e,n,s){const i=e[0];if("."===i){return new O(t,e.slice(1),n).parts}return"@"===i?[new D(t,e.slice(1),s.eventContext)]:"?"===i?[new P(t,e.slice(1),n)]:new x(t,e,n).parts}handleTextExpression(t){return new M(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
