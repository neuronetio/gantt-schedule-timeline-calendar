...
/**
     ...
     * http://polymer.github.io/PATENTS.txt
     */
var H=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},s("next"),s("throw"),s("return"),e[Symbol.asyncIterator]=function(){return this},e);function s(n){e[n]=t[n]&&function(e){return new Promise((function(s,i){(function(t,e,n,s){Promise.resolve(s).then((function(e){t({value:e,done:n})}),e)})(s,i,(e=t[n](e)).done,e.value)}))}}};const j=e((t,e)=>async n=>{var s,i;if(!(n instanceof M))throw new Error("asyncAppend can only be used in text bindings");if(t===n.value)return;let o;n.value=t;let r=0;try{for(var a,l=H(t);!(a=await l.next()).done;){let s=a.value;if(n.value!==t)break;0===r&&n.clear(),void 0!==e&&(s=e(s,r));let i=n.startNode;void 0!==o&&(i=m(),o.endNode=i,n.endNode.parentNode.insertBefore(i,n.endNode)),(o=new M(n.options)).insertAfterNode(i),o.setValue(s),o.commit(),r++}}catch(t){s={error:t}}finally{try{a&&!a.done&&(i=l.return)&&await i.call(l)}finally{if(s)throw s.error}}});
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function Yt(t,e){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,createComponent:l,onChange:c}=t;let d,u;i(s.subscribe("config.wrappers.ListColumnRow",t=>d=t)),i(s.subscribe("config.components.ListExpander",t=>u=t));let h,p,f,m,g=`_internal.flatTreeMapById.${e.rowId}`,b=s.get(g),v=`config.list.columns.data.${e.columnId}`,y=s.get(v);c(({rowId:t,columnId:e})=>{p&&p(),f&&f(),g=`_internal.flatTreeMapById.${t}`,v=`config.list.columns.data.${e}`,p=s.subscribe(g,t=>{h=`--height: ${(b=t).height}px;`;for(let t of b._internal.parents){const e=s.get(`_internal.flatTreeMapById.${t}`);"object"==typeof e.style&&"Object"===e.style.constructor.name&&"string"==typeof e.style.children&&(h+=e.style.children)}"object"==typeof b.style&&"Object"===b.style.constructor.name&&"string"==typeof b.style.current&&(h+=b.style.current),r()}),m&&m.destroy(),m=l(u,{row:b}),f=s.subscribe(v,t=>{y=t,r()})}),i(()=>{m&&m.destroy(),f(),p()});const w=n.getActions("list-column-row");let _;return i(s.subscribe("config.classNames",t=>{_=n.getClass("list-column-row"),r()})),i=>d(a`
        <div
          class=${_}
          style=${h}
          data-actions=${o(w,{column:y,row:b,api:n,state:s})}
        >
      ...
      `:a`
      ${b[y.data]}
    `:"function"==typeof y.data?y.data(b):b[y.data]}
        </div>
      `,{vido:t,props:e,templateProps:i})}
/**
...
/**
     ...
     * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
     * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
     */function Jt(t,e){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,createComponent:l}=t,c=n.getActions("chart-timeline");let d;i(s.subscribe("config.wrappers.ChartTimeline",t=>d=t));const u=s.get("config.components.ChartTimelineGrid"),h=s.get("config.components.ChartTimelineItems"),p=l(u);i(p.destroy);const f=l(h);let m,g;i(f.destroy),i(s.subscribe("config.classNames",()=>{m=n.getClass("chart-timeline"),g=n.getClass("chart-timeline-inner"),r()}));let b="",v="";return i(s.subscribeAll(["_internal.height","_internal.list.rowsHeight","config.scroll.compensation"],()=>{b=`height: ${s.get("_internal.height")}px`;const t=s.get("config.scroll.compensation");v=`height: ${s.get("_internal.list.rowsHeight")}px; margin-top:${t}px;`,r()})),c.push(t=>{s.update("_internal.elements.gantt",t)}),s=>d(a`
        <div class=${m} style=${b} data-actions=${o(c)} @wheel=${n.onScroll}>
          <div class=${g} style=${v}>
            ${p.html()}${f.html()}
          </div>
        </div>
