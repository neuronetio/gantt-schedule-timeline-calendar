...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */const v=` ${l} `;class y{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let i=0;i<t;i++){const t=this.strings[i],s=t.lastIndexOf("\x3c!--");n=(s>-1||n)&&-1===t.indexOf("--\x3e",s+1);const o=g.exec(t);e+=null===o?t+(n?v:c):t.substr(0,o.index)+o[1]+o[2]+h+o[3]+l}return e+=this.strings[t]}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class w extends y{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,n=e.firstChild;return e.removeChild(n),s(e,n.firstChild),t}}
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * subject to an additional IP rights grant found at
     * http://polymer.github.io/PATENTS.txt
     */const D=new class{handleAttributeExpressions(t,e,n,i){const s=e[0];if("."===s){return new P(t,e.slice(1),n).parts}return"@"===s?[new I(t,e.slice(1),i.eventContext)]:"?"===s?[new T(t,e.slice(1),n)]:new x(t,e,n).parts}handleTextExpression(t){return new C(t)}};
/**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
...
/**
     ...
     * @license   GPL-3.0
     */
const Dt=["","list","list-column","list-column-header","list-expander","list-expander-toggle","list-column-header-resizer","list-column-row","chart","chart-calendar","chart-calendar-date","chart-timeline","chart-timeline-grid","chart-timeline-grid-row","chart-timeline-items","chart-timeline-items-row","chart-timeline-items-row-item","chart-timeline-grid-column","chart-timeline-grid-block"];const Lt={height:740,headerHeight:86,components:{Main:Ot,List:function(t){const{api:e,state:n,onDestroy:i,actions:s,update:o,createComponent:r,html:a,repeat:l}=t,c=e.getActions("list");let d,h,u,p,f;i(n.subscribe("config.wrappers.List",t=>d=t)),i(n.subscribe("config.components.ListColumn",t=>h=t)),i(n.subscribe("config.list",()=>{p=n.get("config.list"),f=p.columns.percent,o()})),i(n.subscribe("config.classNames",()=>{u=e.getClass("list",{list:p}),o()}));let m,g,b,v=[];function y(t){if(t.stopPropagation(),t.preventDefault(),"scroll"===t.type)n.update("config.scroll.top",t.target.scrollTop);else{const i=e.normalizeMouseWheelEvent(t);n.update("config.scroll.top",t=>e.limitScroll("top",t+=i.y*n.get("config.scroll.yMultiplier")))}}function w(t){b||(b=t.clientWidth,0===f&&(b=0),n.update("_internal.list.width",b),n.update("_internal.elements.list",t))}return i(n.subscribe("config.list.columns.data;",t=>{v.forEach(t=>t.component.destroy()),m=Object.keys(t),v=m.map(t=>{return{id:t,component:r(h,{columnId:t})}}),o()})),i(()=>{v.forEach(t=>t.component.destroy())}),i(n.subscribe("config.height",t=>{g=`height: ${t}px`,o()})),c.push(t=>(n.update("_internal.elements.list",t),w(t),{update:w})),e=>d(p.columns.percent>0?a`
            <div
              class=${u}
              data-actions=${s(c)}
              style=${g}
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,ListColumnHeader:function({columnId:t},e){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,html:l}=e;let c;s(i.subscribe("config.wrappers.ListColumnHeader",t=>c=t));const d=n.getActions("list-column-header");let h;s(i.subscribe("config.components.ListColumnHeaderResizer",t=>h=t));const u=a(h,{columnId:t});let p;s(u.destroy),s(i.subscribe("config.components.ListExpander",t=>p=t));const f=a(p,{});let m,g,b,v;return s(f.destroy),s(i.subscribe(`config.list.columns.data.${t}`,t=>{m=t,r()})),s(i.subscribeAll(["config.classNames","config.headerHeight"],()=>{const t=i.get("config");g=n.getClass("list-column-header",{column:m}),b=n.getClass("list-column-header-content",{column:m}),v=`--height: ${t.headerHeight}px;`,r()})),s=>c(l`
        <div class=${g} style=${v} data-actions=${o(d,{column:m,api:n,state:i})}>
...
/**
     ...
     */,ListColumnHeaderResizer:function({columnId:t},e){const{api:n,state:i,onDestroy:s,update:o,html:r,actions:a}=e,l="list-column-header-resizer",c=n.getActions(l);let d,h,u,p,f,m,g,b,v;s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>d=t)),s(i.subscribe(`config.list.columns.data.${t}`,t=>{h=t,o()}));let y=!1;s(i.subscribe("config.classNames",t=>{u=n.getClass(l,{column:h}),p=n.getClass(l+"-container",{column:h}),f=n.getClass(l+"-dots",{column:h}),m=n.getClass(l+"-dots-dot",{column:h}),g=n.getClass(l+"-line",{column:h}),o()})),s(i.subscribeAll([`config.list.columns.data.${h.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");b=h.width*n.columns.percent*.01,v=`width: ${n.columns.resizer.width}px`,y=n.columns.resizer.inRealTime,o()}));let w=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{w=[];for(let e=0;e<t;e++)w.push(e);o()}));let _=!1,$=b;const x=`config.list.columns.data.${h.id}.width`;function M(t){_=!0,i.update("_internal.list.columns.resizer.active",!0)}function C(t){_&&(($+=t.movementX)<0&&($=0),y&&i.update(x,$))}function T(t){_&&(i.update("_internal.list.columns.resizer.active",!1),i.update(x,$),_=!1)}return document.body.addEventListener("mousemove",C),s(()=>document.body.removeEventListener("mousemove",C)),document.body.addEventListener("mouseup",T),s(()=>document.body.removeEventListener("mouseup",T)),s=>d(r`
        <div class=${u} data-actions=${a(c,{column:h,api:n,state:i})}>
          ...
          <div class=${f} style=${"--"+v} @mousedown=${M}>
            ${w.map(t=>r`
                  <div class=${m} />
                `)}
          </div>
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,ListColumnRow:function({rowId:t,columnId:e},n){const{api:i,state:s,onDestroy:o,actions:r,update:a,html:l,createComponent:c}=n;let d,h;o(s.subscribe("config.wrappers.ListColumnRow",t=>d=t)),o(s.subscribe("config.components.ListExpander",t=>h=t));let u,p,f=`config.list.rows.${t}`;o(s.subscribe(f,t=>{p=`--height: ${(u=t).height}px;`;for(let t of u._internal.parents){const e=s.get("config.list.rows."+t);"object"==typeof e.style&&"Object"===e.style.constructor.name&&"string"==typeof e.style.children&&(p+=e.style.children)}"object"==typeof u.style&&"Object"===u.style.constructor.name&&"string"==typeof u.style.current&&(p+=u.style.current),a()}));const m=c(h,{row:u});o(m.destroy);let g,b=`config.list.columns.data.${e}`;o(s.subscribe(b,t=>{g=t,a()}));const v=i.getActions("list-column-row");let y;return o(s.subscribe("config.classNames",t=>{y=i.getClass("list-column-row",{row:u,column:g}),a()})),o=>d(l`
        <div
          class=${y}
          style=${p}
          data-actions=${r(v,{column:g,row:u,api:i,state:s})}
        >
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,ListExpander:function(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l}=e,c=n.getActions("list-expander");let d,h,u,p,f,m=[];s(i.subscribe("config.components.ListToggle",t=>f=t));const g=l(f,t.row?{row:t.row}:{});let b;return s(g.destroy),s(i.subscribe("config.wrappers.ListExpander",t=>b=t)),s(i.subscribe("config.classNames",e=>{t.row?(d=n.getClass("list-expander",{row:t.row}),p=n.getClass("list-expander-padding",{row:t.row})):(d=n.getClass("list-expander"),p=n.getClass("list-expander-padding")),r()})),s(i.subscribeAll(["config.list.expander.padding"],t=>{h=t,r()})),t.row?s(i.subscribe(`_internal.list.rows.${t.row.id}.parentId`,e=>{u="width:"+t.row._internal.parents.length*h+"px",m=t.row._internal.children,r()})):(u="width:0px",m=[]),s=>b(a`
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,ListToggle:function(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,unsafeHTML:l}=e,c="list-expander-toggle";let d;s(i.subscribe("config.wrappers.ListToggle",t=>d=t));const h=n.getActions(c);let u,p,f,m,g,b,v=!1;function y(){v=!v,t.row?i.update(`config.list.rows.${t.row.id}.expanded`,v):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=v;return t},{only:["*.expanded"]})}return s(i.subscribe("config.classNames",e=>{t.row?(u=n.getClass(c,{row:t.row}),f=n.getClass(c+"-open",{row:t.row}),m=n.getClass(c+"-closed",{row:t.row})):(u=n.getClass(c),f=n.getClass(c+"-open"),m=n.getClass(c+"-closed")),r()})),s(i.subscribeAll(["config.list.expander.size","config.list.expander.icons"],()=>{const t=i.get("config.list.expander");p=`--size: ${t.size}px`,g=t.icons.open,b=t.icons.closed,r()})),t.row?s(i.subscribe(`config.list.rows.${t.row.id}.expanded`,t=>{v=t,r()})):s(i.subscribe("config.list.rows.*.expanded",t=>{for(const e of t)if(e.value){v=!0;break}r()},{bulk:!0})),s=>d(a`
        <div
          class=${u}
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,Chart:function(t){const{api:e,state:n,onDestroy:i,actions:s,update:o,html:r,createComponent:a}=t,l=n.get("config.components.ChartCalendar"),c=n.get("config.components.ChartTimeline"),d=a(l);i(d.destroy);const h=a(c);i(h.destroy);let u,p,f,m,g="",b="",v=e.getActions("chart");i(n.subscribe("config.classNames",t=>{u=e.getClass("chart"),p=e.getClass("horizontal-scroll"),f=e.getClass("horizontal-scroll-inner"),o()})),i(n.subscribe("config.scroll.left",t=>{m&&m.scrollLeft!==t&&(m.scrollLeft=t),o()})),i(n.subscribeAll(["_internal.chart.dimensions.width","_internal.chart.time.totalViewDurationPx"],(function(t,e){g=`width: ${n.get("_internal.chart.dimensions.width")}px`,b=`width: ${n.get("_internal.chart.time.totalViewDurationPx")}px; height:1px`,o()})));const y={handleEvent(t){let i,s;if(t.stopPropagation(),t.preventDefault(),"scroll"===t.type)n.update("config.scroll.left",t.target.scrollLeft),i=t.target.scrollLeft;else{const o=e.normalizeMouseWheelEvent(t),r=n.get("config.scroll.xMultiplier"),a=n.get("config.scroll.yMultiplier");t.shiftKey&&o.y?n.update("config.scroll.left",t=>i=e.limitScroll("left",t+=o.y*r)):o.x?n.update("config.scroll.left",t=>i=e.limitScroll("left",t+=o.x*r)):n.update("config.scroll.top",t=>s=e.limitScroll("top",t+=o.y*a))}const o=n.get("_internal.elements.chart"),r=n.get("_internal.elements.horizontalScrollInner");if(o){const t=n.get("config.scroll.left");let e=0;t&&(e=Math.round(t/(r.clientWidth-o.clientWidth)*100))>100&&(e=100),n.update("config.scroll.percent.left",e)}},passive:!1};function w(t){m=t,n.update("_internal.elements.horizontalScroll",t)}function _(t){n.update("_internal.elements.horizontalScrollInner",t)}return v.push(t=>{n.update("_internal.elements.chart",t)}),t=>r`
    <div class=${u} data-actions=${s(v,{api:e,state:n})} @wheel=${y}>
      ${d.html()}${h.html()}
      <div class=${p} style=${g} data-actions=${s([w])} @scroll=${y}>
        <div class=${f} style=${b} data-actions=${s([_])} />
      </div>
    </div>
  `}
/**
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,ChartCalendarDate:function({date:t},e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a}=e,l="chart-calendar-date",c=n.getActions(l);let d,h,u,p,f,m,g,b,v,y,w,_,$,x,M,C;return s(i.subscribe("config.wrappers.ChartCalendarDate",t=>d=t)),s(i.subscribe("config.classNames",()=>{h=n.getClass(l,{date:t}),n.time.date(t.leftGlobal).format("YYYY-MM-DD")===n.time.date().format("YYYY-MM-DD")&&(h+=" current"),n.time.date(t.leftGlobal).subtract(1,"day").format("YYYY-MM-DD")===n.time.date().format("YYYY-MM-DD")&&(h+=" next"),n.time.date(t.leftGlobal).add(1,"day").format("YYYY-MM-DD")===n.time.date().format("YYYY-MM-DD")&&(h+=" previous"),u=n.getClass(`${l}-formatted`,{date:t}),p=n.getClass(`${l}-formatted-year`,{date:t}),f=n.getClass(`${l}-formatted-month`,{date:t}),m=n.getClass(`${l}-formatted-day`,{date:t}),g=n.getClass(`${l}-formatted-day-word`,{date:t}),r()})),s(i.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],(function(){b=i.get("_internal.chart.time"),C=b.zoom<=22?18:13;const e=n.time.date(t.leftGlobal),s=b.maxWidth;v=s<=40;const o=i.get("config.chart.calendar.vertical.smallFormat");y=e.format(o),w=e.format("YYYY"),_=e.format("MMMM"),$=e.format("DD"),x=e.format("dddd"),s<=70?(w=e.format("YY"),_=e.format("MMM"),$=e.format("DD"),x=e.format("ddd")):s<=150&&(x=e.format("ddd")),M=`width: ${t.width}px; margin-left:-${t.subPx}px; --day-size: ${C}px`,r()}),{bulk:!0})),s=>d(a`
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,ChartTimeline:function(t){const{api:e,state:n,onDestroy:i,actions:s,update:o,html:r,createComponent:a}=t,l=e.getActions("chart-timeline");let c;i(n.subscribe("config.wrappers.ChartTimeline",t=>c=t));const d=n.get("config.components.ChartTimelineGrid"),h=n.get("config.components.ChartTimelineItems"),u=a(d);i(u.destroy);const p=a(h);let f,m;i(p.destroy),i(n.subscribe("config.classNames",t=>{f=e.getClass("chart-timeline"),m=e.getClass("chart-timeline-inner"),o()}));let g="",b="";return i(n.subscribeAll(["_internal.height","_internal.list.rowsHeight"],()=>{g=`height: ${n.get("_internal.height")}px`,b=`height: ${n.get("_internal.list.rowsHeight")}px;`,o()})),l.push(t=>{n.update("_internal.elements.gantt",t)}),n=>c(r`
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,ChartTimelineGrid:function(t){const{api:e,state:n,onDestroy:i,actions:s,update:o,html:r,createComponent:a,repeat:l}=t,c=e.getActions("chart-timeline-grid");let d;i(n.subscribe("config.wrappers.ChartTimelineGrid",t=>d=t));const h=n.get("config.components.ChartTimelineGridRow");let u,p,f,m;i(n.subscribe("config.classNames",()=>{u=e.getClass("chart-timeline-grid"),o()})),i(n.subscribe("_internal.height",t=>{f=`height: ${p=t}px`,o()})),i(n.subscribe("config.chart.time.period",t=>m=t));let g,b=[];return i(n.subscribeAll([`_internal.chart.time.dates.${m}`,"_internal.list.visibleRows","config.chart.grid.block"],(function(){const t=n.get("_internal.list.visibleRows"),e=n.get(`_internal.chart.time.dates.${m}`);if(!e)return;b.forEach(t=>t.component.destroy()),b=[];let i=0;g=[];for(const n in t){const s=t[n],r=[];let l=0;for(const t of e)r.push({id:l++,date:t,row:s,top:i});const c={id:s.id,blocks:r,rowData:s,top:i};g.push(c),b.push({id:s.id,component:a(h,{row:c})}),i+=s.height,o()}}),{bulk:!0})),c.push(t=>{n.update("_internal.elements.grid")}),i(()=>{b.forEach(t=>t.component.destroy())}),i=>d(r`
...
/**
     ...
     * @package   gantt-schedule-timeline-calendar
     * @license   GPL-3.0
     */,ChartTimelineItemsRowItem:function({rowId:t,itemId:e},n){const{api:i,state:s,onDestroy:o,actions:r,update:a,html:l}=n;let c;o(s.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>c=t));let d,h=`config.list.rows.${t}`;o(s.subscribe(h,t=>{d=t,a()}));let u,p=`config.chart.items.${e}`;o(s.subscribe(p,t=>{u=t,a()}));const f="chart-timeline-items-row-item",m=i.getActions(f);let g,b,v;o(s.subscribe("config.classNames",()=>{g=i.getClass(f,{row:d,item:u}),b=i.getClass(f+"-content",{row:d,item:u}),v=i.getClass(f+"-content-label",{row:d,item:u}),a()}));let y,w="",_=0,$=0;return o(s.subscribeAll(["_internal.chart.time","config.scroll",p],t=>{u=s.get(p);let e=s.get("_internal.chart.time");_=(u.time.start-e.leftGlobal)/e.timePerPixel,$=(u.time.end-u.time.start)/e.timePerPixel,$-=s.get("config.chart.spacing");i.isItemInViewport(u,e.leftGlobal,e.rightGlobal);y=`left:${_}px;width:${$}px;`,"object"==typeof u.style&&"Object"===u.style.constructor.name&&"string"==typeof u.style.current&&(w+=u.style.current),a()},{bulk:!0})),o=>c(l`
    <div
      class=${g}
