 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnHeader(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,html:l,cache:c}=t;let d;s(i.subscribe("config.wrappers.ListColumnHeader",t=>d=t));const h=n.getActions("list-column-header");let u;s(i.subscribe("config.components.ListColumnHeaderResizer",t=>u=t));const p=a(u,{columnId:e.columnId});let f;s(p.destroy),s(i.subscribe("config.components.ListExpander",t=>f=t));const m=a(f,{});let g,v,b,y;s(m.destroy),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{g=t,r()})),s(i.subscribeAll(["config.classNames","config.headerHeight"],()=>{const t=i.get("config");v=n.getClass("list-column-header",{column:g}),b=n.getClass("list-column-header-content",{column:g}),y=`--height: ${t.headerHeight}px;height:${t.headerHeight}px;`,r()}));const w={column:g,api:n,state:i};return n=>d(l`
        <div class=${v} style=${y} data-actions=${o(h,w)}>
          ${c("boolean"==typeof g.expander&&g.expander?function withExpander(){return l`
      <div class=${b}>
        ${m.html()}${p.html(g)}
      </div>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:s,update:o,html:r,actions:a,text:l,cache:c}=t,d="list-column-header-resizer",h=n.getActions(d);let u,p,f,m,g,v,b,y,w;s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>u=t)),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{p=t,o()}));let _=!1;s(i.subscribe("config.classNames",t=>{f=n.getClass(d,{column:p}),m=n.getClass(d+"-container",{column:p}),g=n.getClass(d+"-dots",{column:p}),v=n.getClass(d+"-dots-dot",{column:p}),b=n.getClass(d+"-line",{column:p}),o()})),s(i.subscribeAll([`config.list.columns.data.${p.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");y=p.width*n.columns.percent*.01,w=`width: ${n.columns.resizer.width}px`,_=n.columns.resizer.inRealTime,o()}));let $=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{$=[];for(let e=0;e<t;e++)$.push(e);o()}));let x=!1,C=y;const M=`config.list.columns.data.${p.id}.width`;function onMouseDown(t){x=!0,i.update("_internal.list.columns.resizer.active",!0)}function onMouseMove(t){if(x){let e=i.get("config.list.columns.minWidth");"number"==typeof p.minWidth&&(e=p.minWidth),(C+=t.movementX)<e&&(C=e),_&&i.update(M,C)}}function onMouseUp(t){x&&(i.update("_internal.list.columns.resizer.active",!1),i.update(M,C),x=!1)}document.body.addEventListener("mousemove",onMouseMove),s(()=>document.body.removeEventListener("mousemove",onMouseMove)),document.body.addEventListener("mouseup",onMouseUp),s(()=>document.body.removeEventListener("mouseup",onMouseUp));const O={column:p,api:n,state:i};return n=>u(r`
        <div class=${f} data-actions=${a(h,O)}>
          <div class=${m}>
            ${c(p.header.html?r`
                    ${p.header.html}
                  `:l(p.header.content))}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnRow(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c,styleMap:d,text:h,cache:u}=t;let p,f;s(i.subscribe("config.wrappers.ListColumnRow",t=>p=t)),s(i.subscribe("config.components.ListExpander",t=>f=t));let m,g,v=`_internal.flatTreeMapById.${e.rowId}`,b=i.get(v),y=`config.list.columns.data.${e.columnId}`,w=i.get(y),_={opacity:"1",pointerEvents:"all",height:"","--height":"","--expander-padding-width":"","--expander-size":""};const $=l(f,{row:b});c((t,n)=>{if(n.leave)return _.opacity="0",_.pointerEvents="none",void r();const s=(e=t).rowId,o=e.columnId;m&&m(),g&&g(),v=`_internal.flatTreeMapById.${s}`,y=`config.list.columns.data.${o}`,m=i.subscribeAll([v,"config.list.expander"],t=>{b=i.get(v);const e=i.get("config.list.expander");(_={}).opacity="1",_.pointerEvents="all",_.height=b.height+"px",_["--height"]=b.height+"px",_["--expander-padding-width"]=e.padding*(b._internal.parents.length+1)+"px";for(let t of b._internal.parents){const e=i.get(`_internal.flatTreeMapById.${t}`);"object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children&&(_=Object.assign(Object.assign({},_),e.style.children))}"object"==typeof b.style&&"Object"===b.style.constructor.name&&"object"==typeof b.style.current&&(_=Object.assign(Object.assign({},_),b.style.current)),r()}),$&&$.change({row:b}),g=i.subscribe(y,t=>{w=t,r()})}),s(()=>{$&&$.destroy(),g(),m()});const x=n.getActions("list-column-row");let C;s(i.subscribe("config.classNames",t=>{C=n.getClass("list-column-row"),r()}));const M={column:w,row:b,api:n,state:i};return n=>p(a`
        <div class=${C} style=${d(_)} data-actions=${o(x,M)}>
          ${u(w.expander?$.html():null)}
          <div class=${C+"-content"}>
            ${u("string"==typeof w.html?function getHtml(){return"function"==typeof w.data?a`
        ${w.data(b)}
      `:a`
      ${b[w.data]}
    `}():h(function getText(){return"function"==typeof w.data?w.data(b):b[w.data]}()))}
          </div>
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListExpander(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c}=t,d=n.getActions("list-expander");let h,u,p;s(i.subscribe("config.components.ListToggle",t=>p=t));const f=l(p,e.row?{row:e.row}:{});let m;if(s(f.destroy),s(i.subscribe("config.wrappers.ListExpander",t=>m=t)),s(i.subscribe("config.classNames",t=>{h=n.getClass("list-expander"),u=n.getClass("list-expander-padding"),r()})),e.row){c(t=>{e=t,f.change(e)}),s((function listExpanderDestroy(){}))}const g={row:e.row,api:n,state:i};return n=>m(a`
        <div class=${h} data-action=${o(d,g)}>
          <div class=${u}></div>
          ${f.html()}
        </div>
      `,{vido:t,props:e,templateProps:n})}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListToggle(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,unsafeHTML:l,onChange:c}=t,d="list-expander-toggle";let h;s(i.subscribe("config.wrappers.ListToggle",t=>h=t));const u=n.getActions(d);let p,f,m,g,v,b,y,w=!1;if(s(i.subscribe("config.classNames",t=>{p=n.getClass(d),f=n.getClass(d+"-child"),m=n.getClass(d+"-open"),g=n.getClass(d+"-closed"),r()})),s(i.subscribe("config.list.expander.icons",()=>{const t=i.get("config.list.expander");v=t.icons.child,b=t.icons.open,y=t.icons.closed,r()})),e.row){function expandedChange(t){w=t,r()}let t;function onPropsChange(n){e=n,t&&t(),t=i.subscribe(`config.list.rows.${e.row.id}.expanded`,expandedChange)}c(onPropsChange),s((function listToggleDestroy(){t&&t()}))}else{function expandedChange(t){for(const e of t)if(e.value){w=!0;break}r()}s(i.subscribe("config.list.rows.*.expanded",expandedChange,{bulk:!0}))}function toggle(){w=!w,e.row?i.update(`config.list.rows.${e.row.id}.expanded`,w):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=w;return t},{only:["*.expanded"]})}const _={row:e.row,api:n,state:i};return n=>h(a`
        <div class=${p} data-actions=${o(u,_)} @click=${toggle}>
          ${(()=>{var t,n,i;return 0===(null===(i=null===(n=null===(t=e.row)||void 0===t?void 0:t._internal)||void 0===n?void 0:n.children)||void 0===i?void 0:i.length)?a`
        <div class=${f}>
          ${l(v)}
        </div>
      `:w?a`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartCalendarDate(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,onChange:a,html:l,styleMap:c,text:d}=t,h=n.getActions("chart-calendar-date");let u;s(i.subscribe("config.wrappers.ChartCalendarDate",t=>u=t));let p=n.getClass("chart-calendar-date",e),f="";f=n.time.date(e.date.leftGlobal).format("YYYY-MM-DD")===e.currentDate?" current":"";let m,g,v={width:"","margin-left":"",visibility:"visible"};const b=()=>{if(!e)return;m=i.get("_internal.chart.time"),v.width=e.date.width+"px",v["margin-left"]=-e.date.subPx+"px",v.visibility="visible";const t=n.time.date(e.date.leftGlobal);f=t.format("YYYY-MM-DD")===e.currentDate?" current":t.subtract(1,"days").format("YYYY-MM-DD")===e.currentDate?" next":t.add(1,"days").format("YYYY-MM-DD")===e.currentDate?" previous":"";const s=m.maxWidth[e.period];switch(e.period){case"month":g=l`
          <div
            class=${p+"-content "+p+"-content--month"+f}
            style="margin-left:${e.date.subPx}"
          >
            ${d(t.format("MMMM YYYY"))}
          </div>
        `,s<=100&&(g=l`
            <div class=${p+"-content "+p+"-content--month"+f}>
              ${d(t.format("MMM'YY"))}
            </div>
          `);break;case"day":if(g=l`
          <div class=${p+"-content "+p+"-content--day _0"+f}>
            <div class=${p+"-content "+p+"-content--day-small"+f}>
              ${d(t.format("DD"))} ${d(t.format("ddd"))}
            </div>
          </div>
        `,s>=40&&s<50&&(g=l`
            <div class=${p+"-content "+p+"-content--day _40"+f}>
              ${d(t.format("DD"))}
            </div>
            <div class=${p+"-content "+p+"-content--day-word"+f}>
              ${d(t.format("dd"))}
            </div>
          `),s>=50&&s<90&&(g=l`
            <div class=${p+"-content "+p+"-content--day _50"+f}>
              ${d(t.format("DD"))}
            </div>
            <div class=${p+"-content "+p+"-content--day-word"+f}>
              ${d(t.format("ddd"))}
          ...
          `),s>=90&&s<180&&(g=l`
            <div class=${p+"-content "+p+"-content--day _90"+f}>
              ${d(t.format("DD"))}
            </div>
            <div class=${p+"-content "+p+"-content--day-word"+f}>
              ${d(t.format("dddd"))}
            </div>
          `),s>=180&&s<400){const e=[],n=t.startOf("day");for(let t=0;t<12;t++){const i=n.add(2*t,"hours"),s=(n.add(2*t+1,"hours").endOf("hour").valueOf()-i.valueOf())/m.timePerPixel;e.push({width:s,formatted:i.format("HH")})}g=l`
            <div class=${p+"-content "+p+"-content--day _180"+f}>
              ${d(t.format("DD dddd"))}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+f}>
              ${e.map(t=>l`
                    <div
                      class="${p+"-content "+p+"-content--hours-hour"+f}"
          ...
          `}if(s>=400&&s<1e3){const e=[],n=t.startOf("day");for(let t=0;t<24;t++){const i=n.add(t,"hours"),s=(n.add(t,"hours").endOf("hour").valueOf()-i.valueOf())/m.timePerPixel;e.push({width:s,formatted:i.format("HH")})}g=l`
            <div class=${p+"-content "+p+"-content--day _400"+f}>
              ${d(t.format("DD dddd"))}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+f}>
              ${e.map(t=>l`
          ...
          `}const n=`overflow:hidden; text-align:left; margin-left: ${e.date.subPx+8}px;`;if(s>=1e3&&s<2e3){const e=[],i=t.startOf("day");for(let t=0;t<24;t++){const n=i.add(t,"hours"),s=(i.add(t,"hours").endOf("hour").valueOf()-n.valueOf())/m.timePerPixel;e.push({width:s,formatted:n.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _1000"+f} style=${n}>
              ${d(t.format("DD dddd"))}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+f}>
              ${e.map(t=>l`
          ...
          `}if(s>=2e3&&s<5e3){const e=[],i=t.startOf("day");for(let t=0;t<48;t++){const n=i.add(30*t,"minutes"),s=(i.add(30*(t+1),"minutes").valueOf()-n.valueOf())/m.timePerPixel;e.push({width:s,formatted:n.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _2000"+f} style=${n}>
              ${d(t.format("DD dddd"))}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+f}>
              ${e.map(t=>l`
          ...
          `}if(s>=5e3&&s<2e4){const e=[],i=t.startOf("day");for(let t=0;t<96;t++){const n=i.add(15*t,"minutes"),s=(i.add(15*(t+1),"minutes").valueOf()-n.valueOf())/m.timePerPixel;e.push({width:s,formatted:n.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _5000"+f} style=${n}>
              ${d(t.format("DD dddd"))}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+f}>
              ${e.map(t=>l`
          ...
          `}if(s>=2e4){const e=[],i=t.startOf("day");for(let t=0;t<288;t++){const n=i.add(5*t,"minutes"),s=(i.add(5*(t+1),"minutes").valueOf()-n.valueOf())/m.timePerPixel;e.push({width:s,formatted:n.format("HH:mm")})}g=l`
            <div class=${p+"-content "+p+"-content--day _20000"+f} style=${n}>
              ${d(t.format("DD dddd"))}
            </div>
            <div class=${p+"-content "+p+"-content--hours"+f}>
              ${e.map(t=>l`
          ...
          `}}r()};let y;return a((t,n)=>{if(n.leave)return v.visibility="hidden",r();e=t,y&&y(),y=i.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],b,{bulk:!0})}),s(()=>{y()}),s=>u(l`
        <div
          class=${p+" "+p+"--"+e.period+f}
          style=${c(v)}
          data-actions=${o(h,{date:e.date,period:e.period,api:n,state:i})}
        >
          ${g}
        </div>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const ft=(t,e)=>(e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),t=>{e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>e.filter(e=>e!==t),{only:[""]})}),mt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,styleMap:c}=t;let d=Object.assign(Object.assign({},e),{api:n,state:i});const h=n.getActions("chart-timeline-grid-row-block");let u;s(i.subscribe("config.wrappers.ChartTimelineGridRowBlock",t=>{u=t,r()}));const p=n.time.date().startOf("day").valueOf();let f,m;const g=t=>{f=n.getClass("chart-timeline-grid-row-block"),m=f+"-content",t.leftGlobal===p&&(f+=" current")};g(e.time);let v={width:"",height:""};return l((function onPropsChange(t,s){var o,a,l,c,h,u,p;if(s.leave)return r();e=t,d=Object.assign(Object.assign({},e),{api:n,state:i}),g(e.time),(v={}).width=e.time.width+"px",v.height=e.row.height+"px";const f=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(l=null===(a=null===(o=f[t].style)||void 0===o?void 0:o.grid)||void 0===a?void 0:a.block)||void 0===l?void 0:l.children;e&&(v=Object.assign(Object.assign({},v),e))}const m=null===(p=null===(u=null===(h=null===(c=e.row)||void 0===c?void 0:c.style)||void 0===h?void 0:h.grid)||void 0===u?void 0:u.block)||void 0===p?void 0:p.current;m&&(v=Object.assign(Object.assign({},v),m)),r()})),-1===h.indexOf(ft)&&h.push(ft),n=>u(a`
        <div class=${f} data-actions=${o(h,d)} style=${c(v)}>
          <div class=${m} />
        </div>
      `,{props:e,vido:t,templateProps:n})};
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const gt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-rows",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}),vt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,reuseComponents:c,styleMap:d}=t,h=Object.assign(Object.assign({},e),{api:n,state:i});let u;s(i.subscribe("config.wrappers.ChartTimelineItemsRow",t=>u=t));const p=i.get("config.components.ChartTimelineItemsRowItem");let f,m,g=`_internal.flatTreeMapById.${e.row.id}._internal.items`,v={opacity:"1",pointerEvents:"all",width:"",height:""},b={width:"",height:""},y=[];const w=()=>{const t=i.get("_internal.chart");if(v.opacity="1",v.pointerEvents="all",v.width=t.dimensions.width+"px",b.width=t.time.totalViewDurationPx+"px",!e)return v.opacity="0",void(v.pointerEvents="none");v.height=e.row.height+"px",v["--row-height"]=e.row.height+"px",b.height=e.row.height+"px"};l((t,n)=>{if(n.leave)return w(),r();e=t;for(const t in e)h[t]=e[t];(t=>{g=`_internal.flatTreeMapById.${t.id}._internal.items`,"function"==typeof f&&f(),"function"==typeof m&&m(),f=i.subscribe("_internal.chart",(t,e)=>{w(),r()}),m=i.subscribe(g,e=>{y=c(y,e,e=>({row:t,item:e}),p),w(),r()})})(e.row)}),s(()=>{m(),f(),y.forEach(t=>t.destroy())});const _=n.getActions("chart-timeline-items-row");let $,x;return s(i.subscribe("config.classNames",()=>{$=n.getClass("chart-timeline-items-row",e),x=n.getClass("chart-timeline-items-row-inner",e),r()})),_.includes(gt)||_.push(gt),n=>u(a`
        <div class=${$} data-actions=${o(_,h)} style=${d(v,!0)}>
          <div class=${x} style=${d(b)}>
            ${y.map(t=>t.html())}
          </div>
        </div>
      `,{props:e,vido:t,templateProps:n})},bt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-row-items",(function updateRowItems(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}});function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,styleMap:c,text:d}=t;let h;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>h=t));let u={width:"",height:"",transform:"",opacity:"1",pointerEvents:"all"},p={width:"",height:""},f=0,m=0,g=!1;const v={item:e.item,row:e.row,left:f,width:m,api:n,state:i};function updateItem(){var t,n,s,o,a,l,c,d;if(g)return;let h=i.get("_internal.chart.time");f=(e.item.time.start-h.leftGlobal)/h.timePerPixel,m=(e.item.time.end-e.item.time.start)/h.timePerPixel,m-=i.get("config.chart.spacing")||0,(u={}).width=m+"px",u.height=e.row.height+"px",u.transform=`translate(${f}px, 0px)`,u.opacity="1",u.pointerEvents="all",p={"max-width":m+"px","max-height":e.row.height+"px"};const v=i.get("config.list.rows");for(const i of e.row._internal.parents){const e=null===(s=null===(n=null===(t=v[i].style)||void 0===t?void 0:t.items)||void 0===n?void 0:n.item)||void 0===s?void 0:s.children;e&&(p=Object.assign(Object.assign({},p),e))}const b=null===(c=null===(l=null===(a=null===(o=e.row)||void 0===o?void 0:o.style)||void 0===a?void 0:a.items)||void 0===l?void 0:l.item)||void 0===c?void 0:c.current;b&&(p=Object.assign(Object.assign({},p),b));const y=null===(d=e.item)||void 0===d?void 0:d.style;y&&(p=Object.assign(Object.assign({},p),y)),r()}l((function onPropsChange(t,n){if(n.leave)return g=!0,u.opacity="0",u.pointerEvents="none",r();g=!1,e=t,v.item=e.item,v.row=e.row,v.left=f,v.width=m,updateItem()}));const b="chart-timeline-items-row-item",y=n.getActions(b);let w,_,$;return s(i.subscribe("config.classNames",()=>{w=n.getClass(b,e),_=n.getClass(b+"-content",e),$=n.getClass(b+"-content-label",e),r()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()})),-1===y.indexOf(bt)&&y.push(bt),n=>h(a`
        <div class=${w} data-actions=${o(y,v)} style=${c(u)}>
