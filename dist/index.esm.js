 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const b=` ${l} `;class TemplateResult{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let i=0;i<t;i++){const t=this.strings[i],s=t.lastIndexOf("\x3c!--");n=(s>-1||n)&&-1===t.indexOf("--\x3e",s+1);const o=g.exec(t);e+=null===o?t+(n?b:d):t.substr(0,o.index)+o[1]+o[2]+h+o[3]+l}return e+=this.strings[t]}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class SVGTemplateResult extends TemplateResult{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,n=e.firstChild;return e.removeChild(n),s(e,n.firstChild),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */function ListColumn(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,reuseComponents:l,html:c}=t;let d,u,h;s(i.subscribe("config.wrappers.ListColumn",t=>d=t)),s(i.subscribe("config.components.ListColumnRow",t=>u=t)),s(i.subscribe("config.components.ListColumnHeader",t=>h=t));let p,f=`config.list.columns.data.${e.columnId}`;s(i.subscribe(f,(function columnChanged(t){p=t,r()})));const m=n.getActions("list-column"),g=n.getActions("list-column-rows");let b,v,y,w,_,$,x;s(i.subscribe("config.classNames",t=>{b=n.getClass("list-column",{column:p}),v=n.getClass("list-column-rows",{column:p}),r()})),s(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${p.id}.width`,"_internal.chart.dimensions.width","_internal.height","config.scroll.compensation"],(function calculateStyle(){const t=i.get("config.list"),e=i.get("config.scroll.compensation");y=t.columns.data[p.id].width*t.columns.percent*.01,x=y+t.columns.resizer.width,_=`${w=`width: ${x}px;`} height: ${i.get("_internal.height")}px;`,$=`${_} transform: translate(0px, ${e}px);`}),{bulk:!0}));let C=[];s(i.subscribe("_internal.list.visibleRows;",(function visibleRowsChange(t){l(C,t,t=>({columnId:e.columnId,rowId:t.id,width:x}),u),r()}))),s((function rowsDestroy(){C.forEach(t=>t.destroy())}));const M=a(h,{columnId:e.columnId});function getRowHtml(t){return t.html()}return s(M.destroy),function updateTemplate(s){return d(c`
        ...
        >
          ...
          <div class=${v} style=${_} data-actions=${o(g,{api:n,state:i})}>
            <div class=${v+"--scroll-compensation"} style=${$}>
              ${C.map(getRowHtml)}
            </div>
          </div>
        </div>
 ...
 */function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:s,update:o,html:r,actions:a}=t,l="list-column-header-resizer",c=n.getActions(l);let d,u,h,p,f,m,g,b,v;s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>d=t)),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{u=t,o()}));let y=!1;s(i.subscribe("config.classNames",t=>{h=n.getClass(l,{column:u}),p=n.getClass(l+"-container",{column:u}),f=n.getClass(l+"-dots",{column:u}),m=n.getClass(l+"-dots-dot",{column:u}),g=n.getClass(l+"-line",{column:u}),o()})),s(i.subscribeAll([`config.list.columns.data.${u.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");b=u.width*n.columns.percent*.01,v=`width: ${n.columns.resizer.width}px`,y=n.columns.resizer.inRealTime,o()}));let w=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{w=[];for(let e=0;e<t;e++)w.push(e);o()}));let _=!1,$=b;const x=`config.list.columns.data.${u.id}.width`;function onMouseDown(t){_=!0,i.update("_internal.list.columns.resizer.active",!0)}function onMouseMove(t){if(_){let e=i.get("config.list.columns.minWidth");"number"==typeof u.minWidth&&(e=u.minWidth),($+=t.movementX)<e&&($=e),y&&i.update(x,$)}}function onMouseUp(t){_&&(i.update("_internal.list.columns.resizer.active",!1),i.update(x,$),_=!1)}return document.body.addEventListener("mousemove",onMouseMove),s(()=>document.body.removeEventListener("mousemove",onMouseMove)),document.body.addEventListener("mouseup",onMouseUp),s(()=>document.body.removeEventListener("mouseup",onMouseUp)),s=>d(r`
        <div class=${h} data-actions=${a(c,{column:u,api:n,state:i})}>
          ...
          <div class=${f} style=${"--"+v} @mousedown=${onMouseDown}>
            ${w.map(t=>r`
                  <div class=${m} />
                `)}
          </div>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnRow(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c}=t;let d,u;s(i.subscribe("config.wrappers.ListColumnRow",t=>d=t)),s(i.subscribe("config.components.ListExpander",t=>u=t));let h,p,f,m=`_internal.flatTreeMapById.${e.rowId}`,g=i.get(m),b=`config.list.columns.data.${e.columnId}`,v=i.get(b);const y=l(u,{row:g});c((function onPropsChange(t){const n=(e=t).rowId,s=e.columnId;p&&p(),f&&f(),m=`_internal.flatTreeMapById.${n}`,b=`config.list.columns.data.${s}`,p=i.subscribe(m,t=>{h=`--height: ${(g=t).height}px; width: ${e.width}px; height:${g.height}px;`;for(let t of g._internal.parents){const e=i.get(`_internal.flatTreeMapById.${t}`);"object"==typeof e.style&&"Object"===e.style.constructor.name&&"string"==typeof e.style.children&&(h+=e.style.children)}"object"==typeof g.style&&"Object"===g.style.constructor.name&&"string"==typeof g.style.current&&(h+=g.style.current),r()}),y&&y.change({row:g}),f=i.subscribe(b,t=>{v=t,r()})})),s(()=>{y&&y.destroy(),f(),p()});const w=n.getActions("list-column-row");let _;return s(i.subscribe("config.classNames",t=>{_=n.getClass("list-column-row"),r()})),function updateTemplate(s){return d(a`
        <div class=${_} style=${h} data-actions=${o(w,{column:v,row:g,api:n,state:i})}>
          ${"boolean"==typeof v.expander&&v.expander?y.html():""}
          ${"string"==typeof v.html?function getHtml(){return"function"==typeof v.data?a`
        ${v.data(g)}
      `:a`
      ${g[v.data]}
    `}():function getText(){return"function"==typeof v.data?v.data(g):g[v.data]}()}
        </div>
      `,{vido:t,props:e,templateProps:s})}}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListExpander(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c}=t,d=n.getActions("list-expander");let u,h,p,f,m,g=[];s(i.subscribe("config.components.ListToggle",t=>m=t));const b=l(m,e.row?{row:e.row}:{});let v;if(s(b.destroy),s(i.subscribe("config.wrappers.ListExpander",t=>v=t)),s(i.subscribe("config.classNames",t=>{u=n.getClass("list-expander"),f=n.getClass("list-expander-padding"),r()})),s(i.subscribeAll(["config.list.expander.padding"],t=>{h=t,r()})),e.row){let t;function onPropsChange(n){e=n,t&&t(),t=i.subscribe(`_internal.list.rows.${e.row.id}.parentId`,(function parentChanged(t){p="width:"+e.row._internal.parents.length*h+"px",g=e.row._internal.children,r()})),b.change(e)}c(onPropsChange),s((function listExpanderDestroy(){t&&t()}))}else p="width:0px",g=[];return function updateTemplate(s){return v(a`
        <div class=${u} data-action=${o(d,{row:e.row,api:n,state:i})}>
          <div class=${f} style=${p}></div>
          ${g.length||!e.row?b.html():""}
        </div>
      `,{vido:t,props:e,templateProps:s})}}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListToggle(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,unsafeHTML:l,onChange:c}=t;let d;s(i.subscribe("config.wrappers.ListToggle",t=>d=t));const u=n.getActions("list-expander-toggle");let h,p,f,m,g,b,v=!1;if(s(i.subscribe("config.classNames",t=>{h=n.getClass("list-expander-toggle"),f=n.getClass("list-expander-toggle-open"),m=n.getClass("list-expander-toggle-closed"),r()})),s(i.subscribeAll(["config.list.expander.size","config.list.expander.icons"],()=>{const t=i.get("config.list.expander");p=`--size: ${t.size}px`,g=t.icons.open,b=t.icons.closed,r()})),e.row){function expandedChange(t){v=t,r()}let t;function onPropsChange(n){e=n,t&&t(),t=i.subscribe(`config.list.rows.${e.row.id}.expanded`,expandedChange)}c(onPropsChange),s((function listToggleDestroy(){t&&t()}))}else{function expandedChange(t){for(const e of t)if(e.value){v=!0;break}r()}s(i.subscribe("config.list.rows.*.expanded",expandedChange,{bulk:!0}))}function toggle(){v=!v,e.row?i.update(`config.list.rows.${e.row.id}.expanded`,v):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=v;return t},{only:["*.expanded"]})}return function updateTemplate(s){return d(a`
        <div
          class=${h}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartCalendar(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,reuseComponents:a,html:l,repeat:c}=t,d=n.getActions("chart-calendar"),u=i.get("config.components.ChartCalendarDate");let h,p;s(i.subscribe("config.wrappers.ChartCalendar",t=>h=t)),s(i.subscribe("config.classNames",t=>{p=n.getClass("chart-calendar"),r()}));let f,m,g="";s(i.subscribe("config.headerHeight",t=>{g=`height: ${f=t}px;--calendar-height: ${f}px`,r()})),s(i.subscribe("config.chart.time.period",t=>m=t));let b=[],v=[];return s(i.subscribe("_internal.chart.time.dates",t=>{const e=n.time.date().format("YYYY-MM-DD");"object"==typeof t.day&&Array.isArray(t.day)&&t.day.length&&a(b,t.day,t=>({period:"day",date:t,currentDate:e}),u),"object"==typeof t.month&&Array.isArray(t.month)&&t.month.length&&a(v,t.month,t=>({period:"month",date:t,currentDate:e}),u),r()})),s(()=>{b.forEach(t=>t.destroy())}),d.push(t=>{i.update("_internal.elements.calendar",t)}),s=>h(l`
        <div class=${p} data-actions=${o(d,Object.assign(Object.assign({},e),{api:n,state:i}))} style=${g}>
          <div class=${p+"-dates "+p+"-dates--months"}>${v.map(t=>t.html())}</div>
          <div class=${p+"-dates "+p+"-dates--days"}>${b.map(t=>t.html())}</div>
          </div>
        </div>
      `,{props:e,vido:t,templateProps:s})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimeline(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l}=t,c=n.getActions("chart-timeline");let d;s(i.subscribe("config.wrappers.ChartTimeline",t=>d=t));const u=i.get("config.components.ChartTimelineGrid"),h=i.get("config.components.ChartTimelineItems"),p=l(u);s(p.destroy);const f=l(h);let m,g;s(f.destroy),s(i.subscribe("config.classNames",()=>{m=n.getClass("chart-timeline"),g=n.getClass("chart-timeline-inner"),r()}));let b="",v="";return s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","_internal.list.rowsHeight","config.scroll.compensation"],(function calculateStyle(){const t=i.get("config.scroll.compensation"),e=i.get("_internal.chart.dimensions.width"),n=i.get("_internal.list.rowsHeight"),s=e?`width: ${e}px;`:"";b=`height: ${i.get("_internal.height")}px; ${s}`,v=`height: ${n}px; ${s} transform: translate(0px, ${t}px);`,r()}))),c.push(t=>{i.update("_internal.elements.chart-timeline",t)}),s=>d(a`
        <div
          class=${m}
          style=${b}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimelineGrid(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l}=t,c=n.getActions("chart-timeline-grid");let d;s(i.subscribe("config.wrappers.ChartTimelineGrid",t=>d=t));const u=i.get("config.components.ChartTimelineGridRow");let h,p,f,m,g;s(i.subscribe("config.classNames",()=>{h=n.getClass("chart-timeline-grid"),r()})),s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width"],(function widthHeightChange(){f=i.get("_internal.chart.dimensions.width");const t=i.get("_internal.height");p=`height: ${t}px; width: ${f}px;`,r()}))),s(i.subscribe("config.chart.time.period",t=>m=t)),s(i.subscribe("config.chart.grid.block.onCreate",t=>g=t));let b=[];const v=[],y=new Map;return s(i.subscribeAll(["_internal.list.visibleRows;",`_internal.chart.time.dates.${m};`],(function generateBlocks(){const t=i.get("_internal.list.visibleRows"),e=i.get(`_internal.chart.time.dates.${m}`);if(!e||0===e.length)return;let s=0;v.length=0;for(const i of t){const t=[];for(const o of e){let e;y.has(o.leftGlobal)?e=y.get(o.leftGlobal):(e=n.time.date(o.leftGlobal).format("YYYY-MM-DD"),y.set(o.leftGlobal,e));let r={id:i.id+":"+e,time:o,row:i,top:s};for(const t of g)r=t(r);t.push(r)}v.push({row:i,blocks:t,top:s,width:f}),s+=i.height}i.update("_internal.chart.grid.rowsWithBlocks",v)}),{bulk:!0})),s(i.subscribe("_internal.chart.grid.rowsWithBlocks",(function generateRowsComponents(t){t&&(l(b,t,t=>t,u),r())}))),c.includes((function bindElement(t){i.update("_internal.elements.chart-timeline-grid",t)}))||c.push(),s(()=>{b.forEach(t=>t.destroy())}),function updateTemplate(s){return d(a`
