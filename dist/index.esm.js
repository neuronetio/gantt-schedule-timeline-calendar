 ...
 */const e=t=>(...e)=>{const n=t(...e);return n.isDirective=!0,n};class Directive{constructor(){this.isDirective=!0,this.isClass=!0}body(t){}runPart(t){return this.body(t)}}const n=t=>null!=t&&"boolean"==typeof t.isDirective,i=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,s=(t,e,n=null,i=null)=>{for(;e!==n;){const n=e.nextSibling;t.insertBefore(e,i),e=n}},o=(t,e,n=null)=>{for(;e!==n;){const n=e.nextSibling;t.removeChild(e),e=n}},r={},a={},l=`{{lit-${String(Math.random()).slice(2)}}}`,d=`\x3c!--${l}--\x3e`,h=new RegExp(`${l}|${d}`),u="$lit$";
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class Template{constructor(t,e){this.parts=[],this.element=e;const n=[],i=[],s=document.createTreeWalker(e.content,133,null,!1);let o=0,r=-1,a=0;const{strings:c,values:{length:d}}=t;for(;a<d;){const t=s.nextNode();if(null!==t){if(r++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:n}=e;let i=0;for(let t=0;t<n;t++)p(e[t].name,u)&&i++;for(;i-- >0;){const e=c[a],n=v.exec(e)[2],i=n.toLowerCase()+u,s=t.getAttribute(i);t.removeAttribute(i);const o=s.split(h);this.parts.push({type:"attribute",index:r,name:n,strings:o}),a+=o.length-1}}"TEMPLATE"===t.tagName&&(i.push(t),s.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(l)>=0){const i=t.parentNode,s=e.split(h),o=s.length-1;for(let e=0;e<o;e++){let n,o=s[e];if(""===o)n=g();else{const t=v.exec(o);null!==t&&p(t[2],u)&&(o=o.slice(0,t.index)+t[1]+t[2].slice(0,-u.length)+t[3]),n=document.createTextNode(o)}i.insertBefore(n,t),this.parts.push({type:"node",index:++r})}""===s[o]?(i.insertBefore(g(),t),n.push(t)):t.data=s[o],a+=o}}else if(8===t.nodeType)if(t.data===l){const e=t.parentNode;null!==t.previousSibling&&r!==o||(r++,e.insertBefore(g(),t)),o=r,this.parts.push({type:"node",index:r}),null===t.nextSibling?t.data="":(n.push(t),r--),a++}else{let e=-1;for(;-1!==(e=t.data.indexOf(l,e+1));)this.parts.push({type:"node",index:-1}),a++}}else s.currentNode=i.pop()}for(const t of n)t.parentNode.removeChild(t)}}const p=(t,e)=>{const n=t.length-e.length;return n>=0&&t.slice(n)===e},f=t=>-1!==t.index,m=document.createComment(""),g=()=>m.cloneNode(),v=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */let y;const b=` ${l} `,w=document.createElement("template");class TemplateResult{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let i=0;i<t;i++){const t=this.strings[i],s=t.lastIndexOf("\x3c!--");n=(s>-1||n)&&-1===t.indexOf("--\x3e",s+1);const o=v.exec(t);e+=null===o?t+(n?b:d):t.substr(0,o.index)+o[1]+o[2]+u+o[3]+l}return e+=this.strings[t]}getTemplateElement(){const t=w.cloneNode();return t.innerHTML=function convertConstantTemplateStringToTrustedHTML(t){const e=window,n=e.trustedTypes||e.TrustedTypes;return n&&!y&&(y=n.createPolicy("lit-html",{createHTML:t=>t})),y?y.createHTML(t):t}(this.getHTML()),t}}class SVGTemplateResult extends TemplateResult{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,n=e.firstChild;return e.removeChild(n),s(e,n.firstChild),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const _=t=>null===t||!("object"==typeof t||"function"==typeof t),x=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);let $;const C=(t,e,n,i)=>void 0!==$?$(t,e,n,i):t,M=document.createTextNode("");class AttributeCommitter{constructor(t,e,n){this.dirty=!0,this.element=t,this.name=e,this.strings=n,this.parts=[];for(let t=0;t<n.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new AttributePart(this)}_getValue(){const t=this.strings,e=this.parts,n=t.length-1;if(1===n&&""===t[0]&&""===t[1]&&void 0!==e[0]){const t=e[0].value;if(!x(t))return t}let i="";for(let s=0;s<n;s++){i+=t[s];const n=e[s];if(void 0!==n){const t=n.value;if(_(t)||!x(t))i+="string"==typeof t?t:String(t);else for(const e of t)i+="string"==typeof e?e:String(e)}}return i+=t[n]}commit(){if(this.dirty){this.dirty=!1;let t=this._getValue();"symbol"==typeof(t=C(t,this.name,"attribute",this.element))&&(t=String(t)),this.element.setAttribute(this.name,t)}}}class AttributePart{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===r||_(t)&&t===this.value||(this.value=t,n(t)||(this.committer.dirty=!0))}commit(){for(;n(this.value);){const t=this.value;this.value=r,t.isClass?t.runPart(this):t(this)}this.value!==r&&this.committer.commit()}}class NodePart{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(g()),this.endNode=t.appendChild(g())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=g()),t.__insert(this.endNode=g())}insertAfterPart(t){t.__insert(this.startNode=g()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){for(;n(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=r,t.isClass?t.runPart(this):t(this)}const t=this.__pendingValue;t!==r&&(_(t)?t!==this.value&&this.__commitText(t):t instanceof TemplateResult?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):x(t)?this.__commitIterable(t):t===a?(this.value=a,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling;if(t=null==t?"":t,e===this.endNode.previousSibling&&3===e.nodeType){const n=C(t,"data","property",e);e.data="string"==typeof n?n:String(n)}else{const e=M.cloneNode();this.__commitNode(e);const n=C(t,"textContent","property",e);e.data="string"==typeof n?n:String(n)}this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof TemplateInstance&&this.value.template===e)this.value.update(t.values);else{const n=this.endNode.parentNode;if(void 0!==$&&"STYLE"===n.nodeName||"SCRIPT"===n.nodeName)return void this.__commitText("/* lit-html will not write TemplateResults to scripts and styles */");const i=new TemplateInstance(e,t.processor,this.options),s=i._clone();i.update(t.values),this.__commitNode(s),this.value=i}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let n,i=0;for(const s of t)void 0===(n=e[i])&&(n=new NodePart(this.options),e.push(n),0===i?n.appendIntoPart(this):n.insertAfterPart(e[i-1])),n.setValue(s),n.commit(),i++;i<e.length&&(e.length=i,this.clear(n&&n.endNode))}clear(t=this.startNode){o(this.startNode.parentNode,t.nextSibling,this.endNode)}}class BooleanAttributePart{constructor(t,e,n){if(this.value=void 0,this.__pendingValue=void 0,2!==n.length||""!==n[0]||""!==n[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=n}setValue(t){this.__pendingValue=t}commit(){for(;n(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=r,t.isClass?t.runPart(this):t(this)}if(this.__pendingValue===r)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=r}}class PropertyCommitter extends AttributeCommitter{constructor(t,e,n){super(t,e,n),this.single=2===n.length&&""===n[0]&&""===n[1]}_createPart(){return new PropertyPart(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){if(this.dirty){this.dirty=!1;let t=this._getValue();t=C(t,this.name,"property",this.element),this.element[this.name]=t}}}class PropertyPart extends AttributePart{}let O=!1;try{const t={get capture(){return O=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}class EventPart{constructor(t,e,n){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=n,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;n(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=r,t.isClass?t.runPart(this):t(this)}if(this.__pendingValue===r)return;const t=this.__pendingValue,e=this.value,i=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),s=null!=t&&(null==e||i);i&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),s&&(this.__options=P(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=r}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const P=t=>t&&(O?{capture:t.capture,passive:t.passive,once:t.once}:t.capture);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function templateFactory(t){let e=I.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},I.set(t.type,e));let n=e.stringsArray.get(t.strings);if(void 0!==n)return n;const i=t.strings.join(l);return void 0===(n=e.keyString.get(i))&&(n=new Template(t,t.getTemplateElement()),e.keyString.set(i,n)),e.stringsArray.set(t.strings,n),n}const I=new Map,S=new WeakMap,T=(t,e,n)=>{let i=S.get(e);void 0===i&&(o(e,e.firstChild),S.set(e,i=new NodePart(Object.assign({templateFactory:templateFactory},n))),i.appendInto(e)),i.setValue(t),i.commit()};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const A=(t,...e)=>new TemplateResult(t,e,"html",D),R=(t,...e)=>new SVGTemplateResult(t,e,"svg",D);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */var E=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},verb("next"),verb("throw"),verb("return"),e[Symbol.asyncIterator]=function(){return this},e);function verb(n){e[n]=t[n]&&function(e){return new Promise((function(i,s){(function settle(t,e,n,i){Promise.resolve(i).then((function(e){t({value:e,done:n})}),e)})(i,s,(e=t[n](e)).done,e.value)}))}}};const j=e((t,e)=>async n=>{var i,s;if(!(n instanceof NodePart))throw new Error("asyncReplace can only be used in text bindings");if(t===n.value)return;const o=new NodePart(n.options);n.value=t;let r=0;try{for(var a,l=E(t);!(a=await l.next()).done;){let i=a.value;if(n.value!==t)break;0===r&&(n.clear(),o.appendIntoPart(n)),void 0!==e&&(i=e(i,r)),o.setValue(i),o.commit(),r++}}catch(t){i={error:t}}finally{try{a&&!a.done&&(s=l.return)&&await s.call(l)}finally{if(i)throw i.error}}}),H=new WeakMap,k=e(t=>e=>{if(!(e instanceof NodePart))throw new Error("cache can only be used in text bindings");let n=H.get(e);void 0===n&&(n=new WeakMap,H.set(e,n));const i=e.value;if(i instanceof TemplateInstance){if(t instanceof TemplateResult&&i.template===e.options.templateFactory(t))return void e.setValue(t);{let t=n.get(i.template);void 0===t&&(t={instance:i,nodes:document.createDocumentFragment()},n.set(i.template,t)),s(t.nodes,e.startNode.nextSibling,e.endNode)}}if(t instanceof TemplateResult){const i=e.options.templateFactory(t),s=n.get(i);void 0!==s&&(e.setValue(s.nodes),e.commit(),e.value=s.instance)}e.setValue(t)}),V=new WeakMap,z=e(t=>e=>{if(!(e instanceof AttributePart)||e instanceof PropertyPart||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:n}=e,{element:i}=n;let s=V.get(e);void 0===s&&(i.className=n.strings.join(" "),V.set(e,s=new Set));const{classList:o}=i;s.forEach(e=>{e in t||(o.remove(e),s.delete(e))});for(const e in t){const n=t[e];n!=s.has(e)&&(n?(o.add(e),s.add(e)):(o.remove(e),s.delete(e)))}}),W=new WeakMap,G=e((t,e)=>n=>{const i=W.get(n);if(Array.isArray(t)){if(Array.isArray(i)&&i.length===t.length&&t.every((t,e)=>t===i[e]))return}else if(i===t&&(void 0!==t||W.has(n)))return;n.setValue(e()),W.set(n,Array.isArray(t)?Array.from(t):t)}),B=e(t=>e=>{if(void 0===t&&e instanceof AttributePart){if(t!==e.value){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else e.setValue(t)}),Y=(t,e)=>{const n=t.startNode.parentNode,i=void 0===e?t.endNode:e.startNode,s=n.insertBefore(g(),i);n.insertBefore(g(),i);const o=new NodePart(t.options);return o.insertAfterNode(s),o},F=(t,e)=>(t.setValue(e),t.commit(),t),U=(t,e,n)=>{const i=t.startNode.parentNode,o=n?n.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&s(i,e.startNode,r,o)},J=t=>{o(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},q=(t,e,n)=>{const i=new Map;for(let s=e;s<=n;s++)i.set(t[s],s);return i},Z=new WeakMap,X=new WeakMap,K=e((t,e,n)=>{let i;return void 0===n?n=e:void 0!==e&&(i=e),e=>{if(!(e instanceof NodePart))throw new Error("repeat can only be used in text bindings");const s=Z.get(e)||[],o=X.get(e)||[],r=[],a=[],l=[];let c,d,h=0;for(const e of t)l[h]=i?i(e,h):h,a[h]=n(e,h),h++;let u=0,p=s.length-1,f=0,m=a.length-1;for(;u<=p&&f<=m;)if(null===s[u])u++;else if(null===s[p])p--;else if(o[u]===l[f])r[f]=F(s[u],a[f]),u++,f++;else if(o[p]===l[m])r[m]=F(s[p],a[m]),p--,m--;else if(o[u]===l[m])r[m]=F(s[u],a[m]),U(e,s[u],r[m+1]),u++,m--;else if(o[p]===l[f])r[f]=F(s[p],a[f]),U(e,s[p],s[u]),p--,f++;else if(void 0===c&&(c=q(l,f,m),d=q(o,u,p)),c.has(o[u]))if(c.has(o[p])){const t=d.get(l[f]),n=void 0!==t?s[t]:null;if(null===n){const t=Y(e,s[u]);F(t,a[f]),r[f]=t}else r[f]=F(n,a[f]),U(e,n,s[u]),s[t]=null;f++}else J(s[p]),p--;else J(s[u]),u++;for(;f<=m;){const t=Y(e,r[m+1]);F(t,a[f]),r[f++]=t}for(;u<=p;){const t=s[u++];null!==t&&J(t)}Z.set(e,r),X.set(e,l)}}),Q=new WeakMap,tt=document.createElement("template"),et=e(t=>e=>{if(!(e instanceof NodePart))throw new Error("unsafeHTML can only be used in text bindings");const n=Q.get(e);if(void 0!==n&&_(t)&&t===n.value&&e.value===n.fragment)return;const i=tt.cloneNode();i.innerHTML=t;const s=document.importNode(i.content,!0);e.setValue(s),Q.set(e,{value:t,fragment:s})}),nt=new WeakMap,it=e((...t)=>e=>{let n=nt.get(e);void 0===n&&(n={lastRenderedIndex:2147483647,values:[]},nt.set(e,n));const i=n.values;let s=i.length;n.values=t;for(let o=0;o<t.length&&!(o>n.lastRenderedIndex);o++){const r=t[o];if(_(r)||"function"!=typeof r.then){e.setValue(r),n.lastRenderedIndex=o;break}o<s&&r===i[o]||(n.lastRenderedIndex=2147483647,s=0,Promise.resolve(r).then(t=>{const i=n.values.indexOf(r);i>-1&&i<n.lastRenderedIndex&&(n.lastRenderedIndex=i,e.setValue(t),e.commit())}))}});
/**
 * @license
 ...
 */function Main(t,e={}){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,html:l,StyleMap:c}=t,d=n.name;let h,u;s(i.subscribe("config.components.List",t=>h=t)),s(i.subscribe("config.components.Chart",t=>u=t));const p=a(h);s(p.destroy);const f=a(u);let m;s(f.destroy),s(i.subscribe("config.plugins",e=>{if(void 0!==e&&Array.isArray(e))for(const n of e){const e=n(t);"function"==typeof e&&s(e)}})),s(i.subscribe("config.wrappers.Main",t=>m=t));const g=n.getActions("");let v,y,b,w=new c({}),_=new c({}),x=new c({}),$=0,C=!1;s(i.subscribe("config.classNames",t=>{const e=i.get("config");v=n.getClass(d,{config:e}),C&&(v+=` ${d}__list-column-header-resizer--active`),y=n.getClass("vertical-scroll",{config:e}),r()}));s(i.subscribeAll(["config.height","config.headerHeight","_internal.scrollBarHeight"],()=>{const t=i.get("config"),e=i.get("_internal.scrollBarHeight"),n=t.height-t.headerHeight-e;i.update("_internal.height",n),w.style["--height"]=t.height+"px",_.style.height=n+"px",_.style.width=e+"px",_.style["margin-top"]=t.headerHeight+"px",r()}));s(i.subscribe("_internal.list.columns.resizer.active",t=>{C=t,v=n.getClass(n.name),C&&(v+=` ${n.name}__list-column-header-resizer--active`),r()})),s(i.subscribeAll(["config.list.rows;","config.chart.items;","config.list.rows.*.parentId","config.chart.items.*.rowId"],(function generateTree(t,e){if(i.get("_internal.flatTreeMap").length&&"subscribe"===e.type)return;const s=i.get("config.list.rows"),o=[];for(const t in s)o.push(s[t]);n.fillEmptyRowValues(o);const a=i.get("config.chart.items"),l=[];for(const t in a)l.push(a[t]);const c=n.makeTreeMap(o,l);i.update("_internal.treeMap",c),i.update("_internal.flatTreeMapById",n.getFlatTreeMapById(c)),i.update("_internal.flatTreeMap",n.flattenTreeMap(c)),r()}),{bulk:!0})),s(i.subscribeAll(["config.list.rows.*.expanded","_internal.treeMap;"],(function prepareExpanded(){const t=i.get("config.list.rows"),e=n.getRowsFromIds(n.getRowsWithParentsExpanded(i.get("_internal.flatTreeMap"),i.get("_internal.flatTreeMapById"),t),t);$=n.getRowsHeight(e),i.update("_internal.list.rowsHeight",$),i.update("_internal.list.rowsWithParentsExpanded",e),r()}),{bulk:!0})),s(i.subscribeAll(["_internal.list.rowsWithParentsExpanded","config.scroll.top"],(function generateVisibleRows(){const{visibleRows:t,compensation:e}=n.getVisibleRowsAndCompensation(i.get("_internal.list.rowsWithParentsExpanded")),s=i.get("_internal.list.visibleRows");let o=!0;if(i.update("config.scroll.compensation",-e),t.length&&(o=t.some((t,e)=>void 0===s[e]||t.id!==s[e].id)),o){i.update("_internal.list.visibleRows",t);const e=[];for(const n of t)for(const t of n._internal.items)e.push(t);i.update("_internal.chart.visibleItems",e)}r()})));let M=0;s(i.subscribe("_internal.list.visibleRows;",(function onVisibleRowsChange(){const t=i.get("config.scroll.top");x.style.width="1px",x.style.height=$+"px",M!==t&&b&&(M=t,b.scrollTop=t),r()})));const O=(t,e)=>{const i=[];let s=e.leftGlobal;const o=e.rightGlobal,r=e.timePerPixel;let a=s-n.time.date(s).startOf(t),l=a/r,c=0,d=0;for(;s<o;){const e={sub:a,subPx:l,leftGlobal:s,rightGlobal:n.time.date(s).endOf(t).valueOf(),width:0,leftPx:0,rightPx:0};e.width=(e.rightGlobal-e.leftGlobal+a)/r,d=e.width>d?e.width:d,e.leftPx=c,c+=e.width,e.rightPx=c,i.push(e),s=e.rightGlobal+1,a=0,l=0}e.maxWidth[t]=d,e.dates[t]=i};s(i.subscribeAll(["config.chart.time","_internal.dimensions.width","config.scroll.left","_internal.scrollBarHeight","_internal.list.width","_internal.chart.dimensions"],()=>{const t=i.get("_internal.chart.dimensions.width");let e=n.mergeDeep({},i.get("config.chart.time"));const s=.01*(e=n.time.recalculateFromTo(e)).zoom;let o=i.get("config.scroll.left");if(e.timePerPixel=s+Math.pow(2,e.zoom),e.totalViewDurationMs=n.time.date(e.to).diff(e.from,"milliseconds"),e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,o>e.totalViewDurationPx&&(o=e.totalViewDurationPx-t),e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.leftGlobal+t*e.timePerPixel,e.leftInner=e.leftGlobal-e.from,e.rightInner=e.rightGlobal-e.from,e.leftPx=e.leftInner/e.timePerPixel,e.rightPx=e.rightInner/e.timePerPixel,Math.round(e.rightGlobal/e.timePerPixel)>Math.round(e.to/e.timePerPixel)){const t=(e.rightGlobal-e.to)/(e.rightGlobal-e.from);e.timePerPixel=e.timePerPixel-e.timePerPixel*t,e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.to,e.rightInner=e.rightGlobal-e.from,e.totalViewDurationMs=e.to-e.from,e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,e.rightInner=e.rightGlobal-e.from,e.rightPx=e.rightInner/e.timePerPixel,e.leftPx=e.leftInner/e.timePerPixel}O("day",e),O("month",e),i.update("_internal.chart.time",e),r()},{bulk:!0}));const P=document.createElement("canvas"),D=P.getContext("2d");function renderIcon(t){return new Promise(e=>{const n=document.createElement("img");n.setAttribute("src","data:image/svg+xml;base64,"+btoa(t)),n.onload=function(){P.width=n.width,P.height=n.height,D.drawImage(n,0,0),e(P.toDataURL("image/png"))}})}!function renderIcons(){return function __awaiter(t,e,n,i){return new(n||(n=Promise))((function(s,o){function fulfilled(t){try{step(i.next(t))}catch(t){o(t)}}function rejected(t){try{step(i.throw(t))}catch(t){o(t)}}function step(t){t.done?s(t.value):new n((function(e){e(t.value)})).then(fulfilled,rejected)}step((i=i.apply(t,e||[])).next())}))}(this,void 0,void 0,(function*(){const t=i.get("config.list.expander.icons"),e={};for(const n in t){const i=t[n];e[n]=yield renderIcon(i)}i.update("_internal.list.expander.icons",e)}))}(),i.update("_internal.scrollBarHeight",n.getScrollBarHeight());let I=0;const S={handleEvent:t=>{if("scroll"===t.type){const e=t.target.scrollTop,n=t=>{t.top=e,I=t.top;const n=i.get("_internal.elements.vertical-scroll-inner");if(n){const e=n.clientHeight;t.percent.top=t.top/e}return t};I!==e&&i.update("config.scroll",n,{only:["top","percent.top"]})}else{const e=n.normalizeMouseWheelEvent(t),s=i.get("config.scroll.xMultiplier"),o=i.get("config.scroll.yMultiplier");t.shiftKey&&e.y?i.update("config.scroll.left",t=>n.limitScroll("left",t+=e.y*s)):e.x?i.update("config.scroll.left",t=>n.limitScroll("left",t+=e.x*s)):i.update("config.scroll.top",t=>I=n.limitScroll("top",t+=e.y*o))}},passive:!0,capture:!1},T=t=>{t.stopPropagation(),t.stopImmediatePropagation(),t.preventDefault()},A={width:0,height:0};let R;const L=t=>{R||((R=new xt((e,n)=>{const s=t.clientWidth,o=t.clientHeight;A.width===s&&A.height===o||(A.width=s,A.height=o,i.update("_internal.dimensions",A))})).observe(t),i.update("_internal.elements.main",t))};g.includes(L)||g.push(L),s(()=>{R.disconnect()});const N=t=>{b||(b=t,i.update("_internal.elements.vertical-scroll",t))},E=t=>{i.update("_internal.elements.vertical-scroll-inner",t)},j=Object.assign(Object.assign({},e),{api:n,state:i});return n=>m(l`
        <div
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumn(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,reuseComponents:l,html:c,StyleMap:d}=t;let h,u,p;s(i.subscribe("config.wrappers.ListColumn",t=>h=t)),s(i.subscribe("config.components.ListColumnRow",t=>u=t)),s(i.subscribe("config.components.ListColumnHeader",t=>p=t));let f,m=`config.list.columns.data.${e.columnId}`;s(i.subscribe(m,(function columnChanged(t){f=t,r()})));const g=n.getActions("list-column"),v=n.getActions("list-column-rows");let y,b,w;const _=new d({width:"","--width":""}),x=new d({width:"",height:""}),$=new d({width:"",height:""});let C;s(i.subscribe("config.classNames",t=>{y=n.getClass("list-column",{column:f}),b=n.getClass("list-column-rows",{column:f}),r()})),s(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${f.id}.width`,"_internal.chart.dimensions.width","_internal.height","config.scroll.compensation","_internal.list.width"],(function calculateStyle(){const t=i.get("config.list"),e=i.get("config.scroll.compensation");w=t.columns.data[f.id].width*t.columns.percent*.01,C=w;const n=i.get("_internal.height");_.style.width=C+"px",_.style["--width"]=C+"px",x.style.width=C+"px",x.style.height=n+"px",$.style.width=C+"px",$.style.height=n+Math.abs(e)+"px",$.style.transform=`translate(0px, ${e}px)`}),{bulk:!0}));let M=[];s(i.subscribe("_internal.list.visibleRows;",t=>{l(M,t,t=>t&&{columnId:e.columnId,rowId:t.id,width:C},u),r()})),s((function rowsDestroy(){M.forEach(t=>t.destroy())}));const O=a(p,{columnId:e.columnId});function getRowHtml(t){return t.html()}s(O.destroy);const P={column:f,state:i,api:n},D={api:n,state:i};return n=>h(c`
        <div class=${y} data-actions=${o(g,P)} style=${_}>
          ${O.html()}
          <div
            class=${b}
            style=${x}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnHeader(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,html:l,cache:c,StyleMap:d}=t;let h;s(i.subscribe("config.wrappers.ListColumnHeader",t=>h=t));const u=n.getActions("list-column-header");let p;s(i.subscribe("config.components.ListColumnHeaderResizer",t=>p=t));const f=a(p,{columnId:e.columnId});let m;s(f.destroy),s(i.subscribe("config.components.ListExpander",t=>m=t));const g=a(m,{});let v;s(g.destroy),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{v=t,r()}));let y,b,w=new d({height:"","--height":"","--paddings-count":""});s(i.subscribeAll(["config.classNames","config.headerHeight"],()=>{const t=i.get("config");y=n.getClass("list-column-header",{column:v}),b=n.getClass("list-column-header-content",{column:v}),w.style.height=t.headerHeight+"px",w.style["--height"]=t.headerHeight+"px",w.style["--paddings-count"]="1",r()}));const _={column:v,api:n,state:i};return n=>h(l`
        <div class=${y} style=${w} data-actions=${o(u,_)}>
          ${c("boolean"==typeof v.expander&&v.expander?function withExpander(){return l`
      <div class=${b}>
        ${g.html()}${f.html(v)}
      </div>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:s,update:o,html:r,actions:a,cache:l,StyleMap:c}=t,d="list-column-header-resizer",h=n.getActions(d);let u,p;s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>u=t)),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{p=t,o()}));let f,m,g,v,y,b,w=new c({width:""}),_=!1;s(i.subscribe("config.classNames",t=>{f=n.getClass(d,{column:p}),m=n.getClass(d+"-container",{column:p}),g=n.getClass(d+"-dots",{column:p}),v=n.getClass(d+"-dots-dot",{column:p}),y=n.getClass(d+"-line",{column:p}),o()})),s(i.subscribeAll([`config.list.columns.data.${p.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");b=p.width*n.columns.percent*.01,w.style["--width"]=n.columns.resizer.width+"px",_=n.columns.resizer.inRealTime,i.update("_internal.list.width",b),o()}));let x=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{x=[];for(let e=0;e<t;e++)x.push(e);o()}));let $=!1,C=b;const M=new c({"--display":"none","--left":C+"px"}),O=`config.list.columns.data.${p.id}.width`;function onMouseDown(t){$=!0,i.update("_internal.list.columns.resizer.active",!0),$?(M.style.display="block",M.style["--left"]=C+"px"):(M.style.display="none",M.style["--left"]="0px")}function onMouseMove(t){if($){let e=i.get("config.list.columns.minWidth");"number"==typeof p.minWidth&&(e=p.minWidth),(C+=t.movementX)<e&&(C=e),_&&i.update(O,C)}}function onMouseUp(t){$&&(i.update("_internal.list.columns.resizer.active",!1),i.update(O,C),$=!1)}document.body.addEventListener("mousemove",onMouseMove),s(()=>document.body.removeEventListener("mousemove",onMouseMove)),document.body.addEventListener("mouseup",onMouseUp),s(()=>document.body.removeEventListener("mouseup",onMouseUp));const P={column:p,api:n,state:i};return n=>u(r`
        <div class=${f} data-actions=${a(h,P)}>
          <div class=${m}>
            ${l(p.header.html?r`
                    ${p.header.html}
                  `:p.header.content)}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnRow(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c,StyleMap:d,unsafeHTML:h}=t;let u,p;s(i.subscribe("config.wrappers.ListColumnRow",t=>u=t)),s(i.subscribe("config.components.ListExpander",t=>p=t));let f,m,g=`_internal.flatTreeMapById.${e.rowId}`,v=i.get(g),y=`config.list.columns.data.${e.columnId}`,b=i.get(y),w=new d(b.expander?{opacity:"1",pointerEvents:"auto",height:"",width:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{opacity:"1",pointerEvents:"auto",height:"",width:"",top:"","--height":""});const _=l(p,{row:v});c((t,n)=>{if(n.leave)return w.style.opacity="0",w.style.pointerEvents="none",void r();const s=(e=t).rowId,o=e.columnId;f&&f(),m&&m(),g=`_internal.flatTreeMapById.${s}`,y=`config.list.columns.data.${o}`,f=i.subscribeAll([g,"config.list.expander"],t=>{v=i.get(g);const e=i.get("config.list.expander");w.style={},w.style.opacity="1",w.style.pointerEvents="auto",w.style.height=v.height+"px",w.style["--height"]=v.height+"px",b.expander&&(w.style["--expander-padding-width"]=e.padding*(v._internal.parents.length+1)+"px");for(let t of v._internal.parents){const e=i.get(`_internal.flatTreeMapById.${t}`);if("object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children){const t=e.style.children;for(const e in t)w.style[e]=t[e]}}if("object"==typeof v.style&&"Object"===v.style.constructor.name&&"object"==typeof v.style.current){const t=v.style.current;for(const e in t)w.style[e]=t[e]}r()}),_&&_.change({row:v}),m=i.subscribe(y,t=>{b=t,r()})}),s(()=>{_&&_.destroy(),m(),f()});const x=n.getActions("list-column-row");let $;s(i.subscribe("config.classNames",t=>{$=n.getClass("list-column-row"),r()}));const C={column:b,row:v,api:n,state:i};return n=>u(a`
        <div class=${$} style=${w} data-actions=${o(x,C)}>
          ${b.expander?_.html():null}
          <div class=${$+"-content"}>
            ${b.isHTML?function getHtml(){return"function"==typeof b.data?h(b.data(v)):h(v[b.data])}():function getText(){return"function"==typeof b.data?b.data(v):v[b.data]}()}
          </div>
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListExpander(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c}=t,d=n.getActions("list-expander");let h,u;s(i.subscribe("config.components.ListToggle",t=>u=t));const p=l(u,e.row?{row:e.row}:{});let f;if(s(p.destroy),s(i.subscribe("config.wrappers.ListExpander",t=>f=t)),s(i.subscribe("config.classNames",t=>{h=n.getClass("list-expander"),r()})),e.row){c((function onPropsChange(t){e=t,p.change(e)})),s((function listExpanderDestroy(){}))}const m={row:e.row,api:n,state:i};return n=>f(a`
        <div class=${h} data-action=${o(d,m)}>
          ${p.html()}
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListToggle(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,cache:c}=t;let d;s(i.subscribe("config.wrappers.ListToggle",t=>d=t));const h=n.getActions("list-expander-toggle");let u,p,f,m,g,v,y,b=!1;if(s(i.subscribe("config.classNames",t=>{u=n.getClass("list-expander-toggle"),p=u+"-child",f=u+"-open",m=u+"-closed",r()})),s(i.subscribe("_internal.list.expander.icons",t=>{t&&(g=t.child,v=t.open,y=t.closed),r()})),e.row){function expandedChange(t){b=t,r()}let t;function onPropsChange(n){e=n,t&&t(),t=i.subscribe(`config.list.rows.${e.row.id}.expanded`,expandedChange)}l(onPropsChange),s((function listToggleDestroy(){t&&t()}))}else{function expandedChange(t){for(const e of t)if(e.value){b=!0;break}r()}s(i.subscribe("config.list.rows.*.expanded",expandedChange,{bulk:!0}))}function toggle(){b=!b,e.row?i.update(`config.list.rows.${e.row.id}.expanded`,b):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=b;return t},{only:["*.expanded"]})}const w={row:e.row,api:n,state:i};return n=>d(a`
        <div class=${u} data-action=${o(h,w)} @click=${toggle}>
          ${c((()=>{var t,n,i;return g?0===(null===(i=null===(n=null===(t=e.row)||void 0===t?void 0:t._internal)||void 0===n?void 0:n.children)||void 0===i?void 0:i.length)?a`
          <img class=${p} src=${g} />
        `:b?a`
            <img class=${f} src=${v} />
          `:a`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartCalendar(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,reuseComponents:a,html:l,StyleMap:c}=t,d=n.getActions("chart-calendar"),h=Object.assign(Object.assign({},e),{api:n,state:i}),u=i.get("config.components.ChartCalendarDate");let p,f;s(i.subscribe("config.wrappers.ChartCalendar",t=>p=t)),s(i.subscribe("config.classNames",t=>{f=n.getClass("chart-calendar"),r()}));let m,g,v=new c({height:"","--headerHeight":""});s(i.subscribe("config.headerHeight",t=>{m=t,v.style.height=m+"px",v.style["--calendar-height"]=m+"px",r()})),s(i.subscribe("config.chart.time.period",t=>g=t));let y=[],b=[];return s(i.subscribe("_internal.chart.time.dates",t=>{const e=n.time.date().format("YYYY-MM-DD");"object"==typeof t.day&&Array.isArray(t.day)&&t.day.length&&a(y,t.day,t=>t&&{period:"day",date:t,currentDate:e},u),"object"==typeof t.month&&Array.isArray(t.month)&&t.month.length&&a(b,t.month,t=>t&&{period:"month",date:t,currentDate:e},u),r()})),s(()=>{y.forEach(t=>t.destroy())}),d.push(t=>{i.update("_internal.elements.calendar",t)}),n=>p(l`
        <div class=${f} data-actions=${o(d,h)} style=${v}>
 ...
 */function ChartCalendarDate(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,onChange:a,html:l,StyleMap:c}=t,d=n.getActions("chart-calendar-date");let h;s(i.subscribe("config.wrappers.ChartCalendarDate",t=>h=t));let u=n.getClass("chart-calendar-date",e),p="";p=n.time.date(e.date.leftGlobal).format("YYYY-MM-DD")===e.currentDate?" current":"";let f,m,g=new c({width:"","margin-left":"",visibility:"visible"}),v=new c({overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"});const y=()=>{if(!e)return;f=i.get("_internal.chart.time"),g.style.width=e.date.width+"px",g.style["margin-left"]=-e.date.subPx+"px",g.style.visibility="visible",v.style={overflow:"hidden","text-align":"left","margin-left":e.date.subPx+8+"px"};const t=n.time.date(e.date.leftGlobal);p=t.format("YYYY-MM-DD")===e.currentDate?" current":t.subtract(1,"days").format("YYYY-MM-DD")===e.currentDate?" next":t.add(1,"days").format("YYYY-MM-DD")===e.currentDate?" previous":"";const s=f.maxWidth[e.period];switch(e.period){case"month":m=l`
        ...
        `,s>=40&&s<50)m=l`
          ...
          `}}r()};let b;const w={date:e.date,period:e.period,api:n,state:i};return a((t,n)=>{if(n.leave)return g.style.visibility="hidden",r();e=t,w.date=e.date,w.period=e.period,b&&b(),b=i.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],y,{bulk:!0})}),s(()=>{b()}),n=>h(l`
        <div
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimeline(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,StyleMap:c}=t,d=n.getActions("chart-timeline"),h=Object.assign(Object.assign({},e),{api:n,state:i});let u;s(i.subscribe("config.wrappers.ChartTimeline",t=>u=t));const p=i.get("config.components.ChartTimelineGrid"),f=i.get("config.components.ChartTimelineItems"),m=l(p);s(m.destroy);const g=l(f);let v,y;s(g.destroy),s(i.subscribe("config.classNames",()=>{v=n.getClass("chart-timeline"),y=n.getClass("chart-timeline-inner"),r()}));let b=new c({}),w=new c({});return s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","_internal.list.rowsHeight","config.scroll.compensation"],(function calculateStyle(){const t=i.get("config.scroll.compensation"),e=i.get("_internal.chart.dimensions.width"),n=i.get("_internal.list.rowsHeight");b.style.height=i.get("_internal.height")+"px",e&&(b.style.width=e+"px"),w.style.height=n+"px",e&&(w.style.width=e+"px"),w.style.transform=`translate(0px, ${t}px)`,r()}))),d.push(t=>{i.update("_internal.elements.chart-timeline",t)}),i=>u(a`
        <div
          class=${v}
          style=${b}
          data-actions=${o(d,h)}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimelineGrid(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l,StyleMap:c}=t,d=n.getActions("chart-timeline-grid"),h={api:n,state:i};let u;s(i.subscribe("config.wrappers.ChartTimelineGrid",t=>u=t));const p=i.get("config.components.ChartTimelineGridRow");let f,m,g;s(i.subscribe("config.classNames",()=>{f=n.getClass("chart-timeline-grid"),r()})),s(i.subscribe("config.chart.time.period",t=>m=t)),s(i.subscribe("config.chart.grid.block.onCreate",t=>g=t));let v=[];const y=[],b=new Map,w=new c({});s(i.subscribeAll(["_internal.list.visibleRows;",`_internal.chart.time.dates.${m};`,"_internal.height","_internal.chart.dimensions.width"],()=>{const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height"),s=i.get(`_internal.chart.time.dates.${m}`),o=i.get("_internal.list.visibleRows");if(!s||0===s.length)return;const r=s[0].subPx,a=i.get("config.scroll.compensation");w.style.height=e+Math.abs(a)+"px",w.style.width=t+"px",w.style.transform=`translate(-${r}px, 0px)`;let l=0;y.length=0;for(const e of o){const i=[];for(const t of s){let s;b.has(t.leftGlobal)?s=b.get(t.leftGlobal):(s=n.time.date(t.leftGlobal).format("YYYY-MM-DD"),b.set(t.leftGlobal,s));let o={id:e.id+":"+s,time:t,row:e,top:l};for(const t of g)o=t(o);i.push(o)}y.push({row:e,blocks:i,top:l,width:t}),l+=e.height}i.update("_internal.chart.grid.rowsWithBlocks",y)},{bulk:!0}));return s(i.subscribe("_internal.chart.grid.rowsWithBlocks",t=>{t&&(l(v,t,t=>t,p),r())})),d.includes((function bindElement(t){i.update("_internal.elements.chart-timeline-grid",t)}))||d.push(),s(()=>{v.forEach(t=>t.destroy())}),n=>u(a`
        <div class=${f} data-actions=${o(d,h)} style=${w}>
          ${v.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function bindElementAction(t,e){return e.state.update("_internal.elements.chart-timeline-grid-rows",(function updateGridRows(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-grid-rows",e=>e.filter(e=>e!==t))}}}function ChartTimelineGridRow(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l,onChange:c,StyleMap:d}=t,h=Object.assign(Object.assign({},e),{api:n,state:i});let u;s(i.subscribe("config.wrappers.ChartTimelineGridRow",t=>{u=t,r()}));const p=i.get("config.components.ChartTimelineGridRowBlock"),f=n.getActions("chart-timeline-grid-row");let m=n.getClass("chart-timeline-grid-row"),g=new d({width:e.width+"px",height:e.row.height+"px",opacity:"1",pointerEvents:"all",overflow:"hidden"}),v=[];return c((t,n)=>{var s,o,a,c,d,u,f;if(n.leave)return g.style.opacity="0",g.style.pointerEvents="none",void r();l(v,(e=t).blocks,t=>t,p),g.style={},g.style.opacity="1",g.style.pointerEvents="all",g.style.height=e.row.height+"px",g.style.width=e.width+"px";const m=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(a=null===(o=null===(s=m[t].style)||void 0===s?void 0:s.grid)||void 0===o?void 0:o.row)||void 0===a?void 0:a.children;e&&(g.style=Object.assign(Object.assign({},g.style),e))}const y=null===(f=null===(u=null===(d=null===(c=e.row)||void 0===c?void 0:c.style)||void 0===d?void 0:d.grid)||void 0===u?void 0:u.row)||void 0===f?void 0:f.current;y&&(g.style=Object.assign(Object.assign({},g.style),y));for(const t in e)h[t]=e[t];r()}),s(()=>{v.forEach(t=>t.destroy())}),-1===f.indexOf(bindElementAction)&&f.push(bindElementAction),n=>u(a`
        <div class=${m} data-actions=${o(f,h)} style=${g}>
          ${v.map(t=>t.html())}
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const $t=(t,e)=>(e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),t=>{e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>e.filter(e=>e!==t),{only:[""]})}),Ct=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,StyleMap:c}=t,d="chart-timeline-grid-row-block";let h=Object.assign(Object.assign({},e),{api:n,state:i});const u=n.getActions(d);let p;s(i.subscribe("config.wrappers.ChartTimelineGridRowBlock",t=>{p=t,r()}));const f=n.time.date().startOf("day").valueOf();let m,g;function updateClassName(t){m=n.getClass(d),g=m+"-content",t.leftGlobal===f&&(m+=" current")}updateClassName(e.time);let v=new c({width:"",height:""});return l((function onPropsChange(t,s){var o,a,l,c,d,u,p;if(s.leave)return r();e=t,h=Object.assign(Object.assign({},e),{api:n,state:i}),updateClassName(e.time),v.style={},v.style.width=e.time.width+"px",v.style.height=e.row.height+"px";const f=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(l=null===(a=null===(o=f[t].style)||void 0===o?void 0:o.grid)||void 0===a?void 0:a.block)||void 0===l?void 0:l.children;e&&(v.style=Object.assign(Object.assign({},v.style),e))}const m=null===(p=null===(u=null===(d=null===(c=e.row)||void 0===c?void 0:c.style)||void 0===d?void 0:d.grid)||void 0===u?void 0:u.block)||void 0===p?void 0:p.current;m&&(v.style=Object.assign(Object.assign({},v.style),m)),r()})),-1===u.indexOf($t)&&u.push($t),n=>p(a`
        <div class=${m} data-actions=${o(u,h)} style=${v}>
          <div class=${g} />
        </div>
      `,{props:e,vido:t,templateProps:n})};
/**
 ...
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */
function ChartTimelineItems(t,e={}){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l,StyleMap:c}=t,d=n.getActions("chart-timeline-items");let h;s(i.subscribe("config.wrappers.ChartTimelineItems",t=>h=t));const u=i.get("config.components.ChartTimelineItemsRow");let p;s(i.subscribe("config.classNames",()=>{p=n.getClass("chart-timeline-items"),r()}));let f=new c({});s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","config.scroll.compensation"],()=>{const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height"),n=i.get("config.scroll.compensation");f.style.width=t+"px",f.style.height=e+Math.abs(n)+"px"}));let m=[];s(i.subscribeAll(["_internal.list.visibleRows","config.chart.items","config.list.rows"],()=>{const t=i.get("_internal.list.visibleRows");m=l(m,t,t=>({row:t}),u),r()},{bulk:!0})),s((function destroyRows(){m.forEach(t=>t.destroy())}));const g={api:n,state:i};return n=>h(a`
        <div class=${p} style=${f} data-actions=${o(d,g)}>
          ${m.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const Mt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-rows",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}),Ot=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,reuseComponents:c,StyleMap:d}=t,h=Object.assign(Object.assign({},e),{api:n,state:i});let u;s(i.subscribe("config.wrappers.ChartTimelineItemsRow",t=>u=t));const p=i.get("config.components.ChartTimelineItemsRowItem");let f,m,g=`_internal.flatTreeMapById.${e.row.id}._internal.items`,v=new d({opacity:"1",pointerEvents:"auto",width:"",height:""}),y=[];const b=()=>{const t=i.get("_internal.chart");if(v.style.opacity="1",v.style.pointerEvents="auto",v.style.width=t.dimensions.width+"px",!e)return v.style.opacity="0",void(v.style.pointerEvents="none");v.style.height=e.row.height+"px",v.style["--row-height"]=e.row.height+"px"};l((t,n)=>{if(n.leave)return b(),r();e=t;for(const t in e)h[t]=e[t];(t=>{g=`_internal.flatTreeMapById.${t.id}._internal.items`,"function"==typeof f&&f(),"function"==typeof m&&m(),f=i.subscribe("_internal.chart",(t,e)=>{b(),r()}),m=i.subscribe(g,e=>{y=c(y,e,e=>({row:t,item:e}),p),b(),r()})})(e.row)}),s(()=>{m(),f(),y.forEach(t=>t.destroy())});const w=n.getActions("chart-timeline-items-row");let _;return s(i.subscribe("config.classNames",()=>{_=n.getClass("chart-timeline-items-row",e),r()})),w.includes(Mt)||w.push(Mt),n=>u(a`
        <div class=${_} data-actions=${o(w,h)} style=${v}>
          ${y.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:n})},Pt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-row-items",(function updateRowItems(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}});function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,unsafeHTML:c,StyleMap:d}=t;let h;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>h=t));let u=new d({width:"",height:"",left:"",opacity:"1",pointerEvents:"auto"}),p=new d({width:"",height:""}),f=0,m=0,g=!1;const v={item:e.item,row:e.row,left:f,width:m,api:n,state:i};function updateItem(){var t,s,o,a,l,c,d,h;if(g)return;let v=i.get("_internal.chart.time");f=(e.item.time.start-v.leftGlobal)/v.timePerPixel,f=.1*Math.round(10*f),m=(e.item.time.end-e.item.time.start)/v.timePerPixel,(m-=i.get("config.chart.spacing")||0)&&(m=.1*Math.round(10*m));const y=u.style.width,b=u.style.height,w=u.style.left;u.style={};const _=n.isItemInViewport(e.item,v.leftGlobal,v.rightGlobal);u.style.opacity=_?"1":"0",u.style.pointerEvents=_?"auto":"none",_?(u.style.width=m+"px",u.style.height=e.row.height+"px",u.style.left=f+"px"):(u.style.width=y,u.style.height=b,u.style.left=w),p.style={width:m+"px","max-height":e.row.height+"px"};const x=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(o=null===(s=null===(t=x[n].style)||void 0===t?void 0:t.items)||void 0===s?void 0:s.item)||void 0===o?void 0:o.children;e&&(p.style=Object.assign(Object.assign({},p.style),e))}const $=null===(d=null===(c=null===(l=null===(a=e.row)||void 0===a?void 0:a.style)||void 0===l?void 0:l.items)||void 0===c?void 0:c.item)||void 0===d?void 0:d.current;$&&(p.style=Object.assign(Object.assign({},p),$));const C=null===(h=e.item)||void 0===h?void 0:h.style;C&&(p.style=Object.assign(Object.assign({},p.style),C)),r()}l((function onPropsChange(t,n){if(n.leave)return g=!0,u.style.opacity="0",u.style.pointerEvents="none",r();g=!1,e=t,v.item=e.item,v.row=e.row,v.left=f,v.width=m,updateItem()}));const y="chart-timeline-items-row-item",b=n.getActions(y);let w,_,x;return s(i.subscribe("config.classNames",()=>{w=n.getClass(y,e),_=n.getClass(y+"-content",e),x=n.getClass(y+"-content-label",e),r()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()})),-1===b.indexOf(Pt)&&b.push(Pt),n=>h(a`
        <div class=${w} data-actions=${o(b,v)} style=${u}>
          <div class=${_} style=${p}>
            <div class=${x}>
              ${e.item.isHtml?c(e.item.label):e.item.label}
            </div>
          </div>
        </div>
      `,{vido:t,props:e,templateProps:n})}
 ...
 * @license   GPL-3.0
 */
const Rt="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const Lt={name:Rt,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,hammer:t,date:t=>t?It(t):It(),dayjs:It};
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
 ...
 * @license   GPL-3.0
 */
function GSTC(e){const n=e.state,i=function getInternalApi(e){let n=e.get(),i=[];const s={name:Rt,debug:!1,log(...t){this.debug&&console.log.call(console,...t)},hammer:t,mergeDeep:mergeDeep$1,getClass(t){let e=`${Rt}__${t}`;return t===this.name&&(e=this.name),e},allActions:[],getActions(t){this.allActions.includes(t)||this.allActions.push(t);let n=e.get("config.actions."+t);return void 0===n&&(n=[]),n},isItemInViewport:(t,e,n)=>t.time.start>=e&&t.time.start<n||t.time.end>=e&&t.time.end<n,fillEmptyRowValues(t){let e=0;for(const i in t){const s=t[i];s._internal={parents:[],children:[],items:[]},"number"!=typeof s.height&&(s.height=n.config.list.rowHeight),"boolean"!=typeof s.expanded&&(s.expanded=!1),s.top=e,e+=s.height}return t},generateParents(t,e="parentId"){const n={};for(const i of t){const t=void 0!==i[e]?i[e]:"";void 0===n[t]&&(n[t]={}),n[t][i.id]=i}return n},fastTree(t,e,n=[]){const i=t[e.id];if(e._internal.parents=n,void 0===i)return e._internal.children=[],e;""!==e.id&&(n=[...n,e.id]),e._internal.children=Object.values(i);for(const e in i){const s=i[e];this.fastTree(t,s,n)}return e},makeTreeMap(t,e){const n=this.generateParents(e,"rowId");for(const e of t)e._internal.items=void 0!==n[e.id]?Object.values(n[e.id]):[];const i=this.generateParents(t);return this.fastTree(i,{id:"",_internal:{children:[],parents:[],items:[]}})},getFlatTreeMapById(t,e={}){for(const n of t._internal.children)e[n.id]=n,this.getFlatTreeMapById(n,e);return e},flattenTreeMap(t,e=[]){for(const n of t._internal.children)e.push(n.id),this.flattenTreeMap(n,e);return e},getRowsFromMap:(t,e)=>t.map(t=>e[t.id]),getRowsFromIds(t,e){const n=[];for(const i of t)n.push(e[i]);return n},getRowsWithParentsExpanded(t,e,n){const i=[];t:for(const s of t){for(const t of e[s]._internal.parents){if(!n[t].expanded)continue t}i.push(s)}return i},getRowsHeight(t){let e=0;for(let n of t)e+=n.height;return e},getVisibleRowsAndCompensation(t){const n=[];let i=0,s=0;const o=e.get("config.scroll.top"),r=e.get("_internal.height");let a=0,l=0;for(const e of t)if(a=o+r,i+e.height>=o&&i<=a&&(e.top=s,l=e.top+o-i,s+=e.height,n.push(e)),(i+=e.height)>=a)break;return{visibleRows:n,compensation:l}},normalizeMouseWheelEvent(t){let e=t.deltaX||0,n=t.deltaY||0,i=t.deltaZ||0;const s=t.deltaMode,o=parseInt(getComputedStyle(t.target).getPropertyValue("line-height"));let r=1;switch(s){case 1:r=o;break;case 2:r=window.height}return{x:e*=r,y:n*=r,z:i*=r,event:t}},limitScroll(t,n){if("top"===t){const t=e.get("_internal.list.rowsHeight")-e.get("_internal.height");return n<0?n=0:n>t&&(n=t),n}{const t=e.get("_internal.chart.time.totalViewDurationPx")-e.get("_internal.chart.dimensions.width");return n<0?n=0:n>t&&(n=t),n}},time:timeApi(e),getScrollBarHeight(){const t=document.createElement("div");t.style.visibility="hidden",t.style.height="100px",t.style.msOverflowStyle="scrollbar",document.body.appendChild(t);var e=t.offsetHeight;t.style.overflow="scroll";var n=document.createElement("div");n.style.height="100%",t.appendChild(n);var i=n.offsetHeight;return t.parentNode.removeChild(t),e-i+1},getGridBlocksUnderRect(t,n,i,s){if(!e.get("_internal.elements.main"))return[]},destroy(){n=void 0;for(const t of i)t();i=[],s.debug&&delete window.state}};return s.debug&&(window.state=e,window.api=s),s}(n),s={components:{Main:Main},scrollBarHeight:17,height:0,treeMap:{},flatTreeMap:[],flatTreeMapById:{},list:{expandedHeight:0,visibleRows:[],rows:{},width:0},dimensions:{width:0,height:0},chart:{dimensions:{width:0,innerWidth:0},visibleItems:[],time:{dates:{},timePerPixel:0,firstTaskTime:0,lastTaskTime:0,totalViewDurationMs:0,totalViewDurationPx:0,leftGlobal:0,rightGlobal:0,leftPx:0,rightPx:0,leftInner:0,rightInner:0,maxWidth:{}}},elements:{}};"boolean"==typeof e.debug&&e.debug&&(window.state=n),n.update("",t=>({config:t.config,_internal:s}));const o=Vido(n,i);return{state:n,app:o.createApp({component:Main,props:o,element:e.element})}}GSTC.api=Lt;export default GSTC;
