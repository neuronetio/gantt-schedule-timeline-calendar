 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function Zt(t,e){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,reuseComponents:l}=t,c=n.getActions("chart-timeline-grid");let d;i(s.subscribe("config.wrappers.ChartTimelineGrid",t=>d=t));const u=s.get("config.components.ChartTimelineGridRow");let h,p,f,m;i(s.subscribe("config.classNames",()=>{h=n.getClass("chart-timeline-grid"),r()})),i(s.subscribe("_internal.height",t=>{f=`height: ${p=t}px`,r()})),i(s.subscribe("config.chart.time.period",t=>m=t));let g=[];return i(s.subscribeAll(["_internal.list.visibleRows;",`_internal.chart.time.dates.${m};`],(function(){const t=s.get("_internal.list.visibleRows"),e=s.get(`_internal.chart.time.dates.${m}`);if(!e||0===e.length)return;let n=0;const i=[];let o=0;for(const s of t){const t=[];for(const i of e)t.push({id:o,time:i,row:s,top:n}),o++;i.push({row:s,blocks:t,top:n}),n+=s.height}l(g,i,t=>t,u),r()}),{bulk:!0})),c.push(t=>{s.update("_internal.elements.chart-timeline-grid",t)}),i(()=>{g.forEach(t=>t.destroy())}),i=>d(a`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function Xt(t,e){return e.state.update("_internal.elements.chart-timeline-grid-rows."+e.row.id,{element:t,data:e},{only:null}),{update(t,n){n.row.id!==e.row.id&&e.state.update("_internal.elements.chart-timeline-grid-rows."+n.row.id,{element:t,data:n},{only:null})},destroy(t,e){e.state.update("_internal.elements.chart-timeline-grid-rows",t=>(delete t[e.id],t))}}}function Kt(t,e){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,reuseComponents:l,onChange:c}=t;let d;i(s.subscribe("config.wrappers.ChartTimelineGridRow",t=>{d=t,r()}));const u=s.get("config.components.ChartTimelineGridRowBlock"),h=n.getActions("chart-timeline-grid-row");let p,f=n.getClass("chart-timeline-grid-row"),m=[];return c(t=>{l(m,(e=t).blocks,t=>t,u),p=`height: ${e.row.height}px;`,r()}),i(()=>{m.forEach(t=>t.destroy())}),-1===h.indexOf(Xt)&&h.push(Xt),i=>d(a`
        <div
          class=${f}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function Qt(t,e){return e.state.update("_internal.elements.chart-timeline-grid-row-blocks."+e.id,{element:t,data:e},{only:null}),{update(t,n){n.id!==e.id&&e.state.update("_internal.elements.chart-timeline-grid-row-blocks."+n.id,{element:t,data:n},{only:null})},destroy(t,e){e.state.update("_internal.elements.chart-timeline-grid-row-blocks",t=>(delete t[e.id],t))}}}function te(t,e){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,onChange:l}=t,c="chart-timeline-grid-row-block",d=n.getActions(c);let u;i(s.subscribe("config.wrappers.ChartTimelineGridRowBlock",t=>{u=t,r()}));const h=n.time.date().startOf("day").valueOf();let p;function f(t){p=n.getClass(c),t.leftGlobal===h&&(p+=" current")}f(e.time);let m=`width: ${e.time.width}px;height: 100%;margin-left:-${e.time.subPx}px;`;return l(t=>{f((e=t).time),m=`width: ${e.time.width}px; height: 100%; margin-left:-${e.time.subPx}px; `;const n=s.get("config.list.rows");for(const t of e.row._internal.parents){const e=n[t];"object"==typeof e.style&&"object"==typeof e.style.gridBlock&&"string"==typeof e.style.gridBlock.children&&(m+=e.style.gridBlock.children)}"object"==typeof e.row.style&&"object"==typeof e.row.style.gridBlock&&"string"==typeof e.row.style.gridBlock.current&&(m+=e.row.style.gridBlock.current),r()}),-1===d.indexOf(Qt)&&d.push(Qt),()=>u(a`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ee(t,e={}){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,reuseComponents:l}=t,c=n.getActions("chart-timeline-items");let d;i(s.subscribe("config.wrappers.ChartTimelineItems",t=>d=t));const u=s.get("config.components.ChartTimelineItemsRow");let h;i(s.subscribe("config.classNames",()=>{h=n.getClass("chart-timeline-items"),r()}));let p=[];i(s.subscribeAll(["_internal.list.visibleRows","config.chart.items","config.list.rows"],()=>{const t=s.get("_internal.list.visibleRows");p=l(p,t,t=>({row:t}),u),r()},{bulk:!0}));let f="top:0px;";return i(s.subscribe("config.scroll.compensation",t=>{f=`top: ${t}px;`})),i(()=>{p.forEach(t=>t.destroy())}),e=>d(a`
 ...
 * @package   gantt-schedule-timeline-calendar
 * @license   GPL-3.0
 */const ge="gantt-schedule-timeline-calendar";function ve(t){return t&&"object"==typeof t&&!Array.isArray(t)}function be(t,...e){const n=e.shift();if(ve(t)&&ve(n))for(const e in n)if(ve(n[e]))void 0===t[e]&&(t[e]={}),t[e]=be(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let s of n[e])ve(s)?t[e].push(be({},s)):t[e].push(s)}else t[e]=n[e];return e.length?be(t,...e):t}
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
