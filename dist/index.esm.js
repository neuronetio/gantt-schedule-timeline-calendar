 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const S=(t,...e)=>new TemplateResult(t,e,"html",O),T=(t,...e)=>new SVGTemplateResult(t,e,"svg",O);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
var A=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},verb("next"),verb("throw"),verb("return"),e[Symbol.asyncIterator]=function(){return this},e);function verb(n){e[n]=t[n]&&function(e){return new Promise((function(i,s){(function settle(t,e,n,i){Promise.resolve(i).then((function(e){t({value:e,done:n})}),e)})(i,s,(e=t[n](e)).done,e.value)}))}}};const R=t((t,e)=>async n=>{var i,s;if(!(n instanceof NodePart))throw new Error("asyncAppend can only be used in text bindings");if(t===n.value)return;let o;n.value=t;let r=0;try{for(var a,l=A(t);!(a=await l.next()).done;){let i=a.value;if(n.value!==t)break;0===r&&n.clear(),void 0!==e&&(i=e(i,r));let s=n.startNode;void 0!==o&&(s=m(),o.endNode=s,n.endNode.parentNode.insertBefore(s,n.endNode)),(o=new NodePart(n.options)).insertAfterNode(s),o.setValue(i),o.commit(),r++}}catch(t){i={error:t}}finally{try{a&&!a.done&&(s=l.return)&&await s.call(l)}finally{if(i)throw i.error}}});
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */var L=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},verb("next"),verb("throw"),verb("return"),e[Symbol.asyncIterator]=function(){return this},e);function verb(n){e[n]=t[n]&&function(e){return new Promise((function(i,s){(function settle(t,e,n,i){Promise.resolve(i).then((function(e){t({value:e,done:n})}),e)})(i,s,(e=t[n](e)).done,e.value)}))}}};const N=t((t,e)=>async n=>{var i,s;if(!(n instanceof NodePart))throw new Error("asyncReplace can only be used in text bindings");if(t===n.value)return;const o=new NodePart(n.options);n.value=t;let r=0;try{for(var a,l=L(t);!(a=await l.next()).done;){let i=a.value;if(n.value!==t)break;0===r&&(n.clear(),o.appendIntoPart(n)),void 0!==e&&(i=e(i,r)),o.setValue(i),o.commit(),r++}}catch(t){i={error:t}}finally{try{a&&!a.done&&(s=l.return)&&await s.call(l)}finally{if(i)throw i.error}}}),E=new WeakMap,j=t(t=>e=>{if(!(e instanceof NodePart))throw new Error("cache can only be used in text bindings");let n=E.get(e);void 0===n&&(n=new WeakMap,E.set(e,n));const s=e.value;if(s instanceof TemplateInstance){if(t instanceof TemplateResult&&s.template===e.options.templateFactory(t))return void e.setValue(t);{let t=n.get(s.template);void 0===t&&(t={instance:s,nodes:document.createDocumentFragment()},n.set(s.template,t)),i(t.nodes,e.startNode.nextSibling,e.endNode)}}if(t instanceof TemplateResult){const i=e.options.templateFactory(t),s=n.get(i);void 0!==s&&(e.setValue(s.nodes),e.commit(),e.value=s.instance)}e.setValue(t)}),H=new WeakMap,k=t(t=>e=>{if(!(e instanceof AttributePart)||e instanceof PropertyPart||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:n}=e,{element:i}=n;let s=H.get(e);void 0===s&&(i.className=n.strings.join(" "),H.set(e,s=new Set));const{classList:o}=i;s.forEach(e=>{e in t||(o.remove(e),s.delete(e))});for(const e in t){const n=t[e];n!=s.has(e)&&(n?(o.add(e),s.add(e)):(o.remove(e),s.delete(e)))}}),V=new WeakMap,z=t((t,e)=>n=>{const i=V.get(n);if(Array.isArray(t)){if(Array.isArray(i)&&i.length===t.length&&t.every((t,e)=>t===i[e]))return}else if(i===t&&(void 0!==t||V.has(n)))return;n.setValue(e()),V.set(n,Array.isArray(t)?Array.from(t):t)}),W=t(t=>e=>{if(void 0===t&&e instanceof AttributePart){if(t!==e.value){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else e.setValue(t)}),G=(t,e)=>{const n=t.startNode.parentNode,i=void 0===e?t.endNode:e.startNode,s=n.insertBefore(m(),i);n.insertBefore(m(),i);const o=new NodePart(t.options);return o.insertAfterNode(s),o},B=(t,e)=>(t.setValue(e),t.commit(),t),Y=(t,e,n)=>{const s=t.startNode.parentNode,o=n?n.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&i(s,e.startNode,r,o)},F=t=>{s(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},U=(t,e,n)=>{const i=new Map;for(let s=e;s<=n;s++)i.set(t[s],s);return i},J=new WeakMap,q=new WeakMap,Z=t((t,e,n)=>{let i;return void 0===n?n=e:void 0!==e&&(i=e),e=>{if(!(e instanceof NodePart))throw new Error("repeat can only be used in text bindings");const s=J.get(e)||[],o=q.get(e)||[],r=[],a=[],l=[];let c,d,h=0;for(const e of t)l[h]=i?i(e,h):h,a[h]=n(e,h),h++;let u=0,p=s.length-1,f=0,m=a.length-1;for(;u<=p&&f<=m;)if(null===s[u])u++;else if(null===s[p])p--;else if(o[u]===l[f])r[f]=B(s[u],a[f]),u++,f++;else if(o[p]===l[m])r[m]=B(s[p],a[m]),p--,m--;else if(o[u]===l[m])r[m]=B(s[u],a[m]),Y(e,s[u],r[m+1]),u++,m--;else if(o[p]===l[f])r[f]=B(s[p],a[f]),Y(e,s[p],s[u]),p--,f++;else if(void 0===c&&(c=U(l,f,m),d=U(o,u,p)),c.has(o[u]))if(c.has(o[p])){const t=d.get(l[f]),n=void 0!==t?s[t]:null;if(null===n){const t=G(e,s[u]);B(t,a[f]),r[f]=t}else r[f]=B(n,a[f]),Y(e,n,s[u]),s[t]=null;f++}else F(s[p]),p--;else F(s[u]),u++;for(;f<=m;){const t=G(e,r[m+1]);B(t,a[f]),r[f++]=t}for(;u<=p;){const t=s[u++];null!==t&&F(t)}J.set(e,r),q.set(e,l)}}),X=new WeakMap,K=document.createElement("template"),Q=t(t=>e=>{if(!(e instanceof NodePart))throw new Error("unsafeHTML can only be used in text bindings");const n=X.get(e);if(void 0!==n&&w(t)&&t===n.value&&e.value===n.fragment)return;const i=K.cloneNode();i.innerHTML=t;const s=document.importNode(i.content,!0);e.setValue(s),X.set(e,{value:t,fragment:s})}),tt=new WeakMap,et=t((...t)=>e=>{let n=tt.get(e);void 0===n&&(n={lastRenderedIndex:2147483647,values:[]},tt.set(e,n));const i=n.values;let s=i.length;n.values=t;for(let o=0;o<t.length&&!(o>n.lastRenderedIndex);o++){const r=t[o];if(w(r)||"function"!=typeof r.then){e.setValue(r),n.lastRenderedIndex=o;break}o<s&&r===i[o]||(n.lastRenderedIndex=2147483647,s=0,Promise.resolve(r).then(t=>{const i=n.values.indexOf(r);i>-1&&i<n.lastRenderedIndex&&(n.lastRenderedIndex=i,e.setValue(t),e.commit())}))}});
/**
 * @license
 ...
 */function ListColumn(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,reuseComponents:l,html:c,StyleMap:d}=t;let h,u,p;s(i.subscribe("config.wrappers.ListColumn",t=>h=t)),s(i.subscribe("config.components.ListColumnRow",t=>u=t)),s(i.subscribe("config.components.ListColumnHeader",t=>p=t));let f,m=`config.list.columns.data.${e.columnId}`;s(i.subscribe(m,(function columnChanged(t){f=t,r()})));const g=n.getActions("list-column"),v=n.getActions("list-column-rows");let y,b,w;const _=new d({width:"","--width":""}),$=new d({width:"",height:""}),x=new d({width:"",height:""});let C;s(i.subscribe("config.classNames",t=>{y=n.getClass("list-column",{column:f}),b=n.getClass("list-column-rows",{column:f}),r()}));s(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${f.id}.width`,"_internal.chart.dimensions.width","_internal.height","config.scroll.compensation"],()=>{const t=i.get("config.list"),e=i.get("config.scroll.compensation");w=t.columns.data[f.id].width*t.columns.percent*.01,C=w;const n=i.get("_internal.height");_.style.width=C+"px",_.style["--width"]=C+"px",$.style.width=C+"px",$.style.height=n+"px",x.style.width=C+"px",x.style.height=n+"px",x.style.transform=`translate(0px, ${e}px)`},{bulk:!0}));let M=[];s(i.subscribe("_internal.list.visibleRows;",t=>{l(M,t,t=>t&&{columnId:e.columnId,rowId:t.id,width:C},u),r()})),s((function rowsDestroy(){M.forEach(t=>t.destroy())}));const O=a(p,{columnId:e.columnId});function getRowHtml(t){return t.html()}s(O.destroy);const P={column:f,state:i,api:n},D={api:n,state:i};return n=>h(c`
        <div class=${y} data-actions=${o(g,P)} style=${_}>
          ...
          <div
            ...
            data-actions=${o(v,D)}
          >
            <div class=${b+"--scroll-compensation"} style=${x}>
              ${M.map(getRowHtml)}
            </div>
          </div>
        </div>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:s,update:o,html:r,actions:a,cache:l,StyleMap:c}=t,d="list-column-header-resizer",h=n.getActions(d);let u,p,f,m,g,v,y,b,w;s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>u=t)),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{p=t,o()}));let _=!1;s(i.subscribe("config.classNames",t=>{f=n.getClass(d,{column:p}),m=n.getClass(d+"-container",{column:p}),g=n.getClass(d+"-dots",{column:p}),v=n.getClass(d+"-dots-dot",{column:p}),y=n.getClass(d+"-line",{column:p}),o()})),s(i.subscribeAll([`config.list.columns.data.${p.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");b=p.width*n.columns.percent*.01,w=`width: ${n.columns.resizer.width}px`,_=n.columns.resizer.inRealTime,o()}));let $=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{$=[];for(let e=0;e<t;e++)$.push(e);o()}));let x=!1,C=b;const M=new c({"--display":"none","--left":C+"px"}),O=`config.list.columns.data.${p.id}.width`;function onMouseDown(t){x=!0,i.update("_internal.list.columns.resizer.active",!0),x?(M.style.display="block",M.style["--left"]=C+"px"):(M.style.display="none",M.style["--left"]="0px")}function onMouseMove(t){if(x){let e=i.get("config.list.columns.minWidth");"number"==typeof p.minWidth&&(e=p.minWidth),(C+=t.movementX)<e&&(C=e),_&&i.update(O,C)}}function onMouseUp(t){x&&(i.update("_internal.list.columns.resizer.active",!1),i.update(O,C),x=!1)}document.body.addEventListener("mousemove",onMouseMove),s(()=>document.body.removeEventListener("mousemove",onMouseMove)),document.body.addEventListener("mouseup",onMouseUp),s(()=>document.body.removeEventListener("mouseup",onMouseUp));const P={column:p,api:n,state:i};return n=>u(r`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimelineGrid(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l,StyleMap:c}=t,d=n.getActions("chart-timeline-grid"),h={api:n,state:i};let u;s(i.subscribe("config.wrappers.ChartTimelineGrid",t=>u=t));const p=i.get("config.components.ChartTimelineGridRow");let f,m,g;s(i.subscribe("config.classNames",()=>{f=n.getClass("chart-timeline-grid"),r()})),s(i.subscribe("config.chart.time.period",t=>m=t)),s(i.subscribe("config.chart.grid.block.onCreate",t=>g=t));let v=[];const y=[],b=new Map,w=new c({});s(i.subscribeAll(["_internal.list.visibleRows;",`_internal.chart.time.dates.${m};`,"_internal.height","_internal.chart.dimensions.width"],()=>{const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height"),s=i.get(`_internal.chart.time.dates.${m}`),o=i.get("_internal.list.visibleRows");if(!s||0===s.length)return;w.style.height=e+"px",w.style.width=t+"px";let r=0;y.length=0;for(const e of o){const i=[];for(const t of s){let s;b.has(t.leftGlobal)?s=b.get(t.leftGlobal):(s=n.time.date(t.leftGlobal).format("YYYY-MM-DD"),b.set(t.leftGlobal,s));let o={id:e.id+":"+s,time:t,row:e,top:r};for(const t of g)o=t(o);i.push(o)}y.push({row:e,blocks:i,top:r,width:t}),r+=e.height}i.update("_internal.chart.grid.rowsWithBlocks",y)},{bulk:!0}));return s(i.subscribe("_internal.chart.grid.rowsWithBlocks",t=>{t&&(l(v,t,t=>t,p),r())})),d.includes((function bindElement(t){i.update("_internal.elements.chart-timeline-grid",t)}))||d.push(),s(()=>{v.forEach(t=>t.destroy())}),n=>u(a`
 ...
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */
function ChartTimelineItems(t,e={}){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l,StyleMap:c}=t,d=n.getActions("chart-timeline-items");let h;s(i.subscribe("config.wrappers.ChartTimelineItems",t=>h=t));const u=i.get("config.components.ChartTimelineItemsRow");let p;s(i.subscribe("config.classNames",()=>{p=n.getClass("chart-timeline-items"),r()}));let f=new c({});s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width"],()=>{const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height");f.style.width=t+"px",f.style.height=e+"px"}));let m=[];s(i.subscribeAll(["_internal.list.visibleRows","config.chart.items","config.list.rows"],()=>{const t=i.get("_internal.list.visibleRows");m=l(m,t,t=>({row:t}),u),r()},{bulk:!0})),s((function destroyRows(){m.forEach(t=>t.destroy())}));const g={api:n,state:i};return n=>h(a`
 ...
 * @license   GPL-3.0
 */
const Tt="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const At={name:Tt,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,date:t=>t?Pt(t):Pt(),dayjs:Pt};
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
