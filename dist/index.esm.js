 ...
 * @package   gantt-schedule-timeline-calendar
 * @license   GPL-3.0
 */const zt="gantt-schedule-timeline-calendar";function Gt(t){return t&&"object"==typeof t&&!Array.isArray(t)}function Bt(t,...e){const n=e.shift();if(Gt(t)&&Gt(n))for(const e in n)if(Gt(n[e]))void 0===t[e]&&(t[e]={}),t[e]=Bt(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])Gt(i)?t[e].push(Bt({},i)):t[e].push(i)}else t[e]=n[e];return e.length?Bt(t,...e):t}
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
