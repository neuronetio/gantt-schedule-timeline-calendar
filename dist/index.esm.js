 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumn(t,e){const{api:n,state:s,onDestroy:i,actions:o,update:r,createComponent:a,reuseComponents:l,html:c}=t;let d,u,h;i(s.subscribe("config.wrappers.ListColumn",t=>d=t)),i(s.subscribe("config.components.ListColumnRow",t=>u=t)),i(s.subscribe("config.components.ListColumnHeader",t=>h=t));let p,m=`config.list.columns.data.${e.columnId}`;i(s.subscribe(m,(function columnChanged(t){p=t,r()})));const f=n.getActions("list-column"),g=n.getActions("list-column-rows");let v,b,y,w,_,$;i(s.subscribe("config.classNames",t=>{v=n.getClass("list-column",{column:p}),b=n.getClass("list-column-rows",{column:p}),r()}));let x=[];i(s.subscribe("_internal.list.visibleRows;",(function visibleRowsChange(t){l(x,t,t=>({columnId:e.columnId,rowId:t.id}),u),r()}))),i(()=>{x.forEach(t=>t.destroy())}),i(s.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${p.id}.width`,"_internal.height","config.scroll.compensation"],(function calculateStyle(){const t=s.get("config.list"),e=s.get("config.scroll.compensation");y=t.columns.data[p.id].width*t.columns.percent*.01,w=`width: ${y+t.columns.resizer.width}px`,_=`height: ${s.get("_internal.height")}px;`,$=`transform: translate(0px, ${e}px);`}),{bulk:!0}));const C=a(h,{columnId:e.columnId});function getRowHtml(t){return t.html()}return i(C.destroy),function updateTemplate(i){return d(c`
        <div
          class=${v}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimeline(t,e){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,createComponent:l}=t,c=n.getActions("chart-timeline");let d;i(s.subscribe("config.wrappers.ChartTimeline",t=>d=t));const u=s.get("config.components.ChartTimelineGrid"),h=s.get("config.components.ChartTimelineItems"),p=l(u);i(p.destroy);const m=l(h);let f,g;i(m.destroy),i(s.subscribe("config.classNames",()=>{f=n.getClass("chart-timeline"),g=n.getClass("chart-timeline-inner"),r()}));let v="",b="";return i(s.subscribeAll(["_internal.height","_internal.list.rowsHeight","config.scroll.compensation"],(function calculateStyle(){v=`height: ${s.get("_internal.height")}px`;const t=s.get("config.scroll.compensation");b=`height: ${s.get("_internal.list.rowsHeight")}px; transform: translate(0px, ${t}px);`,r()}))),c.push(t=>{s.update("_internal.elements.chart-timeline",t)}),i=>d(a`
        <div
          class=${f}
          style=${v}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimelineGrid(t,e){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,reuseComponents:l}=t,c=n.getActions("chart-timeline-grid");let d;i(s.subscribe("config.wrappers.ChartTimelineGrid",t=>d=t));const u=s.get("config.components.ChartTimelineGridRow");let h,p,m,f,g;i(s.subscribe("config.classNames",()=>{h=n.getClass("chart-timeline-grid"),r()})),i(s.subscribe("_internal.height",t=>{m=`height: ${p=t}px`,r()})),i(s.subscribe("config.chart.time.period",t=>f=t)),i(s.subscribe("config.chart.grid.block.onCreate",t=>g=t));let v=[];return i(s.subscribeAll(["_internal.list.visibleRows;",`_internal.chart.time.dates.${f};`],(function generateBlocks(){const t=s.get("_internal.list.visibleRows"),e=s.get(`_internal.chart.time.dates.${f}`);if(!e||0===e.length)return;let i=0;const o=[];for(const s of t){const t=[];for(const o of e){let e={id:s.id+":"+n.time.date(o.leftGlobal).format("YYYY-MM-DD"),time:o,row:s,top:i};for(const t of g)e=t(e);t.push(e)}o.push({row:s,blocks:t,top:i}),i+=s.height}s.update("_internal.chart.grid.rowsWithBlocks",o)}),{bulk:!0})),i(s.subscribe("_internal.chart.grid.rowsWithBlocks",(function generateRowsComponents(t){t&&(l(v,t,t=>t,u),r())}))),c.includes((function bindElement(t){s.update("_internal.elements.chart-timeline-grid",t)}))||c.push(),i(()=>{v.forEach(t=>t.destroy())}),function updateTemplate(i){return d(a`
        <div class=${h} data-actions=${o(c,{api:n,state:s})} style=${m}>
          ${v.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:i})}}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimelineItems(t,e={}){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a,reuseComponents:l}=t,c=n.getActions("chart-timeline-items");let d;i(s.subscribe("config.wrappers.ChartTimelineItems",t=>d=t));const u=s.get("config.components.ChartTimelineItemsRow");let h;i(s.subscribe("config.classNames",()=>{h=n.getClass("chart-timeline-items"),r()}));let p=[];return i(s.subscribeAll(["_internal.list.visibleRows","config.chart.items","config.list.rows"],(function createRowComponents(){const t=s.get("_internal.list.visibleRows");p=l(p,t,t=>({row:t}),u),r()}),{bulk:!0})),i(()=>{p.forEach(t=>t.destroy())}),i=>d(a`
        <div class=${h} data-actions=${o(c,{api:n,state:s})}>
          ${p.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:i})}
/**
 ...
 * @package   gantt-schedule-timeline-calendar
 * @license   GPL-3.0
 */const xt="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let s of n[e])isObject$1(s)?t[e].push(mergeDeep$1({},s)):t[e].push(s)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
