 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */let b;const y=` ${l} `,w=document.createElement("template");class TemplateResult{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let i=0;i<t;i++){const t=this.strings[i],s=t.lastIndexOf("\x3c!--");n=(s>-1||n)&&-1===t.indexOf("--\x3e",s+1);const o=v.exec(t);e+=null===o?t+(n?y:d):t.substr(0,o.index)+o[1]+o[2]+u+o[3]+l}return e+=this.strings[t]}getTemplateElement(){const t=w.cloneNode();return t.innerHTML=function convertConstantTemplateStringToTrustedHTML(t){const e=window,n=e.trustedTypes||e.TrustedTypes;return n&&!b&&(b=n.createPolicy("lit-html",{createHTML:t=>t})),b?b.createHTML(t):t}(this.getHTML()),t}}class SVGTemplateResult extends TemplateResult{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,n=e.firstChild;return e.removeChild(n),s(e,n.firstChild),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const _=t=>null===t||!("object"==typeof t||"function"==typeof t),$=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]),x=(t,e,n,i)=>t,C=document.createTextNode("");class AttributeCommitter{constructor(t,e,n){this.dirty=!0,this.element=t,this.name=e,this.strings=n,this.parts=[];for(let t=0;t<n.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new AttributePart(this)}_getValue(){const t=this.strings,e=this.parts,n=t.length-1;if(1===n&&""===t[0]&&""===t[1]&&void 0!==e[0]){const t=e[0].value;if(!$(t))return t}let i="";for(let s=0;s<n;s++){i+=t[s];const n=e[s];if(void 0!==n){const t=n.value;if(_(t)||!$(t))i+="string"==typeof t?t:String(t);else for(const e of t)i+="string"==typeof e?e:String(e)}}return i+=t[n]}commit(){if(this.dirty){this.dirty=!1;let t=this._getValue();"symbol"==typeof(t=x(t,this.name,"attribute",this.element))&&(t=String(t)),this.element.setAttribute(this.name,t)}}}class AttributePart{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===r||_(t)&&t===this.value||(this.value=t,n(t)||(this.committer.dirty=!0))}commit(){for(;n(this.value);){const t=this.value;this.value=r,t(this)}this.value!==r&&this.committer.commit()}}class NodePart{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(g()),this.endNode=t.appendChild(g())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=g()),t.__insert(this.endNode=g())}insertAfterPart(t){t.__insert(this.startNode=g()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){for(;n(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=r,t(this)}const t=this.__pendingValue;t!==r&&(_(t)?t!==this.value&&this.__commitText(t):t instanceof TemplateResult?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):$(t)?this.__commitIterable(t):t===a?(this.value=a,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){const e=this.startNode.nextSibling;if(t=null==t?"":t,e===this.endNode.previousSibling&&3===e.nodeType){const n=x(t);e.data="string"==typeof n?n:String(n)}else{const e=C.cloneNode();this.__commitNode(e);const n=x(t);e.data="string"==typeof n?n:String(n)}this.value=t}__commitTemplateResult(t){const e=this.options.templateFactory(t);if(this.value instanceof TemplateInstance&&this.value.template===e)this.value.update(t.values);else{if("SCRIPT"===this.endNode.parentNode.nodeName)return void this.__commitText("/* lit-html will not write TemplateResults to scripts and styles */");const n=new TemplateInstance(e,t.processor,this.options),i=n._clone();n.update(t.values),this.__commitNode(i),this.value=n}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let n,i=0;for(const s of t)void 0===(n=e[i])&&(n=new NodePart(this.options),e.push(n),0===i?n.appendIntoPart(this):n.insertAfterPart(e[i-1])),n.setValue(s),n.commit(),i++;i<e.length&&(e.length=i,this.clear(n&&n.endNode))}clear(t=this.startNode){o(this.startNode.parentNode,t.nextSibling,this.endNode)}}class BooleanAttributePart{constructor(t,e,n){if(this.value=void 0,this.__pendingValue=void 0,2!==n.length||""!==n[0]||""!==n[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=n}setValue(t){this.__pendingValue=t}commit(){for(;n(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=r,t(this)}if(this.__pendingValue===r)return;const t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=r}}class PropertyCommitter extends AttributeCommitter{constructor(t,e,n){super(t,e,n),this.single=2===n.length&&""===n[0]&&""===n[1]}_createPart(){return new PropertyPart(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){if(this.dirty){this.dirty=!1;let t=this._getValue();t=x(t,this.name,"property",this.element),this.element[this.name]=t}}}class PropertyPart extends AttributePart{}let M=!1;try{const t={get capture(){return M=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}class EventPart{constructor(t,e,n){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=n,this.__boundHandleEvent=t=>this.handleEvent(t)}setValue(t){this.__pendingValue=t}commit(){for(;n(this.__pendingValue);){const t=this.__pendingValue;this.__pendingValue=r,t(this)}if(this.__pendingValue===r)return;const t=this.__pendingValue,e=this.value,i=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),s=null!=t&&(null==e||i);i&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),s&&(this.__options=O(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=r}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const O=t=>t&&(M?{capture:t.capture,passive:t.passive,once:t.once}:t.capture);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const S=(t,...e)=>new TemplateResult(t,e,"html",P),A=(t,...e)=>new SVGTemplateResult(t,e,"svg",P);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */var N=function(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var e,n=t[Symbol.asyncIterator];return n?n.call(t):(t="function"==typeof __values?__values(t):t[Symbol.iterator](),e={},verb("next"),verb("throw"),verb("return"),e[Symbol.asyncIterator]=function(){return this},e);function verb(n){e[n]=t[n]&&function(e){return new Promise((function(i,s){(function settle(t,e,n,i){Promise.resolve(i).then((function(e){t({value:e,done:n})}),e)})(i,s,(e=t[n](e)).done,e.value)}))}}};const E=e((t,e)=>async n=>{var i,s;if(!(n instanceof NodePart))throw new Error("asyncReplace can only be used in text bindings");if(t===n.value)return;const o=new NodePart(n.options);n.value=t;let r=0;try{for(var a,l=N(t);!(a=await l.next()).done;){let i=a.value;if(n.value!==t)break;0===r&&(n.clear(),o.appendIntoPart(n)),void 0!==e&&(i=e(i,r)),o.setValue(i),o.commit(),r++}}catch(t){i={error:t}}finally{try{a&&!a.done&&(s=l.return)&&await s.call(l)}finally{if(i)throw i.error}}}),j=new WeakMap,k=e(t=>e=>{if(!(e instanceof NodePart))throw new Error("cache can only be used in text bindings");let n=j.get(e);void 0===n&&(n=new WeakMap,j.set(e,n));const i=e.value;if(i instanceof TemplateInstance){if(t instanceof TemplateResult&&i.template===e.options.templateFactory(t))return void e.setValue(t);{let t=n.get(i.template);void 0===t&&(t={instance:i,nodes:document.createDocumentFragment()},n.set(i.template,t)),s(t.nodes,e.startNode.nextSibling,e.endNode)}}if(t instanceof TemplateResult){const i=e.options.templateFactory(t),s=n.get(i);void 0!==s&&(e.setValue(s.nodes),e.commit(),e.value=s.instance)}e.setValue(t)}),H=new WeakMap,V=e(t=>e=>{if(!(e instanceof AttributePart)||e instanceof PropertyPart||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:n}=e,{element:i}=n;let s=H.get(e);void 0===s&&(i.className=n.strings.join(" "),H.set(e,s=new Set));const{classList:o}=i;s.forEach(e=>{e in t||(o.remove(e),s.delete(e))});for(const e in t){const n=t[e];n!=s.has(e)&&(n?(o.add(e),s.add(e)):(o.remove(e),s.delete(e)))}}),z=new WeakMap,W=e((t,e)=>n=>{const i=z.get(n);if(Array.isArray(t)){if(Array.isArray(i)&&i.length===t.length&&t.every((t,e)=>t===i[e]))return}else if(i===t&&(void 0!==t||z.has(n)))return;n.setValue(e()),z.set(n,Array.isArray(t)?Array.from(t):t)}),G=e(t=>e=>{if(void 0===t&&e instanceof AttributePart){if(t!==e.value){const t=e.committer.name;e.committer.element.removeAttribute(t)}}else e.setValue(t)}),B=(t,e)=>{const n=t.startNode.parentNode,i=void 0===e?t.endNode:e.startNode,s=n.insertBefore(g(),i);n.insertBefore(g(),i);const o=new NodePart(t.options);return o.insertAfterNode(s),o},Y=(t,e)=>(t.setValue(e),t.commit(),t),F=(t,e,n)=>{const i=t.startNode.parentNode,o=n?n.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&s(i,e.startNode,r,o)},U=t=>{o(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},J=(t,e,n)=>{const i=new Map;for(let s=e;s<=n;s++)i.set(t[s],s);return i},q=new WeakMap,Z=new WeakMap,X=e((t,e,n)=>{let i;return void 0===n?n=e:void 0!==e&&(i=e),e=>{if(!(e instanceof NodePart))throw new Error("repeat can only be used in text bindings");const s=q.get(e)||[],o=Z.get(e)||[],r=[],a=[],l=[];let c,d,h=0;for(const e of t)l[h]=i?i(e,h):h,a[h]=n(e,h),h++;let u=0,p=s.length-1,f=0,m=a.length-1;for(;u<=p&&f<=m;)if(null===s[u])u++;else if(null===s[p])p--;else if(o[u]===l[f])r[f]=Y(s[u],a[f]),u++,f++;else if(o[p]===l[m])r[m]=Y(s[p],a[m]),p--,m--;else if(o[u]===l[m])r[m]=Y(s[u],a[m]),F(e,s[u],r[m+1]),u++,m--;else if(o[p]===l[f])r[f]=Y(s[p],a[f]),F(e,s[p],s[u]),p--,f++;else if(void 0===c&&(c=J(l,f,m),d=J(o,u,p)),c.has(o[u]))if(c.has(o[p])){const t=d.get(l[f]),n=void 0!==t?s[t]:null;if(null===n){const t=B(e,s[u]);Y(t,a[f]),r[f]=t}else r[f]=Y(n,a[f]),F(e,n,s[u]),s[t]=null;f++}else U(s[p]),p--;else U(s[u]),u++;for(;f<=m;){const t=B(e,r[m+1]);Y(t,a[f]),r[f++]=t}for(;u<=p;){const t=s[u++];null!==t&&U(t)}q.set(e,r),Z.set(e,l)}}),K=new WeakMap,Q=document.createElement("template"),tt=e(t=>e=>{if(!(e instanceof NodePart))throw new Error("unsafeHTML can only be used in text bindings");const n=K.get(e);if(void 0!==n&&_(t)&&t===n.value&&e.value===n.fragment)return;const i=Q.cloneNode();i.innerHTML=t;const s=document.importNode(i.content,!0);e.setValue(s),K.set(e,{value:t,fragment:s})}),et=new WeakMap,nt=e((...t)=>e=>{let n=et.get(e);void 0===n&&(n={lastRenderedIndex:2147483647,values:[]},et.set(e,n));const i=n.values;let s=i.length;n.values=t;for(let o=0;o<t.length&&!(o>n.lastRenderedIndex);o++){const r=t[o];if(_(r)||"function"!=typeof r.then){e.setValue(r),n.lastRenderedIndex=o;break}o<s&&r===i[o]||(n.lastRenderedIndex=2147483647,s=0,Promise.resolve(r).then(t=>{const i=n.values.indexOf(r);i>-1&&i<n.lastRenderedIndex&&(n.lastRenderedIndex=i,e.setValue(t),e.commit())}))}});
/**
 * @license
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:s,update:o,html:r,actions:a,cache:l}=t,c="list-column-header-resizer",d=n.getActions(c);let h,u,p,f,m,g,v,b,y;s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>h=t)),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{u=t,o()}));let w=!1;s(i.subscribe("config.classNames",t=>{p=n.getClass(c,{column:u}),f=n.getClass(c+"-container",{column:u}),m=n.getClass(c+"-dots",{column:u}),g=n.getClass(c+"-dots-dot",{column:u}),v=n.getClass(c+"-line",{column:u}),o()})),s(i.subscribeAll([`config.list.columns.data.${u.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");b=u.width*n.columns.percent*.01,y=`width: ${n.columns.resizer.width}px`,w=n.columns.resizer.inRealTime,o()}));let _=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{_=[];for(let e=0;e<t;e++)_.push(e);o()}));let $=!1,x=b;const C=`config.list.columns.data.${u.id}.width`;function onMouseDown(t){$=!0,i.update("_internal.list.columns.resizer.active",!0)}function onMouseMove(t){if($){let e=i.get("config.list.columns.minWidth");"number"==typeof u.minWidth&&(e=u.minWidth),(x+=t.movementX)<e&&(x=e),w&&i.update(C,x)}}function onMouseUp(t){$&&(i.update("_internal.list.columns.resizer.active",!1),i.update(C,x),$=!1)}document.body.addEventListener("mousemove",onMouseMove),s(()=>document.body.removeEventListener("mousemove",onMouseMove)),document.body.addEventListener("mouseup",onMouseUp),s(()=>document.body.removeEventListener("mouseup",onMouseUp));const M={column:u,api:n,state:i};return n=>h(r`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnRow(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c,styleMap:d}=t;let h,u;s(i.subscribe("config.wrappers.ListColumnRow",t=>h=t)),s(i.subscribe("config.components.ListExpander",t=>u=t));let p,f,m=`_internal.flatTreeMapById.${e.rowId}`,g=i.get(m),v=`config.list.columns.data.${e.columnId}`,b=i.get(v),y=b.expander?{opacity:"1",pointerEvents:"all",height:"",width:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{opacity:"1",pointerEvents:"all",height:"",width:"",top:"","--height":""};const w=l(u,{row:g});c((t,n)=>{if(n.leave)return y.opacity="0",y.pointerEvents="none",void r();const s=(e=t).rowId,o=e.columnId;p&&p(),f&&f(),m=`_internal.flatTreeMapById.${s}`,v=`config.list.columns.data.${o}`,p=i.subscribeAll([m,"config.list.expander"],t=>{g=i.get(m);const e=i.get("config.list.expander");(y={}).opacity="1",y.pointerEvents="all",y.height=g.height+"px",y.width=b.width+"px",y.top=g.top+"px",y["--height"]=g.height+"px",b.expander&&(y["--expander-padding-width"]=e.padding*(g._internal.parents.length+1)+"px");for(let t of g._internal.parents){const e=i.get(`_internal.flatTreeMapById.${t}`);"object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children&&(y=Object.assign(Object.assign({},y),e.style.children))}"object"==typeof g.style&&"Object"===g.style.constructor.name&&"object"==typeof g.style.current&&(y=Object.assign(Object.assign({},y),g.style.current)),r()}),w&&w.change({row:g}),f=i.subscribe(v,t=>{b=t,r()})}),s(()=>{w&&w.destroy(),f(),p()});const _=n.getActions("list-column-row");let $;s(i.subscribe("config.classNames",t=>{$=n.getClass("list-column-row"),r()}));const x={column:b,row:g,api:n,state:i};return n=>h(a`
        <div class=${$} style=${d(y)} data-actions=${o(_,x)}>
          ${b.expander?w.html():null}
          <div class=${$+"-content"}>
 ...
 */function ChartCalendarDate(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,onChange:a,html:l,styleMap:c}=t,d=n.getActions("chart-calendar-date");let h;s(i.subscribe("config.wrappers.ChartCalendarDate",t=>h=t));let u=n.getClass("chart-calendar-date",e),p="";p=n.time.date(e.date.leftGlobal).format("YYYY-MM-DD")===e.currentDate?" current":"";let f,m,g={width:"","margin-left":"",visibility:"visible"};const v=()=>{if(!e)return;f=i.get("_internal.chart.time"),g.width=e.date.width+"px",g["margin-left"]=-e.date.subPx+"px",g.visibility="visible";const t={overflow:"hidden","-align":"left","margin-left":e.date.subPx+8+"px"},s=n.time.date(e.date.leftGlobal);p=s.format("YYYY-MM-DD")===e.currentDate?" current":s.subtract(1,"days").format("YYYY-MM-DD")===e.currentDate?" next":s.add(1,"days").format("YYYY-MM-DD")===e.currentDate?" previous":"";const o=f.maxWidth[e.period];switch(e.period){case"month":m=l`
          <div
            class=${u+"-content "+u+"-content--month"+p}
        ...
        `,o>=40&&o<50)m=l`
          ...
          `}else if(o>=1e3&&o<2e3){const e=[],n=s.startOf("day");for(let t=0;t<24;t++){const i=n.add(t,"hours"),s=(n.add(t,"hours").endOf("hour").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}m=l`
            <div
              class=${u+"-content "+u+"-content--day _1000"+p}
              style=${c(t)}
            >
              ${s.format("DD dddd")}
            </div>
          ...
          `}else if(o>=2e3&&o<5e3){const e=[],n=s.startOf("day");for(let t=0;t<48;t++){const i=n.add(30*t,"minutes"),s=(n.add(30*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}m=l`
            <div class=${u+"-content "+u+"-content--day _2000"+p} style=${t}>
              ${s.format("DD dddd")}
            </div>
            <div class=${u+"-content "+u+"-content--hours"+p}>
              ${e.map(t=>l`
          ...
          `}else if(o>=5e3&&o<2e4){const e=[],n=s.startOf("day");for(let t=0;t<96;t++){const i=n.add(15*t,"minutes"),s=(n.add(15*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}m=l`
            <div class=${u+"-content "+u+"-content--day _5000"+p} style=${t}>
              ${s.format("DD dddd")}
            </div>
            <div class=${u+"-content "+u+"-content--hours"+p}>
              ${e.map(t=>l`
          ...
          `}else if(o>=2e4){const e=[],n=s.startOf("day");for(let t=0;t<288;t++){const i=n.add(5*t,"minutes"),s=(n.add(5*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}m=l`
            <div class=${u+"-content "+u+"-content--day _20000"+p} style=${t}>
              ${s.format("DD dddd")}
            </div>
            <div class=${u+"-content "+u+"-content--hours"+p}>
              ${e.map(t=>l`
          ...
          `}}r()};let b;const y={date:e.date,period:e.period,api:n,state:i};return a((t,n)=>{if(n.leave)return g.visibility="hidden",r();e=t,y.date=e.date,y.period=e.period,b&&b(),b=i.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],v,{bulk:!0})}),s(()=>{b()}),n=>h(l`
        <div
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimeline(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l}=t,c=n.getActions("chart-timeline"),d=Object.assign(Object.assign({},e),{api:n,state:i});let h;s(i.subscribe("config.wrappers.ChartTimeline",t=>h=t));const u=i.get("config.components.ChartTimelineGrid"),p=i.get("config.components.ChartTimelineItems"),f=l(u);s(f.destroy);const m=l(p);let g,v;s(m.destroy),s(i.subscribe("config.classNames",()=>{g=n.getClass("chart-timeline"),v=n.getClass("chart-timeline-inner"),r()}));let b="",y="";return s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","_internal.list.rowsHeight","config.scroll.compensation"],(function calculateStyle(){const t=i.get("config.scroll.compensation"),e=i.get("_internal.chart.dimensions.width"),n=i.get("_internal.list.rowsHeight"),s=e?`width: ${e}px;`:"";b=`height: ${i.get("_internal.height")}px; ${s}`,y=`height: ${n}px; ${s} transform: translate(0px, ${t}px);`,r()}))),c.push(t=>{i.update("_internal.elements.chart-timeline",t)}),i=>h(a`
        <div
          class=${g}
          style=${b}
          data-actions=${o(c,d)}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimelineGrid(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l}=t,c=n.getActions("chart-timeline-grid"),d={api:n,state:i};let h;s(i.subscribe("config.wrappers.ChartTimelineGrid",t=>h=t));const u=i.get("config.components.ChartTimelineGridRow");let p,f,m;s(i.subscribe("config.classNames",()=>{p=n.getClass("chart-timeline-grid"),r()})),s(i.subscribe("config.chart.time.period",t=>f=t)),s(i.subscribe("config.chart.grid.block.onCreate",t=>m=t));let g=[];const v=[],b=new Map;let y;s(i.subscribeAll(["_internal.list.visibleRows;",`_internal.chart.time.dates.${f};`,"_internal.height","_internal.chart.dimensions.width"],()=>{const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height"),s=i.get(`_internal.chart.time.dates.${f}`),o=i.get("_internal.list.visibleRows");if(!s||0===s.length)return;const r=s[0].subPx;y=`height: ${e}px; width: ${t}px; transform: translate(-${r}px, 0px);`;let a=0;v.length=0;for(const e of o){const i=[];for(const t of s){let s;b.has(t.leftGlobal)?s=b.get(t.leftGlobal):(s=n.time.date(t.leftGlobal).format("YYYY-MM-DD"),b.set(t.leftGlobal,s));let o={id:e.id+":"+s,time:t,row:e,top:a};for(const t of m)o=t(o);i.push(o)}v.push({row:e,blocks:i,top:a,width:t}),a+=e.height}i.update("_internal.chart.grid.rowsWithBlocks",v)},{bulk:!0}));return s(i.subscribe("_internal.chart.grid.rowsWithBlocks",t=>{t&&(l(g,t,t=>t,u),r())})),c.includes((function bindElement(t){i.update("_internal.elements.chart-timeline-grid",t)}))||c.push(),s(()=>{g.forEach(t=>t.destroy())}),n=>h(a`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const Ct=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-rows",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}),Mt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,reuseComponents:c,styleMap:d}=t,h=Object.assign(Object.assign({},e),{api:n,state:i});let u;s(i.subscribe("config.wrappers.ChartTimelineItemsRow",t=>u=t));const p=i.get("config.components.ChartTimelineItemsRowItem");let f,m,g=`_internal.flatTreeMapById.${e.row.id}._internal.items`,v={opacity:"1",pointerEvents:"all",width:"",height:"",top:"0px"},b=[];const y=()=>{const t=i.get("_internal.chart");if(v.opacity="1",v.pointerEvents="all",v.width=t.dimensions.width+"px",!e)return v.opacity="0",void(v.pointerEvents="none");v.height=e.row.height+"px",v.top=e.row.top+"px",v["--row-height"]=e.row.height+"px"};l((t,n)=>{if(n.leave)return y(),r();e=t;for(const t in e)h[t]=e[t];(t=>{g=`_internal.flatTreeMapById.${t.id}._internal.items`,"function"==typeof f&&f(),"function"==typeof m&&m(),f=i.subscribe("_internal.chart",(t,e)=>{y(),r()}),m=i.subscribe(g,e=>{b=c(b,e,e=>({row:t,item:e}),p),y(),r()})})(e.row)}),s(()=>{m(),f(),b.forEach(t=>t.destroy())});const w=n.getActions("chart-timeline-items-row");let _;return s(i.subscribe("config.classNames",()=>{_=n.getClass("chart-timeline-items-row",e),r()})),w.includes(Ct)||w.push(Ct),n=>u(a`
        <div class=${_} data-actions=${o(w,h)} style=${d(v)}>
          ${b.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:n})},Ot=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-row-items",(function updateRowItems(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}});function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,styleMap:c}=t;let d;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>d=t));let h={width:"",height:"",left:"",opacity:"1",pointerEvents:"all"},u={width:"",height:""},p=0,f=0,m=!1;const g={item:e.item,row:e.row,left:p,width:f,api:n,state:i};function updateItem(){var t,s,o,a,l,c,d,g;if(m)return;let v=i.get("_internal.chart.time");p=(e.item.time.start-v.leftGlobal)/v.timePerPixel,f=(e.item.time.end-e.item.time.start)/v.timePerPixel,f-=i.get("config.chart.spacing")||0;const b=h.width,y=h.height,w=h.left;h={};const _=n.isItemInViewport(e.item,v.leftGlobal,v.rightGlobal);h.opacity=_?"1":"0",h.pointerEvents=_?"all":"none",_?(h.width=f+"px",h.height=e.row.height+"px",h.left=p+"px"):(h.width=b,h.height=y,h.left=w),u={width:f+"px","max-height":e.row.height+"px"};const $=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(o=null===(s=null===(t=$[n].style)||void 0===t?void 0:t.items)||void 0===s?void 0:s.item)||void 0===o?void 0:o.children;e&&(u=Object.assign(Object.assign({},u),e))}const x=null===(d=null===(c=null===(l=null===(a=e.row)||void 0===a?void 0:a.style)||void 0===l?void 0:l.items)||void 0===c?void 0:c.item)||void 0===d?void 0:d.current;x&&(u=Object.assign(Object.assign({},u),x));const C=null===(g=e.item)||void 0===g?void 0:g.style;C&&(u=Object.assign(Object.assign({},u),C)),r()}l((function onPropsChange(t,n){if(n.leave)return m=!0,h.opacity="0",h.pointerEvents="none",r();m=!1,e=t,g.item=e.item,g.row=e.row,g.left=p,g.width=f,updateItem()}));const v="chart-timeline-items-row-item",b=n.getActions(v);let y,w,_;return s(i.subscribe("config.classNames",()=>{y=n.getClass(v,e),w=n.getClass(v+"-content",e),_=n.getClass(v+"-content-label",e),r()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()})),-1===b.indexOf(Ot)&&b.push(Ot),n=>d(a`
        <div class=${y} data-actions=${o(b,g)} style=${c(h)}>
 ...
 * @license   GPL-3.0
 */
const At="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const Rt={name:At,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,date:t=>t?It(t):It(),dayjs:It};
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
