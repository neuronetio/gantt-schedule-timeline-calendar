 ...
 */function Main(t,e={}){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,html:l}=t,c=n.name;let d,u;s(i.subscribe("config.components.List",t=>d=t)),s(i.subscribe("config.components.Chart",t=>u=t));const h=a(d);s(h.destroy);const p=a(u);let f;s(p.destroy),s(i.subscribe("config.plugins",e=>{if(void 0!==e&&Array.isArray(e))for(const n of e){const e=n(t);"function"==typeof e&&s(e)}})),s(i.subscribe("config.wrappers.Main",t=>f=t));const m=n.getActions("");let g,v,b,y,w,_,$=0,x=!1;s(i.subscribe("config.classNames",t=>{const e=i.get("config");g=n.getClass(c,{config:e}),x&&(g+=` ${c}__list-column-header-resizer--active`),v=n.getClass("vertical-scroll",{config:e}),r()}));s(i.subscribeAll(["config.height","config.headerHeight","_internal.scrollBarHeight"],()=>{const t=i.get("config"),e=i.get("_internal.scrollBarHeight"),n=t.height-t.headerHeight-e;i.update("_internal.height",n),b=`--height: ${t.height}px`,y=`height: ${n}px; width: ${e}px; margin-top: ${t.headerHeight}px;`,r()}));s(i.subscribe("_internal.list.columns.resizer.active",t=>{x=t,g=n.getClass(n.name),x&&(g+=` ${n.name}__list-column-header-resizer--active`),r()}));s(i.subscribeAll(["config.list.rows;","config.chart.items;","config.list.rows.*.parentId","config.chart.items.*.rowId"],(t,e)=>{if(i.get("_internal.flatTreeMap").length&&"subscribe"===e.type)return;const s=i.get("config.list.rows"),o=[];for(const t in s)o.push(s[t]);n.fillEmptyRowValues(o);const a=i.get("config.chart.items"),l=[];for(const t in a)l.push(a[t]);const c=n.makeTreeMap(o,l);i.update("_internal.treeMap",c),i.update("_internal.flatTreeMapById",n.getFlatTreeMapById(c)),i.update("_internal.flatTreeMap",n.flattenTreeMap(c)),r()},{bulk:!0}));s(i.subscribeAll(["config.list.rows.*.expanded","_internal.treeMap;"],()=>{const t=i.get("config.list.rows"),e=n.getRowsFromIds(n.getRowsWithParentsExpanded(i.get("_internal.flatTreeMap"),i.get("_internal.flatTreeMapById"),t),t);$=n.getRowsHeight(e),i.update("_internal.list.rowsHeight",$),i.update("_internal.list.rowsWithParentsExpanded",e),r()},{bulk:!0}));s(i.subscribeAll(["_internal.list.rowsWithParentsExpanded","config.scroll.top"],()=>{const{visibleRows:t,compensation:e}=n.getVisibleRowsAndCompensation(i.get("_internal.list.rowsWithParentsExpanded")),s=i.get("_internal.list.visibleRows");let o=!0;if(i.update("config.scroll.compensation",-e),t.length&&(o=t.some((t,e)=>void 0===s[e]||t.id!==s[e].id)),o){i.update("_internal.list.visibleRows",t);const e=[];for(const n of t)for(const t of n._internal.items)e.push(t);i.update("_internal.chart.visibleItems",e)}r()}));let C=0;s(i.subscribe("_internal.list.visibleRows;",()=>{const t=i.get("config.scroll.top");w=`height: ${$}px; width: 1px`,C!==t&&_&&(C=t,_.scrollTop=t),r()}));const M=(t,e)=>{const i=[];let s=e.leftGlobal;const o=e.rightGlobal,r=e.timePerPixel;let a=s-n.time.date(s).startOf(t),l=a/r,c=0,d=0;for(;s<o;){const e={sub:a,subPx:l,leftGlobal:s,rightGlobal:n.time.date(s).endOf(t).valueOf(),width:0,leftPx:0,rightPx:0};e.width=(e.rightGlobal-e.leftGlobal+a)/r,d=e.width>d?e.width:d,e.leftPx=c,c+=e.width,e.rightPx=c,i.push(e),s=e.rightGlobal+1,a=0,l=0}e.maxWidth[t]=d,e.dates[t]=i};s(i.subscribeAll(["config.chart.time","_internal.dimensions.width","config.scroll.left","_internal.scrollBarHeight","_internal.list.width","_internal.chart.dimensions"],()=>{const t=i.get("_internal.chart.dimensions.width");let e=n.mergeDeep({},i.get("config.chart.time"));const s=.01*(e=n.time.recalculateFromTo(e)).zoom;let o=i.get("config.scroll.left");if(e.timePerPixel=s+Math.pow(2,e.zoom),e.totalViewDurationMs=n.time.date(e.to).diff(e.from,"milliseconds"),e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,o>e.totalViewDurationPx&&(o=e.totalViewDurationPx-t),e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.leftGlobal+t*e.timePerPixel,e.leftInner=e.leftGlobal-e.from,e.rightInner=e.rightGlobal-e.from,e.leftPx=e.leftInner/e.timePerPixel,e.rightPx=e.rightInner/e.timePerPixel,Math.round(e.rightGlobal/e.timePerPixel)>Math.round(e.to/e.timePerPixel)){const t=(e.rightGlobal-e.to)/(e.rightGlobal-e.from);e.timePerPixel=e.timePerPixel-e.timePerPixel*t,e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.to,e.rightInner=e.rightGlobal-e.from,e.totalViewDurationMs=e.to-e.from,e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,e.rightInner=e.rightGlobal-e.from,e.rightPx=e.rightInner/e.timePerPixel,e.leftPx=e.leftInner/e.timePerPixel}M("day",e),M("month",e),i.update("_internal.chart.time",e),r()},{bulk:!0}));const O=document.createElement("canvas"),P=O.getContext("2d");function renderIcon(t){return new Promise(e=>{const n=document.createElement("img");n.setAttribute("src","data:image/svg+xml;base64,"+btoa(t)),n.onload=function(){O.width=n.width,O.height=n.height,P.drawImage(n,0,0),e(O.toDataURL("image/png"))}})}!function renderIcons(){return function __awaiter(t,e,n,i){return new(n||(n=Promise))((function(s,o){function fulfilled(t){try{step(i.next(t))}catch(t){o(t)}}function rejected(t){try{step(i.throw(t))}catch(t){o(t)}}function step(t){t.done?s(t.value):new n((function(e){e(t.value)})).then(fulfilled,rejected)}step((i=i.apply(t,e||[])).next())}))}(this,void 0,void 0,(function*(){const t=i.get("config.list.expander.icons"),e={};for(const n in t){const i=t[n];e[n]=yield renderIcon(i)}i.update("_internal.list.expander.icons",e)}))}(),i.update("_internal.scrollBarHeight",n.getScrollBarHeight());let I=0;const D={handleEvent:t=>{if(t.stopPropagation(),"scroll"===t.type){const e=t.target.scrollTop,n=t=>{t.top=e,I=t.top;const n=i.get("_internal.elements.vertical-scroll-inner");if(n){const e=n.clientHeight;t.percent.top=t.top/e}return t};I!==e&&i.update("config.scroll",n,{only:["top","percent.top"]})}else{const e=n.normalizeMouseWheelEvent(t),s=i.get("config.scroll.xMultiplier"),o=i.get("config.scroll.yMultiplier");t.shiftKey&&e.y?i.update("config.scroll.left",t=>n.limitScroll("left",t+=e.y*s)):e.x?i.update("config.scroll.left",t=>n.limitScroll("left",t+=e.x*s)):i.update("config.scroll.top",t=>I=n.limitScroll("top",t+=e.y*o))}},passive:!0,capture:!1},T=t=>{t.stopPropagation(),t.preventDefault()},S={width:0,height:0};let A;const R=t=>{A||((A=new pt((e,n)=>{const s=t.clientWidth,o=t.clientHeight;S.width===s&&S.height===o||(S.width=s,S.height=o,i.update("_internal.dimensions",S))})).observe(t),i.update("_internal.elements.main",t))};m.includes(R)||m.push(R),s(()=>{A.disconnect()});const L=t=>{_||(_=t,i.update("_internal.elements.vertical-scroll",t))},E=t=>{i.update("_internal.elements.vertical-scroll-inner",t)},N=Object.assign(Object.assign({},e),{api:n,state:i});return n=>f(l`
        <div
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function List(t,e={}){const{api:n,state:i,onDestroy:s,actions:o,update:r,reuseComponents:a,html:l,schedule:c,styleMap:d}=t,u=n.getActions("list");let h,p,f,m,g;s(i.subscribe("config.wrappers.List",t=>h=t)),s(i.subscribe("config.components.ListColumn",t=>p=t)),s(i.subscribe("config.list",(function onListChange(){m=i.get("config.list"),g=m.columns.percent,r()}))),s(i.subscribe("config.classNames",()=>{f=n.getClass("list",{list:m}),r()}));let v=[];s(i.subscribe("config.list.columns.data;",(function onListColumnsDataChange(t){a(v,Object.values(t),t=>({columnId:t.id}),p),r()}))),s(()=>{v.forEach(t=>t.destroy())});let b={height:"","--expander-padding-width":"","--expander-size":""};s(i.subscribeAll(["config.height","config.list.expander"],t=>{b.height=i.get("config.height")+"px";const e=i.get("config.list.expander");b["--expander-padding-width"]=e.padding+"px",b["--expander-size"]=e.size+"px",r()}));const y={handleEvent:c((function onScrollHandler(t){if(t.stopPropagation(),t.preventDefault(),"scroll"===t.type)i.update("config.scroll.top",t.target.scrollTop);else{const e=n.normalizeMouseWheelEvent(t);i.update("config.scroll.top",t=>n.limitScroll("top",t+=e.y*i.get("config.scroll.yMultiplier")))}})),passive:!1};let w;function getWidth(t){w||(w=t.clientWidth,0===g&&(w=0),i.update("_internal.list.width",w),i.update("_internal.elements.list",t))}u.push(t=>(i.update("_internal.elements.list",t),getWidth(t),{update:getWidth}));const _=Object.assign(Object.assign({},e),{api:n,state:i});return e=>h(m.columns.percent>0?l`
            <div
              class=${f}
              data-actions=${o(u,_)}
              style=${d(b)}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumn(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,reuseComponents:l,html:c,styleMap:d}=t;let u,h,p;s(i.subscribe("config.wrappers.ListColumn",t=>u=t)),s(i.subscribe("config.components.ListColumnRow",t=>h=t)),s(i.subscribe("config.components.ListColumnHeader",t=>p=t));let f,m=`config.list.columns.data.${e.columnId}`;s(i.subscribe(m,(function columnChanged(t){f=t,r()})));const g=n.getActions("list-column"),v=n.getActions("list-column-rows");let b,y,w,_,$={width:"","--width":""},x={width:"",height:""},C={width:"",height:"",transform:""};s(i.subscribe("config.classNames",t=>{b=n.getClass("list-column",{column:f}),y=n.getClass("list-column-rows",{column:f}),r()}));s(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${f.id}.width`,"_internal.chart.dimensions.width","_internal.height","config.scroll.compensation"],()=>{const t=i.get("config.list"),e=i.get("config.scroll.compensation");w=t.columns.data[f.id].width*t.columns.percent*.01,_=w;const n=i.get("_internal.height");$.width=_+"px",$["--width"]=_+"px",x.width=_+"px",x.height=n+"px",C.width=_+"px",C.height=n+"px",C.transform=`translate(0px, ${e}px)`},{bulk:!0}));let M=[];s(i.subscribe("_internal.list.visibleRows;",t=>{l(M,t,t=>t&&{columnId:e.columnId,rowId:t.id,width:_},h),r()})),s((function rowsDestroy(){M.forEach(t=>t.destroy())}));const O=a(p,{columnId:e.columnId});function getRowHtml(t){return t.html()}s(O.destroy);const P={column:f,state:i,api:n},I={api:n,state:i};return n=>u(c`
        <div
          class=${b}
          data-actions=${o(g,P)}
          style=${d($)}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnHeader(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,html:l,cache:c,styleMap:d}=t;let u;s(i.subscribe("config.wrappers.ListColumnHeader",t=>u=t));const h=n.getActions("list-column-header");let p;s(i.subscribe("config.components.ListColumnHeaderResizer",t=>p=t));const f=a(p,{columnId:e.columnId});let m;s(f.destroy),s(i.subscribe("config.components.ListExpander",t=>m=t));const g=a(m,{});let v;s(g.destroy),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{v=t,r()}));let b,y,w={height:"","--height":"","--paddings-count":""};s(i.subscribeAll(["config.classNames","config.headerHeight"],()=>{const t=i.get("config");b=n.getClass("list-column-header",{column:v}),y=n.getClass("list-column-header-content",{column:v}),w.height=t.headerHeight+"px",w["--height"]=t.headerHeight+"px",w["--paddings-count"]="1",r()}));const _={column:v,api:n,state:i};return n=>u(l`
        <div class=${b} style=${d(w)} data-actions=${o(h,_)}>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnHeaderResizer(t,e){const{api:n,state:i,onDestroy:s,update:o,html:r,actions:a,cache:l}=t,c="list-column-header-resizer",d=n.getActions(c);let u,h,p,f,m,g,v,b,y;s(i.subscribe("config.wrappers.ListColumnHeaderResizer",t=>u=t)),s(i.subscribe(`config.list.columns.data.${e.columnId}`,t=>{h=t,o()}));let w=!1;s(i.subscribe("config.classNames",t=>{p=n.getClass(c,{column:h}),f=n.getClass(c+"-container",{column:h}),m=n.getClass(c+"-dots",{column:h}),g=n.getClass(c+"-dots-dot",{column:h}),v=n.getClass(c+"-line",{column:h}),o()})),s(i.subscribeAll([`config.list.columns.data.${h.id}.width`,"config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],(t,e)=>{const n=i.get("config.list");b=h.width*n.columns.percent*.01,y=`width: ${n.columns.resizer.width}px`,w=n.columns.resizer.inRealTime,o()}));let _=[1,2,3,4,5,6,7,8];s(i.subscribe("config.list.columns.resizer.dots",t=>{_=[];for(let e=0;e<t;e++)_.push(e);o()}));let $=!1,x=b;const C=`config.list.columns.data.${h.id}.width`;function onMouseDown(t){$=!0,i.update("_internal.list.columns.resizer.active",!0)}function onMouseMove(t){if($){let e=i.get("config.list.columns.minWidth");"number"==typeof h.minWidth&&(e=h.minWidth),(x+=t.movementX)<e&&(x=e),w&&i.update(C,x)}}function onMouseUp(t){$&&(i.update("_internal.list.columns.resizer.active",!1),i.update(C,x),$=!1)}document.body.addEventListener("mousemove",onMouseMove),s(()=>document.body.removeEventListener("mousemove",onMouseMove)),document.body.addEventListener("mouseup",onMouseUp),s(()=>document.body.removeEventListener("mouseup",onMouseUp));const M={column:h,api:n,state:i};return n=>u(r`
        <div class=${p} data-actions=${a(d,M)}>
          <div class=${f}>
            ${l(h.header.html?r`
                    ${h.header.html}
                  `:h.header.content)}
          </div>
          <div class=${m} style=${"--"+y} @mousedown=${onMouseDown}>
            ${_.map(t=>r`
                  <div class=${g} />
                `)}
          </div>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumnRow(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c,styleMap:d,unsafeHTML:u}=t;let h,p;s(i.subscribe("config.wrappers.ListColumnRow",t=>h=t)),s(i.subscribe("config.components.ListExpander",t=>p=t));let f,m,g=`_internal.flatTreeMapById.${e.rowId}`,v=i.get(g),b=`config.list.columns.data.${e.columnId}`,y=i.get(b),w=y.expander?{opacity:"1",pointerEvents:"auto",height:"",width:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{opacity:"1",pointerEvents:"auto",height:"",width:"",top:"","--height":""};const _=l(p,{row:v});c((t,n)=>{if(n.leave)return w.opacity="0",w.pointerEvents="none",void r();const s=(e=t).rowId,o=e.columnId;f&&f(),m&&m(),g=`_internal.flatTreeMapById.${s}`,b=`config.list.columns.data.${o}`,f=i.subscribeAll([g,"config.list.expander"],t=>{v=i.get(g);const e=i.get("config.list.expander");(w={}).opacity="1",w.pointerEvents="auto",w.height=v.height+"px",w.width=y.width+"px",w.top=v.top+"px",w["--height"]=v.height+"px",y.expander&&(w["--expander-padding-width"]=e.padding*(v._internal.parents.length+1)+"px");for(let t of v._internal.parents){const e=i.get(`_internal.flatTreeMapById.${t}`);"object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children&&(w=Object.assign(Object.assign({},w),e.style.children))}"object"==typeof v.style&&"Object"===v.style.constructor.name&&"object"==typeof v.style.current&&(w=Object.assign(Object.assign({},w),v.style.current)),r()}),_&&_.change({row:v}),m=i.subscribe(b,t=>{y=t,r()})}),s(()=>{_&&_.destroy(),m(),f()});const $=n.getActions("list-column-row");let x;s(i.subscribe("config.classNames",t=>{x=n.getClass("list-column-row"),r()}));const C={column:y,row:v,api:n,state:i};return n=>h(a`
        <div class=${x} style=${d(w)} data-actions=${o($,C)}>
          ${y.expander?_.html():null}
          <div class=${x+"-content"}>
            ${y.isHTML?function getHtml(){return"function"==typeof y.data?u(y.data(v)):u(v[y.data])}():function getText(){return"function"==typeof y.data?y.data(v):v[y.data]}()}
          </div>
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListExpander(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c}=t,d=n.getActions("list-expander");let u,h;s(i.subscribe("config.components.ListToggle",t=>h=t));const p=l(h,e.row?{row:e.row}:{});let f;if(s(p.destroy),s(i.subscribe("config.wrappers.ListExpander",t=>f=t)),s(i.subscribe("config.classNames",t=>{u=n.getClass("list-expander"),r()})),e.row){c((function onPropsChange(t){e=t,p.change(e)})),s((function listExpanderDestroy(){}))}const m={row:e.row,api:n,state:i};return n=>f(a`
        <div class=${u} data-action=${o(d,m)}>
          ${p.html()}
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListToggle(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,cache:c}=t;let d;s(i.subscribe("config.wrappers.ListToggle",t=>d=t));const u=n.getActions("list-expander-toggle");let h,p,f,m,g,v,b,y=!1;if(s(i.subscribe("config.classNames",t=>{h=n.getClass("list-expander-toggle"),p=h+"-child",f=h+"-open",m=h+"-closed",r()})),s(i.subscribe("_internal.list.expander.icons",t=>{t&&(g=t.child,v=t.open,b=t.closed),r()})),e.row){function expandedChange(t){y=t,r()}let t;function onPropsChange(n){e=n,t&&t(),t=i.subscribe(`config.list.rows.${e.row.id}.expanded`,expandedChange)}l(onPropsChange),s((function listToggleDestroy(){t&&t()}))}else{function expandedChange(t){for(const e of t)if(e.value){y=!0;break}r()}s(i.subscribe("config.list.rows.*.expanded",expandedChange,{bulk:!0}))}function toggle(){y=!y,e.row?i.update(`config.list.rows.${e.row.id}.expanded`,y):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=y;return t},{only:["*.expanded"]})}const w={row:e.row,api:n,state:i};return n=>d(a`
        <div class=${h} data-action=${o(u,w)} @click=${toggle}>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function Chart(t,e={}){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,schedule:l,createComponent:c}=t,d=i.get("config.components.ChartCalendar"),u=i.get("config.components.ChartTimeline");let h;s(i.subscribe("config.wrappers.Chart",t=>h=t));const p=c(d);s(p.destroy);const f=c(u);s(f.destroy);let m,g,v,b,y="",w="",_=n.getActions("chart");s(i.subscribe("config.classNames",t=>{m=n.getClass("chart"),g=n.getClass("horizontal-scroll"),v=n.getClass("horizontal-scroll-inner"),r()})),s(i.subscribe("config.scroll.left",t=>{b&&b.scrollLeft!==t&&(b.scrollLeft=t),r()})),s(i.subscribeAll(["_internal.chart.dimensions.width","_internal.chart.time.totalViewDurationPx"],(function horizontalScroll(t,e){y=`width: ${i.get("_internal.chart.dimensions.width")}px`,w=`width: ${i.get("_internal.chart.time.totalViewDurationPx")}px; height:1px`,r()})));const $=t=>{let e,s;if(t.stopPropagation(),"scroll"===t.type)i.update("config.scroll.left",t.target.scrollLeft),e=t.target.scrollLeft;else{const o=n.normalizeMouseWheelEvent(t),r=i.get("config.scroll.xMultiplier"),a=i.get("config.scroll.yMultiplier");t.shiftKey&&o.y?i.update("config.scroll.left",t=>e=n.limitScroll("left",t+=o.y*r)):o.x?i.update("config.scroll.left",t=>e=n.limitScroll("left",t+=o.x*r)):i.update("config.scroll.top",t=>s=n.limitScroll("top",t+=o.y*a))}const o=i.get("_internal.elements.chart"),r=i.get("_internal.elements.horizontal-scroll-inner");if(o){const t=i.get("config.scroll.left");let e=0;t&&(e=Math.round(t/(r.clientWidth-o.clientWidth)*100))>100&&(e=100),i.update("config.scroll.percent.left",e)}},x={handleEvent:$,passive:!0,capture:!1},C={handleEvent:$,passive:!0,capture:!1},M=t=>{b||(b=t,i.update("_internal.elements.horizontal-scroll",t))},O=t=>{i.update("_internal.elements.horizontal-scroll-inner",t)};let P,I=0;return _.push(t=>{P||((P=new pt((e,n)=>{const s=t.clientWidth,o=t.clientHeight,r=s-i.get("_internal.scrollBarHeight");I!==s&&(I=s,i.update("_internal.chart.dimensions",{width:s,innerWidth:r,height:o}))})).observe(t),i.update("_internal.elements.chart",t))}),s(()=>{P.disconnect()}),e=>h(a`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartCalendar(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,reuseComponents:a,html:l,styleMap:c}=t,d=n.getActions("chart-calendar"),u=Object.assign(Object.assign({},e),{api:n,state:i}),h=i.get("config.components.ChartCalendarDate");let p,f;s(i.subscribe("config.wrappers.ChartCalendar",t=>p=t)),s(i.subscribe("config.classNames",t=>{f=n.getClass("chart-calendar"),r()}));let m,g,v={height:"","--headerHeight":""};s(i.subscribe("config.headerHeight",t=>{m=t,v.height=m+"px",v["--calendar-height"]=m+"px",r()})),s(i.subscribe("config.chart.time.period",t=>g=t));let b=[],y=[];return s(i.subscribe("_internal.chart.time.dates",t=>{const e=n.time.date().format("YYYY-MM-DD");"object"==typeof t.day&&Array.isArray(t.day)&&t.day.length&&a(b,t.day,t=>t&&{period:"day",date:t,currentDate:e},h),"object"==typeof t.month&&Array.isArray(t.month)&&t.month.length&&a(y,t.month,t=>t&&{period:"month",date:t,currentDate:e},h),r()})),s(()=>{b.forEach(t=>t.destroy())}),d.push(t=>{i.update("_internal.elements.calendar",t)}),n=>p(l`
        <div class=${f} data-actions=${o(d,u)} style=${c(v)}>
          <div class=${f+"-dates "+f+"-dates--months"}>${y.map(t=>t.html())}</div>
          <div class=${f+"-dates "+f+"-dates--days"}>${b.map(t=>t.html())}</div>
          </div>
        </div>
      `,{props:e,vido:t,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartCalendarDate(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,onChange:a,html:l,styleMap:c}=t,d=n.getActions("chart-calendar-date");let u;s(i.subscribe("config.wrappers.ChartCalendarDate",t=>u=t));let h=n.getClass("chart-calendar-date",e),p="";p=n.time.date(e.date.leftGlobal).format("YYYY-MM-DD")===e.currentDate?" current":"";let f,m,g={width:"","margin-left":"",visibility:"visible"};const v=()=>{if(!e)return;f=i.get("_internal.chart.time"),g.width=e.date.width+"px",g["margin-left"]=-e.date.subPx+"px",g.visibility="visible";const t={overflow:"hidden","-align":"left","margin-left":e.date.subPx+8+"px"},s=n.time.date(e.date.leftGlobal);p=s.format("YYYY-MM-DD")===e.currentDate?" current":s.subtract(1,"days").format("YYYY-MM-DD")===e.currentDate?" next":s.add(1,"days").format("YYYY-MM-DD")===e.currentDate?" previous":"";const o=f.maxWidth[e.period];switch(e.period){case"month":m=l`
          <div
            class=${h+"-content "+h+"-content--month"+p}
            style="margin-left:${e.date.subPx}"
          >
            ${s.format("MMMM YYYY")}
          </div>
        `,o<=100&&(m=l`
            <div class=${h+"-content "+h+"-content--month"+p}>
              ${s.format("MMM'YY")}
            </div>
          `);break;case"day":if(m=l`
          <div class=${h+"-content "+h+"-content--day _0"+p}>
            <div class=${h+"-content "+h+"-content--day-small"+p}>
              ${s.format("DD")} ${s.format("ddd")}
            </div>
          </div>
        `,o>=40&&o<50)m=l`
            <div class=${h+"-content "+h+"-content--day _40"+p}>
              ${s.format("DD")}
            </div>
            <div class=${h+"-content "+h+"-content--day-word"+p}>
              ${s.format("dd")}
            </div>
          `;else if(o>=50&&o<90)m=l`
            <div class=${h+"-content "+h+"-content--day _50"+p}>
              ${s.format("DD")}
            </div>
            <div class=${h+"-content "+h+"-content--day-word"+p}>
              ${s.format("ddd")}
            </div>
          `;else if(o>=90&&o<180)m=l`
            <div class=${h+"-content "+h+"-content--day _90"+p}>
              ${s.format("DD")}
            </div>
            <div class=${h+"-content "+h+"-content--day-word"+p}>
              ${s.format("dddd")}
            </div>
          `;else if(o>=180&&o<400){const t=[],e=s.startOf("day");for(let n=0;n<12;n++){const i=e.add(2*n,"hours"),s=(e.add(2*n+1,"hours").endOf("hour").valueOf()-i.valueOf())/f.timePerPixel;t.push({width:s,formatted:i.format("HH")})}m=l`
            <div class=${h+"-content "+h+"-content--day _180"+p}>
              ${s.format("DD dddd")}
            </div>
            <div class=${h+"-content "+h+"-content--hours"+p}>
              ${t.map(t=>l`
                    <div
                      class="${h+"-content "+h+"-content--hours-hour"+p}"
          ...
          `}else if(o>=400&&o<1e3){const t=[],e=s.startOf("day");for(let n=0;n<24;n++){const i=e.add(n,"hours"),s=(e.add(n,"hours").endOf("hour").valueOf()-i.valueOf())/f.timePerPixel;t.push({width:s,formatted:i.format("HH")})}m=l`
            <div class=${h+"-content "+h+"-content--day _400"+p}>
              ${s.format("DD dddd")}
            </div>
            <div class=${h+"-content "+h+"-content--hours"+p}>
              ${t.map(t=>l`
          ...
          `}else if(o>=1e3&&o<2e3){const e=[],n=s.startOf("day");for(let t=0;t<24;t++){const i=n.add(t,"hours"),s=(n.add(t,"hours").endOf("hour").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}m=l`
            <div
              class=${h+"-content "+h+"-content--day _1000"+p}
              style=${c(t)}
            >
              ${s.format("DD dddd")}
            </div>
          ...
          `}else if(o>=2e3&&o<5e3){const e=[],n=s.startOf("day");for(let t=0;t<48;t++){const i=n.add(30*t,"minutes"),s=(n.add(30*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}m=l`
            <div class=${h+"-content "+h+"-content--day _2000"+p} style=${t}>
              ${s.format("DD dddd")}
            </div>
            <div class=${h+"-content "+h+"-content--hours"+p}>
              ${e.map(t=>l`
          ...
          `}else if(o>=5e3&&o<2e4){const e=[],n=s.startOf("day");for(let t=0;t<96;t++){const i=n.add(15*t,"minutes"),s=(n.add(15*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}m=l`
            <div class=${h+"-content "+h+"-content--day _5000"+p} style=${t}>
              ${s.format("DD dddd")}
            </div>
            <div class=${h+"-content "+h+"-content--hours"+p}>
              ${e.map(t=>l`
          ...
          `}else if(o>=2e4){const e=[],n=s.startOf("day");for(let t=0;t<288;t++){const i=n.add(5*t,"minutes"),s=(n.add(5*(t+1),"minutes").valueOf()-i.valueOf())/f.timePerPixel;e.push({width:s,formatted:i.format("HH:mm")})}m=l`
            <div class=${h+"-content "+h+"-content--day _20000"+p} style=${t}>
              ${s.format("DD dddd")}
            </div>
            <div class=${h+"-content "+h+"-content--hours"+p}>
              ${e.map(t=>l`
          ...
          `}}r()};let b;const y={date:e.date,period:e.period,api:n,state:i};return a((t,n)=>{if(n.leave)return g.visibility="hidden",r();e=t,y.date=e.date,y.period=e.period,b&&b(),b=i.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],v,{bulk:!0})}),s(()=>{b()}),n=>u(l`
        <div
          class=${h+" "+h+"--"+e.period+p}
          style=${c(g)}
          data-actions=${o(d,y)}
        >
          ${m}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimeline(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l}=t,c=n.getActions("chart-timeline"),d=Object.assign(Object.assign({},e),{api:n,state:i});let u;s(i.subscribe("config.wrappers.ChartTimeline",t=>u=t));const h=i.get("config.components.ChartTimelineGrid"),p=i.get("config.components.ChartTimelineItems"),f=l(h);s(f.destroy);const m=l(p);let g,v;s(m.destroy),s(i.subscribe("config.classNames",()=>{g=n.getClass("chart-timeline"),v=n.getClass("chart-timeline-inner"),r()}));let b="",y="";return s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","_internal.list.rowsHeight","config.scroll.compensation"],(function calculateStyle(){const t=i.get("config.scroll.compensation"),e=i.get("_internal.chart.dimensions.width"),n=i.get("_internal.list.rowsHeight"),s=e?`width: ${e}px;`:"";b=`height: ${i.get("_internal.height")}px; ${s}`,y=`height: ${n}px; ${s} transform: translate(0px, ${t}px);`,r()}))),c.push(t=>{i.update("_internal.elements.chart-timeline",t)}),i=>u(a`
        <div
          class=${g}
          style=${b}
          data-actions=${o(c,d)}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimelineGrid(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l}=t,c=n.getActions("chart-timeline-grid"),d={api:n,state:i};let u;s(i.subscribe("config.wrappers.ChartTimelineGrid",t=>u=t));const h=i.get("config.components.ChartTimelineGridRow");let p,f,m;s(i.subscribe("config.classNames",()=>{p=n.getClass("chart-timeline-grid"),r()})),s(i.subscribe("config.chart.time.period",t=>f=t)),s(i.subscribe("config.chart.grid.block.onCreate",t=>m=t));let g=[];const v=[],b=new Map;let y;s(i.subscribeAll(["_internal.list.visibleRows;",`_internal.chart.time.dates.${f};`,"_internal.height","_internal.chart.dimensions.width"],()=>{const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height"),s=i.get(`_internal.chart.time.dates.${f}`),o=i.get("_internal.list.visibleRows");if(!s||0===s.length)return;const r=s[0].subPx;y=`height: ${e}px; width: ${t}px; transform: translate(-${r}px, 0px);`;let a=0;v.length=0;for(const e of o){const i=[];for(const t of s){let s;b.has(t.leftGlobal)?s=b.get(t.leftGlobal):(s=n.time.date(t.leftGlobal).format("YYYY-MM-DD"),b.set(t.leftGlobal,s));let o={id:e.id+":"+s,time:t,row:e,top:a};for(const t of m)o=t(o);i.push(o)}v.push({row:e,blocks:i,top:a,width:t}),a+=e.height}i.update("_internal.chart.grid.rowsWithBlocks",v)},{bulk:!0}));return s(i.subscribe("_internal.chart.grid.rowsWithBlocks",t=>{t&&(l(g,t,t=>t,h),r())})),c.includes((function bindElement(t){i.update("_internal.elements.chart-timeline-grid",t)}))||c.push(),s(()=>{g.forEach(t=>t.destroy())}),n=>u(a`
        <div class=${p} data-actions=${o(c,d)} style=${y}>
          ${g.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function bindElementAction(t,e){return e.state.update("_internal.elements.chart-timeline-grid-rows",(function updateGridRows(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-grid-rows",e=>e.filter(e=>e!==t))}}}function ChartTimelineGridRow(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l,onChange:c,styleMap:d}=t,u=Object.assign(Object.assign({},e),{api:n,state:i});let h;s(i.subscribe("config.wrappers.ChartTimelineGridRow",t=>{h=t,r()}));const p=i.get("config.components.ChartTimelineGridRowBlock"),f=n.getActions("chart-timeline-grid-row");let m=n.getClass("chart-timeline-grid-row"),g={width:e.width+"px",height:e.row.height+"px",opacity:"1",pointerEvents:"all",overflow:"hidden"},v=[];return c((t,n)=>{var s,o,a,c,d,h,f;if(n.leave)return g.opacity="0",g.pointerEvents="none",void r();l(v,(e=t).blocks,t=>t,p),(g={}).opacity="1",g.pointerEvents="all",g.height=e.row.height+"px",g.width=e.width+"px";const m=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(a=null===(o=null===(s=m[t].style)||void 0===s?void 0:s.grid)||void 0===o?void 0:o.row)||void 0===a?void 0:a.children;e&&(g=Object.assign(Object.assign({},g),e))}const b=null===(f=null===(h=null===(d=null===(c=e.row)||void 0===c?void 0:c.style)||void 0===d?void 0:d.grid)||void 0===h?void 0:h.row)||void 0===f?void 0:f.current;b&&(g=Object.assign(Object.assign({},g),b));for(const t in e)u[t]=e[t];r()}),s(()=>{v.forEach(t=>t.destroy())}),-1===f.indexOf(bindElementAction)&&f.push(bindElementAction),n=>h(a`
        <div class=${m} data-actions=${o(f,u)} style=${d(g)}>
          ${v.map(t=>t.html())}
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const ft=(t,e)=>(e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),t=>{e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>e.filter(e=>e!==t),{only:[""]})}),mt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,styleMap:c}=t,d="chart-timeline-grid-row-block";let u=Object.assign(Object.assign({},e),{api:n,state:i});const h=n.getActions(d);let p;s(i.subscribe("config.wrappers.ChartTimelineGridRowBlock",t=>{p=t,r()}));const f=n.time.date().startOf("day").valueOf();let m,g;function updateClassName(t){m=n.getClass(d),g=m+"-content",t.leftGlobal===f&&(m+=" current")}updateClassName(e.time);let v={width:"",height:""};return l((function onPropsChange(t,s){var o,a,l,c,d,h,p;if(s.leave)return r();e=t,u=Object.assign(Object.assign({},e),{api:n,state:i}),updateClassName(e.time),(v={}).width=e.time.width+"px",v.height=e.row.height+"px";const f=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(l=null===(a=null===(o=f[t].style)||void 0===o?void 0:o.grid)||void 0===a?void 0:a.block)||void 0===l?void 0:l.children;e&&(v=Object.assign(Object.assign({},v),e))}const m=null===(p=null===(h=null===(d=null===(c=e.row)||void 0===c?void 0:c.style)||void 0===d?void 0:d.grid)||void 0===h?void 0:h.block)||void 0===p?void 0:p.current;m&&(v=Object.assign(Object.assign({},v),m)),r()})),-1===h.indexOf(ft)&&h.push(ft),n=>p(a`
        <div class=${m} data-actions=${o(h,u)} style=${c(v)}>
          <div class=${g} />
        </div>
      `,{props:e,vido:t,templateProps:n})};
/**
 ...
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */
function ChartTimelineItems(t,e={}){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l}=t,c=n.getActions("chart-timeline-items");let d;s(i.subscribe("config.wrappers.ChartTimelineItems",t=>d=t));const u=i.get("config.components.ChartTimelineItemsRow");let h,p;s(i.subscribe("config.classNames",()=>{h=n.getClass("chart-timeline-items"),r()}));s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width"],()=>{const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height");p=`width: ${t}px; height: ${e}px;`}));let f=[];s(i.subscribeAll(["_internal.list.visibleRows","config.chart.items","config.list.rows"],()=>{const t=i.get("_internal.list.visibleRows");f=l(f,t,t=>({row:t}),u),r()},{bulk:!0})),s((function destroyRows(){f.forEach(t=>t.destroy())}));const m={api:n,state:i};return n=>d(a`
        <div class=${h} style=${p} data-actions=${o(c,m)}>
          ${f.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const gt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-rows",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}),vt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,reuseComponents:c,styleMap:d}=t,u=Object.assign(Object.assign({},e),{api:n,state:i});let h;s(i.subscribe("config.wrappers.ChartTimelineItemsRow",t=>h=t));const p=i.get("config.components.ChartTimelineItemsRowItem");let f,m,g=`_internal.flatTreeMapById.${e.row.id}._internal.items`,v={opacity:"1",pointerEvents:"auto",width:"",height:"",top:"0px"},b=[];const y=()=>{const t=i.get("_internal.chart");if(v.opacity="1",v.pointerEvents="auto",v.width=t.dimensions.width+"px",!e)return v.opacity="0",void(v.pointerEvents="none");v.height=e.row.height+"px",v.top=e.row.top+"px",v["--row-height"]=e.row.height+"px"};l((t,n)=>{if(n.leave)return y(),r();e=t;for(const t in e)u[t]=e[t];(t=>{g=`_internal.flatTreeMapById.${t.id}._internal.items`,"function"==typeof f&&f(),"function"==typeof m&&m(),f=i.subscribe("_internal.chart",(t,e)=>{y(),r()}),m=i.subscribe(g,e=>{b=c(b,e,e=>({row:t,item:e}),p),y(),r()})})(e.row)}),s(()=>{m(),f(),b.forEach(t=>t.destroy())});const w=n.getActions("chart-timeline-items-row");let _;return s(i.subscribe("config.classNames",()=>{_=n.getClass("chart-timeline-items-row",e),r()})),w.includes(gt)||w.push(gt),n=>h(a`
        <div class=${_} data-actions=${o(w,u)} style=${d(v)}>
          ${b.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:n})},bt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-row-items",(function updateRowItems(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}});function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,styleMap:c,unsafeHTML:d}=t;let u;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>u=t));let h={width:"",height:"",left:"",opacity:"1",pointerEvents:"auto"},p={width:"",height:""},f=0,m=0,g=!1;const v={item:e.item,row:e.row,left:f,width:m,api:n,state:i};function updateItem(){var t,s,o,a,l,c,d,u;if(g)return;let v=i.get("_internal.chart.time");f=(e.item.time.start-v.leftGlobal)/v.timePerPixel,m=(e.item.time.end-e.item.time.start)/v.timePerPixel,m-=i.get("config.chart.spacing")||0;const b=h.width,y=h.height,w=h.left;h={};const _=n.isItemInViewport(e.item,v.leftGlobal,v.rightGlobal);h.opacity=_?"1":"0",h.pointerEvents=_?"auto":"none",_?(h.width=m+"px",h.height=e.row.height+"px",h.left=f+"px"):(h.width=b,h.height=y,h.left=w),p={width:m+"px","max-height":e.row.height+"px"};const $=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(o=null===(s=null===(t=$[n].style)||void 0===t?void 0:t.items)||void 0===s?void 0:s.item)||void 0===o?void 0:o.children;e&&(p=Object.assign(Object.assign({},p),e))}const x=null===(d=null===(c=null===(l=null===(a=e.row)||void 0===a?void 0:a.style)||void 0===l?void 0:l.items)||void 0===c?void 0:c.item)||void 0===d?void 0:d.current;x&&(p=Object.assign(Object.assign({},p),x));const C=null===(u=e.item)||void 0===u?void 0:u.style;C&&(p=Object.assign(Object.assign({},p),C)),r()}l((function onPropsChange(t,n){if(n.leave)return g=!0,h.opacity="0",h.pointerEvents="none",r();g=!1,e=t,v.item=e.item,v.row=e.row,v.left=f,v.width=m,updateItem()}));const b="chart-timeline-items-row-item",y=n.getActions(b);let w,_,$;return s(i.subscribe("config.classNames",()=>{w=n.getClass(b,e),_=n.getClass(b+"-content",e),$=n.getClass(b+"-content-label",e),r()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()})),-1===y.indexOf(bt)&&y.push(bt),n=>u(a`
        <div class=${w} data-actions=${o(y,v)} style=${c(h)}>
          <div class=${_} style=${c(p)}>
            <div class=${$}>
 ...
 * @license   GPL-3.0
 */
const Ct="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const Mt={name:Ct,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,date:t=>t?wt(t):wt(),dayjs:wt};
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
