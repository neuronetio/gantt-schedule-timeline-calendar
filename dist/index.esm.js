 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function Ut(t,{date:e}){const{api:n,state:s,onDestroy:i,actions:o,update:r,html:a}=t,l="chart-calendar-date",c=n.getActions(l);let d,u,h,p,f,m,g,v,b,y,w,_,$,x,C,M;return i(s.subscribe("config.wrappers.ChartCalendarDate",t=>d=t)),i(s.subscribe("config.classNames",()=>{u=n.getClass(l,{date:e}),n.time.date(e.leftGlobal).format("YYYY-MM-DD")===n.time.date().format("YYYY-MM-DD")&&(u+=" current"),n.time.date(e.leftGlobal).subtract(1,"day").format("YYYY-MM-DD")===n.time.date().format("YYYY-MM-DD")&&(u+=" next"),n.time.date(e.leftGlobal).add(1,"day").format("YYYY-MM-DD")===n.time.date().format("YYYY-MM-DD")&&(u+=" previous"),h=n.getClass(`${l}-formatted`,{date:e}),p=n.getClass(`${l}-formatted-year`,{date:e}),f=n.getClass(`${l}-formatted-month`,{date:e}),m=n.getClass(`${l}-formatted-day`,{date:e}),g=n.getClass(`${l}-formatted-day-word`,{date:e}),r()})),i(s.subscribeAll(["_internal.chart.time","config.chart.calendar.vertical.smallFormat"],(function(){v=s.get("_internal.chart.time"),M=v.zoom<=22?18:13;const t=n.time.date(e.leftGlobal),i=v.maxWidth[v.period];b=i<=40;const o=s.get("config.chart.calendar.vertical.smallFormat");y=t.format(o),w=t.format("YYYY"),_=t.format("MMMM"),$=t.format("DD"),x=t.format("dddd"),i<=70?(w=t.format("YY"),_=t.format("MMM"),$=t.format("DD"),x=t.format("ddd")):i<=150&&(x=t.format("ddd")),C=`width: ${e.width}px; margin-left:-${e.subPx}px; --day-size: ${M}px`,r()}),{bulk:!0})),i=>d(a`
