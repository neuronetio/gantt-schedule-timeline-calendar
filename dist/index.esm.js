 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListExpander(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c}=t,d=n.getActions("list-expander");let h,u,p,f,m;s(i.subscribe("config.components.ListToggle",t=>m=t));const g=l(m,e.row?{row:e.row}:{});let v;if(s(g.destroy),s(i.subscribe("config.wrappers.ListExpander",t=>v=t)),s(i.subscribe("config.classNames",t=>{h=n.getClass("list-expander"),f=n.getClass("list-expander-padding"),r()})),s(i.subscribeAll(["config.list.expander.padding"],t=>{u=t,r()})),e.row){let t;c(n=>{e=n,t&&t(),t=i.subscribe(`_internal.list.rows.${e.row.id}.parentId`,(function parentChanged(t){p="width:"+e.row._internal.parents.length*u+"px",r()})),g.change(e)}),s((function listExpanderDestroy(){t&&t()}))}else p="width:0px";return s=>v(a`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListToggle(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,unsafeHTML:l,onChange:c}=t,d="list-expander-toggle";let h;s(i.subscribe("config.wrappers.ListToggle",t=>h=t));const u=n.getActions(d);let p,f,m,g,v,b,y,w,_=!1;if(s(i.subscribe("config.classNames",t=>{p=n.getClass(d),m=n.getClass(d+"-child"),g=n.getClass(d+"-open"),v=n.getClass(d+"-closed"),r()})),s(i.subscribeAll(["config.list.expander.size","config.list.expander.icons"],()=>{const t=i.get("config.list.expander");f=`--size: ${t.size}px`,b=t.icons.child,y=t.icons.open,w=t.icons.closed,r()})),e.row){function expandedChange(t){_=t,r()}let t;function onPropsChange(n){e=n,t&&t(),t=i.subscribe(`config.list.rows.${e.row.id}.expanded`,expandedChange)}c(onPropsChange),s((function listToggleDestroy(){t&&t()}))}else{function expandedChange(t){for(const e of t)if(e.value){_=!0;break}r()}s(i.subscribe("config.list.rows.*.expanded",expandedChange,{bulk:!0}))}function toggle(){_=!_,e.row?i.update(`config.list.rows.${e.row.id}.expanded`,_):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=_;return t},{only:["*.expanded"]})}return function updateTemplate(s){return h(a`
        <div
          class=${p}
          ...
          @click=${toggle}
        >
          ${0===(null===(d=null===(c=null===(r=e.row)||void 0===r?void 0:r._internal)||void 0===c?void 0:c.children)||void 0===d?void 0:d.length)?a`
        <div class=${m}>
          ${l(b)}
        </div>
      `:_?a`
      ...
      `,{vido:t,props:e,templateProps:s});var r,c,d}}
/**
 * Chart component
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const gt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),t=>{e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>e.filter(e=>e!==t),{only:[""]})}),vt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,styleMap:c}=t,d=n.getActions("chart-timeline-grid-row-block");let h;s(i.subscribe("config.wrappers.ChartTimelineGridRowBlock",t=>{h=t,r()}));const u=n.time.date().startOf("day").valueOf();let p,f;const m=t=>{p=n.getClass("chart-timeline-grid-row-block"),f=p+"-content",t.leftGlobal===u&&(p+=" current")};m(e.time);let g={width:"",height:""};return l((t,n)=>{var s,o,a,l,c,d,h;if(n.leave)return;m((e=t).time),(g={}).width=e.time.width+"px",g.height=e.row.height+"px";const u=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(a=null===(o=null===(s=u[t].style)||void 0===s?void 0:s.grid)||void 0===o?void 0:o.block)||void 0===a?void 0:a.children;e&&(g=Object.assign(Object.assign({},g),e))}const p=null===(h=null===(d=null===(c=null===(l=e.row)||void 0===l?void 0:l.style)||void 0===c?void 0:c.grid)||void 0===d?void 0:d.block)||void 0===h?void 0:h.current;p&&(g=Object.assign(Object.assign({},g),p)),r()}),-1===d.indexOf(gt)&&d.push(gt),s=>h(a`
        <div
          class=${p}
          data-actions=${o(d,Object.assign(Object.assign({},e),{api:n,state:i}))}
          style=${c(g)}
 ...
 */const bt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-rows",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}),yt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,reuseComponents:c,styleMap:d}=t;let h;s(i.subscribe("config.wrappers.ChartTimelineItemsRow",t=>h=t));const u=i.get("config.components.ChartTimelineItemsRowItem");let p,f,m=`_internal.flatTreeMapById.${e.row.id}._internal.items`,g={opacity:"1",pointerEvents:"all",width:"",height:""},v={width:"",height:""},b=[];const y=()=>{const t=i.get("_internal.chart");if(g.opacity="1",g.pointerEvents="all",g.width=t.dimensions.width+"px",v.width=t.time.totalViewDurationPx+"px",!e)return g.opacity="0",void(g.pointerEvents="none");g.height=e.row.height+"px",g["--row-height"]=e.row.height+"px",v.height=e.row.height+"px"};l((t,n)=>{if(n.leave)return y(),r();(t=>{m=`_internal.flatTreeMapById.${t.id}._internal.items`,"function"==typeof p&&p(),"function"==typeof f&&f(),p=i.subscribe("_internal.chart",(t,e)=>{y(),r()}),f=i.subscribe(m,e=>{b=c(b,e,e=>({row:t,item:e}),u),y(),r()})})((e=t).row)}),s(()=>{f(),p(),b.forEach(t=>t.destroy())});const w=n.getActions("chart-timeline-items-row");let _,$;return s(i.subscribe("config.classNames",()=>{_=n.getClass("chart-timeline-items-row",e),$=n.getClass("chart-timeline-items-row-inner",e),r()})),w.includes(bt)||w.push(bt),s=>h(a`
      ...
      `,{props:e,vido:t,templateProps:s})},wt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-row-items",(function updateRowItems(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}}),_t=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,styleMap:c}=t;let d;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>d=t));let h={width:"",height:"",transform:"",opacity:"1",pointerEvents:"all"},u={},p=0,f=0,m=!1;const g=()=>{var t,n,s,o,a,l,c,d;if(m)return;let g=i.get("_internal.chart.time");p=(e.item.time.start-g.leftGlobal)/g.timePerPixel,f=(e.item.time.end-e.item.time.start)/g.timePerPixel,f-=i.get("config.chart.spacing")||0,(h={}).width=f+"px",h.height=e.row.height+"px",h.transform=`translate(${p}px, 0px)`,h.opacity="1",h.pointerEvents="all",u={};const v=i.get("config.list.rows");for(const i of e.row._internal.parents){const e=null===(s=null===(n=null===(t=v[i].style)||void 0===t?void 0:t.items)||void 0===n?void 0:n.item)||void 0===s?void 0:s.children;e&&(u=Object.assign(Object.assign({},u),e))}const b=null===(c=null===(l=null===(a=null===(o=e.row)||void 0===o?void 0:o.style)||void 0===a?void 0:a.items)||void 0===l?void 0:l.item)||void 0===c?void 0:c.current;b&&(u=Object.assign(Object.assign({},u),b));const y=null===(d=e.item)||void 0===d?void 0:d.style;y&&(u=Object.assign(Object.assign({},u),y)),r()};l((t,n)=>{if(n.leave)return m=!0,h.opacity="0",h.pointerEvents="none",r();m=!1,e=t,g()});const v="chart-timeline-items-row-item",b=n.getActions(v);let y,w,_;return s(i.subscribe("config.classNames",()=>{y=n.getClass(v,e),w=n.getClass(v+"-content",e),_=n.getClass(v+"-content-label",e),r()})),s(i.subscribe("_internal.chart.time",t=>{g()})),-1===b.indexOf(wt)&&b.push(wt),s=>d(a`
        <div
          class=${y}
