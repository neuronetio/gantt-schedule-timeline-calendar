...
/**
	 ...
	 * subject to an additional IP rights grant found at
	 * http://polymer.github.io/PATENTS.txt
	 */);class k{handleAttributeExpressions(t,e,n,i){const o=e[0];return"."===o?new A(t,e.slice(1),n).parts:"@"===o?[new G(t,e.slice(1),i.eventContext)]:"?"===o?[new R(t,e.slice(1),n)]:new E(t,e,n).parts}handleTextExpression(t){return new C(t)}}const z=new k;
/**
	 * @license
	 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
	 * This code may only be used under the BSD style license found at
...
const U={width:0,height:0};let B,q,Q;class K{constructor(t){B||(B=new ie(()=>{const e=t.clientWidth,n=t.clientHeight;U.width===e&&U.height===n||(U.width=e,U.height=n,i.update("$data.dimensions",U))}),B.observe(t),i.update("$data.elements.main",t))}update(){}destroy(t){B.unobserve(t)}}m.includes(K)||m.push(K),o(()=>{B.disconnect()}),o(i.subscribe("config.scroll",t=>{q=t.horizontal.multiplier,Q=t.vertical.multiplier}));const J={handleEvent(t){const e=n.normalizeMouseWheelEvent(t);if(t.shiftKey||e.x){const t=e.x?e.x:e.y,i=n.getScrollLeft();return void(t>0?n.setScrollLeft(i.dataIndex+q):n.setScrollLeft(i.dataIndex-q))}const i=n.getScrollTop();e.y>0?n.setScrollTop(i.dataIndex+Q):n.setScrollTop(i.dataIndex-Q)},passive:!0},Z=Object.assign(Object.assign({},e),{api:n,state:i}),tt=s.create(m,Z),et=n.generateSlots("main",t,e);return o(et.destroy),()=>k_k_k?et.html("outer",l`
    ...
    `;return P.html("outer",r`
      ...
      `)}class Te{constructor(t,e){let n=!1,i=e.state.get("$data.elements.chart-timeline-items-rows");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("$data.elements.chart-timeline-items-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}function Ee(t,e){const{api:n,state:i,onDestroy:o,Detach:s,Actions:r,update:a,html:l,onChange:c,reuseComponents:u,StyleMap:h}=t,d=Object.assign(Object.assign({},e),{api:n,state:i});let f;o(i.subscribe("config.components.ChartTimelineItemsRowItem",t=>f=t));let p="";const m=[],g=new h({width:"",height:""},!0);let v=!1;const y=new s(()=>v);function b(t=e.rowData){const n=i.get("$data.chart");v=!1,g.style.width=n.dimensions.width+"px",e?(g.style.height=t.outerHeight+"px",g.style["--row-height"]=t.outerHeight+"px",a()):v=!0}function w(t,e){if(!t||!e)return v=!0,u(m,[],()=>null,f,!1),a();const i=e.items;if(void 0===i)return v=!0,u(m,[],()=>null,f,!1),a();const o=n.getItems(i);u(m,o,e=>({row:t,item:e}),f,!1),b(),a()}o(i.subscribe("$data.list.rows."+e.row.id,b));const x="chart-timeline-items-row";let $=n.getClass(x);const D=n.generateSlots(x,t,e);c((function(i,o){if(o.leave||!i||void 0===i.row)return v=!0,u(m,[],()=>null,f,!1),D.change(i,o),a();e=i,$=n.getClass(x,e.row.id);for(const t in e)d[t]=e[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)p=$+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const n=e.row.classNames({row:e.row,vido:t});Array.isArray(n)&&n.length&&(p=$+" "+n.join(" "))}}else p=$;w(e.row,e.rowData),D.change(i,o),a()})),o(i.subscribe("$data.chart.dimensions.width",()=>w(e.row,e.rowData))),o(()=>{m.forEach(t=>t.destroy())});const P=n.getActions(x);P.push(Te);const M=r.create(P,d);return()=>D.html("outer",l`
        <div detach=${y} class=${p} data-actions=${M} style=${g}>
          ${D.html("content",m.map(t=>t.html()))}
        </div>
      `)}class Oe{constructor(t,e){let n=!1,i=e.state.get("$data.elements.chart-timeline-items-row-items");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("$data.elements.chart-timeline-items-row-items",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}}function Ce(t,e){const{api:n,state:i,onDestroy:o,Detach:s,Actions:r,update:a,html:l,onChange:c,unsafeHTML:u,StyleMap:h}=t;let d,f,p;o(i.subscribe("config.debug",t=>p=t));let m=0,g=0,v=!1,y="";const b=new h({width:"",height:"",left:"",top:""}),w=new h({}),x=new h({}),$={item:e.item,row:e.row,left:m,width:g,api:n,state:i},D="chart-timeline-items-row-item";let P,M;P=n.getClass(D),M=n.getClass(D+"-label");const _=n.generateSlots(D,t,e);let I,S=!1;function T(o=i.get("$data.chart.time")){var s;if(_.change(e,{leave:!1}),v||0===o.levels.length||!o.levels[o.level]||0===o.levels[o.level].length)return S=!0,a();if(!e.item)return S=!0,a();p&&(console.groupCollapsed("[items-row-item.ts] Update item (before)"),console.log({id:e.item.id,item:e.item}),console.trace(),console.groupEnd());const r=n.getItemData(e.item.id);if(m=r.position.actualLeft,g=r.actualWidth,e.item.time.end<=o.leftGlobal||e.item.time.start>=o.rightGlobal||g<=0)return S=!0,r.detached=S,a();if(y=P,e.item.time.start<o.leftGlobal?(w.style.display="flex",y+=" "+n.getClass(D+"--left-cut",e.row.id+"-"+e.item.id)):w.style.display="none",r.position.right>o.width?(x.style.display="flex",y+=" "+n.getClass(D+"--right-cut",e.row.id+"-"+e.item.id)):x.style.display="none",e.item.classNames)if(Array.isArray(e.item.classNames)&&e.item.classNames.length)y+=" "+e.item.classNames.join(" ");else if("function"==typeof e.item.classNames){const n=e.item.classNames({item:e.item,vido:t});Array.isArray(n)&&(y+=" "+n.join(" "))}const l=b.style.width,c=b.style.left,u=b.style.top,h=b.style.height;b.setStyle({});const d=n.isItemInViewport(e.item,o.leftGlobal,o.rightGlobal);S=!d,r.detached=S,d?(b.style.width=g+"px",b.style.left=m+"px",b.style.top=r.position.actualTop+"px",b.style.height=r.actualHeight+"px"):(b.style.width=l,b.style.left=c,b.style.top=u,b.style.height=h),(null===(s=null==e?void 0:e.item)||void 0===s?void 0:s.style)&&b.setStyle(Object.assign(Object.assign({},b.style),e.item.style)),$.left=m,$.width=g,p&&console.log("[items-row-item.ts] Update item (after)",{id:e.item.id,itemLeftPx:m,itemWidthPx:g,item:e.item}),a()}o(i.subscribe("config.chart.item.cutIcons",t=>{I={left:n.getSVGIconSrc(t.left),right:n.getSVGIconSrc(t.right)}}));const E=n.getClass(D+"-cut"),O=[];function C(){O.forEach(t=>t()),O.length=0}function R(t={}){if(C(),d&&(O.push(i.subscribe("config.chart.items."+d,n)),O.push(i.subscribe("$data.chart.items."+d,n)),e.item.linkedWith&&Array.isArray(e.item.linkedWith)))for(const t of e.item.linkedWith)O.push(i.subscribe("config.chart.items."+t,n)),O.push(i.subscribe("$data.chart.items."+t,n));function n(){i.mute(n),A(e,t),i.unmute(n)}}function A(t,i){if(i.leave||void 0===t.row||void 0===t.item)return v=!0,S=!0,_.change(t,i),a();S=!1,v=!1,(e=t).item.id===d&&e.row.id===f||(d=e.item.id,f=e.row.id,R(i),P=n.getClass(D,e.row.id+"-"+e.item.id),M=n.getClass(D+"-label",e.row.id+"-"+e.item.id),$.item=e.item,$.row=e.row),T()}R(),c(A),o(C);const L=n.getActions(D);o(i.subscribe("$data.chart.time",T)),L.push(Oe);const N=r.create(L,$),G=new s(()=>S);function Y(){return e.item?e.item.isHTML?e.item&&e.item.label?"function"==typeof e.item.label?u(e.item.label({item:e.item,vido:t})):u(e.item.label):null:e.item&&e.item.label?"function"==typeof e.item.label?e.item.label({item:e.item,vido:t}):e.item.label:null:null}return()=>_.html("outer",l`
  ...
  `}
              <div class=${M}>${_.html("content",Y())}</div>
              ${l`
    <div class=${E} style=${x}>
