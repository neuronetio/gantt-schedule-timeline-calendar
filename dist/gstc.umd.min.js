...
/**
	 ...
	 * subject to an additional IP rights grant found at
	 * http://polymer.github.io/PATENTS.txt
	 */}}const $=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),D=` ${d} `,P=document.createElement("template");class M{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let i=0;i<t;i++){const t=this.strings[i],o=t.lastIndexOf("\x3c!--");n=(o>-1||n)&&-1===t.indexOf("--\x3e",o+1);const s=w.exec(t);e+=null===s?t+(n?D:f):t.substr(0,s.index)+s[1]+s[2]+"$lit$"+s[3]+d}return e+=this.strings[t],e}getTemplateElement(){const t=P.cloneNode();let e=this.getHTML();return void 0!==$&&(e=$.createHTML(e)),t.innerHTML=e,t}}class _ extends M{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,n=e.firstChild;return e.removeChild(n),l(e,n.firstChild),t
/**
	 * @license
	 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
	 * This code may only be used under the BSD style license found at
...
/**
	 ...
	 * subject to an additional IP rights grant found at
	 * http://polymer.github.io/PATENTS.txt
	 */);class z{handleAttributeExpressions(t,e,n,i){const o=e[0];return"."===o?new A(t,e.slice(1),n).parts:"@"===o?[new G(t,e.slice(1),i.eventContext)]:"?"===o?[new R(t,e.slice(1),n)]:new E(t,e,n).parts}handleTextExpression(t){return new C(t)}}const k=new z;
/**
	 * @license
	 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
	 * This code may only be used under the BSD style license found at
...
const U={width:0,height:0};let B,q,Q;class K{constructor(t){B||(B=new ie(()=>{const e=t.clientWidth,n=t.clientHeight;U.width===e&&U.height===n||(U.width=e,U.height=n,i.update("$data.dimensions",U))}),B.observe(t),i.update("$data.elements.main",t))}update(){}destroy(t){B.unobserve(t)}}m.includes(K)||m.push(K),o(()=>{B.disconnect()}),o(i.subscribe("config.scroll",t=>{q=t.horizontal.multiplier,Q=t.vertical.multiplier}));const J={handleEvent(t){const e=n.normalizeMouseWheelEvent(t);if(t.shiftKey||e.x){const t=e.x?e.x:e.y,i=n.getScrollLeft();return void(t>0?n.setScrollLeft(i.dataIndex+q):n.setScrollLeft(i.dataIndex-q))}const i=n.getScrollTop();e.y>0?n.setScrollTop(i.dataIndex+Q):n.setScrollTop(i.dataIndex-Q)},passive:!0},Z=Object.assign(Object.assign({},e),{api:n,state:i}),tt=s.create(m,Z),et=n.generateSlots("main",t,e);return o(et.destroy),()=>k_k_k?et.html("outer",l`
      ...
      `)}function ae(t,e={}){const{api:n,state:i,onDestroy:o,Actions:s,update:r,reuseComponents:a,html:l,StyleMap:c,cache:u}=t,h="list",d=n.getActions(h);let f;const p=i.subscribe("config.components.ListColumn",t=>f=t);!function(){const t=i.get("config.list.expander.icons"),e={};for(const i in t){const o=t[i];e[i]=n.getSVGIconSrc(o)}i.update("$data.list.expander.icons",e)}(),function(){const t={open:"",close:""},e=i.get("config.list.toggle.icons");for(const i in e){const o=e[i];t[i]=n.getSVGIconSrc(o)}i.update("$data.list.toggle.icons",t)}();const m=n.getClass(h),g=n.generateSlots(h,t,e);let v,y;o(i.subscribe("config.list",(function(){v=i.get("config.list"),y=v.columns.percent,r()})));const b=[];o(i.subscribe("config.list.columns.data",(function(t){a(b,Object.values(t),t=>({column:t}),f),r()})));const w=new c({height:"","--expander-padding-width":"","--expander-size":""});let x;function $(t){x||(x=t.clientWidth,0===y&&(x=0),i.update("$data.list.width",x))}o(i.subscribeAll(["$data.height","config.list.expander"],()=>{const t=i.get("config.list.expander");w.style.height=i.get("$data.height")+"px",w.style["--expander-padding-width"]=t.padding+"px",w.style["--expander-size"]=t.size+"px",r()})),o(()=>{b.forEach(t=>t.destroy()),p()});d.push(class{constructor(t,e){e.state.update("$data.elements.list",t),$(t)}update(t){return $(t)}});const D=s.create(d,Object.assign(Object.assign({},e),{api:n,state:i}));return()=>g.html("outer",u(v.columns.percent>0?l`
            ...
            `:""))}class le{constructor(t,e){let n=!1,i=e.state.get("$data.elements.list-columns");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("$data.elements.list-columns",i)}destroy(t,e){e.state.update("$data.elements.list-columns",e=>e.filter(e=>e!==t))}}function ce(t,e){const{api:n,state:i,onDestroy:o,onChange:s,Actions:r,update:a,createComponent:l,reuseComponents:c,html:u,StyleMap:h}=t,d=[];let f,p;d.push(i.subscribe("config.components.ListColumnRow",t=>f=t)),d.push(i.subscribe("config.components.ListColumnHeader",t=>p=t));const m=Object.assign(Object.assign({},e),{api:n,state:i}),g="list-column",v="list-column-rows",y=n.getActions(g),b=n.getActions(v);let w,x,$,D;const P=new h({width:"","--width":""}),M=new h({height:""}),_=new h({"margin-top":"0px"}),I=n.generateSlots(g,t,e);let S;function T(){const t=i.get("config.list");D=t.columns.data[e.column.id].width*t.columns.percent*.01,S=D;const n=i.get("$data.innerHeight");P.style.width=S+"px",P.style["--width"]=S+"px",M.style.height=n+"px"}o(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","$data.chart.dimensions.width","$data.innerHeight","$data.list.width","$data.list.visibleRowsHeight"],T,{bulk:!0}));const E=l(p,e);o(E.destroy);const O=[];function C(){const t=i.get("$data.list.visibleRows")||[],o=n.getRows(t),s=n.getRowsData();c(O,o,t=>t&&{column:e.column,row:t,rowData:s[t.id],width:S},f,!1),I.change(e)}s(t=>{e=t,w=n.getClass(g,e.column.id),$=n.getClass("list-column-rows-offset",e.column.id),x=n.getClass(v,e.column.id);for(const t in e)m[t]=e[t];T(),E.change(e),C()}),o(i.subscribeAll(["$data.list.visibleRows","$data.list.visibleRowsHeight","config.list.rows","config.chart.items.*.height","config.chart.items.*.rowId","config.chart.items.*.time"],C)),o(i.subscribe("config.scroll.vertical.offset",t=>{_.style.transform=`translateY(-${t||0}px)`,a()})),o(()=>{O.forEach(t=>t.destroy()),d.forEach(t=>t())}),y.push(le);const R=r.create(y,{column:e.column,state:i,api:n}),A=r.create(b,{api:n,state:i});return()=>{const t=u`
      <div class=${$} style=${_}>
        ${I.html("content",O.map(t=>t.html()))}
      </div>
    `,e=u`
      <div class=${x} style=${M} data-actions=${A}>
    ...
    `;return P.html("outer",r`
      ...
      `)}class Te{constructor(t,e){let n=!1,i=e.state.get("$data.elements.chart-timeline-items-rows");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("$data.elements.chart-timeline-items-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}function Ee(t,e){const{api:n,state:i,onDestroy:o,Detach:s,Actions:r,update:a,html:l,onChange:c,reuseComponents:u,StyleMap:h}=t,d=Object.assign(Object.assign({},e),{api:n,state:i});let f;o(i.subscribe("config.components.ChartTimelineItemsRowItem",t=>f=t));let p="";const m=[],g=new h({width:"",height:""},!0);let v=!1;const y=new s(()=>v);function b(t,o){if(!t||!o)return v=!0,u(m,[],()=>null,f,!1),a();const s=o.items;if(void 0===s)return v=!0,u(m,[],()=>null,f,!1),a();const r=n.getItems(s);u(m,r,e=>({row:t,item:e}),f,!1),function(){const t=i.get("$data.chart");v=!1,g.style.width=t.dimensions.width+"px",e?(g.style.height=e.rowData.outerHeight+"px",g.style["--row-height"]=e.rowData.outerHeight+"px"):v=!0}(),a()}const w="chart-timeline-items-row";let x=n.getClass(w);const $=n.generateSlots(w,t,e);c((function(i,o){if(o.leave||!i||void 0===i.row)return v=!0,u(m,[],()=>null,f,!1),$.change(i,o),a();e=i,x=n.getClass(w,e.row.id);for(const t in e)d[t]=e[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)p=x+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const n=e.row.classNames({row:e.row,vido:t});Array.isArray(n)&&n.length&&(p=x+" "+n.join(" "))}}else p=x;b(e.row,e.rowData),$.change(i,o),a()})),o(i.subscribe("$data.chart.dimensions.width",()=>b(e.row,e.rowData))),o(()=>{m.forEach(t=>t.destroy())});const D=n.getActions(w);D.push(Te);const P=r.create(D,d);return()=>$.html("outer",l`
        <div detach=${y} class=${p} data-actions=${P} style=${g}>
          ${$.html("content",m.map(t=>t.html()))}
        </div>
      `)}class Oe{constructor(t,e){let n=!1,i=e.state.get("$data.elements.chart-timeline-items-row-items");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("$data.elements.chart-timeline-items-row-items",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}}function Ce(t,e){const{api:n,state:i,onDestroy:o,Detach:s,Actions:r,update:a,html:l,svg:c,onChange:u,unsafeHTML:h,StyleMap:d}=t;let f,p,m;o(i.subscribe("config.debug",t=>m=t));let g=0,v=0,y=!1,b="";const w=new d({width:"",height:"",left:"",top:""}),x=new d({}),$=new d({}),D={item:e.item,row:e.row,left:g,width:v,api:n,state:i},P="chart-timeline-items-row-item";let M,_;M=n.getClass(P),_=n.getClass(P+"-label");const I=n.generateSlots(P,t,e);let S,T=!1;function E(o=i.get("$data.chart.time")){var s;if(I.change(e,{leave:!1}),y||0===o.levels.length||!o.levels[o.level]||0===o.levels[o.level].length)return T=!0,e.item&&n.setItemData(e.item.id,{detached:T}),a();if(!e.item)return T=!0,a();m&&(console.groupCollapsed("[items-row-item.ts] Update item (before)"),console.log({id:e.item.id,item:e.item}),console.trace(),console.groupEnd());const r=n.getItemData(e.item.id);if(g=r.position.actualLeft,v=r.actualWidth,e.item.time.end<=o.leftGlobal||e.item.time.start>=o.rightGlobal||v<=0)return T=!0,r.detached=T,a();if(b=M,e.item.time.start<o.leftGlobal?(x.style.display="flex",b+=" "+n.getClass(P+"--left-cut",e.row.id+"-"+e.item.id)):x.style.display="none",r.position.right>o.width?($.style.display="flex",b+=" "+n.getClass(P+"--right-cut",e.row.id+"-"+e.item.id)):$.style.display="none",e.item.classNames)if(Array.isArray(e.item.classNames)&&e.item.classNames.length)b+=" "+e.item.classNames.join(" ");else if("function"==typeof e.item.classNames){const n=e.item.classNames({item:e.item,vido:t});Array.isArray(n)&&(b+=" "+n.join(" "))}const l=w.style.width,c=w.style.left,u=w.style.top,h=w.style.height;w.setStyle({});const d=n.isItemInViewport(e.item,o.leftGlobal,o.rightGlobal);T=!d,r.detached=T,d?(w.style.width=v+"px",w.style.left=g+"px",w.style.top=r.position.actualTop+"px",w.style.height=r.actualHeight+"px"):(w.style.width=l,w.style.left=c,w.style.top=u,w.style.height=h),(null===(s=null==e?void 0:e.item)||void 0===s?void 0:s.style)&&w.setStyle(Object.assign(Object.assign({},w.style),e.item.style)),D.left=g,D.width=v,m&&console.log("[items-row-item.ts] Update item (after)",{id:e.item.id,itemLeftPx:g,itemWidthPx:v,item:e.item}),a()}o(i.subscribe("config.chart.item.cutIcons",t=>{S={left:n.getSVGIconSrc(t.left),right:n.getSVGIconSrc(t.right)}}));const O=n.getClass(P+"-cut"),C=[];function R(){C.forEach(t=>t()),C.length=0}function A(t={}){if(R(),f&&(C.push(i.subscribe("config.chart.items."+f,()=>L(e,t))),e.item.linkedWith&&Array.isArray(e.item.linkedWith)))for(const n of e.item.linkedWith)C.push(i.subscribe("config.chart.items."+n,()=>L(e,t)))}function L(t,i){if(i.leave||void 0===t.row||void 0===t.item)return y=!0,T=!0,I.change(t,i),a();T=!1,y=!1,(e=t).item.id===f&&e.row.id===p||(f=e.item.id,p=e.row.id,A(i),M=n.getClass(P,e.row.id+"-"+e.item.id),_=n.getClass(P+"-label",e.row.id+"-"+e.item.id),D.item=e.item,D.row=e.row),E()}A(),u(L),o(R);const N=n.getActions(P);o(i.subscribe("$data.chart.time",E)),N.push(Oe);const G=r.create(N,D),Y=new s(()=>T);function z(){return e.item?e.item.isHTML?e.item&&e.item.label?"function"==typeof e.item.label?h(e.item.label({item:e.item,vido:t})):h(e.item.label):null:e.item&&e.item.label?"function"==typeof e.item.label?e.item.label({item:e.item,vido:t}):e.item.label:null:null}return()=>I.html("outer",l`
