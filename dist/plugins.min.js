 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */,ItemMovement:function ItemMovement(e={}){const t={moveable:!0,resizeable:!0,resizerContent:"",collisionDetection:!0,outOfBorders:!1,snapStart:(e,t)=>e+t,snapEnd:(e,t)=>e+t,ghostNode:!0};e=Object.assign(Object.assign({},t),e);const i={};function action(t,n){if(!e.moveable&&!e.resizeable)return;const o=n.state,s=n.api;function isResizeable(t){let i=e.resizeable&&(!t.item.hasOwnProperty("resizeable")||!0===t.item.resizeable);return t.row.hasOwnProperty("resizeable")&&i&&(i=t.row.resizeable),i}function getMovement(e){const t=e.item.id;return void 0===i[t]&&(i[t]={moving:!1,resizing:!1}),i[t]}function moveGhost(i,n){if(e.ghostNode){const e=getMovement(i),o=n.clientX-e.ganttLeft-e.itemLeftCompensation;e.ghost.style.left=o+"px",e.ghost.style.top=n.clientY-e.ganttTop-e.itemTop+parseInt(getComputedStyle(t)["margin-top"])+"px"}}function destroyGhost(t){e.ghostNode&&void 0!==i[t]&&void 0!==i[t].ghost&&(o.get("_internal.elements.chart-timeline").removeChild(i[t].ghost),delete i[t].ghost)}function getSnapStart(t){let i=e.snapStart;return"function"==typeof t.item.snapStart&&(i=t.item.snapStart),i}function getSnapEnd(t){let i=e.snapEnd;return"function"==typeof t.item.snapEnd&&(i=t.item.snapEnd),i}const r=`<div class="${s.getClass("chart-timeline-items-row-item-resizer")}">${e.resizerContent}</div>`;t.insertAdjacentHTML("beforeend",r);const c=t.querySelector(".gantt-schedule-timeline-calendar__chart-timeline-items-row-item-resizer");function labelDown(i){i.stopPropagation();const r=s.normalizePointerEvent(i);if("mousedown"===i.type&&0!==i.button)return;const c=getMovement(n);c.moving=!0;const l=o.get(`config.chart.items.${n.item.id}`),a=o.get("_internal.chart.time.leftGlobal"),m=o.get("_internal.chart.time.timePerPixel"),d=o.get("_internal.elements.chart-timeline").getBoundingClientRect();c.ganttTop=d.top,c.ganttLeft=d.left,c.itemX=Math.round((l.time.start-a)/m),c.itemLeftCompensation=r.clientX-c.ganttLeft-c.itemX,function createGhost(i,n,s,r){const c=getMovement(i);if(!e.ghostNode||void 0!==c.ghost)return;const l=t.cloneNode(!0),a=getComputedStyle(t),m=o.get("config.scroll.compensation");l.style.position="absolute",l.style.left=n.clientX-s-c.itemLeftCompensation+"px";const d=n.clientY-r-t.offsetTop-m+parseInt(a["margin-top"]);c.itemTop=d,l.style.top=n.clientY-r-d+"px",l.style.width=a.width,l.style["box-shadow"]="10px 10px 6px #00000020";const u=t.clientHeight+"px";return l.style.height=u,l.style["line-height"]=t.clientHeight-18+"px",l.style.opacity="0.6",l.style.transform="scale(1.05, 1.05)",o.get("_internal.elements.chart-timeline").appendChild(l),c.ghost=l,l}(n,r,d.left,d.top)}function resizerDown(e){if(e.stopPropagation(),"mousedown"===e.type&&0!==e.button)return;const t=s.normalizePointerEvent(e),i=getMovement(n);i.resizing=!0;const r=o.get(`config.chart.items.${n.item.id}`),c=o.get("_internal.chart.time.leftGlobal"),l=o.get("_internal.chart.time.timePerPixel"),a=o.get("_internal.elements.chart-timeline").getBoundingClientRect();i.ganttTop=a.top,i.ganttLeft=a.left,i.itemX=(r.time.end-c)/l,i.itemLeftCompensation=t.clientX-i.ganttLeft-i.itemX}function isCollision(t,i,n,r){if(!e.collisionDetection)return!1;const c=o.get("_internal.chart.time");if(e.outOfBorders&&(n<c.from||r>c.to))return!0;let l=s.time.date(r).diff(n,"milliseconds");if(-1===Math.sign(l)&&(l=-l),l<=1)return!0;const a=o.get("config.list.rows."+t);for(const e of a._internal.items)if(e.id!==i){if(n>=e.time.start&&n<=e.time.end)return!0;if(r>=e.time.start&&r<=e.time.end)return!0;if(n<=e.time.start&&r>=e.time.end)return!0}return!1}function documentMove(t){t.stopPropagation();const i=getMovement(n),r=s.normalizePointerEvent(t);let c,l,a,m,d;(i.moving||i.resizing)&&(c=o.get(`config.chart.items.${n.item.id}`),l=o.get(`config.chart.items.${n.item.id}.rowId`),a=o.get(`config.list.rows.${l}`),m=o.get("config.chart.time.zoom"),d=o.get("_internal.chart.time.timePerPixel"));const u=function isMoveable(t){let i=e.moveable;return t.item.hasOwnProperty("moveable")&&i&&(i=t.item.moveable),t.row.hasOwnProperty("moveable")&&i&&(i=t.row.moveable),i}(n);if(i.moving){if((!0===u||"x"===u||Array.isArray(u)&&u.includes(l))&&function movementX(e,t,i,s,r){const c=getMovement(n),l=e.clientX-c.ganttLeft-c.itemLeftCompensation;moveGhost(n,e);const a=o.get("_internal.chart.time.leftGlobal")+l*r-i.time.start,m=i.time.start,d=getSnapStart(n)(i.time.start,a,i)-m,u=isCollision(t.id,i.id,i.time.start+d,i.time.end+d);d&&!u&&o.update(`config.chart.items.${n.item.id}.time`,(function moveItem(e){return e.start+=d,e.end=getSnapEnd(n)(e.end,d,i)-1,e}))}(r,a,c,0,d),!u||"x"===u)return;let e=function movementY(e,t,i,s,r){moveGhost(n,e);const c=getMovement(n),l=e.clientY-c.ganttTop,a=o.get("_internal.list.visibleRows"),m=o.get("config.scroll.compensation");let d=0;for(const e of a){if(e.top+m>l)return d>0?d-1:0;d++}return d}(r);const t=o.get("_internal.list.visibleRows");void 0===t[e]&&(e>0?e=t.length-1:e<0&&(e=0));const i=t[e],s=i.id,m=isCollision(s,c.id,c.time.start,c.time.end);s===c.rowId||m||Array.isArray(u)&&!u.includes(s)||i.hasOwnProperty("moveable")&&!i.moveable||o.update(`config.chart.items.${c.id}.rowId`,s)}else!i.resizing||void 0!==c.resizeable&&!0!==c.resizeable||function resizeX(e,t,i,s,r){if(!isResizeable(n))return;const c=o.get("_internal.chart.time"),l=getMovement(n),a=e.clientX-l.ganttLeft-l.itemLeftCompensation,m=c.leftGlobal+a*r-i.time.end;if(i.time.end+m<i.time.start)return;const d=i.time.end,u=getSnapEnd(n)(i.time.end,m,i)-1-d,h=isCollision(t.id,i.id,i.time.start,i.time.end+u);u&&!h&&o.update(`config.chart.items.${n.item.id}.time`,e=>(e.start=getSnapStart(n)(e.start,0,i),e.end=getSnapEnd(n)(e.end,u,i)-1,e))}(r,a,c,0,d)}function documentUp(e){const t=getMovement(n);(t.moving||t.resizing)&&e.stopPropagation(),t.moving=!1,t.resizing=!1;for(const e in i)i[e].moving=!1,i[e].resizing=!1,destroyGhost(e)}return isResizeable(n)?c.style.visibility="visible":c.style.visibility="hidden",t.addEventListener("mousedown",labelDown),t.addEventListener("touchstart",labelDown),c.addEventListener("mousedown",resizerDown),c.addEventListener("touchstart",resizerDown),document.addEventListener("mousemove",documentMove),document.addEventListener("mouseup",documentUp),document.addEventListener("touchmove",documentMove),document.addEventListener("touchend",documentUp),document.addEventListener("touchcancel",documentUp),{update(e,t){isResizeable(n)||"visible"!==c.style.visibility?isResizeable(n)&&"hidden"===c.style.visibility&&(c.style.visibility="visible"):c.style.visibility="hidden",n=t},destroy(e,i){t.removeEventListener("mousedown",labelDown),t.removeEventListener("touchstart",labelDown),c.removeEventListener("mousedown",resizerDown),c.removeEventListener("touchstart",resizerDown),document.removeEventListener("mousemove",documentMove),document.removeEventListener("mouseup",documentUp),document.removeEventListener("touchmove",documentMove),document.removeEventListener("touchend",documentUp),document.removeEventListener("touchcancel",documentUp),c.remove()}}}return function initialize(e){e.state.update("config.actions.chart-timeline-items-row-item",e=>(e.push(action),e))}}
/**
 * SaveAsImage plugin
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
