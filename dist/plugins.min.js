 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */,CalendarScroll:function CalendarScroll(e={}){let t,i;const n={speed:1,hideScroll:!1,onChange(e){}};e=Object.assign(Object.assign({},n),e);class CalendarScrollAction{constructor(n,s){this.isMoving=!1,this.lastX=0,this.onPanStart=this.onPanStart.bind(this),this.onPanMove=this.onPanMove.bind(this),this.onPanEnd=this.onPanEnd.bind(this),this.mc=new i.Hammer(n),this.mc.on("panstart",this.onPanStart),this.mc.on("panmove",this.onPanMove),this.mc.on("panend",this.onPanEnd),n.style.cursor="move";const o=t.get("_internal.elements.horizontal-scroll");e.hideScroll&&o&&(o.style.visibility="hidden")}onPanStart(e){this.isMoving=!0,this.lastX=e.deltaX}onPanMove(i){const n=i.deltaX-this.lastX,s=t.get("_internal.chart.time"),o=-Math.round(n*s.timePerPixel*e.speed);t.update("config.chart.time",t=>(0===t.from&&(t.from=s.from),0===t.to&&(t.to=s.to),t.from+=o,t.to+=o,e.onChange(t),t)),this.lastX=i.deltaX}onPanEnd(e){this.isMoving=!1,this.lastX=0}destroy(e,t){this.mc.off(e)}}return function initialize(e){i=e.api,(t=e.state).update("config.actions.chart-calendar",e=>(e.push(CalendarScrollAction),e))}}};export default e;
