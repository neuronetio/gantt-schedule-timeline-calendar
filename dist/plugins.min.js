 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */,CalendarScroll:function CalendarScroll(e={}){let t,i;class CalendarScrollAction{constructor(e,t){this.isMoving=!1,e.addEventListener("mousedown",this.onMouseDown),document.addEventListener("mousemove",this.onMouseMove),document.addEventListener("mouseup",this.onMouseUp)}onMouseDown(e){this.isMoving=!0}onMouseUp(e){this.isMoving=!1}onMouseMove(e){this.isMoving&&console.log("moving",e.x)}update(e,t){}destroy(e,t){e.removeEventListener("mousedown",this.onMouseDown),document.removeEventListener("mousemove",this.onMouseMove),document.removeEventListener("mouseup",this.onMouseUp)}}return function initialize(e){i=e.api,(t=e.state).update("config.actions.chart-calendar",e=>(e.push(CalendarScrollAction),e))}}};export default e;
