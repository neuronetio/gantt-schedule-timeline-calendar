 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */,ItemMovement:function ItemMovement(e={}){const t={moveable:!0,resizeable:!0,resizerContent:"",collisionDetection:!0,outOfBorders:!1,snapStart:(e,t)=>e+t,snapEnd:(e,t)=>e+t,ghostNode:!0};e=Object.assign(Object.assign({},t),e);const i={};function action(t,n){if(!e.moveable&&!e.resizeable)return;let o,s;function isResizeable(t){let i=e.resizeable&&(!t.item.hasOwnProperty("resizeable")||!0===t.item.resizeable);return t.row.hasOwnProperty("resizeable")&&i&&(i=t.row.resizeable),i}function getMovement(e){const t=e.item.id;return void 0===i[t]&&(i[t]={moving:!1,resizing:!1}),i[t]}function moveGhost(i,n){if(e.ghostNode){const e=getMovement(i),o=n.x-e.ganttLeft-e.itemLeftCompensation;e.ghost.style.left=o+"px",e.ghost.style.top=n.y-e.ganttTop-e.itemTop+parseInt(getComputedStyle(t)["margin-top"])+"px"}}function destroyGhost(t){e.ghostNode&&void 0!==i[t]&&void 0!==i[t].ghost&&(o.get("_internal.elements.chart-timeline").removeChild(i[t].ghost),delete i[t].ghost)}function getSnapStart(t){let i=e.snapStart;return"function"==typeof t.item.snapStart&&(i=t.item.snapStart),i}function getSnapEnd(t){let i=e.snapEnd;return"function"==typeof t.item.snapEnd&&(i=t.item.snapEnd),i}o=n.state;const r=`<div class="${(s=n.api).getClass("chart-timeline-items-row-item-resizer")}">${e.resizerContent}</div>`;t.insertAdjacentHTML("beforeend",r);const c=t.querySelector(".gantt-schedule-timeline-calendar__chart-timeline-items-row-item-resizer");function labelMouseDown(i){if(i.stopPropagation(),0!==i.button)return;const s=getMovement(n);s.moving=!0;const r=o.get(`config.chart.items.${n.item.id}`),c=o.get("_internal.chart.time.leftGlobal"),l=o.get("_internal.chart.time.timePerPixel"),a=o.get("_internal.elements.chart-timeline").getBoundingClientRect();s.ganttTop=a.top,s.ganttLeft=a.left,s.itemX=Math.round((r.time.start-c)/l),s.itemLeftCompensation=i.x-s.ganttLeft-s.itemX,function createGhost(i,n,s,r){const c=getMovement(i);if(!e.ghostNode||void 0!==c.ghost)return;const l=t.cloneNode(!0),a=getComputedStyle(t),m=o.get("config.scroll.compensation");l.style.position="absolute",l.style.left=n.x-s-c.itemLeftCompensation+"px";const d=n.y-r-t.offsetTop-m+parseInt(a["margin-top"]);c.itemTop=d,l.style.top=n.y-r-d+"px",l.style.width=a.width,l.style["box-shadow"]="10px 10px 6px #00000020";const u=t.clientHeight+"px";return l.style.height=u,l.style["line-height"]=t.clientHeight-18+"px",l.style.opacity="0.6",l.style.transform="scale(1.05, 1.05)",o.get("_internal.elements.chart-timeline").appendChild(l),c.ghost=l,l}(n,i,a.left,a.top)}function resizerMouseDown(e){if(e.stopPropagation(),0!==e.button)return;const t=getMovement(n);t.resizing=!0;const i=o.get(`config.chart.items.${n.item.id}`),s=o.get("_internal.chart.time.leftGlobal"),r=o.get("_internal.chart.time.timePerPixel"),c=o.get("_internal.elements.chart-timeline").getBoundingClientRect();t.ganttTop=c.top,t.ganttLeft=c.left,t.itemX=(i.time.end-s)/r,t.itemLeftCompensation=e.x-t.ganttLeft-t.itemX}function isCollision(t,i,n,r){if(!e.collisionDetection)return!1;const c=o.get("_internal.chart.time");if(e.outOfBorders&&(n<c.from||r>c.to))return!0;let l=s.time.date(r).diff(n,"milliseconds");if(-1===Math.sign(l)&&(l=-l),l<=1)return!0;const a=o.get("config.list.rows."+t);for(const e of a._internal.items)if(e.id!==i){if(n>=e.time.start&&n<=e.time.end)return!0;if(r>=e.time.start&&r<=e.time.end)return!0;if(n<=e.time.start&&r>=e.time.end)return!0}return!1}function documentMouseMove(t){const i=getMovement(n);let s,r,c,l,a;(i.moving||i.resizing)&&(s=o.get(`config.chart.items.${n.item.id}`),r=o.get(`config.chart.items.${n.item.id}.rowId`),c=o.get(`config.list.rows.${r}`),l=o.get("config.chart.time.zoom"),a=o.get("_internal.chart.time.timePerPixel"));const m=function isMoveable(t){let i=e.moveable;return t.item.hasOwnProperty("moveable")&&i&&(i=t.item.moveable),t.row.hasOwnProperty("moveable")&&i&&(i=t.row.moveable),i}(n);if(i.moving){if((!0===m||"x"===m||Array.isArray(m)&&m.includes(r))&&function movementX(e,t,i,s,r){const c=getMovement(n),l=e.x-c.ganttLeft-c.itemLeftCompensation;moveGhost(n,e);const a=o.get("_internal.chart.time.leftGlobal")+l*r-i.time.start,m=i.time.start,d=getSnapStart(n)(i.time.start,a,i)-m,u=isCollision(t.id,i.id,i.time.start+d,i.time.end+d);d&&!u&&o.update(`config.chart.items.${n.item.id}.time`,(function moveItem(e){return e.start+=d,e.end=getSnapEnd(n)(e.end,d,i)-1,e}))}(t,c,s,0,a),!m||"x"===m)return;let e=function movementY(e,t,i,s,r){moveGhost(n,e);const c=getMovement(n),l=e.y-c.ganttTop,a=o.get("_internal.list.visibleRows"),m=o.get("config.scroll.compensation");let d=0;for(const e of a){if(e.top+m>l)return d>0?d-1:0;d++}return d}(t);const i=o.get("_internal.list.visibleRows");void 0===i[e]&&(e>0?e=i.length-1:e<0&&(e=0));const l=i[e],d=l.id,u=isCollision(d,s.id,s.time.start,s.time.end);d===s.rowId||u||Array.isArray(m)&&!m.includes(d)||l.hasOwnProperty("moveable")&&!l.moveable||o.update(`config.chart.items.${s.id}.rowId`,d)}else!i.resizing||void 0!==s.resizeable&&!0!==s.resizeable||function resizeX(e,t,i,s,r){if(!isResizeable(n))return;const c=o.get("_internal.chart.time"),l=getMovement(n),a=e.x-l.ganttLeft-l.itemLeftCompensation,m=c.leftGlobal+a*r-i.time.end;if(i.time.end+m<i.time.start)return;const d=i.time.end,u=getSnapEnd(n)(i.time.end,m,i)-1-d,g=isCollision(t.id,i.id,i.time.start,i.time.end+u);u&&!g&&o.update(`config.chart.items.${n.item.id}.time`,e=>(e.start=getSnapStart(n)(e.start,0,i),e.end=getSnapEnd(n)(e.end,u,i)-1,e))}(t,c,s,0,a)}function documentMouseUp(e){const t=getMovement(n);(t.moving||t.resizing)&&e.stopPropagation(),t.moving=!1,t.resizing=!1;for(const e in i)i[e].moving=!1,i[e].resizing=!1,destroyGhost(e)}return isResizeable(n)?c.style.visibility="visible":c.style.visibility="hidden",t.addEventListener("mousedown",labelMouseDown),c.addEventListener("mousedown",resizerMouseDown,{capture:!0}),document.addEventListener("mousemove",documentMouseMove,{capture:!0,passive:!0}),document.addEventListener("mouseup",documentMouseUp,{capture:!0,passive:!0}),{update(e,t){isResizeable(n)||"visible"!==c.style.visibility?isResizeable(n)&&"hidden"===c.style.visibility&&(c.style.visibility="visible"):c.style.visibility="hidden"},destroy(e,i){t.removeEventListener("mousedown",labelMouseDown),c.removeEventListener("mousedown",resizerMouseDown),document.removeEventListener("mousemove",documentMouseMove),document.removeEventListener("mouseup",documentMouseUp),c.remove()}}}return function initialize(e){e.state.update("config.actions.chart-timeline-items-row-item",e=>(e.push(action),e))}}
/**
 * SaveAsImage plugin
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
