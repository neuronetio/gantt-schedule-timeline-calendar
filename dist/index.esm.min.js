 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const S=(t,...e)=>new TemplateResult(t,e,"html",P),O=(t,...e)=>new SVGTemplateResult(t,e,"svg",P);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function saveElement(t,e){e.state.update("_internal.elements.list-column-rows",e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e))}function ListColumnRow(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,createComponent:l,onChange:c,StyleMap:u,unsafeHTML:h}=t,d=Object.assign(Object.assign({},e),{api:n,state:i});let p,f;s(i.subscribe("config.wrappers.ListColumnRow",t=>p=t)),s(i.subscribe("config.components.ListExpander",t=>f=t));let m,g,v=`_internal.flatTreeMapById.${e.rowId}`,y=i.get(v),b=`config.list.columns.data.${e.columnId}`,w=i.get(b),_=new u(w.expander?{opacity:"1",pointerEvents:"auto",height:"",width:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{opacity:"1",pointerEvents:"auto",height:"",width:"",top:"","--height":""});const x=l(f,{row:y});c((t,n)=>{if(n.leave)return _.style.opacity="0",_.style.pointerEvents="none",void r();e=t;for(const t in e)d[t]=e[t];const s=e.rowId,o=e.columnId;m&&m(),g&&g(),v=`_internal.flatTreeMapById.${s}`,b=`config.list.columns.data.${o}`,m=i.subscribeAll([v,"config.list.expander"],t=>{y=i.get(v);const e=i.get("config.list.expander");_.style={},_.style.opacity="1",_.style.pointerEvents="auto",_.style.height=y.height+"px",_.style["--height"]=y.height+"px",w.expander&&(_.style["--expander-padding-width"]=e.padding*(y._internal.parents.length+1)+"px");for(let t of y._internal.parents){const e=i.get(`_internal.flatTreeMapById.${t}`);if("object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children){const t=e.style.children;for(const e in t)_.style[e]=t[e]}}if("object"==typeof y.style&&"Object"===y.style.constructor.name&&"object"==typeof y.style.current){const t=y.style.current;for(const e in t)_.style[e]=t[e]}r()}),x&&x.change({row:y}),g=i.subscribe(b,t=>{w=t,r()})}),s(()=>{x&&x.destroy(),g(),m()});const C=n.getActions("list-column-row");let T;s(i.subscribe("config.classNames",t=>{T=n.getClass("list-column-row"),r()})),C.includes(saveElement)||C.push();const $=o.create(C,d);return n=>p(a`
        <div class=${T} style=${_} data-actions=${$}>
          ${w.expander?x.html():null}
          <div class=${T+"-content"}>
            ${w.isHTML?function getHtml(){return"function"==typeof w.data?h(w.data(y)):h(y[w.data])}():function getText(){return"function"==typeof w.data?w.data(y):y[w.data]}()}
          </div>
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimeline(t,e){const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,createComponent:l,StyleMap:c}=t,u=n.getActions("chart-timeline"),h=Object.assign(Object.assign({},e),{api:n,state:i});let d;s(i.subscribe("config.wrappers.ChartTimeline",t=>d=t));const p=i.get("config.components.ChartTimelineGrid"),f=i.get("config.components.ChartTimelineItems"),m=l(p);s(m.destroy);const g=l(f);let v,y;s(g.destroy),s(i.subscribe("config.classNames",()=>{v=n.getClass("chart-timeline"),y=n.getClass("chart-timeline-inner"),r()}));let b=new c({}),w=new c({});s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","_internal.list.rowsHeight","config.scroll.compensation"],(function calculateStyle(){const t=i.get("config.scroll.compensation"),e=i.get("_internal.chart.dimensions.width"),n=i.get("_internal.list.rowsHeight");b.style.height=i.get("_internal.height")+"px",e&&(b.style.width=e+"px"),w.style.height=n+"px",e&&(w.style.width=e+"px"),w.style.transform=`translate(0px, ${t}px)`,r()}))),u.push(t=>{i.update("_internal.elements.chart-timeline",t)});const _=o.create(u,h);return i=>d(a`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const xt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),t=>{e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>e.filter(e=>e!==t),{only:[""]})}),Ct=(t,e)=>{const{api:n,state:i,onDestroy:s,Actions:o,update:r,html:a,onChange:l,StyleMap:c}=t,u="chart-timeline-grid-row-block",h=Object.assign(Object.assign({},e),{api:n,state:i}),d=n.getActions(u);let p;s(i.subscribe("config.wrappers.ChartTimelineGridRowBlock",t=>{p=t,r()}));const f=n.time.date().startOf("day").valueOf();let m,g;function updateClassName(t){m=n.getClass(u),g=m+"-content",t.leftGlobal===f&&(m+=" current")}updateClassName(e.time);let v=new c({width:"",height:""});l((function onPropsChange(t,n){var s,o,a,l,c,u,d;if(n.leave)return r();e=t;for(const t in e)h[t]=e[t];updateClassName(e.time),v.style={},v.style.width=e.time.width+"px",v.style.height=e.row.height+"px";const p=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(a=null===(o=null===(s=p[t].style)||void 0===s?void 0:s.grid)||void 0===o?void 0:o.block)||void 0===a?void 0:a.children;e&&(v.style=Object.assign(Object.assign({},v.style),e))}const f=null===(d=null===(u=null===(c=null===(l=e.row)||void 0===l?void 0:l.style)||void 0===c?void 0:c.grid)||void 0===u?void 0:u.block)||void 0===d?void 0:d.current;f&&(v.style=Object.assign(Object.assign({},v.style),f)),r()})),-1===d.indexOf(xt)&&d.push(xt);const y=o.create(d,h);return n=>p(a`
        <div class=${m} data-actions=${y} style=${v}>
          <div class=${g} />
        </div>
      `,{props:e,vido:t,templateProps:n})};
/**
 ...
 * @license   GPL-3.0
 */
const Ot="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const Dt={name:Ot,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,Hammer:Pt,date:t=>t?It(t):It(),dayjs:It};
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
