 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const A=(t,...e)=>new TemplateResult(t,e,"html",I),E=(t,...e)=>new SVGTemplateResult(t,e,"svg",I);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */function Main(t,e={}){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,html:l,StyleMap:c}=t,u=n.name;let h,d;s(i.subscribe("config.components.List",t=>h=t)),s(i.subscribe("config.components.Chart",t=>d=t));const p=a(h);s(p.destroy);const f=a(d);let m;s(f.destroy),s(i.subscribe("config.plugins",e=>{if(void 0!==e&&Array.isArray(e))for(const n of e){const e=n(t);"function"==typeof e&&s(e)}})),s(i.subscribe("config.wrappers.Main",t=>m=t));const g=n.getActions("");let v,y,b,w=new c({}),_=new c({}),x=new c({}),T=0,C=!1;s(i.subscribe("config.classNames",t=>{const e=i.get("config");v=n.getClass(u,{config:e}),C&&(v+=` ${u}__list-column-header-resizer--active`),y=n.getClass("vertical-scroll",{config:e}),r()}));s(i.subscribeAll(["config.height","config.headerHeight","_internal.scrollBarHeight"],()=>{const t=i.get("config"),e=i.get("_internal.scrollBarHeight"),n=t.height-t.headerHeight-e;i.update("_internal.height",n),w.style["--height"]=t.height+"px",_.style.height=n+"px",_.style.width=e+"px",_.style["margin-top"]=t.headerHeight+"px",r()}));s(i.subscribe("_internal.list.columns.resizer.active",t=>{C=t,v=n.getClass(n.name),C&&(v+=` ${n.name}__list-column-header-resizer--active`),r()})),s(i.subscribeAll(["config.list.rows;","config.chart.items;","config.list.rows.*.parentId","config.chart.items.*.rowId"],(function generateTree(t,e){if(i.get("_internal.flatTreeMap").length&&"subscribe"===e.type)return;const s=i.get("config.list.rows"),o=[];for(const t in s)o.push(s[t]);n.fillEmptyRowValues(o);const a=i.get("config.chart.items"),l=[];for(const t in a)l.push(a[t]);const c=n.makeTreeMap(o,l);i.update("_internal.treeMap",c),i.update("_internal.flatTreeMapById",n.getFlatTreeMapById(c)),i.update("_internal.flatTreeMap",n.flattenTreeMap(c)),r()}),{bulk:!0})),s(i.subscribeAll(["config.list.rows.*.expanded","_internal.treeMap;"],(function prepareExpanded(){const t=i.get("config.list.rows"),e=n.getRowsFromIds(n.getRowsWithParentsExpanded(i.get("_internal.flatTreeMap"),i.get("_internal.flatTreeMapById"),t),t);T=n.getRowsHeight(e),i.update("_internal.list.rowsHeight",T),i.update("_internal.list.rowsWithParentsExpanded",e),r()}),{bulk:!0})),s(i.subscribeAll(["_internal.list.rowsWithParentsExpanded","config.scroll.top"],(function generateVisibleRows(){const{visibleRows:t,compensation:e}=n.getVisibleRowsAndCompensation(i.get("_internal.list.rowsWithParentsExpanded")),s=i.get("_internal.list.visibleRows");let o=!0;if(i.update("config.scroll.compensation",-e),t.length&&(o=t.some((t,e)=>void 0===s[e]||t.id!==s[e].id)),o){i.update("_internal.list.visibleRows",t);const e=[];for(const n of t)for(const t of n._internal.items)e.push(t);i.update("_internal.chart.visibleItems",e)}r()})));let $=0;s(i.subscribe("_internal.list.visibleRows;",(function onVisibleRowsChange(){const t=i.get("config.scroll.top");x.style.width="1px",x.style.height=T+"px",$!==t&&b&&($=t,b.scrollTop=t),r()})));const M=(t,e)=>{const i=[];let s=e.leftGlobal;const o=e.rightGlobal,r=e.timePerPixel;let a=s-n.time.date(s).startOf(t),l=a/r,c=0,u=0;for(;s<o;){const e={sub:a,subPx:l,leftGlobal:s,rightGlobal:n.time.date(s).endOf(t).valueOf(),width:0,leftPx:0,rightPx:0};e.width=(e.rightGlobal-e.leftGlobal+a)/r,u=e.width>u?e.width:u,e.leftPx=c,c+=e.width,e.rightPx=c,i.push(e),s=e.rightGlobal+1,a=0,l=0}e.maxWidth[t]=u,e.dates[t]=i};s(i.subscribeAll(["config.chart.time","_internal.dimensions.width","config.scroll.left","_internal.scrollBarHeight","_internal.list.width","_internal.chart.dimensions"],()=>{const t=i.get("_internal.chart.dimensions.width");let e=n.mergeDeep({},i.get("config.chart.time"));const s=.01*(e=n.time.recalculateFromTo(e)).zoom;let o=i.get("config.scroll.left");if(e.timePerPixel=s+Math.pow(2,e.zoom),e.totalViewDurationMs=n.time.date(e.to).diff(e.from,"milliseconds"),e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,o>e.totalViewDurationPx&&(o=e.totalViewDurationPx-t),e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.leftGlobal+t*e.timePerPixel,e.leftInner=e.leftGlobal-e.from,e.rightInner=e.rightGlobal-e.from,e.leftPx=e.leftInner/e.timePerPixel,e.rightPx=e.rightInner/e.timePerPixel,Math.round(e.rightGlobal/e.timePerPixel)>Math.round(e.to/e.timePerPixel)){const t=(e.rightGlobal-e.to)/(e.rightGlobal-e.from);e.timePerPixel=e.timePerPixel-e.timePerPixel*t,e.leftGlobal=o*e.timePerPixel+e.from,e.rightGlobal=e.to,e.rightInner=e.rightGlobal-e.from,e.totalViewDurationMs=e.to-e.from,e.totalViewDurationPx=e.totalViewDurationMs/e.timePerPixel,e.rightInner=e.rightGlobal-e.from,e.rightPx=e.rightInner/e.timePerPixel,e.leftPx=e.leftInner/e.timePerPixel}M("day",e),M("month",e),i.update("_internal.chart.time",e),r()},{bulk:!0}));const I=document.createElement("canvas"),P=I.getContext("2d");function renderIcon(t){return new Promise(e=>{const n=document.createElement("img");n.setAttribute("src","data:image/svg+xml;base64,"+btoa(t)),n.onload=function(){I.width=n.width,I.height=n.height,P.drawImage(n,0,0),e(I.toDataURL("image/png"))}})}!function renderIcons(){return function __awaiter(t,e,n,i){return new(n||(n=Promise))((function(s,o){function fulfilled(t){try{step(i.next(t))}catch(t){o(t)}}function rejected(t){try{step(i.throw(t))}catch(t){o(t)}}function step(t){t.done?s(t.value):new n((function(e){e(t.value)})).then(fulfilled,rejected)}step((i=i.apply(t,e||[])).next())}))}(this,void 0,void 0,(function*(){const t=i.get("config.list.expander.icons"),e={};for(const n in t){const i=t[n];e[n]=yield renderIcon(i)}i.update("_internal.list.expander.icons",e)}))}(),i.update("_internal.scrollBarHeight",n.getScrollBarHeight());let S=0;const O={handleEvent:t=>{if("scroll"===t.type){const e=t.target.scrollTop,n=t=>{t.top=e,S=t.top;const n=i.get("_internal.elements.vertical-scroll-inner");if(n){const e=n.clientHeight;t.percent.top=t.top/e}return t};S!==e&&i.update("config.scroll",n,{only:["top","percent.top"]})}else{const e=n.normalizeMouseWheelEvent(t),s=i.get("config.scroll.xMultiplier"),o=i.get("config.scroll.yMultiplier");t.shiftKey&&e.y?i.update("config.scroll.left",t=>n.limitScroll("left",t+=e.y*s)):e.x?i.update("config.scroll.left",t=>n.limitScroll("left",t+=e.x*s)):i.update("config.scroll.top",t=>S=n.limitScroll("top",t+=e.y*o))}},passive:!0,capture:!1},A=t=>{t.stopPropagation(),t.stopImmediatePropagation(),t.preventDefault()},E={width:0,height:0};let D;const R=t=>{D||((D=new _t((e,n)=>{const s=t.clientWidth,o=t.clientHeight;E.width===s&&E.height===o||(E.width=s,E.height=o,i.update("_internal.dimensions",E))})).observe(t),i.update("_internal.elements.main",t))};g.includes(R)||g.push(R),s(()=>{D.disconnect()});const L=t=>{b||(b=t,i.update("_internal.elements.vertical-scroll",t))},N=t=>{i.update("_internal.elements.vertical-scroll-inner",t)},z=Object.assign(Object.assign({},e),{api:n,state:i});return n=>m(l`
        <div
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListColumn(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,createComponent:a,reuseComponents:l,html:c,StyleMap:u}=t;let h,d,p;s(i.subscribe("config.wrappers.ListColumn",t=>h=t)),s(i.subscribe("config.components.ListColumnRow",t=>d=t)),s(i.subscribe("config.components.ListColumnHeader",t=>p=t));let f,m=`config.list.columns.data.${e.columnId}`;s(i.subscribe(m,(function columnChanged(t){f=t,r()})));const g=n.getActions("list-column"),v=n.getActions("list-column-rows");let y,b,w;const _=new u({width:"","--width":""}),x=new u({width:"",height:""}),T=new u({width:"",height:""});let C;s(i.subscribe("config.classNames",t=>{y=n.getClass("list-column",{column:f}),b=n.getClass("list-column-rows",{column:f}),r()})),s(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width",`config.list.columns.data.${f.id}.width`,"_internal.chart.dimensions.width","_internal.height","config.scroll.compensation","_internal.list.width"],(function calculateStyle(){const t=i.get("config.list"),e=i.get("config.scroll.compensation");w=t.columns.data[f.id].width*t.columns.percent*.01,C=w;const n=i.get("_internal.height");_.style.width=C+"px",_.style["--width"]=C+"px",x.style.width=C+"px",x.style.height=n+"px",T.style.width=C+"px",T.style.height=n+Math.abs(e)+"px",T.style.transform=`translate(0px, ${e}px)`}),{bulk:!0}));let $=[];s(i.subscribe("_internal.list.visibleRows;",t=>{l($,t,t=>t&&{columnId:e.columnId,rowId:t.id,width:C},d),r()})),s((function rowsDestroy(){$.forEach(t=>t.destroy())}));const M=a(p,{columnId:e.columnId});function getRowHtml(t){return t.html()}s(M.destroy);const I={column:f,state:i,api:n},P={api:n,state:i};return n=>h(c`
        <div class=${y} data-actions=${o(g,I)} style=${_}>
          ${M.html()}
          <div
            class=${b}
            style=${x}
            data-actions=${o(v,P)}
          >
            <div class=${b+"--scroll-compensation"} style=${T}>
              ${$.map(getRowHtml)}
            </div>
          </div>
        </div>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListExpander(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,onChange:c}=t,u=n.getActions("list-expander");let h,d;s(i.subscribe("config.components.ListToggle",t=>d=t));const p=l(d,e.row?{row:e.row}:{});let f;if(s(p.destroy),s(i.subscribe("config.wrappers.ListExpander",t=>f=t)),s(i.subscribe("config.classNames",t=>{h=n.getClass("list-expander"),r()})),e.row){c((function onPropsChange(t){e=t,p.change(e)})),s((function listExpanderDestroy(){}))}const m={row:e.row,api:n,state:i};return n=>f(a`
        <div class=${h} data-action=${o(u,m)}>
          ${p.html()}
        </div>
      `,{vido:t,props:e,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ListToggle(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,cache:c}=t;let u;s(i.subscribe("config.wrappers.ListToggle",t=>u=t));const h=n.getActions("list-expander-toggle");let d,p,f,m,g,v,y,b=!1;if(s(i.subscribe("config.classNames",t=>{d=n.getClass("list-expander-toggle"),p=d+"-child",f=d+"-open",m=d+"-closed",r()})),s(i.subscribe("_internal.list.expander.icons",t=>{t&&(g=t.child,v=t.open,y=t.closed),r()})),e.row){function expandedChange(t){b=t,r()}let t;function onPropsChange(n){e=n,t&&t(),t=i.subscribe(`config.list.rows.${e.row.id}.expanded`,expandedChange)}l(onPropsChange),s((function listToggleDestroy(){t&&t()}))}else{function expandedChange(t){for(const e of t)if(e.value){b=!0;break}r()}s(i.subscribe("config.list.rows.*.expanded",expandedChange,{bulk:!0}))}function toggle(){b=!b,e.row?i.update(`config.list.rows.${e.row.id}.expanded`,b):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=b;return t},{only:["*.expanded"]})}const w={row:e.row,api:n,state:i};return n=>u(a`
        <div class=${d} data-action=${o(h,w)} @click=${toggle}>
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function ChartTimeline(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,createComponent:l,StyleMap:c}=t,u=n.getActions("chart-timeline"),h=Object.assign(Object.assign({},e),{api:n,state:i});let d;s(i.subscribe("config.wrappers.ChartTimeline",t=>d=t));const p=i.get("config.components.ChartTimelineGrid"),f=i.get("config.components.ChartTimelineItems"),m=l(p);s(m.destroy);const g=l(f);let v,y;s(g.destroy),s(i.subscribe("config.classNames",()=>{v=n.getClass("chart-timeline"),y=n.getClass("chart-timeline-inner"),r()}));let b=new c({}),w=new c({});return s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","_internal.list.rowsHeight","config.scroll.compensation"],(function calculateStyle(){const t=i.get("config.scroll.compensation"),e=i.get("_internal.chart.dimensions.width"),n=i.get("_internal.list.rowsHeight");b.style.height=i.get("_internal.height")+"px",e&&(b.style.width=e+"px"),w.style.height=n+"px",e&&(w.style.width=e+"px"),w.style.transform=`translate(0px, ${t}px)`,r()}))),u.push(t=>{i.update("_internal.elements.chart-timeline",t)}),i=>d(a`
        <div
          class=${v}
          style=${b}
          data-actions=${o(u,h)}
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */function bindElementAction(t,e){return e.state.update("_internal.elements.chart-timeline-grid-rows",(function updateGridRows(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-grid-rows",e=>e.filter(e=>e!==t))}}}function ChartTimelineGridRow(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l,onChange:c,StyleMap:u}=t,h=Object.assign(Object.assign({},e),{api:n,state:i});let d;s(i.subscribe("config.wrappers.ChartTimelineGridRow",t=>{d=t,r()}));const p=i.get("config.components.ChartTimelineGridRowBlock"),f=n.getActions("chart-timeline-grid-row");let m=n.getClass("chart-timeline-grid-row"),g=new u({width:e.width+"px",height:e.row.height+"px",opacity:"1",pointerEvents:"all",overflow:"hidden"}),v=[];return c((t,n)=>{var s,o,a,c,u,d,f;if(n.leave)return g.style.opacity="0",g.style.pointerEvents="none",void r();l(v,(e=t).blocks,t=>t,p),g.style={},g.style.opacity="1",g.style.pointerEvents="all",g.style.height=e.row.height+"px",g.style.width=e.width+"px";const m=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(a=null===(o=null===(s=m[t].style)||void 0===s?void 0:s.grid)||void 0===o?void 0:o.row)||void 0===a?void 0:a.children;e&&(g.style=Object.assign(Object.assign({},g.style),e))}const y=null===(f=null===(d=null===(u=null===(c=e.row)||void 0===c?void 0:c.style)||void 0===u?void 0:u.grid)||void 0===d?void 0:d.row)||void 0===f?void 0:f.current;y&&(g.style=Object.assign(Object.assign({},g.style),y));for(const t in e)h[t]=e[t];r()}),s(()=>{v.forEach(t=>t.destroy())}),-1===f.indexOf(bindElementAction)&&f.push(bindElementAction),n=>d(a`
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const xt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),t=>{e.state.update("_internal.elements.chart-timeline-grid-row-blocks",e=>e.filter(e=>e!==t),{only:[""]})}),Tt=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,StyleMap:c}=t,u="chart-timeline-grid-row-block";let h=Object.assign(Object.assign({},e),{api:n,state:i});const d=n.getActions(u);let p;s(i.subscribe("config.wrappers.ChartTimelineGridRowBlock",t=>{p=t,r()}));const f=n.time.date().startOf("day").valueOf();let m,g;function updateClassName(t){m=n.getClass(u),g=m+"-content",t.leftGlobal===f&&(m+=" current")}updateClassName(e.time);let v=new c({width:"",height:""});return l((function onPropsChange(t,s){var o,a,l,c,u,d,p;if(s.leave)return r();e=t,h=Object.assign(Object.assign({},e),{api:n,state:i}),updateClassName(e.time),v.style={},v.style.width=e.time.width+"px",v.style.height=e.row.height+"px";const f=i.get("config.list.rows");for(const t of e.row._internal.parents){const e=null===(l=null===(a=null===(o=f[t].style)||void 0===o?void 0:o.grid)||void 0===a?void 0:a.block)||void 0===l?void 0:l.children;e&&(v.style=Object.assign(Object.assign({},v.style),e))}const m=null===(p=null===(d=null===(u=null===(c=e.row)||void 0===c?void 0:c.style)||void 0===u?void 0:u.grid)||void 0===d?void 0:d.block)||void 0===p?void 0:p.current;m&&(v.style=Object.assign(Object.assign({},v.style),m)),r()})),-1===d.indexOf(xt)&&d.push(xt),n=>p(a`
        <div class=${m} data-actions=${o(d,h)} style=${v}>
          <div class=${g} />
        </div>
      `,{props:e,vido:t,templateProps:n})};
/**
 ...
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */
function ChartTimelineItems(t,e={}){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,reuseComponents:l,StyleMap:c}=t,u=n.getActions("chart-timeline-items");let h;s(i.subscribe("config.wrappers.ChartTimelineItems",t=>h=t));const d=i.get("config.components.ChartTimelineItemsRow");let p;s(i.subscribe("config.classNames",()=>{p=n.getClass("chart-timeline-items"),r()}));let f=new c({});s(i.subscribeAll(["_internal.height","_internal.chart.dimensions.width","config.scroll.compensation"],()=>{const t=i.get("_internal.chart.dimensions.width"),e=i.get("_internal.height"),n=i.get("config.scroll.compensation");f.style.width=t+"px",f.style.height=e+Math.abs(n)+"px"}));let m=[];s(i.subscribeAll(["_internal.list.visibleRows","config.chart.items","config.list.rows"],()=>{const t=i.get("_internal.list.visibleRows");m=l(m,t,t=>({row:t}),d),r()},{bulk:!0})),s((function destroyRows(){m.forEach(t=>t.destroy())}));const g={api:n,state:i};return n=>h(a`
        <div class=${p} style=${f} data-actions=${o(u,g)}>
          ${m.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:n})}
/**
 ...
 * @license   GPL-3.0 (https://github.com/neuronetio/gantt-schedule-timeline-calendar/blob/master/LICENSE)
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 */const Ct=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-rows",e=>(void 0===e&&(e=[]),e.push(t),e),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}),$t=(t,e)=>{const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,reuseComponents:c,StyleMap:u}=t,h=Object.assign(Object.assign({},e),{api:n,state:i});let d;s(i.subscribe("config.wrappers.ChartTimelineItemsRow",t=>d=t));const p=i.get("config.components.ChartTimelineItemsRowItem");let f,m,g=`_internal.flatTreeMapById.${e.row.id}._internal.items`,v=new u({opacity:"1",pointerEvents:"auto",width:"",height:""}),y=[];const b=()=>{const t=i.get("_internal.chart");if(v.style.opacity="1",v.style.pointerEvents="auto",v.style.width=t.dimensions.width+"px",!e)return v.style.opacity="0",void(v.style.pointerEvents="none");v.style.height=e.row.height+"px",v.style["--row-height"]=e.row.height+"px"};l((t,n)=>{if(n.leave)return b(),r();e=t;for(const t in e)h[t]=e[t];(t=>{g=`_internal.flatTreeMapById.${t.id}._internal.items`,"function"==typeof f&&f(),"function"==typeof m&&m(),f=i.subscribe("_internal.chart",(t,e)=>{b(),r()}),m=i.subscribe(g,e=>{y=c(y,e,e=>({row:t,item:e}),p),b(),r()})})(e.row)}),s(()=>{m(),f(),y.forEach(t=>t.destroy())});const w=n.getActions("chart-timeline-items-row");let _;return s(i.subscribe("config.classNames",()=>{_=n.getClass("chart-timeline-items-row",e),r()})),w.includes(Ct)||w.push(Ct),n=>d(a`
        <div class=${_} data-actions=${o(w,h)} style=${v}>
          ${y.map(t=>t.html())}
        </div>
      `,{props:e,vido:t,templateProps:n})},Mt=(t,e)=>(e.state.update("_internal.elements.chart-timeline-items-row-items",(function updateRowItems(e){return void 0===e&&(e=[]),e.push(t),e}),{only:null}),{update(){},destroy(t){e.state.update("_internal.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}});function ChartTimelineItemsRowItem(t,e){const{api:n,state:i,onDestroy:s,actions:o,update:r,html:a,onChange:l,unsafeHTML:c,StyleMap:u}=t;let h;s(i.subscribe("config.wrappers.ChartTimelineItemsRowItem",t=>h=t));let d=new u({width:"",height:"",left:"",opacity:"1",pointerEvents:"auto"}),p=new u({width:"",height:""}),f=0,m=0,g=!1;const v={item:e.item,row:e.row,left:f,width:m,api:n,state:i};function updateItem(){var t,s,o,a,l,c,u,h;if(g)return;let v=i.get("_internal.chart.time");f=(e.item.time.start-v.leftGlobal)/v.timePerPixel,f=.1*Math.round(10*f),m=(e.item.time.end-e.item.time.start)/v.timePerPixel,(m-=i.get("config.chart.spacing")||0)&&(m=.1*Math.round(10*m));const y=d.style.width,b=d.style.height,w=d.style.left;d.style={};const _=n.isItemInViewport(e.item,v.leftGlobal,v.rightGlobal);d.style.opacity=_?"1":"0",d.style.pointerEvents=_?"auto":"none",_?(d.style.width=m+"px",d.style.height=e.row.height+"px",d.style.left=f+"px"):(d.style.width=y,d.style.height=b,d.style.left=w),p.style={width:m+"px","max-height":e.row.height+"px"};const x=i.get("config.list.rows");for(const n of e.row._internal.parents){const e=null===(o=null===(s=null===(t=x[n].style)||void 0===t?void 0:t.items)||void 0===s?void 0:s.item)||void 0===o?void 0:o.children;e&&(p.style=Object.assign(Object.assign({},p.style),e))}const T=null===(u=null===(c=null===(l=null===(a=e.row)||void 0===a?void 0:a.style)||void 0===l?void 0:l.items)||void 0===c?void 0:c.item)||void 0===u?void 0:u.current;T&&(p.style=Object.assign(Object.assign({},p),T));const C=null===(h=e.item)||void 0===h?void 0:h.style;C&&(p.style=Object.assign(Object.assign({},p.style),C)),r()}l((function onPropsChange(t,n){if(n.leave)return g=!0,d.style.opacity="0",d.style.pointerEvents="none",r();g=!1,e=t,v.item=e.item,v.row=e.row,v.left=f,v.width=m,updateItem()}));const y="chart-timeline-items-row-item",b=n.getActions(y);let w,_,x;return s(i.subscribe("config.classNames",()=>{w=n.getClass(y,e),_=n.getClass(y+"-content",e),x=n.getClass(y+"-content-label",e),r()})),s(i.subscribe("_internal.chart.time",t=>{updateItem()})),-1===b.indexOf(Mt)&&b.push(Mt),n=>h(a`
        <div class=${w} data-actions=${o(b,v)} style=${d}>
          <div class=${_} style=${p}>
            <div class=${x}>
 ...
 * @license   GPL-3.0
 */
const Dt="gantt-schedule-timeline-calendar";function isObject$1(t){return t&&"object"==typeof t&&!Array.isArray(t)}function mergeDeep$1(t,...e){const n=e.shift();if(isObject$1(t)&&isObject$1(n))for(const e in n)if(isObject$1(n[e]))void 0===t[e]&&(t[e]={}),t[e]=mergeDeep$1(t[e],n[e]);else if(Array.isArray(n[e])){t[e]=[];for(let i of n[e])isObject$1(i)?t[e].push(mergeDeep$1({},i)):t[e].push(i)}else t[e]=n[e];return e.length?mergeDeep$1(t,...e):t}const Rt={name:Dt,stateFromConfig:function stateFromConfig(t){const e=defaultConfig(),n=function mergeActions(t,e){const n=mergeDeep$1({},e.actions),i=mergeDeep$1({},t.actions);let s=[...Object.keys(n),...Object.keys(i)];s=s.filter(t=>s.includes(t));const o={};for(const t of s)o[t]=[],void 0!==n[t]&&Array.isArray(n[t])&&(o[t]=[...n[t]]),void 0!==i[t]&&Array.isArray(i[t])&&(o[t]=[...o[t],...i[t]]);return delete t.actions,delete e.actions,o}(t,e),i={config:mergeDeep$1({},e,t)};return i.config.actions=n,new DeepState(i,{delimeter:"."})},mergeDeep:mergeDeep$1,Hammer:Pt,date:t=>t?St(t):St(),dayjs:St};
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright Rafal Pospiech <https://neuronet.io>
