 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */);class H{handleAttributeExpressions(t,e,n,i){const o=e[0];return"."===o?new A(t,e.slice(1),n).parts:"@"===o?[new N(t,e.slice(1),i.eventContext)]:"?"===o?[new R(t,e.slice(1),n)]:new C(t,e,n).parts}handleTextExpression(t){return new E(t)}}const Y=new H;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
