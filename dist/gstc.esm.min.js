import{d as t,u as e,a as o,S as i,A as a,h as s,l as n,v as l,D as r,_ as c,m as d,b as h,c as u,p as m,P as f,e as g,f as p,g as w,V as b}from"./vendor.esm.min.js";
/**
 ...
 */function M(t,e){const{onDestroy:o,state:i,cache:s,api:n,html:l,StyleMap:r,Actions:c,update:d}=t,h="scroll-bar";let u,m,f="",g="";o(i.subscribe("config.classNames",()=>{u=n.getClass(h),m=n.getClass(h+"-inner")}));const p="horizontal"===e.type?"height":"width",w="height"===p?"width":"height",b="horizontal"===e.type?"left":"top",v=new r({}),y=new r({}),D={maxPosPx:0,innerHandleSize:0,scrollSize:0,dataId:""};o(i.subscribeAll("horizontal"===e.type?[`config.scroll.${e.type}`,`$data.scroll.${e.type}`]:[`config.scroll.${e.type}`,`$data.scroll.${e.type}`,"$data.chart.dimensions.heightWithoutScrollBar","$data.list.rowsWithParentsExpanded","$data.list.rowsHeight","config.additionalSpace"],function(t,o){const a=i.get(`config.scroll.${e.type}`),s=i.get(`$data.scroll.${e.type}`),l=n.getScrollSize(e.type),r=s.innerHandleSize,c=s.maxHandlePosPx,h=s.dataId,u=i.get("config.additionalSpace"),m=i.get("$data.chart.time");if(!m.allDates||!m.allDates.length||!m.allDates[m.level])return;if(s.visible?v.style.display="flex":v.style.display="none",v.style[p]=a.width+"px",v.style[w]=l+"px","vertical"===e.type&&(v.style.top=i.get("config.headerHeight")+u.top+"px"),!s.lastPageSize||!s.absoluteSize||!l)return;y.style[p]="100%",y.style[w]=r+"px";!("set-scroll-top"===o.options.data||"set-scroll-left"===o.options.data)&&function(t,e,o,i){const a=D.maxPosPx!==t||D.innerHandleSize!==e||D.scrollSize!==o||D.dataId!==i;return a&&(D.maxPosPx=t,D.innerHandleSize=e,D.scrollSize=o,D.dataId=i),a}(c,r,l,h)&&("horizontal"===e.type?a.byPixels?n.setScrollLeft(s.absolutePosPx):n.setScrollLeft(s.dataIndex,s.preciseOffset):a.byPixels?n.setScrollTop(s.absolutePosPx):n.setScrollTop(s.dataIndex,s.preciseOffset)),d()},{group:!0,bulkValue:!1}));const x=n.getActions(h);x.push(class extends a{constructor(t){super();const o=`$data.elements.scroll-bar--${e.type}`;i.get(o)||i.update(o,t,{only:null})}update(){}destroy(){}});const P={api:n,state:i,props:e,componentName:h},W=c.create(x,P),C=[class extends a{constructor(t){super(),this.moving=!1,this.initialPointerPos=0,this.initialHandlePos=0,this.currentPos=0,this.currentPointerPos=0,this.lastDataIndex=0,this.lastOffset=0,this.dataIndex=0,this.previousRowId="",i.update(`$data.elements.scroll-bar-inner--${e.type}`,t,{only:null}),this.bodyClassName=i.get("config.scroll.bodyClassName"),this.pointerDown=this.pointerDown.bind(this),this.pointerUp=this.pointerUp.bind(this);const o=this.pointerMove.bind(this);this.pointerMove=o,this.unsubscribe=i.subscribe(`$data.scroll.${e.type}`,this.dataChanged.bind(this)),this.destroy=this.destroy.bind(this),t.addEventListener("pointerdown",this.pointerDown),document.addEventListener("pointermove",this.pointerMove),document.addEventListener("pointerup",this.pointerUp)}destroy(t){this.unsubscribe(),t.removeEventListener("pointerdown",this.pointerDown),document.removeEventListener("pointermove",this.pointerMove),document.removeEventListener("pointerup",this.pointerUp)}dataChanged(){const t=i.get(`$data.scroll.${e.type}`),o=i.get("$data.chart.time");if(!o.allDates.length)return;const a=o.allDates[o.level],s=t.dataIndex;if(this.lastDataIndex=s,"horizontal"===e.type&&a&&a.length)this.currentPos=t.handlePosPx,y.style[b]=this.currentPos+"px",d();else if("vertical"===e.type){if(!i.get("$data.list.rowsWithParentsExpanded").length)return;this.currentPos=t.handlePosPx,y.style[b]=this.currentPos+"px",d()}}limitPosition(t){return Math.max(Math.min(t,i.get(`$data.scroll.${e.type}.maxHandlePosPx`)),0)}pointerDown(t){t.stopPropagation(),t.preventDefault(),n.muteMethod("calculateRowsHeight"),document.body.classList.add(this.bodyClassName),requestAnimationFrame(()=>{this.moving=!0,this.initialPointerPos="horizontal"===e.type?t.pageX:t.pageY,this.initialHandlePos=i.get(`$data.scroll.${e.type}.handlePosPx`),g=" "+n.getClass(h)+"-inner--active",f=" "+n.getClass(h)+"--active",d()})}pointerUp(t){this.moving&&(n.unmuteMethod("calculateRowsHeight"),t.preventDefault(),t.stopPropagation(),document.body.classList.remove(this.bodyClassName)),this.moving=!1,g="",f="",d()}pointerMoveRead(t){this.currentPointerPos="horizontal"===e.type?t.pageX:t.pageY}pointerMoveWrite(){const t=i.get(`config.scroll.${e.type}`),o=i.get(`$data.scroll.${e.type}`),a=this.currentPointerPos-this.initialPointerPos;this.currentPos=this.limitPosition(this.initialHandlePos+a);const s=i.get("$data.chart.time");if(!s.allDates.length)return;const l=s.allDates[s.level],r=this.currentPos/o.maxHandlePosPx*o.absoluteSizeWithoutLastPage,c=Math.round(r);if("horizontal"===e.type){let e,o=0,i=0,a=0;for(let t=l.length;o<t&&(e=l[o],a=Math.round(e.rightPx),!(a>c));o++);t.precise&&a!==c&&(i=e.leftPx-r),o||(o=0),e||(e=l[0]),this.dataIndex=o,this.lastDate=l[o],t.byPixels?n.setScrollLeft(r):n.setScrollLeft(e.id,i),this.lastDataIndex=o,this.lastOffset=i}else{const{dataIndex:e,row:o,rowData:i}=n.getRowInfoFromTop(r);let a=0;t.precise&&i.position.top!==r&&(a=i.position.top-r),this.dataIndex=e,this.previousRowId=o.id,t.byPixels?n.setScrollTop(r):n.setScrollTop(e,a),this.lastDataIndex=e,this.lastOffset=a}}pointerMove(t){this.moving&&(t.stopPropagation(),t.preventDefault(),requestAnimationFrame(()=>{this.pointerMoveRead(t)}),requestAnimationFrame(()=>{this.pointerMoveWrite()}))}}],$=c.create(C,P),I=n.generateSlots(h,t,e);function S({classNameOuter:t,classNameOuterActive:e,classNameInner:o,classNameInnerActive:i,styleMapInner:a,styleMapOuter:s,innerActions:n,outerActions:l,slots:r,cache:c,html:d,vido:h,props:u}){return!u||!u.type?null:r.html("outer",d`
          ...
          `)}let G=S;return o(i.subscribe(`config.templates.${h}`,t=>{G=null!=t?t:S,d()})),()=>G({innerActions:$,outerActions:W,classNameOuter:u,classNameOuterActive:f,classNameInner:m,classNameInnerActive:g,cache:s,styleMapInner:y,styleMapOuter:v,slots:I,html:l,vido:t,props:e})}
/**
 * List component
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 * @released  2026-04-23
 * @license   SEE LICENSE IN LICENSE FILE
 */class L{constructor(t,e){let o=!1,i=e.state.get("$data.elements.list-columns");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.list-columns",i,{only:null})}destroy(t,e){e.state.update("$data.elements.list-columns",e=>e.filter(e=>e!==t),{only:null})}}function O(t,e){const{api:o,state:i,onDestroy:a,onChange:s,cache:n,Actions:l,update:r,createComponent:c,reuseComponents:d,html:h,StyleMap:u}=t,m=[];let f,g;m.push(i.subscribe("config.components.ListColumnRow",t=>f=t)),m.push(i.subscribe("config.components.ListColumnHeader",t=>g=t));const p=Object.assign(Object.assign({},e),{api:o,state:i,componentName:"list-column"}),w={column:e.column,state:i,api:o,componentName:"list-column-headers"},b={api:o,state:i,componentName:"list-column-rows"},v="list-column",y=v+"-rows",D=v+"-rows-offset",x=o.getActions(v),P=o.getActions(y),W=o.getClass(v,e.column.id),C=o.getClass(D,e.column.id),$=o.getClass(y,e.column.id);let I,S=o.getId(v,e&&e.column?e.column.id:"");const G=new u({width:"","--width":""}),M=new u({height:""}),z=new u({"margin-top":"0px"});let O=i.get("config.additionalSpace");const R=o.generateSlots(v,t,e);let T;function k(){if(!e||!e.column)return;const t=i.get("config.list");if(!t.columns.data[e.column.id])return;I=t.columns.data[e.column.id].width*t.columns.percent*.01,T=I;const a=Math.round(o.getRealChartHeight());G.style.width=T+"px",G.style["--width"]=T+"px",z.style.height=a+"px",M.style.top=i.get("config.headerHeight")+O.top+"px"}a(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar","$data.list.width","$data.list.visibleRowsHeight","config.additionalSpace.top"],k,{group:!0}));const A=c(g,e);a(A.destroy);const _=[],H={};function N(){var t;if(!e||!e.column)return;i.mute(N);const a=i.get("$data.list.visibleRows")||[],s=o.getRows(a),n=o.getRowsData();for(const o of s){const i=H[o.id]=null!==(t=H[o.id])&&void 0!==t?t:{};i.column=e.column,i.row=o,i.rowData=n[o.id],i.width=T}for(const t in H)a.includes(t)||delete H[t];d(_,s,t=>t&&H[t.id],f,!0),R.change(e),i.unmute(N)}s(t=>{if((e=t)&&e.column&&e.column.id){S=o.getId(v,e&&e.column?e.column.id:"");for(const t in e)p[t]=e[t];k(),A.change(e),N()}}),a(i.subscribeAll(["$data.list.visibleRows","$data.list.visibleRowsHeight","$data.list.rows","config.list.rows","config.chart.items.*.height","config.chart.items.*.rowId","config.chart.items.*.time"],N,{group:!0,bulkValue:!1})),a(i.subscribe("$data.scroll.vertical.preciseOffset",t=>{z.style.transform=`translateY(${Math.round(t)||0}px)`,r()})),a(i.subscribe("config.additionalSpace",t=>{O=t})),a(()=>{_.forEach(t=>t.destroy()),m.forEach(t=>t())}),x.push(L);const V=l.create(x,w),B=l.create(P,b);function E({className:t,classNameOffset:e,classNameContainer:o,containerStyleMap:i,offsetStyleMap:a,widthStyleMap:s,visibleRows:n,rowActions:l,elId:r,headerActions:c,ListColumnHeader:d,html:h,cache:u,vido:m,props:f}){return f&&f.column?R.html("outer",h`
            <div
              class=${t}
      ...
      `)} `)}
          ...
          `):null}let j=E;return a(i.subscribe(`config.templates.${v}`,t=>{j=null!=t?t:E,r()})),()=>j({classNameOffset:C,offsetStyleMap:z,visibleRows:_,classNameContainer:$,containerStyleMap:M,rowActions:B,className:W,elId:S,headerActions:V,widthStyleMap:G,ListColumnHeader:A,html:h,cache:n,vido:t,props:e})}
/**
 ...
 */function R(t,e){const{api:o,state:i,onDestroy:a,cache:s,onChange:n,Actions:l,update:r,createComponent:c,html:d,StyleMap:h}=t,u="list-column-header",m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:u}),f=o.getActions(u),g=[];let p;g.push(i.subscribe("config.components.ListColumnHeaderResizer",t=>p=t));const w=c(p,e);let b;g.push(i.subscribe("config.components.ListColumnRowExpander",t=>b=t));const v=c(b,e);a(()=>{w.destroy(),v.destroy(),g.forEach(t=>t())});const y=o.generateSlots(u,t,e),D=o.getClass(u),x=o.getClass(u+"-content");let P=o.getId(u,e.column.id);n(t=>{e=t;for(const t in e)m[t]=e[t];P=o.getId(u,e.column.id),w.change(e),v.change(e),y.change(t)});const W=new h({height:"","--height":"","--paddings-count":""});a(i.subscribe("config.headerHeight",()=>{const t=i.get("config");W.style.height=t.headerHeight+"px",W.style["--height"]=t.headerHeight+"px",W.style["--paddings-count"]="1",r()}));const C=l.create(f,m);function $({className:t,contentClass:e,styleMap:o,elId:i,cache:a,ListColumnRowExpander:s,ListColumnHeaderResizer:n,actions:l,slots:r,html:c,vido:d,props:h}){return!h||!h.column?null:r.html("outer",c`
      ...
      `:c` <div class=${e}>${n.html(h.column)}</div> `)}
          ...
          `)}let I=$;return a(i.subscribe(`config.templates.${u}`,t=>{I=null!=t?t:$,r()})),()=>I({className:D,contentClass:x,cache:s,styleMap:W,elId:P,ListColumnRowExpander:v,ListColumnHeaderResizer:w,actions:C,slots:y,html:d,vido:t,props:e})}
/**
 ...
 * @released  2026-04-23
 * @license   SEE LICENSE IN LICENSE FILE
 */function T(t,e){const{api:o,state:i,onDestroy:a,cache:s,update:n,html:l,Actions:r,onChange:c,PointerAction:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-header-resizer",f=o.getActions(m),g=o.getActions(m+"-dots"),p={up:"",down:""};let w,b,v,y;a(i.subscribe("config.list.sort.icons",t=>{p.up=o.getSVGIconSrc(t.up),p.down=o.getSVGIconSrc(t.down)})),w=o.getClass(m),b=o.getClass(m+"-container"),v=o.getClass(m+"-dots"),y=o.getClass(m+"-dots-dot");const D=o.getClass(m+"-sort-icon");let x;const P=new h({});let W=!1;const C=o.generateSlots(m,t,e);let $=!0,I=0;const S={componentName:m,column:e.column,api:o,state:i,pointerOptions:{axis:"x",onMove:function({movementX:t,event:o}){if(!$)return;t&&(o.preventDefault(),o.stopPropagation());let a=i.get("config.list.columns.minWidth");"number"==typeof e.column.minWidth&&(a=e.column.minWidth),I+=t,I<a&&(I=a),W&&i.update(`config.list.columns.data.${e.column.id}.width`,I)}}};function G(){if(!e||!e.column||!e.column.id)return;S.column=e.column,w=o.getClass(m,e.column.id),b=o.getClass(m+"-container",e.column.id),v=o.getClass(m+"-dots",e.column.id),y=o.getClass(m+"-dots-dot",e.column.id),$=!("resizer"in e.column)||e.column.resizer;const t=i.get("config.list");x=I=e.column.width*t.columns.percent*.01,P.style["--width"]=t.columns.resizer.width+"px",W=t.columns.resizer.inRealTime,i.update("$data.list.width",x),C.change(e),n()}c(t=>{e=t,G()}),a(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],G,{group:!0}));let M=[1,2,3,4,5,6,7,8];a(i.subscribe("config.list.columns.resizer.dots",t=>{M=[];for(let e=0;e<t;e++)M.push(e);n()}));let z=!0;function L(){e.column.sortable&&(z=!z,i.update("config.list.sort",t=>(t.activeColumnId=e.column.id,t.asc=z,t)))}let O=!1;a(i.subscribe("config.list.sort",t=>{if(t.activeColumnId===e.column.id)return z=t.asc,void(O=!0);O=!1})),g.push(d);const R=r.create(f,S),T=r.create(g,S);function k({className:t,containerClass:e,iconClass:o,dotsClass:i,dotClass:a,dotsStyleMap:s,dots:n,onLabelClick:l,dotsActions:r,resizer:c,icons:d,sortActive:h,cache:u,asc:m,actions:f,slots:g,html:p,unsafeHTML:w,vido:b,props:v}){const y=!v||!v.column;function D(){return v.column.sortable&&h?m?p` <img src="${d.down}" class=${o} /> `:p` <img src="${d.up}" class=${o} /> `:null}function x(){return y?null:"function"==typeof v.column.header.content?v.column.header.content({column:v.column,vido:b}):v.column.header.content}return y?null:g.html("outer",p`
      ...
      `)}
          ...
          `)}let A=k;return a(i.subscribe(`config.templates.${m}`,t=>{A=null!=t?t:k,n()})),()=>A({className:w,containerClass:b,onLabelClick:L,iconClass:D,cache:s,dotsClass:v,dotsStyleMap:P,dotsActions:T,dots:M,dotClass:y,resizer:$,icons:p,sortActive:O,asc:z,actions:R,slots:C,html:l,unsafeHTML:u,vido:t,props:e})}
/**
 ...
 * @released  2026-04-23
 * @license   SEE LICENSE IN LICENSE FILE
 */class k{constructor(t,e){let o=e.state.get("$data.elements.list-column-rows"),i=!1;void 0===o&&(i=!0,o=[]),o.includes(t)||(o.push(t),i=!0),i&&e.state.update("$data.elements.list-column-rows",o,{only:null})}destroy(t,e){e.state.update("$data.elements.list-column-rows",e=>e.filter(e=>e!==t),{only:null})}}function A(t,e){const{api:o,state:i,onDestroy:a,cache:s,Actions:n,update:l,html:r,createComponent:c,onChange:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-row",f=Object.assign(Object.assign({},e),{api:o,state:i,componentName:m});let g,p=!1;a(i.subscribe("config.components.ListColumnRowExpander",t=>g=t));const w=new h(e.column.expander?{height:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{height:"",top:"","--height":""}),b=c(g,{row:e.row}),v=o.getClass(m),y=o.getClass(m+"-content");let D=o.getClass(m);const x=o.generateSlots(m,t,e);let P;d(function(a,s){var n;if(s.leave||!a||void 0===a.row||void 0===a.column)return p=!0,x.change(a,s),void l();p=!1,e=a;for(const t in e)f[t]=e[t];if(!e.column||!e.row||!e.rowData)return p=!0,x.change(a,s),void l();if(void 0===e.column||void 0===e.row)return;P=e.column.isHTML?void 0===e.row?null:"function"==typeof e.column.data?u(e.column.data({row:e.row,vido:t})):"function"==typeof e.row[e.column.data]?u(e.row[e.column.data]({row:e.row,vido:t})):"string"==typeof e.row[e.column.data]?u(e.row[e.column.data]):null:void 0===e.row?null:"function"==typeof e.column.data?e.column.data({row:e.row,vido:t}):"function"==typeof e.row[e.column.data]?e.row[e.column.data]({row:e.row,vido:t}):e.row[e.column.data];const r=i.get("config.list.expander");for(const t in w.style)delete w.style[t];w.style.height=e.rowData.outerHeight+"px",w.style["--height"]=e.rowData.outerHeight+"px",e.column.expander&&(w.style["--expander-padding-width"]=r.padding*(e.rowData.parents.length+1)+"px");const c=i.get("config.list.rows");for(const t of e.rowData.parents){const e=c[t];if("object"==typeof e.style&&"object"==typeof e.style.children){const t=e.style.children;for(const e in t)w.style[e]=t[e]}}if(null===(n=null==e?void 0:e.row)||void 0===n?void 0:n.style)for(const t in e.row.style)w.style[t]=e.row.style[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)D=o.getClass(m)+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const i=e.row.classNames({row:e.row,vido:t});Array.isArray(i)&&i.length&&(D=o.getClass(m)+" "+i.join(" "))}}else D=v;b&&b.change(e),x.change(e,s),l()}),a(()=>{b&&b.destroy()});const W=o.getActions(m);W.includes(k)||W.push(k);const C=n.create(W,f);function $({classNameCurrent:t,classNameContent:e,styleMap:o,cache:i,shouldDetach:a,content:s,ListColumnRowExpander:n,slots:l,actions:r,html:c,vido:d,props:h}){return a||!h||!h.column||!h.row?null:l.html("outer",c`
            <div
              class=${t}
          ...
          `)}let I=$;return a(i.subscribe(`config.templates.${m}`,t=>{I=null!=t?t:$,l()})),()=>I({classNameCurrent:D,cache:s,shouldDetach:p,styleMap:w,ListColumnRowExpander:b,classNameContent:y,slots:x,actions:C,content:P,html:r,vido:t,props:e})}
/**
 ...
 * @released  2026-04-23
 * @license   SEE LICENSE IN LICENSE FILE
 */function H(t,e){const{api:o,state:i,cache:a,onDestroy:s,Actions:n,update:l,html:r,onChange:c}=t,d="list-column-row-expander-toggle",h=Object.assign(Object.assign({},e),{api:o,state:i,componentName:d}),u=o.getActions(d),m=o.getClass(d),f=o.getClass(d+"-child"),g=o.getClass(d+"-open"),p=o.getClass(d+"-closed");let w,b,v,y=!1;s(i.subscribe("$data.list.expander.icons",t=>{t&&(w=t.child,b=t.open,v=t.closed),l()}));const D=o.generateSlots(d,t,e);e.row?(c(function(t){if(e&&e.row){e=t;for(const t in e)h[t]=e[t];y=e.row.expanded,D.change(t),l()}}),s(function(){})):s(i.subscribe("config.list.rows.*.expanded",function(t){for(const e of t)if(e.value){y=!0;break}l()},{bulk:!0}));const x=n.create(u,h);function P(){y=!y,e.row?i.update(`config.list.rows.${e.row.id}.expanded`,y,{data:{name:"expanded",rowId:e.row.id,expanded:y}}):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=y;return t},{only:["*.expanded"],data:{name:"expanded"}})}function W({className:t,classNameChild:e,classNameOpen:o,classNameClosed:i,expanded:a,iconChild:s,iconOpen:n,iconClosed:l,toggle:r,cache:c,slots:d,actions:h,html:u,vido:m,props:f}){return!f?null:d.html("outer",u`
            <div
              class=${t}
          ...
          `);var g,p}let C=W;return s(i.subscribe(`config.templates.${d}`,t=>{C=null!=t?t:W,l()})),()=>C({className:m,classNameChild:f,iconChild:w,expanded:y,cache:a,classNameOpen:g,classNameClosed:p,iconOpen:b,iconClosed:v,toggle:P,slots:D,actions:x,html:r,vido:t,props:e})}
/**
 ...
 */function N(t,e={}){const{html:o,onDestroy:i,api:a,state:s,update:n,StyleMap:l,Actions:r,onChange:c}=t,d="list-toggle",h=a.getClass(d),u=Object.assign(Object.assign({},e),{api:a,state:s,componentName:d});let m={open:"",close:""};i(s.subscribe("$data.list.toggle.icons",t=>{t&&(m=t,n())}));const f=new l({top:"0px"});i(s.subscribe("$data.scroll.vertical.preciseOffset",t=>{f.style.top=(-1*Math.round(t)||0)+"px"}));let g=!0;i(s.subscribe("config.list.columns.percent",t=>g=0!==t));let p=!1;function w(){p=!0}function b(){p&&(p=!1,s.update("config.list.columns.percent",t=>0===t?100:0))}c(t=>{e=t;for(const o in t)u[o]=e[o]});const v=a.getActions(d),y=r.create(v,u),D=a.generateSlots(d,t,e);function x({className:t,styleMap:e,pointerDown:o,pointerUp:i,open:a,toggleIconsSrc:s,actions:n,slots:l,html:r,vido:c,props:d}){return l.html("outer",r`
      ...
      `)}let P=x;return i(s.subscribe(`config.templates.${d}`,t=>{P=null!=t?t:x,n()})),()=>P({className:h,styleMap:f,pointerDown:w,pointerUp:b,open:g,toggleIconsSrc:m,actions:y,slots:D,html:o,vido:t,props:e})}
/**
 * Chart component
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 * @released  2026-04-23
 * @license   SEE LICENSE IN LICENSE FILE
 */function V(t,e={}){const{api:o,state:i,onDestroy:a,Actions:s,html:n,createComponent:l,update:r}=t,c="chart",d=[];let h,u,m;d.push(i.subscribe("config.components.ChartCalendar",t=>h=t)),d.push(i.subscribe("config.components.ChartTimeline",t=>u=t)),d.push(i.subscribe("config.components.ScrollBar",t=>m=t));const f=l(h);a(f.destroy);const g=l(u);a(g.destroy);const p=l(m,{type:"horizontal"});a(p.destroy);const w=l(m,{type:"vertical"});a(w.destroy),a(()=>{d.forEach(t=>t())});const b=o.getClass(c),v=o.getActions(c);let y=!1;a(i.subscribe("config.chart.time.calculatedZoomMode",t=>{y=t,r()}));const D={handleEvent:function(t){t.type},passive:!1,capture:!1};let x,P=0;v.push(function(t){x||(x=new ResizeObserver(()=>{const e=t.offsetWidth,o=t.offsetHeight,a=e-i.get("config.scroll.horizontal.width"),s=i.get("config.headerHeight");P!==e&&(P=e,i.update("$data.chart.dimensions",t=>(t.width=e,t.widthWithoutScrollBar=a,t.height=o,t.innerHeight=o-s,t)))}),x.observe(t),i.update("$data.elements.chart",t))}),a(()=>{x.disconnect()});const W={api:o,state:i,componentName:c},C=s.create(v,W),$=o.generateSlots(c,t,e);function I({className:t,onWheel:e,ChartCalendar:o,ChartTimeline:i,ScrollBarVertical:a,calculatedZoomMode:s,ScrollBarHorizontal:n,actions:l,slots:r,html:c,vido:d,props:h}){return r.html("outer",c`
      ...
      `)}let S=I;return a(i.subscribe(`config.templates.${c}`,t=>{S=null!=t?t:I,r()})),()=>S({className:b,onWheel:D,ChartCalendar:f,ChartTimeline:g,ScrollBarVertical:w,calculatedZoomMode:y,ScrollBarHorizontal:p,actions:C,slots:$,html:n,vido:t,props:e})}
/**
 ...
 */function B(t,e){const{api:o,state:i,onDestroy:a,Actions:s,update:n,reuseComponents:l,html:r,StyleMap:c}=t,d="chart-calendar",h=o.getActions(d),u=Object.assign(Object.assign({},e),{api:o,state:i,componentName:d}),m=i.get("config.components.ChartCalendarDate"),f=o.getClass(d);let g;const p=new c({height:"","--headerHeight":"","margin-left":""});a(i.subscribe("config.headerHeight",t=>{g=t,p.style.height=g+"px",p.style["--calendar-height"]=g+"px",n()}));let w=[],b=0;a(i.subscribeAll(["$data.chart.time.levels","config.chart.time","$data.chart.time","config.chart.calendarLevels"],()=>{const t=i.get("$data.chart.time.levels");let e=0;if(t.length!==b){b=t.length,w.forEach(t=>t.forEach(t=>t.destroy())),w=[];for(let t=0;t<b;t++)w.push([])}for(const i of t){if(!i.length)continue;let t="YYYY-MM-DD HH";switch(i[0].period){case"day":t="YYYY-MM-DD";break;case"week":t="YYYY-MM-ww";break;case"month":t="YYYY-MM";break;case"year":t="YYYY"}const a=o.time.date().format(t);l(w[e],i,o=>o&&{level:e,date:o,currentDate:a,currentDateFormat:t},m,!0),e++}n()},{bulk:!0,bulkValue:!1})),a(()=>{w.forEach(t=>t.forEach(t=>t.destroy()))}),h.push(t=>{i.update("$data.elements.chart-calendar",t)});const v=s.create(h,u),y=o.generateSlots(d,t,e);function D({className:t,styleMap:e,components:o,actions:i,slots:a,html:s,vido:n,props:l}){return a.html("outer",s`
      ...
      `)}let x=D;return a(i.subscribe(`config.templates.${d}`,t=>{x=null!=t?t:D,n()})),()=>x({className:f,styleMap:p,components:w,actions:v,slots:y,html:r,vido:t,props:e})}
/**
 ...
 * @released  2026-04-23
 * @license   SEE LICENSE IN LICENSE FILE
 */class E extends a{constructor(t,e){super(),e.state.update("$data.elements.chart-calendar-dates",e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e))}}function j(t,e){const{api:o,state:i,onDestroy:a,Actions:s,update:n,onChange:l,html:r,StyleMap:c,cache:d}=t,h="chart-calendar-date",u=o.getActions(h),m=o.getClass(h);let f,g="",p="";l(()=>{f=i.get("config.chart.time")});const w=new c({width:"0px"},{schedule:!1});let b="";let v=!1;const y=o.generateSlots(h,t,e);let D,x;const P={date:e.date,period:e.period,api:o,state:i,componentName:h};l((t,o)=>{if(o.leave)return v=!0,y.change(t,o),n();v=!1,D=e.level===f.level,x=D?m+"--main-date ":m+"--non-main-date ",e=t,P.date=e.date,P.period=e.period,function(){if(!e||!e.date)return;const t=i.get(`config.chart.calendarLevels.${e.level}`);w.style.width=e.date.currentView.width+"px",w.style.left=e.date.currentView.leftPx+"px";const o=t.find(t=>+f.zoom<=+t.zoomTo);g=e.date.current?" gstc-current":e.date.next?" gstc-next":e.date.previous?" gstc-previous":"",p=m+"-content "+m+`-content--${e.date.period}`+g,o.classNames&&Array.isArray(o.classNames)?(p+=" "+o.classNames.join(" "),b=" "+o.classNames.join(" ")):b="",n()}(),y.change(t,o)}),u.includes(E)||u.push(E);const W=s.create(u,P);function C({className:t,mainClass:e,additionalClass:o,formatClassName:i,finalClassName:a,styleMap:s,cache:n,shouldDetach:l,actions:r,slots:c,html:d,vido:h,props:u}){return l||!u||!u.date?null:c.html("outer",d`
            <div
          ...
          `)}let $=C;return a(i.subscribe(`config.templates.${h}`,t=>{$=null!=t?t:C,n()})),()=>$({className:m,mainClass:x,additionalClass:g,formatClassName:b,styleMap:w,finalClassName:p,cache:d,shouldDetach:v,actions:W,slots:y,html:r,vido:t,props:e})}
/**
 ...
 */function F(t,e){const{api:o,state:i,onDestroy:a,Action:s,Actions:n,update:l,html:r,createComponent:c,StyleMap:d}=t,h="chart-timeline",u=Object.assign(Object.assign({},e),{api:o,state:i,componentName:h});let m,f,g;a(i.subscribe("config.components.ChartTimelineGrid",t=>{m&&m.destroy(),m=c(t)})),a(()=>{m&&m.destroy()}),a(i.subscribe("config.components.ChartTimelineItems",t=>{f&&f.destroy(),f=c(t)})),a(()=>{f&&f.destroy()}),a(i.subscribe("config.components.ListToggle",t=>{g&&g.destroy(),g=c(t)})),a(()=>{g&&g.destroy()});const p=o.generateSlots(h,t,e),w=o.getClass(h),b=o.getClass(h+"-inner");let v;a(i.subscribe("config.list.toggle.display",t=>v=t));const y=new d({}),D=new d({});let x,P;a(i.subscribe("config.additionalSpace",t=>{x=t,l()})),a(i.subscribe("config.headerHeight",t=>{P=t,l()})),a(i.subscribeAll(["$data.chart.dimensions.heightWithoutScrollBar","$data.scroll.vertical.offset","$data.chart.dimensions.width","$data.list.visibleRowsHeight","$data.chart.time.dates.day","config.headerHeight","config.additionalSpace"],function(){const t=i.get("$data.chart.dimensions.width"),e=Math.round(o.getRealChartHeight(!0));y.style.height=i.get("config.innerHeight")+"px",y.style["--height"]=y.style.height,y.style.top=x.top+P+"px",t?(y.style.width=t+"px",y.style["--width"]=t+"px"):(y.style.width="0px",y.style["--width"]="0px"),D.style.height=e+"px",D.style.width=t?t+"px":"0px";const a=i.get("$data.scroll.vertical.preciseOffset")||0;D.style.transform=`translateY(${Math.round(a)}px)`,l()},{group:!0,bulkValue:!1}));let W=[];a(i.subscribe("config.actions.chart-timeline",t=>{W=t})),W.push(class extends s{constructor(t){super();i.get("$data.elements.chart-timeline")!==t&&i.update("$data.elements.chart-timeline",t)}});const C=n.create(W,u);function $({className:t,classNameInner:e,styleMap:o,innerStyleMap:i,Grid:a,Items:s,showToggle:n,ListToggle:l,actions:r,slots:c,html:d,vido:h,props:u}){return c.html("outer",d`
      ...
      `)}let I=$;return a(i.subscribe(`config.templates.${h}`,t=>{I=null!=t?t:$,l()})),()=>I({className:w,styleMap:y,classNameInner:b,Grid:m,innerStyleMap:D,Items:f,showToggle:v,ListToggle:g,actions:C,slots:p,html:r,vido:t,props:e})}
/**
 ...
 * @released  2026-04-23
 * @license   SEE LICENSE IN LICENSE FILE
 */class Y{constructor(t,e){e.state.get("$data.elements.chart-timeline-grid")!==t&&e.state.update("$data.elements.chart-timeline-grid",t,{only:null})}destroy(t,e){e.state.update("$data.elements",t=>(delete t["chart-timeline-grid"],t),{only:null})}}function Z(t,e){const{api:o,state:i,onDestroy:a,Actions:s,update:n,html:l,reuseComponents:r,StyleMap:c}=t,d="chart-timeline-grid",h=o.getActions(d),u={api:o,state:i,componentName:d},m=i.get("config.components.ChartTimelineGridRow"),f=o.getClass(d);let g;a(i.subscribe("config.chart.grid.cell.onCreate",t=>g=t));const p=[],w={},b=new Map,v=new c({});function y(t){let e=t.month()+1;e<10&&(e="0"+e);let o=t.date();o<10&&(o="0"+o);let i=t.hour();i<10&&(i="0"+i);let a=t.minute();a<10&&(a="0"+a);let s=t.second();return s<10&&(s="0"+s),`${t.year()}-${e}-${o}T${i}-${a}-${s}`}a(i.subscribeAll(["$data.scroll.vertical.preciseOffset","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar"],function(){const t=i.get("$data.chart.dimensions.width"),e=o.getRealChartHeight();v.style.height=Math.round(e)+"px",v.style.width=t+"px"},{group:!0}));let D="",x=0,P=0,W="",C=0,$="",I=0,S=0;function G(){const t=o.getGridRows();r(p,t||[],t=>t,m,!0),n()}a(i.subscribeAll(["$data.list.rowsHeight","$data.list.visibleRows","$data.list.visibleRowsHeight","$data.chart.time.levels","$data.scroll","config.list.rows;","config.list.rows.*;"],function(e,a){const s=i.get("$data.chart.time"),n=i.get(`$data.chart.time.levels.${s.level}`),l=s.levels[s.level];if(!l||!l.length)return;const r=s.levels[s.level].map(t=>t.currentView.width).join(",");if(!n||0===n.length)return void i.update("$data.chart.grid",{rows:{},cells:{}});const c=o.getRowsData(),d=i.get("$data.list.visibleRows"),h=d.map(t=>c[t].outerHeight).join("|"),u=d.join("|"),m=i.get("$data.scroll");if(u===D&&x===s.leftGlobal&&P===s.rightGlobal&&h===W&&C===n.length&&$===r&&m.horizontal.handlePosPx===I&&m.vertical.handlePosPx===S)return"$data.chart.time.levels"===a.path.listener?G():void 0;I=m.horizontal.handlePosPx,S=m.vertical.handlePosPx,x=s.leftGlobal,P=s.rightGlobal,$=r,W=h;let f=0;if(u!==D)for(const t in w)delete w[t];else if(C!==n.length)for(const t in w)w[t].cells.length=0;C=n.length;const p=o.getAllRows(),v=i.get("$data.chart.grid.cells");for(const t in v)delete v[t];for(const e of d){const o=p[e],i=c[e];if(!o||!i)continue;let a,s;u!==D?a=[]:(a=w[e].cells,a.length=0);for(const e of n){let s;b.has(e.leftGlobal)?s=b.get(e.leftGlobal):(s=y(e.leftGlobalDate),b.set(e.leftGlobal,s));const n=o.id+"-"+s;let l;if(v[n])l=v[n],l.id=n,l.time=e,l.row=o,l.rowData=i,l.top=f,l.vido=t,l.content=null;else{const a=Object.create(null);a.id=n,a.time=e,a.row=o,a.rowData=i,a.top=f,a.vido=t,a.content=null,l=a}for(const t of g)l.content=t(l);v[l.id]=l,a.push(l.id)}w[e]?(s=w[e],s.row=o,s.rowData=i,s.cells=a,s.top=f):s={row:o,rowData:i,cells:a,top:f},w[e]=s,f+=i.outerHeight}D=u,i.update("$data.chart.grid",{rows:w,cells:v})},{group:!0,bulkValue:!1})),a(i.subscribe("$data.chart.grid",G,{group:!0})),a(()=>{p.forEach(t=>t.destroy())}),h.push(Y);const M=s.create(h,u),z=o.generateSlots(d,t,e);function L({className:t,styleMap:e,rowsComponents:o,actions:i,slots:a,html:s,vido:n,props:l}){return a.html("outer",s`
        <div class=${t} data-actions=${i()} style=${e.directive()}>
          ${a.html("content",o.map(t=>t.html()))}
        </div>
      `)}let O=L;return a(i.subscribe(`config.templates.${d}`,t=>{O=null!=t?t:L,n()})),()=>O({className:f,styleMap:v,rowsComponents:p,actions:M,slots:z,html:l,vido:t,props:e})}
/**
 ...
 * @released  2026-04-23
 * @license   SEE LICENSE IN LICENSE FILE
 */class U{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-grid-rows");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-grid-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-grid-rows",e=>e.filter(e=>e!==t),{only:null})}}function q(t,e){const{api:o,state:i,onDestroy:a,cache:s,Actions:n,update:l,html:r,reuseComponents:c,onChange:d,StyleMap:h}=t,u="chart-timeline-grid-row",m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:u});let f;a(i.subscribe("config.components.ChartTimelineGridRowCell",t=>f=t));const g=o.getActions(u),p=o.getClass(u),w=new h({height:e.row.height+"px"});let b=!1;const v=o.generateSlots(u,t,e),y=[];d(function(t,i){if(!t||i.leave||void 0===t.row)return b=!0,c(y,[],t=>t,f,!0),v.change(t,i),void l();b=!1,e=t;const a=o.getGridCells(e.cells);if(c(y,a,t=>t,f,!0),w.setStyle({}),w.style.height=e.rowData.outerHeight+"px",e.row.style)for(const t in e.row.style)w.style[t]=e.row.style[t];for(const t in e)m[t]=e[t];v.change(t,i)}),a(function(){y.forEach(t=>t.destroy())}),-1===g.indexOf(U)&&g.push(U);const D=n.create(g,m);function x({className:t,styleMap:e,rowsCellsComponents:o,cache:i,shouldDetach:a,actions:s,slots:n,html:l,vido:r,props:c}){return a||!c||!c.row?null:n.html("outer",l`
            <div class=${t} data-gstcid=${c.row.id} data-actions=${s()} style=${e.directive()}>
              ${n.html("content",o.map(t=>t.html()))}
            </div>
          `)}let P=x;return a(i.subscribe(`config.templates.${u}`,t=>{P=null!=t?t:x,l()})),()=>P({className:p,styleMap:w,rowsCellsComponents:y,cache:s,shouldDetach:b,actions:D,slots:v,html:r,vido:t,props:e})}
/**
 ...
 */class X{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-items-rows");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t),{only:null})}}function tt(t,e){const{api:o,state:i,onDestroy:a,cache:s,Actions:n,update:l,html:r,onChange:c,reuseComponents:d,StyleMap:h}=t,u="chart-timeline-items-row",m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:u});let f;a(i.subscribe("config.components.ChartTimelineItemsRowItem",t=>f=t));let g="";const p=[],w=new h({width:"",height:""});let b=!1;function v(t=e.rowData,o=null){const a=i.get("$data.chart");b=!1,w.style.width=a.dimensions.width+"px",e?(w.style.height=t.outerHeight+"px",w.style["--row-height"]=t.outerHeight+"px",l()):b=!0}function y(t,e){if(!t||!e)return b=!0,d(p,[],()=>null,f,!0),l();const i=e.items;if(void 0===i)return b=!0,d(p,[],()=>null,f,!0),v(),l();const a=o.getItems(i).filter(t=>o.isItemHorizontallyInViewport(t));d(p,a,e=>({row:t,item:e,itemData:e?o.getItemData(e.id):null}),f,!0),v(),l()}const D=o.getClass(u),x=o.generateSlots(u,t,e);c(function(o,i){if(i.leave||!o||void 0===o.row)return b=!0,d(p,[],()=>null,f,!0),x.change(o,i),l();e=o;for(const t in e)m[t]=e[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)g=D+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const o=e.row.classNames({row:e.row,vido:t});Array.isArray(o)&&o.length&&(g=D+" "+o.join(" "))}}else g=D;y(e.row,e.rowData),x.change(o,i),l()}),a(i.subscribe("$data.chart.dimensions.width",()=>y(e.row,e.rowData))),a(()=>{p.forEach(t=>t.destroy())});const P=o.getActions(u);P.push(X);const W=n.create(P,m);function C({classNameCurrent:t,styleMap:e,shouldDetach:o,itemComponents:i,actions:a,slots:s,cache:n,html:l,vido:r,props:c}){return o||!c||!c.row?null:s.html("outer",l`
          ...
          `)}let $=C;return a(i.subscribe(`config.templates.${u}`,t=>{$=null!=t?t:C,l()})),()=>$({cache:s,shouldDetach:b,classNameCurrent:g,styleMap:w,itemComponents:p,actions:W,slots:x,html:r,vido:t,props:e})}
/**
 ...
 * @released  2026-04-23
 * @license   SEE LICENSE IN LICENSE FILE
 */class et{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-items-row-items");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-row-items",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t),{only:null})}}function ot(t,e){const{api:o,state:i,cache:a,onDestroy:s,Actions:n,update:l,html:r,onChange:c,unsafeHTML:d,StyleMap:h}=t;let u,m,f=0,g=0;s(i.subscribe("config.chart.spacing",t=>{"number"==typeof t?(g=t,f=0):("number"==typeof t.left&&(f=t.left),"number"==typeof t.right&&(g=t.right)),l()}));const p="chart-timeline-items-row-item";let w=0,b=0,v=!1,y="";const D=new h({width:"",height:"",left:"",top:""}),x=new h({}),P=new h({}),W={item:e.item,itemData:e.itemData,row:e.row,left:w,width:b,api:o,state:i,componentName:p},C=o.getClass(p),$=o.getClass(p+"-label"),I=o.generateSlots(p,t,e);let S,G=!1;s(i.subscribe("config.chart.item.cutIcons",t=>{S={left:o.getSVGIconSrc(t.left),right:o.getSVGIconSrc(t.right)}}));const M=o.getClass(`${p}-cut`)+" "+o.getClass(`${p}--left-cut-icon`),z=o.getClass(`${p}-cut-image`),L=()=>r`
  ...
  `;c(function(a,s){if(s.leave||void 0===a.row||void 0===a.item)return v=!0,G=!0,I.change(a,s),l();G=!1,v=!1,(e=a).item.id===u&&e.row.id===m||(u=e.item.id,m=e.row.id),W.item=e.item,W.itemData=e.itemData,W.row=e.row,function(){var a;if(G)return l();const s=i.get("$data.chart.time");if(v||0===s.levels.length||!s.levels[s.level]||0===s.levels[s.level].length)return G=!0,l();if(!e.item||!e.itemData)return G=!0,l();if(!i.get().$data.chart.verticallyVisibleItems.includes(e.item.id))return G=!0,l();const n=e.itemData;if(w=n.position.actualLeft+f,b=n.actualWidth-g-f,e.item.time.end<s.leftGlobal||e.item.time.start>s.rightGlobal||b<=0)return G=!0,n.detached=G,l();if(y=C,e.item.time.start<s.leftGlobal?(x.style.display="flex",y+=" "+o.getClass(p+"--left-cut")):x.style.display="none",e.item.time.end>s.rightGlobal?(P.style.display="flex",y+=" "+o.getClass(p+"--right-cut")):P.style.display="none",e.item.classNames)if(Array.isArray(e.item.classNames)&&e.item.classNames.length)y+=" "+e.item.classNames.join(" ");else if("function"==typeof e.item.classNames){const o=e.item.classNames({item:e.item,vido:t});Array.isArray(o)&&(y+=" "+o.join(" "))}const r=D.style.width,c=D.style.left,d=D.style.top,h=D.style.height;D.setStyle({});const u=o.isItemHorizontallyInViewport(e.item,s.leftGlobal,s.rightGlobal);if(G=!u,n.detached=G,u?(D.style.width=b+"px",D.style.left=w+"px",D.style.top=n.position.actualRowTop+"px",D.style.height=n.actualHeight+"px"):(D.style.width=r,D.style.left=c,D.style.top=d,D.style.height=h),null===(a=null==e?void 0:e.item)||void 0===a?void 0:a.style)for(const t in e.item.style)D.style[t]=e.item.style[t];W.left=w,W.width=b,l()}(),I.change(a,s),l()});const k=o.getActions(p);k.push(et);const A=n.create(k,W);function _(){return e.item?e.item.isHTML?e.item&&e.item.label?"function"==typeof e.item.label?d(e.item.label({item:e.item,vido:t})):"string"==typeof e.item.label?d(e.item.label):null:null:e.item&&e.item.label?"function"==typeof e.item.label?e.item.label({item:e.item,vido:t}):e.item.label:null:null}function H({className:t,labelClassName:e,styleMap:o,cache:i,shouldDetach:a,cutterLeft:s,cutterRight:n,getContent:l,actions:r,slots:c,html:d,vido:h,props:u}){return a||!u||!u.item?null:c.html("outer",d`
            <div
              class=${t}
          ...
          `)}let N=H;return c(()=>{const t=i.get(`config.templates.${p}`);N=null!=t?t:H,l()}),()=>N({className:y,labelClassName:$,cache:a,shouldDetach:G,styleMap:D,cutterLeft:L,cutterRight:T,getContent:_,actions:A,slots:I,html:r,vido:t,props:e})}
/**
 ...
 */function ft(t,e){const o=gt();return ft=function(e,i){let a=o[e-=272];if(void 0===ft.odpimQ){const e=function(t,e){let o,i,a=[],s=0,n="";for(t=function(t){let e="",o="";for(let o,i,a=0,s=0;i=t.charAt(s++);~i&&(o=a%4?64*o+i:i,a++%4)?e+=String.fromCharCode(255&o>>(-2*a&6)):0)i="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(i);for(let t=0,i=e.length;t<i;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)}(t),i=0;i<256;i++)a[i]=i;for(i=0;i<256;i++)s=(s+a[i]+e.charCodeAt(i%e.length))%256,o=a[i],a[i]=a[s],a[s]=o;i=0,s=0;for(let e=0;e<t.length;e++)i=(i+1)%256,s=(s+a[i])%256,o=a[i],a[i]=a[s],a[s]=o,n+=String.fromCharCode(t.charCodeAt(e)^a[(a[i]+a[s])%256]);return n};ft.oNOZgr=e,t=arguments,ft.odpimQ=!0}const s=e+o[0],n=t[s];return n?a=n:(void 0===ft.QQkniU&&(ft.QQkniU=!0),a=ft.oNOZgr(a,i),t[s]=a),a},ft(t,e)}function gt(){const t=["wsJdR8kJc2T/","B3jPz2LU","W4ZcPmo7A0tdKG","mtuWoty2BNrIwNfA","DgLTzq","W6r8aCo+WPi","ssy+nCobW5xcOa","WRpcTSoYqW","C3vWCg9YDa","ntKYnJm0zvrMCwju","q29UDgvUDc1tzwn1CML0Es1qB2XPy3K","W7dcUmo7DW","y3vZDg9Tzxi","C2v0uhvIBgLJs2v5","nCk1m8o3iJO+W7m","","EfpcKg1hwmkybCkHBCoSWOq","W4XoW5K5dW","uXddHX97ASoYf8kN","Dw5VyNnLCNzL","WQFcSSo0rCoacCoy","W69rcSkXWPaTWQdcRmkggmoNymoSW5/cHSk+WQNcHuX/W5xdV8omWOBcTCofW6ZdQgZdSHHwzelcRqtdPqRcGKRcHM1ys8kmWO0Simo5jCkjfx/dUmkrW59VW6n8D8ocW78dhCkIWOrTix7cQ8kOWQ8Cq0nBWP3cNCo+pSkXW59jW5tcSH3cGH/dSCkoW6PUWQa7W4JcPfeoneNcLuXTWQG","W700W6BdNYSMb8kWrmki","C3rYAw5N","W79zW4qlagywWQTGWRH0ExK","d8k5iSoMjsO6WR9DW6Hic8kuW4lcUSkYBXS2cqFcJxddJ8oGc2lcLmk/AhFdTCkJWQbgqcSkm8kCkW","mY40mI43","W6nWW6e1W6BcNCklW4FdNLiGWPpdNvfj","Dg9Rzw5FC2HVDwXKx2jL","BwvZC2fNzq","qCopghnrqCkqb8kWW6xdHI4","mZGWnZDXrgfYyLy","ndK2D3DuywvO","W7y5WRiuoHnWF2ddT8oUWP7cG3pdUfDSW4GimCoasJK","lMuVyxyVE20+vxrlAfmTwfDLpwrKltKZrtD5sZLmzYO","kK1sbYyTnL/dHdD5BGLXlMxcUsCrsgWEwa","zgvZy3jPChrPB24","omkFssambSkqC8k9W7hdNvRdJwTBWQtdNHhcN8o6WRJdRCkSW6BcJ18JWObYmM3dOa3cHchcHqpdQCkdiwtdR8koDhpdGxBdSZebtNfrd2dcKCkWvSorpCoMWPlcRYxdNYddNajKBNdcLSkbg8o+W6/cSZKIumo0FSoidI5io8oKmmkxWQZcUSkehSocW6/cHmoyWORdSMpdP0/cLa","zxjYB3i","w2BdRCkXWPa","y2f0y2G","jgrHDgeUzgLTzw5ZAw9UCW","f8kxxIyk","ax9xba","nvHWrfrzwG","W6zRbW","CgfYC2vFBgLJzw5Zzv9RzxK","y29UzMLNlMf1Dg9jBM5LCKHLAwDODa","Ahr0CdOVlW","iSk1WQVcH0VdVCoX","uatdLX99","vuJdNmosk8oFW50","ddDhW7xdVWVcRSohdq","W5hcICk8","ACoGFCoWqmkEdCk1da","zgvZDhjVEq","W7yPCmoVdCowW7bwy1i9W4jh","W4ldVI0QW5e","W68IW7C","W7vHa8oDWOxcQCkhW4dcTqlcHSksW4RdSmkM","CM91BMq","veJdGCogpSoq","qCobWOWoW4FcTG","B3jPz2LUCW","W6rpprxcRG","W6eTDG","DSoOACoQAmkehmkIeCkvWQe","qeZcJgrEtmoRqCkizSo6WOzLCmoTW7JdUmomW6L8WP7dNNzLAmo9W4OHW48SW48Irmkdkmo/WOC1W4iyW70Ngu0bFaGxWPDni8kEW67cS0JcJmkYWRGzlKZdLSoQACoZW67dOXlcUmk5kCo4WRZdRCoQWQupWQdcHvxcSCo/WOvUW6zuySkPxCk1WPXzW5SlWPvTWOzDBSoqWP7dVCoMW7NcQCoRDNJcIKCMW7q","z2v0","W58IWQmEjG","C2v0u2nYB2XSvg9W","W7OYW6/dIaC","W7DqamkNW546WQRdOCkmfmoWymoMW4tdG8kZWQ3dKqfOW5pdSmoeWPVcQmotW7pcRwBcVuS","xItdR8k2","nda4odmYmezmEeHhBq","nda0mwL5Cujusq","W5xcG8kMWPRcJSoSWPaSWQ/cKayaWPhdMrbLb3/dJmk6W7O1","WQOKW7yWx8kgo3lcKW0","r1nuqW","rSoeWOqkW4a","sw52ywXPzcb0B2TLBI4","DMfSDwvFBNvT","DxnLCKfNzw50","lLiDbWJdSmoTWRZdV8k1DdW","b8oUFcRdJ8o7","sw52ywXPzcbSAwnLBNnLigTLEsbBBwfSzM9YBwvKigrHDgfDlG","C3vIC2nYAwjLqwXS","DwX0Aw1HDgu","a8kFtJek","CgfYzw50rwXLBwvUDa","D8oOAG","zg9TywLUCW","DMfSAwrFDw50AwW","r8ofWPOgW53cTa","d1ioprJdTSoNWQldTSkfoYH4DSkDWQdcPmozW6tcMK0w","yw5Jzxn0B3jpCMLNAw5Z","W4DzhCk1WRCWWQhdQCkv","BuzDfs5KA1/dMtvLBq","sw52ywXPzcbSAwnLBNnLigTLEsbBD3jVBMCGC2LNBMf0DxjLxs4","mtm5odu1mKXqwMP0yG","FCoSBG","ChjVzhvJDa","zw5KC1DPDgG","tgLJzw5ZzsbOyxmGzxHWAxjLzc4","WOPVkci","W5dcGSoBsW","yNq8jLzGlZLUndy1AgGSkG","ChvZAa","CMv2zxjZzq","DxZdLXnaWPi4WPqVWPmFW4emW58PF2b3WQJdHWbkh8o0W4VcTHizW5GQtxyx","FCoSDmo7u8kldmkIoSk2WQJcR8oE","cLFdMmo8m8kS","WOFdPwr8W5ldSCo7jq","DhjPywW","aw9wdX5QW5G","pmkGWRpcGL3cImk4ka","lCkWjY7cNCoWACkFcZhcK3bYn8kMWRu","qmolW7NdJ2eIW5VcVW","W4BcO8opj8ozW5pdUW","W7npobBcQrv0W7OhWPS2gcTN","uXhdLWv2F8oYe8k7","y29UzMLNlNnJCM9SBc52zxj0AwnHBc5IEvbPEgvSCW","mwSKWORdVG","W5/cUSoii8odW4u","yxnZAwDU","W6SPA8oK","WOP5kaVdHWBcOLldICkEW6epWOLoAW","WRtdH0ircCo6vHi","zgLYzwn0AxzL","W4zwhCkMWPC7WRy","jSkHWQVcL10","x8oaW6G","s1NdJSotpSolW6/cR8okWQi","l8k5iSoMjsO6","ENRdMHbhWOzZ","m1ldLsO","BKamW6JcVa","W6ZcQmoMEfxdNG","gmo/CZNdJSoG","eMvkcHjJWOldNa7dNmopihjnymk7xKBdJsu0","CgfYzw50","umoqWPWo","oLzDeZS5t1xdNZi","wSk/m8oHi8oGtg/cJszHs0uoW7BdTCkGr1n4vmkqDConWRRcQCoGaCkcW6bRfSoT","Dg9ju09tDhjPBMC","o2hdNIu","Ag9ZDa","WP15nIhdIXFdQu3dRSkdW6mcWOW","CgvYy2vUDa","Dw5ZywzLlwv2ywW","zNjVBuvUDhjPzxm","zg9JDw1LBNq","WQL3W7OqW5icW7u","W6apF0egW7G","zMLSztO","BgLJzw5Zzq","rsyLhG","sMFdPCkMWOFcTZy","FLlcINLhwSof","DMLZAwjSzq","WOuyW5aAhW","z3n0yY1LCNjVCG","W6afze8uW6mEwCo5mq","AgvPz2H0","W79zW4q","Ahr0Chm6lY9NC3rJlM5LDxjVBMv0lMLVl2fWAs9PBNzHBgLKlxrVA2vU","y29UzMLNlMfJDgLVBNmUBwfPBG","pgpcOCksWO/cVv7dM1tcNmo6cSk3WQtdVq","m8kXm8oMjs0AW7ntW6burCko","C2LNBMf0DxjL","AvpcI2vk","jgrHDgeUzwXLBwvUDhmUBwfPBG","Ahr0Chm6lY9NC3rJlM5LDxjVBMv0lMLVl2fWAs9SAwnLBNnL","bSoQEcldIq","jsRdNGz8WOnxWOe","W5FdHCoMWQ7dOLXE","tgBdQmkGWPVcQty","CMvMzxjYzxi","ywjZB2X1DgvqB3nqEa","zNvUy3rPB24","mJKZntz1BfzrCfC","y29UzMLNlMHLywrLCKHLAwDODa","omk9WQtcL0ddGCoY","C3bSAxq","gmktrciwhq","AhjLzG","WP3dO252W5pdNSo7lW","CMvNAxn0zxjLzerVBwfPBNm","Aw5JBhvKzxm","DgHLBG","y3jLyxrLzef0","W6WfE0ChW6id","W6XuW5u2","wCoaW6JdGheOW4O","saRdLHG","DMvYC2LVBG","C3vIC2nYAwjL","AM9PBG","mZLNC1v2qwy","y2XHC3noyw1L","BgfZDeLUzgv4t2y","W6uIW7ddNHuGbq","D2LKDgG","ww91CIbSAwnLBNnLigTLEsbPCYbUB3qGDMfSAwqGzM9YihrOAxmGChjVzhvJDcb2zxjZAw9UicHTywPVCIb1CgrHDgvZigfYzsbUB3qGywXSB3DLzcKU","nfKkob7dPSoNWQm","lvxdMsO","WQFdJwu","ibmhC2dcHKJdSmo1z8koWQjoBSoKWOddJmo+g8odWOxcImoCW7u7qurHW4pcNmkFW4rEzXNdPrfvAr0","if/dHa","W4tdK8oLWQVdPfe","vCotWPSaW5/cPLxdOaZcI8o3mui","C3vIC3rY","tNRdTCk9WPNcQq","W7H5W7CkW6BcN8k5W4ldVKKL","zgLZy29UBMvJDa","W7WOW6JdIbO","wNNdOSk1WORcOG","q1nq","WQpcRSo2qW","cZLDW7ldNWldPmorfSogW6rVWP7dJqL5W58AgIpdHsZcGb8mquXqWRGcFq","CNvSzxm","W48GWRuqiavM","FrSkfJGEEvNdGW","sw52ywXPzcbSAwnLBNnLigTLEs4","nCkNWRtcM0NdNa","fea2WP3dGmoZemonj8ot","egHxaXDXW5JdLtFdGmoixNG","ExhdIHbBWOnZ","xZW/ga","ANnVBG","DMvYDgLJywW","rfjukc9DW7y","BxvSDgLWBgLLCG","zgf0zq","icKU","y29UzMLNlMnVBxbVBMvUDhmUtgLZDa","WRX3WRVcLuD1umktzSkeWRmoqa","tqddLH95F8o+","xY7dUSkHjx5UW64i","W7pcPCoHEvxdVs3cLW","W75oW581jNOnWRvLWPfI","WQv/nI7dLHNcPLldPmklW60AWOLpDSo9WRJdUepcJsCfa3xdJuCNWRhcMXBcOSoHWRKpW5iSWRfTWPxcV23cHYTiWPZcKWtcTSk8vSoqgSk3WP1jWPpcL8oKvdRdHmk1oCoXWR7cU2HaWPOftSofW54TySoxhSkYWRldUmoJWPyRcXRdUmk0W6TwWO3cL0ddLhlcVHjZav9+uhy3WQZcMmkDWOPGEuZcLhj7W43dOSofwSoOlmkZmG","W6u9CCo+dmopW5bi","iSk+iSoMoc0WW615W79ytmktW4pcVq","lgNcOSkQWPJcPei","W47cLKxcVf00","zw50CMLLCW","W6LRgSo2WOJcQW","wJKOeCouW5pcUW","BwfW","jKbpbd08Fq","Ag9YAxPVBNrHBa","hg9xhXPJW4K","F0axW6dcSuZdHbj6WQrGjmoVcmkuexJcRa","jmk1nq","W70ACKCAW6K","r1nuqZOZoG","W4GLWR0ujW","WRpcUmoRr8omcq","DMvY","zg9TywLU","WOXZkcVdGXpcOG","j8kHWQxcGu3dGmo+zCk3","W40UAhdcLqhcG1/dV8ktW5O","vgHPCYbKB21HAw4GAxmGBM90ihjLz2LZDgvYzwqGkca","W4pcGfJcSK4Y","DwX0Aw1HDguTB25LlxLLyxi","WQKpWOLGvIflWOTCWQ57A28","qZpdVmk/ex1UW7m","ChjLDMvUDerLzMf1Bhq","CMvWBgfJzufSBa","a39icqG","WQhcTSoQu8oa","DMfSDwu","W7fsW5m0fNaCWRq","W61mW5q5f3e","W7SpyNunW74FqCo0euC+WQS","DxbKyxrLCW","W7iXCSoV","B2zMC2v0v2LKDgG","tgLJzw5ZzsbRzxKGy2HLy2SGBwvJAgfUAxnTigzHAwX1CMuU","WQ/dNHfpWP3dLCk2","C2v0u2nYB2XStgvMDa","BgvUz3rO","DgvZDa","W7aHCCoJaCooW5a","W4pdOYGPW5y","W7OpzKOpW68v","b8kxsZy","jgrHDgeUzwXLBwvUDhmUCgfYzw50","zwBdIqvgWODI","Dg9Rzw4","zgvJCNLWDa","B2zMC2v0sgvPz2H0","z2v0u2nYB2XSvg9W","W6TmW5WXfW","WQNdHNGreSoYvbZcJCoOAHxcNWZcRtTx","l0DiaIC","oLiD","BM9YBwfSAxPLtw91C2vxAgvLBev2zw50","xhNdQSk9WOO","AhrTBa","W5NdOIKG","pLGhmGldPCkSWRZdUSksB2jLDmklWOhcR8odWRNdKMi","eKyXWPZdVmoGhSokla","q8oyWOWBW5S","Dg9Rzw5FD2fZ","pgjYic8+","CMvWBgfJzq","f1yHWOBdUCoR","WPPZkYtdKbNcT0RdPmkEW6i","BLOvW6pcQW","Dg9tDhjPBMC","raRdIa1XDSoO","be/dNCkbzCkg","zgf0yuLUzgv4","W4ldOYy/W5e8qb0R","WQu4W7a6cmkmj3tcNrm","BwfPBG","C0JcK2C","DxbKyxrL","W5xcG8kMWPRcJSoSWPaPWR/cHHWU","W7/cGSk+WP3cI8oIW5PTWRBcJqOSWPhdHba3jh/dNmoZ","","z2v0vgLTzq","W7FcPmoSA0K","DhLWzq","C2X1zW","mvVdNc3cMW9jW7lcJJS","kNaRWOpdUmkUWQVdUq","tgLJzw5ZzsbMB3iGzgLMzMvYzw50ihbYB2r1y3qGAgfZigjLzw4GChjVDMLKzwqU","zM9SBg93","t8kXmCoYl8oiba","W4tdKmoMWQ7dQLXAW43dGNW0W59mzaNcVtXZD8o+hdldQr8FWPlcJmkZFCk8ArBdNq","C3rHCNrZv2L0Aa","y29UzMLNlMXPy2vUC2vlzxK","W7WdE0m","W5xdUsKTW4WG","xdWUa8ouW4tcOrpdLa","jgrHDgeUzgLTzw5ZAw9UC1bHCMvUDa","W6u6z8oRf8oh","WQXOW6CDW5ipW6FdRmo5tCoYAeRcL8kwcmkltmkxWR1mANn5DSocW4ldJ1VcUSoZrmkg","DMfSAwrvBNrPBa","ke/dHchcJq","D2fZBuLUAxrPywXPEMvK","W75tW5W0dgm","WRpdNgGjhSoEwqu","xeldGSoai8ow","gInFW7hdHq","W6nWW6e","ue9tva","W6NdICoLWRBdPLS","zMv0y2G","nv/dGcJcNJLcW4FcIZS"];return(gt=function(){return t})()}function pt(t,e){const o=gt();return pt=function(e,i){let a=o[e-=272];if(void 0===pt.IaDKiX){pt.MRcnFH=function(t){let e="",o="";for(let o,i,a=0,s=0;i=t.charAt(s++);~i&&(o=a%4?64*o+i:i,a++%4)?e+=String.fromCharCode(255&o>>(-2*a&6)):0)i="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(i);for(let t=0,i=e.length;t<i;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)},t=arguments,pt.IaDKiX=!0}const s=e+o[0],n=t[s];return n?a=n:(a=pt.MRcnFH(a),t[s]=a),a},pt(t,e)}function wt(t,e){const{api:o,state:i,onDestroy:a,Actions:s,createComponent:n,html:l,onChange:r,update:b}=t;let v;function y(t,e){return pt(t-6,e)}const D=mt(t,d);D[j("oGa2",847)]();const x=B(1050,1189);let P;a(i[z(-421,-294)](B(898,779),t=>P=t));const W=l`
  ...
  `,I=[];let S,G;function M(t,e){return ft(t- -778,e)}function z(t,e){return pt(e- -771,t)}I[st(1082,"jT@(")](i[z(-276,-294)](y(522,652),t=>S=t)),I[st(1299,"48Td")](i[M(-193,"cFJk")](et("lW!@",343),t=>G=t));const L=n(S);a(()=>{var t,e;L&&L[t=552,e=697,y(e-355,t)]()});const O=n(G);a(()=>{var t,e;O&&O[t=935,e=778,ct(t- -32,e)]()}),a(()=>{var t,e;I[t="48Td",e=1163,st(e-86,t)](t=>t())});const{onDestroy:R,state:T,update:k,html:A,unsafeHTML:_}=t;var H=!0;const N=A`<strong>[gantt-schedule-timeline-calendar component]</strong><br /><br />`;function V(t,e=""){const o=M(-122-58,"59#q");var i,a;return A` <div class="${o}">${N}${t}${e?A`<br />${typeof e===(i=739,a="G9Y1",et(a,i-338))?_(e):e}`:null}</div> `}function B(t,e){return pt(t-451,e)}function E(t){return c(this,void 0,void 0,function*(){function a(t){function e(t,e){return ft(e- -806,t)}function o(t,e){return pt(e- -271,t)}return(t=String(t))[e("wrQI",-350)](o(-89,58),"")[o(362,318)](e("^x^y",-410),"")}function s(t){function e(t,e){return ft(e-516,t)}function o(t,e){return pt(e-982,t)}const i=(t=a(t))[o(1406,1463)](":");i>-1&&(t=t[e("48Td",1135)](0,i));const s=m(t);var n,l,r,c,d,h,u,g,p,w;return s[p=621,w=449,pt(p-14,w)]===f[u=-597,g="wrQI",ft(u- -875,g)]&&s[d="g6uM",h=565,ft(h-291,d)]&&s[e("$rux",856)]&&(t=s[r="m&ua",c=1253,ft(c-635,r)]+"."+s[n=802,l="F]h8",ft(n-354,l)][o(1409,1460)](".")),t}let n=location[b(935,967)];const l=function(){function t(t,e){return pt(t-415,e)}function e(t,e){return ft(e- -573,t)}function o(t,e){return pt(e-313,t)}if(void 0!==location[i=1108,a="C[V1",ft(i-584,a)])return[...location[c(-385,-376)]];var i,a;const s=[];function n(t,e){return pt(e- -404,t)}let l=window;function r(t,e){return ft(e-465,t)}function c(t,e){return pt(e- -752,t)}for(;l!==window[r("%4uh",741)];){if(l[c(-478,-320)][t(873,710)])try{const o=new URL(l[t(847,957)][n(17,54)]);s[e("lpXA",-249)](o[d(14,107)])}catch(t){}l=l[o(717,734)]}function d(t,e){return pt(t- -268,e)}return s}();function r(t,e){return ft(e-100,t)}function c(t,e){return ft(t-206,e)}if(i[z(1267,"wF1q")](b(802,884),[n,...l]),l[G(594,"g6uM")]&&(n=String(l[l[G(617,"mcbF")]-1])),n[P(1505,1410)](b(810,975)))return H=!1,void(v=$);if(n=a(n),t[x(1097,1146)](P(1427,1490))){let a,d;const h=i[D(131,91)](I("&L1R",394));if(e&&e[M(-80,92)]&&typeof e[b(1294,1165)]===P(1350,1331))d=yield e[b(1177,1165)]()[b(968,861)](t=>{function e(t,e){return G(t- -665,e)}function o(t,e){return x(e- -510,t)}function i(t,e){return z(t- -337,e)}H=!1,h&&console[n(525,"$rux")](n(761,"U%Z0"),t);let s=z(190- -987,"6moZ");function n(t,e){return z(t- -636,e)}typeof t[o(250,282)]===o(317,276)&&(t[n(772,"lpXA")][e(72,"r%*n")](o(278,402))||t[e(69,"kjdD")][i(1087,"SoxO")](x(-481- -1461,-466))||t[i(1020,"kjdD")][n(794,"s^TA")](o(171,263)))&&(s=D(586,703-665)),a=V(s)});else{H=!1,h&&console[x(801,905)](I("f(p1",140),e);const t=G(570,"Ko!H");a=V(t)}if(a)return H=!1,void(v=a);let u;try{const e=b(940,855);u=d[P(1217,1051)](t,e)}catch(t){H=!1;const e=x(986,1118);return void(v=V(e,t[G(770,"eye&")]))}if(!u.ok){H=!1;const t=z(1478,"&L1R");return void(v=V(t,u[c(538,"g6uM")]))}const m=u[c(628,"G9Y1")];if(m&&m[b(1022,1041)]&&m[x(983,1138)]instanceof Map&&(m[r("^x^y",511)]=Object[x(913,850)](m[I("m&ua",359)][I("f(p1",231)]()),m[G(612,"G9Y1")][r("0iMP",671)]instanceof Map&&(m[M(-204,-44)][I("SoxO",73)]=Object[G(773,"s^TA")](m[I("a$cj",384)][D(121,31)][D(288,269)]())),m[M(-204,-238)][D(321,300)]instanceof Map&&(m[G(655,"qX#B")][b(1206,1098)]=Object[D(269,173)](m[D(416,243)][c(708,"Q*Ga")][I("6moZ",202)]()))),i[c(742,"]5A!")](D(284,178),m),m[b(949,922)][M(-97,-187)]!==x(841,878)){H=!1;const t=b(1279,1151);return void(v=V(t))}const f=o[D(76,27)][I("(813",80)]()[z(1205,"^x^y")]();if(m[b(1082,913)][D(103,104)]<f){H=!1;const t=b(886,924);return void(v=V(t))}let g=n;if(m[x(983,1058)][c(775,"Ko!H")]){g=s(n);const t=l[D(135,272)](t=>s(t));if(t[r("jT@(",518)])for(const e of m[r("Q*Ga",638)][G(724,"]5A!")]){const o=e[b(896,1004)](">")[P(1279,1332)]()[I("WYGU",163)](t=>s(t)),i=o[r("m&ua",438)](),a=s(location[r("eye&",575)]);if(!o[D(449,306)]||!t[M(-141,-64)]||o[G(717,"Ko!H")]!==t[P(1454,1410)]||a!==i)continue;let n=0,c=0;for(const e of o){e===t[c]&&n++,c++}if(n===l[I("teYa",318)])return}}if(!m[r("lpXA",652)][r("eye&",694)][z(1273,")&@T")](n)&&!m[r("#1(F",375)][P(1262,1203)][x(951,1100)](g)){let t=!1;for(const e of m[b(923,1041)][x(854,782)]){if(e[M(-322,-456)](".*")){const o=e[G(849,"m&ua")](0,e[M(-224,-99)](".*")+1);if(n[z(1288,"g6uM")](o)){t=!0;break}}if(e[I("URpn",259)]("*")){const o=e[P(1441,1496)](".","\\.")[G(532,"a3NZ")]("*",".*");if(new RegExp(o)[M(-140,-87)](n)){t=!0;break}}}if(!t){H=!1;const t=G(605,"6moZ")+n+"'.";return void(v=V(t,c(581,"r%*n")+m[c(558,"kjdD")][I("k2)q",354)][c(692,"a3NZ")](", ")+G(678,"f(p1")))}}if(!m[z(1467,"a$cj")][G(781,"48Td")][G(706,"mcbF")]){if(i[I("kjdD",131)](I("TNM0",192))[c(782,"s^TA")](".")[0]!==m[D(155,124)][b(854,1016)][G(833,"BGwI")](".")[0]){H=!1;const t=M(-221,-338);return void(v=V(t))}}return}const d=P(1277,1240);function b(t,e){return pt(e-540,t)}const y=r("SoxO",704);function D(t,e){return pt(e- -258,t)}function x(t,e){return pt(t-482,e)}function P(t,e){return pt(t-890,e)}function I(t,e){return ft(e- -208,t)}const S=w;function G(t,e){return ft(t-252,e)}function M(t,e){return pt(t- -705,e)}function z(t,e){return ft(t-875,e)}if(t){if(t[G(675,"lW!@")](c(647,"59#q")))return function(){function e(t,e){return x(t- -636,e)}let o=null;function a(t,e){return x(t- -1127,e)}function s(t,e){return P(e- -1060,t)}try{const s=t[c(260,428)](5),n=h[c(665,509)](s,d)[l("oGa2",722)](g);o=JSON[l("eye&",645)](n),o&&i[a(-44,57)]($("0iMP",-502),{for:o[$("dU#d",-394)],domains:[...o[w(-364,-398)]],type:Object[I(336,"^x^y")]({},o[l("U%Z0",699)]),validUntil:Object[L(478,"BGwI")]({},o[e(469,581)])})}catch(t){}if(!o||!o[w(-113,-71)]||!o[s(420,453)][I(384,"(813")]){H=!1;const t=c(347,302);return void(v=V(t,W))}if(!o[c(248,386)]){H=!1;const t=$("9oGl",-429);return void(v=V(t,W))}function l(t,e){return r(t,e-214)}function c(t,e){return P(e- -954,t)}const u=function(t){function e(t,e){return D(t,e- -443)}const o=Object[e(-452,-296)]({},t);return delete o[e(-219,-251)],delete o[s=-200,n=-235,M(s-34,n)],JSON[i=949,a="eye&",z(i- -327,a)](o);var i,a,s,n}(o);if(!function(t,e){if(!t||!e)return!1;const o=new S({});var i,a,s,n;return o[i=-668,a=-637,P(i- -1852,a)](y),o[s="cFJk",n=1377,z(n- -88,s)](e,t,p)}(o[L(320,"WYGU")],u)){H=!1;const t=e(225,334);return void(v=V(t,W))}function w(t,e){return b(e,t- -1276)}const C=(new Date)[s(374,435)]();function $(t,e){return G(e- -1169,t)}function I(t,e){return r(e,t- -269)}function L(t,e){return r(e,t- -115)}if(o[s(326,453)][c(548,490)]<C){H=!1;const t=w(-352,-348);return void(v=V(t,W))}if(o[I(185,"SoxO")][e(400,458)]===c(448,304)||o[l("dU#d",873)][c(526,490)]===s(454,377)){const t=n[I(178,"WYGU")](":");t>-1&&(n=n[e(338,473)](0,t));const o=m(n);o[I(330,"(813")]===f[$("jT@(",-634)]&&o[e(387,312)]&&o[L(392,"U%Z0")]&&(n=o[l("(813",853)]+"."+o[L(293,"%4uh")][a(-167,-90)]("."))}if(!o[l("WaoG",747)][I(441,"qX#B")](n)){H=!1;const t=c(633,481)+n+c(404,451);return void(v=V(t,W))}}();const e=M(-398,-398),a=encodeURIComponent,s=(new Date)[P(1315,1197)](),l=h[z(1313,"BGwI")](s,d),w=G(649,"mcbF"),$=u(s+n,w,{keySize:16})[P(1483,1530)](),L=[a(r("C[V1",514))+"="+a(t),a(x(909,871))+"="+a(n),a(x(948,808))+"="+a(location[D(347,208)]),a(P(1462,1508))+"="+a(l),a(I(")&@T",204))+"="+a(e),a(I("cFJk",298))+"="+a(navigator[b(948,903)])][r("48Td",537)]("&"),O=x(935,776);window[b(901,819)](O,{method:G(638,"jT@("),redirect:z(1147,"s^TA"),headers:{"Content-Type":r("WaoG",722)},body:L})[c(622,"a3NZ")](t=>{return 200!==t[i="mcbF",a=1306,c(a-681,i)]&&(H=!1,v=C),t[e=1185,o=1022,P(o- -378,e)]();var e,o,i,a})[G(725,"s^TA")](s=>{function l(t,e){return I(t,e-496)}if(s&&s.ok)if(s[f("TNM0",344)]&&s[u("BGwI",-234)]===$)H=!0,i[u("qLP5",-150)](h(986,"^x^y"),()=>{function t(t,e){return pt(e- -68,t)}function e(t,e){return u(e,t-64)}function i(t,e){return pt(t- -318,e)}var a,n;function l(t,e){return f(e,t- -685)}var r,c,d,h;return{registeredDomains:s[i(150,121)],validUntil:{text:s[d=1558,h=1418,pt(d-935,h)],value:o[e(127,"]5A!")][t(308,446)](s[e(119,"a3NZ")])[l(-73,"qoev")]()},type:null!==(a=s[i(289,139)])&&void 0!==a?a:{text:l(-388,"s^TA"),value:t(410,326)},for:null!==(n=s[r=-14,c=-31,pt(r- -307,c)])&&void 0!==n?n:""}});else{H=!1;const o=r(800,682);v=V(o,W);const i=r(750,767),c=[a(d(-23,"qLP5"))+"="+a(t),a(w(246,339))+"="+a(n),a(g(654,664))+"="+a(location[m(-390,-355)]),a(m(-330,-281))+"="+a(e),a(m(-358,-234))+"="+a(String(s[l("kjdD",784)])),a(m(-500,-512))+"="+a($),a(u("kjdD",-251))+"="+a(navigator[d(97,"SoxO")])][w(297,464)]("&");window[l("lW!@",866)](i,{method:p(1258,1344),redirect:p(1593,1640),headers:{"Content-Type":h(1137,"wrQI")},body:c})}else if(s){H=!1;const t=_(s[m(-610,-511)][l("U%Z0",830)](/\n/gi,u("g6uM",41)));let e=null;s[r(805,638)]&&(e=_(s[h(1114,"U%Z0")][f("]5A!",567)](/\n/gi,r(848,909))));const o=g(635,640);v=A` <div class="${o}"><strong>${N} ${t}</strong><br />${e}<br />${W}</div> `}else H=!1,v=C;function r(t,e){return M(e-1026,t)}function d(t,e){return z(t- -1297,e)}function h(t,e){return I(e,t-731)}function u(t,e){return z(e- -1429,t)}function m(t,e){return D(t,e- -563)}function f(t,e){return c(e- -207,t)}function g(t,e){return b(t,e- -342)}function p(t,e){return x(t-499,e)}function w(t,e){return P(t- -1071,e)}k()})[c(529,"Ko!H")](()=>{H=!1,v=C,k()})}else{H=!1;const t=G(558,"C[V1"),e=D(240,184);v=A` <div class="${e}">${N} ${t}${W}</div> `}})}function j(t,e){return ft(e-270,t)}R(T[j("eye&",569)](ct(1247,1154),t=>{var e,o;function a(t,e){return X(t,e-624)}E(t)[e=-559,o=-470,B(o- -1391,e)](()=>{k()})[a(761,770)](t=>{H=!1;const e=a(786,697- -313);function o(t,e){return ft(t-193,e)}function s(t,e){return ft(t- -526,e)}v=V(e),i[s(-37,"a3NZ")](s(-229,"f(p1"))&&console[o(543,"Q*Ga")](o(507,"Q*Ga"),t),k()}),k()}));const F={width:0,height:0},Y={width:0,height:0};let Z,U,q,J;function Q(t){function e(t,e){return z(e,t-482)}const o=t[s(1368,1494)],a=t[s(1382,1391)];function s(t,e){return z(e,t-1579)}var n,l,r,c,d,h;(F[d=-160,h="Ko!H",j(h,d- -799)]!==o||F[e(155,327)]!==a)&&(F[r=-368,c="G9Y1",M(r- -176,c)]=o,F[e(155,13)]=a,i[n=1378,l=1270,B(n-326,l)](s(1130,1197),F))}class K{constructor(t){function e(t,e){return st(e- -380,t)}t&&(!Z&&(Z=new ResizeObserver(()=>{Q(t)}),Z[e("0iMP",918)](t),i[e("s^TA",966)](ct(514- -569,559),t),Q(t)))}[j("BGwI",767)](){}[y(342,210)](t){var e,o;t&&Z&&Z[e=-350,o=-479,z(o,e-121)](t)}}function X(t,e){return pt(e- -175,t)}function tt(t,e){return ft(e-710,t)}function et(t,e){return ft(e-27,t)}function ot(t){if(!t)return;function e(t,e){return M(e-449,t)}const o=t[e("%4uh",165)],a=t[s(894,752)];function s(t,e){return ct(t- -311,e)}var n,l,r,c,d,h;(Y[e("jT@(",277)]!==o||Y[d="$rux",h=-1,et(d,h- -556)]!==a)&&(Y[s(803,776)]=o,Y[r="]5A!",c=902,st(c- -322,r)]=a,i[n=894,l=1026,B(l- -26,n)](z(521,649-800),Y))}!P[z(-392,-302)](K)&&P[ct(1019,1092)](K);class it{constructor(t){var e,o,a,s;t&&t[n(739,811)]&&(t=t[a="C[V1",s=111,j(a,s- -608)],!U&&(U=new ResizeObserver(()=>{ot(t)}),U[e=516,o="lW!@",st(e- -805,o)](t),i[n(943,1042)](X(970,1092-697),t),ot(t)));function n(t,e){return X(t,e-616)}}[st(1133,"G9Y1")](){}[tt("F]h8",1235)](t){function e(t,e){return ct(e- -1164,t)}var o,i;t&&t[o=1288,i="dU#d",st(o-161,i)]&&U&&U[e(-120,-233)](t[e(-81,-163)])}}!P[B(920,1061)](it)&&P[M(-454,"lpXA")](it),a(()=>{function t(t,e){return B(t- -1061,e)}U&&U[t(-115,-59)](),Z&&Z[t(-115,-142)]()}),a(i[B(818,782)]([y(626,567),et("&L1R",384)],()=>{function t(t,e){return z(t,e-880)}function e(t,e){return j(t,e-515)}function o(t,e){return B(t-110,e)}if(i[t(543,458)](o(889,848))){const a=i[e("&L1R",1119)](o(1181,1184));if(!a)return;i[t(557,710)](e("a$cj",1319),()=>{var o,s,n,l;return a[n=986,l=956,t(n,l-403)]-i[o=615,s="oGa2",e(s,o- -657)](X(815,787-1163- -663))})}},{group:!0})),a(i[et("^x^y",570)](tt("U%Z0",1138),t=>{var e,o,i,a,s,n,l,r;q=t[l="59#q",r=-356,et(l,r- -741)][s=243,n=108,B(n- -856,s)],J=t[i=602,a=746,ct(a- -396,i)][e=1408,o=1271,ct(e-264,o)]}));const at={handleEvent(t){const e=o[n(1192,1017)](t);let a=e.y;function s(t,e){return j(e,t- -250)}function n(t,e){return ct(e- -194,t)}let l=e.x;function r(t,e){return X(t,e- -335)}function c(t,e){return et(e,t- -33)}t[s(540,"jT@(")]&&(l=l||a,a=0);const d=i[s(346,"$rux")](c(372,"lW!@"));let h=!1;function u(t,e){return X(e,t- -268)}function m(t,e){return st(t- -186,e)}function f(t,e){return tt(e,t- -1348)}function g(t,e){return et(t,e-415)}function p(t,e){return B(t- -1030,e)}if((a>0&&100===Math[c(411,"a$cj")](d[c(289,"C[V1")][m(999,"lpXA")])||a<0&&0===Math[c(445,"f(p1")](d[n(1003,948)][p(-150,-290)])||a&&!d[w(-184,-78)][w(-255,-411)]||l>0&&100===Math[n(943,778)](d[s(463,"]5A!")][f(-164,")&@T")])||l<0&&0===Math[r(-284,-169)](d[u(89,142)][s(321,"(813")])||l&&!d[p(-47,-211)][c(560,"dU#d")])&&(h=!0),!h&&t[r(-50,40)](),t[s(413,"URpn")]||e.x){const t=o[m(909,"s^TA")]();return void(l>0?i[g("C[V1",977)](g("0iMP",832))?o[p(-16,11)](t[s(527,"lpXA")]+l*q):o[n(1096,1e3)](t[m(981,"6moZ")]+q):i[g("WYGU",823)](s(444,"qoev"))?o[c(551,"]5A!")](t[s(511,"G9Y1")]+l*q):o[u(120,104)](t[u(153,146)]-q))}function w(t,e){return y(t- -701,e)}const b=o[n(930,1012)]();if(a>0)if(i[r(-226,-161)](c(494,"#1(F"))){const t=i[g("r%*n",1021)](g("lpXA",862));let e=0;e=t?a/t*J:a*J,o[u(-92,-223)](b[u(16,-124)]+e)}else o[u(-92,20)](b[w(-99,-123)]+J);else if(i[m(950,"dU#d")](n(794,839))){const t=i[m(1049,"s^TA")](s(604,"r%*n"));let e=0;e=t?a/t*J:a*J,o[w(-344,-233)](b[u(16,-55)]+e)}else o[f(-274,"r%*n")](b[m(937,"#1(F")]-J)},passive:!1};function st(t,e){return ft(t-790,e)}const nt=Object[M(-232,"teYa")](Object[st(1280,"wrQI")]({},e),{api:o,state:i,componentName:x});r(t=>{for(const e in t)nt[e]=t[e]});const lt=s[j("dU#d",891)](P,nt),rt=o[et("WYGU",418)](M(-372,"dU#d"),t,e);function ct(t,e){return pt(t-631,e)}return a(rt[X(138,161)]),()=>H?rt[z(-330,-189)](st(1414,"a3NZ"),l`
            <div
              data-info-url="https://github.com/neuronetio/gantt-schedule-timeline-calendar"
              class=${D[ct(1111,966)]}
              style=${D[tt("oGa2",983)][X(280,234)]()}
              data-actions=${lt()}
              @wheel=${at}
            >
              ${rt[st(1390,"f(p1")](j("BGwI",727),l` ${L[ct(1213,1280)]()}${O[j("m&ua",853)]()} `)}
            </div>
          `):v}let bt;!function(){const t=gt();function e(t,e){return pt(t- -833,e)}function o(t,e){return pt(t-101,e)}function i(t,e){return ft(t-752,e)}function a(t,e){return ft(t- -412,e)}function s(t,e){return ft(e- -455,t)}function n(t,e){return pt(e-352,t)}function l(t,e){return pt(t- -596,e)}for(;;)try{if(257036===parseInt(n(569,664))/1+parseInt(n(722,813))/2*(parseInt(i(1207,"0iMP"))/3)+parseInt(s("s^TA",93))/4+parseInt(o(426,474))/5*(-parseInt(e(-549,-612))/6)+parseInt(o(391,237))/7+-parseInt(o(414,382))/8*(-parseInt(l(-240,-256))/9)+-parseInt(a(105,"kjdD"))/10)break;t.push(t.shift())}catch(e){t.push(t.shift())}}();let vt=0,yt=null;function Dt(){return null!==yt&&0!==yt.byteLength||(yt=new Uint8Array(bt.memory.buffer)),yt}const xt="undefined"!=typeof TextEncoder?new TextEncoder("utf-8"):{encode:()=>{throw Error("TextEncoder not available")}},Pt="function"==typeof xt.encodeInto?function(t,e){return xt.encodeInto(t,e)}:function(t,e){const o=xt.encode(t);return e.set(o),{read:t.length,written:o.length}};function Wt(t,e,o){if(void 0===o){const o=xt.encode(t),i=e(o.length,1)>>>0;return Dt().subarray(i,i+o.length).set(o),vt=o.length,i}let i=t.length,a=e(i,1)>>>0;const s=Dt();let n=0;for(;n<i;n++){const e=t.charCodeAt(n);if(e>127)break;s[a+n]=e}if(n!==i){0!==n&&(t=t.slice(n)),a=o(a,i,i=n+3*t.length,1)>>>0;const e=Dt().subarray(a+n,a+i);n+=Pt(t,e).written,a=o(a,i,n,1)>>>0}return vt=n,a}let Ct=null;function $t(){return(null===Ct||!0===Ct.buffer.detached||void 0===Ct.buffer.detached&&Ct.buffer!==bt.memory.buffer)&&(Ct=new DataView(bt.memory.buffer)),Ct}const It="undefined"!=typeof TextDecoder?new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}):{decode:()=>{throw Error("TextDecoder not available")}};function St(t,e){return t>>>=0,It.decode(Dt().subarray(t,t+e))}function Gt(t,e){try{return t.apply(this,e)}catch(t){const e=function(t){const e=bt.__externref_table_alloc();return bt.__wbindgen_export_5.set(e,t),e}(t);bt.__wbindgen_exn_store(e)}}"undefined"!=typeof TextDecoder&&It.decode();const Mt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_license_free(t>>>0,1));const zt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_licensedate_free(t>>>0,1));const Lt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_licensekeyresult_free(t>>>0,1));const Ot="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_licenseresult_free(t>>>0,1));const Rt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_licensetype_free(t>>>0,1));const Tt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_productinfo_free(t>>>0,1));const kt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_signedlicense_free(t>>>0,1));function At(){const t={wbg:{}};return t.wbg.__wbg_String_8f0eb39a4a4c2f66=function(t,e){const o=Wt(String(e),bt.__wbindgen_malloc,bt.__wbindgen_realloc),i=vt;$t().setInt32(t+4,i,!0),$t().setInt32(t+0,o,!0)},t.wbg.__wbg_error_7534b8e9a36f1ab4=function(t,e){let o,i;try{o=t,i=e,console.error(St(t,e))}finally{bt.__wbindgen_free(o,i,1)}},t.wbg.__wbg_new_8a6f238a6ece86ea=function(){return new Error},t.wbg.__wbg_new_d684b6b3189ca362=function(){return new Object},t.wbg.__wbg_parse_bcc0320de0fc537a=function(){return Gt(function(t,e){return JSON.parse(St(t,e))},arguments)},t.wbg.__wbg_set_3f1d0b984ed272ed=function(t,e,o){t[e]=o},t.wbg.__wbg_stack_0ed75d68575b0f3c=function(t,e){const o=Wt(e.stack,bt.__wbindgen_malloc,bt.__wbindgen_realloc),i=vt;$t().setInt32(t+4,i,!0),$t().setInt32(t+0,o,!0)},t.wbg.__wbindgen_init_externref_table=function(){const t=bt.__wbindgen_export_5,e=t.grow(4);t.set(0,void 0),t.set(e+0,void 0),t.set(e+1,null),t.set(e+2,!0),t.set(e+3,!1)},t.wbg.__wbindgen_string_new=function(t,e){return St(t,e)},t.wbg.__wbindgen_throw=function(t,e){throw new Error(St(t,e))},t}function _t(t,e){return bt=t.exports,Ht.__wbindgen_wasm_module=e,Ct=null,yt=null,bt.__wbindgen_start(),bt}async function Ht(t){if(void 0!==bt)return bt;void 0!==t&&Object.getPrototypeOf(t)===Object.prototype&&({module_or_path:t}=t);const e=At();("string"==typeof t||"function"==typeof Request&&t instanceof Request||"function"==typeof URL&&t instanceof URL)&&(t=fetch(t));const{instance:o,module:i}=await async function(t,e){if("function"==typeof Response&&t instanceof Response){if("function"==typeof WebAssembly.instantiateStreaming)try{return await WebAssembly.instantiateStreaming(t,e)}catch(e){if("application/wasm"==t.headers.get("Content-Type"))throw e;console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",e)}const o=await t.arrayBuffer();return await WebAssembly.instantiate(o,e)}{const o=await WebAssembly.instantiate(t,e);return o instanceof WebAssembly.Instance?{instance:o,module:t}:o}}(await t,e);return _t(o,i)}var Nt=Object.freeze({__proto__:null,parse_license_key:function(t,e){const o=Wt(t,bt.__wbindgen_malloc,bt.__wbindgen_realloc),i=vt,a=Wt(e,bt.__wbindgen_malloc,bt.__wbindgen_realloc),s=vt;return bt.parse_license_key(o,i,a,s)},License:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Mt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_license_free(t,0)}},LicenseDate:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,zt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_licensedate_free(t,0)}},LicenseKeyResult:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Lt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_licensekeyresult_free(t,0)}},LicenseResult:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Ot.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_licenseresult_free(t,0)}},LicenseType:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Rt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_licensetype_free(t,0)}},ProductInfo:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Tt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_productinfo_free(t,0)}},SignedLicense:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,kt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_signedlicense_free(t,0)}},initSync:function(t){if(void 0!==bt)return bt;void 0!==t&&Object.getPrototypeOf(t)===Object.prototype&&({module:t}=t);const e=At();return t instanceof WebAssembly.Module||(t=new WebAssembly.Module(t)),_t(new WebAssembly.Instance(t,e),t)},default:Ht});
/**
