...
const q={width:0,height:0};let Q,K,J;class Z{constructor(t){Q||(Q=new ie(()=>{const e=t.clientWidth,n=t.clientHeight;q.width===e&&q.height===n||(q.width=e,q.height=n,i.update("$data.dimensions",q))}),Q.observe(t),i.update("$data.elements.main",t))}update(){}destroy(t){Q.unobserve(t)}}m.includes(Z)||m.push(Z),o(()=>{Q.disconnect()}),o(i.subscribe("config.scroll",t=>{K=t.horizontal.multiplier,J=t.vertical.multiplier}));const tt={handleEvent(t){const e=n.normalizeMouseWheelEvent(t);if(t.shiftKey||e.x){const t=e.x?e.x:e.y,i=n.getScrollLeft();return void(t>0?n.setScrollLeft(i.dataIndex+K):n.setScrollLeft(i.dataIndex-K))}const i=n.getScrollTop();e.y>0?n.setScrollTop(i.dataIndex+J):n.setScrollTop(i.dataIndex-J)},passive:!0},et=Object.assign(Object.assign({},e),{api:n,state:i}),nt=s.create(m,et),it=n.generateSlots("main",t,e);return o(it.destroy),()=>k_k_k?it.html("outer",l`
            <div
              ...
              @wheel=${tt}
            >
              ${it.html("content",l` ${L.html()}${N.html()} `)}
            </div>
