import{d as t,u as e,a as o,S as i,A as a,h as s,l as n,v as l,D as r,_ as c,m as d,b as h,c as u,p as m,P as g,e as f,f as p,g as w,V as v}from"./vendor.esm.min.js";
/**
 ...
 */function G(t,e){const{onDestroy:o,state:i,cache:s,api:n,html:l,StyleMap:r,Actions:c,update:d}=t,h="scroll-bar";let u,m,g="",f="";o(i.subscribe("config.classNames",()=>{u=n.getClass(h),m=n.getClass(h+"-inner")}));const p="horizontal"===e.type?"height":"width",w="height"===p?"width":"height",v="horizontal"===e.type?"left":"top",b=new r({}),y=new r({}),D={maxPosPx:0,innerHandleSize:0,scrollSize:0,dataId:""};o(i.subscribeAll("horizontal"===e.type?[`config.scroll.${e.type}`,`$data.scroll.${e.type}`]:[`config.scroll.${e.type}`,`$data.scroll.${e.type}`,"$data.chart.dimensions.heightWithoutScrollBar","$data.list.rowsWithParentsExpanded","$data.list.rowsHeight","config.additionalSpace"],function(t,o){const a=i.get(`config.scroll.${e.type}`),s=i.get(`$data.scroll.${e.type}`),l=n.getScrollSize(e.type),r=s.innerHandleSize,c=s.maxHandlePosPx,h=s.dataId,u=i.get("config.additionalSpace"),m=i.get("$data.chart.time");if(!m.allDates||!m.allDates.length||!m.allDates[m.level])return;if(s.visible?b.style.display="flex":b.style.display="none",b.style[p]=a.width+"px",b.style[w]=l+"px","vertical"===e.type&&(b.style.top=i.get("config.headerHeight")+u.top+"px"),!s.lastPageSize||!s.absoluteSize||!l)return;y.style[p]="100%",y.style[w]=r+"px";!("set-scroll-top"===o.options.data||"set-scroll-left"===o.options.data)&&function(t,e,o,i){const a=D.maxPosPx!==t||D.innerHandleSize!==e||D.scrollSize!==o||D.dataId!==i;return a&&(D.maxPosPx=t,D.innerHandleSize=e,D.scrollSize=o,D.dataId=i),a}(c,r,l,h)&&("horizontal"===e.type?a.byPixels?n.setScrollLeft(s.absolutePosPx):n.setScrollLeft(s.dataIndex,s.preciseOffset):a.byPixels?n.setScrollTop(s.absolutePosPx):n.setScrollTop(s.dataIndex,s.preciseOffset)),d()},{group:!0,bulkValue:!1}));const x=n.getActions(h);x.push(class extends a{constructor(t){super();const o=`$data.elements.scroll-bar--${e.type}`;i.get(o)||i.update(o,t,{only:null})}update(){}destroy(){}});const P={api:n,state:i,props:e,componentName:h},W=c.create(x,P),C=[class extends a{constructor(t){super(),this.moving=!1,this.initialPointerPos=0,this.initialHandlePos=0,this.currentPos=0,this.currentPointerPos=0,this.lastDataIndex=0,this.lastOffset=0,this.dataIndex=0,this.previousRowId="",i.update(`$data.elements.scroll-bar-inner--${e.type}`,t,{only:null}),this.bodyClassName=i.get("config.scroll.bodyClassName"),this.pointerDown=this.pointerDown.bind(this),this.pointerUp=this.pointerUp.bind(this);const o=this.pointerMove.bind(this);this.pointerMove=o,this.unsubscribe=i.subscribe(`$data.scroll.${e.type}`,this.dataChanged.bind(this)),this.destroy=this.destroy.bind(this),t.addEventListener("pointerdown",this.pointerDown),document.addEventListener("pointermove",this.pointerMove),document.addEventListener("pointerup",this.pointerUp)}destroy(t){this.unsubscribe(),t.removeEventListener("pointerdown",this.pointerDown),document.removeEventListener("pointermove",this.pointerMove),document.removeEventListener("pointerup",this.pointerUp)}dataChanged(){const t=i.get(`$data.scroll.${e.type}`),o=i.get("$data.chart.time");if(!o.allDates.length)return;const a=o.allDates[o.level],s=t.dataIndex;if(this.lastDataIndex=s,"horizontal"===e.type&&a&&a.length)this.currentPos=t.handlePosPx,y.style[v]=this.currentPos+"px",d();else if("vertical"===e.type){if(!i.get("$data.list.rowsWithParentsExpanded").length)return;this.currentPos=t.handlePosPx,y.style[v]=this.currentPos+"px",d()}}limitPosition(t){return Math.max(Math.min(t,i.get(`$data.scroll.${e.type}.maxHandlePosPx`)),0)}pointerDown(t){t.stopPropagation(),t.preventDefault(),n.muteMethod("calculateRowsHeight"),document.body.classList.add(this.bodyClassName),requestAnimationFrame(()=>{this.moving=!0,this.initialPointerPos="horizontal"===e.type?t.pageX:t.pageY,this.initialHandlePos=i.get(`$data.scroll.${e.type}.handlePosPx`),f=" "+n.getClass(h)+"-inner--active",g=" "+n.getClass(h)+"--active",d()})}pointerUp(t){this.moving&&(n.unmuteMethod("calculateRowsHeight"),t.preventDefault(),t.stopPropagation(),document.body.classList.remove(this.bodyClassName)),this.moving=!1,f="",g="",d()}pointerMoveRead(t){this.currentPointerPos="horizontal"===e.type?t.pageX:t.pageY}pointerMoveWrite(){const t=i.get(`config.scroll.${e.type}`),o=i.get(`$data.scroll.${e.type}`),a=this.currentPointerPos-this.initialPointerPos;this.currentPos=this.limitPosition(this.initialHandlePos+a);const s=i.get("$data.chart.time");if(!s.allDates.length)return;const l=s.allDates[s.level],r=this.currentPos/o.maxHandlePosPx*o.absoluteSizeWithoutLastPage,c=Math.round(r);if("horizontal"===e.type){let e,o=0,i=0,a=0;for(let t=l.length;o<t&&(e=l[o],a=Math.round(e.rightPx),!(a>c));o++);t.precise&&a!==c&&(i=e.leftPx-r),o||(o=0),e||(e=l[0]),this.dataIndex=o,this.lastDate=l[o],t.byPixels?n.setScrollLeft(r):n.setScrollLeft(e.id,i),this.lastDataIndex=o,this.lastOffset=i}else{const{dataIndex:e,row:o,rowData:i}=n.getRowInfoFromTop(r);let a=0;t.precise&&i.position.top!==r&&(a=i.position.top-r),this.dataIndex=e,this.previousRowId=o.id,t.byPixels?n.setScrollTop(r):n.setScrollTop(e,a),this.lastDataIndex=e,this.lastOffset=a}}pointerMove(t){this.moving&&(t.stopPropagation(),t.preventDefault(),requestAnimationFrame(()=>{this.pointerMoveRead(t)}),requestAnimationFrame(()=>{this.pointerMoveWrite()}))}}],$=c.create(C,P),I=n.generateSlots(h,t,e);function S({classNameOuter:t,classNameOuterActive:e,classNameInner:o,classNameInnerActive:i,styleMapInner:a,styleMapOuter:s,innerActions:n,outerActions:l,slots:r,cache:c,html:d,vido:h,props:u}){return c(!u||!u.type?null:r.html("outer",d`
            ...
            `))}let M=S;return o(i.subscribe(`config.templates.${h}`,t=>{M=null!=t?t:S,d()})),()=>M({innerActions:$,outerActions:W,classNameOuter:u,classNameOuterActive:g,classNameInner:m,classNameInnerActive:f,cache:s,styleMapInner:y,styleMapOuter:b,slots:I,html:l,vido:t,props:e})}
/**
 * List component
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */class R{constructor(t,e){let o=!1,i=e.state.get("$data.elements.list-columns");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.list-columns",i,{only:null})}destroy(t,e){e.state.update("$data.elements.list-columns",e=>e.filter(e=>e!==t),{only:null})}}function L(t,e){const{api:o,state:i,onDestroy:a,onChange:s,cache:n,Actions:l,update:r,createComponent:c,reuseComponents:d,html:h,StyleMap:u}=t,m=[];let g,f;m.push(i.subscribe("config.components.ListColumnRow",t=>g=t)),m.push(i.subscribe("config.components.ListColumnHeader",t=>f=t));const p=Object.assign(Object.assign({},e),{api:o,state:i,componentName:"list-column"}),w={column:e.column,state:i,api:o,componentName:"list-column-headers"},v={api:o,state:i,componentName:"list-column-rows"},b="list-column",y=b+"-rows",D=b+"-rows-offset",x=o.getActions(b),P=o.getActions(y),W=o.getClass(b,e.column.id),C=o.getClass(D,e.column.id),$=o.getClass(y,e.column.id);let I,S=o.getId(b,e&&e.column?e.column.id:"");const M=new u({width:"","--width":""}),G=new u({height:""}),z=new u({"margin-top":"0px"});let L=i.get("config.additionalSpace");const T=o.generateSlots(b,t,e);let O;function A(){if(!e||!e.column)return;const t=i.get("config.list");if(!t.columns.data[e.column.id])return;I=t.columns.data[e.column.id].width*t.columns.percent*.01,O=I;const a=Math.round(o.getRealChartHeight());M.style.width=O+"px",M.style["--width"]=O+"px",z.style.height=a+"px",G.style.top=i.get("config.headerHeight")+L.top+"px"}a(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar","$data.list.width","$data.list.visibleRowsHeight","config.additionalSpace.top"],A,{group:!0}));const k=c(f,e);a(k.destroy);const _=[],H={};function V(){var t;if(!e||!e.column)return;i.mute(V);const a=i.get("$data.list.visibleRows")||[],s=o.getRows(a),n=o.getRowsData();for(const o of s){const i=H[o.id]=null!==(t=H[o.id])&&void 0!==t?t:{};i.column=e.column,i.row=o,i.rowData=n[o.id],i.width=O}for(const t in H)a.includes(t)||delete H[t];d(_,s,t=>t&&H[t.id],g,!0),T.change(e),i.unmute(V)}s(t=>{if((e=t)&&e.column&&e.column.id){S=o.getId(b,e&&e.column?e.column.id:"");for(const t in e)p[t]=e[t];A(),k.change(e),V()}}),a(i.subscribeAll(["$data.list.visibleRows","$data.list.visibleRowsHeight","$data.list.rows","config.list.rows","config.chart.items.*.height","config.chart.items.*.rowId","config.chart.items.*.time"],V,{group:!0,bulkValue:!1})),a(i.subscribe("$data.scroll.vertical.preciseOffset",t=>{z.style.transform=`translateY(${Math.round(t)||0}px)`,r()})),a(i.subscribe("config.additionalSpace",t=>{L=t})),a(()=>{_.forEach(t=>t.destroy()),m.forEach(t=>t())}),x.push(R);const N=l.create(x,w),E=l.create(P,v);function B({className:t,classNameOffset:e,classNameContainer:o,containerStyleMap:i,offsetStyleMap:a,widthStyleMap:s,visibleRows:n,rowActions:l,elId:r,headerActions:c,ListColumnHeader:d,html:h,cache:u,vido:m,props:g}){return u(g&&g.column?T.html("outer",h`
              <div
                class=${t}
      ...
      `)} `)}
            ...
            `):null)}let j=B;return a(i.subscribe(`config.templates.${b}`,t=>{j=null!=t?t:B,r()})),()=>j({classNameOffset:C,offsetStyleMap:z,visibleRows:_,classNameContainer:$,containerStyleMap:G,rowActions:E,className:W,elId:S,headerActions:N,widthStyleMap:M,ListColumnHeader:k,html:h,cache:n,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */function T(t,e){const{api:o,state:i,onDestroy:a,cache:s,onChange:n,Actions:l,update:r,createComponent:c,html:d,StyleMap:h}=t,u="list-column-header",m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:u}),g=o.getActions(u),f=[];let p;f.push(i.subscribe("config.components.ListColumnHeaderResizer",t=>p=t));const w=c(p,e);let v;f.push(i.subscribe("config.components.ListColumnRowExpander",t=>v=t));const b=c(v,e);a(()=>{w.destroy(),b.destroy(),f.forEach(t=>t())});const y=o.generateSlots(u,t,e),D=o.getClass(u),x=o.getClass(u+"-content");let P=o.getId(u,e.column.id);n(t=>{e=t;for(const t in e)m[t]=e[t];P=o.getId(u,e.column.id),w.change(e),b.change(e),y.change(t)});const W=new h({height:"","--height":"","--paddings-count":""});a(i.subscribe("config.headerHeight",()=>{const t=i.get("config");W.style.height=t.headerHeight+"px",W.style["--height"]=t.headerHeight+"px",W.style["--paddings-count"]="1",r()}));const C=l.create(g,m);function $({className:t,contentClass:e,styleMap:o,elId:i,cache:a,ListColumnRowExpander:s,ListColumnHeaderResizer:n,actions:l,slots:r,html:c,vido:d,props:h}){return a(!h||!h.column?null:r.html("outer",c`
              <div
                class=${t}
      ...
      `:c` <div class=${e}>${n.html(h.column)}</div> `)}
            ...
            `))}let I=$;return a(i.subscribe(`config.templates.${u}`,t=>{I=null!=t?t:$,r()})),()=>I({className:D,contentClass:x,cache:s,styleMap:W,elId:P,ListColumnRowExpander:b,ListColumnHeaderResizer:w,actions:C,slots:y,html:d,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */function O(t,e){const{api:o,state:i,onDestroy:a,cache:s,update:n,html:l,Actions:r,onChange:c,PointerAction:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-header-resizer",g=o.getActions(m),f=o.getActions(m+"-dots"),p={up:"",down:""};let w,v,b,y;a(i.subscribe("config.list.sort.icons",t=>{p.up=o.getSVGIconSrc(t.up),p.down=o.getSVGIconSrc(t.down)})),w=o.getClass(m),v=o.getClass(m+"-container"),b=o.getClass(m+"-dots"),y=o.getClass(m+"-dots-dot");const D=o.getClass(m+"-sort-icon");let x;const P=new h({});let W=!1;const C=o.generateSlots(m,t,e);let $=!0,I=0;const S={componentName:m,column:e.column,api:o,state:i,pointerOptions:{axis:"x",onMove:function({movementX:t,event:o}){if(!$)return;t&&(o.preventDefault(),o.stopPropagation());let a=i.get("config.list.columns.minWidth");"number"==typeof e.column.minWidth&&(a=e.column.minWidth),I+=t,I<a&&(I=a),W&&i.update(`config.list.columns.data.${e.column.id}.width`,I)}}};function M(){if(!e||!e.column||!e.column.id)return;S.column=e.column,w=o.getClass(m,e.column.id),v=o.getClass(m+"-container",e.column.id),b=o.getClass(m+"-dots",e.column.id),y=o.getClass(m+"-dots-dot",e.column.id),$=!("resizer"in e.column)||e.column.resizer;const t=i.get("config.list");x=I=e.column.width*t.columns.percent*.01,P.style["--width"]=t.columns.resizer.width+"px",W=t.columns.resizer.inRealTime,i.update("$data.list.width",x),C.change(e),n()}c(t=>{e=t,M()}),a(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],M,{group:!0}));let G=[1,2,3,4,5,6,7,8];a(i.subscribe("config.list.columns.resizer.dots",t=>{G=[];for(let e=0;e<t;e++)G.push(e);n()}));let z=!0;function R(){e.column.sortable&&(z=!z,i.update("config.list.sort",t=>(t.activeColumnId=e.column.id,t.asc=z,t)))}let L=!1;a(i.subscribe("config.list.sort",t=>{if(t.activeColumnId===e.column.id)return z=t.asc,void(L=!0);L=!1})),f.push(d);const T=r.create(g,S),O=r.create(f,S);function A({className:t,containerClass:e,iconClass:o,dotsClass:i,dotClass:a,dotsStyleMap:s,dots:n,onLabelClick:l,dotsActions:r,resizer:c,icons:d,sortActive:h,cache:u,asc:m,actions:g,slots:f,html:p,unsafeHTML:w,vido:v,props:b}){const y=!b||!b.column;function D(){return b.column.sortable&&h?m?p` <img src="${d.down}" class=${o} /> `:p` <img src="${d.up}" class=${o} /> `:null}function x(){return y?null:"function"==typeof b.column.header.content?b.column.header.content({column:b.column,vido:v}):b.column.header.content}return u(y?null:f.html("outer",p`
      ...
      `)}
            ...
            `))}let k=A;return a(i.subscribe(`config.templates.${m}`,t=>{k=null!=t?t:A,n()})),()=>k({className:w,containerClass:v,onLabelClick:R,iconClass:D,cache:s,dotsClass:b,dotsStyleMap:P,dotsActions:O,dots:G,dotClass:y,resizer:$,icons:p,sortActive:L,asc:z,actions:T,slots:C,html:l,unsafeHTML:u,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */class A{constructor(t,e){let o=e.state.get("$data.elements.list-column-rows"),i=!1;void 0===o&&(i=!0,o=[]),o.includes(t)||(o.push(t),i=!0),i&&e.state.update("$data.elements.list-column-rows",o,{only:null})}destroy(t,e){e.state.update("$data.elements.list-column-rows",e=>e.filter(e=>e!==t),{only:null})}}function k(t,e){const{api:o,state:i,onDestroy:a,cache:s,Actions:n,update:l,html:r,createComponent:c,onChange:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-row",g=Object.assign(Object.assign({},e),{api:o,state:i,componentName:m});let f,p=!1;a(i.subscribe("config.components.ListColumnRowExpander",t=>f=t));const w=new h(e.column.expander?{height:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{height:"",top:"","--height":""}),v=c(f,{row:e.row}),b=o.getClass(m),y=o.getClass(m+"-content");let D=o.getClass(m);const x=o.generateSlots(m,t,e);let P;d(function(a,s){var n;if(s.leave||!a||void 0===a.row||void 0===a.column)return p=!0,x.change(a,s),void l();p=!1,e=a;for(const t in e)g[t]=e[t];if(!e.column||!e.row||!e.rowData)return p=!0,x.change(a,s),void l();if(void 0===e.column||void 0===e.row)return;P=e.column.isHTML?void 0===e.row?null:"function"==typeof e.column.data?u(e.column.data({row:e.row,vido:t})):"function"==typeof e.row[e.column.data]?u(e.row[e.column.data]({row:e.row,vido:t})):"string"==typeof e.row[e.column.data]?u(e.row[e.column.data]):null:void 0===e.row?null:"function"==typeof e.column.data?e.column.data({row:e.row,vido:t}):"function"==typeof e.row[e.column.data]?e.row[e.column.data]({row:e.row,vido:t}):e.row[e.column.data];const r=i.get("config.list.expander");for(const t in w.style)delete w.style[t];w.style.height=e.rowData.outerHeight+"px",w.style["--height"]=e.rowData.outerHeight+"px",e.column.expander&&(w.style["--expander-padding-width"]=r.padding*(e.rowData.parents.length+1)+"px");const c=i.get("config.list.rows");for(const t of e.rowData.parents){const e=c[t];if("object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children){const t=e.style.children;for(const e in t)w.style[e]=t[e]}}if(null===(n=null==e?void 0:e.row)||void 0===n?void 0:n.style)for(const t in e.row.style)w.style[t]=e.row.style[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)D=o.getClass(m)+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const i=e.row.classNames({row:e.row,vido:t});Array.isArray(i)&&i.length&&(D=o.getClass(m)+" "+i.join(" "))}}else D=b;v&&v.change(e),x.change(e,s),l()}),a(()=>{v&&v.destroy()});const W=o.getActions(m);W.includes(A)||W.push(A);const C=n.create(W,g);function $({classNameCurrent:t,classNameContent:e,styleMap:o,cache:i,shouldDetach:a,content:s,ListColumnRowExpander:n,slots:l,actions:r,html:c,vido:d,props:h}){return i(a||!h||!h.column||!h.row?null:l.html("outer",c`
              <div
                class=${t}
            ...
            `))}let I=$;return a(i.subscribe(`config.templates.${m}`,t=>{I=null!=t?t:$,l()})),()=>I({classNameCurrent:D,cache:s,shouldDetach:p,styleMap:w,ListColumnRowExpander:v,classNameContent:y,slots:x,actions:C,content:P,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */function _(t,e){const{api:o,state:i,onDestroy:a,Actions:s,html:n,cache:l,createComponent:r,onChange:c,update:d}=t,h="list-column-row-expander",u=o.getActions(h),m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:h}),g=o.getClass(h);let f;const p=i.subscribe("config.components.ListColumnRowExpanderToggle",t=>f=t),w=r(f,e);a(()=>{w.destroy(),p()});const v=o.generateSlots(h,t,e);e.row&&c(function(t){if((e=t)&&e.row&&e.rowData){for(const t in e)m[t]=e[t];w.change(e),v.change(t),d()}});const b=s.create(u,m);function y({className:t,ListColumnRowExpanderToggle:e,slots:o,actions:i,html:a,cache:s,vido:n,props:l}){return s(!l?null:o.html("outer",a`
              <div class=${t} data-gstcid=${l.row?l.row.id:""} data-action=${i()}>
                ${o.html("content",e.html())}
              </div>
            `))}let D=y;return a(i.subscribe(`config.templates.${h}`,t=>{D=null!=t?t:y,d()})),()=>D({className:g,ListColumnRowExpanderToggle:w,slots:v,actions:b,html:n,cache:l,vido:t,props:e})}
/**
 ...
 */function H(t,e){const{api:o,state:i,cache:a,onDestroy:s,Actions:n,update:l,html:r,onChange:c}=t,d="list-column-row-expander-toggle",h=Object.assign(Object.assign({},e),{api:o,state:i,componentName:d}),u=o.getActions(d),m=o.getClass(d),g=o.getClass(d+"-child"),f=o.getClass(d+"-open"),p=o.getClass(d+"-closed");let w,v,b,y=!1;s(i.subscribe("$data.list.expander.icons",t=>{t&&(w=t.child,v=t.open,b=t.closed),l()}));const D=o.generateSlots(d,t,e);e.row?(c(function(t){if(e&&e.row){e=t;for(const t in e)h[t]=e[t];y=e.row.expanded,D.change(t),l()}}),s(function(){})):s(i.subscribe("config.list.rows.*.expanded",function(t){for(const e of t)if(e.value){y=!0;break}l()},{bulk:!0}));const x=n.create(u,h);function P(){y=!y,e.row?i.update(`config.list.rows.${e.row.id}.expanded`,y,{data:{name:"expanded",rowId:e.row.id,expanded:y}}):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=y;return t},{only:["*.expanded"],data:{name:"expanded"}})}function W({className:t,classNameChild:e,classNameOpen:o,classNameClosed:i,expanded:a,iconChild:s,iconOpen:n,iconClosed:l,toggle:r,cache:c,slots:d,actions:h,html:u,vido:m,props:g}){return c(!g?null:d.html("outer",u`
            ...
            `));var f,p}let C=W;return s(i.subscribe(`config.templates.${d}`,t=>{C=null!=t?t:W,l()})),()=>C({className:m,classNameChild:g,iconChild:w,expanded:y,cache:a,classNameOpen:f,classNameClosed:p,iconOpen:v,iconClosed:b,toggle:P,slots:D,actions:x,html:r,vido:t,props:e})}
/**
 ...
 */function V(t,e={}){const{html:o,onDestroy:i,api:a,state:s,update:n,StyleMap:l,Actions:r,onChange:c}=t,d="list-toggle",h=a.getClass(d),u=Object.assign(Object.assign({},e),{api:a,state:s,componentName:d});let m={open:"",close:""};i(s.subscribe("$data.list.toggle.icons",t=>{t&&(m=t,n())}));const g=new l({top:"0px"});i(s.subscribe("$data.scroll.vertical.preciseOffset",t=>{g.style.top=(-1*Math.round(t)||0)+"px"}));let f=!0;i(s.subscribe("config.list.columns.percent",t=>f=0!==t));let p=!1;function w(){p=!0}function v(){p&&(p=!1,s.update("config.list.columns.percent",t=>0===t?100:0))}c(t=>{e=t;for(const o in t)u[o]=e[o]});const b=a.getActions(d),y=r.create(b,u),D=a.generateSlots(d,t,e);function x({className:t,styleMap:e,pointerDown:o,pointerUp:i,open:a,toggleIconsSrc:s,actions:n,slots:l,html:r,vido:c,props:d}){return l.html("outer",r`
      ...
      `)}let P=x;return i(s.subscribe(`config.templates.${d}`,t=>{P=null!=t?t:x,n()})),()=>P({className:h,styleMap:g,pointerDown:w,pointerUp:v,open:f,toggleIconsSrc:m,actions:y,slots:D,html:o,vido:t,props:e})}
/**
 * Chart component
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */function N(t,e={}){const{api:o,state:i,onDestroy:a,Actions:s,html:n,createComponent:l,update:r}=t,c="chart",d=[];let h,u,m;d.push(i.subscribe("config.components.ChartCalendar",t=>h=t)),d.push(i.subscribe("config.components.ChartTimeline",t=>u=t)),d.push(i.subscribe("config.components.ScrollBar",t=>m=t));const g=l(h);a(g.destroy);const f=l(u);a(f.destroy);const p=l(m,{type:"horizontal"});a(p.destroy);const w=l(m,{type:"vertical"});a(w.destroy),a(()=>{d.forEach(t=>t())});const v=o.getClass(c),b=o.getActions(c);let y=!1;a(i.subscribe("config.chart.time.calculatedZoomMode",t=>{y=t,r()}));const D={handleEvent:function(t){t.type},passive:!1,capture:!1};let x,P=0;b.push(function(t){x||(x=new ResizeObserver(()=>{const e=t.offsetWidth,o=t.offsetHeight,a=e-i.get("config.scroll.horizontal.width"),s=i.get("config.headerHeight");P!==e&&(P=e,i.update("$data.chart.dimensions",t=>(t.width=e,t.widthWithoutScrollBar=a,t.height=o,t.innerHeight=o-s,t)))}),x.observe(t),i.update("$data.elements.chart",t))}),a(()=>{x.disconnect()});const W={api:o,state:i,componentName:c},C=s.create(b,W),$=o.generateSlots(c,t,e);function I({className:t,onWheel:e,ChartCalendar:o,ChartTimeline:i,ScrollBarVertical:a,calculatedZoomMode:s,ScrollBarHorizontal:n,actions:l,slots:r,html:c,vido:d,props:h}){return r.html("outer",c`
      ...
      `)}let S=I;return a(i.subscribe(`config.templates.${c}`,t=>{S=null!=t?t:I,r()})),()=>S({className:v,onWheel:D,ChartCalendar:g,ChartTimeline:f,ScrollBarVertical:w,calculatedZoomMode:y,ScrollBarHorizontal:p,actions:C,slots:$,html:n,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */function E(t,e){const{api:o,state:i,onDestroy:a,Actions:s,update:n,reuseComponents:l,html:r,StyleMap:c}=t,d="chart-calendar",h=o.getActions(d),u=Object.assign(Object.assign({},e),{api:o,state:i,componentName:d}),m=i.get("config.components.ChartCalendarDate"),g=o.getClass(d);let f;const p=new c({height:"","--headerHeight":"","margin-left":""});a(i.subscribe("config.headerHeight",t=>{f=t,p.style.height=f+"px",p.style["--calendar-height"]=f+"px",n()}));let w=[],v=0;a(i.subscribeAll(["$data.chart.time.levels","config.chart.time","$data.chart.time","config.chart.calendarLevels"],()=>{const t=i.get("$data.chart.time.levels");let e=0;if(t.length!==v){v=t.length,w.forEach(t=>t.forEach(t=>t.destroy())),w=[];for(let t=0;t<v;t++)w.push([])}for(const i of t){if(!i.length)continue;let t="YYYY-MM-DD HH";switch(i[0].period){case"day":t="YYYY-MM-DD";break;case"week":t="YYYY-MM-ww";break;case"month":t="YYYY-MM";break;case"year":t="YYYY"}const a=o.time.date().format(t);l(w[e],i,o=>o&&{level:e,date:o,currentDate:a,currentDateFormat:t},m,!0),e++}n()},{bulk:!0,bulkValue:!1})),a(()=>{w.forEach(t=>t.forEach(t=>t.destroy()))}),h.push(t=>{i.update("$data.elements.chart-calendar",t)});const b=s.create(h,u),y=o.generateSlots(d,t,e);function D({className:t,styleMap:e,components:o,actions:i,slots:a,html:s,vido:n,props:l}){return a.html("outer",s`
      ...
      `)}let x=D;return a(i.subscribe(`config.templates.${d}`,t=>{x=null!=t?t:D,n()})),()=>x({className:g,styleMap:p,components:w,actions:b,slots:y,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */class B extends a{constructor(t,e){super(),e.state.update("$data.elements.chart-calendar-dates",e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e))}}function j(t,e){const{api:o,state:i,onDestroy:a,Actions:s,update:n,onChange:l,html:r,StyleMap:c,cache:d}=t,h="chart-calendar-date",u=o.getActions(h),m=o.getClass(h);let g,f="",p="";l(()=>{g=i.get("config.chart.time")});const w=new c({width:"0px"},{schedule:!1});let v="";let b=!1;const y=o.generateSlots(h,t,e);let D,x;const P={date:e.date,period:e.period,api:o,state:i,componentName:h};l((t,o)=>{if(o.leave)return b=!0,y.change(t,o),n();b=!1,D=e.level===g.level,x=D?m+"--main-date ":m+"--non-main-date ",e=t,P.date=e.date,P.period=e.period,function(){if(!e||!e.date)return;const t=i.get(`config.chart.calendarLevels.${e.level}`);w.style.width=e.date.currentView.width+"px",w.style.left=e.date.currentView.leftPx+"px";const o=t.find(t=>+g.zoom<=+t.zoomTo);f=e.date.current?" gstc-current":e.date.next?" gstc-next":e.date.previous?" gstc-previous":"",p=m+"-content "+m+`-content--${e.date.period}`+f,o.classNames&&Array.isArray(o.classNames)?(p+=" "+o.classNames.join(" "),v=" "+o.classNames.join(" ")):v="",n()}(),y.change(t,o)}),u.includes(B)||u.push(B);const W=s.create(u,P);function C({className:t,mainClass:e,additionalClass:o,formatClassName:i,finalClassName:a,styleMap:s,cache:n,shouldDetach:l,actions:r,slots:c,html:d,vido:h,props:u}){return n(l||!u||!u.date?null:c.html("outer",d`
              <div
            ...
            `))}let $=C;return a(i.subscribe(`config.templates.${h}`,t=>{$=null!=t?t:C,n()})),()=>$({className:m,mainClass:x,additionalClass:f,formatClassName:v,styleMap:w,finalClassName:p,cache:d,shouldDetach:b,actions:W,slots:y,html:r,vido:t,props:e})}
/**
 ...
 */function F(t,e){const{api:o,state:i,onDestroy:a,Action:s,Actions:n,update:l,html:r,createComponent:c,StyleMap:d}=t,h="chart-timeline",u=Object.assign(Object.assign({},e),{api:o,state:i,componentName:h});let m,g,f;a(i.subscribe("config.components.ChartTimelineGrid",t=>{m&&m.destroy(),m=c(t)})),a(()=>{m&&m.destroy()}),a(i.subscribe("config.components.ChartTimelineItems",t=>{g&&g.destroy(),g=c(t)})),a(()=>{g&&g.destroy()}),a(i.subscribe("config.components.ListToggle",t=>{f&&f.destroy(),f=c(t)})),a(()=>{f&&f.destroy()});const p=o.generateSlots(h,t,e),w=o.getClass(h),v=o.getClass(h+"-inner");let b;a(i.subscribe("config.list.toggle.display",t=>b=t));const y=new d({}),D=new d({});let x,P;a(i.subscribe("config.additionalSpace",t=>{x=t,l()})),a(i.subscribe("config.headerHeight",t=>{P=t,l()})),a(i.subscribeAll(["$data.chart.dimensions.heightWithoutScrollBar","$data.scroll.vertical.offset","$data.chart.dimensions.width","$data.list.visibleRowsHeight","$data.chart.time.dates.day","config.headerHeight","config.additionalSpace"],function(){const t=i.get("$data.chart.dimensions.width"),e=Math.round(o.getRealChartHeight(!0));y.style.height=i.get("config.innerHeight")+"px",y.style["--height"]=y.style.height,y.style.top=x.top+P+"px",t?(y.style.width=t+"px",y.style["--width"]=t+"px"):(y.style.width="0px",y.style["--width"]="0px"),D.style.height=e+"px",D.style.width=t?t+"px":"0px";const a=i.get("$data.scroll.vertical.preciseOffset")||0;D.style.transform=`translateY(${Math.round(a)}px)`,l()},{group:!0,bulkValue:!1}));let W=[];a(i.subscribe("config.actions.chart-timeline",t=>{W=t})),W.push(class extends s{constructor(t){super();i.get("$data.elements.chart-timeline")!==t&&i.update("$data.elements.chart-timeline",t)}});const C=n.create(W,u);function $({className:t,classNameInner:e,styleMap:o,innerStyleMap:i,Grid:a,Items:s,showToggle:n,ListToggle:l,actions:r,slots:c,html:d,vido:h,props:u}){return c.html("outer",d`
      ...
      `)}let I=$;return a(i.subscribe(`config.templates.${h}`,t=>{I=null!=t?t:$,l()})),()=>I({className:w,styleMap:y,classNameInner:v,Grid:m,innerStyleMap:D,Items:g,showToggle:b,ListToggle:f,actions:C,slots:p,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */class Y{constructor(t,e){e.state.get("$data.elements.chart-timeline-grid")!==t&&e.state.update("$data.elements.chart-timeline-grid",t,{only:null})}destroy(t,e){e.state.update("$data.elements",t=>(delete t["chart-timeline-grid"],t),{only:null})}}function q(t,e){const{api:o,state:i,onDestroy:a,Actions:s,update:n,html:l,reuseComponents:r,StyleMap:c}=t,d="chart-timeline-grid",h=o.getActions(d),u={api:o,state:i,componentName:d},m=i.get("config.components.ChartTimelineGridRow"),g=o.getClass(d);let f;a(i.subscribe("config.chart.grid.cell.onCreate",t=>f=t));const p=[],w={},v=new Map,b=new c({});function y(t){let e=t.month()+1;e<10&&(e="0"+e);let o=t.date();o<10&&(o="0"+o);let i=t.hour();i<10&&(i="0"+i);let a=t.minute();a<10&&(a="0"+a);let s=t.second();return s<10&&(s="0"+s),`${t.year()}-${e}-${o}T${i}-${a}-${s}`}a(i.subscribeAll(["$data.scroll.vertical.preciseOffset","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar"],function(){const t=i.get("$data.chart.dimensions.width"),e=o.getRealChartHeight();b.style.height=Math.round(e)+"px",b.style.width=t+"px"},{group:!0}));let D="",x=0,P=0,W="",C=0,$="",I=0,S=0;function M(){const t=o.getGridRows();r(p,t||[],t=>t,m,!0),n()}a(i.subscribeAll(["$data.list.rowsHeight","$data.list.visibleRows","$data.list.visibleRowsHeight","$data.chart.time.levels","$data.scroll","config.list.rows;","config.list.rows.*;"],function(e,a){const s=i.get("$data.chart.time"),n=i.get(`$data.chart.time.levels.${s.level}`),l=s.levels[s.level];if(!l||!l.length)return;const r=s.levels[s.level].map(t=>t.currentView.width).join(",");if(!n||0===n.length)return void i.update("$data.chart.grid",{rows:{},cells:{}});const c=o.getRowsData(),d=i.get("$data.list.visibleRows"),h=d.map(t=>c[t].outerHeight).join("|"),u=d.join("|"),m=i.get("$data.scroll");if(u===D&&x===s.leftGlobal&&P===s.rightGlobal&&h===W&&C===n.length&&$===r&&m.horizontal.handlePosPx===I&&m.vertical.handlePosPx===S)return"$data.chart.time.levels"===a.path.listener?M():void 0;I=m.horizontal.handlePosPx,S=m.vertical.handlePosPx,x=s.leftGlobal,P=s.rightGlobal,$=r,W=h;let g=0;if(u!==D)for(const t in w)delete w[t];else if(C!==n.length)for(const t in w)w[t].cells.length=0;C=n.length;const p=o.getAllRows(),b=i.get("$data.chart.grid.cells");for(const t in b)delete b[t];for(const e of d){const o=p[e],i=c[e];if(!o||!i)continue;let a,s;u!==D?a=[]:(a=w[e].cells,a.length=0);for(const e of n){let s;v.has(e.leftGlobal)?s=v.get(e.leftGlobal):(s=y(e.leftGlobalDate),v.set(e.leftGlobal,s));const n=o.id+"-"+s;let l;if(b[n])l=b[n],l.id=n,l.time=e,l.row=o,l.rowData=i,l.top=g,l.vido=t,l.content=null;else{const a=Object.create(null);a.id=n,a.time=e,a.row=o,a.rowData=i,a.top=g,a.vido=t,a.content=null,l=a}for(const t of f)l.content=t(l);b[l.id]=l,a.push(l.id)}w[e]?(s=w[e],s.row=o,s.rowData=i,s.cells=a,s.top=g):s={row:o,rowData:i,cells:a,top:g},w[e]=s,g+=i.outerHeight}D=u,i.update("$data.chart.grid",{rows:w,cells:b})},{group:!0,bulkValue:!1})),a(i.subscribe("$data.chart.grid",M,{group:!0})),a(()=>{p.forEach(t=>t.destroy())}),h.push(Y);const G=s.create(h,u),z=o.generateSlots(d,t,e);function R({className:t,styleMap:e,rowsComponents:o,actions:i,slots:a,html:s,vido:n,props:l}){return a.html("outer",s`
        <div class=${t} data-actions=${i()} style=${e.directive()}>
          ${a.html("content",o.map(t=>t.html()))}
        </div>
      `)}let L=R;return a(i.subscribe(`config.templates.${d}`,t=>{L=null!=t?t:R,n()})),()=>L({className:g,styleMap:b,rowsComponents:p,actions:G,slots:z,html:l,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */class U{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-grid-rows");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-grid-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-grid-rows",e=>e.filter(e=>e!==t),{only:null})}}function K(t,e){const{api:o,state:i,onDestroy:a,cache:s,Actions:n,update:l,html:r,reuseComponents:c,onChange:d,StyleMap:h}=t,u="chart-timeline-grid-row",m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:u});let g;a(i.subscribe("config.components.ChartTimelineGridRowCell",t=>g=t));const f=o.getActions(u),p=o.getClass(u),w=new h({height:e.row.height+"px"});let v=!1;const b=o.generateSlots(u,t,e),y=[];d(function(t,i){if(!t||i.leave||void 0===t.row)return v=!0,c(y,[],t=>t,g,!0),b.change(t,i),void l();v=!1,e=t;const a=o.getGridCells(e.cells);if(c(y,a,t=>t,g,!0),w.setStyle({}),w.style.height=e.rowData.outerHeight+"px",e.row.style)for(const t in e.row.style)w.style[t]=e.row.style[t];for(const t in e)m[t]=e[t];b.change(t,i)}),a(function(){y.forEach(t=>t.destroy())}),-1===f.indexOf(U)&&f.push(U);const D=n.create(f,m);function x({className:t,styleMap:e,rowsCellsComponents:o,cache:i,shouldDetach:a,actions:s,slots:n,html:l,vido:r,props:c}){return i(a||!c||!c.row?null:n.html("outer",l`
              <div
                class=${t}
            ...
            `))}let P=x;return a(i.subscribe(`config.templates.${u}`,t=>{P=null!=t?t:x,l()})),()=>P({className:p,styleMap:w,rowsCellsComponents:y,cache:s,shouldDetach:v,actions:D,slots:b,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */class Z{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-grid-row-cells");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-grid-row-cells",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-grid-row-cells",e=>e.filter(e=>e!==t),{only:[""]})}}function Q(t,e){const{api:o,state:i,cache:a,Actions:s,html:n,onChange:l,onDestroy:r,StyleMap:c,update:d}=t,h="chart-timeline-grid-row-cell",u=Object.assign(Object.assign({},e),{api:o,state:i,componentName:h});let m=!1;const g=o.getActions(h),f=o.generateSlots(h,t,e);let p;function w(t){p=o.getClass(h),t&&t.time&&t.time.current&&(p+=" current")}w(e);const v=new c({width:"",height:""});l(function(t,o){var i,a;if(!t||o.leave||void 0===t.row)return m=!0,f.change(t,o),void d();m=!1,e=t;for(const t in e)u[t]=e[t];if(w(e),v.setStyle({}),e&&e.row){if(v.style.width=((null===(a=null===(i=null==e?void 0:e.time)||void 0===i?void 0:i.currentView)||void 0===a?void 0:a.width)||0)+"px",e.row.style)for(const t in e.row.style)v.style[t]=e.row.style[t];f.change(e,o),d()}}),g.push(Z);const b=s.create(g,u);function y({className:t,styleMap:e,cache:o,shouldDetach:i,actions:a,slots:s,html:n,vido:l,props:r}){var c;return o(i||!r||!r.id?null:s.html("outer",n`
              <div class=${t} data-gstcid=${r.id} data-actions=${a()} style=${e.directive()}>
                ${s.html("content",null!==(c=r&&r.content)&&void 0!==c?c:null)}
              </div>
            `))}let D=y;return r(i.subscribe(`config.templates.${h}`,t=>{D=null!=t?t:y,d()})),()=>D({className:p,styleMap:v,cache:a,shouldDetach:m,actions:b,slots:f,html:n,vido:t,props:e})}
/**
 ...
 */class X{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-items-rows");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t),{only:null})}}function tt(t,e){const{api:o,state:i,onDestroy:a,cache:s,Actions:n,update:l,html:r,onChange:c,reuseComponents:d,StyleMap:h}=t,u="chart-timeline-items-row",m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:u});let g;a(i.subscribe("config.components.ChartTimelineItemsRowItem",t=>g=t));let f="";const p=[],w=new h({width:"",height:""});let v=!1;function b(t=e.rowData,o=null){const a=i.get("$data.chart");v=!1,w.style.width=a.dimensions.width+"px",e?(w.style.height=t.outerHeight+"px",w.style["--row-height"]=t.outerHeight+"px",l()):v=!0}function y(t,e){if(!t||!e)return v=!0,d(p,[],()=>null,g,!0),l();const i=e.items;if(void 0===i)return v=!0,d(p,[],()=>null,g,!0),b(),l();const a=o.getItems(i).filter(t=>o.isItemHorizontallyInViewport(t));d(p,a,e=>({row:t,item:e,itemData:e?o.getItemData(e.id):null}),g,!0),b(),l()}const D=o.getClass(u),x=o.generateSlots(u,t,e);c(function(o,i){if(i.leave||!o||void 0===o.row)return v=!0,d(p,[],()=>null,g,!0),x.change(o,i),l();e=o;for(const t in e)m[t]=e[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)f=D+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const o=e.row.classNames({row:e.row,vido:t});Array.isArray(o)&&o.length&&(f=D+" "+o.join(" "))}}else f=D;y(e.row,e.rowData),x.change(o,i),l()}),a(i.subscribe("$data.chart.dimensions.width",()=>y(e.row,e.rowData))),a(()=>{p.forEach(t=>t.destroy())});const P=o.getActions(u);P.push(X);const W=n.create(P,m);function C({classNameCurrent:t,styleMap:e,shouldDetach:o,itemComponents:i,actions:a,slots:s,cache:n,html:l,vido:r,props:c}){return n(o||!c||!c.row?null:s.html("outer",l`
            ...
            `))}let $=C;return a(i.subscribe(`config.templates.${u}`,t=>{$=null!=t?t:C,l()})),()=>$({cache:s,shouldDetach:v,classNameCurrent:f,styleMap:w,itemComponents:p,actions:W,slots:x,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */class et{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-items-row-items");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-row-items",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t),{only:null})}}function ot(t,e){const{api:o,state:i,cache:a,onDestroy:s,Actions:n,update:l,html:r,onChange:c,unsafeHTML:d,StyleMap:h}=t;let u,m,g=0,f=0;s(i.subscribe("config.chart.spacing",t=>{"number"==typeof t?(f=t,g=0):("number"==typeof t.left&&(g=t.left),"number"==typeof t.right&&(f=t.right)),l()}));const p="chart-timeline-items-row-item";let w=0,v=0,b=!1,y="";const D=new h({width:"",height:"",left:"",top:""}),x=new h({}),P=new h({}),W={item:e.item,itemData:e.itemData,row:e.row,left:w,width:v,api:o,state:i,componentName:p},C=o.getClass(p),$=o.getClass(p+"-label"),I=o.generateSlots(p,t,e);let S,M=!1;s(i.subscribe("config.chart.item.cutIcons",t=>{S={left:o.getSVGIconSrc(t.left),right:o.getSVGIconSrc(t.right)}}));const G=o.getClass(`${p}-cut`)+" "+o.getClass(`${p}--left-cut-icon`),z=o.getClass(`${p}-cut-image`),R=()=>r`
    <div class=${G} style=${x.directive()}>
      <img src="${S.left}" width="18" height="18" class=${z} />
    </div>
  `,L=o.getClass(`${p}-cut`)+" "+o.getClass(`${p}--right-cut-icon`),T=o.getClass(`${p}-cut-image`),O=()=>r`
    <div class=${L} style=${P.directive()}>
      <img src="${S.right}" width="18" height="18" class=${T} />
    </div>
  `;c(function(a,s){if(s.leave||void 0===a.row||void 0===a.item)return b=!0,M=!0,I.change(a,s),l();M=!1,b=!1,(e=a).item.id===u&&e.row.id===m||(u=e.item.id,m=e.row.id),W.item=e.item,W.itemData=e.itemData,W.row=e.row,function(){var a;if(M)return l();const s=i.get("$data.chart.time");if(b||0===s.levels.length||!s.levels[s.level]||0===s.levels[s.level].length)return M=!0,l();if(!e.item||!e.itemData)return M=!0,l();if(!i.get().$data.chart.verticallyVisibleItems.includes(e.item.id))return M=!0,l();const n=e.itemData;if(w=n.position.actualLeft+g,v=n.actualWidth-f-g,e.item.time.end<s.leftGlobal||e.item.time.start>s.rightGlobal||v<=0)return M=!0,n.detached=M,l();if(y=C,e.item.time.start<s.leftGlobal?(x.style.display="flex",y+=" "+o.getClass(p+"--left-cut")):x.style.display="none",e.item.time.end>s.rightGlobal?(P.style.display="flex",y+=" "+o.getClass(p+"--right-cut")):P.style.display="none",e.item.classNames)if(Array.isArray(e.item.classNames)&&e.item.classNames.length)y+=" "+e.item.classNames.join(" ");else if("function"==typeof e.item.classNames){const o=e.item.classNames({item:e.item,vido:t});Array.isArray(o)&&(y+=" "+o.join(" "))}const r=D.style.width,c=D.style.left,d=D.style.top,h=D.style.height;D.setStyle({});const u=o.isItemHorizontallyInViewport(e.item,s.leftGlobal,s.rightGlobal);if(M=!u,n.detached=M,u?(D.style.width=v+"px",D.style.left=w+"px",D.style.top=n.position.actualRowTop+"px",D.style.height=n.actualHeight+"px"):(D.style.width=r,D.style.left=c,D.style.top=d,D.style.height=h),null===(a=null==e?void 0:e.item)||void 0===a?void 0:a.style)for(const t in e.item.style)D.style[t]=e.item.style[t];W.left=w,W.width=v,l()}(),I.change(a,s),l()});const A=o.getActions(p);A.push(et);const k=n.create(A,W);function _(){return e.item?e.item.isHTML?e.item&&e.item.label?"function"==typeof e.item.label?d(e.item.label({item:e.item,vido:t})):"string"==typeof e.item.label?d(e.item.label):null:null:e.item&&e.item.label?"function"==typeof e.item.label?e.item.label({item:e.item,vido:t}):e.item.label:null:null}function H({className:t,labelClassName:e,styleMap:o,cache:i,shouldDetach:a,cutterLeft:s,cutterRight:n,getContent:l,actions:r,slots:c,html:d,vido:h,props:u}){return i(a||!u||!u.item?null:c.html("outer",d`
              <div
                class=${t}
            ...
            `))}let V=H;return c(()=>{const t=i.get(`config.templates.${p}`);V=null!=t?t:H,l()}),()=>V({className:y,labelClassName:$,cache:a,shouldDetach:M,styleMap:D,cutterLeft:R,cutterRight:O,getContent:_,actions:k,slots:I,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-08-16
 * @license   SEE LICENSE IN LICENSE FILE
 */function gt(t,e){const o=wt();return gt=function(e,i){let a=o[e-=156];if(void 0===gt.qMSdkS){const e=function(t,e){let o,i,a=[],s=0,n="";for(t=function(t){let e="",o="";for(let o,i,a=0,s=0;i=t.charAt(s++);~i&&(o=a%4?64*o+i:i,a++%4)?e+=String.fromCharCode(255&o>>(-2*a&6)):0)i="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(i);for(let t=0,i=e.length;t<i;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)}(t),i=0;i<256;i++)a[i]=i;for(i=0;i<256;i++)s=(s+a[i]+e.charCodeAt(i%e.length))%256,o=a[i],a[i]=a[s],a[s]=o;i=0,s=0;for(let e=0;e<t.length;e++)i=(i+1)%256,s=(s+a[i])%256,o=a[i],a[i]=a[s],a[s]=o,n+=String.fromCharCode(t.charCodeAt(e)^a[(a[i]+a[s])%256]);return n};gt.wGuvlj=e,t=arguments,gt.qMSdkS=!0}const s=e+o[0],n=t[s];return n?a=n:(void 0===gt.xjPsQC&&(gt.xjPsQC=!0),a=gt.wGuvlj(a,i),t[s]=a),a},gt(t,e)}function ft(t,e){const o=wt();return ft=function(e,i){let a=o[e-=156];if(void 0===ft.DZBPdC){ft.ymrXBh=function(t){let e="",o="";for(let o,i,a=0,s=0;i=t.charAt(s++);~i&&(o=a%4?64*o+i:i,a++%4)?e+=String.fromCharCode(255&o>>(-2*a&6)):0)i="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(i);for(let t=0,i=e.length;t<i;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)},t=arguments,ft.DZBPdC=!0}const s=e+o[0],n=t[s];return n?a=n:(a=ft.ymrXBh(a),t[s]=a),a},ft(t,e)}function pt(t,e){const{api:o,state:i,onDestroy:a,Actions:s,createComponent:n,html:l,onChange:r,update:v}=t;function b(t,e){return ft(e- -582,t)}let y;const D=mt(t,d);D[z(-264,-112)]();const x=$(63,"XxR4");let P;a(i[z(-98,-74)](z(-23,-108),t=>P=t));const W=l`
    <br />
  ...
  `;function $(t,e){return gt(t- -101,e)}const I=l`
    <div class="gstc-error">
  ...
  `,S=[];let M,G;function z(t,e){return ft(t- -422,e)}S[T(-138,-212)](i[X(585,552)](X(682,527),t=>M=t)),S[st(401,"@45l")](i[z(-98,-36)](z(31,17),t=>G=t));const R=n(M);function L(t,e){return gt(e- -249,t)}function T(t,e){return ft(e- -566,t)}a(()=>{var t,e;R&&R[(t="](ln",e=-11,st(e- -585,t))]()});const O=n(G);a(()=>{var t,e;O&&O[(t=-323,e=-271,b(e,t- -86))]()}),a(()=>{var t,e;S[(t=-117,e=-44,X(t,e- -442))](t=>t())});const{onDestroy:A,state:k,update:_,html:H,unsafeHTML:V}=t;var N=!0;function E(t,e){return gt(e- -84,t)}const B=H`<strong>[gantt-schedule-timeline-calendar component]</strong><br /><br />`;function j(t,e=""){const o=$(86- -230,"s3QI");var i,a;return H` <div class="${o}">${B}${t}${e?H`<br />${typeof e===(i=1002,a=1147,T(a,i-1217))?V(e):e}`:null}</div> `}function F(t){return c(this,void 0,void 0,function*(){function a(t,e){return gt(t-167,e)}function s(t){function e(t,e){return gt(t- -213,e)}return(t=String(t))[e(109,"Mdx)")]((a=-13,s=-58,ft(a- -173,s)),"")[(o=1065,i=935,ft(i-484,o))](e(153,"Hui5"),"");var o,i,a,s}function n(t){function e(t,e){return ft(e-506,t)}const o=(t=s(t))[e(1008,840)](":");function i(t,e){return gt(e-834,t)}o>-1&&(t=t[e(825,695)](0,o));const a=m(t);return a[(r=310,c=247,ft(c- -141,r))]===g[e(732,682)]&&a[i("0hK6",1266)]&&a[e(765,691)]&&(t=a[(n=235,l=401,ft(l-10,n))]+"."+a[i("^LgK",1076)][i("ULcn",995)](".")),t;var n,l,r,c}let l=location[a(465,"H*%3")];function r(t,e){return ft(t-150,e)}const c=function(){function t(t,e){return ft(t-811,e)}function e(t,e){return gt(e-602,t)}function o(t,e){return ft(e- -439,t)}if(void 0!==location[n(1359,"wgUW")])return[...location[o(-163,-282)]];const i=[];function a(t,e){return gt(e- -184,t)}let s=window;function n(t,e){return gt(t-918,e)}function l(t,e){return gt(e-809,t)}for(;s!==window[o(27,-68)];){if(s[a("c9M#",171)][e("ULcn",812)])try{const e=new URL(s[t(1295,1194)][o(135,3)]);i[l("RU5x",1186)](e[n(1205,"8Mu3")])}catch(t){}s=s[n(1110,"Hui5")]}return i}();function d(t,e){return ft(e- -521,t)}function v(t,e){return gt(e- -880,t)}function b(t,e){return ft(t-766,e)}if(i[G(-105,"S8pR")](S(1558,1459),[l,...c]),c[a(627,"^LgK")]&&(l=String(c[c[a(400,"o9Pg")]-1])),l[P(-10,-109)](P(-13,33)))return N=!1,void(y=I);if(l=s(l),t[z("&AIV",-195)](P(-56,-161))){let s,h;const u=i[P(44,48)](r(382,456));if(e&&e[G(-207,"z9*3")]&&typeof e[v("o9Pg",-483)]===d(-88,-45))h=yield e[x(996,"S8pR")]()[b(925,1003)](t=>{function e(t,e){return x(e- -748,t)}function o(t,e){return d(e,t-911)}function i(t,e){return G(e- -60,t)}function a(t,e){return b(e- -786,t)}function n(t,e){return d(t,e-900)}N=!1,u&&console[n(733,638)](n(795,786),t);let l=n(628,615);function c(t,e){return r(t-170,e)}var h,m;typeof t[a(100,207)]===e("Qs4)",400)&&(t[e("CNcZ",319)][n(711,560)](c(549,622))||t[(h=605,m=767,b(m- -226,h))][i("c9M#",-179)](i("#fHR",-357))||t[c(547,486)][a(162,161)](o(693,703)))&&(l=o(808,845)),s=j(l)});else{N=!1,u&&console[z("c9M#",-177)](z("Qs4)",-245),e);const t=b(1002,1038);s=j(t)}if(s)return N=!1,void(y=s);let m;try{const e=x(937,"fIZQ");m=h[b(1035,923)](t,e)}catch(t){N=!1;const e=v("o9Pg",-642);return void(y=j(e,t[G(-306,"RU5x")]))}if(!m.ok){N=!1;const t=G(-53,"8Mu3");return void(y=j(t,m[v("o59d",-570)]))}const g=m[P(-15,-99)];if(g&&g[a(378,"#fHR")]&&g[r(580,415)]instanceof Map&&(g[x(1103,"JAjT")]=Object[v("@45l",-413)](g[G(-270,"l#!r")][b(1030,914)]()),g[v("6qrr",-659)][x(879,"fIZQ")]instanceof Map&&(g[P(144,15)][d(-168,-72)]=Object[v(")DA6",-572)](g[S(1348,1406)][P(101,34)][P(-19,-151)]())),g[d(-146,-91)][S(1416,1302)]instanceof Map&&(g[x(1152,"s3QI")][x(847,"HOIb")]=Object[b(1174,1102)](g[S(1496,1406)][x(1137,"CRdW")][v("CRdW",-484)]()))),i[a(592,"KGpN")](z("WMq4",-253),g),g[r(518,425)][d(-411,-280)]!==P(-32,-144)){N=!1;const t=x(910,"s3QI");return void(y=j(t))}const f=o[b(1017,1020)][G(-232,"z9*3")]()[G(-335,"SURp")]();if(g[S(1431,1308)][x(985,"l#!r")]<f){N=!1;const t=b(1223,1321);return void(y=j(t))}let p=l;if(g[z("&AIV",-170)][v(")DA6",-508)]){p=n(l);const t=c[G(-12,"&jXj")](t=>n(t));if(t[P(-185,-157)])for(const e of g[a(507,"7xEs")][r(367,522)]){const o=e[S(1432,1354)](">")[x(942,"&AIV")]()[d(-100,-169)](t=>n(t)),i=o[d(-203,-171)](),s=n(location[P(0,22)]);if(!o[b(1024,855)]||!t[x(1142,"gS0h")]||o[a(406,"&jXj")]!==t[z("ULcn",-360)]||s!==i)continue;let l=0,r=0;for(const e of o){e===t[r]&&l++,r++}if(l===c[S(1358,1234)])return}}if(!g[S(1321,1406)][d(-284,-304)][a(526,"Hui5")](l)&&!g[x(1009,")DA6")][d(-375,-304)][r(331,257)](p)){let t=!1;for(const e of g[b(1196,1315)][b(983,1007)]){if(e[x(881,"%y@3")](".*")){const o=e[x(1069,"^LgK")](0,e[d(-301,-187)](".*")+1);if(l[z("](ln",-372)](o)){t=!0;break}}if(e[r(331,338)]("*")){const o=e[v("%y@3",-607)](".","\\.")[x(1025,"l#!r")]("*",".*");if(new RegExp(o)[z("o59d",-319)](l)){t=!0;break}}}if(!t){N=!1;const t=b(1061,1066)+l+"'.";return void(y=j(t,d(-89,-177)+g[a(580,"](ln")][G(-247,"&jXj")][b(1078,1050)](", ")+a(494,"S@Y]")))}}if(!g[r(580,492)][b(1092,1173)][z(")DA6",-399)]){if(i[z("c9M#",-382)](x(998,"8Mu3"))[G(-240,"%y@3")](".")[0]!==g[v("s3QI",-578)][b(1128,1012)][P(-147,-37)](".")[0]){N=!1;const t=z("5]^f",-465);return void(y=j(t))}}return}const D=x(1037,"^LgK");function x(t,e){return gt(t-667,e)}function P(t,e){return ft(e- -415,t)}const $=d(-135,-186);function S(t,e){return ft(e-976,t)}const M=w;function G(t,e){return gt(t- -500,e)}function z(t,e){return gt(e- -656,t)}if(t){if(t[r(456,354)](v("l#!r",-436)))return function(){function e(t,e){return S(e,t- -1567)}let o=null;try{const a=t[s(914,"CNcZ")](5),l=h[R("](ln",-774)](a,D)[n(583,676)](f);o=JSON[n(693,698)](l),o&&i[s(1047,"c9M#")](I(866,712),{for:o[R("LyGs",-749)],domains:[...o[w(272,"8Mu3")]],type:Object[e(-129,-271)]({},o[P(257,421)]),validUntil:Object[P(331,423)]({},o[n(798,657)])})}catch(t){}if(!o||!o[I(845,830)]||!o[n(729,657)][P(166,78)]){N=!1;const t=w(275,")DA6");return void(y=j(t,W))}if(!o[C(335,375)]){N=!1;const t=s(1016,"0hK6");return void(y=j(t,W))}function s(t,e){return z(e,t-1357)}function n(t,e){return b(e- -313,t)}function r(t,e){return x(t- -1403,e)}const c=function(t){function e(t,e){return x(t- -192,e)}const o=Object[e(814,"00&&")]({},t);var i,a,s,n;return delete o[(i="Ue10",a=1330,v(i,a-1804))],delete o[e(643,"5]^f")],JSON[(s=-543,n="0hK6",x(s- -1486,n))](o)}(o);if(!function(t,e){if(!t||!e)return!1;const o=new M({});return o[(s="gmm^",n=240,G(n-347,s))]($),o[(i=1032,a=1149,b(a-204,i))](e,t,p);var i,a,s,n}(o[n(688,827)],c)){N=!1;const t=e(-395,-232);return void(y=j(t,W))}const u=(new Date)[I(1068,1152)]();function w(t,e){return v(e,t-792)}function P(t,e){return b(t- -897,e)}function C(t,e){return d(t,e-522)}if(o[r(-514,"o9Pg")][e(-294,-320)]<u){N=!1;const t=n(870,910);return void(y=j(t,W))}function I(t,e){return S(e,t- -335)}function R(t,e){return G(e- -448,t)}if(o[r(-380,"fcaT")][r(-411,"7xEs")]===R("Ue10",-641)||o[L(-396,"LyGs")][w(189,"H*%3")]===s(1084,"^LgK")){const t=l[I(975,1048)](":");t>-1&&(l=l[I(857,925)](0,t));const e=m(l);e[w(94,"0hK6")]===g[w(204,"qU6x")]&&e[I(1032,935)]&&e[I(826,699)]&&(l=e[P(260,202)]+"."+e[C(71,186)][R("w@lv",-792)]("."))}function L(t,e){return a(t- -948,e)}if(!o[n(733,670)][L(-515,"dOMc")](l)){N=!1;const t=s(910,"gmm^")+l+r(-490,"fIZQ");return void(y=j(t,W))}}();const e=r(573,684),s=encodeURIComponent,n=(new Date)[S(1300,1416)](),c=h[d(-186,-71)](n,D),w=z("](ln",-472),I=u(n+l,w,{keySize:16})[S(1360,1199)](),R=[s(x(857,"H*%3"))+"="+s(t),s(v("wgUW",-468))+"="+s(l),s(x(952,"S@Y]"))+"="+s(location[d(-401,-315)]),s(x(1053,"7[KE"))+"="+s(c),s(a(540,"c9M#"))+"="+s(e),s(x(891,"XxR4"))+"="+s(navigator[S(1371,1243)])][r(462,595)]("&"),L=a(354,"7xEs");window[b(1187,1343)](L,{method:z("5]^f",-269),redirect:v(")DA6",-673),headers:{"Content-Type":d(-208,-145)},body:R})[S(1202,1196)](t=>{var e,o,i,s;return 200!==t[(e="dOMc",o=-755,a(o- -1130,e))]&&(N=!1,y=C),t[(i="#fHR",s=147,x(s- -748,i))]()})[G(-265,"gS0h")](a=>{function n(t,e){return v(e,t-1518)}function c(t,e){return b(e- -1516,t)}function d(t,e){return x(e- -848,t)}function h(t,e){return r(t-345,e)}function u(t,e){return x(e- -1559,t)}if(a&&a.ok)if(a[u("fcaT",-464)]&&a[$(770,"S8pR")]===I)N=!0,i[d("Mdx)",59)](D(650,706),()=>{var t,e;var i,s,n,l,r,c,h,m,g,f;function p(t,e){return d(t,e- -716)}function w(t,e){return D(e,t- -377)}return{registeredDomains:a[(g=-86,f="wgUW",u(f,g-316))],validUntil:{text:a[(h="Ue10",m=166,u(h,m-796))],value:o[p("5]^f",-614)][p("KGpN",-617)](a[w(308,375)])[w(421,296)]()},type:null!==(t=a[(r=442,c=433,D(c,r- -427))])&&void 0!==t?t:{text:(n=711,l=733,D(l,n- -185)),value:w(518,546)},for:null!==(e=a[(i=20,s=92,D(s,i- -885))])&&void 0!==e?e:""}});else{N=!1;const o=d("l#!r",250);y=j(o,W);const i=D(568,715),m=[s(h(720,565))+"="+s(t),s(n(824,"LyGs"))+"="+s(l),s(c(-384,-544))+"="+s(location[w(-145,-217)]),s((f=475,p=571,r(p-219,f)))+"="+s(e),s(h(870,748))+"="+s(String(a[w(-243,-141)])),s($(823,"c9M#"))+"="+s(I),s(u("JAjT",-579))+"="+s(navigator[u("@45l",-704)])][w(-58,-111)]("&");window[h(916,790)](i,{method:d("fcaT",2),redirect:n(916,"%y@3"),headers:{"Content-Type":D(804,857)},body:m})}else if(a){N=!1;const t=V(a[w(-73,-196)][c(-264,-299)](/\n/gi,h(949,960)));let e=null;a[w(-159,-58)]&&(e=V(a[(m=165,g="RU5x",z(g,m-411))][c(-180,-299)](/\n/gi,h(949,805))));const o=n(981,"o9Pg");y=H` <div class="${o}"><strong>${B} ${t}</strong><br />${e}<br />${W}</div> `}else N=!1,y=C;var m,g,f,p;function w(t,e){return P(t,e- -8)}function D(t,e){return r(e-331,t)}function $(t,e){return z(e,t-1231)}_()})[v("](ln",-679)](()=>{N=!1,y=C,_()})}else{N=!1;const t=v("Hui5",-654),e=r(355,437);y=H` <div class="${e}">${B} ${t}${W}</div> `}})}function Y(t,e){return gt(e- -300,t)}A(k[b(-138,-258)](st(376,"qU6x"),t=>{function e(t,e){return et(e-758,t)}F(t)[e(199,67)](()=>{_()})[e(-138,6)](t=>{N=!1;const o=r("o59d",922);var a,s,n,l;function r(t,e){return gt(e-561,t)}y=j(o),i[(n=331,l=361,e(n,l-51))](gt(-415- -837,"7xEs"))&&console[(a=-442,s=-505,e(s,a- -548))](r("8Mu3",930),t),_()}),_()}));const q={width:0,height:0},U={width:0,height:0};let K,Z,Q,J;function X(t,e){return ft(e-228,t)}function tt(t){const e=t[o(938,945)];function o(t,e){return z(e-966,t)}const a=t[o(712,867)];var s,n,l,r,c,d,h,u,m,g;(q[(m=-768,g=-614,et(g- -67,m))]!==e||q[(h=-313,u="RU5x",$(h- -668,u))]!==a)&&(q[(c=1289,d=1301,z(c-1347,d))]=e,q[(l=1008,r="KGpN",st(l-637,r))]=a,i[(s="dOMc",n=721,st(n-383,s))](E("8Mu3",-134- -212),q))}function et(t,e){return ft(t- -911,e)}class ot{constructor(t){var e,o,a,s;!K&&(K=new ResizeObserver(()=>{tt(t)}),K[(a="fIZQ",s=402,E(a,s-214))](t),i[(e="K9Uv",o=-46,E(e,o- -139))](X(643,622-176),t),tt(t))}[T(-192,-132)](){}[z(-77,57)](t){var e,o;K[(e=212,o=346,z(o-482,e))](t)}}function it(t){function e(t,e){return st(e- -926,t)}function o(t,e){return T(e,t-151)}const a=t[e("%y@3",-646)],s=t[n("JAjT",-119)];function n(t,e){return st(e- -580,t)}(U[e("5]^f",-376)]!==a||U[o(-240,-128)]!==s)&&(U[n("dOMc",-325)]=a,U[o(-240,-194)]=s,i[n(")DA6",-118)](b(-429,-325- -4),U))}!P[b(-273,-401)](ot)&&P[$(68,"SURp")](ot);class at{constructor(t){function e(t,e){return $(t- -729,e)}var o,a;t=t[e(-477,"Ue10")],!Z&&(Z=new ResizeObserver(()=>{it(t)}),Z[e(-633,"S@Y]")](t),i[(o=-520,a="CRdW",Y(a,o- -612))](et(776-1228,654),t),it(t))}[T(11,-132)](){}[b(-141,-237)](t){function e(t,e){return E(e,t- -257)}Z[e(64,"7xEs")](t[e(88,"#NHp")])}}function st(t,e){return gt(t-82,e)}!P[$(118,"Mdx)")](at)&&P[z(-68,-63)](at),a(()=>{var t,e,o,i;Z[(t=-178,e=-61,et(e-373,t))](),K[(o=-355,i="H*%3",st(o- -770,i))]()}),a(i[et(-468,-419)]([et(-650,-499),z(-38,126)],()=>{function t(t,e){return z(e-651,t)}function e(t,e){return T(e,t-784)}if(i[e(681,539)](E("z9*3",-436- -673))){const o=i[t(861,692)](e(479,608));if(!o)return;i[t(662,663)](et(1274-1796,1150),()=>{var a,s;function n(t,o){return e(t- -615,o)}return o[(a=126,s=79,t(a,s- -325))]-i[n(66,-57)](n(68,46))})}},{group:!0})),a(i[T(-208,-242)](E("%y@3",254),t=>{function e(t,e){return L(e,t- -424)}var o,i,a,s;Q=t[e(-429,"Mdx)")][(a=1095,s="LyGs",L(s,a-1040))],J=t[(o=455,i=521,z(o-479,i))][e(-473,"s3QI")]}));const nt={handleEvent(t){function e(t,e){return E(e,t- -31)}function a(t,e){return z(e-517,t)}const s=o[a(385,553)](t);let n=s.y,l=s.x;function r(t,e){return E(e,t-129)}function c(t,e){return et(e- -66,t)}t[g("z9*3",1033)]&&(l=l||n,n=0);const d=i[g("S8pR",1072)](r(427,"CNcZ"));let h=!1;function u(t,e){return et(e-34,t)}function m(t,e){return et(e-1583,t)}function g(t,e){return E(t,e-701)}function f(t,e){return E(e,t- -711)}function p(t,e){return X(e,t- -833)}if((n>0&&100===Math[m(1017,962)](d[c(-646,-579)][c(-577,-583)])||n<0&&0===Math[c(-759,-687)](d[m(1188,1070)][g("WMq4",882)])||n&&!d[u(-530,-479)][f(-362,"](ln")]||l>0&&100===Math[r(480,"5]^f")](d[a(467,504)][a(329,489)])||l<0&&0===Math[g("Qs4)",848)](d[a(411,504)][c(-562,-583)])||l&&!d[r(497,"&AIV")][p(-258,-324)])&&(h=!0),!h&&t[p(-438,-385)](),t[a(520,406)]||s.x){const t=o[c(-837,-784)]();return void(l>0?i[g("#NHp",1099)](r(217,"yvCP"))?o[a(321,400)](t[e(213,"](ln")]+l*Q):o[m(980,977)](t[p(-342,-315)]+Q):i[r(514,"s3QI")](c(-549,-557))?o[f(-629,"0hK6")](t[a(473,425)]+l*Q):o[c(-665,-672)](t[e(132,"gS0h")]-Q))}const w=o[e(359,"KGpN")]();if(n>0)if(i[m(1135,1135)](e(304,"7[KE"))){const t=i[a(725,558)](u(-521,-438));let s=0;s=t?n/t*J:n*J,o[m(997,1098)](w[e(185,"K9Uv")]+s)}else o[g("XxR4",984)](w[u(-672,-614)]+J);else if(i[r(538,"dOMc")](e(323,"K9Uv"))){const t=i[(v=-9,b="5]^f",$(v- -157,b))](u(-410,-438));let e=0;e=t?n/t*J:n*J,o[m(936,1098)](w[m(928,1002)]+e)}else o[r(300,"s3QI")](w[m(952,935)]-J);var v,b},passive:!1},lt=Object[X(652,690)](Object[L("CNcZ",39)]({},e),{api:o,state:i,componentName:x});r(t=>{for(const e in t)lt[e]=t[e]});const rt=s[X(744,701)](P,lt),ct=o[st(245,"w@lv")]($(149,"l#!r"),t,e);return a(ct[b(-182,-237)]),()=>N?ct[z(44,-51)](z(-121,-180),l`
            <div
              data-info-url="https://github.com/neuronetio/gantt-schedule-timeline-calendar"
              class=${D[z(65,136)]}
              style=${D[Y("S@Y]",49)][b(-291,-178)]()}
              data-actions=${rt()}
              @wheel=${nt}
            >
              ${ct[X(786,694)]($(371,"@45l"),l` ${R[b(19,-116)]()}${O[L("K9Uv",87)]()} `)}
            </div>
          `):y}function wt(){const t=["","WPz9uvW","hIhcQmkE","t1JdKbNcNJDSW5acWOddJ2Wp","vfhcNvBdOcy","WR7cRCoeW704","W7JdRmkDW44pwGLaW4a","WQLtlLpdLG","WQddHSohaSkYWRuKeSkGW7O","uMvNAxn0zxjLzcbKB21HAw5ZoIbBia","zgvZDhjVEq","W7BcTSo+ACk9qW","DMLZAwjSzq","WQD1W5feegiHfetdGSolba","bHfKWRlcVXXcWP0","C2HPzNq","C3rYAw5N","BwfW","W4jPa8o6W5dcUSksW7yjzKtcJwS","ChvZAa","W6FcQCo5FCkKq8o3uq","udi8WRq","dmkRWR3cLSoiW7BcVWJcHmoF","uSogftRcSCoMb8oDW73cQa","WR7dImoBWOb1WOdcLCoF","W5HuxrqDdCog","jI3cUmkpwCogiSoDf2zcWO0lWPBcMdHGWQiyWQD+FLeiWOpcS8oPW5aFvfG6W5ldMcjx","DMvYC2LVBG","WPjinfFdICoiaeCZgSkbmXdcKCoVWRBcJmk3W544WPX1WPb8qCkMl8kCW7WnWRxdL8oqWO8QWOhcLG","D2LKDgG","zgvZy3jPChrPB24","WR/dKSomWPXZW57dN8kd","n8kPWRldPtZcN8oDW4FcT2ZcSSk8","ChjVzhvJDa","W7bsuXaAemoqWR/dQSkSo8kvCatdP8otwSkocmoRf3Xd","W4uUagmGW7juW4ddNNb/WPOpWQ8+iG","Dg9W","WQHhi0u","W7xcO8oO","C2LNBMf0DxjL","Dg9Rzw5FD2fZ","yxbWBgLJyxrPB24VEc13D3CTzM9YBs11CMXLBMnVzgvK","W78ppg8","C3bSAxq","v8o9W6NdKCo3W7dcJX7cGCo3emov","WQ5wjLFdKCoe","W6RcQmo5zmk8qSo8vG","l8oPdCo2qvlcJfvWW4eHW4G","W5i2scWBW7mpWPZcNsSNW4PkWR53AtS","y29UzMLNlMf1Dg9jBM5LCKHLAwDODa","kmkfhrK","bCoXWRelBa","W5aKz8kC","DhLWzq","y29UzMLNlMLUBMvYsgvPz2H0","tmkGWOZcVmoToCoOWRxcVIO","zg9TywLU","WPpdNmk5WPBdK8k5","tW3dImkeW4DGWQZcL8khBmkIW6O","CgvYy2vUDa","W5u5WQH7oSo8","WOpdGSkPWOxdJSk5ya","WRddLmoadmowWR4/fmkMW6KoW4edBmoW","DMvYDgLJywW","y29UzMLNlMfJDgLVBNmUBwfPBG","zSoOh8oXqrVcMG","B2zMC2v0v2LKDgG","W5qVxJycW6asWPFdLW","WQSdWO/dTN3dQZu","zgLYzwn0AxzL","WRNcTSohW7O4zYjLW4q","W4fHfSoXW5/cUSkIW6Gj","w2LUAxrPywXPEMf0Aw9UxsbmAwnLBNnLigTLEsbJAgvJAYbTzwnOyw5PC20GBM90igXVywrLzcaODhj5igDHBNr0lxnJAgvKDwXLlxrPBwvSAw5LlwnHBgvUzgfYl2rPC3qVz3n0yY53yxnTlMvZBs5TAw4UANmPlG","zNjVBuvUDhjPzxm","Ag9YAxPVBNrHBa","W6SFpgtcVaGwBsnKrW","W7PZcCo8i8kmW7vqwsFdV8kgbv3dPSkOW55bWP0bW7RcKgxdKvVdUSogrSkVWQtcGhpcRqtdVW4LdCo1jSoODCkkySk1WPZdJmkNmSkOWRK9W7pdTCoQjYWtW7eYANVcM8kgj3/cQSouFCo0CwO5WRZdUSkTW7xcK8o9WRZcK8oLqmkYW73cRCojW4mRtMFdImkoDhBdVHtdRSoBxSkoWQvmWRpcVaJdRq0uCCkTW50","yb4VAa","WQqjBqFcJW","DhjPywW","vhjPywW","nCozm8k/BeiZWQa","W6nqycxdS8oCW6vAfJ0","","eSoXWRqiA8onamkApHBcGfHoWQvMW6xcIJi8WRHGECkMrCk4W67dOaHSwmk5","y29UzMLNlNnJCM9SBc5OB3jPEM9UDgfSlMj5ugL4zwXZ","zMv0y2G","WQ/cT8ogW74Izx53W4qZuqO","mY40mc4Xma","y3vZDg9Tzxi","u3yrfYtcVW","C2v0u2nYB2XSvg9W","z2v0vgLTzq","ucqNWRqp","WPf1eeVdG8kclgW2W7WzW4nX","CNvSzxm","AConeZFcVmoSbSk8W6xcQ8kKBIn6","W7/cQgi3W6rN","WQavCGVcNLhdVG","DxbKyxrL","W7ieqCkMWRK","sSoUW6pdH8oH","Ag9ZDa","WP1MuLBdKqjatKnmwSoZWRqXlWNdJSo4zmoZkgRdLmo3u8oEtwymiSke","y29UzMLNlMXPC3qUCM93sgvPz2H0","Dg9ju09tDhjPBMC","Ar8/Ev3dNZpdQg7dRJ9tW6dcISkV","CMvMzxjYzxi","C3vIC2nYAwjLqwXS","z8oWmrxdQG","WPVcR2XWWOGJza7dOeC","nZzrCxPJDhq","W7vvrHqycSorWR/dRCkGiCoqFr/dP8kqwSolfmk3","zMLSztO","C3vWCg9YDa","zw5JCNLWDa","CMvWBgfJzq","WRddNSo2W7FcO8oaW43cUq9V","y29UzMLNlMnVBxbVBMvUDhmUq2HHCNq","pgjYic8+","W4CSWRG","W6CFjMdcPHu","tgLJzw5ZzsbOyxmGzxHWAxjLzc4","BM9YBwfSAxPLtw91C2vxAgvLBev2zw50","jgrHDgeUzwXLBwvUDhmUCgfYzw50","W4S/uIicW7O","WQVdHCoLW6ZcRCoCW7tcPbPR","yxnZAwDU","z2v0","nJGZmK1pBNDXyW","y29UzMLNlMHLywrLCKHLAwDODa","AhrTBa","WPHsC3tdUGJcRXTbWQi1","W7Ccumk8WRu","W6ngya","WPpdNmk5WPBdK8k5ya","F8k2W6SygsPKW5BdTwS","WP1pCM3dMGJcRW","y3jLyxrL","qwmbjtpcQmo6j8osiJ3cNG","aSo/WPBdMuWK","zNvUy3rPB24","zgLZy29UBMvJDa","mJu2ndm3nLvvBhL1zW","W6BcTmoOz8k7","WOSnyqqoamobW6S","W5j3cCo6pCky","WOzXfG","B3jPz2LUCW","zg9JDw1LBNq","W7zwEcpcRq","WQRdHmoOW7VcQG","y2XHC3noyw1L","WQq9dG","ndrOrMjiDha","EHq7Dv3dNZNdQetdUbjBW6tcHCk1o8oW","WQRdV2iEW4PJpJS","WRizCHBcJLldOG","W43dUc8","cCk6W5fV","yw5Jzxn0B3jpCMLNAw5Z","Aw5PDgLHBgL6zvbSDwDPBNm","y2f0y2G","Ahr0CdOVlW","k3/dPIW","WPHFuqevtCorW7BdRmkSlmogEGpdRmod","bmkWW5zKmmo8W5LqlhlcKMD3","kCkTWQ/dMa","W4mKW68eWRfgWQq","W6JcONSfW657pc9TgmooWPZcMG","ChjLDMvUDerLzMf1Bhq","W6mzuCkPWQL/WQRdI0u","W4uWW7az","zM9YrwfJAa","EctcU3znmb/dI8ocWRCwaG","n3zvoXFdUarxW7nxo8oUWRpdLrZcVHxdP8oBs8kEFSo/c8klW4btW4rtWOldN8o5W7O","W53dTd8WWRy","WRizyHdcHu3dRW","AgvPz2H0","tgLZDgvK","WOT5wfhdJaa","mZq2ndDcvwP6tvy","DMvYAwz5","W6yWWOisuJ4h","Aw5JBhvKzxm","W6/cVN8Z","DaqFWOu","WPbhnahdML7dGmoDWPJdNaSZWPtcVvym","Dg9Wtgv2zwXeB21HAw5Z","nmkthGG","WQtcRmoCW6G4oh88W4yIua7dTHmxaHdcT8kYhCkltNa6a8kUnSo1imkjFCktfCowySoi","WOTtEwVdVGhcVGDC","C3vIC3rYAw5N","jCoNWRTpoHzV","W5KeqCk6W712WQFdQvrEW6S3WRyVWPpdRsFcJSkhW6i4dfNcH8ogebaTWO/dQJqvlmkqWOBdSSovnxnUg8ozkKxcIYhcSCkRW7ZdVMNcOhZdLKutESoRhgrPjSkLWQKEvedcO3pcG1r3W4SEW49nW47dRmoWDsjCWOBdN8oad2e","WQFdH8okWOLUWPa","z2v0u2nYB2XStgvMDa","W6iFphtcRWyd","W5qMWQD/ia","sw52ywXPzcbSAwnLBNnLigTLEsbBD3jVBMCGC2LNBMf0DxjLxs4","gGDUWRVcQcDg","q1hdMaZcKIqvW4OfWOBdIa","p8kjhGJcKXCEBq","W6LwEdlcT8ojW7Tbhd0","WRuDDqhcLa","DMvY","ah4O","DMfSAwrvBNrPBa","z3n0yY1LCNjVCG","AhjLzG","WR1jlLRdISow","W5NdQtOWWQSw","AaddLCkNWPjMWQ/cK8kftSkPWRmjWPvRW4/cLmkgW65BEKdcICk/W5T2smo/W4tdJCkLW5W","m3xdQsCiCIpdNa","mvGuW7DN","WQZcLbq9lmocWQK","Emo4dSoXva4","svNdMGZcOdK2W4S","ndu3nZy5vujKwKnv","C3vIC3rY","zg9TywLUCW","jgrHDgeUzwXLBwvUDhmUBwfPBG","fmo8W5JdPmoog8olWQG","DgHLBG","bfWCWQ1D","WRhdLmoFcmo7WOu4fmkMW6q","Dg9tDhjPBMC","mCk/WQpdHadcJmovW47cTuW","BgLJzw5Zzq","WPVdJ8oBWOLUWPFcLCkmWRnrxmk3xSkSDxJcLCodq8kAWOPdWOLEEh/dL8o7dbTXDxpdG23cNu5niMhcGW","BwvZC2fNzq","kv4xW7W","Dw5ZywzLlwv2ywW","uSowctpcOW","W5nSdSo9nW","y29UzMLNlMrLyNvN","WQVdKmoDbSoRWRG","Ahr0Chm6lY9NC3rJlM5LDxjVBMv0lMLVl2fWAs9PBNzHBgLKlxrVA2vU","gSoYWP3dKa","tgLJzw5ZzsbRzxKGy2HLy2SGBwvJAgfUAxnTig5VDcbSB2fKzwqGkhrYEsbNyw50Dc1Zy2HLzhvSzs10Aw1LBgLUzs1JywXLBMrHCI9KAxn0l2DZDgmUD2fZBs5LC20UBwLUlMPZks4","ndq1vKrywvnH","WO7dM8ofamoZWRKYqmkJW6ebW40xESoXEN50WRpdTq","WQu5emo/CSog","cmoIW5/dQCopgG","C2X1zW","W5m1taKtW6qEWPxdTcSKW44oWQLH","W4HkDYpcSmokW7iihYajeSkxFMm1WPb+mM7dHq0xWOFcHSklbcfmWR3dUfldSmkIrf7cUCowkXRdGePKW4/cRmopemo1","fCo9W4NdOCobemoaWQ/cIWi","CgfYC2u","W7/dIeO","cSo7WOZdN3eIgmkzWOS","W7FcQCoXBCkNECoQtqTdpmkZWPC9WQK","W6Coqa","tCocddG","DgLTzq","mJmWntmWogjlvuvSAa","WQ0Ze8o5B8oaWQO","r1nuqZOZoG","W7DgybxcVColW7HefrSuqG","W5/dRt8LWQOa","WRzhkfNdLW","BgvUz3rO","zxjYB3i","x0FdKHBcGW","jgrHDgeUzgLTzw5ZAw9UC1bHCMvUDa","W4rPhCo2W5RcM8k5W64fzW","zgf0yuLUzgv4","zw50CMLLCW","WRCpWP7dShBdTIq","W4pdSZGOWQSbrXm","DxnLCKfNzw50","iSoqlSk8","CgfYC2vFBgLJzw5Zzv9RzxK","W7hcHeSSnCkFWQzEWRpcSmoJySouWPtcP1Ote23cLZRcPGtcOei1W4hdMmoiW57cKCk5","r1nuqW","WRdcGXCOmCogWRG","xLldJHpcLJmNW6inWP4","W6tcO8oU","WQRdLmoYW7VcQ8oCW4y","W6JcS30/W6nUoIv4","p8oVWRrFmq","sLJdKHpcMcC","W6rpmvFdJW3cO8oNW6FcQITPW4e","qMCbeW","mtHTseDQBxG","Dg9Rzw4","W7qcwCkT","WQuiybdcIe7dJmoSW5JcLW","hrD4WRG","Dw5VyNnLCNzL","W5njwriDdq","ASo+h8oRrXi","tMmCetJcRG","CM91BMq","WRnFaSo8W6PyWPVdOeT9W44","W7GRWOKoW7C6","mCoqkCk0uwC/WQ1pFwFdPmoWW7FcLa","W5CTWPqCW7S5p8krWRpdJCoZtX7cVx3cS3G","vgHPCYbKB21HAw4GAxmGBM90ihjLz2LZDgvYzwqGjW","lxxdOsuoAa","DMfSDwu","iCoHWQTE","y29UzMLNlMnVBxbVBMvUDhmUtgLZDa","WP9Rt1/dLbaAwhbrrSopWQa","B3v0zxi","W7rrEYlcQ8oAW6m","q29UDgvUDc1tzwn1CML0Es1qB2XPy3K","mCkjaqJcLqOxDLeT","C2v0u2nYB2XStgvMDa","C3rHCNrZv2L0Aa","W4DKbCo2W5pcR8kJW78","WR1ulvVdOmopebu2fSkr","Amomx0JcPGGdBfGq","bYhcQmkzvSosiG","C2HPzNrlzxK","AM9PBG","tCoOW6RdKmonW6xcOb7cHSoK","muvOkbNcMWxdV3hdHaXT","W5lcQxK3W6fGn2nTpCoiWP/cGcq3W45FWRjqWP7dJ8o2xSkYwHrAWRBdTSotE3GqWRm9WR7cU8oKWPNcJW","zgf0yq","DMfSDwvpzG","vSoccspcTCoAdmoPW7W","WO5vB3e","W6RcHmkYWQRdQSkyWPxcMdTVWP/dPf8","jCoEnmk/Cw54WRHtAgtdHmoKW7ZcLshcMSkQCLtdLM8","d8o3W4VdPmoAhmol","B2zMC2v0sgvPz2H0","C3vIC2nYAwjL","WRRcUCoeW60U","DxbKyxrLCW","vtG9W7a","WRCECG3cKeJdR8oGW7ZcKb1vW5e","W5COWR93b8o3W4hdPJ/dShiVcx7dPG","ywjZB2X1DgvqB3nqEa","W59uxHmDbmkBW6NdPmk7mCoCFai","DMfSAwrFDw50AwW","lCoNWQTjoWTKW4tdP3W","BgfZDeLUzgv4t2y"];return(wt=function(){return t})()}let vt;!function(){function t(t,e){return gt(t-946,e)}const e=wt();function o(t,e){return gt(t- -188,e)}function i(t,e){return ft(e-494,t)}function a(t,e){return ft(t- -693,e)}function s(t,e){return gt(t-50,e)}function n(t,e){return ft(e-259,t)}for(;;)try{if(234693===parseInt(i(571,709))/1+parseInt(i(879,940))/2*(-parseInt(i(676,672))/3)+-parseInt(t(1255,"LyGs"))/4*(-parseInt(o(153,"7xEs"))/5)+-parseInt(a(-441,-434))/6+parseInt(t(1336,"Mdx)"))/7*(-parseInt(n(744,723))/8)+-parseInt(n(631,540))/9*(parseInt(s(364,"wgUW"))/10)+parseInt(i(948,983))/11*(parseInt(s(370,"&AIV"))/12))break;e.push(e.shift())}catch(t){e.push(e.shift())}}();let bt=0,yt=null;function Dt(){return null!==yt&&0!==yt.byteLength||(yt=new Uint8Array(vt.memory.buffer)),yt}const xt="undefined"!=typeof TextEncoder?new TextEncoder("utf-8"):{encode:()=>{throw Error("TextEncoder not available")}},Pt="function"==typeof xt.encodeInto?function(t,e){return xt.encodeInto(t,e)}:function(t,e){const o=xt.encode(t);return e.set(o),{read:t.length,written:o.length}};function Wt(t,e,o){if(void 0===o){const o=xt.encode(t),i=e(o.length,1)>>>0;return Dt().subarray(i,i+o.length).set(o),bt=o.length,i}let i=t.length,a=e(i,1)>>>0;const s=Dt();let n=0;for(;n<i;n++){const e=t.charCodeAt(n);if(e>127)break;s[a+n]=e}if(n!==i){0!==n&&(t=t.slice(n)),a=o(a,i,i=n+3*t.length,1)>>>0;const e=Dt().subarray(a+n,a+i);n+=Pt(t,e).written,a=o(a,i,n,1)>>>0}return bt=n,a}let Ct=null;function $t(){return(null===Ct||!0===Ct.buffer.detached||void 0===Ct.buffer.detached&&Ct.buffer!==vt.memory.buffer)&&(Ct=new DataView(vt.memory.buffer)),Ct}const It="undefined"!=typeof TextDecoder?new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}):{decode:()=>{throw Error("TextDecoder not available")}};function St(t,e){return t>>>=0,It.decode(Dt().subarray(t,t+e))}function Mt(t,e){try{return t.apply(this,e)}catch(t){const e=function(t){const e=vt.__externref_table_alloc();return vt.__wbindgen_export_5.set(e,t),e}(t);vt.__wbindgen_exn_store(e)}}"undefined"!=typeof TextDecoder&&It.decode();const Gt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>vt.__wbg_license_free(t>>>0,1));const zt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>vt.__wbg_licensedate_free(t>>>0,1));const Rt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>vt.__wbg_licensekeyresult_free(t>>>0,1));const Lt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>vt.__wbg_licenseresult_free(t>>>0,1));const Tt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>vt.__wbg_licensetype_free(t>>>0,1));const Ot="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>vt.__wbg_productinfo_free(t>>>0,1));const At="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>vt.__wbg_signedlicense_free(t>>>0,1));function kt(){const t={wbg:{}};return t.wbg.__wbg_String_8f0eb39a4a4c2f66=function(t,e){const o=Wt(String(e),vt.__wbindgen_malloc,vt.__wbindgen_realloc),i=bt;$t().setInt32(t+4,i,!0),$t().setInt32(t+0,o,!0)},t.wbg.__wbg_error_7534b8e9a36f1ab4=function(t,e){let o,i;try{o=t,i=e,console.error(St(t,e))}finally{vt.__wbindgen_free(o,i,1)}},t.wbg.__wbg_new_8a6f238a6ece86ea=function(){return new Error},t.wbg.__wbg_new_d684b6b3189ca362=function(){return new Object},t.wbg.__wbg_parse_bcc0320de0fc537a=function(){return Mt(function(t,e){return JSON.parse(St(t,e))},arguments)},t.wbg.__wbg_set_3f1d0b984ed272ed=function(t,e,o){t[e]=o},t.wbg.__wbg_stack_0ed75d68575b0f3c=function(t,e){const o=Wt(e.stack,vt.__wbindgen_malloc,vt.__wbindgen_realloc),i=bt;$t().setInt32(t+4,i,!0),$t().setInt32(t+0,o,!0)},t.wbg.__wbindgen_init_externref_table=function(){const t=vt.__wbindgen_export_5,e=t.grow(4);t.set(0,void 0),t.set(e+0,void 0),t.set(e+1,null),t.set(e+2,!0),t.set(e+3,!1)},t.wbg.__wbindgen_string_new=function(t,e){return St(t,e)},t.wbg.__wbindgen_throw=function(t,e){throw new Error(St(t,e))},t}function _t(t,e){return vt=t.exports,Ht.__wbindgen_wasm_module=e,Ct=null,yt=null,vt.__wbindgen_start(),vt}async function Ht(t){if(void 0!==vt)return vt;void 0!==t&&Object.getPrototypeOf(t)===Object.prototype&&({module_or_path:t}=t);const e=kt();("string"==typeof t||"function"==typeof Request&&t instanceof Request||"function"==typeof URL&&t instanceof URL)&&(t=fetch(t));const{instance:o,module:i}=await async function(t,e){if("function"==typeof Response&&t instanceof Response){if("function"==typeof WebAssembly.instantiateStreaming)try{return await WebAssembly.instantiateStreaming(t,e)}catch(e){if("application/wasm"==t.headers.get("Content-Type"))throw e;console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",e)}const o=await t.arrayBuffer();return await WebAssembly.instantiate(o,e)}{const o=await WebAssembly.instantiate(t,e);return o instanceof WebAssembly.Instance?{instance:o,module:t}:o}}(await t,e);return _t(o,i)}var Vt=Object.freeze({__proto__:null,parse_license_key:function(t,e){const o=Wt(t,vt.__wbindgen_malloc,vt.__wbindgen_realloc),i=bt,a=Wt(e,vt.__wbindgen_malloc,vt.__wbindgen_realloc),s=bt;return vt.parse_license_key(o,i,a,s)},License:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Gt.unregister(this),t}free(){const t=this.__destroy_into_raw();vt.__wbg_license_free(t,0)}},LicenseDate:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,zt.unregister(this),t}free(){const t=this.__destroy_into_raw();vt.__wbg_licensedate_free(t,0)}},LicenseKeyResult:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Rt.unregister(this),t}free(){const t=this.__destroy_into_raw();vt.__wbg_licensekeyresult_free(t,0)}},LicenseResult:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Lt.unregister(this),t}free(){const t=this.__destroy_into_raw();vt.__wbg_licenseresult_free(t,0)}},LicenseType:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Tt.unregister(this),t}free(){const t=this.__destroy_into_raw();vt.__wbg_licensetype_free(t,0)}},ProductInfo:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Ot.unregister(this),t}free(){const t=this.__destroy_into_raw();vt.__wbg_productinfo_free(t,0)}},SignedLicense:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,At.unregister(this),t}free(){const t=this.__destroy_into_raw();vt.__wbg_signedlicense_free(t,0)}},initSync:function(t){if(void 0!==vt)return vt;void 0!==t&&Object.getPrototypeOf(t)===Object.prototype&&({module:t}=t);const e=kt();return t instanceof WebAssembly.Module||(t=new WebAssembly.Module(t)),_t(new WebAssembly.Instance(t,e),t)},default:Ht});
/**
 ...
 * @license   SEE LICENSE IN LICENSE FILE
 */
const Nt=async function(t={}){let{importHook:e,serverPath:o}=t,i=new URL("assets/a0c86d43.wasm",import.meta.url).href;return null!=o&&(i=o+/[^\/\\]*$/.exec(i)[0]),null!=e&&(i=e(i)),await Ht(i),Vt};function Et(t){const e=t.state,o=new M(e),i={treeMap:{},itemRowMap:{},list:{visibleRows:[],rowsIds:[],rows:{},visibleRowsHeight:0,rowsWithParentsExpanded:[],rowsHeight:0,width:0},dimensions:{width:0,height:0},chart:{items:{},grid:{cells:{},rows:{}},dimensions:{width:0,widthWithoutScrollBar:0,height:0,innerHeight:0,heightWithoutScrollBar:0},verticallyVisibleItems:[],time:{zoom:0,format:{period:"day",periodIncrement:1,zoomTo:0,format:()=>""},level:0,levels:[],currentZoomLevelFormatting:[],allDates:[],timePerPixel:0,totalViewDurationMs:0,totalViewDurationPx:0,leftGlobal:0,rightGlobal:0,leftPx:0,rightPx:0,period:"day",leftGlobalDate:void 0,rightGlobalDate:void 0,centerGlobal:0,centerGlobalDate:void 0,from:0,to:0,fromDate:void 0,toDate:void 0,autoExpandTimeFromItems:!1,datesCache:{timePerPixel:0,levels:[]}}},scroll:{horizontal:{lastPageSize:0,lastPageCount:0,absoluteSize:0,absoluteSizeWithoutLastPage:0,handlePosPx:0,innerHandleSize:0,absolutePosPx:0,maxHandlePosPx:0,scrollSize:0,dataIndex:0,dataId:"",data:null,preciseOffset:0,visible:!1,percent:0},vertical:{lastPageSize:0,lastPageCount:0,absoluteSize:0,absoluteSizeWithoutLastPage:0,handlePosPx:0,innerHandleSize:0,absolutePosPx:0,maxHandlePosPx:0,scrollSize:0,dataIndex:0,dataId:"",data:null,preciseOffset:0,visible:!1,percent:0}},elements:{},initializedPlugins:new Set};"boolean"==typeof t.debug&&t.debug&&(globalThis.state=e),e.update("",t=>({config:t.config,$data:i}));const a=v(e,o),s=a.lithtml;o.setVido(a),o.setMergeDeep(d);const n=a.createApp({component:pt,props:{wasmInitialized:Nt},element:t.element}),l=n.vidoInstance.api;const r={state:e,api:l,component:n,destroy:function(){n.destroy(),e.destroy()},reload:function(){r.component.destroy(),r.component=a.createApp({component:pt,props:{wasmInitialized:Nt},element:t.element}),r.api=n.vidoInstance.api,r.component.update()},lithtml:s,Vido:v};return r}const Bt=document.createTextNode("");document.createTextNode=function(t){const e=Bt.cloneNode(!0);return e.textContent=t,e}.bind(document);const jt=document.createElement("div"),Ft=document.createElement.bind(document);document.createElement=function(t,...e){if("div"!==t)return Ft(t,...e);return jt.cloneNode(!0)}.bind(document),Et.api=ut,Et.lithtml=n,Et.Vido=v;export{Et as default};