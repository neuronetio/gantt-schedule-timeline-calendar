 ...
 * @link      https://github.com/neuronetio/gantt-schedule-timeline-calendar
 * @license   SEE LICENSE IN LICENSE FILE
 */class y extends o{constructor(t,e,o){super(e,o),this.subs=[],this.name=t,this.subs.push(e.state.subscribe(`config.slots.${t}`,this.setComponents,{queue:!0}))}destroy(){this.subs.forEach((t=>t())),super.destroy()}getName(){return this.name}}function W(t,e,o){return new y(t,e,o)}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */const x="gstc";function D(t,e=""){let o=`gstc__${t}`;return t===x&&(o=x),e?`${o} ${o}--${e.replace(":","-")}`:o}function $(t,e){let o=`gstc__${t}`;return t===x&&(o=x),`${o}--${e}`}
/**
 * Api functions
 *
 * @copyright NEURONET - Rafal Pospiech <https://neuronet.io>
 ...
 */function I(t,e){const{onDestroy:o,state:i,cache:a,api:n,html:l,StyleMap:r,Actions:c,update:d}=t,u="scroll-bar";let h,m,g="",f="";o(i.subscribe("config.classNames",(()=>{h=n.getClass(u),m=n.getClass("scroll-bar-inner")})));const p="horizontal"===e.type?"height":"width",w="height"===p?"width":"height",v="horizontal"===e.type?"left":"top",b=new r({}),y=new r({}),W={maxPosPx:0,innerHandleSize:0,sub:0,scrollSize:0};o(i.subscribeAll("horizontal"===e.type?[`config.scroll.${e.type}`,`$data.scroll.${e.type}`,"$data.chart.time"]:[`config.scroll.${e.type}`,`$data.scroll.${e.type}`,"$data.chart.dimensions.heightWithoutScrollBar","$data.list.rowsWithParentsExpanded","$data.list.rowsHeight","config.additionalSpace"],(function(){const t=i.get(`config.scroll.${e.type}`),o=i.get(`$data.scroll.${e.type}`),s=n.getScrollSize(e.type),a=o.innerHandleSize,l=o.maxHandlePosPx,r=i.get("config.additionalSpace"),c=i.get("config.chart.time");c.allDates&&c.allDates.length&&c.allDates[c.level]&&(o.visible?b.style.display="flex":b.style.display="none",b.style[p]=t.width+"px",b.style[w]=s+"px","vertical"===e.type&&(b.style.top=i.get("config.headerHeight")+r.top+"px"),o.lastPageSize&&o.absoluteSize&&s&&(y.style[p]="100%",y.style[w]=a+"px",function(t,e,o){const s=W.maxPosPx!==t||W.innerHandleSize!==e||W.scrollSize!==o;return s&&(W.maxPosPx=t,W.innerHandleSize=e,W.scrollSize=o),s}(l,a,s)&&("horizontal"===e.type?n.setScrollLeft(o.dataIndex,o.preciseOffset):n.setScrollTop(o.dataIndex,o.preciseOffset)),d()))}),{group:!0,bulkValue:!1}));let x=0;o(i.subscribe(`$data.scroll.${e.type}.handlePosPx`,(t=>{t!==x&&(y.style[v]=t+"px",x=t,d())})));const D=n.getActions(u);D.push(class extends s{constructor(t){super();const o=`$data.elements.scroll-bar--${e.type}`;i.get(o)||i.update(o,t,{only:null})}update(){}destroy(){}});const $={api:n,state:i,props:e,componentName:u},P=c.create(D,$),C=[class extends s{constructor(t){super(),this.moving=!1,this.initialPointerPos=0,this.initialHandlePos=0,this.currentPos=0,this.currentPointerPos=0,this.lastDataIndex=0,this.lastOffset=0,this.dataIndex=0,this.previousRowId="",i.update(`$data.elements.scroll-bar-inner--${e.type}`,t,{only:null}),this.bodyClassName=i.get("config.scroll.bodyClassName"),this.pointerDown=this.pointerDown.bind(this),this.pointerUp=this.pointerUp.bind(this);const o=this.pointerMove.bind(this);this.pointerMove=o,this.unsubscribe=i.subscribe(`$data.scroll.${e.type}`,this.dataChanged.bind(this)),this.destroy=this.destroy.bind(this),t.addEventListener("pointerdown",this.pointerDown),document.addEventListener("pointermove",this.pointerMove),document.addEventListener("pointerup",this.pointerUp)}destroy(t){this.unsubscribe(),t.removeEventListener("pointerdown",this.pointerDown),document.removeEventListener("pointermove",this.pointerMove),document.removeEventListener("pointerup",this.pointerUp)}dataChanged(){const t=i.get(`$data.scroll.${e.type}`),o=i.get("$data.chart.time");if(!o.allDates.length)return;const s=o.allDates[o.level],a=t.dataIndex;if(this.lastDataIndex=a,"horizontal"===e.type&&s&&s.length){const e=s[a];if(!e)return;if(this.lastDate&&this.lastDate.leftPx===e.leftPx)return;this.currentPos=this.limitPosition(e.leftPx/t.absoluteSizeWithoutLastPage*t.maxHandlePosPx),d()}else if("vertical"===e.type){const e=i.get("$data.list.rowsWithParentsExpanded");if(!e.length)return;const o=e[a],s=n.getRow(o),l=n.getRowData(o);if(!s)return;if(this.previousRowId===l.id)return;l.position.top&&t.absoluteSizeWithoutLastPage&&t.maxHandlePosPx&&(this.currentPos=Math.round(l.position.top/t.absoluteSizeWithoutLastPage*t.maxHandlePosPx)),d()}}limitPosition(t){return Math.max(Math.min(t,i.get(`$data.scroll.${e.type}.maxHandlePosPx`)),0)}pointerDown(t){t.stopPropagation(),t.preventDefault(),n.muteMethod("calculateRowsHeight"),document.body.classList.add(this.bodyClassName),requestAnimationFrame((()=>{this.moving=!0,this.initialPointerPos="horizontal"===e.type?t.screenX:t.screenY,this.initialHandlePos=i.get(`$data.scroll.${e.type}.handlePosPx`),f=" "+n.getClass(u)+"-inner--active",g=" "+n.getClass(u)+"--active",d()}))}pointerUp(t){this.moving&&(n.unmuteMethod("calculateRowsHeight"),t.preventDefault(),t.stopPropagation(),document.body.classList.remove(this.bodyClassName)),this.moving=!1,f="",g="",d()}pointerMoveRead(t){this.currentPointerPos="horizontal"===e.type?t.screenX:t.screenY}pointerMoveWrite(){const t=i.get(`config.scroll.${e.type}`),o=i.get(`$data.scroll.${e.type}`),s=this.currentPointerPos-this.initialPointerPos;this.currentPos=this.limitPosition(this.initialHandlePos+s);const a=i.get("$data.chart.time");if(!a.allDates.length)return;const l=a.allDates[a.level],r=this.currentPos/o.maxHandlePosPx,c=Math.round(r*o.absoluteSizeWithoutLastPage);if("horizontal"===e.type){let e,o=0,s=0,i=0;for(let t=l.length;o<t&&(e=l[o],i=Math.round(e.rightPx),!(i>c));o++);if(t.precise&&i!==c&&(s=Math.round(e.leftPx)-c),o||(o=0),this.dataIndex=o,o===this.lastDataIndex&&s===this.lastOffset)return;this.lastDate=l[o],n.setScrollLeft(o,s),this.lastDataIndex=o,this.lastOffset=s}else{const{dataIndex:e,row:o,rowData:s}=n.getRowInfoFromTop(c);let i=0;if(t.precise&&s.position.top!==c&&(i=s.position.top-c),this.dataIndex=e,e===this.lastDataIndex&&i===this.lastOffset)return;this.previousRowId=o.id,n.setScrollTop(e,i),this.lastDataIndex=e,this.lastOffset=i}}pointerMove(t){this.moving&&(t.stopPropagation(),t.preventDefault(),requestAnimationFrame((()=>{this.pointerMoveRead(t)})),requestAnimationFrame((()=>{this.pointerMoveWrite()})))}}],S=c.create(C,$),M=n.generateSlots(u,t,e);function I({classNameOuter:t,classNameOuterActive:e,classNameInner:o,classNameInnerActive:s,styleMapInner:i,styleMapOuter:a,innerActions:n,outerActions:l,slots:r,cache:c,html:d,vido:u,props:h}){return c(!h||!h.type?null:r.html("outer",d`
            ...
            `))}let R=I;return o(i.subscribe("config.templates.scroll-bar",(t=>{R=null!=t?t:I,d()}))),()=>R({innerActions:S,outerActions:P,classNameOuter:h,classNameOuterActive:g,classNameInner:m,classNameInnerActive:f,cache:a,styleMapInner:y,styleMapOuter:b,slots:M,html:l,vido:t,props:e})}
/**
 * List component
 *
 * @copyright NEURONET - Rafal Pospiech <https://neuronet.io>
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */function R(t,e={}){const{api:o,state:s,onDestroy:i,Actions:a,update:n,reuseComponents:l,html:r,StyleMap:c,cache:d}=t,u="list",h=o.getActions(u);let m,g;const f=Object.assign(Object.assign({},e),{list:m,percent:g,api:o,state:s,componentName:u});let p;const w=s.subscribe("config.components.ListColumn",(t=>p=t));!function(){const t=s.get("config.list.expander.icons"),e={};for(const s in t){const i=t[s];e[s]=o.getSVGIconSrc(i)}s.update("$data.list.expander.icons",e)}(),function(){const t={open:"",close:""},e=s.get("config.list.toggle.icons");for(const s in e){const i=e[s];t[s]=o.getSVGIconSrc(i)}s.update("$data.list.toggle.icons",t)}();const v=o.getClass(u),b=o.generateSlots(u,t,e);i(s.subscribe("config.list",(function(){m=s.get("config.list"),g=m.columns.percent,f.list=m,f.percent=g,n()})));const y=[];i(s.subscribe("config.list.columns.data",(function(t){const e=Object.values(t).filter((t=>!t.hidden)).sort(((t,e)=>"number"==typeof t.position&&"number"==typeof e.position?t.position-e.position:0));l(y,e,(t=>({column:t})),p,!0),n()})));const W=new c({height:"","--expander-padding-width":"","--expander-size":""});let x;function D(t){x||(x=t.offsetWidth,0===g&&(x=0),s.update("$data.list.width",x))}i(s.subscribeAll(["$data.height","config.list.expander"],(()=>{const t=s.get("config.list.expander");W.style.height=s.get("$data.height")+"px",W.style["--expander-padding-width"]=t.padding+"px",W.style["--expander-size"]=t.size+"px",n()}),{group:!0})),i((()=>{y.forEach((t=>t.destroy())),w()}));h.push(class{constructor(t,e){e.state.update("$data.elements.list",t),D(t)}update(t){return D(t)}});const $=a.create(h,f);function P({className:t,styleMap:e,list:o,listColumns:s,actions:i,slots:a,html:n,cache:l,vido:r,props:c}){return a.html("outer",l(o.columns.percent>0?n`
              <div class=${t} data-actions=${i()} style=${e.directive()}>
                ${a.html("content",s.map((t=>t.html())))}
              </div>
            `:""))}let C=P;return i(s.subscribe("config.templates.list",(t=>{C=null!=t?t:P,n()}))),()=>C({list:m,className:v,actions:$,styleMap:W,listColumns:y,slots:b,cache:d,html:r,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */class z{constructor(t,e){let o=!1,s=e.state.get("$data.elements.list-columns");void 0===s&&(s=[],o=!0),s.includes(t)||(s.push(t),o=!0),o&&e.state.update("$data.elements.list-columns",s,{only:null})}destroy(t,e){e.state.update("$data.elements.list-columns",(e=>e.filter((e=>e!==t))),{only:null})}}function O(t,e){const{api:o,state:s,onDestroy:i,onChange:a,cache:n,Actions:l,update:r,createComponent:c,reuseComponents:d,html:u,StyleMap:h}=t,m=[];let g,f;m.push(s.subscribe("config.components.ListColumnRow",(t=>g=t))),m.push(s.subscribe("config.components.ListColumnHeader",(t=>f=t)));const p=Object.assign(Object.assign({},e),{api:o,state:s,componentName:"list-column"}),w={column:e.column,state:s,api:o,componentName:"list-column-headers"},v={api:o,state:s,componentName:"list-column-rows"},b="list-column",y="list-column-rows",W=o.getActions(b),x=o.getActions(y),D=o.getClass(b,e.column.id),$=o.getClass("list-column-rows-offset",e.column.id),P=o.getClass(y,e.column.id);let C,S=o.getId(b,e&&e.column?e.column.id:"");const M=new h({width:"","--width":""}),I=new h({height:""}),R=new h({"margin-top":"0px"});let O=s.get("config.additionalSpace");const A=o.generateSlots(b,t,e);let k;function L(){if(!e||!e.column)return;const t=s.get("config.list");if(!t.columns.data[e.column.id])return;C=t.columns.data[e.column.id].width*t.columns.percent*.01,k=C;const i=Math.round(o.getRealChartHeight());M.style.width=k+"px",M.style["--width"]=k+"px",R.style.height=i+"px",I.style.top=s.get("config.headerHeight")+O.top+"px"}i(s.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar","$data.list.width","$data.list.visibleRowsHeight","config.additionalSpace.top"],L,{group:!0}));const G=c(f,e);i(G.destroy);const H=[],T={};function N(){var t;if(!e||!e.column)return;s.mute(N);const i=s.get("$data.list.visibleRows")||[],a=o.getRows(i),n=o.getRowsData();for(const o of a){const s=T[o.id]=null!==(t=T[o.id])&&void 0!==t?t:{};s.column=e.column,s.row=o,s.rowData=n[o.id],s.width=k}for(const t in T)i.includes(t)||delete T[t];d(H,a,(t=>t&&T[t.id]),g,!0),A.change(e),s.unmute(N)}a((t=>{if((e=t)&&e.column&&e.column.id){S=o.getId(b,e&&e.column?e.column.id:"");for(const t in e)p[t]=e[t];L(),G.change(e),N()}})),i(s.subscribeAll(["$data.list.visibleRows","$data.list.visibleRowsHeight","$data.list.rows","config.list.rows","config.chart.items.*.height","config.chart.items.*.rowId","config.chart.items.*.time"],N,{group:!0,bulkValue:!1})),i(s.subscribe("$data.scroll.vertical.preciseOffset",(t=>{R.style.transform=`translateY(${Math.round(t)||0}px)`,r()}))),i(s.subscribe("config.additionalSpace",(t=>{O=t}))),i((()=>{H.forEach((t=>t.destroy())),m.forEach((t=>t()))})),W.push(z);const V=l.create(W,w),B=l.create(x,v);function j({className:t,classNameOffset:e,classNameContainer:o,containerStyleMap:s,offsetStyleMap:i,widthStyleMap:a,visibleRows:n,rowActions:l,elId:r,headerActions:c,ListColumnHeader:d,html:u,cache:h,vido:m,props:g}){return h(g&&g.column?A.html("outer",u`
              <div
                class=${t}
                ...
                style=${a.directive()}
              >
                ${A.html("inner",u` ${d.html()}${A.html("container-outer",u`
        <div
          class=${o}
          data-gstcid=${g.column.id}
          data-actions=${l()}
      ...
      `)} `)}
            ...
            `):null)}let E=j;return i(s.subscribe("config.templates.list-column",(t=>{E=null!=t?t:j,r()}))),()=>E({classNameOffset:$,offsetStyleMap:R,visibleRows:H,classNameContainer:P,containerStyleMap:I,rowActions:B,className:D,elId:S,headerActions:V,widthStyleMap:M,ListColumnHeader:G,html:u,cache:n,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */function A(t,e){const{api:o,state:s,onDestroy:i,cache:a,onChange:n,Actions:l,update:r,createComponent:c,html:d,StyleMap:u}=t,h="list-column-header",m=Object.assign(Object.assign({},e),{api:o,state:s,componentName:h}),g=o.getActions(h),f=[];let p;f.push(s.subscribe("config.components.ListColumnHeaderResizer",(t=>p=t)));const w=c(p,e);let v;f.push(s.subscribe("config.components.ListColumnRowExpander",(t=>v=t)));const b=c(v,e);i((()=>{w.destroy(),b.destroy(),f.forEach((t=>t()))}));const y=o.generateSlots(h,t,e),W=o.getClass(h),x=o.getClass(h+"-content");let D=o.getId(h,e.column.id);n((t=>{e=t;for(const t in e)m[t]=e[t];D=o.getId(h,e.column.id),w.change(e),b.change(e),y.change(t)}));const $=new u({height:"","--height":"","--paddings-count":""});i(s.subscribe("config.headerHeight",(()=>{const t=s.get("config");$.style.height=t.headerHeight+"px",$.style["--height"]=t.headerHeight+"px",$.style["--paddings-count"]="1",r()})));const P=l.create(g,m);function C({className:t,contentClass:e,styleMap:o,elId:s,cache:i,ListColumnRowExpander:a,ListColumnHeaderResizer:n,actions:l,slots:r,html:c,vido:d,props:u}){return i(!u||!u.column?null:r.html("outer",c`
              <div
                class=${t}
      ...
      `:c` <div class=${e}>${n.html(u.column)}</div> `)}
            ...
            `))}let S=C;return i(s.subscribe(`config.templates.${h}`,(t=>{S=null!=t?t:C,r()}))),()=>S({className:W,contentClass:x,cache:a,styleMap:$,elId:D,ListColumnRowExpander:b,ListColumnHeaderResizer:w,actions:P,slots:y,html:d,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */function k(t,e){const{api:o,state:s,onDestroy:i,cache:a,update:n,html:l,Actions:r,onChange:c,PointerAction:d,StyleMap:u,unsafeHTML:h}=t,m="list-column-header-resizer",g=o.getActions(m),f=o.getActions(m+"-dots"),p={up:"",down:""};let w,v,b,y;i(s.subscribe("config.list.sort.icons",(t=>{p.up=o.getSVGIconSrc(t.up),p.down=o.getSVGIconSrc(t.down)}))),w=o.getClass(m),v=o.getClass(m+"-container"),b=o.getClass(m+"-dots"),y=o.getClass(m+"-dots-dot");const W=o.getClass(m+"-sort-icon");let x;const D=new u({});let $=!1;const P=o.generateSlots(m,t,e);let C=!0,S=0;const M={componentName:m,column:e.column,api:o,state:s,pointerOptions:{axis:"x",onMove:function({movementX:t,event:o}){if(!C)return;t&&(o.preventDefault(),o.stopPropagation());let i=s.get("config.list.columns.minWidth");"number"==typeof e.column.minWidth&&(i=e.column.minWidth),S+=t,S<i&&(S=i),$&&s.update(`config.list.columns.data.${e.column.id}.width`,S)}}};function I(){if(!e||!e.column||!e.column.id)return;M.column=e.column,w=o.getClass(m,e.column.id),v=o.getClass(m+"-container",e.column.id),b=o.getClass(m+"-dots",e.column.id),y=o.getClass(m+"-dots-dot",e.column.id),C=!("resizer"in e.column)||e.column.resizer;const t=s.get("config.list");x=S=e.column.width*t.columns.percent*.01,D.style["--width"]=t.columns.resizer.width+"px",$=t.columns.resizer.inRealTime,s.update("$data.list.width",x),P.change(e),n()}c((t=>{e=t,I()})),i(s.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],I,{group:!0}));let R=[1,2,3,4,5,6,7,8];i(s.subscribe("config.list.columns.resizer.dots",(t=>{R=[];for(let e=0;e<t;e++)R.push(e);n()})));let z=!0;function O(){e.column.sortable&&(z=!z,s.update("config.list.sort",(t=>(t.activeColumnId=e.column.id,t.asc=z,t))))}let A=!1;i(s.subscribe("config.list.sort",(t=>{if(t.activeColumnId===e.column.id)return z=t.asc,void(A=!0);A=!1}))),f.push(d);const k=r.create(g,M),L=r.create(f,M);function G({className:t,containerClass:e,iconClass:o,dotsClass:s,dotClass:i,dotsStyleMap:a,dots:n,onLabelClick:l,dotsActions:r,resizer:c,icons:d,sortActive:u,cache:h,asc:m,actions:g,slots:f,html:p,unsafeHTML:w,vido:v,props:b}){const y=!b||!b.column;function W(){return b.column.sortable&&u?m?p` <img src="${d.down}" class=${o} /> `:p` <img src="${d.up}" class=${o} /> `:null}function x(){return y?null:"function"==typeof b.column.header.content?b.column.header.content({column:b.column,vido:v}):b.column.header.content}return h(y?null:f.html("outer",p`
      ...
      `)}
            ...
            `))}let H=G;return i(s.subscribe(`config.templates.${m}`,(t=>{H=null!=t?t:G,n()}))),()=>H({className:w,containerClass:v,onLabelClick:O,iconClass:W,cache:a,dotsClass:b,dotsStyleMap:D,dotsActions:L,dots:R,dotClass:y,resizer:C,icons:p,sortActive:A,asc:z,actions:k,slots:P,html:l,unsafeHTML:h,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */class L{constructor(t,e){let o=e.state.get("$data.elements.list-column-rows"),s=!1;void 0===o&&(s=!0,o=[]),o.includes(t)||(o.push(t),s=!0),s&&e.state.update("$data.elements.list-column-rows",o,{only:null})}destroy(t,e){e.state.update("$data.elements.list-column-rows",(e=>e.filter((e=>e!==t))),{only:null})}}function G(t,e){const{api:o,state:s,onDestroy:i,cache:a,Actions:n,update:l,html:r,createComponent:c,onChange:d,StyleMap:u,unsafeHTML:h}=t,m="list-column-row",g=Object.assign(Object.assign({},e),{api:o,state:s,componentName:m});let f,p=!1;i(s.subscribe("config.components.ListColumnRowExpander",(t=>f=t)));const w=new u(e.column.expander?{height:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{height:"",top:"","--height":""}),v=c(f,{row:e.row}),b=o.getClass(m),y=o.getClass(m+"-content");let W=o.getClass(m);const x=o.generateSlots(m,t,e);let D;d((function(i,a){var n;if(a.leave||!i||void 0===i.row||void 0===i.column)return p=!0,x.change(i,a),void l();p=!1,e=i;for(const t in e)g[t]=e[t];if(!e.column||!e.row||!e.rowData)return p=!0,x.change(i,a),void l();if(void 0===e.column||void 0===e.row)return;D=e.column.isHTML?void 0===e.row?null:"function"==typeof e.column.data?h(e.column.data({row:e.row,vido:t})):"function"==typeof e.row[e.column.data]?h(e.row[e.column.data]({row:e.row,vido:t})):h(e.row[e.column.data]):void 0===e.row?null:"function"==typeof e.column.data?e.column.data({row:e.row,vido:t}):"function"==typeof e.row[e.column.data]?e.row[e.column.data]({row:e.row,vido:t}):e.row[e.column.data];const r=s.get("config.list.expander");for(const t in w.style)delete w.style[t];w.style.height=e.rowData.outerHeight+"px",w.style["--height"]=e.rowData.outerHeight+"px",e.column.expander&&(w.style["--expander-padding-width"]=r.padding*(e.rowData.parents.length+1)+"px");const c=s.get("config.list.rows");for(const t of e.rowData.parents){const e=c[t];if("object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children){const t=e.style.children;for(const e in t)w.style[e]=t[e]}}if(null===(n=null==e?void 0:e.row)||void 0===n?void 0:n.style)for(const t in e.row.style)w.style[t]=e.row.style[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)W=o.getClass(m)+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const s=e.row.classNames({row:e.row,vido:t});Array.isArray(s)&&s.length&&(W=o.getClass(m)+" "+s.join(" "))}}else W=b;v&&v.change(e),x.change(e,a),l()})),i((()=>{v&&v.destroy()}));const $=o.getActions(m);$.includes(L)||$.push(L);const P=n.create($,g);function C({classNameCurrent:t,classNameContent:e,styleMap:o,cache:s,shouldDetach:i,content:a,ListColumnRowExpander:n,slots:l,actions:r,html:c,vido:d,props:u}){return s(i||!u||!u.column||!u.row?null:l.html("outer",c`
              <div
                class=${t}
            ...
            `))}let S=C;return i(s.subscribe("config.templates.list-column-row",(t=>{S=null!=t?t:C,l()}))),()=>S({classNameCurrent:W,cache:a,shouldDetach:p,styleMap:w,ListColumnRowExpander:v,classNameContent:y,slots:x,actions:P,content:D,html:r,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */function T(t,e){const{api:o,state:s,cache:i,onDestroy:a,Actions:n,update:l,html:r,onChange:c}=t,d="list-column-row-expander-toggle",u=Object.assign(Object.assign({},e),{api:o,state:s,componentName:d}),h=o.getActions(d),m=o.getClass(d),g=o.getClass(d+"-child"),f=o.getClass(d+"-open"),p=o.getClass(d+"-closed");let w,v,b,y=!1;a(s.subscribe("$data.list.expander.icons",(t=>{t&&(w=t.child,v=t.open,b=t.closed),l()})));const W=o.generateSlots(d,t,e);e.row?(c((function(t){if(e&&e.row){e=t;for(const t in e)u[t]=e[t];y=e.row.expanded,W.change(t),l()}})),a((function(){}))):a(s.subscribe("config.list.rows.*.expanded",(function(t){for(const e of t)if(e.value){y=!0;break}l()}),{bulk:!0}));const x=n.create(h,u);function D(){y=!y,e.row?s.update(`config.list.rows.${e.row.id}.expanded`,y,{data:{name:"expanded",rowId:e.row.id,expanded:y}}):s.update("config.list.rows",(t=>{for(const e in t)t[e].expanded=y;return t}),{only:["*.expanded"]})}function $({className:t,classNameChild:e,classNameOpen:o,classNameClosed:s,expanded:i,iconChild:a,iconOpen:n,iconClosed:l,toggle:r,cache:c,slots:d,actions:u,html:h,vido:m,props:g}){return c(!g||!g.rowData||!g.row?null:d.html("outer",h`
            ...
            `));var f,p}let P=$;return a(s.subscribe(`config.templates.${d}`,(t=>{P=null!=t?t:$,l()}))),()=>P({className:m,classNameChild:g,iconChild:w,expanded:y,cache:i,classNameOpen:f,classNameClosed:p,iconOpen:v,iconClosed:b,toggle:D,slots:W,actions:x,html:r,vido:t,props:e})}
/**
 ...
 */function N(t,e={}){const{html:o,onDestroy:s,api:i,state:a,update:n,StyleMap:l,Actions:r,onChange:c}=t,d="list-toggle",u=i.getClass(d),h=Object.assign(Object.assign({},e),{api:i,state:a,componentName:d});let m={open:"",close:""};s(a.subscribe("$data.list.toggle.icons",(t=>{t&&(m=t,n())})));const g=new l({top:"0px"});s(a.subscribe("$data.scroll.vertical.preciseOffset",(t=>{g.style.top=(-1*Math.round(t)||0)+"px"})));let f=!0;s(a.subscribe("config.list.columns.percent",(t=>f=0!==t)));let p=!1;function w(){p=!0}function v(){p&&(p=!1,a.update("config.list.columns.percent",(t=>0===t?100:0)))}c((t=>{e=t;for(const o in t)h[o]=e[o]}));const b=i.getActions(d),y=r.create(b,h),W=i.generateSlots(d,t,e);function x({className:t,styleMap:e,pointerDown:o,pointerUp:s,open:i,toggleIconsSrc:a,actions:n,slots:l,html:r,vido:c,props:d}){return l.html("outer",r`
      ...
      `)}let D=x;return s(a.subscribe("config.templates.list-toggle",(t=>{D=null!=t?t:x,n()}))),()=>D({className:u,styleMap:g,pointerDown:w,pointerUp:v,open:f,toggleIconsSrc:m,actions:y,slots:W,html:o,vido:t,props:e})}
/**
 * Chart component
 *
 * @copyright NEURONET - Rafal Pospiech <https://neuronet.io>
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */function V(t,e={}){const{api:o,state:s,onDestroy:i,Actions:a,html:n,createComponent:l,update:r}=t,c="chart",d=[];let u,h,m;d.push(s.subscribe("config.components.ChartCalendar",(t=>u=t))),d.push(s.subscribe("config.components.ChartTimeline",(t=>h=t))),d.push(s.subscribe("config.components.ScrollBar",(t=>m=t)));const g=l(u);i(g.destroy);const f=l(h);i(f.destroy);const p=l(m,{type:"horizontal"});i(p.destroy);const w=l(m,{type:"vertical"});i(w.destroy),i((()=>{d.forEach((t=>t()))}));const v=o.getClass(c),b=o.getActions(c);let y=!1;i(s.subscribe("config.chart.time.calculatedZoomMode",(t=>y=t)));const W={handleEvent:function(t){t.type},passive:!1,capture:!1};let x,D=0;b.push((function(t){x||(x=new ResizeObserver((()=>{const e=t.offsetWidth,o=t.offsetHeight,i=e-s.get("config.scroll.horizontal.width"),a=s.get("config.headerHeight");D!==e&&(D=e,s.update("$data.chart.dimensions",(t=>(t.width=e,t.widthWithoutScrollBar=i,t.height=o,t.innerHeight=o-a,t))))})),x.observe(t),s.update("$data.elements.chart",t))})),i((()=>{x.disconnect()}));const $={api:o,state:s,componentName:c},P=a.create(b,$),C=o.generateSlots(c,t,e);function S({className:t,onWheel:e,ChartCalendar:o,ChartTimeline:s,ScrollBarVertical:i,calculatedZoomMode:a,ScrollBarHorizontal:n,actions:l,slots:r,html:c,vido:d,props:u}){return r.html("outer",c`
      ...
      `)}let M=S;return i(s.subscribe("config.templates.chart",(t=>{M=null!=t?t:S,r()}))),()=>M({className:v,onWheel:W,ChartCalendar:g,ChartTimeline:f,ScrollBarVertical:w,calculatedZoomMode:y,ScrollBarHorizontal:p,actions:P,slots:C,html:n,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */function B(t,e){const{api:o,state:s,onDestroy:i,Actions:a,update:n,reuseComponents:l,html:r,StyleMap:c}=t,d="chart-calendar",u=o.getActions(d),h=Object.assign(Object.assign({},e),{api:o,state:s,componentName:d}),m=s.get("config.components.ChartCalendarDate"),g=o.getClass(d);let f;const p=new c({height:"","--headerHeight":"","margin-left":""});i(s.subscribe("config.headerHeight",(t=>{f=t,p.style.height=f+"px",p.style["--calendar-height"]=f+"px",n()})));let w=[],v=0;i(s.subscribe("$data.chart.time.levels",((t,e)=>{const i=s.get("$data.chart.time.levels");let a=0;if(i.length!==v){v=i.length,w.forEach((t=>t.forEach((t=>t.destroy())))),w=[];for(let t=0;t<v;t++)w.push([])}for(const t of i){if(!t.length)continue;let e="YYYY-MM-DD HH";switch(t[0].period){case"day":e="YYYY-MM-DD";break;case"week":e="YYYY-MM-ww";break;case"month":e="YYYY-MM";break;case"year":e="YYYY"}const s=o.time.date().format(e);l(w[a],t,(t=>t&&{level:a,date:t,currentDate:s,currentDateFormat:e}),m,!0),a++}n()}))),i((()=>{w.forEach((t=>t.forEach((t=>t.destroy()))))})),u.push((t=>{s.update("$data.elements.chart-calendar",t)}));const b=a.create(u,h),y=o.generateSlots(d,t,e);function W({className:t,styleMap:e,components:o,actions:s,slots:i,html:a,vido:n,props:l}){return i.html("outer",a`
      ...
      `)}let x=W;return i(s.subscribe("config.templates.chart-calendar",(t=>{x=null!=t?t:W,n()}))),()=>x({className:g,styleMap:p,components:w,actions:b,slots:y,html:r,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */class j extends s{constructor(t,e){super(),e.state.update("$data.elements.chart-calendar-dates",(e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e)))}}function E(t,e){const{api:o,state:s,onDestroy:i,Actions:a,update:n,onChange:l,html:r,StyleMap:c,cache:d}=t,u="chart-calendar-date",h=o.getActions(u),m=o.getClass(u);let g,f="",p="";i(s.subscribe("config.chart.time",(t=>g=t)));const w=new c({width:"0px"},{schedule:!1});let v="";function b(){if(!e||!e.date)return;const t=s.get(`config.chart.calendarLevels.${e.level}`);w.style.width=e.date.currentView.width+"px",w.style.left=e.date.currentView.leftPx+"px";const o=t.find((t=>+g.zoom<=+t.zoomTo));f=e.date.current?" gstc-current":e.date.next?" gstc-next":e.date.previous?" gstc-previous":"",p=m+"-content "+m+`-content--${e.date.period}`+f,o.classNames&&Array.isArray(o.classNames)?(p+=" "+o.classNames.join(" "),v=" "+o.classNames.join(" ")):v="",n()}let y=!1;const W=o.generateSlots(u,t,e);let x,D,$;const P={date:e.date,period:e.period,api:o,state:s,componentName:u};l(((t,o)=>{if(o.leave)return y=!0,W.change(t,o),n();y=!1,D=e.level===g.level,$=D?m+"--main-date ":m+"--non-main-date ",e=t,P.date=e.date,P.period=e.period,x&&x(),x=s.subscribeAll(["$data.chart.time","config.chart.calendarLevels"],b,{bulk:!0}),W.change(t,o)})),i((()=>{x()})),h.includes(j)||h.push(j);const C=a.create(h,P);function S({className:t,mainClass:e,additionalClass:o,formatClassName:s,finalClassName:i,styleMap:a,cache:n,shouldDetach:l,actions:r,slots:c,html:d,vido:u,props:h}){return n(l||!h||!h.date?null:c.html("outer",d`
              <div
            ...
            `))}let M=S;return i(s.subscribe(`config.templates.${u}`,(t=>{M=null!=t?t:S,n()}))),()=>M({className:m,mainClass:$,additionalClass:f,formatClassName:v,styleMap:w,finalClassName:p,cache:d,shouldDetach:y,actions:C,slots:W,html:r,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */function Y(t,e){const{api:o,state:s,onDestroy:i,Action:a,Actions:n,update:l,html:r,createComponent:c,StyleMap:d}=t,u="chart-timeline",h=Object.assign(Object.assign({},e),{api:o,state:s,componentName:u});let m,g,f;i(s.subscribe("config.components.ChartTimelineGrid",(t=>{m&&m.destroy(),m=c(t)}))),i((()=>{m&&m.destroy()})),i(s.subscribe("config.components.ChartTimelineItems",(t=>{g&&g.destroy(),g=c(t)}))),i((()=>{g&&g.destroy()})),i(s.subscribe("config.components.ListToggle",(t=>{f&&f.destroy(),f=c(t)}))),i((()=>{f&&f.destroy()}));const p=o.generateSlots(u,t,e),w=o.getClass(u),v=o.getClass("chart-timeline-inner");let b;i(s.subscribe("config.list.toggle.display",(t=>b=t)));const y=new d({}),W=new d({});let x,D;i(s.subscribe("config.additionalSpace",(t=>{x=t,l()}))),i(s.subscribe("config.headerHeight",(t=>{D=t,l()}))),i(s.subscribeAll(["$data.chart.dimensions.heightWithoutScrollBar","$data.scroll.vertical.offset","$data.chart.dimensions.width","$data.list.visibleRowsHeight","$data.chart.time.dates.day","config.headerHeight","config.additionalSpace"],(function(){const t=s.get("$data.chart.dimensions.width"),e=Math.round(o.getRealChartHeight(!0));y.style.height=s.get("config.innerHeight")+"px",y.style["--height"]=y.style.height,y.style.top=x.top+D+"px",t?(y.style.width=t+"px",y.style["--width"]=t+"px"):(y.style.width="0px",y.style["--width"]="0px"),W.style.height=e+"px",W.style.width=t?t+"px":"0px";const i=s.get("$data.scroll.vertical.preciseOffset")||0;W.style.transform=`translateY(${Math.round(i)}px)`,l()}),{group:!0,bulkValue:!1}));let $=[];i(s.subscribe("config.actions.chart-timeline",(t=>{$=t}))),$.push(class extends a{constructor(t){super();s.get("$data.elements.chart-timeline")!==t&&s.update("$data.elements.chart-timeline",t)}});const P=n.create($,h);function C({className:t,classNameInner:e,styleMap:o,innerStyleMap:s,Grid:i,Items:a,showToggle:n,ListToggle:l,actions:r,slots:c,html:d,vido:u,props:h}){return c.html("outer",d`
      ...
      `)}let S=C;return i(s.subscribe("config.templates.chart-timeline",(t=>{S=null!=t?t:C,l()}))),()=>S({className:w,styleMap:y,classNameInner:v,Grid:m,innerStyleMap:W,Items:g,showToggle:b,ListToggle:f,actions:P,slots:p,html:r,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */class _{constructor(t,e){e.state.get("$data.elements.chart-timeline-grid")!==t&&e.state.update("$data.elements.chart-timeline-grid",t,{only:null})}destroy(t,e){e.state.update("$data.elements",(t=>(delete t["chart-timeline-grid"],t)),{only:null})}}function Z(t,e){const{api:o,state:s,onDestroy:i,Actions:a,update:n,html:l,reuseComponents:r,StyleMap:c}=t,d="chart-timeline-grid",u=o.getActions(d),h={api:o,state:s,componentName:d},m=s.get("config.components.ChartTimelineGridRow"),g=o.getClass(d);let f,p;i(s.subscribe("config.chart.grid.cell.onCreate",(t=>f=t))),i(s.subscribe("config.debug",(t=>p=t)));const w=[],v={},b=new Map,y=new c({});i(s.subscribeAll(["$data.scroll.vertical.preciseOffset","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar"],(function(){const t=s.get("$data.chart.dimensions.width"),e=o.getRealChartHeight();y.style.height=Math.round(e)+"px",y.style.width=t+"px"}),{group:!0}));let W="",x=0,D=0,$="",P=0,C="";i(s.subscribeAll(["$data.list.rowsHeight","$data.list.visibleRows","$data.list.visibleRowsHeight","$data.chart.time.levels","$data.scroll","config.list.rows;","config.list.rows.*;"],(function(e,i){const a=s.get("$data.chart.time"),n=s.get(`$data.chart.time.levels.${a.level}`),l=a.levels[a.level];if(!l||!l.length)return;const r=a.levels[a.level].map((t=>t.currentView.width)).join(",");if(!n||0===n.length)return void s.update("$data.chart.grid",{rows:{},cells:{}});const c=o.getRowsData(),d=s.get("$data.list.visibleRows"),u=d.map((t=>c[t].outerHeight)).join("|"),h=d.join("|");if(h===W&&x===a.leftGlobal&&D===a.rightGlobal&&u===$&&P===n.length&&C===r)return;x=a.leftGlobal,D=a.rightGlobal,C=r,$=u,p&&console.log("[grid.ts] generateCells");let m=0;if(h!==W)for(const t in v)delete v[t];else if(P!==n.length)for(const t in v)v[t].cells.length=0;P=n.length;const g=o.getAllRows(),w=s.get("$data.chart.grid.cells");for(const t in w)delete w[t];for(const e of d){const s=g[e],i=c[e];if(!s||!i)continue;let a,l;h!==W?a=[]:(a=v[e].cells,a.length=0);for(const e of n){let n;b.has(e.leftGlobal)?n=b.get(e.leftGlobal):(n=o.time.date(e.leftGlobal).format("YYYY-MM-DDTHH-mm-ss"),b.set(e.leftGlobal,n));const l=s.id+"-"+n;let r;w[l]?(r=w[l],r.id=l,r.time=e,r.row=s,r.rowData=i,r.top=m,r.vido=t,r.content=null):r={id:l,time:e,row:s,rowData:i,top:m,vido:t,content:null};for(const t of f)r.content=t(r);w[r.id]=r,a.push(r.id)}v[e]?(l=v[e],l.row=s,l.rowData=i,l.cells=a,l.top=m):l={row:s,rowData:i,cells:a,top:m},v[e]=l,m+=i.outerHeight}W=h,s.update("$data.chart.grid",{rows:v,cells:w})}),{group:!0,bulkValue:!1})),i(s.subscribe("$data.chart.grid",(function(t,e){p&&console.log("[grid.ts] generate rows components",e);const s=o.getGridRows();r(w,s||[],(t=>t),m,!0),n()}),{group:!0})),i((()=>{w.forEach((t=>t.destroy()))})),u.push(_);const S=a.create(u,h),M=o.generateSlots(d,t,e);function I({className:t,styleMap:e,rowsComponents:o,actions:s,slots:i,html:a,vido:n,props:l}){return i.html("outer",a`
        <div class=${t} data-actions=${s()} style=${e.directive()}>
          ${i.html("content",o.map((t=>t.html())))}
        </div>
      `)}let R=I;return i(s.subscribe(`config.templates.${d}`,(t=>{R=null!=t?t:I,n()}))),()=>R({className:g,styleMap:y,rowsComponents:w,actions:S,slots:M,html:l,vido:t,props:e})}
/**
 ...
 */class K{constructor(t,e){let o=!1,s=e.state.get("$data.elements.chart-timeline-grid-rows");void 0===s&&(s=[],o=!0),s.includes(t)||(s.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-grid-rows",s,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-grid-rows",(e=>e.filter((e=>e!==t))),{only:null})}}function q(t,e){const{api:o,state:s,onDestroy:i,cache:a,Actions:n,update:l,html:r,reuseComponents:c,onChange:d,StyleMap:u}=t,h="chart-timeline-grid-row",m=Object.assign(Object.assign({},e),{api:o,state:s,componentName:h});let g;i(s.subscribe("config.components.ChartTimelineGridRowCell",(t=>g=t)));const f=o.getActions(h),p=o.getClass(h),w=new u({height:e.row.height+"px"});let v=!1;const b=o.generateSlots(h,t,e),y=[];d((function(t,s){if(!t||s.leave||void 0===t.row)return v=!0,c(y,[],(t=>t),g,!0),b.change(t,s),void l();v=!1,e=t;const i=o.getGridCells(e.cells);if(c(y,i,(t=>t),g,!0),w.setStyle({}),w.style.height=e.rowData.outerHeight+"px",e.row.style)for(const t in e.row.style)w.style[t]=e.row.style[t];for(const t in e)m[t]=e[t];b.change(t,s)})),i((function(){y.forEach((t=>t.destroy()))})),-1===f.indexOf(K)&&f.push(K);const W=n.create(f,m);function x({className:t,styleMap:e,rowsCellsComponents:o,cache:s,shouldDetach:i,actions:a,slots:n,html:l,vido:r,props:c}){return s(i||!c||!c.row?null:n.html("outer",l`
            ...
            `))}let D=x;return i(s.subscribe(`config.templates.${h}`,(t=>{D=null!=t?t:x,l()}))),()=>D({className:p,styleMap:w,rowsCellsComponents:y,cache:a,shouldDetach:v,actions:W,slots:b,html:r,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */class U{constructor(t,e){let o=!1,s=e.state.get("$data.elements.chart-timeline-grid-row-cells");void 0===s&&(s=[],o=!0),s.includes(t)||(s.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-grid-row-cells",s,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-grid-row-cells",(e=>e.filter((e=>e!==t))),{only:[""]})}}function F(t,e){const{api:o,state:s,cache:i,Actions:a,html:n,onChange:l,onDestroy:r,StyleMap:c,update:d}=t,u="chart-timeline-grid-row-cell",h=Object.assign(Object.assign({},e),{api:o,state:s,componentName:u});let m=!1;const g=o.getActions(u),f=o.generateSlots(u,t,e);let p;function w(t){p=o.getClass(u),t&&t.time&&t.time.current&&(p+=" current")}w(e);const v=new c({width:"",height:""});l((function(t,o){var s,i;if(!t||o.leave||void 0===t.row)return m=!0,f.change(t,o),void d();m=!1,e=t;for(const t in e)h[t]=e[t];if(w(e),v.setStyle({}),e&&e.row){if(v.style.width=((null===(i=null===(s=null==e?void 0:e.time)||void 0===s?void 0:s.currentView)||void 0===i?void 0:i.width)||0)+"px",e.row.style)for(const t in e.row.style)v.style[t]=e.row.style[t];f.change(e,o),d()}})),g.push(U);const b=a.create(g,h);function y({className:t,styleMap:e,cache:o,shouldDetach:s,actions:i,slots:a,html:n,vido:l,props:r}){var c;return o(s||!r||!r.id?null:a.html("outer",n`
              <div class=${t} data-gstcid=${r.id} data-actions=${i()} style=${e.directive()}>
                ${a.html("content",null!==(c=r&&r.content)&&void 0!==c?c:null)}
              </div>
            `))}let W=y;return r(s.subscribe(`config.templates.${u}`,(t=>{W=null!=t?t:y,d()}))),()=>W({className:p,styleMap:v,cache:i,shouldDetach:m,actions:b,slots:f,html:n,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */class Q{constructor(t,e){let o=!1,s=e.state.get("$data.elements.chart-timeline-items-rows");void 0===s&&(s=[],o=!0),s.includes(t)||(s.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-rows",s,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-rows",(e=>e.filter((e=>e!==t))),{only:null})}}function X(t,e){const{api:o,state:s,onDestroy:i,cache:a,Actions:n,update:l,html:r,onChange:c,reuseComponents:d,StyleMap:u}=t,h="chart-timeline-items-row",m=Object.assign(Object.assign({},e),{api:o,state:s,componentName:h});let g;i(s.subscribe("config.components.ChartTimelineItemsRowItem",(t=>g=t)));let f="";const p=[],w=new u({width:"",height:""});let v=!1;function b(t=e.rowData,o=null){const i=s.get("$data.chart");v=!1,w.style.width=i.dimensions.width+"px",e?(w.style.height=t.outerHeight+"px",w.style["--row-height"]=t.outerHeight+"px",l()):v=!0}function y(t,e){if(!t||!e)return v=!0,d(p,[],(()=>null),g,!0),l();const s=e.items;if(void 0===s)return v=!0,d(p,[],(()=>null),g,!0),b(),l();const i=o.getItems(s);i.sort(((t,e)=>t.time.start-e.time.start)),d(p,i,(e=>({row:t,item:e,itemData:e?o.getItemData(e.id):null})),g,!0),b(),l()}const W=o.getClass(h),x=o.generateSlots(h,t,e);c((function(o,s){if(s.leave||!o||void 0===o.row)return v=!0,d(p,[],(()=>null),g,!0),x.change(o,s),l();e=o;for(const t in e)m[t]=e[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)f=W+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const o=e.row.classNames({row:e.row,vido:t});Array.isArray(o)&&o.length&&(f=W+" "+o.join(" "))}}else f=W;y(e.row,e.rowData),x.change(o,s),l()})),i(s.subscribe("$data.chart.dimensions.width",(()=>y(e.row,e.rowData)))),i((()=>{p.forEach((t=>t.destroy()))}));const D=o.getActions(h);D.push(Q);const $=n.create(D,m);function P({classNameCurrent:t,styleMap:e,shouldDetach:o,itemComponents:s,actions:i,slots:a,cache:n,html:l,vido:r,props:c}){return n(o||!c||!c.row?null:a.html("outer",l`
              <div
                class=${t}
                data-gstcid=${c.row.id}
                data-actions=${i()}
            ...
            `))}let C=P;return i(s.subscribe(`config.templates.${h}`,(t=>{C=null!=t?t:P,l()}))),()=>C({cache:a,shouldDetach:v,classNameCurrent:f,styleMap:w,itemComponents:p,actions:$,slots:x,html:r,vido:t,props:e})}
/**
 ...
 * @released  2021-12-14
 * @license   SEE LICENSE IN LICENSE FILE
 */class tt{constructor(t,e){let o=!1,s=e.state.get("$data.elements.chart-timeline-items-row-items");void 0===s&&(s=[],o=!0),s.includes(t)||(s.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-row-items",s,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-row-items",(e=>e.filter((e=>e!==t))),{only:null})}}function et(t,e){const{api:o,state:s,cache:i,onDestroy:a,Actions:n,update:l,html:r,onChange:c,unsafeHTML:d,StyleMap:u}=t;let h,m,g;a(s.subscribe("config.debug",(t=>g=t)));const f="chart-timeline-items-row-item";let p=0,w=0,v=!1,b="";const y=new u({width:"",height:"",left:"",top:""}),W=new u({}),x=new u({}),D={item:e.item,itemData:e.itemData,row:e.row,left:p,width:w,api:o,state:s,componentName:f},$=o.getClass(f),P=o.getClass(f+"-label"),C=o.generateSlots(f,t,e);let S,M=!1;function I(i=s.get("$data.chart.time")){var a;if(C.change(e,{leave:!1}),v||0===i.levels.length||!i.levels[i.level]||0===i.levels[i.level].length)return M=!0,l();if(!e.item||!e.itemData)return M=!0,l();"verbose"===g&&(console.groupCollapsed("[items-row-item.ts] Update item (before)"),console.log({id:e.item.id,item:e.item}),console.trace(),console.groupEnd());const n=e.itemData;if(p=n.position.actualLeft,w=n.actualWidth,e.item.time.end<i.leftGlobal||e.item.time.start>i.rightGlobal||w<=0)return M=!0,n.detached=M,l();b=$,e.item.time.start<i.leftGlobal?(W.style.display="flex",b+=" "+o.getClass(f+"--left-cut")):W.style.display="none";const r=i.totalViewDurationPx<i.width?i.totalViewDurationPx:i.width;if(n.position.right>r?(x.style.display="flex",b+=" "+o.getClass(f+"--right-cut")):x.style.display="none",e.item.classNames)if(Array.isArray(e.item.classNames)&&e.item.classNames.length)b+=" "+e.item.classNames.join(" ");else if("function"==typeof e.item.classNames){const o=e.item.classNames({item:e.item,vido:t});Array.isArray(o)&&(b+=" "+o.join(" "))}const c=y.style.width,d=y.style.left,u=y.style.top,h=y.style.height;y.setStyle({});const m=o.isItemInViewport(e.item,i.leftGlobal,i.rightGlobal);if(M=!m,n.detached=M,m?(y.style.width=w+"px",y.style.left=p+"px",y.style.top=n.position.actualRowTop+"px",y.style.height=n.actualHeight+"px"):(y.style.width=c,y.style.left=d,y.style.top=u,y.style.height=h),null===(a=null==e?void 0:e.item)||void 0===a?void 0:a.style)for(const t in e.item.style)y.style[t]=e.item.style[t];D.left=p,D.width=w,"verbose"===g&&console.log("[items-row-item.ts] Update item (after)",{id:e.item.id,itemLeftPx:p,itemWidthPx:w,item:e.item}),l()}a(s.subscribe("config.chart.item.cutIcons",(t=>{S={left:o.getSVGIconSrc(t.left),right:o.getSVGIconSrc(t.right)}})));const R=o.getClass(f+"-cut"),z=()=>r`
    <div class=${R} style=${W.directive()}>
      <img src="${S.left}" width="18" height="18" class=${R+"-image"} />
    </div>
  `,O=()=>r`
    <div class=${R} style=${x.directive()}>
      <img src="${S.right}" width="18" height="18" class=${R+"-image"} />
    </div>
  `;c((function(t,o){if(o.leave||void 0===t.row||void 0===t.item)return v=!0,M=!0,C.change(t,o),l();M=!1,v=!1,(e=t).item.id===h&&e.row.id===m||(h=e.item.id,m=e.row.id),D.item=e.item,D.itemData=e.itemData,D.row=e.row,I(),C.change(t,o),l()}));const A=o.getActions(f);a(s.subscribe("$data.chart.time",I)),A.push(tt);const k=n.create(A,D);function L(){return e.item?e.item.isHTML?e.item&&e.item.label?"function"==typeof e.item.label?d(e.item.label({item:e.item,vido:t})):d(e.item.label):null:e.item&&e.item.label?"function"==typeof e.item.label?e.item.label({item:e.item,vido:t}):e.item.label:null:null}function G({className:t,labelClassName:e,styleMap:o,cache:s,shouldDetach:i,cutterLeft:a,cutterRight:n,getContent:l,actions:r,slots:c,html:d,vido:u,props:h}){return s(i||!h||!h.item?null:c.html("outer",d`
              <div
                class=${t}
            ...
            `))}let H=G;return a(s.subscribe(`config.templates.${f}`,(t=>{H=null!=t?t:G,l()}))),()=>H({className:b,labelClassName:P,cache:i,shouldDetach:M,styleMap:y,cutterLeft:z,cutterRight:O,getContent:L,actions:k,slots:C,html:r,vido:t,props:e})}
/**
 ...
 */function ct(t,e){const{api:o,onDestroy:s,state:i,update:a,StyleMap:n}=t,l=o.name;let r;s(i.subscribe("config.debug",(t=>r=t)));let c=!1;function d(t,e){"fullReload"!==e.options.data&&(m.fullReload(e),"subscribe"===e.type&&setTimeout(m.triggerLoadedEvent,0))}function u(t,e){["config","config.list.rows","config.chart.items"].includes(e.path.update)||(["config.list.rows.*.parentId"].includes(e.path.listener)?function(t,e){"subscribe"!==e.type&&"sortRowsByColumn"!==e.options.data&&"fullReload"!==e.options.data&&m.partialReload(!0,e)}(0,e):function(t,e){"subscribe"!==e.type&&"fullReload"!==e.options.data&&m.partialReload(!1,e)}(0,e))}function h(t=null,e){e&&"subscribe"===e.type||e&&e.options.data&&"updateVisibleItems"===e.options.data||m.minimalReload(e)}var m={className:D(l),styleMap:new n({}),initializePlugins(){const e=[];function o(){e.forEach((t=>t())),e.length=0}s(i.subscribe("config.plugins",(s=>{if(r&&console.log("Plugins changed. Destroying plugins..."),o(),r&&console.log("Plugins destroyed. Initializing plugins..."),void 0!==s&&Array.isArray(s))for(const o of s){const s=o(t);"function"==typeof s?e.push(s):s&&Object.prototype.hasOwnProperty.call(s,"destroy")&&e.push(s.destroy.bind(s))}r&&console.log("Plugins initialized.")}))),s(o)},heightChange(){if(o.isMutedMethod("heightChange"))return;const t=i.get("config"),e=i.get("config.scroll.horizontal.width"),s=t.innerHeight-e;i.multi(!0).update("$data.chart.dimensions.heightWithoutScrollBar",s).update("$data.chart.dimensions.innerHeight",t.innerHeight).update("$data.chart.dimensions.height",t.innerHeight+t.headerHeight).update("$data.height",t.innerHeight+t.headerHeight).done(),m.styleMap.style["--height"]=s+"px",m.styleMap.style.height=t.innerHeight+t.headerHeight+"px",o.calculateVerticalScrollSize(),a()},resizerActiveChange(t){c=t,m.className=D(o.name),c&&(m.className+=` ${o.name}__list-column-header-resizer--active`),a()},generateTreeFromVisibleRows(){if(o.isMutedMethod("generateTreeFromVisibleRows"))return;const t=o.getVisibleRowsId(),e=o.getAllRows(),s=o.getRowsData(),n={},l={},r=i.get("config.chart.items"),c={};for(const o of t){const t=e[o],i=s[o];l[o]=i,n[o]=t;for(const t of i.items)c[t]=r[t]}o.makeTreeMap(l,c,!0),a()},generateTree(t=!0){let e=i.get("$data.list.rowsIds");if(!e)return;e=e.slice();const s=i.get("config.list.rows");if(!t)return m.generateTreeFromVisibleRows();o.fillEmptyRowValues(s);let a=o.getAllRows();const n=o.getRowsData(),l=i.get("config.chart.items");o.makeTreeMap(n,l),a=o.sortRowsByChildren(Object.values(a).map((t=>t.id)));i.get("config").list.rows=a,o.prepareItems(l);const r=Object.keys(a);i.update("$data.list.rowsIds",r),o.setAllRowsIdsCache(r)},prepareExpanded(){if(o.isMutedMethod("prepareExpanded"))return;const t=o.getAllRows();if(!t)return;const e=o.generateRowsWithParentsExpanded(t);i.update("$data.list.rowsWithParentsExpanded",e)},generateVisibleRowsAndItems(){if(o.isMutedMethod("generateVisibleRowsAndItems"))return;const t=o.getVisibleRows(),e=i.get("$data.list.visibleRows")||[];let s=!0;t.length!==e.length?s=!0:t.length&&(s=t.join("|")!==e.join("|"));let n=i.multi(!0);s&&(n=n.update("$data.list.visibleRows",t));const l=[],r=o.getRowsData();for(const e of t){const t=r[e];for(const e of t.items)l.push(e)}const c=i.get("$data.chart.visibleItems")||[];l.join("|")!==c.join("|")&&(n=n.update("$data.chart.visibleItems",l)),n.done(),a()},updateItemsVerticalPositions(){const t=o.getAllItems(),e=o.getItemsData(),s=o.getRowsData(),i=o.getVisibleRows(),a=[];for(const t of i){const e=s[t];if(e)for(const t of e.items)a.includes(t)||a.push(t)}for(const i of a){const a=t[i];a&&o.calculateItemVerticalPosition(i,e[i],s[a.rowId])}},getMutedListeners(){const t=[];return i.isMutedListener(d)&&t.push(d),i.isMutedListener(u)&&t.push(u),i.isMutedListener(h)&&t.push(h),t},triggerLoadedEvent(){Promise.resolve().then((()=>{const t=i.get("$data.elements.main");if(!t)return;const e=t.parentNode;if(!e)return;const o=new Event("gstc-loaded");t.dispatchEvent(o),e.dispatchEvent(o)}))},getLastPageDatesWidth(t,e){if(0===e.length)return 0;let o=0,s=0;if(e.length){if(Math.ceil(e[e.length-1].rightPx)>t)for(let i=e.length-1;i>=0;i--){const a=e[i];if(o+=a.width,o>=t){o-=a.width;break}s++}}return i.update("$data.scroll.horizontal",(t=>(t.lastPageSize=o,t.lastPageCount=s,t))),o},generatePeriodDates(e,s,i,a){const n=e.period,l=s.fromDate,r=s.toDate,c=o.time.generatePeriodDates({leftDate:l,rightDate:r,level:i,levelIndex:a,period:n,time:s,callOnDate:!1,callOnLevelDates:!0}),d=D("chart-calendar-date");for(const o of c)o.formatted=e.format({timeStart:o.leftGlobalDate,timeEnd:o.rightGlobalDate,vido:t,className:d,props:{date:o}});return c},limitGlobal:(t,e)=>(t.centerGlobal=e.centerGlobal,t.centerGlobalDate=e.centerGlobalDate,t),setCenter(t){let e=Math.floor(t.rightGlobalDate.diff(t.leftGlobalDate,"millisecond",!0)/2);const s=o.time.getRightViewDate(t);s&&(s.width!==s.currentView.width&&(e-=(s.width-s.currentView.width)*t.timePerPixel),t.centerGlobalDate=t.leftGlobalDate.add(e,"millisecond"),t.centerGlobal=t.centerGlobalDate.valueOf())},guessPeriod(t,e){if(!t.zoom)return t;for(const o of e){const e=o.find((e=>+t.zoom<=+e.zoomTo));e&&e.main&&(t.period=e.period)}return r&&console.log("[main.ts] guessPeriod",t.period,{time:t}),t},getFormatAndLevelIndexForZoom(t,e=i.get("config.chart.calendarLevels")){let o=0,s=0;for(const i of e){for(const e of i)if(e.main&&t<=e.zoomTo)return s=o,{levelIndex:s,format:e};o++}if(!s)throw new Error(`There is no main date format for zoom ${t}.`)},generateAllDates(t,e){if(!t.zoom)return 0;t.allDates=new Array(e.length);const{format:o,levelIndex:s}=m.getFormatAndLevelIndexForZoom(t.zoom,e);t.level=s,t.allDates[t.level]=m.generatePeriodDates(o,t,e[s],t.level);let i=0;for(const o of e){const e=o.find((e=>+t.zoom<=+e.zoomTo));i!==t.level&&(t.allDates[i]=m.generatePeriodDates(e,t,o,i)),i++}return t.allDates},getPeriodDates(t,e){if(!t.length)return[];const s=t.filter((t=>t.leftGlobal<e.rightGlobal&&t.rightGlobal>=e.rightGlobal||t.leftGlobal<=e.leftGlobal&&t.rightGlobal>e.leftGlobal||t.leftGlobal>=e.leftGlobal&&t.rightGlobal<=e.rightGlobal));if(!s.length)return[];let i=0;e.leftGlobal>s[0].leftGlobal&&(i=o.time.getDatesDiffPx(e.leftGlobalDate,s[0].leftGlobalDate,e,!0));let a=0;const n=s.length-1;return s.map(((t,o)=>(t.currentView={leftPx:a,rightPx:t.rightPx,width:t.width},i<0&&(t.currentView.width=t.width+i,t.currentView.leftPx=0,i=0),t.currentView.rightPx=t.currentView.leftPx+t.currentView.width,a+=t.currentView.width,o===n&&t.currentView.rightPx>e.width&&(t.currentView.rightPx=e.width,t.currentView.width=t.currentView.rightPx-t.currentView.leftPx),t)))},updateLevels(t,e){t.levels=[];let o=0;for(const s of e){const e=s.find((e=>+t.zoom<=+e.zoomTo));if(e.main&&(t.format=e,t.level=o),e){let i=m.getPeriodDates(t.allDates[o],t);t.onCurrentViewLevelDates.forEach((a=>{i=a({dates:i,format:e,time:t,level:s,levelIndex:o})})),t.levels.push(i)}o++}},calculateTotalViewDuration(t){let e=0,o=0;for(const s of t.allDates[t.level])e+=s.width,o+=s.rightGlobal-s.leftGlobal;t.totalViewDurationPx=e,t.totalViewDurationMs=o},calculateRightGlobal(t,e,s,a,n){const l=i.get("$data.chart.time"),r=t.endOf(l.period).valueOf(),c=o.time.findDateAtTime(r,s);if(!c)return t.valueOf();let d=s.indexOf(c),u=c.leftGlobal,h=0;for(let t=s.length;d<t;d++){const t=s[d];if(u=t.rightGlobal,h+=t.width,h+a>=e)break}return u+n},updateVisibleItems(t=i.get("$data.chart.time"),e=i.multi(!0)){r&&console.log("Updating visible items.",{});const s=i.get("$data.chart.visibleItems"),a=o.getItems(s);if(!a)return e;const n=o.getAllRows(),l=o.getRowsData(),c=o.getItemsData();if(!n)return e;if(!t.levels||!t.levels[t.level])return e;const d=i.get("config.chart.spacing");let u=!1;for(const s of a){if(!s)return e;const i=n[s.rowId],a=l[s.rowId];if(!i||!a)continue;const r=o.mergeDeep({},c[s.id]),h=r.position,m=o.calculateItemPosition(s.id,c[s.id],a,t,d,s);for(const t in h)if(m[t]!==h[t]){u=!0;break}if(!u)for(const t in r)if(c[s.id][t]!==r[t]){u=!0;break}}return u&&(e=e.update("$data.chart.items",(t=>t))),r&&console.log("Visible items updated.",{visibleItemsId:s,visibleItems:a}),e},recalculateTimes(t){if(o.isMutedMethod("recalculateTimes"))return;const s=i.get("config.chart.time");let n=e({},s);if(!(n.from&&n.to||Object.keys(i.get("config.chart.items")).length))return;n.fromDate=o.time.date(n.from).startOf(n.period),n.toDate=o.time.date(n.to).endOf(n.period);const l=o.getChartWidth(),r=i.get("config.chart.calendarLevels"),c=Object.assign({},i.get("$data.chart.time")),d=i.get("$data.scroll.horizontal");if(n.calculatedZoomMode&&l){if(n.totalViewDurationMs=o.time.date(n.to).diff(n.from,"millisecond"),n.timePerPixel=n.totalViewDurationMs/l,n.totalViewDurationPx=l,n.zoom=Math.log(n.timePerPixel)/Math.log(2),m.guessPeriod(n,r),c.zoom!==n.zoom||0===n.allDates.length||"utcMode"===t.name||"items"===t.name||"reload"===t.name||"from"===t.name||"to"===t.name||"calculatedZoomMode"===t.name){o.resetHorizontalScroll(),m.generateAllDates(n,r);const t=n.allDates[n.level];n.to=t[t.length-1].rightGlobal,n.toDate=o.time.date(n.to).endOf(n.period)}m.calculateTotalViewDuration(n),n.leftGlobal=n.from,n.leftGlobalDate=o.time.date(n.leftGlobal),n.rightGlobal=n.to,n.rightGlobalDate=o.time.date(n.rightGlobal)}else if(n.timePerPixel=Math.pow(2,n.zoom),"items"===t.name&&(n.from=t.from,n.to=t.to,n.fromDate=o.time.date(n.from).startOf(n.period),n.toDate=o.time.date(n.to).endOf(n.period)),n=o.time.recalculateFromTo(n),n.leftGlobal=n.from,n.leftGlobalDate=o.time.date(n.leftGlobal),c.zoom!==n.zoom||0===n.allDates.length||"utcMode"===t.name||"items"===t.name||"reload"===t.name||"from"===t.name||"to"===t.name||"calculatedZoomMode"===t.name){o.resetHorizontalScroll(),m.generateAllDates(n,r),m.calculateTotalViewDuration(n);const t=n.allDates[n.level];n.to=t[t.length-1].rightGlobal,n.toDate=o.time.date(n.to).endOf(n.period)}else n.totalViewDurationPx=c.totalViewDurationPx,n.totalViewDurationMs=c.totalViewDurationMs;const u=n.allDates[n.level];let h=!1;const g=i.get("$data.chart.time.recalculateTimesLastReason")||"",f=i.get("$data.scroll.horizontal.preciseOffset"),p=f*n.timePerPixel;if(!n.calculatedZoomMode){if(n.zoom===c.zoom&&"period"!==t.name||!c.centerGlobal){if("scroll"===t.name){let t=d.data;t||(t=u[0]),n.leftGlobal=t.leftGlobal-p,n.leftGlobalDate=o.time.date(n.leftGlobal)}}else{const t=l*n.timePerPixel,e=Math.round(t/2),s=Math.ceil(c.centerGlobalDate.diff(c.centerGlobal+e,n.period,!0));n.leftGlobalDate=c.centerGlobalDate.add(s,n.period);const i=n.leftGlobalDate.valueOf();let a=o.time.findDateAtTime(i,u);a||(a=u[0]),n.leftGlobal=a.leftGlobal-p,n.leftGlobalDate=o.time.date(n.leftGlobal),n.rightGlobal=m.calculateRightGlobal(n.leftGlobalDate,l,u,f,p),n.rightGlobalDate=o.time.date(n.rightGlobal),n.rightGlobal=n.rightGlobalDate.valueOf()}n.rightGlobal=m.calculateRightGlobal(n.leftGlobalDate,l,u,f,p),n.rightGlobalDate=o.time.date(n.rightGlobal),n.rightGlobal=n.rightGlobalDate.valueOf()}m.limitGlobal(n,c),o.calculateHorizontalScrollSize(),n.leftInner=n.leftGlobal-n.from,n.rightInner=n.rightGlobal-n.from,n.leftPx=0,n.rightPx=l,n.width=l,m.updateLevels(n,r),h="zoom"!==g&&"period"!==g&&"time"!==g,h&&m.setCenter(n);const w=n.levels[n.level];w&&w.length&&(n.leftPx=w[0].leftPx,n.rightPx=w[w.length-1].leftPx);let v=i.multi(!0).update("$data.chart.time",n).update("config.chart.time",(t=>(t.zoom=n.zoom,t.level=n.level,t.period=n.format.period,t.leftGlobal=n.leftGlobal,t.leftGlobalDate=n.leftGlobalDate,t.centerGlobal=n.centerGlobal,t.rightGlobal=n.rightGlobal,t.rightGlobalDate=n.rightGlobalDate,t.from=n.from,t.to=n.to,t.allDates=n.allDates,t.additionalSpaceAdded=n.additionalSpaceAdded,t)));v=m.updateVisibleItems(n,v),v=v.update("$data.chart.time.recalculateTimesLastReason",t.name),v.done(),a()},minimalReload(t){if(o.isMutedMethod("minimalReload"))return;o.muteMethod("minimalReload");const e=m.getMutedListeners();i.mute(d),i.mute(u),i.mute(h),i.collect(),o.calculateVisibleRowsHeights(),m.generateVisibleRowsAndItems(),m.updateVisibleItems().done(),i.executeCollected(),e.includes(d)||i.unmute(d),e.includes(u)||i.unmute(u),e.includes(h)||i.unmute(h),o.unmuteMethod("minimalReload"),a()},partialReload(t=!0,e){if(o.isMutedMethod("partialReload"))return;o.muteMethod("partialReload");const s=m.getMutedListeners();if(i.mute(d),i.mute(u),i.mute(h),t){const t=i.get("$data");t.list.rows={},t.chart.items={}}i.collect(),m.generateTree(t),m.prepareExpanded(),o.measureRows(),o.calculateVerticalScrollSize(),m.minimalReload(e),i.executeCollected(),s.includes(d)||i.unmute(d),s.includes(u)||i.unmute(u),s.includes(h)||i.unmute(h),o.unmuteMethod("partialReload"),a()},fullReload(t){if(o.isMutedMethod("fullReload"))return;i.update("$data.reloading",!0),o.muteMethod("fullReload");const e=m.getMutedListeners();i.mute(d),i.mute(u),i.mute(h),i.collect(),m.partialReload(!0,t),m.recalculateTimes({name:"reload"}),i.executeCollected(),e.includes(d)||i.unmute(d),e.includes(u)||i.unmute(u),e.includes(h)||i.unmute(h),o.unmuteMethod("fullReload"),i.update("$data.reloading",!1),a()}};s(i.subscribeAll(["config.innerHeight","config.headerHeight","config.scroll.vertical.width"],m.heightChange,{group:!0,bulkValue:!1})),s(i.subscribe("$data.list.columns.resizer.active",m.resizerActiveChange)),s(i.subscribeAll(["config;","config.chart.items;","config.list.rows;","config.list.rows.*;","config.chart.items.*;"],d,{group:!0,bulkValue:!1})),s(i.subscribeAll(["config.list.rows.*.parentId","config.chart.items.*.rowId","config.list.rows.*.expanded"],u,{group:!0,bulkValue:!1})),s(i.subscribeAll(["config.chart.items.*.time","config.chart.items.*.height","config.chart.items.*.top","$data.chart.dimensions.heightWithoutScrollBar","$data.list.rowsHeight"],h,{group:!0,bulkValue:!1})),s(i.subscribeAll(["$data.scroll.vertical.dataIndex","$data.scroll.vertical.preciseOffset"],(function(){i.collect(),m.generateVisibleRowsAndItems(),o.calculateVisibleRowsHeights(),m.updateItemsVerticalPositions(),m.updateVisibleItems().done(),i.executeCollected()}),{group:!0,bulkValue:!1})),s(i.subscribe("config.list.sort",(t=>{const e=i.get(`config.list.columns.data.${t.activeColumnId}`);e&&o.sortRowsByColumn(e,t.asc)}))),s(i.subscribeAll(["config.chart.items.*.time","config.chart.items.*;","config.chart.items.*.rowId"],(function(t,e){e.options.data&&"updateVisibleItems"===e.options.data||m.updateVisibleItems().done()}),{group:!0,bulkValue:!1}));const g={utcMode:!1,initialized:!1,zoom:0,period:"",scrollAbsolutePosPx:0,chartWidth:0,from:0,to:0,calculatedZoomMode:!1};return s(i.subscribeAll(["config.utcMode","config.chart.time","$data.chart.time","config.chart.calendarLevels","$data.scroll.horizontal.absolutePosPx","$data.chart.dimensions.width","config.chart.items.*.time"],(()=>{const t=function(){const t=i.get("config.utcMode"),e=i.get("config.chart.time"),o=i.get("$data.scroll.horizontal.absolutePosPx"),s=i.get("$data.chart.dimensions.width"),a=i.get("config.chart.time.calculatedZoomMode"),n=Object.assign({},g);return g.utcMode=t,g.zoom=e.zoom,g.period=e.period,g.from=e.from,g.to=e.to,g.scrollAbsolutePosPx=o,g.chartWidth=s,g.calculatedZoomMode=a,g.initialized?t!==n.utcMode?{name:"utcMode",oldValue:n.utcMode,newValue:t}:a!==n.calculatedZoomMode?{name:"calculatedZoomMode",oldValue:n.calculatedZoomMode,newValue:a}:e.zoom!==n.zoom?{name:"zoom",oldValue:n.zoom,newValue:e.zoom}:e.period!==n.period?{name:"period",oldValue:n.period,newValue:e.period}:e.from!==n.from?{name:"from",oldValue:n.from,newValue:e.from}:e.to!==n.to?{name:"to",oldValue:n.to,newValue:e.to}:o!==n.scrollAbsolutePosPx?{name:"scroll",oldValue:n.scrollAbsolutePosPx,newValue:o}:s!==n.chartWidth?{name:"chartWidth",oldValue:n.chartWidth,newValue:s}:{name:""}:(g.initialized=!0,{name:"all"})}();t.name&&m.recalculateTimes(t)}),{group:!0,bulkValue:!1})),s(i.subscribe("config.chart.items.:itemId.time",(t=>{const e=i.get("$data.chart.time"),s=o.getAllItems();let a=1/0,n=0;for(const o of t){const t=s[o.params.itemId];if(!t)return;if(t.time.start<e.from||t.time.end>e.to){let o=e.from,s=e.to;return t.time.start<e.from&&(o=t.time.start),t.time.end>e.to&&(s=t.time.end),m.recalculateTimes({name:"items",from:o,to:s})}t.time.start<a&&(a=t.time.start),t.time.end>n&&(n=t.time.end)}if(0===e.leftGlobal&&0===e.rightGlobal)return m.recalculateTimes({name:"items",from:a,to:n})}),{bulk:!0,bulkValue:!1})),t.api.main=m,m}function dt(){const t=["odu3odi0mfLPrhDTqW","WOuAW6q","W5WKvCkJFmoAgmoUB8kHW6S","hSkdWRT6","kCozmSoBW4ddVGnnW4NcSvWUj8kZcI0C","z2vUzxjHDgvtBg90CW","jgrHDgeUzgLTzw5ZAw9UCW","WOBdH8otWPm","Ahr0Chm6lY9NC3rJlM5LDxjVBMv0lMLVl2fWAs9PBNzHBgLKlxrVA2vU","tmoBjM0xW4lcJ8kDW7ebx8kslq","tgLJzw5ZzsbRzxKGy2HLy2SGBwvJAgfUAxnTig5VDcbSB2fKzwqGkhDHC20GzMLSzsKU","otm4rvvAwLPO","u0KVkK9X","gIddUCoIyNHKk8kFWOJdQtq4t1FcH8kWWOBdSCojW5a1sSo1amkOWO3cJSoOxs12W6GNBsJcJSoPzIRcVG","pCkHw8kcwW","WP5lWQTgW7Hwt8kvpYr+W6WuW4HxWOaJ","lMuVyxyVE20+vxrlAfmTwfDLpwrKltKZrtD5sZLmzYO","w8oFifSAW4tcPCkDW7GGx8kAlq","dcVdVKddUCotWR9RW5G","zgf0zq","Ahr0Chm6lY9NC3rJlM5LDxjVBMv0lMLVl2fWAs9SAwnLBNnL","rmo8e8orW7y","C2LNBMf0DxjL","W59LW4pcJJmomW","vgHPCYbKB21HAw4GAxmGBM90ihjLz2LZDgvYzwqGjW","WQjxlfe","jSotmSoAW53dSq","uSk8idyQW6en","C2v0u2nYB2XStgvMDa","nSkTv8kNttC0WQxdPG","y29UzMLNlMfJDgLVBNmUBwfPBG","z3n0yY1LCNjVCG","D2LKDgG","W47cQmkHWPpcKCkIWRdcLwW","iWDRm8oxWRTRW5ddTq","i8oyp8orW5ZdVuHs","pgjYic8+","DMvY","rJS1yYzJw1G0i2u2ps08EG","h8oeWQzjFXfLpCoQ","DMfSDwu","Ag9ZDa","z2v0","ntC1mZG4mgXzrvz4yW","h8ouW48RpCksla","W6D4W7FcGYKfWRRdUGBcQW","W65IW7BcLIKBWQu","nCk5r8kXqdeyWQVdPSkAWP3cItS","Ag9YAxPVBNrHBa","wmkOW4ddUMPfgSopiG","cfJdHuPg","zM9SBg93","W5ZcJ1ZcPCk/WRBdN1NcJYmeWPtdVWOEWOyZBs7dStRdOSocW7XzkSo3W6uRuSkTWPxcJhNdRmomW5FdMq","WOJdM8orWPXsB8kU","AM9PBG","yxnZAwDU","WQzBl1W","ydhdMaymW6K","zCo+hSorW67cSq","AhjLzG","BxvSDgLWBgLLCG","gZhdSvldS8opWQu","q0SMiK8","WPZcRqtdOHi2W6pcUSo/z8kLWOhdSSk4WRfTumo5W4G6WRS","W60wBCkjiG","zgvZy3jPChrPB24","ChvZAa","AgvPz2H0","W6K6WR7dRxS5gNq","W4tdRGZdSXuWWRZdOCoW","z2v0u2nYB2XSvg9W","wmkOW4ddUN1f","DxnLCKfNzw50","D2fZBuLUAxrPywXPEMvK","W6hcIu/cQG","B8kdW5HUWRToWO89WOv7W4tcMq","yw5Jzxn0B3jpCMLNAw5Z","nda2otzPB0HJz3i","WPdcMYxdTLSrWPPitCoeW4S/","C3rHDhvZ","W6JdRXBdO0y5WQFdTmoWESo7W4NcPmk2WQzNgCo/W5u3W7JdUCoAW5ZcH1/dJM1FkvNdLry/W515WQXdW77cMmo+ouldVLZdLvlcGIWdAdziw23dSbdcKCkqW53dM13cGCkmWRVdR2H1WPhcJX5kW77dRmoGtGWiW6ldPSo6WOlcNmojWRLUwq","CNvSzxm","WP0hWRHLWQHEWO7dH8oXfgSfW7pcTCkLjSoXW71SW4hcIZRcVSkMl1SIW7RdMHZdOWW","ySo7fSovW6K","DMfSDwvFBNvT","q8oIW6/cGrddLCogEMmm","W44KtCkRuCoRcCoLyW","DMfSDwvpzG","WOaCWOHHaSoSWRddVmksWQ0jqtW3W6xcR8klEZOR","W4FdPrhdUaaS","W4zMW5ZcNIq","yxbWBgLJyxrPB24VEc13D3CTzM9YBs11CMXLBMnVzgvK","zgf0yuLUzgv4","W5j3iCo7W4eOWPnu","WP9aiuq","W495W4ddN2C","lCotkmoPW4ddTeG","Dg9Rzw5FD2fZ","smorpfGDW5FdJSkzW7GSxSkrk8k7rYZdQSo2wa","WQddLbNdS8oKW6FdNHZcQIalWR8","zmkhW47dSCoDyCkkW7BcHw03WR0FW4hcVmo0W5xcVSoZ","y3jLyxrLzef0","DgLTzq","W4zMW5ZcGIuTobLfWQu","zgLYzwn0AxzL","DgHLBG","dLFdKLTxWQpdLW","t8oxiv0BW57cJSkuW745","y29UzMLNlMLUBMvYsgvPz2H0","y29UDgvUDa","ntq5mJi2ofzYyMXjBW","Dg9Wtgv2zwXeB21HAw5Z","c8ozWRffFHy","W5DmWP7dKq","mtyZmdm3nKrwt0DhqW","W4LiWOpdRaiVzCkTCqKBWQCB","b8osW4CRpq","tgLJzw5ZzsbMB3iGzgLMzMvYzw50ihbYB2r1y3qGAgfZigjLzw4GChjVDMLKzwqU","WOakW7qccfdcPq9Gw14/","tgLJzw5ZzsbOyxmGzxHWAxjLzc4","amonW4aNjW","Aw5JBhvKzxm","y2f0y2G","smoliuOBW53cHCkd","ue9tva","WQtcQLS6W5CeW4NdHCkN","jgrHDgeUzgLTzw5ZAw9UC1bHCMvUDa","WOfwoe8","W7/dRv9zW5q+WRZcPSkHWPhdR8kTWPb1gNa","BwvZC2fNzq","jgrHDgeUzwXLBwvUDhmUCgfYzw50","DmoHf8orW7pcUG","W4lcRmk8WPxcSmk4","WPLwWQtdVCoulmkkW4HIWRe","BgLJzw5Zzq","WQNcPa3dPmoEA8oA","a8oykSoCW4xdSeKbW4ZcU1OLoSkLjgGoWR7dRCoWsKpdLXtcS8ogm8k2W6eGeCkltc/dN8k1W48uW6ldJW","C2v0u2nYB2XSvg9W","CCoRaCoMfNnRWQJdT8kIWRtcQsq","ibvIkmoYWOLGW4RdQgC","AhrTBa","W5TPW5JdMxW","DxbKyxrL","y29UzMLNlMnVBxbVBMvUDhmUq2HHCNq","W4ldTaldOXiMWPNdVSoHFa","s8k2gHyeW5uCWOddHCogW6S","zg9TywLU","W6qGWR/dThu4fNWHWOrOWQvoWOxdRX7cJw1em8kkk8oDWOW","umk/ntyUW7iGWPFdHCopW6r3","WORdKCoiWP5t","","sw52ywXPzcb0B2TLBI4","WOHiWRfjW7XqfCktFszGW6zxW5rCWPuIFSkZy8kSva","W6i9WQJdVW","W4LJW7/dJMBcOCkarq","FIxdKbOk","wmkQWRhcOmk7WRidW4P6WR4","BSkbWRPcpSo8W6KCfbtcPCoHW7fe","tmkTWRFcQSo4WRayW55S","C2fHCW","W74GWR3dLxeIgMOaWQzQWRfuWO7dIW","j8kgW5S","W6LSW6/cLcG","ChjVzhvJDa","bLZdGLPpWRtdHG","gSoRWPhcUtOarCoPesZcPCoOW6O","W5rOW53cIIGw","ovZdLKbDWQFdHMFdKrnfjsC5W4hcU8kOpLOgWP7cSq","C3vIC2nYAwjL","q1C/la","xSkPiYKIW6ujWOBdHCohW6iScaaSWRyWW5nItrFdJSkaW68uhdlcHSklhWvkbq","W4rOW5VcJI8","W4BdOrddVc87WQFdO8o8DCoKW4xdVSk4WQC","m8kmWRL6W6mbW5ZcRLNdNcaEy8kzW5ZcLfiaWOJdMCkjWRCWWRSIW49LW4iaeWxdQCoRDXFdI2G","WP8wW7uubvhcQq","hmklWQn+WRu","tdX1W6Tiq8oP","uCoQW7dcIXVdRSogA2Ku","WROBWRbKW7XjWRBdG8oKfq","WO/cNYldKMCDWPjevSoaW4G","CCk0WQyv","hSoUWOvy","BgfZDeLUzgv4t2y","W5JdRGddVrmXWQVdPa","WPxdPaldPqD7WQRdVSo4CCoMW5/dRCkYWQ1TACo3W5rYW7JdOG","W45Qf8oP","lrhdTmogiG","WP1DluW","W4L+W4xdM3G","CCkouCkUvJaF","WPSlW6ibgbJdO0i","y29UzMLNlMf1Dg9jBM5LCKHLAwDODa","pSkWu8kwsSoQ","DsvIW75zqG","gmkhAMKMWOeQW6D/W73dNSo3WRThW4hdVu1oW6Ws","cCkwWR1YW6ep","Dg9Rzw4","C3r5Bgvnyxa","wColpLSh","imkbyMKMWQ08WQ94W6NdGCkZWOfDW5q","CMvWBgfJzq","a8k7WRFdO8k5W6K","W6XjvCk3B04","WQ7cRGddSmooFmkaCaiErx1pjCobW6NcV8kVWOJdN8kXnq","WR4gWRvIW6a","WQPqWRVdMq","Ahr0CdOVlW","lCofkmoEWOtdVf9tW4/cOa","sw52ywXPzcbSAwnLBNnLigTLEs4","W75hvmk/yNvsDSo7W4e","jCk7sCkhWQ3dRaVcJx5hiCk4","CgfYC2vFBgLJzw5Zzv9RzxK","W75KW7BcKG","u8o2W63cIWddQCohya","W63cMSkbWRe","FcBdIrakW63dLq","W7L4W7NcHcmhWR/dSqy","sYRcJmodW6pcHG","DhLWzq","F8oOhmodW7/cOdNcGvnzjq","W4P9hmoOW4CP","c8oQW7hdSCkUW6fhW5DHWPK8Dhu","C2HPzNrlzxK","WQ0aWRX3W6fuWPi","W5NcGmkfW48jn8oLW5Scqmoep8os","j8kPvmksumo8Aa","Dw5VyNnLCNzL","yc3dNrSzW6/dHx/cSa","zgvZDhjVEq","W4rpw8kZAfnziSo5W4GLuMxcGhz0zY/cVCkHW49IoSkGoSoGoSobx27dLrFdIdGNdW","WRWbWPTYmCoKWRpcUCkqWRa","W5hdSaaAW6WTW7BcV8kKW4dcOmk4WPT1uZLHW67cJ8obW7RdRmkpW6xcG8oHWPjuW5FdP8kzumoYc3OGWPa/xgr1DJddLSkNvMHDjmkcW4C","zM9YrwfJAa","r1nuqZOZoG","WP5aWQBdPSo4oCkiW59PWQhcR8oja3HrWORcJq","wmoIW6RcHG","eSotW48RimkvjHFcU3/dOCouhJLZ","q04Ooe9M","W7L5W7RcHtqgWOhdUHFcSq","DYlcJCoeW6m","DwX0Aw1HDgu","n8kcAh87WRWUWQPY","W7ZcJ0pcSmk6WR7dLXdcMs83WP3dPb4sW4GR","DMfSAwrvBNrPBa","WPLvWQxdRSo/ka","WOnojf9cWRhdGa","W5WGs8k5CCoQaW","nfzKENH1qG","W57dTrFdTbq","y29UzMLNlNnJCM9SBa","WRKAWQj+","nCktW4VdPmoikG","WQyjWRDLW61oWRBdG8o0cw0","xWNcHXayWRRdJf3dLXax","n8kkW4VdSCou","icKU","zshdIaerW7JdKwe"];return(dt=function(){return t})()}function ut(t,e){const o=dt();return ut=function(e,s){let i=o[e-=140];if(void 0===ut.foKFuG){var a=function(t){let e="",o="";for(let o,s,i=0,a=0;s=t.charAt(a++);~s&&(o=i%4?64*o+s:s,i++%4)?e+=String.fromCharCode(255&o>>(-2*i&6)):0)s="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(s);for(let t=0,s=e.length;t<s;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)};ut.AGksNf=a,t=arguments,ut.foKFuG=!0}const n=o[0],l=e+n,r=t[l];return r?i=r:(i=ut.AGksNf(i),t[l]=i),i},ut(t,e)}function ht(t,e){const o=dt();return ht=function(e,s){let i=o[e-=140];if(void 0===ht.KwOWge){var a=function(t){let e="",o="";for(let o,s,i=0,a=0;s=t.charAt(a++);~s&&(o=i%4?64*o+s:s,i++%4)?e+=String.fromCharCode(255&o>>(-2*i&6)):0)s="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(s);for(let t=0,s=e.length;t<s;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)};const e=function(t,e){let o,s,i=[],n=0,l="";for(t=a(t),s=0;s<256;s++)i[s]=s;for(s=0;s<256;s++)n=(n+i[s]+e.charCodeAt(s%e.length))%256,o=i[s],i[s]=i[n],i[n]=o;s=0,n=0;for(let e=0;e<t.length;e++)s=(s+1)%256,n=(n+i[s])%256,o=i[s],i[s]=i[n],i[n]=o,l+=String.fromCharCode(t.charCodeAt(e)^i[(i[s]+i[n])%256]);return l};ht.gOSfmy=e,t=arguments,ht.KwOWge=!0}const n=o[0],l=e+n,r=t[l];return r?i=r:(void 0===ht.DJzyJy&&(ht.DJzyJy=!0),i=ht.gOSfmy(i,s),t[l]=i),i},ht(t,e)}function mt(t,e){const{api:o,state:s,onDestroy:i,Actions:a,createComponent:n,html:l,onChange:w,update:v}=t;function b(t,e){return ht(e- -524,t)}let y;const W=ct(t,c);function x(t,e){return ut(e- -952,t)}W[O(0,"nVZM")]();const D=st("aFOW",-404);let $;i(s[st("t0AZ",-211)](Y(587,642),(t=>$=t)));const P=l`
  ...
  `,M=[];let I,R;M[Y(745,678)](s[x(-771,-752)](st("&()#",-365),(t=>I=t))),M[st("Rm$]",-235)](s[at(-542,"mYdy")](X(-204,-162),(t=>R=t)));const z=n(I);function O(t,e){return ht(t- -274,e)}i((()=>{var t,e;z&&z[(t=488,e=490,X(e-609,t))]()}));const A=n(R);i((()=>{var t,e;A&&A[(t=902,e=951,Y(t,e-368))]()})),i((()=>{var t,e;M[(t=750,e=637,tt(t,e-1207))]((t=>t()))}));const{onDestroy:k,state:L,update:G,html:H,unsafeHTML:T}=t;function N(t,e){return ut(e- -696,t)}var V=!0;const B=H`<strong>[gantt-schedule-timeline-calendar component]</strong><br /><br />`;function j(t,e=""){const o=Y(1018,1029-386);var s,i;return H` <div class="${o}">${B}${t}${e?H`<br />${typeof e===(s="L*eg",i=-499,b(s,i- -202))?T(e):e}`:null}</div> `}function E(t){return r(this,void 0,void 0,(function*(){function i(t,e){return ht(e-477,t)}function a(t,e){return ut(t- -996,e)}function n(t,e){return ht(e- -887,t)}function l(t,e){return ht(e-397,t)}let r=location[c(326,329)];if(typeof location[c(284,364)]!==l("7UFp",725)){const t=location[i("U7oB",745)];t[i("t3#G",729)]&&(r=String(t[t[i("KeO3",792)]-1]))}function c(t,e){return ut(e- -1,t)}function w(t,e){return ht(t- -696,e)}if(r[b("s5B6",1172)](b("L*eg",1169)))return V=!1,void(y=S);function v(t,e){return ut(e- -346,t)}if(r=function(t){function e(t,e){return ut(e- -227,t)}return(t=String(t))[(o=745,s=811,ut(o-513,s))](e(-21,11),"")[e(-1,5)](ht(918-696,"9bc$"),"");var o,s}(r),t[n("dDb#",-711)](M(1221,1232))){let h,m,g;if(e&&e[D(861,846)]&&typeof e[i("dDb#",681)]===l("sl#(",642))m=yield e[a(-634,-682)]()[w(-357,"5sPt")]((t=>{V=!1;const e=c(1310,1281-983);h=j(e)}));else{V=!1;const t=w(-433,"@E^2");h=j(t)}if(h)return V=!1,void(y=h);try{const e=v(-66,-41);g=m[v(-90,-103)](t,e)}catch(t){V=!1;const e=w(-319,"1Jc0");return void(y=j(e,t[a(-835,-798)]))}if(!g.ok){V=!1;const t=M(1196,1236);return void(y=j(t,g[n("8zzX",-571)]))}const f=g[w(-404,"L*eg")];if(s[n("B#7X",-663)](D(777,650),f),f[D(725,679)][w(-495,"^ARp")]!==n("rK]c",-641)){V=!1;const t=D(648,633);return void(y=j(t))}const p=o[D(855,875)][c(254,307)]()[a(-620,-566)]();if(f[i("biAd",768)][v(121,27)]<p){V=!1;const t=w(-470,"97sF");return void(y=j(t))}if(f[n("wABL",-657)][M(1147,1183)]){const t=r[M(1170,1248)](":");t>-1&&(r=r[b("^ARp",1231)](0,t));const e=d(r);e[n("lY[S",-674)]===u[w(-447,"7*x4")]&&e[n("1ZMT",-689)]&&e[M(1099,1172)]&&(r=e[w(-533,"basI")]+"."+e[D(579,627)][l("@mZU",609)]("."))}if(!f[b("basI",1334)][l("&sq0",732)][w(-372,"KeO3")](r)){V=!1;const t=a(-683,-630)+r+"'.";return void(y=j(t,n("5sPt",-688)+f[a(-626,-732)][w(-346,"mYdy")][M(1299,1228)](", ")+i("&sq0",714)))}if(!f[i("0uAs",861)][b("XkBx",1170)][w(-509,"hs[v")]){if(s[i("(GUZ",670)](i("$y97",666))[l("^ARp",748)](".")[0]!==f[v(-144,-151)][w(-418,"biAd")][l("U7oB",549)](".")[0]){V=!1;const t=b("dDb#",1331);return void(y=j(t))}}return}function b(t,e){return ht(e-962,t)}const W=l("@E^2",557),x=D(724,666);function D(t,e){return ut(e-484,t)}const $=p;function M(t,e){return ut(t-956,e)}if(t){if(t[l("&sq0",667)](i("biAd",830)))return function(){function e(t,e){return M(e- -1357,t)}let o=null;function l(t,e){return v(e,t-211)}function c(t,e){return i(t,e-425)}try{const i=t[S(-240,"hs[v")](5),a=h[S(-419,"N]N)")](i,W)[S(-400,"0uAs")](g);o=JSON[c("7*x4",1173)](a),o&&s[e(-190,-227)](D("9bc$",351),{for:o[S(-229,"EdBS")],domains:[...o[S(-331,"s5B6")]],type:Object[l(209,119)]({},o[l(115,34)]),validUntil:Object[p(1154,1181)]({},o[S(-194,"1ZMT")])})}catch(t){}if(!o||!o[l(140,157)]||!o[R(714,"sl#(")][c("B#7X",1205)]){V=!1;const t=D("L*eg",350);return void(y=j(t,P))}if(!o[e(-110,-90)]){V=!1;const t=D("KeO3",313);return void(y=j(t,P))}const m=function(t){const e=Object[(o=274,s=402,v(o,s-404))]({},t);var o,s,i,n;function l(t,e){return b(t,e- -914)}return delete e[l("hs[v",307)],delete e[(i=668,n=757,a(n-1363,i))],JSON[l("kp4n",238)](e)}(o);function p(t,e){return v(t,e-1183)}if(!function(t,e){function o(t,e){return w(t-1572,e)}if(!t||!e)return!1;const s=new $({});return s[o(1243,"pKw*")](x),s[o(1254,"dDb#")](e,t,f)}(o[p(1123,1148)],m)){V=!1;const t=c("nVZM",1243);return void(y=j(t,P))}function D(t,e){return n(t,e-1032)}const C=(new Date)[R(725,"KeO3")]();if(o[p(1082,1112)][I(-107,1)]<C){V=!1;const t=e(-173,-250);y=j(t,P)}else{if(o[S(-241,"Rm$]")][D("M%3I",363)]===a(-724,-273)||o[l(115,90)][R(719,"1ZMT")]===S(-282,"&()#")){const t=r[S(-375,"pKw*")](":");t>-1&&(r=r[c("t0AZ",1262)](0,t));const o=d(r);o[R(499,"Vl&l")]===u[c("XkBx",1127)]&&o[l(43,-67)]&&o[p(922,980)]&&(r=o[c("yHzR",1136)]+"."+o[S(-394,"EdBS")][e(-28,-58)]("."))}if(o[D("yS!$",487)][l(18,-77)](r));else{V=!1;const t=D("s5B6",516)+r+I(-149,-245);y=j(t,P)}}function S(t,e){return w(t-110,e)}function I(t,e){return M(t- -1392,e)}function R(t,e){return w(t-1036,e)}}();const e=b("dDb#",1314),p=encodeURIComponent,S=(new Date)[l("8zzX",574)](),I=h[l("5sPt",792)](S,W),R=a(-669,-691),z=m(S+r,R,{keySize:16})[i("t3#G",859)](),O=[p(c(251,165))+"="+p(t),p(a(-666,-538))+"="+p(r),p(b("t3#G",1179))+"="+p(location[i("EdBS",662)]),p(c(241,227))+"="+p(I),p(a(-670,-553))+"="+p(e),p(n("M@Li",-722))+"="+p(navigator[M(1317,1360)])][n("Vl&l",-504)]("&"),A=M(1265,1348);window[l("yS!$",578)](A,{method:c(250,155),redirect:D(875,824),headers:{"Content-Type":a(-616,-584)},body:O})[b("nVZM",1325)]((t=>{var e,o,s,i;return 200!==t[(e=-287,o=-227,M(o- -1551,e))]&&(V=!1,y=C),t[(s="yS!$",i=17,n(s,i-608))]()}))[a(-602,-541)]((a=>{function d(t,e){return n(e,t-1845)}function u(t,e){return c(e,t-943)}function h(t,e){return v(t,e- -415)}function m(t,e){return i(t,e- -1317)}function g(t,e){return v(t,e-14)}function f(t,e){return v(e,t-354)}if(a&&a.ok)if(a[h(-612,-533)]&&a[d(1161,"1ZMT")]===z)V=!0,s[h(-512,-587)]($(143,"B#7X"),(()=>{function t(t,e){return $(t- -688,e)}var e,s;var i,n,l,r;function c(t,e){return $(t- -674,e)}function h(t,e){return u(t- -942,e)}return{registeredDomains:a[t(-536,"M@Li")],validUntil:{text:a[t(-631,"evM%")],value:o[(l=-514,r="&sq0",d(l- -1716,r))][h(308,291)](a[(i="yHzR",n=1236,$(n-1109,i))])[t(-525,"Vl&l")]()},type:null!==(e=a[h(250,203)])&&void 0!==e?e:{text:t(-492,"basI"),value:c(-568,"0uAs")},for:null!==(s=a[c(-633,"wABL")])&&void 0!==s?s:""}}));else{V=!1;const o=h(-656,-578);y=j(o,P);const s=h(-361,-464),i=[p(m("U7oB",-507))+"="+p(t),p((x=717,D=729,c(D,x-388)))+"="+p(r),p(S("Vl&l",-453))+"="+p(location[f(356,469)]),p(d(1248,"9bc$"))+"="+p(e),p(f(394,500))+"="+p(String(a[S("U7oB",-524)])),p(S("97sF",-441))+"="+p(z),p(m("1Jc0",-578))+"="+p(navigator[d(1281,"evM%")])][g(122,11)]("&");window[d(1131,"0uAs")](s,{method:g(-112,-176),redirect:u(1282,1294),headers:{"Content-Type":(b=-678,W="8zzX",w(b- -184,W))},body:i})}else if(a){V=!1;const t=T(a[S("5sPt",-476)][u(1174,1295)](/\n/gi,m("kp4n",-607)));let e=null;a[g(42,22)]&&(e=T(a[g(2,22)][u(1174,1148)](/\n/gi,u(1267,1203))));const o=S("kp4n",-484);y=H` <div class="${o}"><strong>${B} ${t}</strong><br />${e}<br />${P}</div> `}else V=!1,y=C;var b,W,x,D;function $(t,e){return l(e,t- -511)}function S(t,e){return l(t,e- -1069)}G()}))[i("&sq0",671)]((()=>{V=!1,y=C,G()}))}else{V=!1;const t=n("nyNJ",-585),e=i("KeO3",716);y=H` <div class="${e}">${B} ${t}${P}</div> `}}))}function Y(t,e){return ut(e-323,t)}k(L[st("J*u9",-231)](at(-556,"KeO3"),(t=>{function e(t,e){return x(e,t-723)}E(t)[e(165,262)]((()=>{G()}))[e(-75,-181)]((t=>{V=!1;const e=ht(644-383,"yHzR");y=j(e),G()})),G()})));const _={width:0,height:0},Z={width:0,height:0};let K,q,U,F;function J(t){const e=t[i(-633,"basI")],o=t[i(-520,"0$$%")];function i(t,e){return b(e,t- -360)}function a(t,e){return X(e- -96,t)}var n,l,r,c,d,u;(_[(d=1296,u=1407,x(u,d-1927))]!==e||_[(r=378,c="rK]c",st(c,r-763))]!==o)&&(_[a(-176,-154)]=e,_[a(-198,-119)]=o,s[(n=418,l=451,Y(l,n- -79))](a(-109,-180),_))}class Q{constructor(t){function e(t,e){return et(e,t-374)}!K&&(K=new ResizeObserver((()=>{J(t)})),K[e(825,"hs[v")](t),s[e(861,"(GUZ")](et("(GUZ",507- -86),t),J(t))}[N(-481,-522)](){}[Y(679,583)](t){var e,o;K[(e=937,o=851,x(o,e-1631))](t)}}function X(t,e){return ut(t- -379,e)}function tt(t,e){return ut(e- -834,t)}function et(t,e){return ht(e-204,t)}function ot(t){function e(t,e){return at(e-1666,t)}function o(t,e){return b(e,t- -368)}const i=t[o(-608,"s5B6")];function a(t,e){return Y(t,e-379)}const n=t[o(-712,"8zzX")];var l,r;(Z[e("(GUZ",1103)]!==i||Z[(l=-581,r=-607,tt(l,r- -129))]!==n)&&(Z[e("s5B6",1053)]=i,Z[a(1142,1058)]=n,s[a(816,876)](e("dDb#",1033),Z))}function st(t,e){return ht(e- -549,t)}!$[et("dDb#",419)](Q)&&$[Y(558,678)](Q);class it{constructor(t){function e(t,e){return X(e-216,t)}function o(t,e){return et(t,e- -1170)}t=t[o("wABL",-660)],!q&&(q=new ResizeObserver((()=>{ot(t)})),q[o("1ZMT",-654)](t),s[e(-57,11)](e(69,-1),t),ot(t))}[st("M@Li",-273)](){}[N(-494,-436)](t){var e,o,s,i;q[(s=837,i="dDb#",st(i,s-1028))](t[(e=389,o="J*u9",O(e-327,o))])}}function at(t,e){return ht(t- -849,e)}!$[N(-586,-543)](it)&&$[et("s5B6",486)](it),i((()=>{function t(t,e){return b(e,t-123)}q[t(-5,"wABL")](),K[t(-192,"sl#(")]()})),i(s[at(-699,"9bc$")]([tt(-782,-676),b("N]N)",-289)],(()=>{function t(t,e){return X(e-505,t)}function e(t,e){return N(t,e-259)}function o(t,e){return at(e-1226,t)}if(s[t(421,457)](t(438,349))){const t=s[(i=-113,a=-208,X(a- -160,i))](X(-298- -77,-305));if(!t)return;s[o("basI",724)](e(-225,-297),(()=>{function i(t,o){return e(o,t-809)}return t[i(728,616)]-s[i(703,719)](o("wABL",626- -138))}))}var i,a}),{group:!0})),i(s[at(-601,"&sq0")](x(-673,-671),(t=>{function e(t,e){return N(t,e-712)}function o(t,e){return O(e-495,t)}U=t[e(456,353)][e(433,365)],F=t[o("hs[v",509)][o("&sq0",555)]})));const nt={handleEvent(t){function e(t,e){return X(e-286,t)}function s(t,e){return x(t,e-1437)}const i=o[h(-551,"EdBS")](t);if(t[e(175,161)]||i.x){const t=i.x?i.x:i.y,s=o[(c="wABL",d=-417,O(d- -441,c))]();return void(t>0?o[h(-583,"aFOW")](s[(l="biAd",r=1335,O(r-1234,l))]+U):o[e(292,224)](s[(a=91,n=12,x(n,a-662))]-U))}var a,n,l,r,c,d;const u=o[s(917,844)]();function h(t,e){return et(e,t- -934)}var m,g,f,p;i.y>0?o[s(775,654)](u[s(956,866)]+F):o[(f=-139,p=-51,X(p-159,f))](u[(m=-642,g="rK]c",b(g,m- -440))]-F)},passive:!0},lt=Object[x(-545,-608)](Object[O(-130,"7UFp")]({},e),{api:o,state:s,componentName:D});w((t=>{for(const e in t)lt[e]=t[e]}));const rt=a[O(27,"^ARp")]($,lt),dt=o[N(-372,-402)](O(-7,"sl#("),t,e);return i(dt[x(-808,-692)]),()=>V?dt[tt(-688,-662)](O(6,"dDb#"),l`
            <div
              data-info-url="https://github.com/neuronetio/gantt-schedule-timeline-calendar"
              class=${W[at(-576,"97sF")]}
              style=${W[tt(-561,-605)][tt(-361,-441)]()}
              data-actions=${rt()}
              @wheel=${nt}
            >
              ${dt[Y(595,495)](X(-238,-336),l` ${z[N(-582,-524)]()}${A[x(-850,-780)]()} `)}
            </div>
          `):y}let gt;!function(t,e){const o=dt();function s(t,e){return ut(e- -892,t)}function i(t,e){return ut(t- -683,e)}function a(t,e){return ht(t-164,e)}for(;;)try{if(914194===-parseInt(s(-592,-613))/1*(-parseInt(a(552,"nVZM"))/2)+parseInt(a(417,"kp4n"))/3+parseInt(i(-537,-433))/4+-parseInt(s(-537,-603))/5+parseInt(i(-351,-448))/6+-parseInt((n=41,l=114,ut(n- -259,l)))/7*(parseInt(ht(26- -259,"5sPt"))/8)+-parseInt(a(420,"yS!$"))/9)break;o.push(o.shift())}catch(t){o.push(o.shift())}var n,l}();const ft=new Array(32).fill(void 0);function pt(t){return ft[t]}ft.push(void 0,null,!0,!1);let wt=ft.length;function vt(t){const e=pt(t);return function(t){t<36||(ft[t]=wt,wt=t)}(t),e}let bt=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});bt.decode();let yt=null;function Wt(){return null!==yt&&yt.buffer===gt.memory.buffer||(yt=new Uint8Array(gt.memory.buffer)),yt}function xt(t,e){return bt.decode(Wt().subarray(t,t+e))}function Dt(t){wt===ft.length&&ft.push(ft.length+1);const e=wt;return wt=ft[e],ft[e]=t,e}let $t=0,Pt=new TextEncoder("utf-8");const Ct="function"==typeof Pt.encodeInto?function(t,e){return Pt.encodeInto(t,e)}:function(t,e){const o=Pt.encode(t);return e.set(o),{read:t.length,written:o.length}};function St(t,e,o){if(void 0===o){const o=Pt.encode(t),s=e(o.length);return Wt().subarray(s,s+o.length).set(o),$t=o.length,s}let s=t.length,i=e(s);const a=Wt();let n=0;for(;n<s;n++){const e=t.charCodeAt(n);if(e>127)break;a[i+n]=e}if(n!==s){0!==n&&(t=t.slice(n)),i=o(i,s,s=n+3*t.length);const e=Wt().subarray(i+n,i+s);n+=Ct(t,e).written}return $t=n,i}let Mt=null;function It(){return null!==Mt&&Mt.buffer===gt.memory.buffer||(Mt=new Int32Array(gt.memory.buffer)),Mt}async function Rt(t){const e={wbg:{}};e.wbg.__wbindgen_object_drop_ref=function(t){vt(t)},e.wbg.__wbindgen_string_new=function(t,e){return Dt(xt(t,e))},e.wbg.__wbindgen_json_parse=function(t,e){return Dt(JSON.parse(xt(t,e)))},e.wbg.__wbg_new_693216e109162396=function(){return Dt(new Error)},e.wbg.__wbg_stack_0ddaca5d1abfb52f=function(t,e){var o=St(pt(e).stack,gt.__wbindgen_malloc,gt.__wbindgen_realloc),s=$t;It()[t/4+1]=s,It()[t/4+0]=o},e.wbg.__wbg_error_09919627ac0992f5=function(t,e){try{console.error(xt(t,e))}finally{gt.__wbindgen_free(t,e)}},e.wbg.__wbindgen_throw=function(t,e){throw new Error(xt(t,e))},("string"==typeof t||"function"==typeof Request&&t instanceof Request||"function"==typeof URL&&t instanceof URL)&&(t=fetch(t));const{instance:o,module:s}=await async function(t,e){if("function"==typeof Response&&t instanceof Response){if("function"==typeof WebAssembly.instantiateStreaming)try{return await WebAssembly.instantiateStreaming(t,e)}catch(e){if("application/wasm"==t.headers.get("Content-Type"))throw e;console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",e)}const o=await t.arrayBuffer();return await WebAssembly.instantiate(o,e)}{const o=await WebAssembly.instantiate(t,e);return o instanceof WebAssembly.Instance?{instance:o,module:t}:o}}(await t,e);return gt=o.exports,Rt.__wbindgen_wasm_module=s,gt}var zt=Object.freeze({__proto__:null,parse_license_key:function(t,e){var o=St(t,gt.__wbindgen_malloc,gt.__wbindgen_realloc),s=$t,i=St(e,gt.__wbindgen_malloc,gt.__wbindgen_realloc),a=$t;return vt(gt.parse_license_key(o,s,i,a))},default:Rt});
/**
 * Gantt-Schedule-Timeline-Calendar
 *
 * @copyright NEURONET - Rafal Pospiech <https://neuronet.io>
