 ...
 * @released  2022-07-01
 * @license   SEE LICENSE IN LICENSE FILE
 */const P="gstc";function C(t,e=""){let a=`gstc__${t}`;return t===P&&(a=P),e?`${a} ${a}--${e.replace(":","-")}`:a}function W(t,e){let a=`gstc__${t}`;return t===P&&(a=P),`${a}--${e}`}
/**
 * Api functions
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 */function M(t,e){const{onDestroy:a,state:o,cache:s,api:n,html:l,StyleMap:r,Actions:c,update:d}=t,h="scroll-bar";let u,m,g="",f="";a(o.subscribe("config.classNames",(()=>{u=n.getClass(h),m=n.getClass("scroll-bar-inner")})));const p="horizontal"===e.type?"height":"width",w="height"===p?"width":"height",v="horizontal"===e.type?"left":"top",b=new r({}),D=new r({}),y={maxPosPx:0,innerHandleSize:0,scrollSize:0,dataId:""};a(o.subscribeAll("horizontal"===e.type?[`config.scroll.${e.type}`,`$data.scroll.${e.type}`]:[`config.scroll.${e.type}`,`$data.scroll.${e.type}`,"$data.chart.dimensions.heightWithoutScrollBar","$data.list.rowsWithParentsExpanded","$data.list.rowsHeight","config.additionalSpace"],(function(){const t=o.get(`config.scroll.${e.type}`),a=o.get(`$data.scroll.${e.type}`),i=n.getScrollSize(e.type),s=a.innerHandleSize,l=a.maxHandlePosPx,r=a.dataId,c=o.get("config.additionalSpace"),h=o.get("config.chart.time");h.allDates&&h.allDates.length&&h.allDates[h.level]&&(a.visible?b.style.display="flex":b.style.display="none",b.style[p]=t.width+"px",b.style[w]=i+"px","vertical"===e.type&&(b.style.top=o.get("config.headerHeight")+c.top+"px"),a.lastPageSize&&a.absoluteSize&&i&&(D.style[p]="100%",D.style[w]=s+"px",function(t,e,a,o){const i=y.maxPosPx!==t||y.innerHandleSize!==e||y.scrollSize!==a||y.dataId!==o;return i&&(y.maxPosPx=t,y.innerHandleSize=e,y.scrollSize=a,y.dataId=o),i}(l,s,i,r)&&("horizontal"===e.type?n.setScrollLeft(a.dataIndex,a.preciseOffset):n.setScrollTop(a.dataIndex,a.preciseOffset)),d()))}),{group:!0,bulkValue:!1}));const x=n.getActions(h);x.push(class extends i{constructor(t){super();const a=`$data.elements.scroll-bar--${e.type}`;o.get(a)||o.update(a,t,{only:null})}update(){}destroy(){}});const P={api:n,state:o,props:e,componentName:h},C=c.create(x,P),W=[class extends i{constructor(t){super(),this.moving=!1,this.initialPointerPos=0,this.initialHandlePos=0,this.currentPos=0,this.currentPointerPos=0,this.lastDataIndex=0,this.lastOffset=0,this.dataIndex=0,this.previousRowId="",o.update(`$data.elements.scroll-bar-inner--${e.type}`,t,{only:null}),this.bodyClassName=o.get("config.scroll.bodyClassName"),this.pointerDown=this.pointerDown.bind(this),this.pointerUp=this.pointerUp.bind(this);const a=this.pointerMove.bind(this);this.pointerMove=a,this.unsubscribe=o.subscribe(`$data.scroll.${e.type}`,this.dataChanged.bind(this)),this.destroy=this.destroy.bind(this),t.addEventListener("pointerdown",this.pointerDown),document.addEventListener("pointermove",this.pointerMove),document.addEventListener("pointerup",this.pointerUp)}destroy(t){this.unsubscribe(),t.removeEventListener("pointerdown",this.pointerDown),document.removeEventListener("pointermove",this.pointerMove),document.removeEventListener("pointerup",this.pointerUp)}dataChanged(){const t=o.get(`$data.scroll.${e.type}`),a=o.get("$data.chart.time");if(!a.allDates.length)return;const i=a.allDates[a.level],s=t.dataIndex;if(this.lastDataIndex=s,"horizontal"===e.type&&i&&i.length)this.currentPos=t.handlePosPx,D.style[v]=this.currentPos+"px",d();else if("vertical"===e.type){if(!o.get("$data.list.rowsWithParentsExpanded").length)return;this.currentPos=t.handlePosPx,D.style[v]=this.currentPos+"px",d()}}limitPosition(t){return Math.max(Math.min(t,o.get(`$data.scroll.${e.type}.maxHandlePosPx`)),0)}pointerDown(t){t.stopPropagation(),t.preventDefault(),n.muteMethod("calculateRowsHeight"),document.body.classList.add(this.bodyClassName),requestAnimationFrame((()=>{this.moving=!0,this.initialPointerPos="horizontal"===e.type?t.screenX:t.screenY,this.initialHandlePos=o.get(`$data.scroll.${e.type}.handlePosPx`),f=" "+n.getClass(h)+"-inner--active",g=" "+n.getClass(h)+"--active",d()}))}pointerUp(t){this.moving&&(n.unmuteMethod("calculateRowsHeight"),t.preventDefault(),t.stopPropagation(),document.body.classList.remove(this.bodyClassName)),this.moving=!1,f="",g="",d()}pointerMoveRead(t){this.currentPointerPos="horizontal"===e.type?t.screenX:t.screenY}pointerMoveWrite(){const t=o.get(`config.scroll.${e.type}`),a=o.get(`$data.scroll.${e.type}`),i=this.currentPointerPos-this.initialPointerPos;this.currentPos=this.limitPosition(this.initialHandlePos+i);const s=o.get("$data.chart.time");if(!s.allDates.length)return;const l=s.allDates[s.level],r=this.currentPos/a.maxHandlePosPx,c=Math.round(r*a.absoluteSizeWithoutLastPage);if("horizontal"===e.type){let e,a=0,o=0,i=0;for(let t=l.length;a<t&&(e=l[a],i=Math.round(e.rightPx),!(i>c));a++);t.precise&&i!==c&&(o=Math.round(e.leftPx)-c),a||(a=0),e||(e=l[0]),this.dataIndex=a,this.lastDate=l[a],n.setScrollLeft(e.id,o),this.lastDataIndex=a,this.lastOffset=o}else{const{dataIndex:e,row:a,rowData:o}=n.getRowInfoFromTop(c);let i=0;t.precise&&o.position.top!==c&&(i=o.position.top-c),this.dataIndex=e,this.previousRowId=a.id,n.setScrollTop(e,i),this.lastDataIndex=e,this.lastOffset=i}}pointerMove(t){this.moving&&(t.stopPropagation(),t.preventDefault(),requestAnimationFrame((()=>{this.pointerMoveRead(t)})),requestAnimationFrame((()=>{this.pointerMoveWrite()})))}}],$=c.create(W,P),I=n.generateSlots(h,t,e);function G({classNameOuter:t,classNameOuterActive:e,classNameInner:a,classNameInnerActive:o,styleMapInner:i,styleMapOuter:s,innerActions:n,outerActions:l,slots:r,cache:c,html:d,vido:h,props:u}){return c(!u||!u.type?null:r.html("outer",d`
            ...
            `))}let S=G;return a(o.subscribe("config.templates.scroll-bar",(t=>{S=null!=t?t:G,d()}))),()=>S({innerActions:$,outerActions:C,classNameOuter:u,classNameOuterActive:g,classNameInner:m,classNameInnerActive:f,cache:s,styleMapInner:D,styleMapOuter:b,slots:I,html:l,vido:t,props:e})}
/**
 * List component
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 * @released  2022-07-01
 * @license   SEE LICENSE IN LICENSE FILE
 */class k{constructor(t,e){let a=!1,o=e.state.get("$data.elements.list-columns");void 0===o&&(o=[],a=!0),o.includes(t)||(o.push(t),a=!0),a&&e.state.update("$data.elements.list-columns",o,{only:null})}destroy(t,e){e.state.update("$data.elements.list-columns",(e=>e.filter((e=>e!==t))),{only:null})}}function z(t,e){const{api:a,state:o,onDestroy:i,onChange:s,cache:n,Actions:l,update:r,createComponent:c,reuseComponents:d,html:h,StyleMap:u}=t,m=[];let g,f;m.push(o.subscribe("config.components.ListColumnRow",(t=>g=t))),m.push(o.subscribe("config.components.ListColumnHeader",(t=>f=t)));const p=Object.assign(Object.assign({},e),{api:a,state:o,componentName:"list-column"}),w={column:e.column,state:o,api:a,componentName:"list-column-headers"},v={api:a,state:o,componentName:"list-column-rows"},b="list-column",D="list-column-rows",y=a.getActions(b),x=a.getActions(D),P=a.getClass(b,e.column.id),C=a.getClass("list-column-rows-offset",e.column.id),W=a.getClass(D,e.column.id);let $,I=a.getId(b,e&&e.column?e.column.id:"");const G=new u({width:"","--width":""}),S=new u({height:""}),M=new u({"margin-top":"0px"});let L=o.get("config.additionalSpace");const z=a.generateSlots(b,t,e);let T;function R(){if(!e||!e.column)return;const t=o.get("config.list");if(!t.columns.data[e.column.id])return;$=t.columns.data[e.column.id].width*t.columns.percent*.01,T=$;const i=Math.round(a.getRealChartHeight());G.style.width=T+"px",G.style["--width"]=T+"px",M.style.height=i+"px",S.style.top=o.get("config.headerHeight")+L.top+"px"}i(o.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar","$data.list.width","$data.list.visibleRowsHeight","config.additionalSpace.top"],R,{group:!0}));const O=c(f,e);i(O.destroy);const A=[],N={};function H(){var t;if(!e||!e.column)return;o.mute(H);const i=o.get("$data.list.visibleRows")||[],s=a.getRows(i),n=a.getRowsData();for(const a of s){const o=N[a.id]=null!==(t=N[a.id])&&void 0!==t?t:{};o.column=e.column,o.row=a,o.rowData=n[a.id],o.width=T}for(const t in N)i.includes(t)||delete N[t];d(A,s,(t=>t&&N[t.id]),g,!0),z.change(e),o.unmute(H)}s((t=>{if((e=t)&&e.column&&e.column.id){I=a.getId(b,e&&e.column?e.column.id:"");for(const t in e)p[t]=e[t];R(),O.change(e),H()}})),i(o.subscribeAll(["$data.list.visibleRows","$data.list.visibleRowsHeight","$data.list.rows","config.list.rows","config.chart.items.*.height","config.chart.items.*.rowId","config.chart.items.*.time"],H,{group:!0,bulkValue:!1})),i(o.subscribe("$data.scroll.vertical.preciseOffset",(t=>{M.style.transform=`translateY(${Math.round(t)||0}px)`,r()}))),i(o.subscribe("config.additionalSpace",(t=>{L=t}))),i((()=>{A.forEach((t=>t.destroy())),m.forEach((t=>t()))})),y.push(k);const V=l.create(y,w),B=l.create(x,v);function E({className:t,classNameOffset:e,classNameContainer:a,containerStyleMap:o,offsetStyleMap:i,widthStyleMap:s,visibleRows:n,rowActions:l,elId:r,headerActions:c,ListColumnHeader:d,html:h,cache:u,vido:m,props:g}){return u(g&&g.column?z.html("outer",h`
              <div
                class=${t}
      ...
      `)} `)}
            ...
            `):null)}let j=E;return i(o.subscribe("config.templates.list-column",(t=>{j=null!=t?t:E,r()}))),()=>j({classNameOffset:C,offsetStyleMap:M,visibleRows:A,classNameContainer:W,containerStyleMap:S,rowActions:B,className:P,elId:I,headerActions:V,widthStyleMap:G,ListColumnHeader:O,html:h,cache:n,vido:t,props:e})}
/**
 ...
 */function T(t,e){const{api:a,state:o,onDestroy:i,cache:s,onChange:n,Actions:l,update:r,createComponent:c,html:d,StyleMap:h}=t,u="list-column-header",m=Object.assign(Object.assign({},e),{api:a,state:o,componentName:u}),g=a.getActions(u),f=[];let p;f.push(o.subscribe("config.components.ListColumnHeaderResizer",(t=>p=t)));const w=c(p,e);let v;f.push(o.subscribe("config.components.ListColumnRowExpander",(t=>v=t)));const b=c(v,e);i((()=>{w.destroy(),b.destroy(),f.forEach((t=>t()))}));const D=a.generateSlots(u,t,e),y=a.getClass(u),x=a.getClass(u+"-content");let P=a.getId(u,e.column.id);n((t=>{e=t;for(const t in e)m[t]=e[t];P=a.getId(u,e.column.id),w.change(e),b.change(e),D.change(t)}));const C=new h({height:"","--height":"","--paddings-count":""});i(o.subscribe("config.headerHeight",(()=>{const t=o.get("config");C.style.height=t.headerHeight+"px",C.style["--height"]=t.headerHeight+"px",C.style["--paddings-count"]="1",r()})));const W=l.create(g,m);function $({className:t,contentClass:e,styleMap:a,elId:o,cache:i,ListColumnRowExpander:s,ListColumnHeaderResizer:n,actions:l,slots:r,html:c,vido:d,props:h}){return i(!h||!h.column?null:r.html("outer",c`
      ...
      `:c` <div class=${e}>${n.html(h.column)}</div> `)}
            ...
            `))}let I=$;return i(o.subscribe(`config.templates.${u}`,(t=>{I=null!=t?t:$,r()}))),()=>I({className:y,contentClass:x,cache:s,styleMap:C,elId:P,ListColumnRowExpander:b,ListColumnHeaderResizer:w,actions:W,slots:D,html:d,vido:t,props:e})}
/**
 ...
 * @released  2022-07-01
 * @license   SEE LICENSE IN LICENSE FILE
 */function R(t,e){const{api:a,state:o,onDestroy:i,cache:s,update:n,html:l,Actions:r,onChange:c,PointerAction:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-header-resizer",g=a.getActions(m),f=a.getActions(m+"-dots"),p={up:"",down:""};let w,v,b,D;i(o.subscribe("config.list.sort.icons",(t=>{p.up=a.getSVGIconSrc(t.up),p.down=a.getSVGIconSrc(t.down)}))),w=a.getClass(m),v=a.getClass(m+"-container"),b=a.getClass(m+"-dots"),D=a.getClass(m+"-dots-dot");const y=a.getClass(m+"-sort-icon");let x;const P=new h({});let C=!1;const W=a.generateSlots(m,t,e);let $=!0,I=0;const G={componentName:m,column:e.column,api:a,state:o,pointerOptions:{axis:"x",onMove:function({movementX:t,event:a}){if(!$)return;t&&(a.preventDefault(),a.stopPropagation());let i=o.get("config.list.columns.minWidth");"number"==typeof e.column.minWidth&&(i=e.column.minWidth),I+=t,I<i&&(I=i),C&&o.update(`config.list.columns.data.${e.column.id}.width`,I)}}};function S(){if(!e||!e.column||!e.column.id)return;G.column=e.column,w=a.getClass(m,e.column.id),v=a.getClass(m+"-container",e.column.id),b=a.getClass(m+"-dots",e.column.id),D=a.getClass(m+"-dots-dot",e.column.id),$=!("resizer"in e.column)||e.column.resizer;const t=o.get("config.list");x=I=e.column.width*t.columns.percent*.01,P.style["--width"]=t.columns.resizer.width+"px",C=t.columns.resizer.inRealTime,o.update("$data.list.width",x),W.change(e),n()}c((t=>{e=t,S()})),i(o.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],S,{group:!0}));let M=[1,2,3,4,5,6,7,8];i(o.subscribe("config.list.columns.resizer.dots",(t=>{M=[];for(let e=0;e<t;e++)M.push(e);n()})));let L=!0;function k(){e.column.sortable&&(L=!L,o.update("config.list.sort",(t=>(t.activeColumnId=e.column.id,t.asc=L,t))))}let z=!1;i(o.subscribe("config.list.sort",(t=>{if(t.activeColumnId===e.column.id)return L=t.asc,void(z=!0);z=!1}))),f.push(d);const T=r.create(g,G),R=r.create(f,G);function O({className:t,containerClass:e,iconClass:a,dotsClass:o,dotClass:i,dotsStyleMap:s,dots:n,onLabelClick:l,dotsActions:r,resizer:c,icons:d,sortActive:h,cache:u,asc:m,actions:g,slots:f,html:p,unsafeHTML:w,vido:v,props:b}){const D=!b||!b.column;function y(){return b.column.sortable&&h?m?p` <img src="${d.down}" class=${a} /> `:p` <img src="${d.up}" class=${a} /> `:null}function x(){return D?null:"function"==typeof b.column.header.content?b.column.header.content({column:b.column,vido:v}):b.column.header.content}return u(D?null:f.html("outer",p`
      ...
      `)}
            ...
            `))}let A=O;return i(o.subscribe(`config.templates.${m}`,(t=>{A=null!=t?t:O,n()}))),()=>A({className:w,containerClass:v,onLabelClick:k,iconClass:y,cache:s,dotsClass:b,dotsStyleMap:P,dotsActions:R,dots:M,dotClass:D,resizer:$,icons:p,sortActive:z,asc:L,actions:T,slots:W,html:l,unsafeHTML:u,vido:t,props:e})}
/**
 ...
 */class O{constructor(t,e){let a=e.state.get("$data.elements.list-column-rows"),o=!1;void 0===a&&(o=!0,a=[]),a.includes(t)||(a.push(t),o=!0),o&&e.state.update("$data.elements.list-column-rows",a,{only:null})}destroy(t,e){e.state.update("$data.elements.list-column-rows",(e=>e.filter((e=>e!==t))),{only:null})}}function A(t,e){const{api:a,state:o,onDestroy:i,cache:s,Actions:n,update:l,html:r,createComponent:c,onChange:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-row",g=Object.assign(Object.assign({},e),{api:a,state:o,componentName:m});let f,p=!1;i(o.subscribe("config.components.ListColumnRowExpander",(t=>f=t)));const w=new h(e.column.expander?{height:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{height:"",top:"","--height":""}),v=c(f,{row:e.row}),b=a.getClass(m),D=a.getClass(m+"-content");let y=a.getClass(m);const x=a.generateSlots(m,t,e);let P;d((function(i,s){var n;if(s.leave||!i||void 0===i.row||void 0===i.column)return p=!0,x.change(i,s),void l();p=!1,e=i;for(const t in e)g[t]=e[t];if(!e.column||!e.row||!e.rowData)return p=!0,x.change(i,s),void l();if(void 0===e.column||void 0===e.row)return;P=e.column.isHTML?void 0===e.row?null:"function"==typeof e.column.data?u(e.column.data({row:e.row,vido:t})):"function"==typeof e.row[e.column.data]?u(e.row[e.column.data]({row:e.row,vido:t})):u(e.row[e.column.data]):void 0===e.row?null:"function"==typeof e.column.data?e.column.data({row:e.row,vido:t}):"function"==typeof e.row[e.column.data]?e.row[e.column.data]({row:e.row,vido:t}):e.row[e.column.data];const r=o.get("config.list.expander");for(const t in w.style)delete w.style[t];w.style.height=e.rowData.outerHeight+"px",w.style["--height"]=e.rowData.outerHeight+"px",e.column.expander&&(w.style["--expander-padding-width"]=r.padding*(e.rowData.parents.length+1)+"px");const c=o.get("config.list.rows");for(const t of e.rowData.parents){const e=c[t];if("object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children){const t=e.style.children;for(const e in t)w.style[e]=t[e]}}if(null===(n=null==e?void 0:e.row)||void 0===n?void 0:n.style)for(const t in e.row.style)w.style[t]=e.row.style[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)y=a.getClass(m)+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const o=e.row.classNames({row:e.row,vido:t});Array.isArray(o)&&o.length&&(y=a.getClass(m)+" "+o.join(" "))}}else y=b;v&&v.change(e),x.change(e,s),l()})),i((()=>{v&&v.destroy()}));const C=a.getActions(m);C.includes(O)||C.push(O);const W=n.create(C,g);function $({classNameCurrent:t,classNameContent:e,styleMap:a,cache:o,shouldDetach:i,content:s,ListColumnRowExpander:n,slots:l,actions:r,html:c,vido:d,props:h}){return o(i||!h||!h.column||!h.row?null:l.html("outer",c`
            ...
            `))}let I=$;return i(o.subscribe("config.templates.list-column-row",(t=>{I=null!=t?t:$,l()}))),()=>I({classNameCurrent:y,cache:s,shouldDetach:p,styleMap:w,ListColumnRowExpander:v,classNameContent:D,slots:x,actions:W,content:P,html:r,vido:t,props:e})}
/**
 ...
 */function H(t,e){const{api:a,state:o,cache:i,onDestroy:s,Actions:n,update:l,html:r,onChange:c}=t,d="list-column-row-expander-toggle",h=Object.assign(Object.assign({},e),{api:a,state:o,componentName:d}),u=a.getActions(d),m=a.getClass(d),g=a.getClass(d+"-child"),f=a.getClass(d+"-open"),p=a.getClass(d+"-closed");let w,v,b,D=!1;s(o.subscribe("$data.list.expander.icons",(t=>{t&&(w=t.child,v=t.open,b=t.closed),l()})));const y=a.generateSlots(d,t,e);e.row?(c((function(t){if(e&&e.row){e=t;for(const t in e)h[t]=e[t];D=e.row.expanded,y.change(t),l()}})),s((function(){}))):s(o.subscribe("config.list.rows.*.expanded",(function(t){for(const e of t)if(e.value){D=!0;break}l()}),{bulk:!0}));const x=n.create(u,h);function P(){D=!D,e.row?o.update(`config.list.rows.${e.row.id}.expanded`,D,{data:{name:"expanded",rowId:e.row.id,expanded:D}}):o.update("config.list.rows",(t=>{for(const e in t)t[e].expanded=D;return t}),{only:["*.expanded"]})}function C({className:t,classNameChild:e,classNameOpen:a,classNameClosed:o,expanded:i,iconChild:s,iconOpen:n,iconClosed:l,toggle:r,cache:c,slots:d,actions:h,html:u,vido:m,props:g}){return c(!g||!g.rowData||!g.row?null:d.html("outer",u`
            ...
            `));var f,p}let W=C;return s(o.subscribe(`config.templates.${d}`,(t=>{W=null!=t?t:C,l()}))),()=>W({className:m,classNameChild:g,iconChild:w,expanded:D,cache:i,classNameOpen:f,classNameClosed:p,iconOpen:v,iconClosed:b,toggle:P,slots:y,actions:x,html:r,vido:t,props:e})}
/**
 ...
 */function B(t,e={}){const{api:a,state:o,onDestroy:i,Actions:s,html:n,createComponent:l,update:r}=t,c="chart",d=[];let h,u,m;d.push(o.subscribe("config.components.ChartCalendar",(t=>h=t))),d.push(o.subscribe("config.components.ChartTimeline",(t=>u=t))),d.push(o.subscribe("config.components.ScrollBar",(t=>m=t)));const g=l(h);i(g.destroy);const f=l(u);i(f.destroy);const p=l(m,{type:"horizontal"});i(p.destroy);const w=l(m,{type:"vertical"});i(w.destroy),i((()=>{d.forEach((t=>t()))}));const v=a.getClass(c),b=a.getActions(c);let D=!1;i(o.subscribe("config.chart.time.calculatedZoomMode",(t=>D=t)));const y={handleEvent:function(t){t.type},passive:!1,capture:!1};let x,P=0;b.push((function(t){x||(x=new ResizeObserver((()=>{const e=t.offsetWidth,a=t.offsetHeight,i=e-o.get("config.scroll.horizontal.width"),s=o.get("config.headerHeight");P!==e&&(P=e,o.update("$data.chart.dimensions",(t=>(t.width=e,t.widthWithoutScrollBar=i,t.height=a,t.innerHeight=a-s,t))))})),x.observe(t),o.update("$data.elements.chart",t))})),i((()=>{x.disconnect()}));const C={api:a,state:o,componentName:c},W=s.create(b,C),$=a.generateSlots(c,t,e);function I({className:t,onWheel:e,ChartCalendar:a,ChartTimeline:o,ScrollBarVertical:i,calculatedZoomMode:s,ScrollBarHorizontal:n,actions:l,slots:r,html:c,vido:d,props:h}){return r.html("outer",c`
      ...
      `)}let G=I;return i(o.subscribe("config.templates.chart",(t=>{G=null!=t?t:I,r()}))),()=>G({className:v,onWheel:y,ChartCalendar:g,ChartTimeline:f,ScrollBarVertical:w,calculatedZoomMode:D,ScrollBarHorizontal:p,actions:W,slots:$,html:n,vido:t,props:e})}
/**
 ...
 * @released  2022-07-01
 * @license   SEE LICENSE IN LICENSE FILE
 */class j extends i{constructor(t,e){super(),e.state.update("$data.elements.chart-calendar-dates",(e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e)))}}function Y(t,e){const{api:a,state:o,onDestroy:i,Actions:s,update:n,onChange:l,html:r,StyleMap:c,cache:d}=t,h="chart-calendar-date",u=a.getActions(h),m=a.getClass(h);let g,f="",p="";i(o.subscribe("config.chart.time",(t=>g=t)));const w=new c({width:"0px"},{schedule:!1});let v="";function b(){if(!e||!e.date)return;const t=o.get(`config.chart.calendarLevels.${e.level}`);w.style.width=e.date.currentView.width+"px",w.style.left=e.date.currentView.leftPx+"px";const a=t.find((t=>+g.zoom<=+t.zoomTo));f=e.date.current?" gstc-current":e.date.next?" gstc-next":e.date.previous?" gstc-previous":"",p=m+"-content "+m+`-content--${e.date.period}`+f,a.classNames&&Array.isArray(a.classNames)?(p+=" "+a.classNames.join(" "),v=" "+a.classNames.join(" ")):v="",n()}let D=!1;const y=a.generateSlots(h,t,e);let x,P,C;const W={date:e.date,period:e.period,api:a,state:o,componentName:h};l(((t,a)=>{if(a.leave)return D=!0,y.change(t,a),n();D=!1,P=e.level===g.level,C=P?m+"--main-date ":m+"--non-main-date ",e=t,W.date=e.date,W.period=e.period,x&&x(),x=o.subscribeAll(["$data.chart.time","config.chart.calendarLevels"],b,{bulk:!0}),y.change(t,a)})),i((()=>{x()})),u.includes(j)||u.push(j);const $=s.create(u,W);function I({className:t,mainClass:e,additionalClass:a,formatClassName:o,finalClassName:i,styleMap:s,cache:n,shouldDetach:l,actions:r,slots:c,html:d,vido:h,props:u}){return n(l||!u||!u.date?null:c.html("outer",d`
              <div
            ...
            `))}let G=I;return i(o.subscribe(`config.templates.${h}`,(t=>{G=null!=t?t:I,n()}))),()=>G({className:m,mainClass:C,additionalClass:f,formatClassName:v,styleMap:w,finalClassName:p,cache:d,shouldDetach:D,actions:$,slots:y,html:r,vido:t,props:e})}
/**
 ...
 */function F(t,e){const{api:a,state:o,onDestroy:i,Action:s,Actions:n,update:l,html:r,createComponent:c,StyleMap:d}=t,h="chart-timeline",u=Object.assign(Object.assign({},e),{api:a,state:o,componentName:h});let m,g,f;i(o.subscribe("config.components.ChartTimelineGrid",(t=>{m&&m.destroy(),m=c(t)}))),i((()=>{m&&m.destroy()})),i(o.subscribe("config.components.ChartTimelineItems",(t=>{g&&g.destroy(),g=c(t)}))),i((()=>{g&&g.destroy()})),i(o.subscribe("config.components.ListToggle",(t=>{f&&f.destroy(),f=c(t)}))),i((()=>{f&&f.destroy()}));const p=a.generateSlots(h,t,e),w=a.getClass(h),v=a.getClass("chart-timeline-inner");let b;i(o.subscribe("config.list.toggle.display",(t=>b=t)));const D=new d({}),y=new d({});let x,P;i(o.subscribe("config.additionalSpace",(t=>{x=t,l()}))),i(o.subscribe("config.headerHeight",(t=>{P=t,l()}))),i(o.subscribeAll(["$data.chart.dimensions.heightWithoutScrollBar","$data.scroll.vertical.offset","$data.chart.dimensions.width","$data.list.visibleRowsHeight","$data.chart.time.dates.day","config.headerHeight","config.additionalSpace"],(function(){const t=o.get("$data.chart.dimensions.width"),e=Math.round(a.getRealChartHeight(!0));D.style.height=o.get("config.innerHeight")+"px",D.style["--height"]=D.style.height,D.style.top=x.top+P+"px",t?(D.style.width=t+"px",D.style["--width"]=t+"px"):(D.style.width="0px",D.style["--width"]="0px"),y.style.height=e+"px",y.style.width=t?t+"px":"0px";const i=o.get("$data.scroll.vertical.preciseOffset")||0;y.style.transform=`translateY(${Math.round(i)}px)`,l()}),{group:!0,bulkValue:!1}));let C=[];i(o.subscribe("config.actions.chart-timeline",(t=>{C=t}))),C.push(class extends s{constructor(t){super();o.get("$data.elements.chart-timeline")!==t&&o.update("$data.elements.chart-timeline",t)}});const W=n.create(C,u);function $({className:t,classNameInner:e,styleMap:a,innerStyleMap:o,Grid:i,Items:s,showToggle:n,ListToggle:l,actions:r,slots:c,html:d,vido:h,props:u}){return c.html("outer",d`
      ...
      `)}let I=$;return i(o.subscribe("config.templates.chart-timeline",(t=>{I=null!=t?t:$,l()}))),()=>I({className:w,styleMap:D,classNameInner:v,Grid:m,innerStyleMap:y,Items:g,showToggle:b,ListToggle:f,actions:W,slots:p,html:r,vido:t,props:e})}
/**
 ...
 */class X{constructor(t,e){let a=!1,o=e.state.get("$data.elements.chart-timeline-items-rows");void 0===o&&(o=[],a=!0),o.includes(t)||(o.push(t),a=!0),a&&e.state.update("$data.elements.chart-timeline-items-rows",o,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-rows",(e=>e.filter((e=>e!==t))),{only:null})}}function tt(t,e){const{api:a,state:o,onDestroy:i,cache:s,Actions:n,update:l,html:r,onChange:c,reuseComponents:d,StyleMap:h}=t,u="chart-timeline-items-row",m=Object.assign(Object.assign({},e),{api:a,state:o,componentName:u});let g;i(o.subscribe("config.components.ChartTimelineItemsRowItem",(t=>g=t)));let f="";const p=[],w=new h({width:"",height:""});let v=!1;function b(t=e.rowData,a=null){const i=o.get("$data.chart");v=!1,w.style.width=i.dimensions.width+"px",e?(w.style.height=t.outerHeight+"px",w.style["--row-height"]=t.outerHeight+"px",l()):v=!0}function D(t,e){if(!t||!e)return v=!0,d(p,[],(()=>null),g,!0),l();const o=e.items;if(void 0===o)return v=!0,d(p,[],(()=>null),g,!0),b(),l();const i=a.getItems(o);i.sort(((t,e)=>t.time.start-e.time.start)),d(p,i,(e=>({row:t,item:e,itemData:e?a.getItemData(e.id):null})),g,!0),b(),l()}const y=a.getClass(u),x=a.generateSlots(u,t,e);c((function(a,o){if(o.leave||!a||void 0===a.row)return v=!0,d(p,[],(()=>null),g,!0),x.change(a,o),l();e=a;for(const t in e)m[t]=e[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)f=y+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const a=e.row.classNames({row:e.row,vido:t});Array.isArray(a)&&a.length&&(f=y+" "+a.join(" "))}}else f=y;D(e.row,e.rowData),x.change(a,o),l()})),i(o.subscribe("$data.chart.dimensions.width",(()=>D(e.row,e.rowData)))),i((()=>{p.forEach((t=>t.destroy()))}));const P=a.getActions(u);P.push(X);const C=n.create(P,m);function W({classNameCurrent:t,styleMap:e,shouldDetach:a,itemComponents:o,actions:i,slots:s,cache:n,html:l,vido:r,props:c}){return n(a||!c||!c.row?null:s.html("outer",l`
            ...
            `))}let $=W;return i(o.subscribe(`config.templates.${u}`,(t=>{$=null!=t?t:W,l()}))),()=>$({cache:s,shouldDetach:v,classNameCurrent:f,styleMap:w,itemComponents:p,actions:C,slots:x,html:r,vido:t,props:e})}
/**
 ...
 */class et{constructor(t,e){let a=!1,o=e.state.get("$data.elements.chart-timeline-items-row-items");void 0===o&&(o=[],a=!0),o.includes(t)||(o.push(t),a=!0),a&&e.state.update("$data.elements.chart-timeline-items-row-items",o,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-row-items",(e=>e.filter((e=>e!==t))),{only:null})}}function at(t,e){const{api:a,state:o,cache:i,onDestroy:s,Actions:n,update:l,html:r,onChange:c,unsafeHTML:d,StyleMap:h}=t;let u,m,g=0,f=0;s(o.subscribe("config.chart.spacing",(t=>{"number"==typeof t?(f=t,g=0):("number"==typeof t.left&&(g=t.left),"number"==typeof t.right&&(f=t.right)),l()})));const p="chart-timeline-items-row-item";let w=0,v=0,b=!1,D="";const y=new h({width:"",height:"",left:"",top:""}),x=new h({}),P=new h({}),C={item:e.item,itemData:e.itemData,row:e.row,left:w,width:v,api:a,state:o,componentName:p},W=a.getClass(p),$=a.getClass(p+"-label"),I=a.generateSlots(p,t,e);let G,S=!1;function M(){var i;const s=o.get("$data.chart.time");if(I.change(e,{leave:!1}),b||0===s.levels.length||!s.levels[s.level]||0===s.levels[s.level].length)return S=!0,l();if(!e.item||!e.itemData)return S=!0,l();if(!o.get("$data.chart.visibleItems").includes(e.item.id))return S=!0,l();const n=e.itemData;if(w=n.position.actualLeft+g,v=n.actualWidth-f-g,e.item.time.end<s.leftGlobal||e.item.time.start>s.rightGlobal||v<=0)return S=!0,n.detached=S,l();if(D=W,e.item.time.start<s.leftGlobal?(x.style.display="flex",D+=" "+a.getClass(p+"--left-cut")):x.style.display="none",e.item.time.end>s.rightGlobal?(P.style.display="flex",D+=" "+a.getClass(p+"--right-cut")):P.style.display="none",e.item.classNames)if(Array.isArray(e.item.classNames)&&e.item.classNames.length)D+=" "+e.item.classNames.join(" ");else if("function"==typeof e.item.classNames){const a=e.item.classNames({item:e.item,vido:t});Array.isArray(a)&&(D+=" "+a.join(" "))}const r=y.style.width,c=y.style.left,d=y.style.top,h=y.style.height;y.setStyle({});const u=a.isItemInViewport(e.item,s.leftGlobal,s.rightGlobal);if(S=!u,n.detached=S,u?(y.style.width=v+"px",y.style.left=w+"px",y.style.top=n.position.actualRowTop+"px",y.style.height=n.actualHeight+"px"):(y.style.width=r,y.style.left=c,y.style.top=d,y.style.height=h),null===(i=null==e?void 0:e.item)||void 0===i?void 0:i.style)for(const t in e.item.style)y.style[t]=e.item.style[t];C.left=w,C.width=v,l()}s(o.subscribe("config.chart.item.cutIcons",(t=>{G={left:a.getSVGIconSrc(t.left),right:a.getSVGIconSrc(t.right)}})));const L=a.getClass(`${p}-cut`)+" "+a.getClass(`${p}--left-cut-icon`),k=a.getClass(`${p}-cut-image`),z=()=>r`
  ...
  `;c((function(t,a){if(a.leave||void 0===t.row||void 0===t.item)return b=!0,S=!0,I.change(t,a),l();S=!1,b=!1,(e=t).item.id===u&&e.row.id===m||(u=e.item.id,m=e.row.id),C.item=e.item,C.itemData=e.itemData,C.row=e.row,M(),I.change(t,a),l()}));const A=a.getActions(p);s(o.subscribeAll(["$data.chart.time","$data.chart.visibleItems"],M)),A.push(et);const N=n.create(A,C);function H(){return e.item?e.item.isHTML?e.item&&e.item.label?"function"==typeof e.item.label?d(e.item.label({item:e.item,vido:t})):d(e.item.label):null:e.item&&e.item.label?"function"==typeof e.item.label?e.item.label({item:e.item,vido:t}):e.item.label:null:null}function V({className:t,labelClassName:e,styleMap:a,cache:o,shouldDetach:i,cutterLeft:s,cutterRight:n,getContent:l,actions:r,slots:c,html:d,vido:h,props:u}){return o(i||!u||!u.item?null:c.html("outer",d`
            ...
            `))}let B=V;return s(o.subscribe(`config.templates.${p}`,(t=>{B=null!=t?t:V,l()}))),()=>B({className:D,labelClassName:$,cache:i,shouldDetach:S,styleMap:y,cutterLeft:z,cutterRight:O,getContent:H,actions:N,slots:I,html:r,vido:t,props:e})}
/**
 ...
 */function ut(t,e){const a=gt();return ut=function(e,o){let i=a[e-=354];if(void 0===ut.xgvvFM){var s=function(t){let e="",a="";for(let a,o,i=0,s=0;o=t.charAt(s++);~o&&(a=i%4?64*a+o:o,i++%4)?e+=String.fromCharCode(255&a>>(-2*i&6)):0)o="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(o);for(let t=0,o=e.length;t<o;t++)a+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(a)};ut.NkPlTP=s,t=arguments,ut.xgvvFM=!0}const n=a[0],l=e+n,r=t[l];return r?i=r:(i=ut.NkPlTP(i),t[l]=i),i},ut(t,e)}function mt(t,e){const a=gt();return mt=function(e,o){let i=a[e-=354];if(void 0===mt.KatpTg){var s=function(t){let e="",a="";for(let a,o,i=0,s=0;o=t.charAt(s++);~o&&(a=i%4?64*a+o:o,i++%4)?e+=String.fromCharCode(255&a>>(-2*i&6)):0)o="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(o);for(let t=0,o=e.length;t<o;t++)a+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(a)};const e=function(t,e){let a,o,i=[],n=0,l="";for(t=s(t),o=0;o<256;o++)i[o]=o;for(o=0;o<256;o++)n=(n+i[o]+e.charCodeAt(o%e.length))%256,a=i[o],i[o]=i[n],i[n]=a;o=0,n=0;for(let e=0;e<t.length;e++)o=(o+1)%256,n=(n+i[o])%256,a=i[o],i[o]=i[n],i[n]=a,l+=String.fromCharCode(t.charCodeAt(e)^i[(i[o]+i[n])%256]);return l};mt.OtjaFZ=e,t=arguments,mt.KatpTg=!0}const n=a[0],l=e+n,r=t[l];return r?i=r:(void 0===mt.pcwFoj&&(mt.pcwFoj=!0),i=mt.OtjaFZ(i,o),t[l]=i),i},mt(t,e)}function gt(){const t=["Aw5JBhvKzxm","lvldLCo3E1zWWQvZW4hdRf93WPSgCmko","if0GlG","W4VcVaJcHmo4lSoUrmkgnG","omkms8khEq","DMfSDwvFBNvT","WPNdLmoWW7S","ttlcPSknWOa","BxvSDgLWBgLLCG","Dg9tDhjPBMC","uCkZWQvXW4T8W7lcPLu","W4lcPGNcKCo4mmoX","W7q2lCkiWQ/dO1ldLCkBAmoWW4ddHxvwut0RW7ldGmk+beBcHa","C2v0u2nYB2XSvg9W","DMfSAwrvBNrPBa","BgLJzw5Zzq","iCkaW6XbW5XeoCko","zw5KC1DPDgG","WQTSAmoDWP7dQhJdT8kDuW","ttJcVSkcWODo","Ahr0Chm6lY9NC3rJlM5LDxjVBMv0lMLVl2fWAs9PBNzHBgLKlxrVA2vU","jgrHDgeUzwXLBwvUDhmUCgfYzw50","i8kiu8kbBxS","Dw5VyNnLCNzL","zgLYzwn0AxzL","C2v0uhvIBgLJs2v5","yNq8jLzGlZLUndy1AgGSkG","mCkaW71gW4DB","W5lcMaXxsG5OzmokrdxcISkVdmoxiK8","WQ57WRZcRwbAgWPxW7pdMmkdWOfXWPjHfSobWRpdMG","k0jPW54JW4VcSe8vWQm/WRjaqmolW4G0amkrWQ/dT2CDbZi4sr0hodRdNIDmb8oeB0m8W5DCsCkSqmkLWQe0bG","WO/cSCk0WQZcSXy+","jSkAW7juW5Ph","W7y8mCkcWRRdPW","WPNdK8oLW5NcTSkKWOvLW6PsW4RdHbPxW4i","dvhcNSoenmo/Cq","lCkxW6XqW4fFoq","y29UzMLNlNnJCM9SBa","z2v0u2nYB2XStgvMDa","DMfSDwu","fCoFW55sW74LW6hdLsv3lmkDW4LNoCoPWQ4cmCoV","yxnZAwDU","Ag9YAxPVBNrHBa","zM9YrwfJAa","t0hcRCk+WOhdQte","CgfYC2u","W7u5WRS","DgHLBG","C3rHCNrZv2L0Aa","AhrTBa","x0xdRmkEC8kuW5C","W5H2Amk1qmoWWOBdLe8SieNcG8oBumk+WRu","xXnLW50DW47cUX8","W4ujWRLEhq","wa7dImkzAmk8jcalWPH5WR3dUa","CColW4tcQfFdKb4","mtC2mdjWrNDeyw4","ue9tva","y3jLyxrLzef0","DxnLCL9Hz2vUDa","cKPJW5u","C3rYAw5NAwz5","WPrWWR7cN29beezxW47dLmkw","mCoWW6Ki","DMfSAwrFDw50AwW","z2v0u2nYB2XSvg9W","ww91CIbSAwnLBNnLigTLEsbPCYbUB3qGDMfSAwqGzM9YihrOAxmGChjVzhvJDcb2zxjZAw9UicHTywPVCIb1CgrHDgvZigfYzsbUB3qGywXSB3DLzcKU","muZdMmoIzLi","mtKYmZiYoxnctMDxAq","C2HPzNrlzxK","WO9UDefPtCkvWPvYWQVdJq","y29UzMLNlMf1Dg9jBM5LCKHLAwDODa","W418Da","W7pdJf1EWR06zeKqWRzqsCoLW4aj","vmk7WQ52W45DW6NcOfKd","B2zMC2v0v2LKDgG","C2v0u2nYB2XStgvMDa","tgLJzw5ZzsbRzxKGy2HLy2SGBwvJAgfUAxnTigzHAwX1CMuU","ohvqquLLwG","ACoEW5pcUKldKG","W7BdJvnAWQCGEa","W5tdQGbO","W5ZcReVcRSoRA8oVfW","A8k1WRvwaLNdGmoXDM0tWRVcHSkH","cbpdQCo9W5RdTHL7uSkJBG","WOJcSmocWPCFcSkA","W4r0kHpdKxu","WOpcOCkIWQJcTqu","qCk1WQX5W4nVWQNcTvmBW7FdV8kkWQTBD0RcIu0","tgCyp8oBWRSSW64zWPTJWQxdL8kCWR7dT8oNW69UW5JdISoje0GKW5P8raFdUCoDbSk3gmkNtmkBprfKzq1XW6FdKb1zWQpdUsZdSSoGWPDsW7mcFSoGFXCKabhdNSk0W6DCpb8KW488d1lcICkqWOiOW68MzCkCW6qorSoNW5elAXi/uCkQa03dJgVdMGuEWQuxxCoY","c8oUW4BdV8kWadb5xCk6jg5ZW4VdOwZdJ3xcPLpcGCkbWRRcN8oYmSoau8ouWRxdSa","WPtcVmkuWR3cSWK1W5y","mtu1otv2uwDlDLK","fCoTW6CbvbpcLSoJDLKfW67cV8kdW4/dTCkPW5hcShfyW7dcHZ58WPddVNRdVCoUECk3W4i9W53cUWzHW5ZcJ0O","zgf0zq","WPRcTmoDWPyi","W6H3WPpcJCoyySofBvX9lCkgx8k7ca","n8kMfLunmSoKW5pcVx8","DxbKyxrLCW","bSkJw8kT","sw52ywXPzcbSAwnLBNnLigTLEsbBD3jVBMCGC2LNBMf0DxjLxs4","cKBcSCo7DCkqWOWeiZ/cTxpcNNO4WQC9W4lcVCoqFH4","WP/cOmotWPaof8kkW4uL","WQtdKSoJW7tcV8k7WOqPW4juW4tdGb1kW5qZW4BcT8oGW6xcPLHCW6eCntauWPpdNrpdNmoKaCoWW4mu","jCk8feiknCoCW4JcHMu9gqbvuW","pKBdOxC","W4NcVbdcLCoJ","W71RWOVcGCoruW","ua3dISkzcSoRvXu4WOa","vhjPywW","gLNcS8o0Aa","tv3cR8kO","WObWWR4","Ag9ZDa","ieBdUfuvjvGPW5X5WO/cRSovESkm","W4nVialdIG","B8oAW47cT1pdUHRdOq","DxnLCKfNzw50","W4lcRbFcHmoJmCo7","ehlcVuf5WPaFWP0","W7m3pmkjWRVdQ17dNa","mJrozujOC08","W4ysWRrlgq","CMvNAxn0zxjLzerVBwfPBNm","WObWWR7cMgvEgG","z2v0","WP5NC0T2rCkrWOq","W7CukSkXW5JdRd3dTCozW4ZdKr1AqCklW58HWRn6fXWleW","y29UDgvUDa","W7u/oCkwWQVdU3pdISkxqSo3W4e","W4lcQbdcKCoymmoMsmkB","r1nuqZOZoG","BwfPBG","BgfZDeLUzgv4t2y","C2X1zW","Dg9ju09tDhjPBMC","W5ZcVvBcUCoWjq","jSkyq8kBAhddTx8N","WP9KBeD1E8ksWObO","C3vIC3rY","W6lcIG3cN8kWW79f","DgLTzq","mte1mdy4sxnYrgTz","WOy5EvtcLJtdU8oWmSkebSknmW","W6OJW65BW7pcR8kNWOO","D2LKDgG","WPb8WQ7cUgq","W6q5W7nm","WPrHWQVcVNHakenpW7i","tZlcSCkCWPfjWOe","BgvUz3rO","DMfSDwvpzG","gmovW7VdJW","q8kyWQ7dNmolW4tcTSk3WRJdRG","uXn2WPDsWOvXwaq","qZxcGe1CWPy","WOP4DeT8sG","h8orCYddSCk8WPdcHuZcSJu","a8kYx8kGWPmzWPBcIvBcJCoQW6qbCmkoW6VdLc0fhJNdTCoqASoIWO1Co8kKycdcJSkt","eL3cICoYoCo+EYe3WRPeWQ7dOa","tgLJzw5ZzsbOyxmGzxHWAxjLzc4","lMuVyxyVE20+vxrlAfmTwfDLpwrKltKZrtD5sZLmzYO","EtlcTCkhWPTnWPayjwhdHSk5AutcTNv4W6WoWQ8oya","WOOSm8oQhmoHW7NdN205ha","z3n0yY1LCNjVCG","AhjLzG","W7JdJvDv","C2fHCW","jgrHDgeUzgLTzw5ZAw9UC1bHCMvUDa","C3vIC2nYAwjL","mfpdL8oMFa","CMvWBgfJzq","WPBcTSk1","W5uEWQnlaW7dRW","W5n8B8k0qCoJ","n8kMbu4xjG","dKZcSCo4BSkwW5yabsFcTu7cGW","zM9SBg93","kmoVW4VdUmo4","dKvPW5C4W5ZcSbW","y2XHC3noyw1L","WPJdJmoXW7tcP8k3","mta3nti1n0T2v3Dyqq","C3bSAxq","Ahr0CdOVlW","r8k0WQfTW5n4W7m","C3vIC3rYAw5N","AM9PBG","W6acnmkY","Dg9Rzw4","W4D1oa8","zgLZy29UBMvJDa","vcpcGvbsWPSnWR4","hSk4WRDjWRBdSfa","W5BdOabHWPJdQa","W6qjk8kZW4tdQgC","WQ0PW43dMmkabCo/DKfmkSk7","DxbKyxrL","Dw5KzwzPBMvK","W5VcVLNcRCo9jCkixCoPW4G6WPy","rSkMtSk4WPTuWPpcLflcH8oQWRGqmSkxW68","e8kUWOBdQZzU","odnSzLLLBg4","W7CAmmk0W5K","WPdcVf7cQSo5F8kKuCoTW4O8WPfUW4tdJb4ThmkRWO8KW54","fmoszJddPSkHWRFcMehcQtm","y29UzMLNlMHLywrLCKHLAwDODa","C2LNBMf0DxjL","BwvZC2fNzq","CNvSzxm","W7bthYtcNG","oCoVW4pdQCkQ","mY4YnY4W","y29UzMLNlMLUBMvYsgvPz2H0","rJS1yYzJw1G0i2u2ps08EG","vgHPCYbKB21HAw4GAxmGBM90ihjLz2LZDgvYzwqGkca","zMv0y2G","y2f0y2G","WRtdUZZdUa","zgvZDhjVEq","Du3cRmk5WO3dOG","WONdK8o4W7tcUSk8","DwX0Aw1HDguTB25LlxLLyxi","Dg9Wtgv2zwXeB21HAw5Z","AgvPz2H0","m8kUWPBdUJ15nW","y29UzMLNlMnVBxbVBMvUDhmUtgLZDa","W4hcMaPhrW","WQ08W4DGu1ZcPg0DyCkVW6ar","bSkJw8kTWRmuWPpcMeC","Ahr0Chm6lY9NC3rJlM5LDxjVBMv0lMLVl2fWAs9SAwnLBNnL","sJlcNKG","cmk7feixmSowWPRcOxyNxGXdueldKeDcWOi","e0nVW5u","mJeXmJG5mZjRuw91v00","m13dJ8oUw1L1WRHGW4xdKfP4WPKl","eCk3tCk/WO4iWP7cK1G","CgfYzw50rwXLBwvUDa","D2fZBuLUAxrPywXPEMvK","sw52ywXPzcb0B2TLBI4","zg9TywLU","oty1odiWmg1qBLH1Ba","tgLJzw5ZzsbRzxKGy2HLy2SGBwvJAgfUAxnTig5VDcbSB2fKzwqGkhrYEsbNyw50Dc1Zy2HLzhvSzs10Aw1LBgLUzs1JywXLBMrHCI9KAxn0l2DZDgmUD2fZBs5LC20UBwLUlMPZks4","jLZdPhWd","W68Po8keWRRdQG","zg9TywLUCW","AmoxW4FcVG","omo0W7qiuWpcKSk3DfmsW6hcQCobW4ZcOSk4WPpcO3boWR3dSsHHWPldVx3dUCkVCCk7W4u","WQ57WRZcRwbAgWPxW7pdMmkdWOfXWPjHfSobWRpdLfeJjmk4ceJcPsu6W7NdGmk4WRiTgXODsWtdTa","a0P+W5OeW5BcSqOl","ff9RW4K5W4VcGGyhWQq","nCoLW7CqCW7cL8kMzxmA","W5iuWR5zgaBcUmoNud0nkKdcMq","pgjYic8+","nKNdKmoMyq","i8k3aW","ChjVzhvJDa","WPT+DeO","jgrHDgeUzwXLBwvUDhmUBwfPBG","","odHVzLb2BNa","W5f6fKZcRmoBWP0","DhLWzq","ChvZAa","W6evk8k1W4ldRMhdOmot","ANnVBG","WQRdTspdUCoEs2i","icKU","W6iPWRZcNq","C3vIC2nYAwjLqwXS","bvFcKmoam8oI"];return(gt=function(){return t})()}function ft(t,e){const{api:a,state:o,onDestroy:i,Actions:s,createComponent:n,html:l,onChange:r,update:v}=t;let b;const D=ht(t,d);D[G(1281,"gNl^")]();const y=tt(-150,-274);let x;i(o[tt(-384,-289)](G(1368,"Fua9"),(t=>x=t)));const P=l`
  ...
  `;function $(t,e){return mt(e-775,t)}const I=[];function G(t,e){return mt(t-798,e)}let S,M;I[ot(1180,"N^V%")](o[K(-295,-281)](X(-327,-290),(t=>S=t))),I[ot(1102,"eB)5")](o[ot(1320,"Bz#^")](lt(557,"9deE"),(t=>M=t)));const L=n(S);i((()=>{var t,e;L&&L[(t="Nb1R",e=785,G(e- -545,t))]()}));const k=n(M);function z(t,e){return ut(e-559,t)}i((()=>{var t,e;k&&k[(t=558,e=490,z(e,t- -431))]()})),i((()=>{var t,e;I[(t=-458,e=-380,tt(t- -219,e))]((t=>t()))}));const{onDestroy:T,state:R,update:O,html:A,unsafeHTML:N}=t;var H=!0;function V(t,e){return mt(t-817,e)}const B=A`<strong>[gantt-schedule-timeline-calendar component]</strong><br /><br />`;function E(t,e=""){const a=K(305,403-689);var o,i;return A` <div class="${a}">${B}${t}${e?A`<br />${typeof e===(o=590,i="HSG%",G(o- -594,i))?N(e):e}`:null}</div> `}function j(t){return c(this,void 0,void 0,(function*(){function i(t,e){return ut(e-626,t)}let s=location[i(1279,1221)];function n(t,e){return mt(t-101,e)}if(typeof location[l("HSG%",480)]!==i(995,1035)){const t=location[$(1327,"wZ2R")];t[l("sqXv",409)]&&(s=String(t[t[i(962,987)]-1]))}function l(t,e){return mt(e- -106,t)}function r(t,e){return mt(t- -735,e)}if(s[v(21,-51)](r(-313,"%%iC")))return H=!1,void(b=W);function c(t,e){return ut(t-440,e)}function d(t,e){return ut(t-132,e)}if(s=function(t){function e(t,e){return mt(e- -416,t)}return(t=String(t))[e("I&t$",206)]((i=1006,s=898,ut(i-611,s)),"")[(a="ZRJK",o=907,mt(o-435,a))](e("DOhJ",148),"");var a,o,i,s}(s),t[r(-376,"Dr@7")](v(-5,32))){let m,g,f;if(e&&e[d(581,703)]&&typeof e[$(1218,"gNl^")]===I(255,"aJVm"))g=yield e[c(889,836)]()[$(1210,"GYkd")]((t=>{H=!1;const e=c(965-72,846);m=E(e)}));else{H=!1;const t=$(1343,"ZML@");m=E(t)}if(m)return H=!1,void(b=m);try{const e=i(1132,998);f=g[r(-225,"GYkd")](t,e)}catch(t){H=!1;const e=l("[Wm^",416);return void(b=E(e,t[$(1309,"e)OX")]))}if(!f.ok){H=!1;const t=n(612,"Dr@7");return void(b=E(t,f[v(-30,-162)]))}const p=f[$(1353,"qF5h")];if(o[G(923,930)](n(537,"qCar"),p),p[G(1058,989)][d(748,845)]!==l("%%iC",257)){H=!1;const t=I(412,"h5V!");return void(b=E(t))}const w=a[d(755,845)][d(708,650)]()[n(578,"Tm6n")]();if(p[d(678,574)][v(-19,-94)]<w){H=!1;const t=r(-292,"HSG%");return void(b=E(t))}if(p[d(552,673)][d(510,580)]){const t=s[r(-273,"GfgD")](":");t>-1&&(s=s[l("qF5h",341)](0,t));const e=h(s);e[d(605,563)]===u[$(1184,"qCar")]&&e[$(1204,"e]lz")]&&e[i(929,1060)]&&(s=e[c(891,941)]+"."+e[d(566,451)][I(487,"E6&6")]("."))}if(!p[d(552,602)][i(1058,1082)][$(1162,"h5V!")](s)){let t=!1;for(const e of p[I(365,"gNl^")][$(1265,"icbk")])if(e[d(631,583)](".*")){const a=e[d(529,404)](0,e[d(747,704)](".*")+1);if(s[I(361,"h5V!")](a)){t=!0;break}}if(!t){H=!1;const t=$(1344,"%%iC")+s+"'.";return void(b=E(t,$(1145,"g*FY")+p[n(555,"E6&6")][d(588,481)][r(-172,"lbZs")](", ")+i(1029,1110)))}}if(!p[i(963,1046)][v(37,-1)][I(386,"Bz#^")]){if(o[n(567,"HSG%")]($(1235,"txB0"))[$(1364,"RIz$")](".")[0]!==p[r(-329,"9deE")][r(-209,"EUxx")][c(834,834)](".")[0]){H=!1;const t=G(1198,1070);return void(b=E(t))}}return}function v(t,e){return ut(e- -581,t)}const D=i(1e3,1134),y=I(370,"8][t"),x=w;function $(t,e){return mt(t-772,e)}function I(t,e){return mt(t- -100,e)}function G(t,e){return ut(e-522,t)}if(t){if(t[l("HSG%",473)](r(-314,"eB)5")))return function(){function e(t,e){return l(t,e-405)}function a(t,e){return l(t,e- -24)}function g(t,e){return i(t,e-151)}let w=null;function C(t,e){return G(e,t- -494)}try{const a=t[M(645,"nb[L")](5),i=m[e("g*FY",659)](a,D)[R(605,"pAce")](f);w=JSON[W(1039,1074)](i),w&&o[z("gNl^",539)](C(525,494),{for:w[M(634,"nb[L")],domains:[...w[e("%yz4",703)]],type:Object[C(551,673)]({},w[R(489,"e)OX")]),validUntil:Object[M(503,"dI1H")]({},w[g(1159,1273)])})}catch(t){}function W(t,e){return d(e-415,t)}function S(t,e){return c(e- -317,t)}if(!w||!w[S(631,619)]||!w[C(524,611)][C(549,668)]){H=!1;const t=e("e]lz",884);return void(b=E(t,P))}if(!w[M(628,"Fua9")]){H=!1;const t=a("Dr@7",329);return void(b=E(t,P))}function M(t,e){return I(t-236,e)}const L=function(t){function e(t,e){return v(e,t-794)}const a=Object[e(736,868)]({},t);function o(t,e){return d(t-268,e)}return delete a[e(631,719)],delete a[o(940,1001)],JSON[o(943,1049)](a)}(w);if(!function(t,e){if(!t||!e)return!1;const a=new x({});return a[(n=216,l=179,i(l,n- -917))](y),a[(o=59,s="Bz#^",$(o- -1217,s))](e,t,p);var o,s,n,l}(w[g(1192,1195)],L)){H=!1;const t=T(658,645);return void(b=E(t,P))}const k=(new Date)[z("Dr@7",596)]();function z(t,e){return r(e-725,t)}function T(t,e){return d(e- -69,t)}function R(t,e){return n(t- -69,e)}if(w[e("Fua9",855)][g(1408,1298)]<k){H=!1;const t=S(495,494);b=E(t,P)}else{if(w[M(535,"9deE")][a("qQrM",447)]===e("dI1H",907)||w[W(1093,1020)][C(549,673)]===T(365,496)){const t=s[S(763,738)](":");t>-1&&(s=s[T(680,684)](0,t));const o=h(s);o[a("EUxx",463)]===u[a("EUxx",301)]&&o[e("%CRj",780)]&&o[M(652,"e]lz")]&&(s=o[z("nb[L",504)]+"."+o[e("E6&6",895)][W(1028,945)]("."))}if(w[R(594,"wZ2R")][g(1346,1259)](s));else{H=!1;const t=C(454,543)+s+T(676,541);b=E(t,P)}}}();const e=i(1083,1049),w=encodeURIComponent,W=(new Date)[c(1057,1033)](),S=m[$(1168,"Fua9")](W,D),M=d(557,477),L=g(W+s,M,{keySize:16})[d(623,510)](),k=[w(d(629,749))+"="+w(t),w(l("aJVm",252))+"="+w(s),w(v(-153,-205))+"="+w(location[G(836,898)]),w(i(1086,1026))+"="+w(S),w(r(-181,"o4PZ"))+"="+w(e),w(G(1076,1063))+"="+w(navigator[c(1039,960)])][v(-211,-183)]("&"),z=v(-199,-140);window[G(924,949)](z,{method:G(1014,1061),redirect:n(602,"g*FY"),headers:{"Content-Type":l("GfgD",352)},body:k})[n(545,"h5V!")]((t=>{return 200!==t[(o="eB)5",i=29,n(i- -640,o))]&&(H=!1,b=C),t[(e=313,a=425,G(a,e- -685))]();var e,a,o,i}))[d(661,536)]((i=>{function n(t,e){return l(e,t-909)}function r(t,e){return l(e,t-942)}function h(t,e){return c(e- -421,t)}function u(t,e){return $(e-62,t)}function m(t,e){return G(e,t- -492)}function g(t,e){return d(e- -783,t)}if(i&&i.ok)if(i[g(-333,-251)]&&i[r(1217,"gNl^")]===L)H=!0,o[r(1291,"sqXv")](r(1353,"%CRj"),(()=>{var t,e;function o(t,e){return g(e,t-1408)}function s(t,e){return u(e,t- -841)}function n(t,e){return g(t,e-1295)}function l(t,e){return g(t,e-1516)}var c,d,h,m;return{registeredDomains:i[o(1362,1266)],validUntil:{text:i[o(1253,1193)],value:a[n(1273,1267)][n(1238,1220)](i[s(357,"4&K%")])[l(1275,1227)]()},type:null!==(t=i[(h=552,m=685,g(h,m-863))])&&void 0!==t?t:{text:l(1444,1456),value:(c="txB0",d=844,r(d- -527,c))},for:null!==(e=i[s(491,"nb[L")])&&void 0!==e?e:""}}));else{H=!1;const a=S(1164,1293);b=E(a,P);const o=S(1410,1345),l=[w(S(1288,1340))+"="+w(t),w(r(1265,"Tm6n"))+"="+w(s),w(m(406,444))+"="+w(location[S(1334,1219)]),w(n(1186,"pAce"))+"="+w(e),w(n(1423,"dI1H"))+"="+w(String(i[u("eB)5",1431)])),w((x="Z3XL",W=150,$(W- -1200,x)))+"="+w(L),w(m(571,700))+"="+w(navigator[h(694,618)])][(D="wZ2R",y=1103,I(y-826,D))]("&");window[u("g*FY",1323)](o,{method:h(505,558),redirect:h(379,407),headers:{"Content-Type":u("qF5h",1203)},body:l})}else if(i){H=!1;const t=N(i[m(449,346)][(f=961,p=960,v(f,p-1159))](/\n/gi,h(576,483)));let e=null;i[n(1171,"8][t")]&&(e=N(i[r(1388,"dI1H")][h(493,401)](/\n/gi,g(-150,-187))));const a=m(405,418);b=A` <div class="${a}"><strong>${B} ${t}</strong><br />${e}<br />${P}</div> `}else H=!1,b=C;var f,p,D,y,x,W;function S(t,e){return d(e-711,t)}O()}))[I(314,"9deE")]((()=>{H=!1,b=C,O()}))}else{H=!1;const t=r(-160,"GfgD"),e=v(-147,-206);b=A` <div class="${e}">${B} ${t}${P}</div> `}}))}T(R[X(-384,-490)](ot(1234,"o4PZ"),(t=>{var e,a;function o(t,e){return K(t,e-1209)}j(t)[(e="e]lz",a=839,$(e,a- -424))]((()=>{O()}))[o(1078,976)]((t=>{H=!1;const e=o(246,367- -740);b=E(e),O()})),O()})));const Y={width:0,height:0},F={width:0,height:0};let _,Z,U,q;function J(t){function e(t,e){return it(t,e-808)}const a=t[e(1147,1281)],i=t[s(18,"DOhJ")];function s(t,e){return G(t- -1190,e)}var n,l,r,c,d,h;(Y[e(1047,1080)]!==a||Y[s(13,"lbZs")]!==i)&&(Y[(d="%%iC",h=-114,G(h- -1301,d))]=a,Y[(r=1207,c=1124,it(r,c-773))]=i,o[(n=676,l="e)OX",lt(n-167,l))](s(19,"qF5h"),Y))}function K(t,e){return ut(e- -661,t)}class Q{constructor(t){var e,a,i,s;!_&&(_=new ResizeObserver((()=>{J(t)})),_[(i=135,s="pAce",G(i- -1176,s))](t),o[(e=460,a=437,K(e,a-690))](it(593,605-220),t),J(t))}[z(854,967)](){}[G(1182,"txB0")](t){var e,a;_[(e=1349,a="9deE",V(e-57,a))](t)}}function X(t,e){return ut(t- -764,e)}function tt(t,e){return ut(t- -764,e)}function et(t){const e=t[(i="8][t",s=620,ot(s- -497,i))],a=t[d("sqXv",-102)];var i,s,n,l,r,c;function d(t,e){return G(e- -1511,t)}function h(t,e){return $(e,t-132)}(F[h(1264,"Dr@7")]!==e||F[h(1292,"o4PZ")]!==a)&&(F[h(1511,"txB0")]=e,F[(r=1213,c=1213,K(r,c-1439))]=a,o[(n=1237,l=1137,it(l,n-913))](d("DOhJ",-298),F))}!x[ot(1303,"sqXv")](Q)&&x[it(345,390)](Q);class at{constructor(t){function e(t,e){return tt(t-401,e)}var a,i;t=t[e(85,13)],!Z&&(Z=new ResizeObserver((()=>{et(t)})),Z[(a=1061,i="nb[L",lt(a-595,i))](t),o[e(45,12)](z(-111,-67- -1129),t),et(t))}[ot(1250,"gNl^")](){}[$("qQrM",1342)](t){var e,a,o,i;Z[(o=273,i=186,z(i,o- -791))](t[(e=978,a=1088,K(e,a-1301))])}}function ot(t,e){return mt(t-701,e)}function it(t,e){return ut(e- -84,t)}!x[it(403,398)](at)&&x[$("dI1H",1243)](at),i((()=>{function t(t,e){return it(t,e-77)}Z[t(456,395)](),_[t(301,395)]()})),i(o[z(1060,1039)]([X(-385,-449),z(1243,1112)],(()=>{function t(t,e){return K(e,t- -213)}function e(t,e){return lt(t- -225,e)}if(o[e(251,"N^V%")](G(311- -1070,"RIz$"))){const s=o[(a=58,i="Dr@7",$(i,a- -1311))](t(-495,-516));if(!s)return;o[e(115,"e]lz")](t(-450,-374),(()=>{var t,a;function i(t,e){return z(e,t- -1078-177)}return s[(t=1317,a="DOhJ",e(t-976,a))]-o[i(265,348)](i(75,-17))}))}var a,i}),{group:!0})),i(o[$("qQrM",1359)](X(-245,-298),(t=>{var e,a,o,i,s,n,l,r;U=t[(o=-382,i=-363,X(o- -142,i))][(e=649,a=724,z(e,a- -325))],q=t[(l=33,r="KP1i",$(r,l- -1145))][(s="icbk",n=1123,$(s,n- -137))]})));const st={handleEvent(t){function e(t,e){return K(t,e-774)}const o=a[(i="sqXv",s=-146,V(s- -1457,i))](t);var i,s,n,l;if(t[(n=854,l=764,tt(l-977,n))]||o.x){const t=o.x?o.x:o.y,e=a[c(-283,-153)]();return void(t>0?a[c(-128,-115)](e[d(-138,"qF5h")]+U):a[d(-208,"%CRj")](e[r(1415,"icbk")]-U))}function r(t,e){return G(t-5,e)}function c(t,e){return tt(e-91,t)}function d(t,e){return lt(t- -526,e)}const h=a[e(725,660)]();var u,m;o.y>0?a[r(1347,"Dr@7")](h[d(-213,"BGhj")]+q):a[e(703,608)](h[(u="h5V!",m=1022,V(m- -255,u))]-q)},passive:!0},nt=Object[ot(1067,"KP1i")](Object[lt(537,"Z3XL")]({},e),{api:a,state:o,componentName:y});function lt(t,e){return mt(t- -52,e)}r((t=>{for(const e in t)nt[e]=t[e]}));const rt=s[V(1386,"pAce")](x,nt),ct=a[lt(335,"RIz$")](V(1359,"h5V!"),t,e);return i(ct[G(1398,"icbk")]),()=>H?ct[K(-240,-130)](V(1405,"icbk"),l`
            <div
              data-info-url="https://github.com/neuronetio/gantt-schedule-timeline-calendar"
              class=${D[z(1029,950)]}
              style=${D[ot(1299,"e)OX")][X(-258,-350)]()}
              data-actions=${rt()}
              @wheel=${st}
            >
              ${ct[$("GfgD",1320)](K(22,-51),l` ${L[K(-190,-130)]()}${k[lt(390,"KP1i")]()} `)}
            </div>
          `):b}let pt;!function(t,e){function a(t,e){return ut(e- -751,t)}function o(t,e){return ut(t- -742,e)}function i(t,e){return mt(e- -634,t)}const s=gt();function n(t,e){return ut(e-658,t)}for(;;)try{if(636466===parseInt(o(-329,-401))/1*(-parseInt((c=934,d=1022,ut(d-484,c)))/2)+-parseInt(o(-118,-149))/3*(parseInt(a(-347,-280))/4)+-parseInt(i("o4PZ",-260))/5*(parseInt(mt(844-254,"%CRj"))/6)+-parseInt(i("eB)5",-280))/7*(-parseInt(n(1223,1218))/8)+-parseInt((l=984,r=854,ut(l-591,r)))/9+-parseInt(a(-425,-299))/10+-parseInt(o(-297,-251))/11*(-parseInt(n(1237,1261))/12))break;s.push(s.shift())}catch(t){s.push(s.shift())}var l,r,c,d}();const wt=new Array(32).fill(void 0);function vt(t){return wt[t]}wt.push(void 0,null,!0,!1);let bt=wt.length;function Dt(t){const e=vt(t);return function(t){t<36||(wt[t]=bt,bt=t)}(t),e}let yt=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});yt.decode();let xt=null;function Pt(){return null!==xt&&xt.buffer===pt.memory.buffer||(xt=new Uint8Array(pt.memory.buffer)),xt}function Ct(t,e){return yt.decode(Pt().subarray(t,t+e))}function Wt(t){bt===wt.length&&wt.push(wt.length+1);const e=bt;return bt=wt[e],wt[e]=t,e}let $t=0,It=new TextEncoder("utf-8");const Gt="function"==typeof It.encodeInto?function(t,e){return It.encodeInto(t,e)}:function(t,e){const a=It.encode(t);return e.set(a),{read:t.length,written:a.length}};function St(t,e,a){if(void 0===a){const a=It.encode(t),o=e(a.length);return Pt().subarray(o,o+a.length).set(a),$t=a.length,o}let o=t.length,i=e(o);const s=Pt();let n=0;for(;n<o;n++){const e=t.charCodeAt(n);if(e>127)break;s[i+n]=e}if(n!==o){0!==n&&(t=t.slice(n)),i=a(i,o,o=n+3*t.length);const e=Pt().subarray(i+n,i+o);n+=Gt(t,e).written}return $t=n,i}let Mt=null;function Lt(){return null!==Mt&&Mt.buffer===pt.memory.buffer||(Mt=new Int32Array(pt.memory.buffer)),Mt}async function kt(t){const e={wbg:{}};e.wbg.__wbindgen_object_drop_ref=function(t){Dt(t)},e.wbg.__wbindgen_string_new=function(t,e){return Wt(Ct(t,e))},e.wbg.__wbindgen_json_parse=function(t,e){return Wt(JSON.parse(Ct(t,e)))},e.wbg.__wbg_new_693216e109162396=function(){return Wt(new Error)},e.wbg.__wbg_stack_0ddaca5d1abfb52f=function(t,e){var a=St(vt(e).stack,pt.__wbindgen_malloc,pt.__wbindgen_realloc),o=$t;Lt()[t/4+1]=o,Lt()[t/4+0]=a},e.wbg.__wbg_error_09919627ac0992f5=function(t,e){try{console.error(Ct(t,e))}finally{pt.__wbindgen_free(t,e)}},e.wbg.__wbindgen_throw=function(t,e){throw new Error(Ct(t,e))},("string"==typeof t||"function"==typeof Request&&t instanceof Request||"function"==typeof URL&&t instanceof URL)&&(t=fetch(t));const{instance:a,module:o}=await async function(t,e){if("function"==typeof Response&&t instanceof Response){if("function"==typeof WebAssembly.instantiateStreaming)try{return await WebAssembly.instantiateStreaming(t,e)}catch(e){if("application/wasm"==t.headers.get("Content-Type"))throw e;console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",e)}const a=await t.arrayBuffer();return await WebAssembly.instantiate(a,e)}{const a=await WebAssembly.instantiate(t,e);return a instanceof WebAssembly.Instance?{instance:a,module:t}:a}}(await t,e);return pt=a.exports,kt.__wbindgen_wasm_module=o,pt}var zt=Object.freeze({__proto__:null,parse_license_key:function(t,e){var a=St(t,pt.__wbindgen_malloc,pt.__wbindgen_realloc),o=$t,i=St(e,pt.__wbindgen_malloc,pt.__wbindgen_realloc),s=$t;return Dt(pt.parse_license_key(a,o,i,s))},default:kt});
/**
 ...
 * @license   SEE LICENSE IN LICENSE FILE
 */
const Tt=async function(t={}){let{importHook:e,serverPath:a}=t,o=new URL("assets/43748c9e.wasm",import.meta.url).href;return null!=a&&(o=a+/[^\/\\]*$/.exec(o)[0]),null!=e&&(o=e(o)),await kt(o),zt};function Rt(t){const e=t.state,a=new S(e),o={treeMap:{},itemRowMap:{},list:{visibleRows:[],rowsIds:[],rows:{},visibleRowsHeight:0,rowsWithParentsExpanded:[],rowsHeight:0,width:0},dimensions:{width:0,height:0},chart:{items:{},grid:{cells:{},rows:{}},dimensions:{width:0,widthWithoutScrollBar:0,height:0,innerHeight:0,heightWithoutScrollBar:0},visibleItems:[],time:{zoom:0,format:{period:"day",periodIncrement:1,zoomTo:0,format:()=>""},level:0,levels:[],currentZoomLevelFormatting:[],allDates:[],timePerPixel:0,totalViewDurationMs:0,totalViewDurationPx:0,leftGlobal:0,rightGlobal:0,leftPx:0,rightPx:0,period:"day",leftGlobalDate:void 0,rightGlobalDate:void 0,centerGlobal:0,centerGlobalDate:void 0,from:0,to:0,fromDate:void 0,toDate:void 0,autoExpandTimeFromItems:!1,datesCache:{timePerPixel:0,levels:[]}}},scroll:{horizontal:{lastPageSize:0,lastPageCount:0,absoluteSize:0,absoluteSizeWithoutLastPage:0,handlePosPx:0,innerHandleSize:0,absolutePosPx:0,maxHandlePosPx:0,scrollSize:0,dataIndex:0,dataId:"",data:null,preciseOffset:0,visible:!1,percent:0},vertical:{lastPageSize:0,lastPageCount:0,absoluteSize:0,absoluteSizeWithoutLastPage:0,handlePosPx:0,innerHandleSize:0,absolutePosPx:0,maxHandlePosPx:0,scrollSize:0,dataIndex:0,dataId:"",data:null,preciseOffset:0,visible:!1,percent:0}},elements:{}};"boolean"==typeof t.debug&&t.debug&&(globalThis.state=e),e.update("",(t=>({config:t.config,$data:o})));const i=v(e,a),s=i.lithtml;a.setVido(i),a.setMergeDeep(d);const n=i.createApp({component:ft,props:{wasmInitialized:Tt},element:t.element});const l={state:e,api:n.vidoInstance.api,component:n,destroy:function(){n.destroy()},reload:function(){l.component.destroy(),l.component=i.createApp({component:ft,props:{wasmInitialized:Tt},element:t.element}),l.api=n.vidoInstance.api,l.component.update()},lithtml:s};return l}const Ot=document.createTextNode("");document.createTextNode=function(t){const e=Ot.cloneNode(!0);return e.textContent=t,e}.bind(document);const At=document.createElement("div"),Nt=document.createElement.bind(document);document.createElement=function(t,...e){if("div"!==t)return Nt(t,...e);return At.cloneNode(!0)}.bind(document),Rt.api=dt,Rt.lithtml=n;export{Rt as default};