 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */}}const $=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),D=` ${d} `,P=document.createElement("template");class _{constructor(t,e,n,i){this.strings=t,this.values=e,this.type=n,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let i=0;i<t;i++){const t=this.strings[i],o=t.lastIndexOf("\x3c!--");n=(o>-1||n)&&-1===t.indexOf("--\x3e",o+1);const s=b.exec(t);e+=null===s?t+(n?D:f):t.substr(0,s.index)+s[1]+s[2]+"$lit$"+s[3]+d}return e+=this.strings[t],e}getTemplateElement(){const t=P.cloneNode();let e=this.getHTML();return void 0!==$&&(e=$.createHTML(e)),t.innerHTML=e,t}}class M extends _{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,n=e.firstChild;return e.removeChild(n),l(e,n.firstChild),t
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */);class H{handleAttributeExpressions(t,e,n,i){const o=e[0];return"."===o?new A(t,e.slice(1),n).parts:"@"===o?[new N(t,e.slice(1),i.eventContext)]:"?"===o?[new R(t,e.slice(1),n)]:new C(t,e,n).parts}handleTextExpression(t){return new E(t)}}const G=new H;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const B=(t,...e)=>new _(t,e,"html",G),F=(t,...e)=>new M(t,e,"svg",G);var X=Object.freeze({__proto__:null,html:B,svg:F,DefaultTemplateProcessor:H,defaultTemplateProcessor:G,directive:o,Directive:s,isDirective:r,removeNodes:c,reparentNodes:l,noChange:u,nothing:h,AttributeCommitter:C,AttributePart:O,BooleanAttributePart:R,EventPart:N,isIterable:I,isPrimitive:S,NodePart:E,PropertyCommitter:A,PropertyPart:L,parts:W,render:j,templateCaches:V,templateFactory:Y,TemplateInstance:x,SVGTemplateResult:M,TemplateResult:_,createMarker:w,isTemplatePartActive:v,Template:m});
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
function Lt(t,e,n,i){return new(n||(n=Promise))((function(o,s){function r(t){try{l(i.next(t))}catch(t){s(t)}}function a(t){try{l(i.throw(t))}catch(t){s(t)}}function l(t){var e;t.done?o(t.value):(e=t.value,e instanceof n?e:new n((function(t){t(e)}))).then(r,a)}l((i=i.apply(t,e||[])).next())}))}At.prototype.lithtml=X,At.prototype.Action=Dt,At.prototype.Directive=s,At.prototype.schedule=It,At.prototype.Detach=xt,At.prototype.StyleMap=$t,At.prototype.PointerAction=St,At.prototype.asyncAppend=U,At.prototype.asyncReplace=K,At.prototype.cache=q,At.prototype.classMap=tt,At.prototype.guard=nt,At.prototype.live=yt,At.prototype.ifDefined=ot,At.prototype.repeat=dt,At.prototype.unsafeHTML=mt,At.prototype.until=vt,At.prototype.Slots=Rt;var kt=n((function(t,e){var n;t.exports=(n=n||function(t,e){var n=Object.create||function(){function t(){}return function(e){var n;return t.prototype=e,n=new t,t.prototype=null,n}}(),i={},o=i.lib={},s=o.Base={extend:function(t){var e=n(this);return t&&e.mixIn(t),e.hasOwnProperty("init")&&this.init!==e.init||(e.init=function(){e.$super.init.apply(this,arguments)}),e.init.prototype=e,e.$super=this,e},create:function(){var t=this.extend();return t.init.apply(t,arguments),t},init:function(){},mixIn:function(t){for(var e in t)t.hasOwnProperty(e)&&(this[e]=t[e]);t.hasOwnProperty("toString")&&(this.toString=t.toString)},clone:function(){return this.init.prototype.extend(this)}},r=o.WordArray=s.extend({init:function(t,n){t=this.words=t||[],this.sigBytes=n!=e?n:4*t.length},toString:function(t){return(t||l).stringify(this)},concat:function(t){var e=this.words,n=t.words,i=this.sigBytes,o=t.sigBytes;if(this.clamp(),i%4)for(var s=0;s<o;s++){var r=n[s>>>2]>>>24-s%4*8&255;e[i+s>>>2]|=r<<24-(i+s)%4*8}else for(s=0;s<o;s+=4)e[i+s>>>2]=n[s>>>2];return this.sigBytes+=o,this},clamp:function(){var e=this.words,n=this.sigBytes;e[n>>>2]&=4294967295<<32-n%4*8,e.length=t.ceil(n/4)},clone:function(){var t=s.clone.call(this);return t.words=this.words.slice(0),t},random:function(e){for(var n,i=[],o=function(e){e=e;var n=987654321,i=4294967295;return function(){var o=((n=36969*(65535&n)+(n>>16)&i)<<16)+(e=18e3*(65535&e)+(e>>16)&i)&i;return o/=4294967296,(o+=.5)*(t.random()>.5?1:-1)}},s=0;s<e;s+=4){var a=o(4294967296*(n||t.random()));n=987654071*a(),i.push(4294967296*a()|0)}return new r.init(i,e)}}),a=i.enc={},l=a.Hex={stringify:function(t){for(var e=t.words,n=t.sigBytes,i=[],o=0;o<n;o++){var s=e[o>>>2]>>>24-o%4*8&255;i.push((s>>>4).toString(16)),i.push((15&s).toString(16))}return i.join("")},parse:function(t){for(var e=t.length,n=[],i=0;i<e;i+=2)n[i>>>3]|=parseInt(t.substr(i,2),16)<<24-i%8*4;return new r.init(n,e/2)}},c=a.Latin1={stringify:function(t){for(var e=t.words,n=t.sigBytes,i=[],o=0;o<n;o++){var s=e[o>>>2]>>>24-o%4*8&255;i.push(String.fromCharCode(s))}return i.join("")},parse:function(t){for(var e=t.length,n=[],i=0;i<e;i++)n[i>>>2]|=(255&t.charCodeAt(i))<<24-i%4*8;return new r.init(n,e)}},u=a.Utf8={stringify:function(t){try{return decodeURIComponent(escape(c.stringify(t)))}catch(t){throw new Error("Malformed UTF-8 data")}},parse:function(t){return c.parse(unescape(encodeURIComponent(t)))}},h=o.BufferedBlockAlgorithm=s.extend({reset:function(){this._data=new r.init,this._nDataBytes=0},_append:function(t){"string"==typeof t&&(t=u.parse(t)),this._data.concat(t),this._nDataBytes+=t.sigBytes},_process:function(e){var n=this._data,i=n.words,o=n.sigBytes,s=this.blockSize,a=o/(4*s),l=(a=e?t.ceil(a):t.max((0|a)-this._minBufferSize,0))*s,c=t.min(4*l,o);if(l){for(var u=0;u<l;u+=s)this._doProcessBlock(i,u);var h=i.splice(0,l);n.sigBytes-=c}return new r.init(h,c)},clone:function(){var t=s.clone.call(this);return t._data=this._data.clone(),t},_minBufferSize:0}),d=(o.Hasher=h.extend({cfg:s.extend(),init:function(t){this.cfg=this.cfg.extend(t),this.reset()},reset:function(){h.reset.call(this),this._doReset()},update:function(t){return this._append(t),this._process(),this},finalize:function(t){return t&&this._append(t),this._doFinalize()},blockSize:16,_createHelper:function(t){return function(e,n){return new t.init(n).finalize(e)}},_createHmacHelper:function(t){return function(e,n){return new d.HMAC.init(t,n).finalize(e)}}}),i.algo={});return i}(Math),n)})),pbkdf2=(n((function(t,e){var n;t.exports=(n=kt,function(){var t=n,e=t.lib,i=e.WordArray,o=e.Hasher,s=t.algo,r=[],a=s.SHA1=o.extend({_doReset:function(){this._hash=new i.init([1732584193,4023233417,2562383102,271733878,3285377520])},_doProcessBlock:function(t,e){for(var n=this._hash.words,i=n[0],o=n[1],s=n[2],a=n[3],l=n[4],c=0;c<80;c++){if(c<16)r[c]=0|t[e+c];else{var u=r[c-3]^r[c-8]^r[c-14]^r[c-16];r[c]=u<<1|u>>>31}var h=(i<<5|i>>>27)+l+r[c];h+=c<20?1518500249+(o&s|~o&a):c<40?1859775393+(o^s^a):c<60?(o&s|o&a|s&a)-1894007588:(o^s^a)-899497514,l=a,a=s,s=o<<30|o>>>2,o=i,i=h}n[0]=n[0]+i|0,n[1]=n[1]+o|0,n[2]=n[2]+s|0,n[3]=n[3]+a|0,n[4]=n[4]+l|0},_doFinalize:function(){var t=this._data,e=t.words,n=8*this._nDataBytes,i=8*t.sigBytes;return e[i>>>5]|=128<<24-i%32,e[14+(i+64>>>9<<4)]=Math.floor(n/4294967296),e[15+(i+64>>>9<<4)]=n,t.sigBytes=4*e.length,this._process(),this._hash},clone:function(){var t=o.clone.call(this);return t._hash=this._hash.clone(),t}});t.SHA1=o._createHelper(a),t.HmacSHA1=o._createHmacHelper(a)}(),n.SHA1)})),n((function(t,e){var n;t.exports=(n=kt,void function(){var t=n,e=t.lib.Base,i=t.enc.Utf8;t.algo.HMAC=e.extend({init:function(t,e){t=this._hasher=new t.init,"string"==typeof e&&(e=i.parse(e));var n=t.blockSize,o=4*n;e.sigBytes>o&&(e=t.finalize(e)),e.clamp();for(var s=this._oKey=e.clone(),r=this._iKey=e.clone(),a=s.words,l=r.words,c=0;c<n;c++)a[c]^=1549556828,l[c]^=909522486;s.sigBytes=r.sigBytes=o,this.reset()},reset:function(){var t=this._hasher;t.reset(),t.update(this._iKey)},update:function(t){return this._hasher.update(t),this},finalize:function(t){var e=this._hasher,n=e.finalize(t);return e.reset(),e.finalize(this._oKey.clone().concat(n))}})}())})),n((function(t,e){var n;t.exports=(n=kt,function(){var t=n,e=t.lib,i=e.Base,o=e.WordArray,s=t.algo,r=s.SHA1,a=s.HMAC,l=s.PBKDF2=i.extend({cfg:i.extend({keySize:4,hasher:r,iterations:1}),init:function(t){this.cfg=this.cfg.extend(t)},compute:function(t,e){for(var n=this.cfg,i=a.create(n.hasher,t),s=o.create(),r=o.create([1]),l=s.words,c=r.words,u=n.keySize,h=n.iterations;l.length<u;){var d=i.update(e).finalize(r);i.reset();for(var f=d.words,p=f.length,m=d,g=1;g<h;g++){m=i.finalize(m),i.reset();for(var v=m.words,y=0;y<p;y++)f[y]^=v[y]}s.concat(d),c[0]++}return s.sigBytes=4*u,s}});t.PBKDF2=function(t,e,n){return l.create(n).compute(t,e)}}(),n.PBKDF2)}))),aes=(n((function(t,e){var n;t.exports=(n=kt,function(){var t=n,e=t.lib.WordArray;function i(t,n,i){for(var o=[],s=0,r=0;r<n;r++)if(r%4){var a=i[t.charCodeAt(r-1)]<<r%4*2,l=i[t.charCodeAt(r)]>>>6-r%4*2;o[s>>>2]|=(a|l)<<24-s%4*8,s++}return e.create(o,s)}t.enc.Base64={stringify:function(t){var e=t.words,n=t.sigBytes,i=this._map;t.clamp();for(var o=[],s=0;s<n;s+=3)for(var r=(e[s>>>2]>>>24-s%4*8&255)<<16|(e[s+1>>>2]>>>24-(s+1)%4*8&255)<<8|e[s+2>>>2]>>>24-(s+2)%4*8&255,a=0;a<4&&s+.75*a<n;a++)o.push(i.charAt(r>>>6*(3-a)&63));var l=i.charAt(64);if(l)for(;o.length%4;)o.push(l);return o.join("")},parse:function(t){var e=t.length,n=this._map,o=this._reverseMap;if(!o){o=this._reverseMap=[];for(var s=0;s<n.length;s++)o[n.charCodeAt(s)]=s}var r=n.charAt(64);if(r){var a=t.indexOf(r);-1!==a&&(e=a)}return i(t,e,o)},_map:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="}}(),n.enc.Base64)})),n((function(t,e){var n;t.exports=(n=kt,function(t){var e=n,i=e.lib,o=i.WordArray,s=i.Hasher,r=e.algo,a=[];!function(){for(var e=0;e<64;e++)a[e]=4294967296*t.abs(t.sin(e+1))|0}();var l=r.MD5=s.extend({_doReset:function(){this._hash=new o.init([1732584193,4023233417,2562383102,271733878])},_doProcessBlock:function(t,e){for(var n=0;n<16;n++){var i=e+n,o=t[i];t[i]=16711935&(o<<8|o>>>24)|4278255360&(o<<24|o>>>8)}var s=this._hash.words,r=t[e+0],l=t[e+1],f=t[e+2],p=t[e+3],m=t[e+4],g=t[e+5],v=t[e+6],y=t[e+7],w=t[e+8],b=t[e+9],x=t[e+10],$=t[e+11],D=t[e+12],P=t[e+13],_=t[e+14],M=t[e+15],S=s[0],I=s[1],T=s[2],C=s[3];S=c(S,I,T,C,r,7,a[0]),C=c(C,S,I,T,l,12,a[1]),T=c(T,C,S,I,f,17,a[2]),I=c(I,T,C,S,p,22,a[3]),S=c(S,I,T,C,m,7,a[4]),C=c(C,S,I,T,g,12,a[5]),T=c(T,C,S,I,v,17,a[6]),I=c(I,T,C,S,y,22,a[7]),S=c(S,I,T,C,w,7,a[8]),C=c(C,S,I,T,b,12,a[9]),T=c(T,C,S,I,x,17,a[10]),I=c(I,T,C,S,$,22,a[11]),S=c(S,I,T,C,D,7,a[12]),C=c(C,S,I,T,P,12,a[13]),T=c(T,C,S,I,_,17,a[14]),S=u(S,I=c(I,T,C,S,M,22,a[15]),T,C,l,5,a[16]),C=u(C,S,I,T,v,9,a[17]),T=u(T,C,S,I,$,14,a[18]),I=u(I,T,C,S,r,20,a[19]),S=u(S,I,T,C,g,5,a[20]),C=u(C,S,I,T,x,9,a[21]),T=u(T,C,S,I,M,14,a[22]),I=u(I,T,C,S,m,20,a[23]),S=u(S,I,T,C,b,5,a[24]),C=u(C,S,I,T,_,9,a[25]),T=u(T,C,S,I,p,14,a[26]),I=u(I,T,C,S,w,20,a[27]),S=u(S,I,T,C,P,5,a[28]),C=u(C,S,I,T,f,9,a[29]),T=u(T,C,S,I,y,14,a[30]),S=h(S,I=u(I,T,C,S,D,20,a[31]),T,C,g,4,a[32]),C=h(C,S,I,T,w,11,a[33]),T=h(T,C,S,I,$,16,a[34]),I=h(I,T,C,S,_,23,a[35]),S=h(S,I,T,C,l,4,a[36]),C=h(C,S,I,T,m,11,a[37]),T=h(T,C,S,I,y,16,a[38]),I=h(I,T,C,S,x,23,a[39]),S=h(S,I,T,C,P,4,a[40]),C=h(C,S,I,T,r,11,a[41]),T=h(T,C,S,I,p,16,a[42]),I=h(I,T,C,S,v,23,a[43]),S=h(S,I,T,C,b,4,a[44]),C=h(C,S,I,T,D,11,a[45]),T=h(T,C,S,I,M,16,a[46]),S=d(S,I=h(I,T,C,S,f,23,a[47]),T,C,r,6,a[48]),C=d(C,S,I,T,y,10,a[49]),T=d(T,C,S,I,_,15,a[50]),I=d(I,T,C,S,g,21,a[51]),S=d(S,I,T,C,D,6,a[52]),C=d(C,S,I,T,p,10,a[53]),T=d(T,C,S,I,x,15,a[54]),I=d(I,T,C,S,l,21,a[55]),S=d(S,I,T,C,w,6,a[56]),C=d(C,S,I,T,M,10,a[57]),T=d(T,C,S,I,v,15,a[58]),I=d(I,T,C,S,P,21,a[59]),S=d(S,I,T,C,m,6,a[60]),C=d(C,S,I,T,$,10,a[61]),T=d(T,C,S,I,f,15,a[62]),I=d(I,T,C,S,b,21,a[63]),s[0]=s[0]+S|0,s[1]=s[1]+I|0,s[2]=s[2]+T|0,s[3]=s[3]+C|0},_doFinalize:function(){var e=this._data,n=e.words,i=8*this._nDataBytes,o=8*e.sigBytes;n[o>>>5]|=128<<24-o%32;var s=t.floor(i/4294967296),r=i;n[15+(o+64>>>9<<4)]=16711935&(s<<8|s>>>24)|4278255360&(s<<24|s>>>8),n[14+(o+64>>>9<<4)]=16711935&(r<<8|r>>>24)|4278255360&(r<<24|r>>>8),e.sigBytes=4*(n.length+1),this._process();for(var a=this._hash,l=a.words,c=0;c<4;c++){var u=l[c];l[c]=16711935&(u<<8|u>>>24)|4278255360&(u<<24|u>>>8)}return a},clone:function(){var t=s.clone.call(this);return t._hash=this._hash.clone(),t}});function c(t,e,n,i,o,s,r){var a=t+(e&n|~e&i)+o+r;return(a<<s|a>>>32-s)+e}function u(t,e,n,i,o,s,r){var a=t+(e&i|n&~i)+o+r;return(a<<s|a>>>32-s)+e}function h(t,e,n,i,o,s,r){var a=t+(e^n^i)+o+r;return(a<<s|a>>>32-s)+e}function d(t,e,n,i,o,s,r){var a=t+(n^(e|~i))+o+r;return(a<<s|a>>>32-s)+e}e.MD5=s._createHelper(l),e.HmacMD5=s._createHmacHelper(l)}(Math),n.MD5)})),n((function(t,e){var n;t.exports=(n=kt,function(){var t=n,e=t.lib,i=e.Base,o=e.WordArray,s=t.algo,r=s.MD5,a=s.EvpKDF=i.extend({cfg:i.extend({keySize:4,hasher:r,iterations:1}),init:function(t){this.cfg=this.cfg.extend(t)},compute:function(t,e){for(var n=this.cfg,i=n.hasher.create(),s=o.create(),r=s.words,a=n.keySize,l=n.iterations;r.length<a;){c&&i.update(c);var c=i.update(t).finalize(e);i.reset();for(var u=1;u<l;u++)c=i.finalize(c),i.reset();s.concat(c)}return s.sigBytes=4*a,s}});t.EvpKDF=function(t,e,n){return a.create(n).compute(t,e)}}(),n.EvpKDF)})),n((function(t,e){var n;t.exports=void((n=kt).lib.Cipher||function(t){var e=n,i=e.lib,o=i.Base,s=i.WordArray,r=i.BufferedBlockAlgorithm,a=e.enc,l=(a.Utf8,a.Base64),c=e.algo.EvpKDF,u=i.Cipher=r.extend({cfg:o.extend(),createEncryptor:function(t,e){return this.create(this._ENC_XFORM_MODE,t,e)},createDecryptor:function(t,e){return this.create(this._DEC_XFORM_MODE,t,e)},init:function(t,e,n){this.cfg=this.cfg.extend(n),this._xformMode=t,this._key=e,this.reset()},reset:function(){r.reset.call(this),this._doReset()},process:function(t){return this._append(t),this._process()},finalize:function(t){return t&&this._append(t),this._doFinalize()},keySize:4,ivSize:4,_ENC_XFORM_MODE:1,_DEC_XFORM_MODE:2,_createHelper:function(){function t(t){return"string"==typeof t?w:v}return function(e){return{encrypt:function(n,i,o){return t(i).encrypt(e,n,i,o)},decrypt:function(n,i,o){return t(i).decrypt(e,n,i,o)}}}}()}),h=(i.StreamCipher=u.extend({_doFinalize:function(){return this._process(!0)},blockSize:1}),e.mode={}),d=i.BlockCipherMode=o.extend({createEncryptor:function(t,e){return this.Encryptor.create(t,e)},createDecryptor:function(t,e){return this.Decryptor.create(t,e)},init:function(t,e){this._cipher=t,this._iv=e}}),f=h.CBC=function(){var e=d.extend();function n(e,n,i){var o=this._iv;if(o){var s=o;this._iv=t}else s=this._prevBlock;for(var r=0;r<i;r++)e[n+r]^=s[r]}return e.Encryptor=e.extend({processBlock:function(t,e){var i=this._cipher,o=i.blockSize;n.call(this,t,e,o),i.encryptBlock(t,e),this._prevBlock=t.slice(e,e+o)}}),e.Decryptor=e.extend({processBlock:function(t,e){var i=this._cipher,o=i.blockSize,s=t.slice(e,e+o);i.decryptBlock(t,e),n.call(this,t,e,o),this._prevBlock=s}}),e}(),p=(e.pad={}).Pkcs7={pad:function(t,e){for(var n=4*e,i=n-t.sigBytes%n,o=i<<24|i<<16|i<<8|i,r=[],a=0;a<i;a+=4)r.push(o);var l=s.create(r,i);t.concat(l)},unpad:function(t){var e=255&t.words[t.sigBytes-1>>>2];t.sigBytes-=e}},m=(i.BlockCipher=u.extend({cfg:u.cfg.extend({mode:f,padding:p}),reset:function(){u.reset.call(this);var t=this.cfg,e=t.iv,n=t.mode;if(this._xformMode==this._ENC_XFORM_MODE)var i=n.createEncryptor;else i=n.createDecryptor,this._minBufferSize=1;this._mode&&this._mode.__creator==i?this._mode.init(this,e&&e.words):(this._mode=i.call(n,this,e&&e.words),this._mode.__creator=i)},_doProcessBlock:function(t,e){this._mode.processBlock(t,e)},_doFinalize:function(){var t=this.cfg.padding;if(this._xformMode==this._ENC_XFORM_MODE){t.pad(this._data,this.blockSize);var e=this._process(!0)}else e=this._process(!0),t.unpad(e);return e},blockSize:4}),i.CipherParams=o.extend({init:function(t){this.mixIn(t)},toString:function(t){return(t||this.formatter).stringify(this)}})),g=(e.format={}).OpenSSL={stringify:function(t){var e=t.ciphertext,n=t.salt;if(n)var i=s.create([1398893684,1701076831]).concat(n).concat(e);else i=e;return i.toString(l)},parse:function(t){var e=l.parse(t),n=e.words;if(1398893684==n[0]&&1701076831==n[1]){var i=s.create(n.slice(2,4));n.splice(0,4),e.sigBytes-=16}return m.create({ciphertext:e,salt:i})}},v=i.SerializableCipher=o.extend({cfg:o.extend({format:g}),encrypt:function(t,e,n,i){i=this.cfg.extend(i);var o=t.createEncryptor(n,i),s=o.finalize(e),r=o.cfg;return m.create({ciphertext:s,key:n,iv:r.iv,algorithm:t,mode:r.mode,padding:r.padding,blockSize:t.blockSize,formatter:i.format})},decrypt:function(t,e,n,i){return i=this.cfg.extend(i),e=this._parse(e,i.format),t.createDecryptor(n,i).finalize(e.ciphertext)},_parse:function(t,e){return"string"==typeof t?e.parse(t,this):t}}),y=(e.kdf={}).OpenSSL={execute:function(t,e,n,i){i||(i=s.random(8));var o=c.create({keySize:e+n}).compute(t,i),r=s.create(o.words.slice(e),4*n);return o.sigBytes=4*e,m.create({key:o,iv:r,salt:i})}},w=i.PasswordBasedCipher=v.extend({cfg:v.cfg.extend({kdf:y}),encrypt:function(t,e,n,i){var o=(i=this.cfg.extend(i)).kdf.execute(n,t.keySize,t.ivSize);i.iv=o.iv;var s=v.encrypt.call(this,t,e,o.key,i);return s.mixIn(o),s},decrypt:function(t,e,n,i){i=this.cfg.extend(i),e=this._parse(e,i.format);var o=i.kdf.execute(n,t.keySize,t.ivSize,e.salt);return i.iv=o.iv,v.decrypt.call(this,t,e,o.key,i)}})}())})),n((function(t,e){var n;t.exports=(n=kt,function(){var t=n,e=t.lib.BlockCipher,i=t.algo,o=[],s=[],r=[],a=[],l=[],c=[],u=[],h=[],d=[],f=[];!function(){for(var t=[],e=0;e<256;e++)t[e]=e<128?e<<1:e<<1^283;var n=0,i=0;for(e=0;e<256;e++){var p=i^i<<1^i<<2^i<<3^i<<4;p=p>>>8^255&p^99,o[n]=p,s[p]=n;var m=t[n],g=t[m],v=t[g],y=257*t[p]^16843008*p;r[n]=y<<24|y>>>8,a[n]=y<<16|y>>>16,l[n]=y<<8|y>>>24,c[n]=y,y=16843009*v^65537*g^257*m^16843008*n,u[p]=y<<24|y>>>8,h[p]=y<<16|y>>>16,d[p]=y<<8|y>>>24,f[p]=y,n?(n=m^t[t[t[v^m]]],i^=t[t[i]]):n=i=1}}();var p=[0,1,2,4,8,16,32,64,128,27,54],m=i.AES=e.extend({_doReset:function(){if(!this._nRounds||this._keyPriorReset!==this._key){for(var t=this._keyPriorReset=this._key,e=t.words,n=t.sigBytes/4,i=4*((this._nRounds=n+6)+1),s=this._keySchedule=[],r=0;r<i;r++)if(r<n)s[r]=e[r];else{var a=s[r-1];r%n?n>6&&r%n==4&&(a=o[a>>>24]<<24|o[a>>>16&255]<<16|o[a>>>8&255]<<8|o[255&a]):(a=o[(a=a<<8|a>>>24)>>>24]<<24|o[a>>>16&255]<<16|o[a>>>8&255]<<8|o[255&a],a^=p[r/n|0]<<24),s[r]=s[r-n]^a}for(var l=this._invKeySchedule=[],c=0;c<i;c++)r=i-c,a=c%4?s[r]:s[r-4],l[c]=c<4||r<=4?a:u[o[a>>>24]]^h[o[a>>>16&255]]^d[o[a>>>8&255]]^f[o[255&a]]}},encryptBlock:function(t,e){this._doCryptBlock(t,e,this._keySchedule,r,a,l,c,o)},decryptBlock:function(t,e){var n=t[e+1];t[e+1]=t[e+3],t[e+3]=n,this._doCryptBlock(t,e,this._invKeySchedule,u,h,d,f,s),n=t[e+1],t[e+1]=t[e+3],t[e+3]=n},_doCryptBlock:function(t,e,n,i,o,s,r,a){for(var l=this._nRounds,c=t[e]^n[0],u=t[e+1]^n[1],h=t[e+2]^n[2],d=t[e+3]^n[3],f=4,p=1;p<l;p++){var m=i[c>>>24]^o[u>>>16&255]^s[h>>>8&255]^r[255&d]^n[f++],g=i[u>>>24]^o[h>>>16&255]^s[d>>>8&255]^r[255&c]^n[f++],v=i[h>>>24]^o[d>>>16&255]^s[c>>>8&255]^r[255&u]^n[f++],y=i[d>>>24]^o[c>>>16&255]^s[u>>>8&255]^r[255&h]^n[f++];c=m,u=g,h=v,d=y}m=(a[c>>>24]<<24|a[u>>>16&255]<<16|a[h>>>8&255]<<8|a[255&d])^n[f++],g=(a[u>>>24]<<24|a[h>>>16&255]<<16|a[d>>>8&255]<<8|a[255&c])^n[f++],v=(a[h>>>24]<<24|a[d>>>16&255]<<16|a[c>>>8&255]<<8|a[255&u])^n[f++],y=(a[d>>>24]<<24|a[c>>>16&255]<<16|a[u>>>8&255]<<8|a[255&h])^n[f++],t[e]=m,t[e+1]=g,t[e+2]=v,t[e+3]=y},keySize:8});t.AES=e._createHelper(m)}(),n.AES)})));function Nt(t,e={}){const{api:n,state:i,onDestroy:o,Actions:s,update:r,createComponent:a,html:l,StyleMap:c}=t,u=n.name;let c_c_c,h,d;o(i.subscribe("config.debug",t=>h=t)),function(){const e=[];function n(){e.forEach(t=>t()),e.length=0}o(i.subscribe("config.plugins",i=>{if(h&&console.log("Plugins changed. Destroying plugins..."),n(),h&&console.log("Plugins destroyed. Initializing plugins..."),void 0!==i&&Array.isArray(i))for(const n of i){const i=n(t);"function"==typeof i?e.push(i):i&&Object.prototype.hasOwnProperty.call(i,"destroy")&&e.push(i.destroy)}h&&console.log("Plugins intialized.")})),o(n)}(),o(i.subscribe("config.actions.main",t=>d=t));const f=new c({});let p=!1,m=-1,g=n.getClass(u);function v(t=!0){t=t&&!n.isMutedMethod("fullReload");let e=i.get("$data.list.rowsIds");e=e.slice();const o=i.get("config.list.rows");if(e&&e.length){if(e.sort(),!o)return;const n=Object.keys(o);n.sort(),n.join(",")!==e.join(",")&&(t=!0)}if(h&&console.log("Generating tree.",{fullReload:t}),!t)return function(){if(n.isMutedMethod("generateTreeFromVisibleRows"))return;const t=n.getVisibleRowsId(),e=n.getAllRows(),o=n.getRowsData(),s={},a={},l=i.get("config.chart.items"),c={};for(const n of t){const t=e[n],i=o[n];a[n]=i,s[n]=t;for(const t of i.children){s[t]=e[t];for(const e of o[t].items)c[e]=l[e]}for(const t of i.items)c[t]=l[t]}n.makeTreeMap(a,c,!0),r()}();n.fillEmptyRowValues(o);const s=n.sortRows(Object.values(o)),a=n.getRowsData(),l=i.get("config.chart.items");n.prepareItems(l),n.makeTreeMap(a,l),i.update("$data.list.rowsIds",Object.keys(s)),r()}function y(){if(n.isMutedMethod("calculateVerticalScrollArea"))return;const t=i.get("$data.list.rowsWithParentsExpanded"),e=i.get("$data.list.rowsHeight");if(e===m)return;m=e;const o=i.get("$data.innerHeight"),s=function(t,e){if(n.isMutedMethod("getLastPageRowsHeight"))return;if(0===e.length)return 0;let o=0,s=0;const r=n.getAllRows(),a=n.getRowsData();for(let n=e.length-1;n>=0;n--){const i=a[e[n]];if(o+=i.outerHeight,o>=t){o-=i.outerHeight;break}s++}return h&&console.log("Last page height.",{lastPageCount:s,lastPageSize:o,rows:r}),i.multi().update("config.scroll.vertical.lastPageSize",o,{force:!0}).update("config.scroll.vertical.lastPageCount",s,{force:!0}).done(),o}(o,t);h&&console.log("Calculate height related things.",{rowsWithParentsExpanded:t,lastRowsHeight:m,innerHeight:o}),i.multi().update("config.scroll.vertical.area",e,{force:!0}).update("config.scroll.vertical.areaWithoutLastPage",e-s,{force:!0}).done()}o(i.subscribeAll(["config.innerHeight","config.headerHeight","config.scroll.horizontal.size"],(function(){if(n.isMutedMethod("heightChange"))return;h&&console.log("Height change.",["config.innerHeight","config.headerHeight","config.scroll.horizontal.size"]);const t=i.get("config"),e=i.get("config.scroll.horizontal.size"),o=t.innerHeight-e;i.multi().update("$data.innerHeight",o).update("$data.height",t.innerHeight+t.headerHeight).done(),f.style["--height"]=o+"px",r()}))),o(i.subscribe("$data.list.columns.resizer.active",(function(t){p=t,g=n.getClass(n.name),p&&(g+=` ${n.name}__list-column-header-resizer--active`),r()})));const ctm=l`
  ...
  `;function w(t){n.isMutedMethod("minimalReload")||(h&&console.log("Minimal reload fired.",{eventInfo:t}),i.mute(D),i.mute(P),i.mute(_),i.mute(M),i.mute(S),function(){if(n.isMutedMethod("generateVisibleRowsAndItems"))return;const t=n.getVisibleRowsAndCalculateViewTop(),e=i.get("$data.list.visibleRows")||[];let o=!0;t.length!==e.length?o=!0:t.length&&(o=t.join("|")!==e.join("|")),h&&console.log("Generating visible rows and items #1.",{visibleRowsId:t,shouldUpdateRows:o}),o&&(h&&console.log("Saving visible rows and items #2.",{visibleRowsId:t,shouldUpdateRows:o}),i.update("$data.list.visibleRows",t));const s=[],a=n.getRowsData();for(const e of t){const t=a[e];for(const e of t.items)s.push(e)}const l=i.get("$data.chart.visibleItems")||[];h&&console.log("Generating visible rows and items #3.",{visibleItemsId:s,visibleRowsId:t,shouldUpdateRows:o,rowsData:a}),s.join("|")!==l.join("|")&&(h&&console.log("Generate visible rows and items #4.",{visibleItemsId:s,currentVisibleItems:l}),i.update("$data.chart.visibleItems",s)),r()}(),function(){if(n.isMutedMethod("calculateRowsHeight"))return;const t=i.get("$data.list.rowsWithParentsExpanded"),e=n.recalculateRowsHeights(t);i.update("$data.list.rowsHeight",e),h&&console.log("calculateRowsHeight.",{rowsHeight:e})}(),y(),function(){if(n.isMutedMethod("recalculateRowPercents"))return;const t=i.get("$data.list.rowsWithParentsExpanded");n.recalculateRowsPercents(t,i.get("config.scroll.vertical.area"))}(),n.calculateVisibleRowsHeights(),function(){const t=n.getAllItems(),e=n.getItemsData(),i=n.getRowsData();for(const o in t){const s=t[o];n.calculateItemVerticalPosition(o,e[o],i[s.rowId])}}(),H().done(),i.unmute(D),i.unmute(P),i.unmute(_),i.unmute(M),i.unmute(S),r())}function b(t=!0,e){n.isMutedMethod("partialReload")||(h&&console.log("Partial reload fired.",{fullReload:t}),i.mute(D),i.mute(P),i.mute(_),i.mute(M),i.mute(S),v(t),function(){if(n.isMutedMethod("prepareExpanded"))return;const t=n.getAllRows();if(!t)return;const e=n.getRowsWithParentsExpanded(t);i.update("$data.list.rowsWithParentsExpanded",e)}(),w(e),i.unmute(D),i.unmute(P),i.unmute(_),i.unmute(M),i.unmute(S),r())}function x(){Promise.resolve().then(()=>{const t=i.get("$data.elements.main");if(!t)return;const e=t.parentNode;if(!e)return;const n=new Event("gstc-loaded");t.dispatchEvent(n),e.dispatchEvent(n)})}function $(t){n.isMutedMethod("fullReload")||(h&&console.log("Full reload fired.",{}),i.mute(D),i.mute(P),i.mute(_),i.mute(M),i.mute(S),b(!0,t),Y({name:"reload"}),i.update("config.scroll",t=>(t.horizontal.dataIndex=0,t.horizontal.data=null,t.horizontal.posPx=0,t.vertical.dataIndex=0,t.vertical.data=Object.values(i.get("config.list.rows"))[0],t.vertical.posPx=0,t)),i.unmute(D),i.unmute(P),i.unmute(_),i.unmute(M),i.unmute(S),r())}function D(t,e){$(e),setTimeout(x,0)}function P(t,e){"subscribe"!==e.type&&$(e)}function _(t,e){"subscribe"!==e.type&&(h&&console.log("partial full cause",e),b(!0,e))}function M(t,e){"subscribe"!==e.type&&(h&&console.log("partial not full cause",e),b(!1,e))}function S(t,e){"subscribe"!==e.type&&function(t=null,e){e&&"subscribe"===e.type||e&&e.options.data&&"updateVisibleItems"===e.options.data||w(e)}(t,e)}o(i.subscribe("config;",D)),o(i.subscribeAll(["config.chart.items;","config.list.rows;"],P)),o(i.subscribeAll(["config.list.rows.*;","config.list.rows.*.parentId"],_,{bulk:!0})),o(i.subscribe("config.chart.items.*;",_)),o(i.subscribeAll(["config.chart.items.*.rowId","config.list.rows.*.expanded"],M,{bulk:!0})),o(i.subscribeAll(["config.chart.items.*.time","config.chart.items.*.height","config.chart.items.*.top","$data.list.rows.*.outerHeight","config.scroll.vertical.offset","$data.innerHeight","$data.list.rowsHeight"],S,{bulk:!0}));const I=[];let T,C;I.push(i.subscribe("config.components.List",t=>T=t)),I.push(i.subscribe("config.components.Chart",t=>C=t));const O=a(T);o(()=>{O&&O.destroy()});const E=a(C);function R(e,i,o,s){const r=e.period,a=i.from,l=n.time.date(a).startOf(r),c=n.time.date(i.to).endOf(r),u=n.time.generatePeriodDates({leftDate:l,rightDate:c,level:o,levelIndex:s,period:r,time:i,callOnDate:!1,callOnLevelDates:!0}),h=n.getClass("chart-calendar-date");for(const n of u)n.formatted=e.format({timeStart:n.leftGlobalDate,timeEnd:n.rightGlobalDate,vido:t,className:h,props:{date:n}});return u}function A(t,e){const n=function(t,e){if(0===e.length)return 0;let n=0,o=0;if(e.length&&Math.ceil(e[e.length-1].rightPx)>t)for(let i=e.length-1;i>=0;i--){const s=e[i];if(n+=s.width,n>=t){n-=s.width;break}o++}return i.update("config.scroll.horizontal",t=>(t.lastPageSize=n,t.lastPageCount=o,t)),n}(e,t);let o=0;for(const e of t)o+=e.width;const s=o-n;for(const e of t)e.leftPercent=e.leftPx/s,e.rightPercent=e.rightPx/s;return s}function L(t,e,n){if(!t.zoom)return 0;t.allDates=new Array(e.length);const{format:o,levelIndex:s}=function(t,e=i.get("config.chart.calendarLevels")){let n=0,o=0;for(const i of e){for(const e of i)if(e.main&&t<=e.zoomTo)return o=n,{levelIndex:o,format:e};n++}if(!o)throw new Error(`There is no main date format for zoom ${t}.`)}(t.zoom,e);t.level=s,t.allDates[t.level]=R(o,t,e[s],t.level);let r=0;for(const n of e){const e=n.find(e=>+t.zoom<=+e.zoomTo);r!==t.level&&(t.allDates[r]=R(e,t,n,r)),r++}return A(t.allDates[t.level],n)}function k(t,e){if(!t.length)return[];const i=t.filter(t=>t.leftGlobal>=e.leftGlobal&&t.leftGlobal<=e.rightGlobal||t.rightGlobal>=e.leftGlobal&&t.rightGlobal<=e.rightGlobal||t.leftGlobal<=e.leftGlobal&&t.rightGlobal>=e.rightGlobal||t.leftGlobal>=e.leftGlobal&&t.rightGlobal<=e.rightGlobal);if(!i.length)return[];let o=0;i[0].period!==e.period&&e.leftGlobal>i[0].leftGlobal&&(o=n.time.getDatesDiffPx(e.leftGlobalDate,i[0].leftGlobalDate,e,!1));let s=0;const r=i.length-1;return i.map((t,n)=>(t.currentView={leftPx:s,rightPx:t.rightPx,width:t.width},o<0&&(t.currentView.width=t.width+o,t.currentView.leftPx=0,o=0),t.currentView.rightPx=t.currentView.leftPx+t.currentView.width,s+=t.currentView.width,n===r&&t.currentView.rightPx>e.width&&(t.currentView.rightPx=e.width,t.currentView.width=t.currentView.rightPx-t.currentView.leftPx),t))}function N(t){let e=0,n=0;for(const i of t.allDates[t.level])e+=i.width,n+=i.rightGlobal-i.leftGlobal;t.totalViewDurationPx=e,t.totalViewDurationMs=n}function z(t,e,i){const o=n.time.findDateAtTime(t,i);if(!o)return t;let s=i.indexOf(o),r=o.leftGlobal,a=0;for(let t=i.length;s<t;s++){const t=i[s];if(r=t.leftGlobal,a+=t.width,a>=e)break}return r}function H(t=i.get("$data.chart.time"),e=i.multi()){h&&console.log("Updating visible items.",{});const o=i.get("$data.chart.visibleItems"),s=n.getItems(o);if(!s)return e;const r=n.getAllRows(),a=n.getRowsData(),l=n.getItemsData();if(!r)return e;if(!t.levels||!t.levels[t.level])return e;const c=i.get("config.chart.spacing");for(const i of s){if(!i)return e;const o=r[i.rowId],s=a[i.rowId];o&&s&&n.calculateItemPosition(i.id,l[i.id],s,t,c)}return e=e.update("$data.chart.items",t=>t),h&&console.log("Visible items updated.",{visibleItemsId:o,visibleItems:s}),e}function G(){H().done()}function Y(t){if(n.isMutedMethod("recalculateTimes"))return;h&&console.log("Recalculating times.",{reason:t});const e=i.get("$data.chart.dimensions.width");if(!e)return;const o=i.get("config.chart.time"),s=i.get("config.chart.calendarLevels"),a=Object.assign({},i.get("$data.chart.time"));let l=n.mergeDeep({},o);if(!(l.from&&l.to||Object.keys(i.get("config.chart.items")).length))return;l.fromDate=n.time.date(l.from),l.toDate=n.time.date(l.to);const c=i.get("config.scroll.horizontal");let u=0;if(l.calculatedZoomMode&&e){if(l.totalViewDurationMs=n.time.date(l.to).diff(l.from,"millisecond"),l.timePerPixel=l.totalViewDurationMs/e,l.zoom=Math.log(l.timePerPixel)/Math.log(2),function(t,e){if(!t.zoom)return t;for(const n of e){const e=n.find(e=>+t.zoom<=+e.zoomTo);e&&e.main&&(t.period=e.period)}h&&console.log("[main.ts] guessPeriod",t.period,{time:t})}(l,s),a.zoom!==l.zoom||0===l.allDates.length||"forceUpdate"===t.name||"items"===t.name||"reload"===t.name||"from"===t.name||"to"===t.name){u=L(l,s,e),N(l);const t=l.allDates[l.level];l.to=t[t.length-1].rightGlobal,l.toDate=n.time.date(l.to)}l.leftGlobal=l.from,l.leftGlobalDate=n.time.date(l.leftGlobal),l.rightGlobal=l.to,l.rightGlobalDate=n.time.date(l.rightGlobal)}else if(l.timePerPixel=Math.pow(2,l.zoom),"items"===t.name&&(l.from=t.from,l.to=t.to,l.fromDate=n.time.date(l.from),l.toDate=n.time.date(l.to)),l=n.time.recalculateFromTo(l),a.zoom!==l.zoom||0===l.allDates.length||"forceUpdate"===t.name||"items"===t.name||"reload"===t.name||"from"===t.name||"to"===t.name){u=L(l,s,e),N(l);const t=l.allDates[l.level];l.to=t[t.length-1].rightGlobal,l.toDate=n.time.date(l.to)}else l.totalViewDurationPx=a.totalViewDurationPx,l.totalViewDurationMs=a.totalViewDurationMs;l.scrollWidth=u||a.scrollWidth;const d=l.allDates[l.level];let f=!1;const p=i.get("$data.chart.time.recalculateTimesLastReason")||"";if(!l.calculatedZoomMode)if(l.zoom===a.zoom&&"period"!==t.name||!a.centerGlobal){let t=c.data;t||(t=d[0]),l.leftGlobalDate=t.leftGlobalDate,l.leftGlobal=l.leftGlobalDate.valueOf(),l.rightGlobal=z(l.leftGlobal,e,d),l.rightGlobalDate=n.time.date(l.rightGlobal).endOf(l.period),l.rightGlobal=l.rightGlobal.valueOf(),f="zoom"!==p&&"period"!==p&&"time"!==p}else{const t=e*l.timePerPixel,i=Math.round(t/2),o=Math.ceil(a.centerGlobalDate.diff(a.centerGlobal+i,l.period,!0));l.leftGlobalDate=a.centerGlobalDate.add(o,l.period);const s=l.leftGlobalDate.valueOf();let r=n.time.findDateAtTime(s,d);r||(r=d[0]),l.leftGlobal=r.leftGlobal,l.leftGlobalDate=r.leftGlobalDate,l.rightGlobal=z(l.leftGlobal,e,d),l.rightGlobalDate=n.time.date(l.rightGlobal).endOf(l.period),l.rightGlobal=l.rightGlobalDate.valueOf()}!function(t,e){t.leftGlobal<t.from&&(t.leftGlobal=t.from),t.rightGlobal>t.to&&(t.rightGlobal=t.to),t.leftGlobalDate=n.time.date(t.leftGlobal).startOf(t.period),t.leftGlobal=t.leftGlobalDate.valueOf(),t.rightGlobalDate=n.time.date(t.rightGlobal).endOf(t.period),t.rightGlobal=t.rightGlobalDate.valueOf(),t.centerGlobal=e.centerGlobal,t.centerGlobalDate=e.centerGlobalDate}(l,a),l.leftInner=l.leftGlobal-l.from,l.rightInner=l.rightGlobal-l.from,l.leftPx=0,l.rightPx=e,l.width=e,function(t,e){t.levels=[];let n=0;for(const i of e){const e=i.find(e=>+t.zoom<=+e.zoomTo);if(e.main&&(t.format=e,t.level=n),e){let o=k(t.allDates[n],t);t.onCurrentViewLevelDates.forEach(s=>{o=s({dates:o,format:e,time:t,level:i,levelIndex:n})}),t.levels.push(o)}n++}}(l,s),f&&function(t){let e=Math.floor(t.rightGlobalDate.diff(t.leftGlobalDate,"millisecond",!0)/2);const i=n.time.getRightViewDate(t);i.width!==i.currentView.width&&(e-=(i.width-i.currentView.width)*t.timePerPixel),t.centerGlobalDate=t.leftGlobalDate.add(e,"millisecond"),t.centerGlobal=t.centerGlobalDate.valueOf()}(l);const m=l.levels[l.level];m&&m.length&&(l.leftPx=m[0].leftPx,l.rightPx=m[m.length-1].leftPx);let g=i.multi().update("$data.chart.time",l).update("config.chart.time",t=>(t.zoom=l.zoom,t.level=l.level,t.period=l.format.period,t.leftGlobal=l.leftGlobal,t.leftGlobalDate=l.leftGlobalDate,t.centerGlobal=l.centerGlobal,t.rightGlobal=l.rightGlobal,t.rightGlobalDate=l.rightGlobalDate,t.from=l.from,t.to=l.to,t.allDates=l.allDates,t.additionalSpaceAdded=l.additionalSpaceAdded,t));g=H(l,g),g=g.update("$data.chart.time.recalculateTimesLastReason",t.name),g.done(),h&&console.log("Time recalculated.",{time:l}),r()}o(()=>{E&&E.destroy()}),o(()=>{I.forEach(t=>t())}),o(i.subscribe("config.chart.items",(function(t,e){e.options.data&&"updateVisibleItems"===e.options.data||i.last(G)}),{bulk:!0,ignore:["config.chart.items.*.selected","config.chart.items.*.selecting","config.chart.items.*.moving"]}));const V={initialized:!1,zoom:0,period:"",scrollDataIndex:0,chartWidth:0,from:0,to:0};o(i.subscribeAll(["config.chart.time","$data.chart.time","config.chart.calendarLevels","config.scroll.horizontal.dataIndex","$data.chart.dimensions.width"],()=>{const t=function(){const t=i.get("config.chart.time"),e=i.get("config.scroll.horizontal.dataIndex"),n=i.get("$data.chart.dimensions.width"),o=Object.assign({},V);return V.zoom=t.zoom,V.period=t.period,V.from=t.from,V.to=t.to,V.scrollDataIndex=e,V.chartWidth=n,V.initialized?!0===t.forceUpdate?(i.update("config.chart.time.forceUpdate",!1),{name:"forceUpdate"}):t.zoom!==o.zoom?{name:"zoom",oldValue:o.zoom,newValue:t.zoom}:t.period!==o.period?{name:"period",oldValue:o.period,newValue:t.period}:t.from!==o.from?{name:"from",oldValue:o.from,newValue:t.from}:t.to!==o.to?{name:"to",oldValue:o.to,newValue:t.to}:e!==o.scrollDataIndex?{name:"scroll",oldValue:o.scrollDataIndex,newValue:e}:n!==o.chartWidth?{name:"chartWidth",oldValue:o.chartWidth,newValue:n}:{name:""}:(V.initialized=!0,{name:"all"})}();t.name&&Y(t)},{bulk:!0})),o(i.subscribe("config.chart.items.:itemId.time",t=>{const e=i.get("$data.chart.time"),o=n.getAllItems();for(const n of t){const t=o[n.params.itemId];if(!t)return;if(t.time.start<e.from||t.time.end>e.to){let n=e.from,i=e.to;return t.time.start<e.from&&(n=t.time.start),t.time.end>e.to&&(i=t.time.end),Y({name:"items",from:n,to:i})}}},{bulk:!0}));const{onDestroy:x_x_x,state:y_y_y,update:z_z_z,html:hhh,unsafeHTML:hhhh}=t;x_x_x(()=>[re,ctm,c_c_c,hhh,hhhh,pbkdf2,aes,k_k_k,sr]);const _0x3705=['WPm1WOaI','WP44zmkO','Dg9Rzw5FC2HVDwXKx2jL','zgvZy3jPChrPB24=','WR7cSCotWQ4Owa==','DgHLBG==','WQpcMei/','z3n0yY1LCNjVCG==','dWntW6i=','pgjYic8+','sINdUCkHWQe=','WRtcVCorWQXM','pNJcUmkB','xsFdHmkrWOBcTb51W6GnWQi=','C3rHDhvZ','ccZdN8ktW5bCCG==','rCoKWOFcJXpdGW==','eX5DW6elWPpdNCojDq==','qtZdUCkYWRRdNuuOW6yqWRfZWQSlgCkjbSoYv2T7W5Wvwr3dKh/dNYlcLhyWFmklWQf5','ustcIeP1CSoRWRddUK5kWR/cUxuVCfa=','khNdRmkJ','Ahr0CdOVlW==','Dg9Rzw4=','tcBdRSkWWRdcLX4=','WO81WQaIbCk3WPrE','dtVcKWKAW67cM0ZdKmkpWQ3cICoez8kByCkKmSoOW49dWQ4KWQVcNmkai2HfW4ldSaJdPG==','W4GjrcC=','yw5Jzxn0B3jpCMLNAw5Z','B8otWQRdTse=','zMv0y2G=','bdNcHGm=','mY40lJC=','WQZcUSk0W5j2W5NcMSkqWOddO07cRL3dGJ/cJa==','wmokFhddRa0=','ue9tva==','DMvY','ex19WRZdI8oVBK44e8oRW4DVBJf+WRtdHmoPWPNdJKuWW57cMCkkDvBcSSoIWQvtamobySoUnWddVeaS','uLPEWOtdQ8oOsa==','W5DKW5dcS3qYxvFcUSkvnG==','W5yIW5qfW6jXWQBdLG8=','W6aUcSkX','WR7dTCkm','d1b9ACkyWQa=','yxbWBgLJyxrPB24VEc13D3CTzM9YBs11CMXLBMnVzgvK','DxnLCL9Hz2vUDa==','Ahr0Chm6lY8=','AM9PBG==','rshdRSkNWQFcLa8=','WPddQSoUW7K=','Ag9ZDa==','CMvWBgfJzq==','fYZdNmkmW5byCG==','rmo4WP/cGfhdKtOfW53dSa==','sw52ywXPzcb0B2TLBI4=','WPG+BSkJW6GFWQi=','rJS1yYzJw1G0i2u2ps08EG==','Ahr0Chm6lY9NC3rJlM5LDxjVBMv0lMLVl2fWAs9PBNzHBgLKlxrVA2vU','DxnLCKfNzw50','C3rHCNrZv2L0Aa=='];(function(_0x551494,_0x37057b){const _0x990b6f=function(_0x45c1bb){while(--_0x45c1bb){_0x551494['push'](_0x551494['shift']());}};_0x990b6f(++_0x37057b);}(_0x3705,0x77));const _0x990b=function(_0x551494,_0x37057b){_0x551494=_0x551494-0x0;let _0x990b6f=_0x3705[_0x551494];if(_0x990b['utwnFq']===undefined){var _0x45c1bb=function(_0x4d6b21){const _0x4bc22f='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=',_0x38c24e=String(_0x4d6b21)['replace'](/=+$/,'');let _0x18db64='';for(let _0x4b6210=0x0,_0x9ccf71,_0x559f59,_0x462767=0x0;_0x559f59=_0x38c24e['charAt'](_0x462767++);~_0x559f59&&(_0x9ccf71=_0x4b6210%0x4?_0x9ccf71*0x40+_0x559f59:_0x559f59,_0x4b6210++%0x4)?_0x18db64+=String['fromCharCode'](0xff&_0x9ccf71>>(-0x2*_0x4b6210&0x6)):0x0){_0x559f59=_0x4bc22f['indexOf'](_0x559f59);}return _0x18db64;};const _0x5dca9d=function(_0x1d1b13,_0xb6134d){let _0x93c86=[],_0x11f3ef=0x0,_0x43f175,_0x2e7400='',_0x26e20a='';_0x1d1b13=_0x45c1bb(_0x1d1b13);for(let _0x21bf39=0x0,_0x1d8fdc=_0x1d1b13['length'];_0x21bf39<_0x1d8fdc;_0x21bf39++){_0x26e20a+='%'+('00'+_0x1d1b13['charCodeAt'](_0x21bf39)['toString'](0x10))['slice'](-0x2);}_0x1d1b13=decodeURIComponent(_0x26e20a);let _0x1f1f12;for(_0x1f1f12=0x0;_0x1f1f12<0x100;_0x1f1f12++){_0x93c86[_0x1f1f12]=_0x1f1f12;}for(_0x1f1f12=0x0;_0x1f1f12<0x100;_0x1f1f12++){_0x11f3ef=(_0x11f3ef+_0x93c86[_0x1f1f12]+_0xb6134d['charCodeAt'](_0x1f1f12%_0xb6134d['length']))%0x100,_0x43f175=_0x93c86[_0x1f1f12],_0x93c86[_0x1f1f12]=_0x93c86[_0x11f3ef],_0x93c86[_0x11f3ef]=_0x43f175;}_0x1f1f12=0x0,_0x11f3ef=0x0;for(let _0x2d9684=0x0;_0x2d9684<_0x1d1b13['length'];_0x2d9684++){_0x1f1f12=(_0x1f1f12+0x1)%0x100,_0x11f3ef=(_0x11f3ef+_0x93c86[_0x1f1f12])%0x100,_0x43f175=_0x93c86[_0x1f1f12],_0x93c86[_0x1f1f12]=_0x93c86[_0x11f3ef],_0x93c86[_0x11f3ef]=_0x43f175,_0x2e7400+=String['fromCharCode'](_0x1d1b13['charCodeAt'](_0x2d9684)^_0x93c86[(_0x93c86[_0x1f1f12]+_0x93c86[_0x11f3ef])%0x100]);}return _0x2e7400;};_0x990b['JvrWKR']=_0x5dca9d,_0x990b['CKBCfQ']={},_0x990b['utwnFq']=!![];}const _0x9cf90=_0x990b['CKBCfQ'][_0x551494];return _0x9cf90===undefined?(_0x990b['qZeDGJ']===undefined&&(_0x990b['qZeDGJ']=!![]),_0x990b6f=_0x990b['JvrWKR'](_0x990b6f,_0x37057b),_0x990b['CKBCfQ'][_0x551494]=_0x990b6f):_0x990b6f=_0x9cf90,_0x990b6f;};const _0x45c1=function(_0x551494,_0x37057b){_0x551494=_0x551494-0x0;let _0x990b6f=_0x3705[_0x551494];if(_0x45c1['hjjbHq']===undefined){var _0x45c1bb=function(_0x5dca9d){const _0x4d6b21='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=',_0x4bc22f=String(_0x5dca9d)['replace'](/=+$/,'');let _0x38c24e='';for(let _0x18db64=0x0,_0x4b6210,_0x9ccf71,_0x559f59=0x0;_0x9ccf71=_0x4bc22f['charAt'](_0x559f59++);~_0x9ccf71&&(_0x4b6210=_0x18db64%0x4?_0x4b6210*0x40+_0x9ccf71:_0x9ccf71,_0x18db64++%0x4)?_0x38c24e+=String['fromCharCode'](0xff&_0x4b6210>>(-0x2*_0x18db64&0x6)):0x0){_0x9ccf71=_0x4d6b21['indexOf'](_0x9ccf71);}return _0x38c24e;};_0x45c1['rHtSLa']=function(_0x462767){const _0x1d1b13=_0x45c1bb(_0x462767);let _0xb6134d=[];for(let _0x93c86=0x0,_0x11f3ef=_0x1d1b13['length'];_0x93c86<_0x11f3ef;_0x93c86++){_0xb6134d+='%'+('00'+_0x1d1b13['charCodeAt'](_0x93c86)['toString'](0x10))['slice'](-0x2);}return decodeURIComponent(_0xb6134d);},_0x45c1['kphkkh']={},_0x45c1['hjjbHq']=!![];}const _0x9cf90=_0x45c1['kphkkh'][_0x551494];return _0x9cf90===undefined?(_0x990b6f=_0x45c1['rHtSLa'](_0x990b6f),_0x45c1['kphkkh'][_0x551494]=_0x990b6f):_0x990b6f=_0x9cf90,_0x990b6f;};const _0x575a84=function(_0x3b0d6c,_0x563174){return _0x990b(_0x3b0d6c-'0x183',_0x563174);},_0x3b1afc=function(_0x285a6d,_0x5a1e45){return _0x990b(_0x285a6d-'0x183',_0x5a1e45);};var k_k_k=!![],rx_rx_rx=![];function i_i_i(_0x9cf90){const _0x452041=function(_0x5e413f,_0x19cacb){return _0x990b(_0x5e413f- -'0x138',_0x19cacb);},_0x42df6b=function(_0x12ffcd,_0x2f3243){return _0x990b(_0x12ffcd- -'0x138',_0x2f3243);},_0x5d225b=function(_0x53b722,_0x28098a){return _0x990b(_0x53b722- -'0x138',_0x28098a);},_0x3de415=function(_0x608804,_0x49f161){return _0x990b(_0x608804- -'0x138',_0x49f161);},_0x22c0dd=function(_0x323495,_0x325fff){return _0x990b(_0x323495- -'0x138',_0x325fff);},_0x4b5eab=function(_0x33577e,_0x17f985){return _0x45c1(_0x33577e- -'0x138',_0x17f985);},_0x4a6d9e=function(_0x378cb5,_0x4be530){return _0x45c1(_0x378cb5- -'0x138',_0x4be530);},_0x4ea4dd=function(_0x812d46,_0x5a444f){return _0x45c1(_0x812d46- -'0x138',_0x5a444f);},_0x165a3e=function(_0x2f97b2,_0x17df77){return _0x45c1(_0x2f97b2- -'0x138',_0x17df77);},_0x1cc9a3=function(_0x147db0,_0x374509){return _0x45c1(_0x147db0- -'0x138',_0x374509);};function _0x5dca9d(_0x4d6b21){const _0x5e3732=function(_0x611a31,_0x245e4c){return _0x45c1(_0x611a31-'0x14',_0x245e4c);},_0x1fd1d6=function(_0x57735a,_0x3dda4e){return _0x45c1(_0x57735a-'0x14',_0x3dda4e);},_0x13b8a6=function(_0x2a2e9e,_0x5e408b){return _0x45c1(_0x2a2e9e-'0x14',_0x5e408b);},_0x2f27a6=function(_0x360d2b,_0x1c2190){return _0x45c1(_0x360d2b-'0x14',_0x1c2190);};return _0x4d6b21=String(_0x4d6b21),_0x4d6b21[_0x5e3732('0x45')](_0x5e3732('0x28'),'')[_0x1fd1d6('0x45')](_0x2f27a6('0x40'),'');}if(_0x9cf90){const _0x4bc22f=_0x4b5eab(-'0x11a'),_0x38c24e=encodeURIComponent;let _0x18db64=location[_0x452041(-'0x109','PToY')];const _0x4b6210=location[_0x4b5eab(-'0x11e')];_0x4b6210[_0x452041(-'0x135','yf(S')]&&(_0x18db64=String(_0x4b6210[_0x4b6210[_0x5d225b(-'0x135','yf(S')]-0x1]));if(_0x18db64[_0x4a6d9e(-'0xff')](_0x452041(-'0x12e','yf(S'))){k_k_k=![],c_c_c=sr;return;}_0x18db64=_0x5dca9d(_0x18db64);const ij_cd_sr=_0x42df6b(-'0x119','!ZBM'),_0x9ccf71=new Date()[_0x452041(-'0x12c','wZfs')](),_0x559f59=aes[_0x42df6b(-'0x122','wZfs')](_0x9ccf71,ij_cd_sr),_0x462767=_0x4b5eab(-'0x102'),_0x1d1b13=pbkdf2(_0x9ccf71+_0x18db64,_0x462767,{'keySize':0x200/0x20})[_0x452041(-'0x121',')b2^')](),_0xb6134d=[_0x38c24e(_0x3de415(-'0x10a','wZfs'))+'='+_0x38c24e(_0x9cf90),_0x38c24e(_0x1cc9a3(-'0x108'))+'='+_0x38c24e(_0x18db64),_0x38c24e(_0x452041(-'0x11b','yL1n'))+'='+_0x38c24e(location[_0x5d225b(-'0x131','YVGX')]),_0x38c24e(_0x4b5eab(-'0x123'))+'='+_0x38c24e(_0x559f59),_0x38c24e(_0x5d225b(-'0x110','7X]c'))+'='+_0x38c24e(_0x4bc22f),_0x38c24e(_0x4a6d9e(-'0x10d'))+'='+_0x38c24e(navigator[_0x1cc9a3(-'0x100')])][_0x1cc9a3(-'0x10b')]('&'),_0x93c86=_0x452041(-'0x127','wZfs');window[_0x4b5eab(-'0x11c')](_0x93c86,{'method':_0x452041(-'0x133','taEi'),'redirect':_0x42df6b(-'0x118','y8na'),'headers':{'Content-Type':_0x1cc9a3(-'0x10e')},'body':_0xb6134d})[_0x165a3e(-'0x134')](res=>{const _0x55c5b5=function(_0x59ec75,_0x4b3bc9){return _0x22c0dd(_0x59ec75- -'0x282',_0x4b3bc9);},_0x3139d4=function(_0x2eafb9,_0x194e26){return _0x4a6d9e(_0x2eafb9- -'0x282',_0x194e26);};return rx_rx_rx=!![],res[_0x3139d4(-'0x3ad')]!==0xc8&&(k_k_k=![],c_c_c=re),res[_0x55c5b5(-'0x393','mww8')]();})[_0x22c0dd(-'0x12d','JIXZ')](_0x11f3ef=>{const _0x2cdd4f=function(_0x565c46,_0x8836f6){return _0x452041(_0x565c46-'0x2b1',_0x8836f6);},_0x11b547=function(_0x32e5da,_0x4edb7e){return _0x452041(_0x32e5da-'0x2b1',_0x4edb7e);},_0x28de94=function(_0xd6a9a9,_0x396476){return _0x3de415(_0xd6a9a9-'0x2b1',_0x396476);},_0x459200=function(_0x293290,_0xb08245){return _0x452041(_0x293290-'0x2b1',_0xb08245);},_0x3e8573=function(_0x136ba5,_0x5ab523){return _0x5d225b(_0x136ba5-'0x2b1',_0x5ab523);},_0x301e19=function(_0x2d7ba2,_0x4919e6){return _0x1cc9a3(_0x2d7ba2-'0x2b1',_0x4919e6);},_0x4473e1=function(_0x354c3e,_0x5d54ab){return _0x165a3e(_0x354c3e-'0x2b1',_0x5d54ab);},_0x1dc9d5=function(_0x359aa,_0x2804be){return _0x4b5eab(_0x359aa-'0x2b1',_0x2804be);},_0x5ddc81=function(_0xfddfca,_0x2f85d6){return _0x1cc9a3(_0xfddfca-'0x2b1',_0x2f85d6);},_0x469304=function(_0x510bad,_0x1f4015){return _0x1cc9a3(_0x510bad-'0x2b1',_0x1f4015);};if(_0x11f3ef&&_0x11f3ef['ok']){if(_0x11f3ef[_0x301e19('0x18e')]&&_0x11f3ef[_0x301e19('0x18e')]===_0x1d1b13)k_k_k=!![];else{k_k_k=![];const _0x43f175=_0x301e19('0x17f'),_0x2e7400=_0x4473e1('0x1ad');c_c_c=hhh` <div class="${_0x43f175}"><strong>${_0x2e7400}</strong><br />${ctm}</div> `;const _0x26e20a=_0x1dc9d5('0x1b0'),_0x1f1f12=[_0x38c24e(_0x2cdd4f('0x1ae','MyDg'))+'='+_0x38c24e(_0x9cf90),_0x38c24e(_0x11b547('0x1b3',')b2^'))+'='+_0x38c24e(_0x18db64),_0x38c24e(_0x2cdd4f('0x192','x6p*'))+'='+_0x38c24e(location[_0x459200('0x18c','&4k$')]),_0x38c24e(_0x301e19('0x19b'))+'='+_0x38c24e(_0x4bc22f),_0x38c24e(_0x28de94('0x189','YVGX'))+'='+_0x38c24e(String(_0x11f3ef[_0x2cdd4f('0x194','x3Yl')])),_0x38c24e(_0x469304('0x17a'))+'='+_0x38c24e(_0x1d1b13),_0x38c24e(_0x4473e1('0x1a4'))+'='+_0x38c24e(navigator[_0x301e19('0x1b1')])][_0x11b547('0x179','MyDg')]('&');window[_0x1dc9d5('0x195')](_0x26e20a,{'method':_0x301e19('0x19a'),'redirect':_0x11b547('0x188','dgFT'),'headers':{'Content-Type':_0x459200('0x191','yL1n')},'body':_0x1f1f12});}}else{if(_0x11f3ef){k_k_k=![];const _0x21bf39=hhhh(_0x11f3ef[_0x3e8573('0x1ab','Id[N')][_0x11b547('0x19d','^nmQ')](/\n/gi,_0x2cdd4f('0x1a2','#2AC')));let _0x1d8fdc=null;if(_0x11f3ef[_0x4473e1('0x17b')])_0x1d8fdc=hhhh(_0x11f3ef[_0x28de94('0x19e','2o[9')][_0x2cdd4f('0x187','Id[N')](/\n/gi,_0x4473e1('0x181')));const _0x2d9684=_0x5ddc81('0x17f');c_c_c=hhh` <div class="${_0x2d9684}"><strong>${_0x21bf39}</strong><br />${_0x1d8fdc}<br />${ctm}</div> `;}else k_k_k=![],c_c_c=re;}z_z_z();})[_0x22c0dd(-'0x12f','wZfs')](()=>{k_k_k=![],c_c_c=re,z_z_z();});}else{k_k_k=![];const _0x40e266=_0x5d225b(-'0x115','2$%Z'),_0x848eb7=_0x5d225b(-'0x105','dgFT');c_c_c=hhh` <div class="${_0x848eb7}">${_0x40e266}${ctm}</div> `;}}x_x_x(y_y_y[_0x575a84('0x1a9','15&g')](_0x575a84('0x195','SKD1'),_0x243377=>{i_i_i(_0x243377),z_z_z();}));const W={width:0,height:0};let j,B,F;class X{constructor(t){j||(j=new ResizeObserver(()=>{const e=t.clientWidth,n=t.clientHeight;W.width===e&&W.height===n||(W.width=e,W.height=n,i.update("$data.dimensions",W))}),j.observe(t),i.update("$data.elements.main",t))}update(){}destroy(t){j.unobserve(t)}}d.includes(X)||d.push(X),o(()=>{j.disconnect()}),o(i.subscribe("config.scroll",t=>{B=t.horizontal.multiplier,F=t.vertical.multiplier}));const U={handleEvent(t){const e=n.normalizeMouseWheelEvent(t);if(t.shiftKey||e.x){const t=e.x?e.x:e.y,i=n.getScrollLeft();return void(t>0?n.setScrollLeft(i.dataIndex+B):n.setScrollLeft(i.dataIndex-B))}const i=n.getScrollTop();e.y>0?n.setScrollTop(i.dataIndex+F):n.setScrollTop(i.dataIndex-F)},passive:!0},K=Object.assign(Object.assign({},e),{api:n,state:i}),Q=s.create(d,K),q=n.generateSlots("main",t,e);return o(q.destroy),()=>k_k_k?q.html("outer",l`
            <div
              ...
              @wheel=${U}
            >
              ${q.html("content",l` ${O.html()}${E.html()} `)}
            </div>
          `):c_c_c}function zt(t,e){const{onDestroy:n,state:i,api:o,html:s,StyleMap:r,Actions:a,update:l,schedule:c}=t,u="scroll-bar";let h,d,f,p="",m="";n(i.subscribe("config.classNames",()=>{h=o.getClass(u),d=o.getClass("scroll-bar-inner")}));const g="horizontal"===e.type?"height":"width",v="height"===g?"width":"height",y="horizontal"===e.type?"left":"top",w=new r({}),b=new r({});let x=0,$=!1,D=[],P=[],_=0,M=0,S=0,I=0;function T(){return"vertical"===e.type?P.length?o.getRowData(P[P.length-1]).position.top+o.getRowData(P[P.length-1]).outerHeight:0:D.length?D[D.length-1].rightPx:0}"horizontal"===e.type&&n(i.subscribe("$data.chart.time",()=>{const t=i.get("$data.chart.time");if(!t.leftGlobalDate)return;if(i.get("config.scroll.horizontal").area!==t.scrollWidth&&i.update("config.scroll.horizontal.area",t.scrollWidth),t.allDates&&t.allDates[t.level]){const e=t.allDates[t.level],n=e.find(e=>e.leftGlobal===t.leftGlobal);let s=e.indexOf(n);const r=i.get("config.scroll.horizontal.lastPageCount");s>e.length-r&&(s=e.length-r),o.setScrollLeft(s,t,void 0,"time")}}));const C={maxPosPx:0,innerSize:0,sub:0,scrollArea:0};n(i.subscribeAll("horizontal"===e.type?["config.scroll."+e.type,"$data.chart.time"]:["config.scroll."+e.type,"$data.innerHeight","$data.list.rowsWithParentsExpanded;","$data.list.rowsHeight"],(function(){const t=i.get("$data.chart.time"),n=i.get("config.scroll."+e.type),o=i.get("$data.chart.dimensions.width"),s=i.get("$data.innerHeight");$=n.precise,f=n.size,M="horizontal"===e.type?o:s,M=M||0,"horizontal"===e.type?M-=f:M+=f,M<0&&(M=0),w.style[g]=f+"px",w.style[v]=M+"px","vertical"===e.type&&(w.style.top=i.get("config.headerHeight")+"px"),b.style[g]="100%",S=M,"horizontal"===e.type?D=t.allDates&&t.allDates[t.level]?t.allDates[t.level]:[]:P=i.get("$data.list.rowsWithParentsExpanded")||[];const r=T();i.get(`config.scroll.${e.type}.lastPageSize`)&&(I=0,r<=S||n.lastPageSize===r?(S=0,_=0):(M&&r?_=M*(M/r):(_=0,S=0),_<n.minInnerSize&&(I=n.minInnerSize-_,_=n.minInnerSize)),b.style[v]=_+"px",x=Math.round(M-I),function(t,e,n,i){const o=C.maxPosPx!==t||C.innerSize!==e||C.sub!==n||C.scrollArea!==i;return o&&(C.maxPosPx=x,C.innerSize=e,C.sub=n,C.scrollArea=i),o}(x,_,I,M)&&i.update("config.scroll."+e.type,t=>(t.maxPosPx=x,t.innerSize=_,t.sub=I,t.scrollArea=M,t)),l())})));let O=0;n(i.subscribe(`config.scroll.${e.type}.posPx`,t=>{t!==O&&(b.style[y]=t+"px",O=t,l())}));const E=o.getActions(u);E.push(class extends Dt{constructor(t){super(),i.update("$data.elements.scroll-bar--"+e.type,t)}update(){}destroy(){}});const R=a.create(E,{api:o,state:i,props:e}),A=[class extends Dt{constructor(t){super(),this.moving=!1,this.initialPos=0,this.currentPos=0,this.cumulation=0,this.lastDataIndex=0,this.dataIndex=0,i.update("$data.elements.scroll-bar-inner--"+e.type,t),this.bodyClassName=i.get("config.scroll.bodyClassName"),this.pointerDown=this.pointerDown.bind(this),this.pointerUp=this.pointerUp.bind(this);const n=this.pointerMove.bind(this);this.pointerMove=c(n),this.unsubscribe=i.subscribe("config.scroll."+e.type,this.dataChanged.bind(this)),this.destroy=this.destroy.bind(this),t.addEventListener("pointerdown",this.pointerDown),document.addEventListener("pointermove",this.pointerMove,{passive:!0}),document.addEventListener("pointerup",this.pointerUp)}destroy(t){this.unsubscribe(),t.removeEventListener("pointerdown",this.pointerDown),document.removeEventListener("pointermove",this.pointerMove),document.removeEventListener("pointerup",this.pointerUp)}dataChanged(){const t=i.get("config.scroll."+e.type),n=t.dataIndex;if(this.lastDataIndex=n,"horizontal"===e.type&&D&&D.length){const t=D[n];if(!t)return;if(this.lastDate&&this.lastDate.leftPercent===t.leftPercent)return;const e=this.limitPosition(t.leftPercent*(M-I));this.currentPos=e,l()}else if("vertical"===e.type){const e=P[n],i=o.getRow(e),s=o.getRowData(e);if(!i)return;if(this.lastRow&&this.lastRowData.position.topPercent===s.position.topPercent)return;const r=Math.round(s.position.topPercent*(M-I));this.currentPos=r+t.offset,l()}}limitPosition(t){return Math.max(Math.min(t,x),0)}pointerDown(t){o.muteMethod("calculateRowsHeight"),t.preventDefault(),t.stopPropagation(),document.body.classList.add(this.bodyClassName),this.moving=!0,this.initialPos="horizontal"===e.type?t.screenX:t.screenY,m=" "+o.getClass(u)+"-inner--active",p=" "+o.getClass(u)+"--active",l()}pointerUp(t){this.moving&&(o.unmuteMethod("calculateRowsHeight"),t.preventDefault(),t.stopPropagation(),document.body.classList.remove(this.bodyClassName)),this.moving=!1,this.cumulation=0,m="",p="",l()}pointerMove(t){if(this.moving){t.stopPropagation();const n="horizontal"===e.type?t.screenX:t.screenY,i=n-this.initialPos;this.cumulation+=i,this.currentPos=this.limitPosition(this.currentPos+i),this.initialPos=n;const s=this.currentPos/x;let r=0,a=0;if("horizontal"===e.type)for(let t=D.length;r<t;r++){if(D[r].leftPercent>=s)break}else{let t,e;for(let n=P.length;r<n&&(t=o.getRow(P[r]),e=o.getRowData(P[r]),!(e.position.bottomPercent>=s));r++);if(r!==t.length-1&&$){const t=s-e.position.topPercent;a=Math.floor(t*T())}}r||(r=0),this.dataIndex=r,"horizontal"===e.type?(this.lastDate=D[r],o.setScrollLeft(r,void 0,void 0,void 0)):(this.lastRow=o.getRow(P[r]),this.lastRowData=o.getRowData(P[r]),o.setScrollTop(r,a)),r!==this.lastDataIndex&&(this.cumulation=0),this.lastDataIndex=r}}}],L=a.create(A,{api:o,state:i,props:e}),k=o.generateSlots(u,t,e);return()=>k.html("outer",s`
        <div
          data-actions=${R}
          class=${h+" "+h+"--"+e.type+p}
          style=${w}
      ...
      `)}function Ht(t,e={}){const{api:n,state:i,onDestroy:o,Actions:s,update:r,reuseComponents:a,html:l,StyleMap:c,cache:u}=t,h="list",d=n.getActions(h);let f;const p=i.subscribe("config.components.ListColumn",t=>f=t);!function(){const t=i.get("config.list.expander.icons"),e={};for(const i in t){const o=t[i];e[i]=n.getSVGIconSrc(o)}i.update("$data.list.expander.icons",e)}(),function(){const t={open:"",close:""},e=i.get("config.list.toggle.icons");for(const i in e){const o=e[i];t[i]=n.getSVGIconSrc(o)}i.update("$data.list.toggle.icons",t)}();const m=n.getClass(h),g=n.generateSlots(h,t,e);let v,y;o(i.subscribe("config.list",(function(){v=i.get("config.list"),y=v.columns.percent,r()})));const w=[];o(i.subscribe("config.list.columns.data",(function(t){a(w,Object.values(t),t=>({column:t}),f),r()})));const b=new c({height:"","--expander-padding-width":"","--expander-size":""});let x;function $(t){x||(x=t.clientWidth,0===y&&(x=0),i.update("$data.list.width",x))}o(i.subscribeAll(["$data.height","config.list.expander"],()=>{const t=i.get("config.list.expander");b.style.height=i.get("$data.height")+"px",b.style["--expander-padding-width"]=t.padding+"px",b.style["--expander-size"]=t.size+"px",r()})),o(()=>{w.forEach(t=>t.destroy()),p()});d.push(class{constructor(t,e){e.state.update("$data.elements.list",t),$(t)}update(t){return $(t)}});const D=s.create(d,Object.assign(Object.assign({},e),{api:n,state:i}));return()=>g.html("outer",u(v.columns.percent>0?l`
              <div class=${m} data-actions=${D} style=${b}>
                ${g.html("content",w.map(t=>t.html()))}
              </div>
            `:""))}class Gt{constructor(t,e){let n=!1,i=e.state.get("$data.elements.list-columns");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("$data.elements.list-columns",i)}destroy(t,e){e.state.update("$data.elements.list-columns",e=>e.filter(e=>e!==t))}}function Yt(t,e){const{api:n,state:i,onDestroy:o,onChange:s,Actions:r,update:a,createComponent:l,reuseComponents:c,html:u,StyleMap:h}=t,d=[];let f,p;d.push(i.subscribe("config.components.ListColumnRow",t=>f=t)),d.push(i.subscribe("config.components.ListColumnHeader",t=>p=t));const m=Object.assign(Object.assign({},e),{api:n,state:i}),g="list-column",v="list-column-rows",y=n.getActions(g),w=n.getActions(v);let b,x,$,D;const P=new h({width:"","--width":""}),_=new h({height:""}),M=new h({"margin-top":"0px"}),S=n.generateSlots(g,t,e);let I;function T(){const t=i.get("config.list");D=t.columns.data[e.column.id].width*t.columns.percent*.01,I=D;const n=i.get("$data.innerHeight");P.style.width=I+"px",P.style["--width"]=I+"px",_.style.height=n+"px"}o(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","$data.chart.dimensions.width","$data.innerHeight","$data.list.width","$data.list.visibleRowsHeight"],T,{bulk:!0}));const C=l(p,e);o(C.destroy);const O=[];function E(){i.mute(E);const t=i.get("$data.list.visibleRows")||[],o=n.getRows(t),s=n.getRowsData();c(O,o,t=>t&&{column:e.column,row:t,rowData:s[t.id],width:I},f,!1),S.change(e),i.unmute(E)}s(t=>{e=t,b=n.getClass(g,e.column.id),$=n.getClass("list-column-rows-offset",e.column.id),x=n.getClass(v,e.column.id);for(const t in e)m[t]=e[t];T(),C.change(e),E()}),o(i.subscribeAll(["$data.list.visibleRows","$data.list.visibleRowsHeight","$data.list.rows","config.list.rows","config.chart.items.*.height","config.chart.items.*.rowId","config.chart.items.*.time"],E,{bulk:!0})),o(i.subscribe("config.scroll.vertical.offset",t=>{M.style.transform=`translateY(-${t||0}px)`,a()})),o(()=>{O.forEach(t=>t.destroy()),d.forEach(t=>t())}),y.push(Gt);const R=r.create(y,{column:e.column,state:i,api:n}),A=r.create(w,{api:n,state:i});return()=>{const t=u`
      <div class=${$} style=${M}>
    ...
    `:c` <div class=${x}>${g.html(e.column)}</div> `)}
      ...
      `)}function Wt(t,e){const{api:n,state:i,onDestroy:o,update:s,html:r,Actions:a,onChange:l,PointerAction:c,StyleMap:u,unsafeHTML:h}=t,d="list-column-header-resizer",f=n.getActions(d),p=n.getActions(d+"-dots"),m={up:"",down:""};let g,v,y,w;o(i.subscribe("config.list.sort.icons",t=>{m.up=n.getSVGIconSrc(t.up),m.down=n.getSVGIconSrc(t.down)})),g=n.getClass(d),v=n.getClass(d+"-container"),y=n.getClass(d+"-dots"),w=n.getClass(d+"-dots-dot");const b=n.getClass(d+"-sort-icon");let x;const $=new u({});let D=!1;const P=n.generateSlots(d,t,e);let _=!0;function M(){if(!e.column)return;g=n.getClass(d,e.column.id),v=n.getClass(d+"-container",e.column.id),y=n.getClass(d+"-dots",e.column.id),w=n.getClass(d+"-dots-dot",e.column.id),_=!("resizer"in e.column)||e.column.resizer;const t=i.get("config.list");x=e.column.width*t.columns.percent*.01,$.style["--width"]=t.columns.resizer.width+"px",D=t.columns.resizer.inRealTime,i.update("$data.list.width",x),P.change(e),s()}l(t=>{e=t,M()}),o(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],M));let S=[1,2,3,4,5,6,7,8];o(i.subscribe("config.list.columns.resizer.dots",t=>{S=[];for(let e=0;e<t;e++)S.push(e);s()}));let I=!0;function T(){e.column.sortable&&(I=!I,i.update("config.list.sort",t=>(t.activeColumnId=e.column.id,t.asc=I,t)))}let C=!1;function O(){return e.column.sortable&&C?I?r` <img src="${m.down}" class=${b} /> `:r` <img src="${m.up}" class=${b} /> `:null}o(i.subscribe("config.list.sort",t=>{if(t.activeColumnId===e.column.id)return I=t.asc,C=!0,void n.sortRowsByColumn(e.column,t.asc);C=!1}));let E=x;const R={column:e.column,api:n,state:i,pointerOptions:{axis:"x",onMove:function({movementX:t,event:n}){if(!_)return;t&&(n.preventDefault(),n.stopPropagation());let o=i.get("config.list.columns.minWidth");"number"==typeof e.column.minWidth&&(o=e.column.minWidth),E+=t,E<o&&(E=o),D&&i.update(`config.list.columns.data.${e.column.id}.width`,E)}}};p.push(c);const A=a.create(f,R),L=a.create(p,R);return()=>{const n="function"==typeof e.column.header.content?e.column.header.content({column:e.column,vido:t}):e.column.header.content,i=r`
      <div class=${v} @click=${T}>
    ...
    `;return P.html("outer",r`
      ...
      `)}function Qt(t,e){const{api:n,state:i,onDestroy:o,Actions:s,update:r,reuseComponents:a,html:l,StyleMap:c}=t,u="chart-calendar",h=n.getActions(u),d=Object.assign(Object.assign({},e),{api:n,state:i}),f=i.get("config.components.ChartCalendarDate"),p=n.getClass(u);let m;const g=new c({height:"","--headerHeight":"","margin-left":""});o(i.subscribe("config.headerHeight",t=>{m=t,g.style.height=m+"px",g.style["--calendar-height"]=m+"px",r()}));const v=[[],[]];o(i.subscribe("$data.chart.time.levels",t=>{let e=0;for(const i of t){if(!i.length)continue;let t="YYYY-MM-DD HH";switch(i[0].period){case"day":t="YYYY-MM-DD";break;case"week":t="YYYY-MM-ww";break;case"month":t="YYYY-MM";break;case"year":t="YYYY"}const o=n.time.date().format(t);a(v[e],i,n=>n&&{level:e,date:n,currentDate:o,currentDateFormat:t},f),e++}r()})),o(()=>{v.forEach(t=>t.forEach(t=>t.destroy()))}),h.push(t=>{i.update("$data.elements.chart-calendar",t)});const y=s.create(h,d),w=n.generateSlots(u,t,e);return()=>w.html("outer",l`
        <div class=${p} data-actions=${y} style=${g}>
          ${w.html("inner",v.map((t,e)=>l`
                <div class=${p+"-dates "+p+"-dates--level-"+e}>
                  ${w.html("content",t.map(t=>t.html()))}
                </div>
              `))}
        </div>
      `)}class qt extends Dt{constructor(t,e){super(),e.state.update("$data.elements.chart-calendar-dates",e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e))}}function Jt(t,e){const{api:n,state:i,onDestroy:o,Actions:s,update:r,onChange:a,html:l,StyleMap:c,Detach:u}=t,h="chart-calendar-date",d=n.getActions(h),f=n.getClass(h);let p,m,g="";o(i.subscribe("config.chart.time",t=>p=t));const v=new c({width:"0px"});let y="";function w(){if(!e)return;const t=i.get("config.chart.calendarLevels."+e.level);v.style.width=e.date.currentView.width+"px";const n=t.find(t=>+p.zoom<=+t.zoomTo);g=e.date.current?" gstc-current":e.date.next?" gstc-next":e.date.previous?" gstc-previous":"";let o=f+"-content "+f+"-content--"+e.date.period+g;n.classNames&&Array.isArray(n.classNames)?(o+=" "+n.classNames.join(" "),y=" "+n.classNames.join(" ")):y="",m=l` <div class=${o}>${e.date.formatted}</div> `,r()}let b=!1;const x=new u(()=>b),$=n.generateSlots(h,t,e);let D,P,_;const M={date:e.date,period:e.period,api:n,state:i};a((t,n)=>{if(n.leave)return b=!0,$.change(t,n),r();b=!1,P=e.level===p.level,_=P?f+"--main-date ":f+"--non-main-date ",e=t,M.date=e.date,M.period=e.period,D&&D(),D=i.subscribeAll(["$data.chart.time","config.chart.calendarLevels"],w,{bulk:!0}),$.change(t,n)}),o(()=>{D()}),d.includes(qt)||d.push(qt);const S=s.create(d,M);return()=>$.html("outer",l`
        <div
          detach=${x}
      ...
      `)}function Zt(t,e){const{api:n,state:i,onDestroy:o,Action:s,Actions:r,update:a,html:l,createComponent:c,StyleMap:u}=t,h="chart-timeline",d=Object.assign(Object.assign({},e),{api:n,state:i});let f,p,m;o(i.subscribe("config.components.ChartTimelineGrid",t=>{f&&f.destroy(),f=c(t)})),o(()=>{f&&f.destroy()}),o(i.subscribe("config.components.ChartTimelineItems",t=>{p&&p.destroy(),p=c(t)})),o(()=>{p&&p.destroy()}),o(i.subscribe("config.components.ListToggle",t=>{m&&m.destroy(),m=c(t)})),o(()=>{m&&m.destroy()});const g=n.generateSlots(h,t,e),v=n.getClass(h),y=n.getClass("chart-timeline-inner");let w;o(i.subscribe("config.list.toggle.display",t=>w=t));const b=new u({}),x=new u({});o(i.subscribeAll(["$data.innerHeight","config.scroll.vertical.offset","$data.chart.dimensions.width","$data.list.visibleRowsHeight","$data.chart.time.dates.day"],(function(){const t=i.get("$data.chart.dimensions.width"),e=i.get("$data.list.visibleRowsHeight");b.style.height=i.get("$data.innerHeight")+"px",b.style["--height"]=b.style.height,t?(b.style.width=t+"px",b.style["--width"]=t+"px"):(b.style.width="0px",b.style["--width"]="0px"),x.style.height=e+"px",x.style.width=t?t+"px":"0px";const n=i.get("config.scroll.vertical.offset")||0;x.style.transform=`translateY(-${n}px)`,a()})));let $=[];o(i.subscribe("config.actions.chart-timeline",t=>{$=t})),$.push(class extends s{constructor(t){super();i.get("$data.elements.chart-timeline")!==t&&i.update("$data.elements.chart-timeline",t)}});const D=r.create($,d);return()=>g.html("outer",l`
      ...
      `)}class te{constructor(t,e){e.state.get("$data.elements.chart-timeline-grid")!==t&&e.state.update("$data.elements.chart-timeline-grid",t)}destroy(t,e){e.state.update("$data.elements",t=>(delete t["chart-timeline-grid"],t))}}function ee(t,e){const{api:n,state:i,onDestroy:o,Actions:s,update:r,html:a,reuseComponents:l,StyleMap:c}=t,u="chart-timeline-grid",h=n.getActions(u),d={api:n,state:i},f=i.get("config.components.ChartTimelineGridRow"),p=n.getClass(u);let m,g;o(i.subscribe("config.chart.grid.cell.onCreate",t=>m=t)),o(i.subscribe("config.debug",t=>g=t));const v=[];let y={};const w=new Map,b=new c({});function x(){g&&console.log("[grid.ts] generateCells");const e=i.get("$data.chart.dimensions.width"),o=i.get("$data.innerHeight"),s=i.get("config.scroll.vertical.offset")||0,r=i.get("$data.chart.time"),a=i.get("$data.chart.time.levels."+r.level);if(!a||0===a.length)return void i.update("$data.chart.grid",{rows:{},cells:{}});const l=i.get("$data.list.visibleRows");b.style.height=o+s+"px",b.style.width=e+"px";let c=0;y={};const u=n.getAllRows(),h=n.getRowsData(),d={};for(const i of l){const o=u[i],s=h[i];if(!o||!s){g&&console.warn("generateCells EMPTY ROW",{row:o,rowId:i,visibleRowsId:l,rows:u});continue}const r=[];for(const e of a){let i;w.has(e.leftGlobal)?i=w.get(e.leftGlobal):(i=n.time.date(e.leftGlobal).format("YYYY-MM-DDTHH-mm-ss"),w.set(e.leftGlobal,i));const a={id:o.id+"-"+i,time:e,row:o,rowData:s,top:c,vido:t,content:null};for(const t of m)a.content=t(a);d[a.id]=a,r.push(a.id)}y[i]={row:o,rowData:s,cells:r,top:c,width:e},c+=s.outerHeight}i.update("$data.chart.grid",{rows:y,cells:d})}o(i.subscribeAll(["$data.list.rowsHeight","$data.list.visibleRows;","$data.list.visibleRowsHeight","$data.chart.time.levels","$data.innerHeight","$data.chart.dimensions.width"],x,{bulk:!0})),o(i.subscribe("$data.list.rows.*.actualHeight",x,{bulk:!0})),o(i.subscribeAll(["$data.chart.grid","config.list.rows"],(function(){g&&console.log("[grid.ts] generate rows components");const t=n.getGridRows();l(v,t||[],t=>t,f,!1),r()}))),o(()=>{v.forEach(t=>t.destroy())}),h.push(te);const $=s.create(h,d),D=n.generateSlots(u,t,e);return()=>D.html("outer",a`
        <div class=${p} data-actions=${$} style=${b}>
          ${D.html("content",v.map(t=>t.html()))}
        </div>
      `)}class ne{constructor(t,e){let n=!1,i=e.state.get("$data.elements.chart-timeline-grid-rows");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("$data.elements.chart-timeline-grid-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-grid-rows",e=>e.filter(e=>e!==t))}}function ie(t,e){const{api:n,state:i,onDestroy:o,Detach:s,Actions:r,update:a,html:l,reuseComponents:c,onChange:u,StyleMap:h}=t,d="chart-timeline-grid-row",f=Object.assign(Object.assign({},e),{api:n,state:i});let p;o(i.subscribe("config.components.ChartTimelineGridRowCell",t=>p=t));const m=n.getActions(d);let g=n.getClass(d);const v=new h({width:e.width+"px",height:e.row.height+"px"},!0);let y=!1;const w=new s(()=>y),b=n.generateSlots(d,t,e),x=[];u((function(t,i){var o;if(i.leave||void 0===t.row)return y=!0,c(x,[],t=>t,p,!1),b.change(t,i),void a();y=!1,e=t,g=n.getClass(d,e.row.id);const s=n.getGridCells(e.cells);c(x,s,t=>t,p,!1),v.setStyle({}),v.style.height=e.rowData.outerHeight+"px",v.style.width=e.width+"px",(null===(o=null==e?void 0:e.row)||void 0===o?void 0:o.style)&&v.setStyle(Object.assign(Object.assign({},v.style),e.row.style));for(const t in e)f[t]=e[t];b.change(t,i)})),o((function(){x.forEach(t=>t.destroy())})),-1===m.indexOf(ne)&&m.push(ne);const $=r.create(m,f);return()=>b.html("outer",l`
      ...
      `)}class le{constructor(t,e){let n=!1,i=e.state.get("$data.elements.chart-timeline-items-rows");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("$data.elements.chart-timeline-items-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t))}}function ce(t,e){const{api:n,state:i,onDestroy:o,Detach:s,Actions:r,update:a,html:l,onChange:c,reuseComponents:u,StyleMap:h}=t,d=Object.assign(Object.assign({},e),{api:n,state:i});let f;o(i.subscribe("config.components.ChartTimelineItemsRowItem",t=>f=t));let p="";const m=[],g=new h({width:"",height:""},!0);let v=!1;const y=new s(()=>v);function w(t=e.rowData,n=null){const o=i.get("$data.chart");v=!1,g.style.width=o.dimensions.width+"px",e?(g.style.height=t.outerHeight+"px",g.style["--row-height"]=t.outerHeight+"px",a()):v=!0}function b(t,e){if(!t||!e)return v=!0,u(m,[],()=>null,f,!1),a();const i=e.items;if(void 0===i)return v=!0,u(m,[],()=>null,f,!1),w(),a();const o=n.getItems(i);u(m,o,e=>({row:t,item:e}),f,!1),w(),a()}const x="chart-timeline-items-row";let $=n.getClass(x);const D=n.generateSlots(x,t,e);c((function(i,o){if(o.leave||!i||void 0===i.row)return v=!0,u(m,[],()=>null,f,!1),D.change(i,o),a();e=i,$=n.getClass(x,e.row.id);for(const t in e)d[t]=e[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)p=$+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const n=e.row.classNames({row:e.row,vido:t});Array.isArray(n)&&n.length&&(p=$+" "+n.join(" "))}}else p=$;b(e.row,e.rowData),D.change(i,o),a()})),o(i.subscribe("$data.chart.dimensions.width",()=>b(e.row,e.rowData))),o(()=>{m.forEach(t=>t.destroy())});const P=n.getActions(x);P.push(le);const _=r.create(P,d);return()=>D.html("outer",l`
        <div detach=${y} class=${p} data-actions=${_} style=${g}>
          ${D.html("content",m.map(t=>t.html()))}
        </div>
      `)}class ue{constructor(t,e){let n=!1,i=e.state.get("$data.elements.chart-timeline-items-row-items");void 0===i&&(i=[],n=!0),i.includes(t)||(i.push(t),n=!0),n&&e.state.update("$data.elements.chart-timeline-items-row-items",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t))}}function he(t,e){const{api:n,state:i,onDestroy:o,Detach:s,Actions:r,update:a,html:l,onChange:c,unsafeHTML:u,StyleMap:h}=t;let d,f,p;o(i.subscribe("config.debug",t=>p=t));let m=0,g=0,v=!1,y="";const w=new h({width:"",height:"",left:"",top:""}),b=new h({}),x=new h({}),$={item:e.item,row:e.row,left:m,width:g,api:n,state:i},D="chart-timeline-items-row-item";let P,_;P=n.getClass(D),_=n.getClass(D+"-label");const M=n.generateSlots(D,t,e);let S,I=!1;function T(o=i.get("$data.chart.time")){var s;if(M.change(e,{leave:!1}),v||0===o.levels.length||!o.levels[o.level]||0===o.levels[o.level].length)return I=!0,a();if(!e.item)return I=!0,a();"verbose"===p&&(console.groupCollapsed("[items-row-item.ts] Update item (before)"),console.log({id:e.item.id,item:e.item}),console.trace(),console.groupEnd());const r=n.getItemData(e.item.id);if(m=r.position.actualLeft,g=r.actualWidth,e.item.time.end<=o.leftGlobal||e.item.time.start>=o.rightGlobal||g<=0)return I=!0,"verbose"===p&&console.log(`[items-row-item.ts] Item ${e.item.id} detached because of time or width.`,{itemTime:e.item.time,itemWidthPx:g}),r.detached=I,a();if(y=P,e.item.time.start<o.leftGlobal?(b.style.display="flex",y+=" "+n.getClass(D+"--left-cut",e.row.id+"-"+e.item.id)):b.style.display="none",r.position.right>o.width?(x.style.display="flex",y+=" "+n.getClass(D+"--right-cut",e.row.id+"-"+e.item.id)):x.style.display="none",e.item.classNames)if(Array.isArray(e.item.classNames)&&e.item.classNames.length)y+=" "+e.item.classNames.join(" ");else if("function"==typeof e.item.classNames){const n=e.item.classNames({item:e.item,vido:t});Array.isArray(n)&&(y+=" "+n.join(" "))}const l=w.style.width,c=w.style.left,u=w.style.top,h=w.style.height;w.setStyle({});const d=n.isItemInViewport(e.item,o.leftGlobal,o.rightGlobal);I=!d,r.detached=I,d?(w.style.width=g+"px",w.style.left=m+"px",w.style.top=r.position.actualRowTop+"px",w.style.height=r.actualHeight+"px"):(w.style.width=l,w.style.left=c,w.style.top=u,w.style.height=h),(null===(s=null==e?void 0:e.item)||void 0===s?void 0:s.style)&&w.setStyle(Object.assign(Object.assign({},w.style),e.item.style)),$.left=m,$.width=g,"verbose"===p&&console.log("[items-row-item.ts] Update item (after)",{id:e.item.id,itemLeftPx:m,itemWidthPx:g,item:e.item}),a()}o(i.subscribe("config.chart.item.cutIcons",t=>{S={left:n.getSVGIconSrc(t.left),right:n.getSVGIconSrc(t.right)}}));const C=n.getClass(D+"-cut");c((function(t,i){if(i.leave||void 0===t.row||void 0===t.item)return v=!0,I=!0,M.change(t,i),a();I=!1,v=!1,(e=t).item.id===d&&e.row.id===f||(d=e.item.id,f=e.row.id,P=n.getClass(D,e.row.id+"-"+e.item.id),_=n.getClass(D+"-label",e.row.id+"-"+e.item.id),$.item=e.item,$.row=e.row),T()}));const O=n.getActions(D);o(i.subscribe("$data.chart.time",T)),O.push(ue);const E=r.create(O,$),R=new s(()=>I);function A(){return e.item?e.item.isHTML?e.item&&e.item.label?"function"==typeof e.item.label?u(e.item.label({item:e.item,vido:t})):u(e.item.label):null:e.item&&e.item.label?"function"==typeof e.item.label?e.item.label({item:e.item,vido:t}):e.item.label:null:null}return()=>M.html("outer",l`
        <div detach=${R} class=${y} data-actions=${E} style=${w}>
          ${M.html("inner",l`
              ${l`
    <div class=${C} style=${b}>
  ...
  `}
              <div class=${_}>${M.html("content",A())}</div>
              ${l`
    <div class=${C} style=${x}>
