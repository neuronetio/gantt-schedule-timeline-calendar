 ...
 * @released  2023-08-29
 * @license   SEE LICENSE IN LICENSE FILE
 */class D extends a{constructor(t,e,o){super(e,o),this.subs=[],this.name=t,this.subs.push(e.state.subscribe(`config.slots.${t}`,this.setComponents,{queue:!0}))}destroy(){this.subs.forEach((t=>t())),super.destroy()}getName(){return this.name}}function x(t,e,o){return new D(t,e,o)}
/**
 ...
 */function M(t,e){const{onDestroy:o,state:a,cache:s,api:n,html:l,StyleMap:r,Actions:c,update:d}=t,h="scroll-bar";let u,m,f="",g="";o(a.subscribe("config.classNames",(()=>{u=n.getClass(h),m=n.getClass(h+"-inner")})));const p="horizontal"===e.type?"height":"width",w="height"===p?"width":"height",b="horizontal"===e.type?"left":"top",v=new r({}),y=new r({}),D={maxPosPx:0,innerHandleSize:0,scrollSize:0,dataId:""};o(a.subscribeAll("horizontal"===e.type?[`config.scroll.${e.type}`,`$data.scroll.${e.type}`]:[`config.scroll.${e.type}`,`$data.scroll.${e.type}`,"$data.chart.dimensions.heightWithoutScrollBar","$data.list.rowsWithParentsExpanded","$data.list.rowsHeight","config.additionalSpace"],(function(t,o){const i=a.get(`config.scroll.${e.type}`),s=a.get(`$data.scroll.${e.type}`),l=n.getScrollSize(e.type),r=s.innerHandleSize,c=s.maxHandlePosPx,h=s.dataId,u=a.get("config.additionalSpace"),m=a.get("$data.chart.time");if(!m.allDates||!m.allDates.length||!m.allDates[m.level])return;if(s.visible?v.style.display="flex":v.style.display="none",v.style[p]=i.width+"px",v.style[w]=l+"px","vertical"===e.type&&(v.style.top=a.get("config.headerHeight")+u.top+"px"),!s.lastPageSize||!s.absoluteSize||!l)return;y.style[p]="100%",y.style[w]=r+"px";!("set-scroll-top"===o.options.data||"set-scroll-left"===o.options.data)&&function(t,e,o,a){const i=D.maxPosPx!==t||D.innerHandleSize!==e||D.scrollSize!==o||D.dataId!==a;return i&&(D.maxPosPx=t,D.innerHandleSize=e,D.scrollSize=o,D.dataId=a),i}(c,r,l,h)&&("horizontal"===e.type?i.byPixels?n.setScrollLeft(s.absolutePosPx):n.setScrollLeft(s.dataIndex,s.preciseOffset):i.byPixels?n.setScrollTop(s.absolutePosPx):n.setScrollTop(s.dataIndex,s.preciseOffset)),d()}),{group:!0,bulkValue:!1}));const x=n.getActions(h);x.push(class extends i{constructor(t){super();const o=`$data.elements.scroll-bar--${e.type}`;a.get(o)||a.update(o,t,{only:null})}update(){}destroy(){}});const P={api:n,state:a,props:e,componentName:h},W=c.create(x,P),C=[class extends i{constructor(t){super(),this.moving=!1,this.initialPointerPos=0,this.initialHandlePos=0,this.currentPos=0,this.currentPointerPos=0,this.lastDataIndex=0,this.lastOffset=0,this.dataIndex=0,this.previousRowId="",a.update(`$data.elements.scroll-bar-inner--${e.type}`,t,{only:null}),this.bodyClassName=a.get("config.scroll.bodyClassName"),this.pointerDown=this.pointerDown.bind(this),this.pointerUp=this.pointerUp.bind(this);const o=this.pointerMove.bind(this);this.pointerMove=o,this.unsubscribe=a.subscribe(`$data.scroll.${e.type}`,this.dataChanged.bind(this)),this.destroy=this.destroy.bind(this),t.addEventListener("pointerdown",this.pointerDown),document.addEventListener("pointermove",this.pointerMove),document.addEventListener("pointerup",this.pointerUp)}destroy(t){this.unsubscribe(),t.removeEventListener("pointerdown",this.pointerDown),document.removeEventListener("pointermove",this.pointerMove),document.removeEventListener("pointerup",this.pointerUp)}dataChanged(){const t=a.get(`$data.scroll.${e.type}`),o=a.get("$data.chart.time");if(!o.allDates.length)return;const i=o.allDates[o.level],s=t.dataIndex;if(this.lastDataIndex=s,"horizontal"===e.type&&i&&i.length)this.currentPos=t.handlePosPx,y.style[b]=this.currentPos+"px",d();else if("vertical"===e.type){if(!a.get("$data.list.rowsWithParentsExpanded").length)return;this.currentPos=t.handlePosPx,y.style[b]=this.currentPos+"px",d()}}limitPosition(t){return Math.max(Math.min(t,a.get(`$data.scroll.${e.type}.maxHandlePosPx`)),0)}pointerDown(t){t.stopPropagation(),t.preventDefault(),n.muteMethod("calculateRowsHeight"),document.body.classList.add(this.bodyClassName),requestAnimationFrame((()=>{this.moving=!0,this.initialPointerPos="horizontal"===e.type?t.screenX:t.screenY,this.initialHandlePos=a.get(`$data.scroll.${e.type}.handlePosPx`),g=" "+n.getClass(h)+"-inner--active",f=" "+n.getClass(h)+"--active",d()}))}pointerUp(t){this.moving&&(n.unmuteMethod("calculateRowsHeight"),t.preventDefault(),t.stopPropagation(),document.body.classList.remove(this.bodyClassName)),this.moving=!1,g="",f="",d()}pointerMoveRead(t){this.currentPointerPos="horizontal"===e.type?t.screenX:t.screenY}pointerMoveWrite(){const t=a.get(`config.scroll.${e.type}`),o=a.get(`$data.scroll.${e.type}`),i=this.currentPointerPos-this.initialPointerPos;this.currentPos=this.limitPosition(this.initialHandlePos+i);const s=a.get("$data.chart.time");if(!s.allDates.length)return;const l=s.allDates[s.level],r=this.currentPos/o.maxHandlePosPx,c=Math.round(r*o.absoluteSizeWithoutLastPage);if("horizontal"===e.type){let e,o=0,a=0,i=0;for(let t=l.length;o<t&&(e=l[o],i=Math.round(e.rightPx),!(i>c));o++);t.precise&&i!==c&&(a=Math.round(e.leftPx)-c),o||(o=0),e||(e=l[0]),this.dataIndex=o,this.lastDate=l[o],t.byPixels?n.setScrollLeft(c):n.setScrollLeft(e.id,a),this.lastDataIndex=o,this.lastOffset=a}else{const{dataIndex:e,row:o,rowData:a}=n.getRowInfoFromTop(c);let i=0;t.precise&&a.position.top!==c&&(i=a.position.top-c),this.dataIndex=e,this.previousRowId=o.id,t.byPixels?n.setScrollTop(c):n.setScrollTop(e,i),this.lastDataIndex=e,this.lastOffset=i}}pointerMove(t){this.moving&&(t.stopPropagation(),t.preventDefault(),requestAnimationFrame((()=>{this.pointerMoveRead(t)})),requestAnimationFrame((()=>{this.pointerMoveWrite()})))}}],$=c.create(C,P),I=n.generateSlots(h,t,e);function S({classNameOuter:t,classNameOuterActive:e,classNameInner:o,classNameInnerActive:a,styleMapInner:i,styleMapOuter:s,innerActions:n,outerActions:l,slots:r,cache:c,html:d,vido:h,props:u}){return c(!u||!u.type?null:r.html("outer",d`
            ...
            `))}let G=S;return o(a.subscribe(`config.templates.${h}`,(t=>{G=null!=t?t:S,d()}))),()=>G({innerActions:$,outerActions:W,classNameOuter:u,classNameOuterActive:f,classNameInner:m,classNameInnerActive:g,cache:s,styleMapInner:y,styleMapOuter:v,slots:I,html:l,vido:t,props:e})}
/**
 * List component
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 * @released  2023-08-29
 * @license   SEE LICENSE IN LICENSE FILE
 */class k{constructor(t,e){let o=!1,a=e.state.get("$data.elements.list-columns");void 0===a&&(a=[],o=!0),a.includes(t)||(a.push(t),o=!0),o&&e.state.update("$data.elements.list-columns",a,{only:null})}destroy(t,e){e.state.update("$data.elements.list-columns",(e=>e.filter((e=>e!==t))),{only:null})}}function z(t,e){const{api:o,state:a,onDestroy:i,onChange:s,cache:n,Actions:l,update:r,createComponent:c,reuseComponents:d,html:h,StyleMap:u}=t,m=[];let f,g;m.push(a.subscribe("config.components.ListColumnRow",(t=>f=t))),m.push(a.subscribe("config.components.ListColumnHeader",(t=>g=t)));const p=Object.assign(Object.assign({},e),{api:o,state:a,componentName:"list-column"}),w={column:e.column,state:a,api:o,componentName:"list-column-headers"},b={api:o,state:a,componentName:"list-column-rows"},v="list-column",y=v+"-rows",D=v+"-rows-offset",x=o.getActions(v),P=o.getActions(y),W=o.getClass(v,e.column.id),C=o.getClass(D,e.column.id),$=o.getClass(y,e.column.id);let I,S=o.getId(v,e&&e.column?e.column.id:"");const G=new u({width:"","--width":""}),M=new u({height:""}),O=new u({"margin-top":"0px"});let z=a.get("config.additionalSpace");const L=o.generateSlots(v,t,e);let R;function T(){if(!e||!e.column)return;const t=a.get("config.list");if(!t.columns.data[e.column.id])return;I=t.columns.data[e.column.id].width*t.columns.percent*.01,R=I;const i=Math.round(o.getRealChartHeight());G.style.width=R+"px",G.style["--width"]=R+"px",O.style.height=i+"px",M.style.top=a.get("config.headerHeight")+z.top+"px"}i(a.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar","$data.list.width","$data.list.visibleRowsHeight","config.additionalSpace.top"],T,{group:!0}));const A=c(g,e);i(A.destroy);const H=[],N={};function V(){var t;if(!e||!e.column)return;a.mute(V);const i=a.get("$data.list.visibleRows")||[],s=o.getRows(i),n=o.getRowsData();for(const o of s){const a=N[o.id]=null!==(t=N[o.id])&&void 0!==t?t:{};a.column=e.column,a.row=o,a.rowData=n[o.id],a.width=R}for(const t in N)i.includes(t)||delete N[t];d(H,s,(t=>t&&N[t.id]),f,!0),L.change(e),a.unmute(V)}s((t=>{if((e=t)&&e.column&&e.column.id){S=o.getId(v,e&&e.column?e.column.id:"");for(const t in e)p[t]=e[t];T(),A.change(e),V()}})),i(a.subscribeAll(["$data.list.visibleRows","$data.list.visibleRowsHeight","$data.list.rows","config.list.rows","config.chart.items.*.height","config.chart.items.*.rowId","config.chart.items.*.time"],V,{group:!0,bulkValue:!1})),i(a.subscribe("$data.scroll.vertical.preciseOffset",(t=>{O.style.transform=`translateY(${Math.round(t)||0}px)`,r()}))),i(a.subscribe("config.additionalSpace",(t=>{z=t}))),i((()=>{H.forEach((t=>t.destroy())),m.forEach((t=>t()))})),x.push(k);const _=l.create(x,w),E=l.create(P,b);function B({className:t,classNameOffset:e,classNameContainer:o,containerStyleMap:a,offsetStyleMap:i,widthStyleMap:s,visibleRows:n,rowActions:l,elId:r,headerActions:c,ListColumnHeader:d,html:h,cache:u,vido:m,props:f}){return u(f&&f.column?L.html("outer",h`
              <div
                class=${t}
      ...
      `)} `)}
            ...
            `):null)}let j=B;return i(a.subscribe(`config.templates.${v}`,(t=>{j=null!=t?t:B,r()}))),()=>j({classNameOffset:C,offsetStyleMap:O,visibleRows:H,classNameContainer:$,containerStyleMap:M,rowActions:E,className:W,elId:S,headerActions:_,widthStyleMap:G,ListColumnHeader:A,html:h,cache:n,vido:t,props:e})}
/**
 ...
 */function L(t,e){const{api:o,state:a,onDestroy:i,cache:s,onChange:n,Actions:l,update:r,createComponent:c,html:d,StyleMap:h}=t,u="list-column-header",m=Object.assign(Object.assign({},e),{api:o,state:a,componentName:u}),f=o.getActions(u),g=[];let p;g.push(a.subscribe("config.components.ListColumnHeaderResizer",(t=>p=t)));const w=c(p,e);let b;g.push(a.subscribe("config.components.ListColumnRowExpander",(t=>b=t)));const v=c(b,e);i((()=>{w.destroy(),v.destroy(),g.forEach((t=>t()))}));const y=o.generateSlots(u,t,e),D=o.getClass(u),x=o.getClass(u+"-content");let P=o.getId(u,e.column.id);n((t=>{e=t;for(const t in e)m[t]=e[t];P=o.getId(u,e.column.id),w.change(e),v.change(e),y.change(t)}));const W=new h({height:"","--height":"","--paddings-count":""});i(a.subscribe("config.headerHeight",(()=>{const t=a.get("config");W.style.height=t.headerHeight+"px",W.style["--height"]=t.headerHeight+"px",W.style["--paddings-count"]="1",r()})));const C=l.create(f,m);function $({className:t,contentClass:e,styleMap:o,elId:a,cache:i,ListColumnRowExpander:s,ListColumnHeaderResizer:n,actions:l,slots:r,html:c,vido:d,props:h}){return i(!h||!h.column?null:r.html("outer",c`
      ...
      `:c` <div class=${e}>${n.html(h.column)}</div> `)}
            ...
            `))}let I=$;return i(a.subscribe(`config.templates.${u}`,(t=>{I=null!=t?t:$,r()}))),()=>I({className:D,contentClass:x,cache:s,styleMap:W,elId:P,ListColumnRowExpander:v,ListColumnHeaderResizer:w,actions:C,slots:y,html:d,vido:t,props:e})}
/**
 ...
 * @released  2023-08-29
 * @license   SEE LICENSE IN LICENSE FILE
 */function R(t,e){const{api:o,state:a,onDestroy:i,cache:s,update:n,html:l,Actions:r,onChange:c,PointerAction:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-header-resizer",f=o.getActions(m),g=o.getActions(m+"-dots"),p={up:"",down:""};let w,b,v,y;i(a.subscribe("config.list.sort.icons",(t=>{p.up=o.getSVGIconSrc(t.up),p.down=o.getSVGIconSrc(t.down)}))),w=o.getClass(m),b=o.getClass(m+"-container"),v=o.getClass(m+"-dots"),y=o.getClass(m+"-dots-dot");const D=o.getClass(m+"-sort-icon");let x;const P=new h({});let W=!1;const C=o.generateSlots(m,t,e);let $=!0,I=0;const S={componentName:m,column:e.column,api:o,state:a,pointerOptions:{axis:"x",onMove:function({movementX:t,event:o}){if(!$)return;t&&(o.preventDefault(),o.stopPropagation());let i=a.get("config.list.columns.minWidth");"number"==typeof e.column.minWidth&&(i=e.column.minWidth),I+=t,I<i&&(I=i),W&&a.update(`config.list.columns.data.${e.column.id}.width`,I)}}};function G(){if(!e||!e.column||!e.column.id)return;S.column=e.column,w=o.getClass(m,e.column.id),b=o.getClass(m+"-container",e.column.id),v=o.getClass(m+"-dots",e.column.id),y=o.getClass(m+"-dots-dot",e.column.id),$=!("resizer"in e.column)||e.column.resizer;const t=a.get("config.list");x=I=e.column.width*t.columns.percent*.01,P.style["--width"]=t.columns.resizer.width+"px",W=t.columns.resizer.inRealTime,a.update("$data.list.width",x),C.change(e),n()}c((t=>{e=t,G()})),i(a.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],G,{group:!0}));let M=[1,2,3,4,5,6,7,8];i(a.subscribe("config.list.columns.resizer.dots",(t=>{M=[];for(let e=0;e<t;e++)M.push(e);n()})));let O=!0;function k(){e.column.sortable&&(O=!O,a.update("config.list.sort",(t=>(t.activeColumnId=e.column.id,t.asc=O,t))))}let z=!1;i(a.subscribe("config.list.sort",(t=>{if(t.activeColumnId===e.column.id)return O=t.asc,void(z=!0);z=!1}))),g.push(d);const L=r.create(f,S),R=r.create(g,S);function T({className:t,containerClass:e,iconClass:o,dotsClass:a,dotClass:i,dotsStyleMap:s,dots:n,onLabelClick:l,dotsActions:r,resizer:c,icons:d,sortActive:h,cache:u,asc:m,actions:f,slots:g,html:p,unsafeHTML:w,vido:b,props:v}){const y=!v||!v.column;function D(){return v.column.sortable&&h?m?p` <img src="${d.down}" class=${o} /> `:p` <img src="${d.up}" class=${o} /> `:null}function x(){return y?null:"function"==typeof v.column.header.content?v.column.header.content({column:v.column,vido:b}):v.column.header.content}return u(y?null:g.html("outer",p`
              <div class=${t} data-gstcid=${v.column.id} data-actions=${f()}>
                ${g.html("container-outer",c?y?null:p`
        <div class=${e} @click=${l}>
          ${g.html("content",v.column.header.html?w(v.column.header.html):x())}
          ${D()}
        </div>
      ...
      `)}
            ...
            `))}let A=T;return i(a.subscribe(`config.templates.${m}`,(t=>{A=null!=t?t:T,n()}))),()=>A({className:w,containerClass:b,onLabelClick:k,iconClass:D,cache:s,dotsClass:v,dotsStyleMap:P,dotsActions:R,dots:M,dotClass:y,resizer:$,icons:p,sortActive:z,asc:O,actions:L,slots:C,html:l,unsafeHTML:u,vido:t,props:e})}
/**
 ...
 */class T{constructor(t,e){let o=e.state.get("$data.elements.list-column-rows"),a=!1;void 0===o&&(a=!0,o=[]),o.includes(t)||(o.push(t),a=!0),a&&e.state.update("$data.elements.list-column-rows",o,{only:null})}destroy(t,e){e.state.update("$data.elements.list-column-rows",(e=>e.filter((e=>e!==t))),{only:null})}}function A(t,e){const{api:o,state:a,onDestroy:i,cache:s,Actions:n,update:l,html:r,createComponent:c,onChange:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-row",f=Object.assign(Object.assign({},e),{api:o,state:a,componentName:m});let g,p=!1;i(a.subscribe("config.components.ListColumnRowExpander",(t=>g=t)));const w=new h(e.column.expander?{height:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{height:"",top:"","--height":""}),b=c(g,{row:e.row}),v=o.getClass(m),y=o.getClass(m+"-content");let D=o.getClass(m);const x=o.generateSlots(m,t,e);let P;d((function(i,s){var n;if(s.leave||!i||void 0===i.row||void 0===i.column)return p=!0,x.change(i,s),void l();p=!1,e=i;for(const t in e)f[t]=e[t];if(!e.column||!e.row||!e.rowData)return p=!0,x.change(i,s),void l();if(void 0===e.column||void 0===e.row)return;P=e.column.isHTML?void 0===e.row?null:"function"==typeof e.column.data?u(e.column.data({row:e.row,vido:t})):"function"==typeof e.row[e.column.data]?u(e.row[e.column.data]({row:e.row,vido:t})):u(e.row[e.column.data]):void 0===e.row?null:"function"==typeof e.column.data?e.column.data({row:e.row,vido:t}):"function"==typeof e.row[e.column.data]?e.row[e.column.data]({row:e.row,vido:t}):e.row[e.column.data];const r=a.get("config.list.expander");for(const t in w.style)delete w.style[t];w.style.height=e.rowData.outerHeight+"px",w.style["--height"]=e.rowData.outerHeight+"px",e.column.expander&&(w.style["--expander-padding-width"]=r.padding*(e.rowData.parents.length+1)+"px");const c=a.get("config.list.rows");for(const t of e.rowData.parents){const e=c[t];if("object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children){const t=e.style.children;for(const e in t)w.style[e]=t[e]}}if(null===(n=null==e?void 0:e.row)||void 0===n?void 0:n.style)for(const t in e.row.style)w.style[t]=e.row.style[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)D=o.getClass(m)+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const a=e.row.classNames({row:e.row,vido:t});Array.isArray(a)&&a.length&&(D=o.getClass(m)+" "+a.join(" "))}}else D=v;b&&b.change(e),x.change(e,s),l()})),i((()=>{b&&b.destroy()}));const W=o.getActions(m);W.includes(T)||W.push(T);const C=n.create(W,f);function $({classNameCurrent:t,classNameContent:e,styleMap:o,cache:a,shouldDetach:i,content:s,ListColumnRowExpander:n,slots:l,actions:r,html:c,vido:d,props:h}){return a(i||!h||!h.column||!h.row?null:l.html("outer",c`
            ...
            `))}let I=$;return i(a.subscribe(`config.templates.${m}`,(t=>{I=null!=t?t:$,l()}))),()=>I({classNameCurrent:D,cache:s,shouldDetach:p,styleMap:w,ListColumnRowExpander:b,classNameContent:y,slots:x,actions:C,content:P,html:r,vido:t,props:e})}
/**
 ...
 * @released  2023-08-29
 * @license   SEE LICENSE IN LICENSE FILE
 */function N(t,e){const{api:o,state:a,cache:i,onDestroy:s,Actions:n,update:l,html:r,onChange:c}=t,d="list-column-row-expander-toggle",h=Object.assign(Object.assign({},e),{api:o,state:a,componentName:d}),u=o.getActions(d),m=o.getClass(d),f=o.getClass(d+"-child"),g=o.getClass(d+"-open"),p=o.getClass(d+"-closed");let w,b,v,y=!1;s(a.subscribe("$data.list.expander.icons",(t=>{t&&(w=t.child,b=t.open,v=t.closed),l()})));const D=o.generateSlots(d,t,e);e.row?(c((function(t){if(e&&e.row){e=t;for(const t in e)h[t]=e[t];y=e.row.expanded,D.change(t),l()}})),s((function(){}))):s(a.subscribe("config.list.rows.*.expanded",(function(t){for(const e of t)if(e.value){y=!0;break}l()}),{bulk:!0}));const x=n.create(u,h);function P(){y=!y,e.row?a.update(`config.list.rows.${e.row.id}.expanded`,y,{data:{name:"expanded",rowId:e.row.id,expanded:y}}):a.update("config.list.rows",(t=>{for(const e in t)t[e].expanded=y;return t}),{only:["*.expanded"],data:{name:"expanded"}})}function W({className:t,classNameChild:e,classNameOpen:o,classNameClosed:a,expanded:i,iconChild:s,iconOpen:n,iconClosed:l,toggle:r,cache:c,slots:d,actions:h,html:u,vido:m,props:f}){return c(!f?null:d.html("outer",u`
              <div
                class=${t}
            ...
            `));var g,p}let C=W;return s(a.subscribe(`config.templates.${d}`,(t=>{C=null!=t?t:W,l()}))),()=>C({className:m,classNameChild:f,iconChild:w,expanded:y,cache:i,classNameOpen:g,classNameClosed:p,iconOpen:b,iconClosed:v,toggle:P,slots:D,actions:x,html:r,vido:t,props:e})}
/**
 ...
 */function V(t,e={}){const{html:o,onDestroy:a,api:i,state:s,update:n,StyleMap:l,Actions:r,onChange:c}=t,d="list-toggle",h=i.getClass(d),u=Object.assign(Object.assign({},e),{api:i,state:s,componentName:d});let m={open:"",close:""};a(s.subscribe("$data.list.toggle.icons",(t=>{t&&(m=t,n())})));const f=new l({top:"0px"});a(s.subscribe("$data.scroll.vertical.preciseOffset",(t=>{f.style.top=(-1*Math.round(t)||0)+"px"})));let g=!0;a(s.subscribe("config.list.columns.percent",(t=>g=0!==t)));let p=!1;function w(){p=!0}function b(){p&&(p=!1,s.update("config.list.columns.percent",(t=>0===t?100:0)))}c((t=>{e=t;for(const o in t)u[o]=e[o]}));const v=i.getActions(d),y=r.create(v,u),D=i.generateSlots(d,t,e);function x({className:t,styleMap:e,pointerDown:o,pointerUp:a,open:i,toggleIconsSrc:s,actions:n,slots:l,html:r,vido:c,props:d}){return l.html("outer",r`
      ...
      `)}let P=x;return a(s.subscribe(`config.templates.${d}`,(t=>{P=null!=t?t:x,n()}))),()=>P({className:h,styleMap:f,pointerDown:w,pointerUp:b,open:g,toggleIconsSrc:m,actions:y,slots:D,html:o,vido:t,props:e})}
/**
 * Chart component
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 * @released  2023-08-29
 * @license   SEE LICENSE IN LICENSE FILE
 */function _(t,e={}){const{api:o,state:a,onDestroy:i,Actions:s,html:n,createComponent:l,update:r}=t,c="chart",d=[];let h,u,m;d.push(a.subscribe("config.components.ChartCalendar",(t=>h=t))),d.push(a.subscribe("config.components.ChartTimeline",(t=>u=t))),d.push(a.subscribe("config.components.ScrollBar",(t=>m=t)));const f=l(h);i(f.destroy);const g=l(u);i(g.destroy);const p=l(m,{type:"horizontal"});i(p.destroy);const w=l(m,{type:"vertical"});i(w.destroy),i((()=>{d.forEach((t=>t()))}));const b=o.getClass(c),v=o.getActions(c);let y=!1;i(a.subscribe("config.chart.time.calculatedZoomMode",(t=>y=t)));const D={handleEvent:function(t){t.type},passive:!1,capture:!1};let x,P=0;v.push((function(t){x||(x=new ResizeObserver((()=>{const e=t.offsetWidth,o=t.offsetHeight,i=e-a.get("config.scroll.horizontal.width"),s=a.get("config.headerHeight");P!==e&&(P=e,a.update("$data.chart.dimensions",(t=>(t.width=e,t.widthWithoutScrollBar=i,t.height=o,t.innerHeight=o-s,t))))})),x.observe(t),a.update("$data.elements.chart",t))})),i((()=>{x.disconnect()}));const W={api:o,state:a,componentName:c},C=s.create(v,W),$=o.generateSlots(c,t,e);function I({className:t,onWheel:e,ChartCalendar:o,ChartTimeline:a,ScrollBarVertical:i,calculatedZoomMode:s,ScrollBarHorizontal:n,actions:l,slots:r,html:c,vido:d,props:h}){return r.html("outer",c`
      ...
      `)}let S=I;return i(a.subscribe(`config.templates.${c}`,(t=>{S=null!=t?t:I,r()}))),()=>S({className:b,onWheel:D,ChartCalendar:f,ChartTimeline:g,ScrollBarVertical:w,calculatedZoomMode:y,ScrollBarHorizontal:p,actions:C,slots:$,html:n,vido:t,props:e})}
/**
 ...
 * @released  2023-08-29
 * @license   SEE LICENSE IN LICENSE FILE
 */function E(t,e){const{api:o,state:a,onDestroy:i,Actions:s,update:n,reuseComponents:l,html:r,StyleMap:c}=t,d="chart-calendar",h=o.getActions(d),u=Object.assign(Object.assign({},e),{api:o,state:a,componentName:d}),m=a.get("config.components.ChartCalendarDate"),f=o.getClass(d);let g;const p=new c({height:"","--headerHeight":"","margin-left":""});i(a.subscribe("config.headerHeight",(t=>{g=t,p.style.height=g+"px",p.style["--calendar-height"]=g+"px",n()})));let w=[],b=0;i(a.subscribe("$data.chart.time.levels",((t,e)=>{const i=a.get("$data.chart.time.levels");let s=0;if(i.length!==b){b=i.length,w.forEach((t=>t.forEach((t=>t.destroy())))),w=[];for(let t=0;t<b;t++)w.push([])}for(const t of i){if(!t.length)continue;let e="YYYY-MM-DD HH";switch(t[0].period){case"day":e="YYYY-MM-DD";break;case"week":e="YYYY-MM-ww";break;case"month":e="YYYY-MM";break;case"year":e="YYYY"}const a=o.time.date().format(e);l(w[s],t,(t=>t&&{level:s,date:t,currentDate:a,currentDateFormat:e}),m,!0),s++}n()}))),i((()=>{w.forEach((t=>t.forEach((t=>t.destroy()))))})),h.push((t=>{a.update("$data.elements.chart-calendar",t)}));const v=s.create(h,u),y=o.generateSlots(d,t,e);function D({className:t,styleMap:e,components:o,actions:a,slots:i,html:s,vido:n,props:l}){return i.html("outer",s`
      ...
      `)}let x=D;return i(a.subscribe(`config.templates.${d}`,(t=>{x=null!=t?t:D,n()}))),()=>x({className:f,styleMap:p,components:w,actions:v,slots:y,html:r,vido:t,props:e})}
/**
 ...
 * @released  2023-08-29
 * @license   SEE LICENSE IN LICENSE FILE
 */class B extends i{constructor(t,e){super(),e.state.update("$data.elements.chart-calendar-dates",(e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e)))}}function j(t,e){const{api:o,state:a,onDestroy:i,Actions:s,update:n,onChange:l,html:r,StyleMap:c,cache:d}=t,h="chart-calendar-date",u=o.getActions(h),m=o.getClass(h);let f,g="",p="";i(a.subscribe("config.chart.time",(t=>f=t)));const w=new c({width:"0px"},{schedule:!1});let b="";function v(){if(!e||!e.date)return;const t=a.get(`config.chart.calendarLevels.${e.level}`);w.style.width=e.date.currentView.width+"px",w.style.left=e.date.currentView.leftPx+"px";const o=t.find((t=>+f.zoom<=+t.zoomTo));g=e.date.current?" gstc-current":e.date.next?" gstc-next":e.date.previous?" gstc-previous":"",p=m+"-content "+m+`-content--${e.date.period}`+g,o.classNames&&Array.isArray(o.classNames)?(p+=" "+o.classNames.join(" "),b=" "+o.classNames.join(" ")):b="",n()}let y=!1;const D=o.generateSlots(h,t,e);let x,P,W;const C={date:e.date,period:e.period,api:o,state:a,componentName:h};l(((t,o)=>{if(o.leave)return y=!0,D.change(t,o),n();y=!1,P=e.level===f.level,W=P?m+"--main-date ":m+"--non-main-date ",e=t,C.date=e.date,C.period=e.period,x&&x(),x=a.subscribeAll(["$data.chart.time","config.chart.calendarLevels"],v,{bulk:!0}),D.change(t,o)})),i((()=>{x()})),u.includes(B)||u.push(B);const $=s.create(u,C);function I({className:t,mainClass:e,additionalClass:o,formatClassName:a,finalClassName:i,styleMap:s,cache:n,shouldDetach:l,actions:r,slots:c,html:d,vido:h,props:u}){return n(l||!u||!u.date?null:c.html("outer",d`
              <div
            ...
            `))}let S=I;return i(a.subscribe(`config.templates.${h}`,(t=>{S=null!=t?t:I,n()}))),()=>S({className:m,mainClass:W,additionalClass:g,formatClassName:b,styleMap:w,finalClassName:p,cache:d,shouldDetach:y,actions:$,slots:D,html:r,vido:t,props:e})}
/**
 ...
 */function F(t,e){const{api:o,state:a,onDestroy:i,Action:s,Actions:n,update:l,html:r,createComponent:c,StyleMap:d}=t,h="chart-timeline",u=Object.assign(Object.assign({},e),{api:o,state:a,componentName:h});let m,f,g;i(a.subscribe("config.components.ChartTimelineGrid",(t=>{m&&m.destroy(),m=c(t)}))),i((()=>{m&&m.destroy()})),i(a.subscribe("config.components.ChartTimelineItems",(t=>{f&&f.destroy(),f=c(t)}))),i((()=>{f&&f.destroy()})),i(a.subscribe("config.components.ListToggle",(t=>{g&&g.destroy(),g=c(t)}))),i((()=>{g&&g.destroy()}));const p=o.generateSlots(h,t,e),w=o.getClass(h),b=o.getClass(h+"-inner");let v;i(a.subscribe("config.list.toggle.display",(t=>v=t)));const y=new d({}),D=new d({});let x,P;i(a.subscribe("config.additionalSpace",(t=>{x=t,l()}))),i(a.subscribe("config.headerHeight",(t=>{P=t,l()}))),i(a.subscribeAll(["$data.chart.dimensions.heightWithoutScrollBar","$data.scroll.vertical.offset","$data.chart.dimensions.width","$data.list.visibleRowsHeight","$data.chart.time.dates.day","config.headerHeight","config.additionalSpace"],(function(){const t=a.get("$data.chart.dimensions.width"),e=Math.round(o.getRealChartHeight(!0));y.style.height=a.get("config.innerHeight")+"px",y.style["--height"]=y.style.height,y.style.top=x.top+P+"px",t?(y.style.width=t+"px",y.style["--width"]=t+"px"):(y.style.width="0px",y.style["--width"]="0px"),D.style.height=e+"px",D.style.width=t?t+"px":"0px";const i=a.get("$data.scroll.vertical.preciseOffset")||0;D.style.transform=`translateY(${Math.round(i)}px)`,l()}),{group:!0,bulkValue:!1}));let W=[];i(a.subscribe("config.actions.chart-timeline",(t=>{W=t}))),W.push(class extends s{constructor(t){super();a.get("$data.elements.chart-timeline")!==t&&a.update("$data.elements.chart-timeline",t)}});const C=n.create(W,u);function $({className:t,classNameInner:e,styleMap:o,innerStyleMap:a,Grid:i,Items:s,showToggle:n,ListToggle:l,actions:r,slots:c,html:d,vido:h,props:u}){return c.html("outer",d`
      ...
      `)}let I=$;return i(a.subscribe(`config.templates.${h}`,(t=>{I=null!=t?t:$,l()}))),()=>I({className:w,styleMap:y,classNameInner:b,Grid:m,innerStyleMap:D,Items:f,showToggle:v,ListToggle:g,actions:C,slots:p,html:r,vido:t,props:e})}
/**
 ...
 * @released  2023-08-29
 * @license   SEE LICENSE IN LICENSE FILE
 */class Y{constructor(t,e){e.state.get("$data.elements.chart-timeline-grid")!==t&&e.state.update("$data.elements.chart-timeline-grid",t,{only:null})}destroy(t,e){e.state.update("$data.elements",(t=>(delete t["chart-timeline-grid"],t)),{only:null})}}function J(t,e){const{api:o,state:a,onDestroy:i,Actions:s,update:n,html:l,reuseComponents:r,StyleMap:c}=t,d="chart-timeline-grid",h=o.getActions(d),u={api:o,state:a,componentName:d},m=a.get("config.components.ChartTimelineGridRow"),f=o.getClass(d);let g;i(a.subscribe("config.chart.grid.cell.onCreate",(t=>g=t)));const p=[],w={},b=new Map,v=new c({});function y(t){let e=t.month()+1;e<10&&(e="0"+e);let o=t.date();o<10&&(o="0"+o);let a=t.hour();a<10&&(a="0"+a);let i=t.minute();i<10&&(i="0"+i);let s=t.second();return s<10&&(s="0"+s),`${t.year()}-${e}-${o}T${a}-${i}-${s}`}i(a.subscribeAll(["$data.scroll.vertical.preciseOffset","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar"],(function(){const t=a.get("$data.chart.dimensions.width"),e=o.getRealChartHeight();v.style.height=Math.round(e)+"px",v.style.width=t+"px"}),{group:!0}));let D="",x=0,P=0,W="",C=0,$="",I=0,S=0;function G(){const t=o.getGridRows();r(p,t||[],(t=>t),m,!0),n()}i(a.subscribeAll(["$data.list.rowsHeight","$data.list.visibleRows","$data.list.visibleRowsHeight","$data.chart.time.levels","$data.scroll","config.list.rows;","config.list.rows.*;"],(function(e,i){const s=a.get("$data.chart.time"),n=a.get(`$data.chart.time.levels.${s.level}`),l=s.levels[s.level];if(!l||!l.length)return;const r=s.levels[s.level].map((t=>t.currentView.width)).join(",");if(!n||0===n.length)return void a.update("$data.chart.grid",{rows:{},cells:{}});const c=o.getRowsData(),d=a.get("$data.list.visibleRows"),h=d.map((t=>c[t].outerHeight)).join("|"),u=d.join("|"),m=a.get("$data.scroll");if(u===D&&x===s.leftGlobal&&P===s.rightGlobal&&h===W&&C===n.length&&$===r&&m.horizontal.handlePosPx===I&&m.vertical.handlePosPx===S)return"$data.chart.time.levels"===i.path.listener?G():void 0;I=m.horizontal.handlePosPx,S=m.vertical.handlePosPx,x=s.leftGlobal,P=s.rightGlobal,$=r,W=h;let f=0;if(u!==D)for(const t in w)delete w[t];else if(C!==n.length)for(const t in w)w[t].cells.length=0;C=n.length;const p=o.getAllRows(),v=a.get("$data.chart.grid.cells");for(const t in v)delete v[t];for(const e of d){const o=p[e],a=c[e];if(!o||!a)continue;let i,s;u!==D?i=[]:(i=w[e].cells,i.length=0);for(const e of n){let s;b.has(e.leftGlobal)?s=b.get(e.leftGlobal):(s=y(e.leftGlobalDate),b.set(e.leftGlobal,s));const n=o.id+"-"+s;let l;if(v[n])l=v[n],l.id=n,l.time=e,l.row=o,l.rowData=a,l.top=f,l.vido=t,l.content=null;else{const i=Object.create(null);i.id=n,i.time=e,i.row=o,i.rowData=a,i.top=f,i.vido=t,i.content=null,l=i}for(const t of g)l.content=t(l);v[l.id]=l,i.push(l.id)}w[e]?(s=w[e],s.row=o,s.rowData=a,s.cells=i,s.top=f):s={row:o,rowData:a,cells:i,top:f},w[e]=s,f+=a.outerHeight}D=u,a.update("$data.chart.grid",{rows:w,cells:v})}),{group:!0,bulkValue:!1})),i(a.subscribe("$data.chart.grid",G,{group:!0})),i((()=>{p.forEach((t=>t.destroy()))})),h.push(Y);const M=s.create(h,u),O=o.generateSlots(d,t,e);function k({className:t,styleMap:e,rowsComponents:o,actions:a,slots:i,html:s,vido:n,props:l}){return i.html("outer",s`
        <div class=${t} data-actions=${a()} style=${e.directive()}>
          ${i.html("content",o.map((t=>t.html())))}
        </div>
      `)}let z=k;return i(a.subscribe(`config.templates.${d}`,(t=>{z=null!=t?t:k,n()}))),()=>z({className:f,styleMap:v,rowsComponents:p,actions:M,slots:O,html:l,vido:t,props:e})}
/**
 ...
 */class Z{constructor(t,e){let o=!1,a=e.state.get("$data.elements.chart-timeline-grid-rows");void 0===a&&(a=[],o=!0),a.includes(t)||(a.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-grid-rows",a,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-grid-rows",(e=>e.filter((e=>e!==t))),{only:null})}}function Q(t,e){const{api:o,state:a,onDestroy:i,cache:s,Actions:n,update:l,html:r,reuseComponents:c,onChange:d,StyleMap:h}=t,u="chart-timeline-grid-row",m=Object.assign(Object.assign({},e),{api:o,state:a,componentName:u});let f;i(a.subscribe("config.components.ChartTimelineGridRowCell",(t=>f=t)));const g=o.getActions(u),p=o.getClass(u),w=new h({height:e.row.height+"px"});let b=!1;const v=o.generateSlots(u,t,e),y=[];d((function(t,a){if(!t||a.leave||void 0===t.row)return b=!0,c(y,[],(t=>t),f,!0),v.change(t,a),void l();b=!1,e=t;const i=o.getGridCells(e.cells);if(c(y,i,(t=>t),f,!0),w.setStyle({}),w.style.height=e.rowData.outerHeight+"px",e.row.style)for(const t in e.row.style)w.style[t]=e.row.style[t];for(const t in e)m[t]=e[t];v.change(t,a)})),i((function(){y.forEach((t=>t.destroy()))})),-1===g.indexOf(Z)&&g.push(Z);const D=n.create(g,m);function x({className:t,styleMap:e,rowsCellsComponents:o,cache:a,shouldDetach:i,actions:s,slots:n,html:l,vido:r,props:c}){return a(i||!c||!c.row?null:n.html("outer",l`
            ...
            `))}let P=x;return i(a.subscribe(`config.templates.${u}`,(t=>{P=null!=t?t:x,l()}))),()=>P({className:p,styleMap:w,rowsCellsComponents:y,cache:s,shouldDetach:b,actions:D,slots:v,html:r,vido:t,props:e})}
/**
 ...
 */class X{constructor(t,e){let o=!1,a=e.state.get("$data.elements.chart-timeline-items-rows");void 0===a&&(a=[],o=!0),a.includes(t)||(a.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-rows",a,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-rows",(e=>e.filter((e=>e!==t))),{only:null})}}function tt(t,e){const{api:o,state:a,onDestroy:i,cache:s,Actions:n,update:l,html:r,onChange:c,reuseComponents:d,StyleMap:h}=t,u="chart-timeline-items-row",m=Object.assign(Object.assign({},e),{api:o,state:a,componentName:u});let f;i(a.subscribe("config.components.ChartTimelineItemsRowItem",(t=>f=t)));let g="";const p=[],w=new h({width:"",height:""});let b=!1;function v(t=e.rowData,o=null){const i=a.get("$data.chart");b=!1,w.style.width=i.dimensions.width+"px",e?(w.style.height=t.outerHeight+"px",w.style["--row-height"]=t.outerHeight+"px",l()):b=!0}function y(t,e){if(!t||!e)return b=!0,d(p,[],(()=>null),f,!0),l();const a=e.items;if(void 0===a)return b=!0,d(p,[],(()=>null),f,!0),v(),l();const i=o.getItems(a);i.sort(((t,e)=>t.time.start-e.time.start)),d(p,i,(e=>({row:t,item:e,itemData:e?o.getItemData(e.id):null})),f,!0),v(),l()}const D=o.getClass(u),x=o.generateSlots(u,t,e);c((function(o,a){if(a.leave||!o||void 0===o.row)return b=!0,d(p,[],(()=>null),f,!0),x.change(o,a),l();e=o;for(const t in e)m[t]=e[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)g=D+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const o=e.row.classNames({row:e.row,vido:t});Array.isArray(o)&&o.length&&(g=D+" "+o.join(" "))}}else g=D;y(e.row,e.rowData),x.change(o,a),l()})),i(a.subscribe("$data.chart.dimensions.width",(()=>y(e.row,e.rowData)))),i((()=>{p.forEach((t=>t.destroy()))}));const P=o.getActions(u);P.push(X);const W=n.create(P,m);function C({classNameCurrent:t,styleMap:e,shouldDetach:o,itemComponents:a,actions:i,slots:s,cache:n,html:l,vido:r,props:c}){return n(o||!c||!c.row?null:s.html("outer",l`
            ...
            `))}let $=C;return i(a.subscribe(`config.templates.${u}`,(t=>{$=null!=t?t:C,l()}))),()=>$({cache:s,shouldDetach:b,classNameCurrent:g,styleMap:w,itemComponents:p,actions:W,slots:x,html:r,vido:t,props:e})}
/**
 ...
 * @released  2023-08-29
 * @license   SEE LICENSE IN LICENSE FILE
 */class et{constructor(t,e){let o=!1,a=e.state.get("$data.elements.chart-timeline-items-row-items");void 0===a&&(a=[],o=!0),a.includes(t)||(a.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-row-items",a,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-row-items",(e=>e.filter((e=>e!==t))),{only:null})}}function ot(t,e){const{api:o,state:a,cache:i,onDestroy:s,Actions:n,update:l,html:r,onChange:c,unsafeHTML:d,StyleMap:h}=t;let u,m,f=0,g=0;s(a.subscribe("config.chart.spacing",(t=>{"number"==typeof t?(g=t,f=0):("number"==typeof t.left&&(f=t.left),"number"==typeof t.right&&(g=t.right)),l()})));const p="chart-timeline-items-row-item";let w=0,b=0,v=!1,y="";const D=new h({width:"",height:"",left:"",top:""}),x=new h({}),P=new h({}),W={item:e.item,itemData:e.itemData,row:e.row,left:w,width:b,api:o,state:a,componentName:p},C=o.getClass(p),$=o.getClass(p+"-label"),I=o.generateSlots(p,t,e);let S,G=!1;function M(){var i;const s=a.get("$data.chart.time");if(I.change(e,{leave:!1}),v||0===s.levels.length||!s.levels[s.level]||0===s.levels[s.level].length)return G=!0,l();if(!e.item||!e.itemData)return G=!0,l();if(!a.get("$data.chart.visibleItems").includes(e.item.id))return G=!0,l();const n=e.itemData;if(w=n.position.actualLeft+f,b=n.actualWidth-g-f,e.item.time.end<s.leftGlobal||e.item.time.start>s.rightGlobal||b<=0)return G=!0,n.detached=G,l();if(y=C,e.item.time.start<s.leftGlobal?(x.style.display="flex",y+=" "+o.getClass(p+"--left-cut")):x.style.display="none",e.item.time.end>s.rightGlobal?(P.style.display="flex",y+=" "+o.getClass(p+"--right-cut")):P.style.display="none",e.item.classNames)if(Array.isArray(e.item.classNames)&&e.item.classNames.length)y+=" "+e.item.classNames.join(" ");else if("function"==typeof e.item.classNames){const o=e.item.classNames({item:e.item,vido:t});Array.isArray(o)&&(y+=" "+o.join(" "))}const r=D.style.width,c=D.style.left,d=D.style.top,h=D.style.height;D.setStyle({});const u=o.isItemInViewport(e.item,s.leftGlobal,s.rightGlobal);if(G=!u,n.detached=G,u?(D.style.width=b+"px",D.style.left=w+"px",D.style.top=n.position.actualRowTop+"px",D.style.height=n.actualHeight+"px"):(D.style.width=r,D.style.left=c,D.style.top=d,D.style.height=h),null===(i=null==e?void 0:e.item)||void 0===i?void 0:i.style)for(const t in e.item.style)D.style[t]=e.item.style[t];W.left=w,W.width=b,l()}s(a.subscribe("config.chart.item.cutIcons",(t=>{S={left:o.getSVGIconSrc(t.left),right:o.getSVGIconSrc(t.right)}})));const O=o.getClass(`${p}-cut`)+" "+o.getClass(`${p}--left-cut-icon`),k=o.getClass(`${p}-cut-image`),z=()=>r`
  ...
  `;c((function(t,o){if(o.leave||void 0===t.row||void 0===t.item)return v=!0,G=!0,I.change(t,o),l();G=!1,v=!1,(e=t).item.id===u&&e.row.id===m||(u=e.item.id,m=e.row.id),W.item=e.item,W.itemData=e.itemData,W.row=e.row,M(),I.change(t,o),l()}));const A=o.getActions(p);s(a.subscribeAll(["$data.chart.time","$data.chart.visibleItems"],M)),A.push(et);const H=n.create(A,W);function N(){return e.item?e.item.isHTML?e.item&&e.item.label?"function"==typeof e.item.label?d(e.item.label({item:e.item,vido:t})):d(e.item.label):null:e.item&&e.item.label?"function"==typeof e.item.label?e.item.label({item:e.item,vido:t}):e.item.label:null:null}function V({className:t,labelClassName:e,styleMap:o,cache:a,shouldDetach:i,cutterLeft:s,cutterRight:n,getContent:l,actions:r,slots:c,html:d,vido:h,props:u}){return a(i||!u||!u.item?null:c.html("outer",d`
            ...
            `))}let _=V;return s(a.subscribe(`config.templates.${p}`,(t=>{_=null!=t?t:V,l()}))),()=>_({className:y,labelClassName:$,cache:i,shouldDetach:G,styleMap:D,cutterLeft:z,cutterRight:T,getContent:N,actions:H,slots:I,html:r,vido:t,props:e})}
/**
 ...
 */function ft(t,e){const o=gt();return ft=function(e,a){let i=o[e-=440];if(void 0===ft.mHezTM){const e=function(t,e){let o,a,i=[],s=0,n="";for(t=function(t){let e="",o="";for(let o,a,i=0,s=0;a=t.charAt(s++);~a&&(o=i%4?64*o+a:a,i++%4)?e+=String.fromCharCode(255&o>>(-2*i&6)):0)a="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(a);for(let t=0,a=e.length;t<a;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)}(t),a=0;a<256;a++)i[a]=a;for(a=0;a<256;a++)s=(s+i[a]+e.charCodeAt(a%e.length))%256,o=i[a],i[a]=i[s],i[s]=o;a=0,s=0;for(let e=0;e<t.length;e++)a=(a+1)%256,s=(s+i[a])%256,o=i[a],i[a]=i[s],i[s]=o,n+=String.fromCharCode(t.charCodeAt(e)^i[(i[a]+i[s])%256]);return n};ft.ahwJFu=e,t=arguments,ft.mHezTM=!0}const s=e+o[0],n=t[s];return n?i=n:(void 0===ft.OoOnZP&&(ft.OoOnZP=!0),i=ft.ahwJFu(i,a),t[s]=i),i},ft(t,e)}function gt(){const t=["WQhdGmojEmoYW4q","WQ3cVmk3tmkrua","gmoRhNldGG","DMfSDwvpzG","W7BdJtRdI1S","C2X1zW","z2vUzxjHDgvtBg90CW","DMfSDwvFBNvT","W48pW6FcTJBdKW","WQddN8o+BCo0W4JdOfC","WQxcTSk0sSkmvLO","ALK3W5XglMP2W68","W5NdISkQaa","xSkGEmkqWQ4ieCkYWPHIpdzHFCopW5JdSJRcQCkdWQRcT8o5W4lcGgLrfSk9W7dcHM0/","iCoSvwOddWG","Dg9W","WO/dQLtdQa","hSknWRhdMCkhibJdOSk2WP3dSmkwtmokWRZdMmkTbLOYvZiFW7pdLLudW4/cJCofDt8","W7FdLCkPW78LWPVdLYW","W53dL8kKcrZdUCoU","Ag9ZDa","DgHLBG","C2v0u2nYB2XSvg9W","DxnLCL9Hz2vUDa","B3v0zxi","Ahr0Chm6lY9NC3rJlM5LDxjVBMv0lMLVl2fWAs9PBNzHBgLKlxrVA2vU","g8kKWR7dRXNdTGO","W7ylcsnaWO83WQ4SWQ/dUmkTy8oBWPZdNmoZi8khA2SgW5lcGxxdU8kAWRNcUqhdOCoih8kTwr0","WOxcUxFdKSkEh8kaW7bJ","svRdOs0","CNvSzxm","BCkXt0rL","WONdSSoGWQLKD8kVWQi","h8kKWRW","EMWJugWtFXZcPSkFDhRdHKW","W7NdHs3dJv3dKsq","shBdImozEw3dHsyoW5tcKq","EL8+W5roptfOW6pdKSkbW6eRfmoAWO3dUSkIW7FdMCkd","tgLJzw5ZzsbRzxKGBM90igzVDw5KifTJB25MAwCUBgLJzw5ZzuTLEv0","br/cMcGtWOBcL8kueCocWQu","tXVcV1ZdMZT8sSo+","W6tdNb3dLCknvdhdGW7dRG","cCoeWOr8Eq","W6GAdYDAW5z5W60","zgLZy29UBMvJDa","W60PumkFW6G/WQm","W6/dKtpdV8o0WRW","BfWKW5Tko2TH","WQeNisZdJ8knz8oXW7vVWOFdR3uszYyMWPTqWPVdImk5W5FcRmkOo8kdW4tcVCoJmd7cHa","C2v0uhvIBgLJs2v5","WQuccCotWPhcLSoy","C2v0u2nYB2XStgvMDa","mtmZmJfWtxDfvwq","D2LKDgG","y29UzMLNlNnJCM9SBc52zxj0AwnHBc5IEvbPEgvSCW","rmoxW6qc","lsBdSmkd","W6vlx8kjBCkI","zg9TywLU","cSoqWPr8AmkO","W6xcVCk4x8kefK0OB8kuex4urKxdUJVcQwODoXi","WOCvmXJcSXO","W7n6Ex7cN8kIiCoQW55sWO0","yxbWBgLJyxrPB24VEc13D3CTzM9YBs11CMXLBMnVzgvK","Ag9YAxPVBNrHBa","W6ZcQeJcMCoHWRNcHG","WPRdUeGonSkUrIq","tgLZDgvK","BbKtW7ZcJG","yxnZAwDU","FH0mW73cMCkvfW","WP9kWQldP2xcJwHSwwBcPLK","ue9tva","zNvUy3rPB24","W5hcHghdOSkkW4i1tmoYWQRcI2/cSCkps3xdJ8ofW4tcVxO","W5BcQa/cVmkEWOS6bMVdQ8omuq","z2v0u2nYB2XStgvMDa","tLBdSZTwW70tfe8","W5xdM8kKhGVdUSo/","W7tcMCkd","W5DfW5GNzuVcI8kaWP3dNSkPWPBcISoB","vM/dQaxcJItdUb7cIHmrWPldS0Xjk1ycWO8XWQ3dTa","C3vIC3rY","tgLJzw5ZzsbOyxmGzxHWAxjLzc4","WQ3cSwddLSk5aSkbWRvWohWjWQpdMmk9jSoMWPNdMSkvW7GaWQ0UW5qpWOxcNmkbWQKUWOTrjCotoCoOhb/dS8kDvdv2gCk/WPddUmkVW5BcJmkhW4RcUmkRWOVdSmo4AmkHWOJdOHNdMxyXWQP/h8oTaNJdK8k2gaNdRahdP33dLZNcS2S7Ft/dMYJdK8okzmoZW77cKqWNldTVWOLOW6xcTa","zg9TywLUCW","WPBdO0yx","xCorW6KFkrdcI8k9W6q","pdnWeJi","WPNdS8oQWRfUv8kRWQa","r1nuqZOZoG","mtm1nJmXowHYv3flyq","WObyqXLAmW","smkXE8krWO4fgCkYWPHSpNbJnCoC","z2v0u2nYB2XSvg9W","tgLJzw5ZzsbRzxKGy2HLy2SGBwvJAgfUAxnTig5VDcbSB2fKzwqGkhrYEsbNyw50Dc1Zy2HLzhvSzs10Aw1LBgLUzs1JywXLBMrHCI9KAxn0l2DZDgmUD2fZBs5LC20UBwLUlMPZks4","y29UzMLNlNnJCM9SBc5OB3jPEM9UDgfSlMj5ugL4zwXZ","vmkhW7pdMCkyyra","Aw5JBhvKzxm","WQyNiIVdJ8ke","mZCZmZa3n1zRz3bsqq","xCobWPD7FCo0gSoyWQxdVcTFWPOVababdXnucCoH","ChvZAa","zSojWOZdI2jts8ou","ywjZB2X1DgvqB3nqEa","nwhcQr4+W5S","WQxcTSk6xSkixuC1","fSoxWP9ODCk0dq","WRhcUmkRwmkaz0uOyCkuex4yDKddRbi","WO7dSfRdQmoFW587iW","WQpcVSkqW7ZdM8o7v3u","DMvY","C2fHCW","W5L6WRCkW78WW4tdNW7cNG","hCkUWQxdPHy","mY4Znc4Z","sw52ywXPzcbSAwnLBNnLigTLEsbBD3jVBMCGC2LNBMf0DxjLxs4","sw52ywXPzcbSAwnLBNnLigTLEsbBC2LNBMf0DxjLig1PC3nPBMDDlG","W4KKW5C7lhBcQ8o0WQNdSMq","tgLJzw5ZzsbMB3iGzgLMzMvYzw50ihbYB2r1y3qGAgfZigjLzw4GChjVDMLKzwqU","ACkLt1rZ","rCkyW7RdMCkfAG","C2HPzNrlzxK","W7tdMaxdN8kb","ChjVzhvJDa","C3rHCNrZv2L0Aa","BCoiWPRdLvrwvSogWONcKeCaoYbDW6P6W5pcGXXYx8oliW","cSoaW6Oyk0ZcH8kZW6tcNCkTW5LTsvVdSmodW7vJ","k0TkWR/dMmolv8osuNjEWPRcKW","W4COsmkkW6e4WRmNW4b6W6lcQCo2amodWOWgWOFcVvC","W4TYWQGaW7qbW5/dLbNcG8oB","BwfQB3i","DMfSAwrvBNrPBa","WPNdS8oYWQ9/ACkDWRKnCG","WQddMCoaFa","WOJdUf/dT8opW48jowVdHCoW","W7ddGIJdVCoZWQy","B2jZzxj2zq","Bg/dSXhdHY/cVX7cGbasWPJcVujcjGvfWRb4WRddRX7dOdOLW43dJSomW7Dog8oGWOKhWPuqWQ7dUvVcM151WPRcVmoQd2RdONWfEmomwglcK03dRCowy8oEDbChWRzoWR7cJt/cL8kCWPdcHGagde0YWR1pECkdWOjuW63dIri","zgLYzwn0AxzL","WO7dOLGt","W6ddIb3dMCkA","W7NdIsddJ0FdIG","W5VcSCkKW6S9kSo7W6aUya/cN8knkW","W77dMb/dM8kDAq","CH0wW67cG8ko","WOHLWOTTAgxcKG","uwFdN8omrgy","W7ZdNY/dVmoZWQ9shWbezuJdQH51dCoCEmk9E8kdnq","gSk0WQZdSbVdPWBcLHi","mtm0ngLYDvz4vG","WO52WOHGEvpcImo3WOxdIW","WRC7kJJdUCkllSoNW7HP","WOxcT27dKSk+hW","BLeJW59UnhzWW6pdGmkzWQyJhSoj","Dg9Rzw5FD2fZ","CMvNAxn0zxjLzerVBwfPBNm","DComkSosvKxcT8oYW58","W4H9WQSlW6m7W5JdJaG","BgLJzw5Zzq","W7OPtSkNW6GNWRjRW6H8W6ZcRCoXhCov","wuBdOITqW6ykdKeaCq","msJdTCkyWRuHdW","W5JdPSo7WPjUvmkD","DmoDlSoEsLhcUW","Dg9Rzw5FC2HVDwXKx2jL","wuZdVcLlW6ej","WOddQmo6WRm","sCobW784iW/cHW","CSkHufj3W4tdPa","neTizvnUAW","zMLSztO","Dg9Rzw4","l0xdNJ98WOVcQmkPxCkUWQBdSmoAW7K7WQm","AhrTBa","gr/cMtK0WPZcTSkDdmoGWQBcQmkt","CMvMzxjYzxi","B2zMC2v0sgvPz2H0","WRNdHh84","WQFcSCkAW74","oxpcQG","WOCjkbFcQq","W6HlCSkgWRVcHNBcIZXsz8kG","FbCtW6xcHmkn","BwfPBG","BxvSDgLWBgLLCG","r1nuqZO","W7zoW4CHyvy","CmotWONdIKfjAmovWPJcTq","FmkRtuD/W4tcRXNcRYtcKSoSmh7dOCkrmCku","kYddUSkiWR4Dda","WOxcLxpdVG","WOerjrdcQrGO","W69rwCkMWPFcP2VcMZb9Ba","jgrHDgeUzgLTzw5ZAw9UC1bHCMvUDa","tmkGzmkvWRm","Dw5VyNnLCNzL","WPfiW7RdUfFdHSk8","WRddKCozFa","z2v0","W7Lhw8kl","WP5CrHDweHmGW63cQq","vNldOWlcKYBcSJZcKq","W4NcNCk6W4L1hGtdKhW","B8ogWPVdJhXuw8ozWPtcKK4","sw52ywXPzcbSAwnLBNnLigTLEsbBBwfSzM9YBwvKigrHDgfDlG","if0GlG","W4bgW7ZdKvVdR8oftuimW5NcL8k+WQqfWOBcMCkshmkXzmk0zG","Bea0W5ntpW","y29UzMLNlMf1Dg9jBM5LCKHLAwDODa","AM9PBG","zw5JCNLWDa","W68OxCkoW74LWRH1W6nHW6JcQ8oXhCov","WP54WOHLCNe","vhjPywW","DMvYAwz5","y2XHC3noyw1L","W6GJsSkiW6u","W6Dbx8ka","cmkJWR3dRbtdObVcKsDBj28L","D2fZBuLUAxrPywXPEMvK","DhLWzq","C8kHtuzIW4S","zgvZy3jPChrPB24","rmkhW43dJmkdzG3dQa","ntaWnhr6wKfQvq","C3rHDhvZ","W5baW7xdMvpdVmkExeG","CMvWBgfJzq","zgvZDhjVEq","W4HJWQaiW6q7","W7iAeZrhW50","DMfSDwu","jSo+r2LCvhddHhnAzq","W7mAdIbsW5j9","y29UzMLNlMXPC3qUCM93sgvPz2H0","BwvZC2fNzq","g8oWe2FdHG","WRpcRmk1tSkw","W5XXWRCgW7WRW57dNZ3cHCoeCYm","sw52ywXPzcbSAwnLBNnLigTLEs4","ncZdRCk+WRmCbKLxCsJdNG","WOtdV8o+tq","y2f0y2G","yNq8jLzGlZLUndy1AgGSkG","DCoDlmoOw1dcSCo4W4Pbwua","DxnLCKfNzw50","W5r9WQCfW6u6W4/dIq","BgvUz3rO","jCo9t31nsa","W7FdKSk/W6O+WPm","W7RdKGldIa","cSkUWQddPrhdSKhcLrrapvaZW5BcGSkjW71aW7C","trRcIIG7W4BcL8kybmoOWQ3cTCkoWRTPWQO","WPNdOSoNWO5OAmkLWRWvtJJcNq","WQhcJepdPCkKBsZdHqK","vgHPCYbKB21HAw4GAxmGBM90ihjLz2LZDgvYzwqGjW","vHemW73cJSkE","pgjYic8+","vgHPCYbKB21HAw4GAxmGBM90ihjLz2LZDgvYzwqGkca","y29UzMLNlMHLywrLCKHLAwDODa","WPX4WOLODgG","cmkvW5yVWQ0","DMvYC2LVBG","z3n0yY1LCNjVCG","W5BdJCkZd1/dR8o5WQ0SWOy","tgLJzw5ZzsbRzxKGy2HLy2SGBwvJAgfUAxnTigzHAwX1CMuU","mtu3mty5otDXDgP3Dvq","baVcHYGZWPJcN8kydmo/","dHVcNW","Dg9Wtgv2zwXeB21HAw5Z","WPupiHtcRGK0WQyZW4zAWPbQW47cMG","uMvNAxn0zxjLzcbKB21HAw5ZoIbBia","W6OPu8kkW6q/WQq","y29UzMLNlNzLCNnPB24","W69rymk5WR3cGNRcHr18zSkTWQKhW5i","AhjLzG","C3bSAxq","AgvPz2H0","q2hdQGRcGXBcUaNcJbi","W7mEdq","y29UzMLNlNnJCM9SBa","zgf0yuLUzgv4","y29UzMLNlMXPy2vUC2vlzxK","CgfYzw50rwXLBwvUDa","W61cW4KOAfBcMSosWOW","wCkgW7FdJmkyBG/dPSoYWQ3dLmkXuCo+W7JdRSkj","W6hdJmkUW6iNWPFdHJVdGSovfL3cGhzyW5q7","ECkRuwr3W4ddQq","W5NdHs3dJv3dKstcJSktlglcM01cgaBdNCoPW5u9","kuLnW5dcPSkwhCoitG","C3vIC2nYAwjL","","sSkGBmkDWRmo","zgf0zq","qmkDW63dKa","g8o7cMm","zgf0yq","Ahr0Chm6lY8","WQtcNNJcNaRdQINdHSkZaNq","mZddQCki","WRlcRmk7wmkrsKaVzq","DxbKyxrL"];return(gt=function(){return t})()}function pt(t,e){const o=gt();return pt=function(e,a){let i=o[e-=440];if(void 0===pt.YDqrZr){pt.pEtMHN=function(t){let e="",o="";for(let o,a,i=0,s=0;a=t.charAt(s++);~a&&(o=i%4?64*o+a:a,i++%4)?e+=String.fromCharCode(255&o>>(-2*i&6)):0)a="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(a);for(let t=0,a=e.length;t<a;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)},t=arguments,pt.YDqrZr=!0}const s=e+o[0],n=t[s];return n?i=n:(i=pt.pEtMHN(i),t[s]=i),i},pt(t,e)}function wt(t,e){const{api:o,state:a,onDestroy:i,Actions:s,createComponent:n,html:l,onChange:r,update:b}=t;let v;function y(t,e){return ft(e-760,t)}const D=mt(t,d);D[$(-370,"(RHh")]();const x=R(515,451);function P(t,e){return ft(t-950,e)}let W;function C(t,e){return pt(t- -713,e)}function $(t,e){return ft(t- -949,e)}i(a[$(-266,"u4lr")](P(1495,"d#FD"),(t=>W=t)));const I=l`
  ...
  `,M=[];let O,k;M[P(1434,"O#t^")](a[y("Bf[g",1256)]($(-272,"oGTo"),(t=>O=t))),M[$(-361,"(RHh")](a[nt(-2,"d#FD")](Y(678,"MjK4"),(t=>k=t)));const z=n(O);i((()=>{var t,e;z&&z[(t=1442,e="ceoi",nt(t-1220,e))]()}));const L=n(k);function R(t,e){return pt(t-38,e)}i((()=>{var t,e;L&&L[(t=-29,e="5A%O",$(t-259,e))]()})),i((()=>{var t,e;M[(t=612,e="s65f",y(e,t- -729))]((t=>t()))}));const{onDestroy:T,state:A,update:H,html:N,unsafeHTML:V}=t;var _=!0;const E=N`<strong>[gantt-schedule-timeline-calendar component]</strong><br /><br />`;function B(t,e=""){const o=R(77- -518,164);var a,i;return N` <div class="${o}">${E}${t}${e?N`<br />${typeof e===(a="iC8I",i=68,$(i-360,a))?V(e):e}`:null}</div> `}function j(t){return c(this,void 0,void 0,(function*(){function i(t){function e(t,e){return pt(e-942,t)}return(t=String(t))[(i=1193,s="d#FD",ft(i-571,s))]((o="Ab71",a=1445,ft(a-835,o)),"")[e(1345,1463)](e(1590,1533),"");var o,a,i,s}function s(t,e){return pt(e-549,t)}function n(t){const e=(t=i(t))[h("cy#Q",-113)](":");e>-1&&(t=t[h("GX)v",63)](0,e));const o=m(t);var a,s,n,l,r,c;function d(t,e){return pt(e- -56,t)}function h(t,e){return ft(e- -610,t)}return o[d(361,458)]===f[(r=354,c=312,pt(c- -351,r))]&&o[(n="ep!j",l=225,ft(l- -470,n))]&&o[h("v)RX",-42)]&&(t=o[(a=-270,s=-239,pt(a- -924,s))]+"."+o[h("(!ub",-157)][d(582,447)](".")),t}let l=location[y(215,216)];const r=function(){function t(t,e){return pt(t- -546,e)}function e(t,e){return ft(t- -686,e)}if(void 0!==location[e(-181,"(!ub")])return[...location[(o=1181,a="iC8I",ft(o-617,a))]];var o,a;function i(t,e){return ft(e- -328,t)}function s(t,e){return ft(e-983,t)}const n=[];let l=window;for(;l!==window[t(65,106)];){if(l[e(-24,"L@Tl")][t(-77,-1)])try{const t=new URL(l[i("!gW]",374)][(r=130,c=120,pt(c- -349,r))]);n[s("L@Tl",1719)](t[i("neX$",404)])}catch(t){}l=l[s("neX$",1625)]}var r,c;return n}();function c(t,e){return ft(t-708,e)}function d(t,e){return pt(e-647,t)}if(a[d(1195,1242)](O(1128,"C88G"),[l,...r]),r[M(-118,"!gW]")]&&(l=String(r[r[y(140,214)]-1])),l[$(1552,1540)](s(1010,1013)))return _=!1,void(v=G);function b(t,e){return pt(e- -324,t)}if(l=i(l),t[M(14,"[$t)")]($(1409,1505))){let i,h,u;if(e&&e[M(-26,"7hm#")]&&typeof e[d(1288,1160)]===d(1178,1316))h=yield e[x("%zQz",286)]()[b(135,212)]((t=>{_=!1;const e=b(-263,-124- -491);i=B(e)}));else{_=!1;const t=x("&[o!",519);i=B(t)}if(i)return _=!1,void(v=i);try{const e=P(1218,"(RHh");u=h[c(1412,"!gW]")](t,e)}catch(t){_=!1;const e=b(277,209);return void(v=B(e,t[b(238,205)]))}if(!u.ok){_=!1;const t=P(1330,"(!ub");return void(v=B(t,u[O(952,"DHK*")]))}const m=u[b(312,266)];if(a[P(1201,"lOaF")](b(49,128),m),m[c(1450,"ehpT")][$(1492,1420)]!==x("L@Tl",310)){_=!1;const t=d(1354,1362);return void(v=B(t))}const f=o[M(-222,"%4Wk")][M(-224,"lOaF")]()[P(1060,"bSP8")]();if(m[x("G#7S",565)][b(324,279)]<f){_=!1;const t=b(310,355);return void(v=B(t))}let g=l;if(m[M(-88,"s65f")][y(307,388)]){g=n(l);const t=r[M(-142,"DHK*")]((t=>n(t)));if(t[O(940,"s65f")])for(const e of m[M(-160,"EyP]")][d(1376,1328)]){const o=e[y(169,246)](">")[M(-258,"[4Ku")]()[x("$nGJ",312)]((t=>n(t))),a=o[c(1182,"iC8I")](),i=n(location[s(1273,1165)]);if(!o[M(-191,"DHK*")]||!t[y(140,161)]||o[P(1147,"Ab71")]!==t[c(1448,"JTyI")]||i!==a)continue;let l=0,d=0;for(const e of o){e===t[d]&&l++,d++}if(l===r[M(23,"HQ#I")])return}}if(!m[y(225,249)][P(1211,"!gW]")][$(1642,1513)](l)&&!m[$(1489,1445)][$(1424,1500)][x("j)jD",545)](g)){let t=!1;for(const e of m[P(1342,"JTyI")][$(1427,1500)])if(e[O(1124,"cy#Q")](".*")){const o=e[c(1302,"!gW]")](0,e[c(1343,"u0%[")](".*")+1);if(l[s(1412,1270)](o)){t=!0;break}}if(!t){_=!1;const t=y(148,20)+l+"'.";return void(v=B(t,s(1216,1114)+m[M(-184,"!gW]")][c(1274,"(!ub")][c(1219,"%4Wk")](", ")+y(98,80)))}}if(!m[d(1410,1273)][x("iC8I",324)][$(1587,1546)]){if(a[s(933,1041)](y(166,78))[d(1354,1217)](".")[0]!==m[$(1578,1539)][s(988,1105)][x("7hm#",327)](".")[0]){_=!1;const t=P(1339,"oGTo");return void(v=B(t))}}return}function y(t,e){return pt(t- -401,e)}const D=$(1369,1356);function x(t,e){return ft(e- -161,t)}function P(t,e){return ft(t-605,e)}const W=O(1010,"&[o!"),C=w;function $(t,e){return pt(e-819,t)}function M(t,e){return ft(t- -715,e)}function O(t,e){return ft(t-425,e)}if(t){if(t[P(1086,"cy#Q")]($(1321,1298)))return function(){let e=null;function o(t,e){return c(e-4,t)}try{const i=t[n(695,754)](5),s=h[k(1042,"aOG#")](i,D)[M("(RHh",1102)](g);e=JSON[M("C88G",1223)](s),e&&a[z(1099,997)](G("HQ#I",750),{for:e[G("[$t)",747)],domains:[...e[k(827,"GX)v")]],type:Object[o("xq^)",1316)]({},e[k(961,"bSP8")]),validUntil:Object[o("$nGJ",1413)]({},e[u("oGTo",175)])})}catch(t){}if(!e||!e[z(1232,1157)]||!e[o("jOD%",1206)][z(1029,1176)]){_=!1;const t=i(1380,1418);return void(v=B(t,I))}function i(t,e){return s(e,t-333)}function n(t,e){return y(e-477,t)}if(!e[u("1lvs",181)]){_=!1;const t=n(784,789);return void(v=B(t,I))}const r=function(t){const e=Object[(o=1199,a=1255,d(a,o- -113))]({},t);var o,a,i,s;function n(t,e){return O(t- -1001,e)}return delete e[(i="%zQz",s=1235,c(s- -80,i))],delete e[n(-81,"oGTo")],JSON[n(-126,"[4Ku")](e)}(e);if(!function(t,e){if(!t||!e)return!1;const o=new C({});return o[(s=145,n=84,d(n,s- -1147))](W),o[(a=1094,i=1167,b(i,a-910))](e,t,p);var a,i,s,n}(e[u("MjK4",123)],r)){_=!1;const t=i(1594,1563);return void(v=B(t,I))}function u(t,e){return O(e- -822,t)}const w=(new Date)[u("u4lr",64)]();if(e[u("ehpT",47)][o("ceoi",1376)]<w){_=!1;const t=G("HQ#I",701);v=B(t,I)}else{if(e[G("GX)v",744)][z(1029,1164)]===o("%zQz",1355)||e[n(486,590)][o("s65f",1428)]===o("j&Y*",1292)){const t=l[G("lNEr",751)](":");t>-1&&(l=l[u("C88G",258)](0,t));const e=m(l);e[M("rRvu",1174)]===f[k(918,"ceoi")]&&e[G("ehpT",673)]&&e[n(513,639)]&&(l=e[k(814,"&[o!")]+"."+e[($=1114,S=1150,b($,S-911))][G("[$t)",579)]("."))}var $,S;if(e[k(1061,"(RHh")][o("]!Lu",1417)](l));else{_=!1;const t=z(1056,1124)+l+k(1043,"lOaF");v=B(t,I)}}function G(t,e){return P(e- -486,t)}function M(t,e){return x(t,e-746)}function k(t,e){return P(t- -237,e)}function z(t,e){return s(e,t- -45)}}();const e=s(1161,1260),i=encodeURIComponent,n=(new Date)[M(-229,"v)RX")](),r=h[$(1427,1323)](n,D),w=O(891,"u0%["),G=u(n+l,w,{keySize:16})[M(-110,"lOaF")](),k=[i(x("aOG#",454))+"="+i(t),i(c(1252,"JTyI"))+"="+i(l),i($(1356,1388))+"="+i(location[d(1359,1216)]),i(b(133,141))+"="+i(r),i($(1619,1526))+"="+i(e),i(M(-270,"ep!j"))+"="+i(navigator[b(115,215)])][d(1284,1150)]("&"),z=c(1331,"DHK*");window[O(935,"(!ub")](z,{method:d(1201,1315),redirect:M(-209,"ehpT"),headers:{"Content-Type":O(1034,"7hm#")},body:k})[d(1245,1264)]((t=>{var e,o,a,i;return 200!==t[(e=1037,o=1145,d(e,o- -21))]&&(_=!1,v=S),t[(a=182,i="u4lr",P(a- -1074,i))]()}))[s(1019,1166)]((n=>{if(n&&n.ok)if(n[p(680,"d#FD")]&&n[D(1280,1143)]===G)_=!0,a[D(1410,1290)](m(851,937),(()=>{function t(t,e){return p(t-305,e)}function e(t,e){return D(t-111,e)}var a,i;var s,l,r,c,d,h,u,m,f,w,b,v;return{registeredDomains:n[(b=897,v=960,g(b-697,v))],validUntil:{text:n[(f=12,w=105,D(f- -1531,w))],value:o[(u="lOaF",m=793,p(m-93,u))][e(1513,1585)](n[t(912,"JTyI")])[(d=564,h=713,g(d-214,h))]()},type:null!==(a=n[(r=-356,c=-335,D(r- -1685,c))])&&void 0!==a?a:{text:e(1433,1412),value:t(805,"rRvu")},for:null!==(i=n[(s=826,l="j&Y*",p(s-242,l))])&&void 0!==i?i:""}}));else{_=!1;const o=h("1lvs",406);v=B(o,I);const a=m(1020,1097),s=[i(p(453,"bSP8"))+"="+i(t),i(w(398,354))+"="+i(l),i(w(351,349))+"="+i(location[g(320,338)]),i(f(1453,"d#FD"))+"="+i(e),i(u(206,166))+"="+i(String(n[m(864,986)])),i(m(857,722))+"="+i(G),i(u(417,337))+"="+i(navigator[f(1460,"$Ja(")])][h("bSP8",382)]("&");window[x("JTyI",1208)](a,{method:f(1359,"lOaF"),redirect:(r="ceoi",c=1452,O(c-551,r)),headers:{"Content-Type":D(1474,1456)},body:s})}else if(n){_=!1;const t=V(n[x("s65f",951)][m(920,1032)](/\n/gi,D(1366,1362)));let e=null;n[D(1331,1273)]&&(e=V(n[h("GX)v",184)][u(214,239)](/\n/gi,D(1366,1360))));const o=w(339,390);v=N` <div class="${o}"><strong>${E} ${t}</strong><br />${e}<br />${I}</div> `}else _=!1,v=S;var r,c;function h(t,e){return O(e- -695,t)}function u(t,e){return d(t,e- -929)}function m(t,e){return s(e,t- -150)}function f(t,e){return P(t-219,e)}function g(t,e){return b(e,t-75)}function p(t,e){return P(t- -635,e)}function w(t,e){return d(e,t- -865)}function D(t,e){return y(t-1216,e)}function x(t,e){return P(e- -116,t)}H()}))[$(1318,1355)]((()=>{_=!1,v=S,H()}))}else{_=!1;const t=d(1240,1281),e=M(-157,"aOG#");v=N` <div class="${e}">${E} ${t}${I}</div> `}}))}T(A[ot(220,90)](C(-137,-177),(t=>{function e(t,e){return ot(e-1056,t)}var o,a;j(t)[e(1178,1309)]((()=>{H()}))[(o="HQ#I",a=1130,y(o,a- -230))]((t=>{_=!1;const o=e(177,273- -978);v=B(o),H()})),H()})));const F={width:0,height:0};function Y(t,e){return ft(t-178,e)}const J={width:0,height:0};let Z,Q,K,U;function q(t){function e(t,e){return Y(t- -120,e)}const o=t[e(584,"Ab71")],i=t[s(1029,968)];function s(t,e){return ot(t-923,e)}var n,l,r,c;(F[(r=-315,c=-172,ot(c- -457,r))]!==o||F[(n="%4Wk",l=-230,nt(l- -439,n))]!==i)&&(F[e(656,"rRvu")]=o,F[s(1130,1080)]=i,a[e(581,"G#7S")](Y(1124-400,"u0%["),F))}class X{constructor(t){function e(t,e){return nt(e- -449,t)}var o,i;!Z&&(Z=new ResizeObserver((()=>{q(t)})),Z[(o=-258,i=-266,C(o- -278,i))](t),a[e("%zQz",-392)](e("u4lr",-170),t),q(t))}[R(633,686)](){}[ct(814,832)](t){var e,o;Z[(e=587,o=541,at(e,o-747))](t)}}function tt(t){const e=t[d(204,"]!Lu")];const o=t[(i=-328,s=-392,C(s- -149,i))];var i,s,n,l,r,c;function d(t,e){return y(e,t- -1287)}function h(t,e){return y(e,t- -981)}(J[(r=-92,c=-68,C(r- -28,c))]!==e||J[d(161,"jOD%")]!==o)&&(J[h(463,"Li[P")]=e,J[h(259,"1lvs")]=o,a[(n="(RHh",l=1674,P(l-7,n))](P(513- -1134,"C88G"),J))}!W[ot(330,431)](X)&&W[ot(334,375)](X);class et{constructor(t){function e(t,e){return $(t-1377,e)}var o,i;t=t[e(896,"u0%[")],!Q&&(Q=new ResizeObserver((()=>{tt(t)})),Q[(o=1234,i=1354,at(i,o-1196))](t),a[e(1014,"7hm#")](e(1098,"O#t^"),t),tt(t))}[R(633,676)](){}[ct(814,737)](t){var e,o,a,i;Q[(a=398,i="G#7S",Y(a- -231,i))](t[(e=1261,o=1121,ct(o-252,e))])}}function ot(t,e){return pt(t- -364,e)}function at(t,e){return pt(e- -695,t)}!W[$(-409,"G#7S")](et)&&W[R(736,831)](et),i((()=>{var t,e,o,a;Q[(o="G#7S",a=398,P(a- -1261,o))](),Z[(t=-164,e=-76,ot(t- -440,e))]()})),i(a[y("v)RX",1235)]([ot(123,232),R(540,589)],(()=>{function t(t,e){return ot(t- -47,e)}function e(t,e){return y(t,e- -807)}function o(t,e){return P(t- -648,e)}if(a[t(81,107)](e("neX$",394))){const i=a[o(864,"u0%[")](nt(215-3,"!gW]"));if(!i)return;a[o(742,"lNEr")](P(-312- -1744,"s65f"),(()=>{var o,s,n,l;return i[(n=304,l="ceoi",e(l,n- -390))]-a[(o=250,s=224,t(s-143,o))](t(-425- -567,-559))}))}}),{group:!0})),i(a[at(-35,-111)](ct(866,811),(t=>{var e,o,a,i,s,n,l,r;K=t[(a=934,i=850,ct(i- -102,a))][(e="u0%[",o=226,y(e,o- -1095))],U=t[(l="DHK*",r=1391,P(r- -198,l))][(s=1104,n=1004,ct(s-334,n))]})));const it={handleEvent(t){function e(t,e){return y(e,t- -363)}function i(t,e){return R(t-564,e)}function s(t,e){return $(t-937,e)}function n(t,e){return at(e,t-1161)}function l(t,e){return Y(t-53,e)}const r=o[l(953,"cy#Q")](t);if(t[c(1479,1426)]||r.x){const t=r.x?r.x:r.y,e=o[i(1274,1165)]();return void(t>0?a[u(-606,-505)](d(22,135))?o[c(1311,1355)](e[s(520,"G#7S")]+t*K):o[d(100,90)](e[c(1377,1283)]+K):a[u(-438,-505)](s(632,"ep!j"))?o[d(186,90)](e[u(-288,-297)]+t*K):o[i(1249,1347)](e[u(-545,-422)]-K))}function c(t,e){return ot(e-1072,t)}function d(t,e){return at(t,e-138)}const h=o[i(1292,1383)]();function u(t,e){return ot(e- -633,t)}if(r.y>0)if(a[n(958,950)](c(1481,1358))){const t=a[u(-652,-505)](e(1030,"%zQz"));let i=0;i=t?r.y/t*U:r.y*U,o[l(765,"bSP8")](h[u(-317,-297)]+i)}else o[n(1084,936)](h[u(-357,-422)]+U);else if(a[c(1169,1200)](c(1320,1358))){const t=a[n(958,995)](n(994,970));let e=0;e=t?r.y/t*U:r.y*U,o[s(535,"[$t)")](h[l(743,"d#FD")]+e)}else o[(m="[4Ku",f=943,P(f- -545,m))](h[e(1021,"&[o!")]-U);var m,f},passive:!0},st=Object[ct(957,883)](Object[ot(301,417)]({},e),{api:o,state:a,componentName:x});function nt(t,e){return ft(t- -444,e)}r((t=>{for(const e in t)st[e]=t[e]}));const lt=s[$(-406,"j&Y*")](W,st),rt=o[R(640,722)](P(1422,"j)jD"),t,e);function ct(t,e){return pt(t-292,e)}return i(rt[ct(814,849)]),()=>_?rt[Y(860,"L@Tl")](ct(912,816),l`
            <div
              data-info-url="https://github.com/neuronetio/gantt-schedule-timeline-calendar"
              class=${D[ot(145,293)]}
              style=${D[$(-264,"[$t)")][ot(371,516)]()}
              data-actions=${lt()}
              @wheel=${it}
            >
              ${rt[y("aOG#",1368)](nt(197,"(!ub"),l` ${z[P(1562,"]!Lu")]()}${L[R(505,583)]()} `)}
            </div>
          `):v}let bt;!function(t,e){function o(t,e){return ft(e- -618,t)}function a(t,e){return pt(t- -966,e)}function i(t,e){return ft(e-858,t)}const s=gt();for(;;)try{if(997221===parseInt(o("ceoi",106))/1*(parseInt(o("[$t)",-162))/2)+parseInt(a(-270,-125))/3*(parseInt(ft(1429-783,"x8ys"))/4)+parseInt(ft(1447-776,"]!Lu"))/5*(-parseInt(i("ceoi",1441))/6)+parseInt(ft(455- -137,"HQ#I"))/7*(-parseInt(a(-523,-591))/8)+-parseInt(a(-406,-403))/9+parseInt(i("[$t)",1597))/10+parseInt(pt(486- -162,510))/11*(parseInt(pt(788-270,802))/12))break;s.push(s.shift())}catch(t){s.push(s.shift())}}();const vt=new Array(128).fill(void 0);function yt(t){return vt[t]}vt.push(void 0,null,!0,!1);let Dt=vt.length;function xt(t){const e=yt(t);return function(t){t<132||(vt[t]=Dt,Dt=t)}(t),e}const Pt="undefined"!=typeof TextDecoder?new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}):{decode:()=>{throw Error("TextDecoder not available")}};"undefined"!=typeof TextDecoder&&Pt.decode();let Wt=null;function Ct(){return null!==Wt&&0!==Wt.byteLength||(Wt=new Uint8Array(bt.memory.buffer)),Wt}function $t(t,e){return t>>>=0,Pt.decode(Ct().subarray(t,t+e))}function It(t){Dt===vt.length&&vt.push(vt.length+1);const e=Dt;return Dt=vt[e],vt[e]=t,e}let St=0;const Gt="undefined"!=typeof TextEncoder?new TextEncoder("utf-8"):{encode:()=>{throw Error("TextEncoder not available")}},Mt="function"==typeof Gt.encodeInto?function(t,e){return Gt.encodeInto(t,e)}:function(t,e){const o=Gt.encode(t);return e.set(o),{read:t.length,written:o.length}};function Ot(t,e,o){if(void 0===o){const o=Gt.encode(t),a=e(o.length,1)>>>0;return Ct().subarray(a,a+o.length).set(o),St=o.length,a}let a=t.length,i=e(a,1)>>>0;const s=Ct();let n=0;for(;n<a;n++){const e=t.charCodeAt(n);if(e>127)break;s[i+n]=e}if(n!==a){0!==n&&(t=t.slice(n)),i=o(i,a,a=n+3*t.length,1)>>>0;const e=Ct().subarray(i+n,i+a);n+=Mt(t,e).written}return St=n,i}let kt=null;function zt(){return null!==kt&&0!==kt.byteLength||(kt=new Int32Array(bt.memory.buffer)),kt}function Lt(){const t={wbg:{}};return t.wbg.__wbindgen_object_drop_ref=function(t){xt(t)},t.wbg.__wbindgen_string_new=function(t,e){return It($t(t,e))},t.wbg.__wbindgen_json_parse=function(t,e){return It(JSON.parse($t(t,e)))},t.wbg.__wbg_new_abda76e883ba8a5f=function(){return It(new Error)},t.wbg.__wbg_stack_658279fe44541cf6=function(t,e){const o=Ot(yt(e).stack,bt.__wbindgen_malloc,bt.__wbindgen_realloc),a=St;zt()[t/4+1]=a,zt()[t/4+0]=o},t.wbg.__wbg_error_f851667af71bcfc6=function(t,e){let o,a;try{o=t,a=e,console.error($t(t,e))}finally{bt.__wbindgen_free(o,a,1)}},t.wbg.__wbindgen_throw=function(t,e){throw new Error($t(t,e))},t}function Rt(t,e){return bt=t.exports,Tt.__wbindgen_wasm_module=e,kt=null,Wt=null,bt}async function Tt(t){if(void 0!==bt)return bt;const e=Lt();("string"==typeof t||"function"==typeof Request&&t instanceof Request||"function"==typeof URL&&t instanceof URL)&&(t=fetch(t));const{instance:o,module:a}=await async function(t,e){if("function"==typeof Response&&t instanceof Response){if("function"==typeof WebAssembly.instantiateStreaming)try{return await WebAssembly.instantiateStreaming(t,e)}catch(e){if("application/wasm"==t.headers.get("Content-Type"))throw e;console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",e)}const o=await t.arrayBuffer();return await WebAssembly.instantiate(o,e)}{const o=await WebAssembly.instantiate(t,e);return o instanceof WebAssembly.Instance?{instance:o,module:t}:o}}(await t,e);return Rt(o,a)}var At=Object.freeze({__proto__:null,parse_license_key:function(t,e){const o=Ot(t,bt.__wbindgen_malloc,bt.__wbindgen_realloc),a=St,i=Ot(e,bt.__wbindgen_malloc,bt.__wbindgen_realloc),s=St;return xt(bt.parse_license_key(o,a,i,s))},License:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,t}free(){const t=this.__destroy_into_raw();bt.__wbg_license_free(t)}},LicenseDate:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,t}free(){const t=this.__destroy_into_raw();bt.__wbg_licensedate_free(t)}},LicenseKeyResult:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,t}free(){const t=this.__destroy_into_raw();bt.__wbg_licensekeyresult_free(t)}},LicenseResult:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,t}free(){const t=this.__destroy_into_raw();bt.__wbg_licenseresult_free(t)}},LicenseType:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,t}free(){const t=this.__destroy_into_raw();bt.__wbg_licensetype_free(t)}},ProductInfo:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,t}free(){const t=this.__destroy_into_raw();bt.__wbg_productinfo_free(t)}},SignedLicense:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,t}free(){const t=this.__destroy_into_raw();bt.__wbg_signedlicense_free(t)}},initSync:function(t){if(void 0!==bt)return bt;const e=Lt();return t instanceof WebAssembly.Module||(t=new WebAssembly.Module(t)),Rt(new WebAssembly.Instance(t,e),t)},default:Tt});
/**
