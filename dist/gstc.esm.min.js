 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */class P extends i{constructor(t,e,o){super(e,o),this.subs=[],this.name=t,this.subs.push(e.state.subscribe(`config.slots.${t}`,this.setComponents,{queue:!0}))}destroy(){this.subs.forEach(t=>t()),super.destroy()}getName(){return this.name}}function x(t,e,o){return new P(t,e,o)}
/**
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */const D="gstc";function W(t,e=""){let o=`${D}__${t}`;return t===D&&(o=D),e?`${o} ${o}--${e.replace(":","-")}`:o}function C(t,e){let o=`${D}__${t}`;return t===D&&(o=D),`${o}--${e}`}
/**
 * Api functions
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 */function G(t,e){const{onDestroy:o,state:i,cache:s,api:n,html:l,StyleMap:r,Actions:c,update:d}=t,h="scroll-bar";let u,m,g="",f="";o(i.subscribe("config.classNames",()=>{u=n.getClass(h),m=n.getClass(h+"-inner")}));const p="horizontal"===e.type?"height":"width",w="height"===p?"width":"height",b="horizontal"===e.type?"left":"top",v=new r({}),y=new r({}),P={maxPosPx:0,innerHandleSize:0,scrollSize:0,dataId:""};o(i.subscribeAll("horizontal"===e.type?[`config.scroll.${e.type}`,`$data.scroll.${e.type}`]:[`config.scroll.${e.type}`,`$data.scroll.${e.type}`,"$data.chart.dimensions.heightWithoutScrollBar","$data.list.rowsWithParentsExpanded","$data.list.rowsHeight","config.additionalSpace"],function(t,o){const a=i.get(`config.scroll.${e.type}`),s=i.get(`$data.scroll.${e.type}`),l=n.getScrollSize(e.type),r=s.innerHandleSize,c=s.maxHandlePosPx,h=s.dataId,u=i.get("config.additionalSpace"),m=i.get("$data.chart.time");if(!m.allDates||!m.allDates.length||!m.allDates[m.level])return;if(s.visible?v.style.display="flex":v.style.display="none",v.style[p]=a.width+"px",v.style[w]=l+"px","vertical"===e.type&&(v.style.top=i.get("config.headerHeight")+u.top+"px"),!s.lastPageSize||!s.absoluteSize||!l)return;y.style[p]="100%",y.style[w]=r+"px";!("set-scroll-top"===o.options.data||"set-scroll-left"===o.options.data)&&function(t,e,o,i){const a=P.maxPosPx!==t||P.innerHandleSize!==e||P.scrollSize!==o||P.dataId!==i;return a&&(P.maxPosPx=t,P.innerHandleSize=e,P.scrollSize=o,P.dataId=i),a}(c,r,l,h)&&("horizontal"===e.type?a.byPixels?n.setScrollLeft(s.absolutePosPx):n.setScrollLeft(s.dataIndex,s.preciseOffset):a.byPixels?n.setScrollTop(s.absolutePosPx):n.setScrollTop(s.dataIndex,s.preciseOffset)),d()},{group:!0,bulkValue:!1}));const x=n.getActions(h);x.push(class extends a{constructor(t){super();const o=`$data.elements.scroll-bar--${e.type}`;i.get(o)||i.update(o,t,{only:null})}update(){}destroy(){}});const D={api:n,state:i,props:e,componentName:h},W=c.create(x,D),C=[class extends a{constructor(t){super(),this.moving=!1,this.initialPointerPos=0,this.initialHandlePos=0,this.currentPos=0,this.currentPointerPos=0,this.lastDataIndex=0,this.lastOffset=0,this.dataIndex=0,this.previousRowId="",i.update(`$data.elements.scroll-bar-inner--${e.type}`,t,{only:null}),this.bodyClassName=i.get("config.scroll.bodyClassName"),this.pointerDown=this.pointerDown.bind(this),this.pointerUp=this.pointerUp.bind(this);const o=this.pointerMove.bind(this);this.pointerMove=o,this.unsubscribe=i.subscribe(`$data.scroll.${e.type}`,this.dataChanged.bind(this)),this.destroy=this.destroy.bind(this),t.addEventListener("pointerdown",this.pointerDown),document.addEventListener("pointermove",this.pointerMove),document.addEventListener("pointerup",this.pointerUp)}destroy(t){this.unsubscribe(),t.removeEventListener("pointerdown",this.pointerDown),document.removeEventListener("pointermove",this.pointerMove),document.removeEventListener("pointerup",this.pointerUp)}dataChanged(){const t=i.get(`$data.scroll.${e.type}`),o=i.get("$data.chart.time");if(!o.allDates.length)return;const a=o.allDates[o.level],s=t.dataIndex;if(this.lastDataIndex=s,"horizontal"===e.type&&a&&a.length)this.currentPos=t.handlePosPx,y.style[b]=this.currentPos+"px",d();else if("vertical"===e.type){if(!i.get("$data.list.rowsWithParentsExpanded").length)return;this.currentPos=t.handlePosPx,y.style[b]=this.currentPos+"px",d()}}limitPosition(t){return Math.max(Math.min(t,i.get(`$data.scroll.${e.type}.maxHandlePosPx`)),0)}pointerDown(t){t.stopPropagation(),t.preventDefault(),n.muteMethod("calculateRowsHeight"),document.body.classList.add(this.bodyClassName),requestAnimationFrame(()=>{this.moving=!0,this.initialPointerPos="horizontal"===e.type?t.pageX:t.pageY,this.initialHandlePos=i.get(`$data.scroll.${e.type}.handlePosPx`),f=" "+n.getClass(h)+"-inner--active",g=" "+n.getClass(h)+"--active",d()})}pointerUp(t){this.moving&&(n.unmuteMethod("calculateRowsHeight"),t.preventDefault(),t.stopPropagation(),document.body.classList.remove(this.bodyClassName)),this.moving=!1,f="",g="",d()}pointerMoveRead(t){this.currentPointerPos="horizontal"===e.type?t.pageX:t.pageY}pointerMoveWrite(){const t=i.get(`config.scroll.${e.type}`),o=i.get(`$data.scroll.${e.type}`),a=this.currentPointerPos-this.initialPointerPos;this.currentPos=this.limitPosition(this.initialHandlePos+a);const s=i.get("$data.chart.time");if(!s.allDates.length)return;const l=s.allDates[s.level],r=this.currentPos/o.maxHandlePosPx*o.absoluteSizeWithoutLastPage,c=Math.round(r);if("horizontal"===e.type){let e,o=0,i=0,a=0;for(let t=l.length;o<t&&(e=l[o],a=Math.round(e.rightPx),!(a>c));o++);t.precise&&a!==c&&(i=e.leftPx-r),o||(o=0),e||(e=l[0]),this.dataIndex=o,this.lastDate=l[o],t.byPixels?n.setScrollLeft(r):n.setScrollLeft(e.id,i),this.lastDataIndex=o,this.lastOffset=i}else{const{dataIndex:e,row:o,rowData:i}=n.getRowInfoFromTop(r);let a=0;t.precise&&i.position.top!==r&&(a=i.position.top-r),this.dataIndex=e,this.previousRowId=o.id,t.byPixels?n.setScrollTop(r):n.setScrollTop(e,a),this.lastDataIndex=e,this.lastOffset=a}}pointerMove(t){this.moving&&(t.stopPropagation(),t.preventDefault(),requestAnimationFrame(()=>{this.pointerMoveRead(t)}),requestAnimationFrame(()=>{this.pointerMoveWrite()}))}}],$=c.create(C,D),I=n.generateSlots(h,t,e);function S({classNameOuter:t,classNameOuterActive:e,classNameInner:o,classNameInnerActive:i,styleMapInner:a,styleMapOuter:s,innerActions:n,outerActions:l,slots:r,cache:c,html:d,vido:h,props:u}){return c(!u||!u.type?null:r.html("outer",d`
            ...
            `))}let M=S;return o(i.subscribe(`config.templates.${h}`,t=>{M=null!=t?t:S,d()})),()=>M({innerActions:$,outerActions:W,classNameOuter:u,classNameOuterActive:g,classNameInner:m,classNameInnerActive:f,cache:s,styleMapInner:y,styleMapOuter:v,slots:I,html:l,vido:t,props:e})}
/**
 * List component
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */class L{constructor(t,e){let o=!1,i=e.state.get("$data.elements.list-columns");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.list-columns",i,{only:null})}destroy(t,e){e.state.update("$data.elements.list-columns",e=>e.filter(e=>e!==t),{only:null})}}function O(t,e){const{api:o,state:i,onDestroy:a,onChange:s,cache:n,Actions:l,update:r,createComponent:c,reuseComponents:d,html:h,StyleMap:u}=t,m=[];let g,f;m.push(i.subscribe("config.components.ListColumnRow",t=>g=t)),m.push(i.subscribe("config.components.ListColumnHeader",t=>f=t));const p=Object.assign(Object.assign({},e),{api:o,state:i,componentName:"list-column"}),w={column:e.column,state:i,api:o,componentName:"list-column-headers"},b={api:o,state:i,componentName:"list-column-rows"},v="list-column",y=v+"-rows",P=v+"-rows-offset",x=o.getActions(v),D=o.getActions(y),W=o.getClass(v,e.column.id),C=o.getClass(P,e.column.id),$=o.getClass(y,e.column.id);let I,S=o.getId(v,e&&e.column?e.column.id:"");const M=new u({width:"","--width":""}),G=new u({height:""}),z=new u({"margin-top":"0px"});let O=i.get("config.additionalSpace");const R=o.generateSlots(v,t,e);let T;function k(){if(!e||!e.column)return;const t=i.get("config.list");if(!t.columns.data[e.column.id])return;I=t.columns.data[e.column.id].width*t.columns.percent*.01,T=I;const a=Math.round(o.getRealChartHeight());M.style.width=T+"px",M.style["--width"]=T+"px",z.style.height=a+"px",G.style.top=i.get("config.headerHeight")+O.top+"px"}a(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar","$data.list.width","$data.list.visibleRowsHeight","config.additionalSpace.top"],k,{group:!0}));const A=c(f,e);a(A.destroy);const _=[],N={};function V(){var t;if(!e||!e.column)return;i.mute(V);const a=i.get("$data.list.visibleRows")||[],s=o.getRows(a),n=o.getRowsData();for(const o of s){const i=N[o.id]=null!==(t=N[o.id])&&void 0!==t?t:{};i.column=e.column,i.row=o,i.rowData=n[o.id],i.width=T}for(const t in N)a.includes(t)||delete N[t];d(_,s,t=>t&&N[t.id],g,!0),R.change(e),i.unmute(V)}s(t=>{if((e=t)&&e.column&&e.column.id){S=o.getId(v,e&&e.column?e.column.id:"");for(const t in e)p[t]=e[t];k(),A.change(e),V()}}),a(i.subscribeAll(["$data.list.visibleRows","$data.list.visibleRowsHeight","$data.list.rows","config.list.rows","config.chart.items.*.height","config.chart.items.*.rowId","config.chart.items.*.time"],V,{group:!0,bulkValue:!1})),a(i.subscribe("$data.scroll.vertical.preciseOffset",t=>{z.style.transform=`translateY(${Math.round(t)||0}px)`,r()})),a(i.subscribe("config.additionalSpace",t=>{O=t})),a(()=>{_.forEach(t=>t.destroy()),m.forEach(t=>t())}),x.push(L);const H=l.create(x,w),B=l.create(D,b);function E({className:t,classNameOffset:e,classNameContainer:o,containerStyleMap:i,offsetStyleMap:a,widthStyleMap:s,visibleRows:n,rowActions:l,elId:r,headerActions:c,ListColumnHeader:d,html:h,cache:u,vido:m,props:g}){return u(g&&g.column?R.html("outer",h`
              <div
                class=${t}
      ...
      `)} `)}
            ...
            `):null)}let j=E;return a(i.subscribe(`config.templates.${v}`,t=>{j=null!=t?t:E,r()})),()=>j({classNameOffset:C,offsetStyleMap:z,visibleRows:_,classNameContainer:$,containerStyleMap:G,rowActions:B,className:W,elId:S,headerActions:H,widthStyleMap:M,ListColumnHeader:A,html:h,cache:n,vido:t,props:e})}
/**
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */function R(t,e){const{api:o,state:i,onDestroy:a,cache:s,onChange:n,Actions:l,update:r,createComponent:c,html:d,StyleMap:h}=t,u="list-column-header",m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:u}),g=o.getActions(u),f=[];let p;f.push(i.subscribe("config.components.ListColumnHeaderResizer",t=>p=t));const w=c(p,e);let b;f.push(i.subscribe("config.components.ListColumnRowExpander",t=>b=t));const v=c(b,e);a(()=>{w.destroy(),v.destroy(),f.forEach(t=>t())});const y=o.generateSlots(u,t,e),P=o.getClass(u),x=o.getClass(u+"-content");let D=o.getId(u,e.column.id);n(t=>{e=t;for(const t in e)m[t]=e[t];D=o.getId(u,e.column.id),w.change(e),v.change(e),y.change(t)});const W=new h({height:"","--height":"","--paddings-count":""});a(i.subscribe("config.headerHeight",()=>{const t=i.get("config");W.style.height=t.headerHeight+"px",W.style["--height"]=t.headerHeight+"px",W.style["--paddings-count"]="1",r()}));const C=l.create(g,m);function $({className:t,contentClass:e,styleMap:o,elId:i,cache:a,ListColumnRowExpander:s,ListColumnHeaderResizer:n,actions:l,slots:r,html:c,vido:d,props:h}){return a(!h||!h.column?null:r.html("outer",c`
              <div
                class=${t}
      ...
      `:c` <div class=${e}>${n.html(h.column)}</div> `)}
            ...
            `))}let I=$;return a(i.subscribe(`config.templates.${u}`,t=>{I=null!=t?t:$,r()})),()=>I({className:P,contentClass:x,cache:s,styleMap:W,elId:D,ListColumnRowExpander:v,ListColumnHeaderResizer:w,actions:C,slots:y,html:d,vido:t,props:e})}
/**
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */function T(t,e){const{api:o,state:i,onDestroy:a,cache:s,update:n,html:l,Actions:r,onChange:c,PointerAction:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-header-resizer",g=o.getActions(m),f=o.getActions(m+"-dots"),p={up:"",down:""};let w,b,v,y;a(i.subscribe("config.list.sort.icons",t=>{p.up=o.getSVGIconSrc(t.up),p.down=o.getSVGIconSrc(t.down)})),w=o.getClass(m),b=o.getClass(m+"-container"),v=o.getClass(m+"-dots"),y=o.getClass(m+"-dots-dot");const P=o.getClass(m+"-sort-icon");let x;const D=new h({});let W=!1;const C=o.generateSlots(m,t,e);let $=!0,I=0;const S={componentName:m,column:e.column,api:o,state:i,pointerOptions:{axis:"x",onMove:function({movementX:t,event:o}){if(!$)return;t&&(o.preventDefault(),o.stopPropagation());let a=i.get("config.list.columns.minWidth");"number"==typeof e.column.minWidth&&(a=e.column.minWidth),I+=t,I<a&&(I=a),W&&i.update(`config.list.columns.data.${e.column.id}.width`,I)}}};function M(){if(!e||!e.column||!e.column.id)return;S.column=e.column,w=o.getClass(m,e.column.id),b=o.getClass(m+"-container",e.column.id),v=o.getClass(m+"-dots",e.column.id),y=o.getClass(m+"-dots-dot",e.column.id),$=!("resizer"in e.column)||e.column.resizer;const t=i.get("config.list");x=I=e.column.width*t.columns.percent*.01,D.style["--width"]=t.columns.resizer.width+"px",W=t.columns.resizer.inRealTime,i.update("$data.list.width",x),C.change(e),n()}c(t=>{e=t,M()}),a(i.subscribeAll(["config.list.columns.percent","config.list.columns.resizer.width","config.list.columns.resizer.inRealTime"],M,{group:!0}));let G=[1,2,3,4,5,6,7,8];a(i.subscribe("config.list.columns.resizer.dots",t=>{G=[];for(let e=0;e<t;e++)G.push(e);n()}));let z=!0;function L(){e.column.sortable&&(z=!z,i.update("config.list.sort",t=>(t.activeColumnId=e.column.id,t.asc=z,t)))}let O=!1;a(i.subscribe("config.list.sort",t=>{if(t.activeColumnId===e.column.id)return z=t.asc,void(O=!0);O=!1})),f.push(d);const R=r.create(g,S),T=r.create(f,S);function k({className:t,containerClass:e,iconClass:o,dotsClass:i,dotClass:a,dotsStyleMap:s,dots:n,onLabelClick:l,dotsActions:r,resizer:c,icons:d,sortActive:h,cache:u,asc:m,actions:g,slots:f,html:p,unsafeHTML:w,vido:b,props:v}){const y=!v||!v.column;function P(){return v.column.sortable&&h?m?p` <img src="${d.down}" class=${o} /> `:p` <img src="${d.up}" class=${o} /> `:null}function x(){return y?null:"function"==typeof v.column.header.content?v.column.header.content({column:v.column,vido:b}):v.column.header.content}return u(y?null:f.html("outer",p`
              <div class=${t} data-gstcid=${v.column.id} data-actions=${g()}>
                ${f.html("container-outer",c?y?null:p`
        <div class=${e} @click=${l}>
          ${f.html("content",v.column.header.html?w(v.column.header.html):x())}
          ${P()}
        </div>
      ...
      `)}
            ...
            `))}let A=k;return a(i.subscribe(`config.templates.${m}`,t=>{A=null!=t?t:k,n()})),()=>A({className:w,containerClass:b,onLabelClick:L,iconClass:P,cache:s,dotsClass:v,dotsStyleMap:D,dotsActions:T,dots:G,dotClass:y,resizer:$,icons:p,sortActive:O,asc:z,actions:R,slots:C,html:l,unsafeHTML:u,vido:t,props:e})}
/**
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */class k{constructor(t,e){let o=e.state.get("$data.elements.list-column-rows"),i=!1;void 0===o&&(i=!0,o=[]),o.includes(t)||(o.push(t),i=!0),i&&e.state.update("$data.elements.list-column-rows",o,{only:null})}destroy(t,e){e.state.update("$data.elements.list-column-rows",e=>e.filter(e=>e!==t),{only:null})}}function A(t,e){const{api:o,state:i,onDestroy:a,cache:s,Actions:n,update:l,html:r,createComponent:c,onChange:d,StyleMap:h,unsafeHTML:u}=t,m="list-column-row",g=Object.assign(Object.assign({},e),{api:o,state:i,componentName:m});let f,p=!1;a(i.subscribe("config.components.ListColumnRowExpander",t=>f=t));const w=new h(e.column.expander?{height:"",top:"","--height":"","--expander-padding-width":"","--expander-size":""}:{height:"",top:"","--height":""}),b=c(f,{row:e.row}),v=o.getClass(m),y=o.getClass(m+"-content");let P=o.getClass(m);const x=o.generateSlots(m,t,e);let D;d(function(a,s){var n;if(s.leave||!a||void 0===a.row||void 0===a.column)return p=!0,x.change(a,s),void l();p=!1,e=a;for(const t in e)g[t]=e[t];if(!e.column||!e.row||!e.rowData)return p=!0,x.change(a,s),void l();if(void 0===e.column||void 0===e.row)return;D=e.column.isHTML?void 0===e.row?null:"function"==typeof e.column.data?u(e.column.data({row:e.row,vido:t})):"function"==typeof e.row[e.column.data]?u(e.row[e.column.data]({row:e.row,vido:t})):"string"==typeof e.row[e.column.data]?u(e.row[e.column.data]):null:void 0===e.row?null:"function"==typeof e.column.data?e.column.data({row:e.row,vido:t}):"function"==typeof e.row[e.column.data]?e.row[e.column.data]({row:e.row,vido:t}):e.row[e.column.data];const r=i.get("config.list.expander");for(const t in w.style)delete w.style[t];w.style.height=e.rowData.outerHeight+"px",w.style["--height"]=e.rowData.outerHeight+"px",e.column.expander&&(w.style["--expander-padding-width"]=r.padding*(e.rowData.parents.length+1)+"px");const c=i.get("config.list.rows");for(const t of e.rowData.parents){const e=c[t];if("object"==typeof e.style&&"Object"===e.style.constructor.name&&"object"==typeof e.style.children){const t=e.style.children;for(const e in t)w.style[e]=t[e]}}if(null===(n=null==e?void 0:e.row)||void 0===n?void 0:n.style)for(const t in e.row.style)w.style[t]=e.row.style[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)P=o.getClass(m)+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const i=e.row.classNames({row:e.row,vido:t});Array.isArray(i)&&i.length&&(P=o.getClass(m)+" "+i.join(" "))}}else P=v;b&&b.change(e),x.change(e,s),l()}),a(()=>{b&&b.destroy()});const W=o.getActions(m);W.includes(k)||W.push(k);const C=n.create(W,g);function $({classNameCurrent:t,classNameContent:e,styleMap:o,cache:i,shouldDetach:a,content:s,ListColumnRowExpander:n,slots:l,actions:r,html:c,vido:d,props:h}){return i(a||!h||!h.column||!h.row?null:l.html("outer",c`
              <div
                class=${t}
            ...
            `))}let I=$;return a(i.subscribe(`config.templates.${m}`,t=>{I=null!=t?t:$,l()})),()=>I({classNameCurrent:P,cache:s,shouldDetach:p,styleMap:w,ListColumnRowExpander:b,classNameContent:y,slots:x,actions:C,content:D,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */function N(t,e){const{api:o,state:i,cache:a,onDestroy:s,Actions:n,update:l,html:r,onChange:c}=t,d="list-column-row-expander-toggle",h=Object.assign(Object.assign({},e),{api:o,state:i,componentName:d}),u=o.getActions(d),m=o.getClass(d),g=o.getClass(d+"-child"),f=o.getClass(d+"-open"),p=o.getClass(d+"-closed");let w,b,v,y=!1;s(i.subscribe("$data.list.expander.icons",t=>{t&&(w=t.child,b=t.open,v=t.closed),l()}));const P=o.generateSlots(d,t,e);e.row?(c(function(t){if(e&&e.row){e=t;for(const t in e)h[t]=e[t];y=e.row.expanded,P.change(t),l()}}),s(function(){})):s(i.subscribe("config.list.rows.*.expanded",function(t){for(const e of t)if(e.value){y=!0;break}l()},{bulk:!0}));const x=n.create(u,h);function D(){y=!y,e.row?i.update(`config.list.rows.${e.row.id}.expanded`,y,{data:{name:"expanded",rowId:e.row.id,expanded:y}}):i.update("config.list.rows",t=>{for(const e in t)t[e].expanded=y;return t},{only:["*.expanded"],data:{name:"expanded"}})}function W({className:t,classNameChild:e,classNameOpen:o,classNameClosed:i,expanded:a,iconChild:s,iconOpen:n,iconClosed:l,toggle:r,cache:c,slots:d,actions:h,html:u,vido:m,props:g}){return c(!g?null:d.html("outer",u`
              <div
                class=${t}
            ...
            `));var f,p}let C=W;return s(i.subscribe(`config.templates.${d}`,t=>{C=null!=t?t:W,l()})),()=>C({className:m,classNameChild:g,iconChild:w,expanded:y,cache:a,classNameOpen:f,classNameClosed:p,iconOpen:b,iconClosed:v,toggle:D,slots:P,actions:x,html:r,vido:t,props:e})}
/**
 ...
 */function V(t,e={}){const{html:o,onDestroy:i,api:a,state:s,update:n,StyleMap:l,Actions:r,onChange:c}=t,d="list-toggle",h=a.getClass(d),u=Object.assign(Object.assign({},e),{api:a,state:s,componentName:d});let m={open:"",close:""};i(s.subscribe("$data.list.toggle.icons",t=>{t&&(m=t,n())}));const g=new l({top:"0px"});i(s.subscribe("$data.scroll.vertical.preciseOffset",t=>{g.style.top=(-1*Math.round(t)||0)+"px"}));let f=!0;i(s.subscribe("config.list.columns.percent",t=>f=0!==t));let p=!1;function w(){p=!0}function b(){p&&(p=!1,s.update("config.list.columns.percent",t=>0===t?100:0))}c(t=>{e=t;for(const o in t)u[o]=e[o]});const v=a.getActions(d),y=r.create(v,u),P=a.generateSlots(d,t,e);function x({className:t,styleMap:e,pointerDown:o,pointerUp:i,open:a,toggleIconsSrc:s,actions:n,slots:l,html:r,vido:c,props:d}){return l.html("outer",r`
      ...
      `)}let D=x;return i(s.subscribe(`config.templates.${d}`,t=>{D=null!=t?t:x,n()})),()=>D({className:h,styleMap:g,pointerDown:w,pointerUp:b,open:f,toggleIconsSrc:m,actions:y,slots:P,html:o,vido:t,props:e})}
/**
 * Chart component
 *
 * @copyright NEURONET - Rafal Pospiech
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */function H(t,e={}){const{api:o,state:i,onDestroy:a,Actions:s,html:n,createComponent:l,update:r}=t,c="chart",d=[];let h,u,m;d.push(i.subscribe("config.components.ChartCalendar",t=>h=t)),d.push(i.subscribe("config.components.ChartTimeline",t=>u=t)),d.push(i.subscribe("config.components.ScrollBar",t=>m=t));const g=l(h);a(g.destroy);const f=l(u);a(f.destroy);const p=l(m,{type:"horizontal"});a(p.destroy);const w=l(m,{type:"vertical"});a(w.destroy),a(()=>{d.forEach(t=>t())});const b=o.getClass(c),v=o.getActions(c);let y=!1;a(i.subscribe("config.chart.time.calculatedZoomMode",t=>{y=t,r()}));const P={handleEvent:function(t){t.type},passive:!1,capture:!1};let x,D=0;v.push(function(t){x||(x=new ResizeObserver(()=>{const e=t.offsetWidth,o=t.offsetHeight,a=e-i.get("config.scroll.horizontal.width"),s=i.get("config.headerHeight");D!==e&&(D=e,i.update("$data.chart.dimensions",t=>(t.width=e,t.widthWithoutScrollBar=a,t.height=o,t.innerHeight=o-s,t)))}),x.observe(t),i.update("$data.elements.chart",t))}),a(()=>{x.disconnect()});const W={api:o,state:i,componentName:c},C=s.create(v,W),$=o.generateSlots(c,t,e);function I({className:t,onWheel:e,ChartCalendar:o,ChartTimeline:i,ScrollBarVertical:a,calculatedZoomMode:s,ScrollBarHorizontal:n,actions:l,slots:r,html:c,vido:d,props:h}){return r.html("outer",c`
      ...
      `)}let S=I;return a(i.subscribe(`config.templates.${c}`,t=>{S=null!=t?t:I,r()})),()=>S({className:b,onWheel:P,ChartCalendar:g,ChartTimeline:f,ScrollBarVertical:w,calculatedZoomMode:y,ScrollBarHorizontal:p,actions:C,slots:$,html:n,vido:t,props:e})}
/**
 ...
 */function B(t,e){const{api:o,state:i,onDestroy:a,Actions:s,update:n,reuseComponents:l,html:r,StyleMap:c}=t,d="chart-calendar",h=o.getActions(d),u=Object.assign(Object.assign({},e),{api:o,state:i,componentName:d}),m=i.get("config.components.ChartCalendarDate"),g=o.getClass(d);let f;const p=new c({height:"","--headerHeight":"","margin-left":""});a(i.subscribe("config.headerHeight",t=>{f=t,p.style.height=f+"px",p.style["--calendar-height"]=f+"px",n()}));let w=[],b=0;a(i.subscribeAll(["$data.chart.time.levels","config.chart.time","$data.chart.time","config.chart.calendarLevels"],()=>{const t=i.get("$data.chart.time.levels");let e=0;if(t.length!==b){b=t.length,w.forEach(t=>t.forEach(t=>t.destroy())),w=[];for(let t=0;t<b;t++)w.push([])}for(const i of t){if(!i.length)continue;let t="YYYY-MM-DD HH";switch(i[0].period){case"day":t="YYYY-MM-DD";break;case"week":t="YYYY-MM-ww";break;case"month":t="YYYY-MM";break;case"year":t="YYYY"}const a=o.time.date().format(t);l(w[e],i,o=>o&&{level:e,date:o,currentDate:a,currentDateFormat:t},m,!0),e++}n()},{bulk:!0,bulkValue:!1})),a(()=>{w.forEach(t=>t.forEach(t=>t.destroy()))}),h.push(t=>{i.update("$data.elements.chart-calendar",t)});const v=s.create(h,u),y=o.generateSlots(d,t,e);function P({className:t,styleMap:e,components:o,actions:i,slots:a,html:s,vido:n,props:l}){return a.html("outer",s`
      ...
      `)}let x=P;return a(i.subscribe(`config.templates.${d}`,t=>{x=null!=t?t:P,n()})),()=>x({className:g,styleMap:p,components:w,actions:v,slots:y,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */class E extends a{constructor(t,e){super(),e.state.update("$data.elements.chart-calendar-dates",e=>(void 0===e&&(e=[]),e.includes(t)||e.push(t),e))}}function j(t,e){const{api:o,state:i,onDestroy:a,Actions:s,update:n,onChange:l,html:r,StyleMap:c,cache:d}=t,h="chart-calendar-date",u=o.getActions(h),m=o.getClass(h);let g,f="",p="";l(()=>{g=i.get("config.chart.time")});const w=new c({width:"0px"},{schedule:!1});let b="";let v=!1;const y=o.generateSlots(h,t,e);let P,x;const D={date:e.date,period:e.period,api:o,state:i,componentName:h};l((t,o)=>{if(o.leave)return v=!0,y.change(t,o),n();v=!1,P=e.level===g.level,x=P?m+"--main-date ":m+"--non-main-date ",e=t,D.date=e.date,D.period=e.period,function(){if(!e||!e.date)return;const t=i.get(`config.chart.calendarLevels.${e.level}`);w.style.width=e.date.currentView.width+"px",w.style.left=e.date.currentView.leftPx+"px";const o=t.find(t=>+g.zoom<=+t.zoomTo);f=e.date.current?" gstc-current":e.date.next?" gstc-next":e.date.previous?" gstc-previous":"",p=m+"-content "+m+`-content--${e.date.period}`+f,o.classNames&&Array.isArray(o.classNames)?(p+=" "+o.classNames.join(" "),b=" "+o.classNames.join(" ")):b="",n()}(),y.change(t,o)}),u.includes(E)||u.push(E);const W=s.create(u,D);function C({className:t,mainClass:e,additionalClass:o,formatClassName:i,finalClassName:a,styleMap:s,cache:n,shouldDetach:l,actions:r,slots:c,html:d,vido:h,props:u}){return n(l||!u||!u.date?null:c.html("outer",d`
              <div
            ...
            `))}let $=C;return a(i.subscribe(`config.templates.${h}`,t=>{$=null!=t?t:C,n()})),()=>$({className:m,mainClass:x,additionalClass:f,formatClassName:b,styleMap:w,finalClassName:p,cache:d,shouldDetach:v,actions:W,slots:y,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */function F(t,e){const{api:o,state:i,onDestroy:a,Action:s,Actions:n,update:l,html:r,createComponent:c,StyleMap:d}=t,h="chart-timeline",u=Object.assign(Object.assign({},e),{api:o,state:i,componentName:h});let m,g,f;a(i.subscribe("config.components.ChartTimelineGrid",t=>{m&&m.destroy(),m=c(t)})),a(()=>{m&&m.destroy()}),a(i.subscribe("config.components.ChartTimelineItems",t=>{g&&g.destroy(),g=c(t)})),a(()=>{g&&g.destroy()}),a(i.subscribe("config.components.ListToggle",t=>{f&&f.destroy(),f=c(t)})),a(()=>{f&&f.destroy()});const p=o.generateSlots(h,t,e),w=o.getClass(h),b=o.getClass(h+"-inner");let v;a(i.subscribe("config.list.toggle.display",t=>v=t));const y=new d({}),P=new d({});let x,D;a(i.subscribe("config.additionalSpace",t=>{x=t,l()})),a(i.subscribe("config.headerHeight",t=>{D=t,l()})),a(i.subscribeAll(["$data.chart.dimensions.heightWithoutScrollBar","$data.scroll.vertical.offset","$data.chart.dimensions.width","$data.list.visibleRowsHeight","$data.chart.time.dates.day","config.headerHeight","config.additionalSpace"],function(){const t=i.get("$data.chart.dimensions.width"),e=Math.round(o.getRealChartHeight(!0));y.style.height=i.get("config.innerHeight")+"px",y.style["--height"]=y.style.height,y.style.top=x.top+D+"px",t?(y.style.width=t+"px",y.style["--width"]=t+"px"):(y.style.width="0px",y.style["--width"]="0px"),P.style.height=e+"px",P.style.width=t?t+"px":"0px";const a=i.get("$data.scroll.vertical.preciseOffset")||0;P.style.transform=`translateY(${Math.round(a)}px)`,l()},{group:!0,bulkValue:!1}));let W=[];a(i.subscribe("config.actions.chart-timeline",t=>{W=t})),W.push(class extends s{constructor(t){super();i.get("$data.elements.chart-timeline")!==t&&i.update("$data.elements.chart-timeline",t)}});const C=n.create(W,u);function $({className:t,classNameInner:e,styleMap:o,innerStyleMap:i,Grid:a,Items:s,showToggle:n,ListToggle:l,actions:r,slots:c,html:d,vido:h,props:u}){return c.html("outer",d`
      ...
      `)}let I=$;return a(i.subscribe(`config.templates.${h}`,t=>{I=null!=t?t:$,l()})),()=>I({className:w,styleMap:y,classNameInner:b,Grid:m,innerStyleMap:P,Items:g,showToggle:v,ListToggle:f,actions:C,slots:p,html:r,vido:t,props:e})}
/**
 ...
 * @released  2025-09-10
 * @license   SEE LICENSE IN LICENSE FILE
 */class Y{constructor(t,e){e.state.get("$data.elements.chart-timeline-grid")!==t&&e.state.update("$data.elements.chart-timeline-grid",t,{only:null})}destroy(t,e){e.state.update("$data.elements",t=>(delete t["chart-timeline-grid"],t),{only:null})}}function Z(t,e){const{api:o,state:i,onDestroy:a,Actions:s,update:n,html:l,reuseComponents:r,StyleMap:c}=t,d="chart-timeline-grid",h=o.getActions(d),u={api:o,state:i,componentName:d},m=i.get("config.components.ChartTimelineGridRow"),g=o.getClass(d);let f;a(i.subscribe("config.chart.grid.cell.onCreate",t=>f=t));const p=[],w={},b=new Map,v=new c({});function y(t){let e=t.month()+1;e<10&&(e="0"+e);let o=t.date();o<10&&(o="0"+o);let i=t.hour();i<10&&(i="0"+i);let a=t.minute();a<10&&(a="0"+a);let s=t.second();return s<10&&(s="0"+s),`${t.year()}-${e}-${o}T${i}-${a}-${s}`}a(i.subscribeAll(["$data.scroll.vertical.preciseOffset","$data.chart.dimensions.width","$data.chart.dimensions.heightWithoutScrollBar"],function(){const t=i.get("$data.chart.dimensions.width"),e=o.getRealChartHeight();v.style.height=Math.round(e)+"px",v.style.width=t+"px"},{group:!0}));let P="",x=0,D=0,W="",C=0,$="",I=0,S=0;function M(){const t=o.getGridRows();r(p,t||[],t=>t,m,!0),n()}a(i.subscribeAll(["$data.list.rowsHeight","$data.list.visibleRows","$data.list.visibleRowsHeight","$data.chart.time.levels","$data.scroll","config.list.rows;","config.list.rows.*;"],function(e,a){const s=i.get("$data.chart.time"),n=i.get(`$data.chart.time.levels.${s.level}`),l=s.levels[s.level];if(!l||!l.length)return;const r=s.levels[s.level].map(t=>t.currentView.width).join(",");if(!n||0===n.length)return void i.update("$data.chart.grid",{rows:{},cells:{}});const c=o.getRowsData(),d=i.get("$data.list.visibleRows"),h=d.map(t=>c[t].outerHeight).join("|"),u=d.join("|"),m=i.get("$data.scroll");if(u===P&&x===s.leftGlobal&&D===s.rightGlobal&&h===W&&C===n.length&&$===r&&m.horizontal.handlePosPx===I&&m.vertical.handlePosPx===S)return"$data.chart.time.levels"===a.path.listener?M():void 0;I=m.horizontal.handlePosPx,S=m.vertical.handlePosPx,x=s.leftGlobal,D=s.rightGlobal,$=r,W=h;let g=0;if(u!==P)for(const t in w)delete w[t];else if(C!==n.length)for(const t in w)w[t].cells.length=0;C=n.length;const p=o.getAllRows(),v=i.get("$data.chart.grid.cells");for(const t in v)delete v[t];for(const e of d){const o=p[e],i=c[e];if(!o||!i)continue;let a,s;u!==P?a=[]:(a=w[e].cells,a.length=0);for(const e of n){let s;b.has(e.leftGlobal)?s=b.get(e.leftGlobal):(s=y(e.leftGlobalDate),b.set(e.leftGlobal,s));const n=o.id+"-"+s;let l;if(v[n])l=v[n],l.id=n,l.time=e,l.row=o,l.rowData=i,l.top=g,l.vido=t,l.content=null;else{const a=Object.create(null);a.id=n,a.time=e,a.row=o,a.rowData=i,a.top=g,a.vido=t,a.content=null,l=a}for(const t of f)l.content=t(l);v[l.id]=l,a.push(l.id)}w[e]?(s=w[e],s.row=o,s.rowData=i,s.cells=a,s.top=g):s={row:o,rowData:i,cells:a,top:g},w[e]=s,g+=i.outerHeight}P=u,i.update("$data.chart.grid",{rows:w,cells:v})},{group:!0,bulkValue:!1})),a(i.subscribe("$data.chart.grid",M,{group:!0})),a(()=>{p.forEach(t=>t.destroy())}),h.push(Y);const G=s.create(h,u),z=o.generateSlots(d,t,e);function L({className:t,styleMap:e,rowsComponents:o,actions:i,slots:a,html:s,vido:n,props:l}){return a.html("outer",s`
        <div class=${t} data-actions=${i()} style=${e.directive()}>
          ${a.html("content",o.map(t=>t.html()))}
        </div>
      `)}let O=L;return a(i.subscribe(`config.templates.${d}`,t=>{O=null!=t?t:L,n()})),()=>O({className:g,styleMap:v,rowsComponents:p,actions:G,slots:z,html:l,vido:t,props:e})}
/**
 ...
 */class q{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-grid-rows");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-grid-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-grid-rows",e=>e.filter(e=>e!==t),{only:null})}}function K(t,e){const{api:o,state:i,onDestroy:a,cache:s,Actions:n,update:l,html:r,reuseComponents:c,onChange:d,StyleMap:h}=t,u="chart-timeline-grid-row",m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:u});let g;a(i.subscribe("config.components.ChartTimelineGridRowCell",t=>g=t));const f=o.getActions(u),p=o.getClass(u),w=new h({height:e.row.height+"px"});let b=!1;const v=o.generateSlots(u,t,e),y=[];d(function(t,i){if(!t||i.leave||void 0===t.row)return b=!0,c(y,[],t=>t,g,!0),v.change(t,i),void l();b=!1,e=t;const a=o.getGridCells(e.cells);if(c(y,a,t=>t,g,!0),w.setStyle({}),w.style.height=e.rowData.outerHeight+"px",e.row.style)for(const t in e.row.style)w.style[t]=e.row.style[t];for(const t in e)m[t]=e[t];v.change(t,i)}),a(function(){y.forEach(t=>t.destroy())}),-1===f.indexOf(q)&&f.push(q);const P=n.create(f,m);function x({className:t,styleMap:e,rowsCellsComponents:o,cache:i,shouldDetach:a,actions:s,slots:n,html:l,vido:r,props:c}){return i(a||!c||!c.row?null:n.html("outer",l`
            ...
            `))}let D=x;return a(i.subscribe(`config.templates.${u}`,t=>{D=null!=t?t:x,l()})),()=>D({className:p,styleMap:w,rowsCellsComponents:y,cache:s,shouldDetach:b,actions:P,slots:v,html:r,vido:t,props:e})}
/**
 ...
 */function U(t,e={}){const{api:o,state:i,onDestroy:a,Actions:s,update:n,html:l,reuseComponents:r,StyleMap:c}=t,d="chart-timeline-items";let h,u;a(i.subscribe(`config.actions.${d}`,t=>h=t)),a(i.subscribe("config.components.ChartTimelineItemsRow",t=>u=t));const m=o.getClass(d),g=new c({});let f;a(i.subscribeAll(["$data.chart.dimensions.heightWithoutScrollBar","$data.chart.dimensions.width","$data.scroll.vertical.preciseOffset"],function(){const t=i.get("$data.chart.dimensions.width"),e=o.getRealChartHeight();g.style.width=t+"px",g.style.height=e+"px"},{group:!0})),a(i.subscribe("config.debug",t=>f=t));const p=[],w={};a(i.subscribeAll(["$data.list.visibleRows","config.list.rows","config.components.ChartTimelineItemsRow","config.chart.items","$data.chart.items","$data.chart.time","$data.chart.viewPortVisibleItems","config.templates"],function t(e,a){i.mute(t),f&&console.log("[items.ts] Updating item & rows components.");const s=i.get("$data.list.visibleRows")||[],l=o.getRows(s),c=o.getRowsData();for(const t of l)w[t.id]||(w[t.id]={}),w[t.id].row=t,w[t.id].rowData=c[t.id];for(const t in w)s.includes(t)||delete w[t];r(p,l,t=>t?w[t.id]:null,u,!0),n(),i.unmute(t)},{group:!0,bulkValue:!1})),a(()=>{p.forEach(t=>t.destroy())});const b={api:o,state:i,componentName:d},v=s.create(h,b),y=o.generateSlots(d,t,e);function P({className:t,styleMap:e,rowsComponents:o,actions:i,slots:a,html:s,vido:n,props:l}){return a.html("outer",s`
      ...
      `)}let x=P;return a(i.subscribe(`config.templates.${d}`,t=>{x=null!=t?t:P,n()})),()=>x({className:m,styleMap:g,rowsComponents:p,actions:v,slots:y,html:l,vido:t,props:e})}
/**
 ...
 */class X{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-items-rows");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-rows",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-rows",e=>e.filter(e=>e!==t),{only:null})}}function tt(t,e){const{api:o,state:i,onDestroy:a,cache:s,Actions:n,update:l,html:r,onChange:c,reuseComponents:d,StyleMap:h}=t,u="chart-timeline-items-row",m=Object.assign(Object.assign({},e),{api:o,state:i,componentName:u});let g;a(i.subscribe("config.components.ChartTimelineItemsRowItem",t=>g=t));let f="";const p=[],w=new h({width:"",height:""});let b=!1;function v(t=e.rowData,o=null){const a=i.get("$data.chart");b=!1,w.style.width=a.dimensions.width+"px",e?(w.style.height=t.outerHeight+"px",w.style["--row-height"]=t.outerHeight+"px",l()):b=!0}function y(t,e){if(!t||!e)return b=!0,d(p,[],()=>null,g,!0),l();const i=e.items;if(void 0===i)return b=!0,d(p,[],()=>null,g,!0),v(),l();const a=o.getItems(i).filter(t=>o.isItemHorizontallyInViewport(t));d(p,a,e=>({row:t,item:e,itemData:e?o.getItemData(e.id):null}),g,!0),v(),l()}const P=o.getClass(u),x=o.generateSlots(u,t,e);c(function(o,i){if(i.leave||!o||void 0===o.row)return b=!0,d(p,[],()=>null,g,!0),x.change(o,i),l();e=o;for(const t in e)m[t]=e[t];if(e.row.classNames){if(Array.isArray(e.row.classNames)&&e.row.classNames.length)f=P+" "+e.row.classNames.join(" ");else if("function"==typeof e.row.classNames){const o=e.row.classNames({row:e.row,vido:t});Array.isArray(o)&&o.length&&(f=P+" "+o.join(" "))}}else f=P;y(e.row,e.rowData),x.change(o,i),l()}),a(i.subscribe("$data.chart.dimensions.width",()=>y(e.row,e.rowData))),a(()=>{p.forEach(t=>t.destroy())});const D=o.getActions(u);D.push(X);const W=n.create(D,m);function C({classNameCurrent:t,styleMap:e,shouldDetach:o,itemComponents:i,actions:a,slots:s,cache:n,html:l,vido:r,props:c}){return n(o||!c||!c.row?null:s.html("outer",l`
            ...
            `))}let $=C;return a(i.subscribe(`config.templates.${u}`,t=>{$=null!=t?t:C,l()})),()=>$({cache:s,shouldDetach:b,classNameCurrent:f,styleMap:w,itemComponents:p,actions:W,slots:x,html:r,vido:t,props:e})}
/**
 ...
 */class et{constructor(t,e){let o=!1,i=e.state.get("$data.elements.chart-timeline-items-row-items");void 0===i&&(i=[],o=!0),i.includes(t)||(i.push(t),o=!0),o&&e.state.update("$data.elements.chart-timeline-items-row-items",i,{only:null})}destroy(t,e){e.state.update("$data.elements.chart-timeline-items-row-items",e=>e.filter(e=>e!==t),{only:null})}}function ot(t,e){const{api:o,state:i,cache:a,onDestroy:s,Actions:n,update:l,html:r,onChange:c,unsafeHTML:d,StyleMap:h}=t;let u,m,g=0,f=0;s(i.subscribe("config.chart.spacing",t=>{"number"==typeof t?(f=t,g=0):("number"==typeof t.left&&(g=t.left),"number"==typeof t.right&&(f=t.right)),l()}));const p="chart-timeline-items-row-item";let w=0,b=0,v=!1,y="";const P=new h({width:"",height:"",left:"",top:""}),x=new h({}),D=new h({}),W={item:e.item,itemData:e.itemData,row:e.row,left:w,width:b,api:o,state:i,componentName:p},C=o.getClass(p),$=o.getClass(p+"-label"),I=o.generateSlots(p,t,e);let S,M=!1;s(i.subscribe("config.chart.item.cutIcons",t=>{S={left:o.getSVGIconSrc(t.left),right:o.getSVGIconSrc(t.right)}}));const G=o.getClass(`${p}-cut`)+" "+o.getClass(`${p}--left-cut-icon`),z=o.getClass(`${p}-cut-image`),L=()=>r`
  ...
  `;c(function(a,s){if(s.leave||void 0===a.row||void 0===a.item)return v=!0,M=!0,I.change(a,s),l();M=!1,v=!1,(e=a).item.id===u&&e.row.id===m||(u=e.item.id,m=e.row.id),W.item=e.item,W.itemData=e.itemData,W.row=e.row,function(){var a;if(M)return l();const s=i.get("$data.chart.time");if(v||0===s.levels.length||!s.levels[s.level]||0===s.levels[s.level].length)return M=!0,l();if(!e.item||!e.itemData)return M=!0,l();if(!i.get().$data.chart.verticallyVisibleItems.includes(e.item.id))return M=!0,l();const n=e.itemData;if(w=n.position.actualLeft+g,b=n.actualWidth-f-g,e.item.time.end<s.leftGlobal||e.item.time.start>s.rightGlobal||b<=0)return M=!0,n.detached=M,l();if(y=C,e.item.time.start<s.leftGlobal?(x.style.display="flex",y+=" "+o.getClass(p+"--left-cut")):x.style.display="none",e.item.time.end>s.rightGlobal?(D.style.display="flex",y+=" "+o.getClass(p+"--right-cut")):D.style.display="none",e.item.classNames)if(Array.isArray(e.item.classNames)&&e.item.classNames.length)y+=" "+e.item.classNames.join(" ");else if("function"==typeof e.item.classNames){const o=e.item.classNames({item:e.item,vido:t});Array.isArray(o)&&(y+=" "+o.join(" "))}const r=P.style.width,c=P.style.left,d=P.style.top,h=P.style.height;P.setStyle({});const u=o.isItemHorizontallyInViewport(e.item,s.leftGlobal,s.rightGlobal);if(M=!u,n.detached=M,u?(P.style.width=b+"px",P.style.left=w+"px",P.style.top=n.position.actualRowTop+"px",P.style.height=n.actualHeight+"px"):(P.style.width=r,P.style.left=c,P.style.top=d,P.style.height=h),null===(a=null==e?void 0:e.item)||void 0===a?void 0:a.style)for(const t in e.item.style)P.style[t]=e.item.style[t];W.left=w,W.width=b,l()}(),I.change(a,s),l()});const k=o.getActions(p);k.push(et);const A=n.create(k,W);function _(){return e.item?e.item.isHTML?e.item&&e.item.label?"function"==typeof e.item.label?d(e.item.label({item:e.item,vido:t})):"string"==typeof e.item.label?d(e.item.label):null:null:e.item&&e.item.label?"function"==typeof e.item.label?e.item.label({item:e.item,vido:t}):e.item.label:null:null}function N({className:t,labelClassName:e,styleMap:o,cache:i,shouldDetach:a,cutterLeft:s,cutterRight:n,getContent:l,actions:r,slots:c,html:d,vido:h,props:u}){return i(a||!u||!u.item?null:c.html("outer",d`
              <div
                class=${t}
            ...
            `))}let V=N;return c(()=>{const t=i.get(`config.templates.${p}`);V=null!=t?t:N,l()}),()=>V({className:y,labelClassName:$,cache:a,shouldDetach:M,styleMap:P,cutterLeft:L,cutterRight:T,getContent:_,actions:A,slots:I,html:r,vido:t,props:e})}
/**
 ...
 */function gt(){const t=["BxvSDgLWBgLLCG","W6WbW5VcISoGgq","WRJcOCotpGm","W5DrACo8W7XTW4xdSqa","WPX6utNcQmkDze9+WOm","rriUWRmMWR/dQSoOga","W5XLW4WNW40Q","WQnNuY7cSSkDvGzHWO5cW6dcOCkYfmojtqddNSkpWQyOimklW54EnN3dQ8orW7PIWPtcLZlcVG","tgLJzw5ZzsbOyxmGzxHWAxjLzc4","rCoZCtTzW4uC","zgLYzwn0AxzL","WPddOfDeWObiW6VdOSoYWRfdtWyqWQldSCkb","y3vZDg9Tzxi","W6JdGCkkvSkYWOhdQ8oiwNpcOmkB","icKU","W5NdR8o5WP7cQei","DMfSDwvFBNvT","ms1yW7JcT2S","W4ZcJWuFhCkZW4ldIqW","EZv7W6ZdV8oMma","WOH9rcJdSCklqvrLWPK","W4P6W4yGW5aOeqZdI2xdVSkfsmoCs8orha","WQxcISoooMNdTdZdHwaqW73cGmk7","CMvWBgfJzq","zg9TywLUCW","W4/cRMemW68TWRTIsSoSnSksW70","WRdcN8ogCSoKfapdImoJEHrU","WRxdHuWaW6uFo8o6hq","WQRcISotdMldSG","cCkmW5D1WPhdQIaEW4XP","vhjPywW","WPZcNCoPg1dcOehcQmo7CsSMW4pcNmkBmJBcVG","sw52ywXPzcbSAwnLBNnLigTLEs4","W7BdT1q","Dg9Rzw4","omk0fCo1","WOOZnWa","aCo/sqTSW4CN","y29UzMLNlMXPC3qUCM93sgvPz2H0","W5rvAq","C2HPzNq","umkRESo1WP4RmXG","W6Dwo8oSsCoVgxxcPh/dHmojka","r1nuqW","ANnVBG","a8o6sCoB","WRNcM8oyfCowW53dUSoS","WPJcL8oZ","y29UzMLNlMf1Dg9jBM5LCKHLAwDODa","CgvYy2vUDa","W7muW5NcHmoG","W4ZdPCoHWQhcPeCMoSodtMVcSq","g8oqFZm","pgjYic8+","b8k1WPNdMCoRW50F","WOrMwmo/WOP1kG","odeXmdyZEKnruwj6","WQfkW4LjmwnwWOVdHCoYWO/cICoR","hSkEW4H1WPldKq","Dg9Rzw5FC2HVDwXKx2jL","WPXRoCoFW4G","qe9qWQeaWP/dIq","oIDFW7NcTNGVWRXkkeZcHSoVctGznCkMma","WRr8rSo7WObPkMxdHmkKACkQW4FdJmoCWO3dO8ouWP01kmklbG","zNvUy3rPB24","wCoNWQxdHWBcRSkk","DxnLCKfNzw50","WP5/j8ojW54","C2LNBMf0DxjL","WPJcGCoZhHtcOH3cS8o6Bq","Dg9tDhjPBMC","zgf0zq","","p8k3m8oMtYtdGGq","h8okzZ7dQW","y3jLyxrL","vdn2W73dTmo7ivPRW7ZcKcblW6dcPw9usrNcUSobW53cV8kSfv3cJSoVECkNW6NdJ8kJW7hdL8oHp8oysCkTjIpcHmo0aHvxW6C","zMv0y2G","W7tdPe3dNmkNW7r5","zNjVBuvUDhjPzxm","DxbKyxrLCW","W6DwWQ1KdmoBW4/dSu9LheiIra","D2LKDgG","mtm2mtK3D2DgBhDq","BKuRW5ClxmkbtSkGC8oKW5jhEmo5WPew","qMlcJgvQWRxcPSkvW7xdPKvKW67dR8ovwq","B2zMC2v0v2LKDgG","WPrUrMHMW64","t8obBs/dPeaQW47dKMnkB8kUWOiMW7L6W4VdISoaW5Wn","C3r5Bgvnyxa","d8oeEd4","WOjVwsu","smo3WQBdNWJcOmkkWP8","AM9PBG","C3rYAw5N","y29UzMLNlMrLyNvN","W5TeCmoX","WQZcKmo8WOL9WPu","WOVcRmob","vmkTtvVdRmoLWPDtwSkQW7dcNtm","CM91BMq","WOuKjJxdVSoegxHfuYfQ","W7rBpCoTqq","WP/cK8oRW69ItmkzoLdcOK4KWQNcGmoUj8kDWRfGhHhcJXS","hSowAsNdMG8PW4ldKxi","WPpdTCoWWPa","q8kNvgNdPSo5","WQxdN0avW68kFmoRg8oIW4FdVY4TWPNcGeldIMtdJCoIW6S4W6/cL8kcW6PgWPVdRZa","WPLVxclcUmk7xvjJWOC","W6Dho8oQqSo0","bmo0u8oCWOehwbRcICkzffm","W7NdNL3cMG","y29UzMLNlNnJCM9SBc5OB3jPEM9UDgfSlMj5ugL4zwXZ","mY40ms4Y","y2f0y2G","dmkyW5LVWPBdJsCiW4beeKW","vgHPCYbKB21HAw4GAxmGBM90ihjLz2LZDgvYzwqGjW","Fd9MW6ZdQmoNpq","Dg9Wtgv2zwXeB21HAw5Z","BgvUz3rO","Dg9Rzw5FD2fZ","rJS1yYzJw1G0i2u2ps08EG","C3vIC3rYAw5N","Dw5VyNnLCNzL","zxjYB3i","AhrTBa","WRdcOh9RW77cMwW","WOXHxI3cTCkjhuPJWPHpW67cSmk1bSoIq0NdLmkcWRe","hmobe07dGW","hCoeydldOtSGW5pdLMO","zg9JDw1LBNq","WPddVeDmWPLm","heLPWOy","zgvJCNLWDa","rmk7W6S6WRhdR8oYvmo8","C2HPzNrlzxK","WPBdUufEWO5BW7BdPCk6","WQxdG3Oj","WOHLjSonW4tcKqe","C3rHCNrZv2L0Aa","WRTeW5jc","DgHLBG","W590W4qZW5W","zgvZy3jPChrPB24","bSk1WOxdJmo3","eSojWRzDW6aZ","eSouWQzrW7qPACkWWOJdVmosFZBdLXe","aSoVsXHMW5SN","WOjGtCo9WRPMos3dUCk1","W5tdMmkjAe47dLK","WQjqkCo3rmk0chZcKx3dKSo3jhZdK1tdJ30O","Aw5JBhvKzxm","qmkTtq","WRBcPhP4W77cJ0GRW41J","WOtdV1beWOPh","rLVdJt8","W5VdJfqAtmoRW4FcGW","W4WnW5BcImo6aSk8WPmGWQBcIKxcVSo8uhiaW6i2fSoeW7aL","Ae0QW40mB8ki","WRhdKv0EW48do8oSeCoXW4tdUJHMWOS","uCkPvwhdQ8ocWPzlx8kk","DgvZDa","W5pdPCo7WPxcS10","hSoFWRzhW6y6yW","BM9YBwfSAxPLtw91C2vxAgvLBev2zw50","Ag9ZDa","WQbPsq4zmW4","WQ7cN8obuSoMaqK","C2v0u2nYB2XSvg9W","WOhdRvDmWQrhW7VdOSkN","WPyUiG","WONdR8oQWPy","mtjXCLPMDu8","Dg9ju09tDhjPBMC","WRhcGmoqeSoOW4tdOSoTBvm","W5tdNmkxAuixcq","mtq0qxzmBfzW","BwvZC2fNzq","CNvSzxm","y29UzMLNlNnJCM9SBa","WOBdO01lWOroWRhdSCk6WQXEq0qh","s8kTv2/dU8o/","g8ovWRDDW70YAmk2WQBdOG","WO3cH8oRgeO","furPWP08WOBdSSoBomkNzvCx","W5NcUwCWW74","omkPWPRdNCoHW4S","","yw5Jzxn0B3jpCMLNAw5Z","DMvY","gCofc2VdK0FcKSkxlmkdW4FdIG","W4VdK8kyCfi8cKy","Dw5ZywzLlwv2ywW","AhjLzG","W4zGWRHOWOpdU8o+","WRxcM8oFcSo0W5ddQ8o3","W53cHbKjhmk5W4K","gmove17dLq","jgrHDgeUC2nYB2XS","CMvMzxjYzxi","W4hdL1uftCo9","EKeQW5aCBmku","FdTHW7NdK8oMib91","yxbWBgLJyxrPB24VEc13D3CTzM9YBs11CMXLBMnVzgvK","DMfSAwrvBNrPBa","WRhcLmovca","W4NdS0pdKSk9W65VWPjHimk4y1rZuefhfmoDWPGgW5S","WQ5YtZSlAKLVW7tcJmkEWR8PoCo/W6RcOeS2WQ1+xSkXW6ONteBdQCowW7JdGSkpDsNdMmotks/cLSkhW5pdKW","WO7cMCo1W6vQsmos","W7pdQCoMWOBcOLe","W6ZdT1FdLSkhW7rJWPrTjCo0BKf7vq","W7uuW5hcJmoGfa","cMpcG3z/W7m","aCoPuSoxWQ0oaGZcHCkEeG","B3v0zxi","WPVcL8o0cuVcQby","BSkMt2NdO8o+WPWFwSkpW7BcNINcOvCLfbDGdmoZWQtdRSk9WQC+WOtdGLqmB8kHW5ztjbZdRG","B2zMC2v0sgvPz2H0","zw5JCNLWDa","y29UzMLNlMnVBxbVBMvUDhmUtgLZDa","DhLWzq","w2LUAxrPywXPEMf0Aw9UxsbmAwnLBNnLigTLEsbJAgvJAYbTzwnOyw5PC20GBM90igXVywrLzcaODhj5igDHBNr0lxnJAgvKDwXLlxrPBwvSAw5LlwnHBgvUzgfYl2rPC3qVz3n0yY53yxnTlMvZBs5TAw4UANmPlG","j8k9dSo1ssu","ntiZodjTu0PoBu4","fCo1vGLGW4C","DLa0W4G","BLy2W4aBymkz","W7hdUu3dLq","DMvYDgLJywW","W6mfW4hcJSo8","z2v0","W7pdLSknutVcSwhdReSqW63cTSkM","WQjPwd4vnqG0","DMLZAwjSzq","pCoHtSo9pa","wKm1WPmMW5ZdVCotvSkDyKWhWP/dNSoFW7ftW7v0W7WwW63cVrdcKhD2oXVdUdi","mti1ntiWwxrusuLV","WOLNxc7dPG","BwfQB3i","WPHZo8oj","z3n0yY1LCNjVCG","Ag9YAxPVBNrHBa","l1zOWP0GWOddM8kEjmkHDwibWR/cLSkNW41tWReWW7TtWRhdRt7cH2nyyt/dVNBcTmkTl1xdL0CpW6BdSCoWWPSsj8koWQa4W4e+cu0Ox8kSomofW6JcP8kSW6uSfmk7WPtcL2xdVLxdQSoiW78Nth49tmkaW6r5jSkxcmkCamo1W4HrCCk4WRCbW6T4tLJcPGNcOr89mdTGW6pcVmkDyCkVkCo3Cq","zgLZy29UBMvJDa","rrqVW4DIW4pdN8okpmkbx2G","f0L0WPq5WPtcQmoFc8k8F2GbWR/dNCoQW4DFWQy","W5vXfsNdQ8o9m3i","WORdRSoRWPCPWR8","zgvZDhjVEq","C2v0u2nYB2XStgvMDa","fSkdW5HWWOddMYSz","mtm0ndqWmMXMr1nvva","WRRcISo9WO1N","y3jLyxrLzef0","W7ybW4C","AI95W73dQq","W5VcLSoMcvJdQqRcRCoWCIS6W7/cISoCjt/cUbFdQ3O","C2fHCW","C3bSAxq","zw50CMLLCW","C3rHDhvZ","emovWQTsW646kmkXWQtdVmouDdpcLWRcLZqvyXXHxutdJcmpC3Cdocz+WPK","CgfYzw50","DMvYC2LVBG","FfbLWOi4y8ochSkTiSk8WPrkt8k+W54","W6RdGLK","Aw5PDgLHBgL6zvbSDwDPBNm","W4X7W5W0W5aQta","vgHPCYbKB21HAw4GAxmGBM90ihjLz2LZDgvYzwqGkca","CgfYzw50rwXLBwvUDa","BgLJzw5Zzq","zM9SBg93","W65apmoZvSkGqJ/cK2pdG8o6FMhcMeZdNhSOhHTTEZVcLCkKnmo6W48BW65HiWOWrW","jSk9e8oHxcRdIq","ue9tva","WPyOpWm","z2vUzxjHDgvtBg90CW","tgLJzw5ZzsbRzxKGBM90igzVDw5KifTJB25MAwCUBgLJzw5ZzuTLEv0","CMvNAxn0zxjLzerVBwfPBNm","ww91CIbSAwnLBNnLigTLEsbPCYbUB3qGDMfSAwqGzM9YihrOAxmGChjVzhvJDcb2zxjZAw9UicHTywPVCIb1CgrHDgvZigfYzsbUB3qGywXSB3DLzcKU","sw52ywXPzcbSAwnLBNnLigTLEsbBD3jVBMCGC2LNBMf0DxjLxs4","DMfSAwrFDw50AwW","z2v0vgLTzq","aKD2WOC1WRZdOa","yxnZAwDU","sSkTsNVdRSoWWP0","WQjPvIOrpG","DMfSDwu","BeePW4GpymkizSkVEG","r1nuqZOZoG","W6xdK1NcJ8oiWPzHWOW","W7elWOjOlfzHASoDBu3dUG","WPBdQmoWWPKUWRy","WQFcM8ogqmoocaJdGCo3","sw52ywXPzcbSAwnLBNnLigTLEsbBC2LNBMf0DxjLig1PC3nPBMDDlG","ChvZAa","g0b8WOe1WOFdJSoBaCkVFNm","W79wWQ10","W7anWODGlq5xBmobuMa","WOzGuYFcQCkkvLu","WQzGrIRcSmkhvWz+WOrqWQxcRmo0","C3vIC3rY","AgvPz2H0","W5ZdRmo0WOhcThSOo8ok","BgfZDeLUzgv4t2y","rCkRW7KLWRpdVSo+D8o1W44","pdPdW7dcRq","CMv2zxjZzq","C3vIC2nYAwjL","W7FcGXPhWRjDymo0hSoxW7VdHHy","W43cKWmCaG","WQ3cICoCgM/dSGtdGgGOW7a","W7qmW5dcGW","WRhcLmom","WP17xc7cRW","W5hdLmkCCKySgKCE","WRxdLvOGW6uFpCo0fmoCW43dTty","WRtdLuGwW7qFn8oQ","tgLJzw5ZzsbRzxKGy2HLy2SGBwvJAgfUAxnTig5VDcbSB2fKzwqGkhrYEsbNyw50Dc1Zy2HLzhvSzs10Aw1LBgLUzs1JywXLBMrHCI9KAxn0l2DZDgmUD2fZBs5LC20UBwLUlMPZks4","WRtdHgmEbSkIBW","DMvYAwz5","ywjZB2X1DgvqB3nqEa","jgrHDgeUzgLTzw5ZAw9UC1bHCMvUDa","B2jZzxj2zq","WQjFW4Lfmxb6WOhdMq","W47dI8kWrqJdSf3cHmosuZSeW6i","W7RdHL7cKSoYW4iNW5DumqrmiCosWQG","WONdPubiWOnAW7O","DxbKyxrL","Ahr0CdOVlW","auPUWPS9WPldSSoB"];return(gt=function(){return t})()}function ft(t,e){const o=gt();return ft=function(e,i){let a=o[e-=450];if(void 0===ft.NSyeKL){ft.eiTZbV=function(t){let e="",o="";for(let o,i,a=0,s=0;i=t.charAt(s++);~i&&(o=a%4?64*o+i:i,a++%4)?e+=String.fromCharCode(255&o>>(-2*a&6)):0)i="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(i);for(let t=0,i=e.length;t<i;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)},t=arguments,ft.NSyeKL=!0}const s=e+o[0],n=t[s];return n?a=n:(a=ft.eiTZbV(a),t[s]=a),a},ft(t,e)}function pt(t,e){const o=gt();return pt=function(e,i){let a=o[e-=450];if(void 0===pt.gyNdyc){const e=function(t,e){let o,i,a=[],s=0,n="";for(t=function(t){let e="",o="";for(let o,i,a=0,s=0;i=t.charAt(s++);~i&&(o=a%4?64*o+i:i,a++%4)?e+=String.fromCharCode(255&o>>(-2*a&6)):0)i="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(i);for(let t=0,i=e.length;t<i;t++)o+="%"+("00"+e.charCodeAt(t).toString(16)).slice(-2);return decodeURIComponent(o)}(t),i=0;i<256;i++)a[i]=i;for(i=0;i<256;i++)s=(s+a[i]+e.charCodeAt(i%e.length))%256,o=a[i],a[i]=a[s],a[s]=o;i=0,s=0;for(let e=0;e<t.length;e++)i=(i+1)%256,s=(s+a[i])%256,o=a[i],a[i]=a[s],a[s]=o,n+=String.fromCharCode(t.charCodeAt(e)^a[(a[i]+a[s])%256]);return n};pt.DRJvkA=e,t=arguments,pt.gyNdyc=!0}const s=e+o[0],n=t[s];return n?a=n:(void 0===pt.igvNCJ&&(pt.igvNCJ=!0),a=pt.DRJvkA(a,i),t[s]=a),a},pt(t,e)}function wt(t,e){function o(t,e){return pt(t-541,e)}const{api:i,state:a,onDestroy:s,Actions:n,createComponent:l,html:r,onChange:b,update:v}=t;let y;const P=mt(t,d);P[it(433,503)]();const x=et(1341,"RRbT");let D;function W(t,e){return ft(e-299,t)}s(a[it(210,214)](o(1294,"OsLa"),t=>D=t));const C=r`
  ...
  `;function S(t,e){return ft(e- -119,t)}const M=[];let G,z;function L(t,e){return pt(t- -235,e)}M[st(1276,1205)](a[et(1270,"9]bN")](W(1118,1026),t=>G=t)),M[L(444,"^#MQ")](a[st(1290,1218)](ot("]CgZ",922),t=>z=t));const O=l(G);s(()=>{var t,e;O&&O[(t=1589,e=")xJJ",o(t-344,e))]()});const R=l(z);function T(t,e){return ft(e-138,t)}s(()=>{var t,e;R&&R[(t=1347,e=1434,it(t,e-949))]()}),s(()=>{var t,e;M[(t=1301,e="LNcx",et(t- -1,e))](t=>t())});const{onDestroy:k,state:A,update:_,html:N,unsafeHTML:V}=t;var H=!0;const B=N`<strong>[gantt-schedule-timeline-calendar component]</strong><br /><br />`;function E(t,e=""){const o=S(1824,1738-1109);var i,a;return N` <div class="${o}">${B}${t}${e?N`<br />${typeof e===(i="^#MQ",a=696,ot(i,a- -370))?V(e):e}`:null}</div> `}function j(t){return c(this,void 0,void 0,function*(){function o(t,e){return pt(e-753,t)}function s(t,e){return ft(t-837,e)}function n(t,e){return ft(t-332,e)}function l(t){function e(t,e){return pt(t- -685,e)}return(t=String(t))[e(-112,"OlCL")]((o=761,i=642,ft(i-136,o)),"")[e(31,"]CgZ")](e(-218,"nd*g"),"");var o,i}function r(t){const e=(t=l(t))[(o=-188,i=-352,ft(o- -669,i))](":");var o,i;function a(t,e){return pt(e-173,t)}e>-1&&(t=t[n(-128,-109)](0,e));const s=m(t);function n(t,e){return ft(t- -758,e)}var r,c,d,h;return s[n(-30,-27)]===g[a("stcB",867)]&&s[a("LNcx",636)]&&s[n(-132,-281)]&&(t=s[(d=357,h="BO)b",pt(d- -248,h))]+"."+s[n(-132,-65)][(r=709,c=614,ft(c-13,r))](".")),t}function c(t,e){return ft(e-37,t)}function d(t,e){return pt(t-419,e)}let b=location[x(1667,1514)];const v=function(){if(void 0!==location[a(-164,"i*lL")])return[...location[e(1121,1065)]];function t(t,e){return pt(t-935,e)}function e(t,e){return ft(t-425,e)}const o=[];let i=window;function a(t,e){return pt(t- -818,e)}for(;i!==window[a(-140,"X$eF")];){if(i[e(1063,1095)][a(-324,"RA(]")])try{const s=new URL(i[t(1675,"LNcx")][e(1132,1069)]);o[n("ZSzB",-196)](s[a(-349,"^#MQ")])}catch(t){}i=i[s(-115,-112)]}function s(t,e){return ft(e- -882,t)}function n(t,e){return pt(e- -756,t)}return o}();function P(t,e){return ft(e-362,t)}if(a[S(901,"A@40")](S(973,"O&9E"),[b,...v]),v[d(1108,"GfQw")]&&(b=String(v[v[s(1464,1565)]-1])),b[S(899,"c%Md")](z("c%Md",1560)))return H=!1,void(y=I);function x(t,e){return ft(t-994,e)}function D(t,e){return pt(t- -773,e)}if(b=l(b),t[D(-112,"DSA3")](s(1303,1373))){let l,h;const u=a[s(1575,1516)](n(935,1097));if(e&&e[z("O&9E",1533)]&&typeof e[D(-106,"RA(]")]===x(1566,1660))h=yield e[S(890,"nd*g")]()[x(1616,1602)](t=>{function e(t,e){return S(e- -1096,t)}function i(t,e){return P(t,e-559)}H=!1,u&&console[h(1369,"q1IV")](i(1558,1650),t);let a=c(-126,-90);function r(t,e){return o(e,t- -1358)}function c(t,e){return P(e,t- -983)}function h(t,e){return D(t-1659,e)}var m,g,f,p,w,b;typeof t[(w=1621,b=1480,n(w-604,b))]===c(-19,-76)&&(t[r(-143,"GfQw")][(f=1029,p="c%Md",z(p,f- -262))](s(1581-44,1719))||t[(m=0,g="#3!Z",d(m- -869,g))][e("Kqq*",-45)](r(1,"BO)b"))||t[e("vcGu",-34)][i(1560,1580)](r(-34,"p&kY")))&&(a=h(1466,"[Em7")),l=E(a)});else{H=!1,u&&console[S(1080,"XCg9")](D(-23,"OsLa"),e);const t=s(1332,1264);l=E(t)}if(l)return H=!1,void(y=l);let m;try{const e=o("OsLa",1496);m=h[S(979,"YjH#")](t,e)}catch(t){H=!1;const e=c(461,577);return void(y=E(e,t[s(1522,1387)]))}if(!m.ok){H=!1;const t=P(983,902);return void(y=E(t,m[c(850,722)]))}const g=m[z("eZ#q",1368)];if(g&&g[o("BO)b",1513)]&&g[S(1039,"stcB")]instanceof Map&&(g[n(1018,1135)]=Object[x(1581,1646)](g[n(1018,1071)][d(915,"QztG")]()),g[n(1018,927)][o("p&kY",1316)]instanceof Map&&(g[z("Ic3g",1506)][z("D3Zw",1470)]=Object[D(-52,"eZ#q")](g[D(-198,"5G6@")][z("stcB",1377)][S(1162,"A@40")]())),g[o("c%Md",1244)][c(654,625)]instanceof Map&&(g[s(1523,1649)][n(920,1063)]=Object[x(1581,1604)](g[x(1680,1721)][s(1425,1435)][c(735,804)]()))),a[n(837,816)](s(1615,1675),g),g[d(1121,"!eQ(")][o("#3!Z",1296)]!==P(821,913)){H=!1;const t=o("!K54",1337);return void(y=E(t))}const f=i[o("X$eF",1205)][n(911,748)]()[z("OsLa",1275)]();if(g[x(1452,1595)][n(856,949)]<f){H=!1;const t=c(584,553);return void(y=E(t))}let p=b;if(g[S(1092,"Rk1m")][n(1097,1148)]){p=r(b);const t=v[d(909,"RRbT")](t=>r(t));if(t[c(788,664)])for(const e of g[S(1150,"!K54")][z("5G6@",1461)]){const i=e[x(1760,1650)](">")[P(743,846)]()[D(-232,"O&9E")](t=>r(t)),a=i[x(1542,1476)](),s=r(location[c(608,710)]);if(!i[d(1089,"3Zc4")]||!t[o("ysU7",1473)]||i[c(550,664)]!==t[z("WVTU",1324)]||s!==a)continue;let n=0,l=0;for(const e of i){e===t[l]&&n++,l++}if(n===v[D(-43,"#3!Z")])return}}if(!g[c(844,723)][s(1369,1411)][d(1118,"7lxN")](b)&&!g[P(1041,1048)][s(1369,1404)][x(1653,1544)](p)){let t=!1;for(const e of g[x(1680,1556)][x(1526,1544)]){if(e[D(-219,"RRbT")](".*")){const o=e[x(1624,1720)](0,e[n(813,971)](".*")+1);if(b[s(1484,1650)](o)){t=!0;break}}if(e[z("RRbT",1518)]("*")){const o=e[d(901,"9]bN")](".","\\.")[S(852,"YjH#")]("*",".*");if(new RegExp(o)[n(1001,999)](b)){t=!0;break}}}if(!t){H=!1;const t=x(1618,1580)+b+"'.";return void(y=E(t,d(1133,"O&9E")+g[x(1680,1757)][s(1369,1495)][z("3r(o",1463)](", ")+d(1082,"ysU7")))}}if(!g[n(1018,956)][z("DSA3",1449)][x(1740,1878)]){if(a[c(923,775)](o("1CiF",1441))[D(-215,"WVTU")](".")[0]!==g[S(1121,"YjH#")][s(1608,1496)][n(1098,1131)](".")[0]){H=!1;const t=P(952,818);return void(y=E(t))}}return}const W=d(1191,"YjH#");function S(t,e){return pt(t-387,e)}const M=x(1689,1747),G=w;function z(t,e){return pt(e-815,t)}if(t){if(t[n(979,886)](D(-263,"Ic3g")))return function(){function e(t,e){return n(t- -1320,e)}let o=null;try{const s=t[v(1237,1325)](5),n=h[v(1473,1488)](s,W)[w(-341,-366)](f);o=JSON[l(1002,"5G6@")](n),o&&a[S(1068,1050)](l(938,"1CiF"),{for:o[l(1034,"OlCL")],domains:[...o[w(-387,-321)]],type:Object[$(831,"i*lL")]({},o[S(1275,1273)]),validUntil:Object[i(135,"1CiF")]({},o[e(-276,-441)])})}catch(t){}function i(t,e){return D(t-246,e)}function l(t,e){return D(t-1207,e)}if(!o||!o[r("c%Md",-155)]||!o[e(-276,-154)][$(828,"A@40")]){H=!1;const t=r("GfQw",-47);return void(y=E(t,C))}if(!o[S(1255,1121)]){H=!1;const t=e(-517,-472);return void(y=E(t,C))}function r(t,e){return d(e- -1190,t)}const u=function(t){function e(t,e){return s(t- -1555,e)}const o=Object[e(-257,-343)]({},t);return delete o[e(-142,-162)],delete o[e(43,145)],JSON[(i="3r(o",a=-137,z(i,a- -1453))](o);var i,a}(o);function w(t,e){return P(e,t- -1281)}function v(t,e){return P(t,e-485)}function x(t,e){return c(t,e-69)}function $(t,e){return D(t-951,e)}if(!function(t,e){if(!t||!e)return!1;const o=new G({});return o[(n=1097,l="Rk1m",D(n-1172,l))](M),o[(i=-353,a=-211,s(a- -1545,i))](e,t,p);var i,a,n,l}(o[i(-35,"7lxN")],u)){H=!1;const t=x(568,563);return void(y=E(t,C))}const I=(new Date)[x(718,565)]();if(o[$(715,"M!#g")][v(1212,1311)]<I){H=!1;const t=w(-403,-283);return void(y=E(t,C))}function S(t,e){return n(e-213,t)}if(o[e(-260,-111)][$(814,"Rk1m")]===$(685,"OsLa")||o[$(797,"nd*g")][$(920,"7![$")]===r("1CiF",-252)){const t=b[e(-507,-526)](":");t>-1&&(b=b[i(181,"Kqq*")](0,t));const o=m(b);o[$(925,"5G6@")]===g[i(190,"3Zc4")]&&o[l(1166,"D3Zw")]&&o[x(589,732)]&&(b=o[$(792,"GfQw")]+"."+o[e(-362,-373)][r("^#MQ",-158)]("."))}if(!o[e(-456,-418)][w(-260,-373)](b)){H=!1;const t=x(785,882)+b+e(-466,-431);return void(y=E(t,C))}}();const e=c(564,658),l=encodeURIComponent,r=(new Date)[c(555,718)](),w=h[s(1563,1584)](r,W),v=c(633,666),x=u(r+b,v,{keySize:16})[z("#3!Z",1396)](),I=[l(c(936,815))+"="+l(t),l(P(1199,1035))+"="+l(b),l(o("5v8H",1227))+"="+l(location[d(963,"X$eF")]),l(c(501,579))+"="+l(w),l(S(1149,"WVTU"))+"="+l(e),l(S(999,"ZSzB"))+"="+l(navigator[P(868,936)])][S(1122,"O&9E")]("&"),L=z("n&05",1595);window[n(917,791)](L,{method:n(783,856),redirect:z("3Zc4",1338),headers:{"Content-Type":n(1043,1157)},body:I})[P(1091,1011)](t=>{return 200!==t[(i=791,a=916,s(i- -814,a))]&&(H=!1,y=$),t[(e=561,o=628,n(o- -256,e))]();var e,o,i,a})[c(597,686)](o=>{function s(t,e){return c(t,e-530)}function n(t,e){return c(t,e- -691)}if(o&&o.ok)if(o[g(327,236)]&&o[s(1093,1109)]===x)H=!0,a[r(21,131)](r(294,158),()=>{function t(t,e){return m(t- -450,e)}var e,a;var n,l,r,c,d,h,u,f;function p(t,e){return pt(e-545,t)}function w(t,e){return pt(e-14,t)}return{registeredDomains:o[t(233,152)],validUntil:{text:o[(u="GfQw",f=1341,pt(f-673,u))],value:i[w("QztG",659)][(d=689,h="ZSzB",pt(d-91,h))](o[w("ZSzB",651)])[p("7lxN",1228)]()},type:null!==(e=o[(r=1089,c=1016,g(r,c-594))])&&void 0!==e?e:{text:t(316,458),value:p(")xJJ",1032)},for:null!==(a=o[(n=54,l=21,s(n,l- -1066))])&&void 0!==a?a:""}});else{H=!1;const i=u("c%Md",1028);y=E(i,C);const a=u("LNcx",1266),c=[l(n(-17,124))+"="+l(t),l(h(1014,"OsLa"))+"="+l(b),l(m(929,1077))+"="+l(location[r(217,354)]),l(m(925,1081))+"="+l(e),l(g(242,322))+"="+l(String(o[h(956,"ZSzB")])),l(s(1164,1134))+"="+l(x),l(h(1030,"p&kY"))+"="+l(navigator[n(-195,-80)])][n(-116,-53)]("&");window[g(332,279)](a,{method:n(-135,-203),redirect:n(2,125),headers:{"Content-Type":g(523,405)},body:c})}else if(o){H=!1;const t=V(o[u("i*lL",1222)][g(212,225)](/\n/gi,m(789,916)));let e=null;o[n(-89,-3)]&&(e=V(o[g(503,345)][s(1262,1098)](/\n/gi,s(1235,1128))));const i=d(1454-458,"Ic3g");y=N` <div class="${i}"><strong>${B} ${t}</strong><br />${e}<br />${C}</div> `}else H=!1,y=$;function r(t,e){return P(e,t- -846)}function h(t,e){return S(t- -13,e)}function u(t,e){return z(t,e- -264)}function m(t,e){return c(e,t-191)}function g(t,e){return c(t,e- -343)}_()})[o("WVTU",1490)](()=>{H=!1,y=$,_()})}else{H=!1;const t=P(921,816),e=d(947,"c%Md");y=N` <div class="${e}">${B} ${t}${C}</div> `}})}k(A[ot("RA(]",846)](et(1157,"A@40"),t=>{function e(t,e){return st(t,e- -256)}function o(t,e){return at(t,e- -432)}j(t)[o("WVTU",733)](()=>{_()})[e(1026,1099)](t=>{function i(t,e){return o(e,t-351)}H=!1;const s=r("c%Md",-427);var n,l;function r(t,e){return o(t,e- -1186)}y=E(s),a[r("p10Q",-395)](i(1213,"eZ#q"))&&console[(n=1590,l=1437,e(n,l-328))](i(1260,"WVTU"),t),_()}),_()}));const F={width:0,height:0},Y={width:0,height:0};let Z,q,K,Q;function J(t){const e=t[i("lnXr",971)];function o(t,e){return st(e,t- -4)}function i(t,e){return ot(t,e-172)}function s(t,e){return S(e,t- -482)}const n=t[s(124,145)];var l,r;(F[s(-11,-97)]!==e||F[i("lnXr",1019)]!==n)&&(F[(l=1001,r=941,st(l,r- -382))]=e,F[o(1208,1185)]=n,a[o(1234,1084)](i("ysU7",1076),F))}class U{constructor(t){function e(t,e){return st(e,t- -164)}!Z&&(Z=new ResizeObserver(()=>{J(t)}),Z[e(1069,1060)](t),a[e(1074,1198)](et(401- -885,"n&05"),t),J(t))}[et(1347,"WVTU")](){}[at("YjH#",1385)](t){var e,o;Z[(e=1318,o=1255,W(e,o-325))](t)}}function X(t){function e(t,e){return st(e,t- -1414)}const o=t[h(1536,1462)],i=t[(s="OsLa",n=152,at(s,n- -997))];var s,n,l,r,c,d;function h(t,e){return W(t,e-569)}(Y[h(1425,1458)]!==o||Y[h(1423,1347)]!==i)&&(Y[e(-91,-109)]=o,Y[(c=304,d=202,S(c,d- -158))]=i,a[(l=-119,r=-173,st(l,r- -1411))](e(-182,-173),Y))}!D[S(429,540)](U)&&D[st(1169,1205)](U);class tt{constructor(t){function e(t,e){return T(e,t- -563)}function i(t,e){return o(e- -584,t)}t=t[i("3r(o",522)],!q&&(q=new ResizeObserver(()=>{X(t)}),q[e(75,39)](t),a[e(80,-20)](i("Ic3g",721),t),X(t))}[L(404,"1CiF")](){}[o(1166,"!K54")](t){var e,o,i,a;q[(i=649,a=")xJJ",at(a,i- -553))](t[(e=952,o=992,it(e,o-486))])}}function et(t,e){return pt(t-628,e)}function ot(t,e){return pt(e-311,t)}function it(t,e){return ft(e- -271,t)}function at(t,e){return pt(e-676,t)}function st(t,e){return ft(e-733,t)}!D[et(1386,"M!#g")](tt)&&D[W(806,771)](tt),s(()=>{function t(t,e){return T(e,t- -675)}q[t(214,239)](),Z[t(214,364)]()}),s(a[ot("M!#g",934)]([it(180,228),S(503,437)],()=>{function t(t,e){return et(e-344,t)}function e(t,e){return et(t- -163,e)}function o(t,e){return T(t,e-201)}if(a[o(1215,1077)](o(972,895))){const n=a[o(1157,1077)](e(1061,"ZSzB"));if(!n)return;a[(i=47,s="[Em7",at(s,i- -1224))](t("Ic3g",1511),()=>{function o(e,o){return t(e,o- -1407)}return n[o("q1IV",90)]-a[o("Ic3g",120)](e(1065-30,"q1IV"))})}var i,s},{group:!0})),s(a[at("1CiF",1320)](st(1448,1420),t=>{function e(t,e){return et(e-57,t)}var o,i,a,s;K=t[(a=1029,s=929,T(a,s-42))][(o=974,i=895,T(o,i-249))],Q=t[e("7lxN",1342)][e("RRbT",1367)]}));const nt={handleEvent(t){function e(t,e){return it(t,e-526)}function o(t,e){return et(e-300,t)}const s=i[e(848,927)](t);let n=s.y;function l(t,e){return ot(e,t-206)}function r(t,e){return S(e,t-999)}function c(t,e){return et(t- -3,e)}let d=s.x;function h(t,e){return T(t,e- -48)}t[m(40,40)]&&(d=d||n,n=0);const u=a[l(1290,"nd*g")](w(916,869));function m(t,e){return it(t,e- -332)}function g(t,e){return ot(t,e- -723)}let f=!1;function p(t,e){return L(e- -442,t)}function w(t,e){return st(e,t- -523)}if((n>0&&100===Math[m(-117,5)](u[r(1616,1502)][l(1062,"D3Zw")])||n<0&&0===Math[r(1488,1415)](u[w(946,795)][e(937,812)])||n&&!u[w(946,1105)][m(62,138)]||d>0&&100===Math[l(1127,"n&05")](u[m(19,146)][e(829,812)])||d<0&&0===Math[w(818,983)](u[o("i*lL",1618)][w(767,779)])||d&&!u[w(959,870)][o("YjH#",1594)])&&(f=!0),!f&&t[l(1106,"5v8H")](),t[w(853,866)]||s.x){const t=i[c(1155,"lnXr")]();return void(d>0?a[m(-28,135)](w(830,921))?i[c(1232,"GfQw")](t[o("n&05",1478)]+d*K):i[h(736,847)](t[o("1CiF",1605)]+K):a[c(1285,"GfQw")](g("i*lL",357))?i[c(1158,"XCg9")](t[p("OsLa",15)]+d*K):i[c(1118,"RA(]")](t[g("vcGu",58)]-K))}const b=i[o("X$eF",1537)]();if(n>0)if(a[e(1134,993)](o("RA(]",1543))){const t=a[w(948,864)](r(1426,1418));let e=0;e=t?n/t*Q:n*Q,i[m(154,73)](b[r(1378,1525)]+e)}else i[c(1184,"3Zc4")](b[c(1136,"p10Q")]+Q);else if(a[r(1618,1571)](o("RA(]",1543))){const t=a[w(948,1109)](o("c%Md",1563));let e=0;e=t?n/t*Q:n*Q,i[p("vcGu",-143)](b[h(445,588)]+e)}else i[h(714,766)](b[c(1335,"!K54")]-Q)},passive:!1},lt=Object[ot("M!#g",877)](Object[ot("n&05",928)]({},e),{api:i,state:a,componentName:x});b(t=>{for(const e in t)lt[e]=t[e]});const rt=n[it(148,312)](D,lt),ct=i[W(715,752)](o(1140,"c%Md"),t,e);return s(ct[at("Ic3g",1399)]),()=>H?ct[et(1232,"p10Q")](S(768,603),r`
            <div
              data-info-url="https://github.com/neuronetio/gantt-schedule-timeline-calendar"
              class=${P[o(1021,"3Zc4")]}
              style=${P[T(701,735)][it(91,247)]()}
              data-actions=${rt()}
              @wheel=${nt}
            >
              ${ct[S(480,514)](et(1155,"!K54"),r` ${O[st(1207,1366)]()}${R[L(498,"YjH#")]()} `)}
            </div>
          `):y}let bt;!function(){function t(t,e){return ft(e-558,t)}function e(t,e){return ft(e- -918,t)}function o(t,e){return pt(t- -214,e)}function i(t,e){return ft(e-121,t)}const a=gt();function s(t,e){return ft(e-629,t)}function n(t,e){return pt(t-549,e)}for(;;)try{if(152963===-parseInt(t(1425,1302))/1+parseInt(o(261,"cUs9"))/2*(parseInt(e(-346,-238))/3)+parseInt(o(355,"OsLa"))/4*(-parseInt(o(307,"RRbT"))/5)+parseInt(i(988,880))/6+parseInt(o(288,"Ic3g"))/7+parseInt(s(1375,1313))/8*(parseInt(t(1129,1149))/9)+-parseInt(n(1303,"X$eF"))/10*(parseInt(s(1036,1193))/11))break;a.push(a.shift())}catch(t){a.push(a.shift())}}();let vt=0,yt=null;function Pt(){return null!==yt&&0!==yt.byteLength||(yt=new Uint8Array(bt.memory.buffer)),yt}const xt="undefined"!=typeof TextEncoder?new TextEncoder("utf-8"):{encode:()=>{throw Error("TextEncoder not available")}},Dt="function"==typeof xt.encodeInto?function(t,e){return xt.encodeInto(t,e)}:function(t,e){const o=xt.encode(t);return e.set(o),{read:t.length,written:o.length}};function Wt(t,e,o){if(void 0===o){const o=xt.encode(t),i=e(o.length,1)>>>0;return Pt().subarray(i,i+o.length).set(o),vt=o.length,i}let i=t.length,a=e(i,1)>>>0;const s=Pt();let n=0;for(;n<i;n++){const e=t.charCodeAt(n);if(e>127)break;s[a+n]=e}if(n!==i){0!==n&&(t=t.slice(n)),a=o(a,i,i=n+3*t.length,1)>>>0;const e=Pt().subarray(a+n,a+i);n+=Dt(t,e).written,a=o(a,i,n,1)>>>0}return vt=n,a}let Ct=null;function $t(){return(null===Ct||!0===Ct.buffer.detached||void 0===Ct.buffer.detached&&Ct.buffer!==bt.memory.buffer)&&(Ct=new DataView(bt.memory.buffer)),Ct}const It="undefined"!=typeof TextDecoder?new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}):{decode:()=>{throw Error("TextDecoder not available")}};function St(t,e){return t>>>=0,It.decode(Pt().subarray(t,t+e))}function Mt(t,e){try{return t.apply(this,e)}catch(t){const e=function(t){const e=bt.__externref_table_alloc();return bt.__wbindgen_export_5.set(e,t),e}(t);bt.__wbindgen_exn_store(e)}}"undefined"!=typeof TextDecoder&&It.decode();const Gt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_license_free(t>>>0,1));const zt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_licensedate_free(t>>>0,1));const Lt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_licensekeyresult_free(t>>>0,1));const Ot="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_licenseresult_free(t>>>0,1));const Rt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_licensetype_free(t>>>0,1));const Tt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_productinfo_free(t>>>0,1));const kt="undefined"==typeof FinalizationRegistry?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(t=>bt.__wbg_signedlicense_free(t>>>0,1));function At(){const t={wbg:{}};return t.wbg.__wbg_String_8f0eb39a4a4c2f66=function(t,e){const o=Wt(String(e),bt.__wbindgen_malloc,bt.__wbindgen_realloc),i=vt;$t().setInt32(t+4,i,!0),$t().setInt32(t+0,o,!0)},t.wbg.__wbg_error_7534b8e9a36f1ab4=function(t,e){let o,i;try{o=t,i=e,console.error(St(t,e))}finally{bt.__wbindgen_free(o,i,1)}},t.wbg.__wbg_new_8a6f238a6ece86ea=function(){return new Error},t.wbg.__wbg_new_d684b6b3189ca362=function(){return new Object},t.wbg.__wbg_parse_bcc0320de0fc537a=function(){return Mt(function(t,e){return JSON.parse(St(t,e))},arguments)},t.wbg.__wbg_set_3f1d0b984ed272ed=function(t,e,o){t[e]=o},t.wbg.__wbg_stack_0ed75d68575b0f3c=function(t,e){const o=Wt(e.stack,bt.__wbindgen_malloc,bt.__wbindgen_realloc),i=vt;$t().setInt32(t+4,i,!0),$t().setInt32(t+0,o,!0)},t.wbg.__wbindgen_init_externref_table=function(){const t=bt.__wbindgen_export_5,e=t.grow(4);t.set(0,void 0),t.set(e+0,void 0),t.set(e+1,null),t.set(e+2,!0),t.set(e+3,!1)},t.wbg.__wbindgen_string_new=function(t,e){return St(t,e)},t.wbg.__wbindgen_throw=function(t,e){throw new Error(St(t,e))},t}function _t(t,e){return bt=t.exports,Nt.__wbindgen_wasm_module=e,Ct=null,yt=null,bt.__wbindgen_start(),bt}async function Nt(t){if(void 0!==bt)return bt;void 0!==t&&Object.getPrototypeOf(t)===Object.prototype&&({module_or_path:t}=t);const e=At();("string"==typeof t||"function"==typeof Request&&t instanceof Request||"function"==typeof URL&&t instanceof URL)&&(t=fetch(t));const{instance:o,module:i}=await async function(t,e){if("function"==typeof Response&&t instanceof Response){if("function"==typeof WebAssembly.instantiateStreaming)try{return await WebAssembly.instantiateStreaming(t,e)}catch(e){if("application/wasm"==t.headers.get("Content-Type"))throw e;console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",e)}const o=await t.arrayBuffer();return await WebAssembly.instantiate(o,e)}{const o=await WebAssembly.instantiate(t,e);return o instanceof WebAssembly.Instance?{instance:o,module:t}:o}}(await t,e);return _t(o,i)}var Vt=Object.freeze({__proto__:null,parse_license_key:function(t,e){const o=Wt(t,bt.__wbindgen_malloc,bt.__wbindgen_realloc),i=vt,a=Wt(e,bt.__wbindgen_malloc,bt.__wbindgen_realloc),s=vt;return bt.parse_license_key(o,i,a,s)},License:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Gt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_license_free(t,0)}},LicenseDate:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,zt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_licensedate_free(t,0)}},LicenseKeyResult:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Lt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_licensekeyresult_free(t,0)}},LicenseResult:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Ot.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_licenseresult_free(t,0)}},LicenseType:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Rt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_licensetype_free(t,0)}},ProductInfo:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,Tt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_productinfo_free(t,0)}},SignedLicense:class{__destroy_into_raw(){const t=this.__wbg_ptr;return this.__wbg_ptr=0,kt.unregister(this),t}free(){const t=this.__destroy_into_raw();bt.__wbg_signedlicense_free(t,0)}},initSync:function(t){if(void 0!==bt)return bt;void 0!==t&&Object.getPrototypeOf(t)===Object.prototype&&({module:t}=t);const e=At();return t instanceof WebAssembly.Module||(t=new WebAssembly.Module(t)),_t(new WebAssembly.Instance(t,e),t)},default:Nt});
/**
